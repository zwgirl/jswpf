define(["dojo/_base/declare", "dojo/_base/lang", 
        "my/DependencyProperty", "my/DependencyObjectType"], 
		function(declare, lang, DependencyProperty, DependencyObjectType){
	

    
//    [FriendAccessAllowed] // Built into Base, also used by Framework. 
    /*internal enum */var UpdateResult =
    {
        ValueChanged : 0x01, 
...
//    [FriendAccessAllowed] // Built into Base, also used by Framework.
    /*internal enum */var RequestFlags =
    { 
        FullyResolved : 0x00,
...
//    [FriendAccessAllowed] // Built into Base, also used by Framework.
    /*internal static readonly object */var ExpressionInAlternativeStore = new NamedObject("ExpressionInAlternativeStore");

    // callbacks used for alternative expression storage 
    /*private static AlternativeExpressionStorageCallback*/ var _getExpressionCore;
    ...
    /*internal static readonly UncommonField<object> */var DependentListMapField = new UncommonField/*<object>*/(); 

    // Optimization, to avoid calling FromSystemType too often 
    /*internal static DependencyObjectType */var DType = DependencyObjectType.FromSystemTypeInternal(typeof(DependencyObject));
    
 // This uncommon field is used to store the handlers for the InheritanceContextChanged event 
    /*private  static readonly UncommonField<EventHandler> */var InheritanceContextChangedHandlersField = new UncommonField/*<EventHandler>*/();
    ...
    declare(null, {
        ...
        /// </remarks>
        /*public DependencyObject*/constructor:function()
        {
            Initialize(); 
        },
...
//        }
        ...
        /*private void */Initialize:function()
        { 
        ...
        /// </summary>
//        [FriendAccessAllowed] // Built into Base, also used by Framework. 
        /*internal virtual void*/ Seal:function() 
        {
...
//        }
        ...
        /// </summary>
        /*public override sealed bool */Equals:function(Object obj) 
        {
        ...
        /// </summary>
        /*public override sealed int */GetHashCode:function() 
        {
        ...
        /*public object */GetValue:function(/*DependencyProperty*/ dp)
        {
...
//        [FriendAccessAllowed] // Built into Base, also used by Core.
        /*internal EffectiveValueEntry */GetValueEntry:function( 
            /*EntryIndex*/          entryIndex,
            /*DependencyProperty*/  dp,
            /*PropertyMetadata*/    metadata,
            /*RequestFlags*/        requests) 
        {
            /*EffectiveValueEntry*/var entry; 
            ...
            { 
                ...
                /*GetReadOnlyValueCallback*/var getValueCallback = metadata.GetReadOnlyValueCallback; 
                if (getValueCallback != null) 
                {
                    /*BaseValueSourceInternal*/var valueSource; 
            ...
            if (entry.Value == DependencyProperty.UnsetValue) 
            {
                if (dp.IsPotentiallyInherited)
                {
                    ...
                    {
                        /*DependencyObject*/var inheritanceParent = InheritanceParent;
        ...
        /// </summary> 
        /*private EffectiveValueEntry */GetEffectiveValue:function( 
            /*EntryIndex*/          entryIndex,
            /*DependencyProperty*/  dp, 
            /*RequestFlags*/        requests)
        {
            /*EffectiveValueEntry*/ var entry = _effectiveValues[entryIndex.Index];
            /*EffectiveValueEntry*/ var effectiveEntry = entry.GetFlattenedEntry(requests); 
...
//                Debug.Assert(!DO_Sealed, "A Sealed DO cannot be modified");
                ...
                if (!entry.HasExpressionMarker) 
                {
                    ...
                    /*DeferredReference*/var reference = /*(DeferredReference)*/entry.Value; 
                    /*object*/ value = reference.GetValue(entry.BaseValueSourceInternal); 

                    if (!dp.IsValidValue(value)) 
                    {
                        throw new Error("InvalidPropertyValue value = " + value + " dependency property : " +  dp.Name));
                    }
            ...
            { 
                ...
                /*ModifiedValue*/var modifiedValue = entry.ModifiedValue; 
                /*DeferredReference*/var reference = null; 
                /*bool*/var referenceFromExpression = false;
...
//                Debug.Assert(reference != null, "the only modified values that can have deferredreferences are (a) expression, (b) coerced control value"); 
                ...
                /*object*/var value = reference.GetValue(entry.BaseValueSourceInternal); 
 
                if (!dp.IsValidValue(value))
                { 
                    throw new Error("InvalidPropertyValue value=" + value + " dp=" + dp.Name));
                }
        ...
        /*public void */SetValue:function(/*DependencyProperty*/ dp, /*object*/ value)
        {
            // Do not allow foreign threads access. 
            // (This is a noop if this object is not assigned to a Dispatcher.)
            // 
            ...
            /*PropertyMetadata*/var metadata = SetupPropertyChange(dp);
...
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework. 
        /*internal void */SetValueInternal:function(/*DependencyProperty*/ dp, /*object*/ value)
        {
            // Do not allow foreign threads access.
            // (This is a noop if this object is not assigned to a Dispatcher.) 
            //
        ...
        /// <param name="value">New local value</param>
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
        /*internal void */SetCurrentValueInternal:function(/*DependencyProperty*/ dp, /*object*/ value) 
        {
            // Do not allow foreign threads access. 
            // (This is a noop if this object is not assigned to a Dispatcher.) 
            //
        ...
        /// </summary>
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        /*internal void */SetDeferredValue:function(/*DependencyProperty*/ dp, /*DeferredReference*/ deferredReference) 
        {
            // Cache the metadata object this method needed to get anyway. 
            /*PropertyMetadata*/var metadata = SetupPropertyChange(dp); 
        ...
        /// </summary> 
//        [FriendAccessAllowed] // Built into Base, also used by Framework. 
        /*internal void */SetCurrentDeferredValue:function(/*DependencyProperty*/ dp, /*DeferredReference*/ deferredReference)
        { 
            // Cache the metadata object this method needed to get anyway.
            /*PropertyMetadata*/var metadata = SetupPropertyChange(dp);
        ...
        /// </summary>
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        /*internal void */SetMutableDefaultValue:function(/*DependencyProperty*/ dp, /*object*/ value)
        { 
            // Cache the metadata object this method needed to get anyway.
            /*PropertyMetadata*/var metadata = SetupPropertyChange(dp); 
        ...
        public void SetValue(DependencyPropertyKey key, object value) 
        {
            ...
            // Cache the metadata object this method needed to get anyway. 
            /*PropertyMetadata*/ var metadata = SetupPropertyChange(key, out dp);
        ...
        /// can be changed. 
        /// </summary>
        /*private PropertyMetadata */SetupPropertyChange:function(/*DependencyProperty*/ dp)
        {
            if ( dp != null ) 
            {
                if ( !dp.ReadOnly ) 
                ...
                {
                    throw new Error("ReadOnlyChangeNotAllowed " +  dp.Name); 
                }
            } 
            else 
            {
                throw new Error("dp may not be null"); 
            }
        },
...
//                Debug.Assert(dp != null); 
            ...
            /*bool*/                isInternal)
        {
            if (IsSealed) 
            {
                throw new Error("SetOnReadOnlyObjectNotAllowed " +  this)); 
            } 

            /*Expression*/var newExpr = null; 
            /*DependencySource[]*/var newSources = null;

            /*EntryIndex*/var entryIndex = LookupEntry(dp.GlobalIndex);
...
//                Debug.Assert(!coerceWithCurrentValue, "Don't call SetCurrentValue with UnsetValue");
            ...
            /*bool*/var newValueHasExpressionMarker = (value == ExpressionInAlternativeStore);
            ...
            { 
                /*bool*/ var isValidValue = isInternal ? dp.IsValidValueInternal(value) : dp.IsValidValue(value);
                ...
                { 
                    ...
                    { 
                        ...
                        {
                            throw new Error("SharingNonSharableExpression"); 
                        }
            ...
            { 
                ...
                {
                    // CALLBACK
/*                    DependencySource[]*/var currentSources = currentExpr.GetSources();
...
//                    Debug.Assert(!coerceWithCurrentValue, "Expression values not supported in SetCurrentValue"); 
                    ...
                    /*object*/var defaultValue = metadata.GetDefaultValue(this, dp);
                    entryIndex = CheckEntryIndex(entryIndex, dp.GlobalIndex);
                    this.SetExpressionValue(entryIndex, defaultValue, newExpr); 
                    this.UpdateSourceDependentLists(this, dp, newSources, newExpr, true);  // Add
...
//        [FriendAccessAllowed] // Built into Base, also used by Core & Framework. 
        /*internal bool */ProvideSelfAsInheritanceContext:function( /*object*/ value, /*DependencyProperty*/ dp )
        { 
...
//        [FriendAccessAllowed] // Built into Base, also used by Core & Framework.
        /*internal bool */ProvideSelfAsInheritanceContext:function( /*DependencyObject*/ doValue, /*DependencyProperty*/ dp ) 
        {
            ...
            {
                /*DependencyObject*/var oldInheritanceContext = doValue.InheritanceContext;
        ...
        // 
//        [FriendAccessAllowed] // Built into Base, also used by Core & Framework.
        /*internal bool */RemoveSelfAsInheritanceContext:function( /*object*/ value, /*DependencyProperty*/ dp ) 
        {
            /*DependencyObject*/var doValue = value instanceof DependencyObject ? value : null;
            if (doValue != null)
            { 
...
//        [FriendAccessAllowed] // Built into Base, also used by Core & Framework. 
        /*internal bool */RemoveSelfAsInheritanceContext:function( /*DependencyObject*/ doValue, /*DependencyProperty*/ dp )
        { 
        ...
        /// </summary> 
        /// <param name="dp">Dependency property</param>
        /*public void */ClearValue:function(/*DependencyProperty*/ dp)
        {
        ...
        /// </summary>
        /*private void */ClearValueCommon:function(/*EntryIndex*/ entryIndex, /*DependencyProperty*/ dp, /*PropertyMetadata*/ metadata) 
        {
            if (this.IsSealed) 
            { 
                throw new Error("ClearOnReadOnlyObjectNotAllowed " +  this));
            } 

            // Get old value
            /*EffectiveValueEntry*/var oldEntry = GetValueEntry(
                                        entryIndex, 
                                        dp,
                                        metadata, 
            ...
            /*object*/var current = oldEntry.LocalValue;
 
            // Get current expression
            /*Expression*/var currentExpr = (oldEntry.IsExpression) ? (current as Expression) : null; 
            ...
            /*EffectiveValueEntry*/var newEntry = new EffectiveValueEntry(dp, BaseValueSourceInternal.Local);
        ...
        /// </summary> 
        /*internal bool */ContainsValue:function(/*DependencyProperty*/ dp)
        { 
            /*EntryIndex*/var entryIndex = LookupEntry(dp.GlobalIndex); 
            ...
            /*EffectiveValueEntry*/ var entry = this._effectiveValues[entryIndex.Index];
            /*object*/ var value = entry.IsCoercedWithCurrentValue ? entry.ModifiedValue.CoercedValue : entry.LocalValue; 
        ...
        /// </summary>
        /// <param name="dp">Dependency property</param>
        /*public void */CoerceValue:function(/*DependencyProperty*/ dp) 
        {
            // Do not allow foreign threads access. 
            // (This is a noop if this object is not assigned to a Dispatcher.) 
            //
            ...
            /*EntryIndex*/var entryIndex = LookupEntry(dp.GlobalIndex);
            /*PropertyMetadata*/var metadata = dp.GetMetadata(DependencyObjectType);
            ...
            if (entryIndex.Found) 
            {
                /*EffectiveValueEntry*/var entry = this.GetValueEntry(entryIndex, dp, metadata, RequestFlags.RawEntry); 
                if (entry.IsCoercedWithCurrentValue)
                {
            ...
            /*EffectiveValueEntry*/ var newEntry = new EffectiveValueEntry(dp, FullValueSource.IsCoerced); 
        ...
        /// </remarks> 
//        [FriendAccessAllowed] // Built into Base, also used by Framework. 
        /*internal void */InvalidateSubProperty:function(/*DependencyProperty*/ dp)
        { 
        ...
        /// </remarks> 
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        /*internal void */NotifySubPropertyChange:function(/*DependencyProperty*/ dp) 
        {
            ...
            /*Freezable*/var freezable = this instanceof Freezable ? this : null; 
            if (freezable != null) 
            {
        ...
        /*public void */InvalidateProperty:function(/*DependencyProperty*/ dp) 
        {
            this.InvalidateProperty(dp, preserveCurrentValue:false);
        }
        ...
        { 
            ...
            /*EffectiveValueEntry*/var newEntry = new EffectiveValueEntry(dp, BaseValueSourceInternal.Unknown); 
...
//        [FriendAccessAllowed] // Declared in Base also used in Framework
        /*internal UpdateResult */UpdateEffectiveValue:function( 
                /*EntryIndex*/          entryIndex,
                /*DependencyProperty*/  dp,
                /*PropertyMetadata*/    metadata,
        ...
        { 
            if (dp == null)
            {
                throw new Error("dp may notbe null!");
            } 

            /*int*/var targetIndex = dp.GlobalIndex;
            ...
            /*object*/var oldValue = oldEntry.GetFlattenedEntry(RequestFlags.FullyResolved).Value;
            ...
            /*bool*/var isReEvaluate = false; 
            /*bool*/var isCoerceValue = false; 
            /*bool*/var isClearValue = false;
                 ...
                 (oldEntry.IsExpression && newEntry.IsExpression && (newEntry.ModifiedValue.BaseValue == oldEntry.ModifiedValue.BaseValue)))))
            {
                ...
                if (!isCoerceValue) 
                {
                    ...
                    /*bool*/var found = (newEntry.Value != DependencyProperty.UnsetValue);
            ...
            if (coerceWithCurrentValue)
            { 
                /*object*/var baseValue = newEntry.GetFlattenedEntry(RequestFlags.CoercionBaseValue).Value;
            ...
            /*bool*/var isAValueChange = !Equals(dp, oldValue, newEntry.GetFlattenedEntry(RequestFlags.FullyResolved).Value);
            ...
            /*bool*/var oldEntryHadContext = oldEntry.FullValueSource == /*(FullValueSource)*/ BaseValueSourceInternal.Local;
            /*bool*/var newEntryNeedsContext = newEntry.FullValueSource == /*(FullValueSource) */BaseValueSourceInternal.Local;
...
//                    !newEntry.IsAnimated, "Coerced or Animated value cannot be a deferred reference"); 
            ...
            /*object*/var coercedValue = coerceWithCurrentValue ? controlValue : coerceValueCallback(this, baseValue); 
            ...
            if (!Equals(dp, coercedValue, baseValue)) 
            {
                ...
                { 
                    ...
                    if (!(coerceWithCurrentValue && coercedValue is DeferredReference))
                        throw new Error("InvalidPropertyValue £¨coerceValue=" + coercedValue + " dependency property=" + dp.Name)); 
                }
        ...
        /// </summary> 
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        /*internal void */NotifyPropertyChange:function(/*DependencyPropertyChangedEventArgs*/ args) 
        { 
            // fire change notification
        ...
        /// </summary>
        /*internal virtual void */EvaluateAnimatedValueCore:function( 
                DependencyProperty  dp,
                PropertyMetadata    metadata,
            ref EffectiveValueEntry newEntry)
        { 
        ...
        /*protected virtual void */OnPropertyChanged:function(/*DependencyPropertyChangedEventArgs*/ e)
        {
        ...
        /// </summary> 
        /*protected internal virtual bool */ShouldSerializeProperty:function( /*DependencyProperty*/ dp )
        { 
            return ContainsValue( dp );
        }

//        [FriendAccessAllowed] // Built into Base, also used by Core & Framework. 
        /*internal BaseValueSourceInternal */GetValueSource:function(DependencyProperty dp, PropertyMetadata metadata, out bool hasModifiers)
        { 
        ...
        ///     set via <cref see="SetValue"/>.
        /// </returns>
        /*internal object */ReadLocalValueEntry:function(/*EntryIndex*/ entryIndex, /*DependencyProperty*/ dp, /*bool*/ allowDeferredReferences) 
        {
            if (!entryIndex.Found) 
            { 
        ...
        /*public LocalValueEnumerator */GetLocalValueEnumerator:function() 
        {
            // Do not allow foreign threads access. 
            // (This is a noop if this object is not assigned to a Dispatcher.) 
            //
        ...
        /// </returns> 
        /*internal bool */HasAnyExpression:function() 
        {
        ...
        /// </summary> 
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
        /*internal bool */HasExpression:function(/*EntryIndex*/ entryIndex, /*DependencyProperty*/ dp)
        {
            if (!entryIndex.Found) 
            {
                return false; 
...
//            [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
        ...
        /// </remarks>
        /*internal virtual void */AddInheritanceContext:function(/*DependencyObject*/ context, /*DependencyProperty*/ property)
        { 
        }
        ...
        /// </remarks> 
        /*internal virtual void */RemoveInheritanceContext:function(/*DependencyObject*/ context, /*DependencyProperty*/ property) 
        {
        } 
        ...
        /// </summary>
        /*internal virtual bool */ShouldProvideInheritanceContext:function(/*DependencyObject*/ target, /*DependencyProperty*/ property) 
        { 
            return true;
        } 
        ...
        /// </remarks> 
//        [FriendAccessAllowed] // Built into Base, also used by Core.
        /*internal void */OnInheritanceContextChanged:function(EventArgs args)
        {
            ...
            try 
            {
                ...
                // Iterate through the sorted effectiveValues 
                /*uint*/ var effectiveValuesCount = EffectiveValuesCount;
                for (/*uint*/var i=0; i<effectiveValuesCount; i++)
                {
                    /*DependencyProperty*/var dp = DependencyProperty.RegisteredPropertyList.List[_effectiveValues[i].PropertyIndex]; 
                    if (dp != null)
                    { 
                        /*object*/ var localValue = ReadLocalValueEntry(new EntryIndex(i), dp, true /* allowDeferredReferences */); 
                        if (localValue != DependencyProperty.UnsetValue)
                        { 
                            /*DependencyObject*/var inheritanceChild = localValue instanceof DependencyObject ? localValue : null;
...
//                Debug.Assert(CanModifyEffectiveValues == false, "We do not expect re-entrancy here.");
        ...
        /// </summary> 
//        [FriendAccessAllowed] // Built into Base, also used by Core. 
        /*internal virtual void */OnInheritanceContextChangedCore:function(/*EventArgs*/ args)
        { 
        }
...
//            [FriendAccessAllowed] // Built into Base, also used by Framework.
        ...
        // fewer reallocations
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework. 
        /*internal void */BeginPropertyInitialization:function()
        { 
...
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
        /*internal void */EndPropertyInitialization:function() 
        {
            ...
            if (this._effectiveValues != null) 
            {
                ...
                {
                    /*uint*/var endLength = effectiveValuesCount; 
                    if (((float) endLength / (float) _effectiveValues.Length) < 0.8)
                    {
                        // For thread-safety, sealed DOs can't modify _effectiveValues.
//                        Debug.Assert(!DO_Sealed, "A Sealed DO cannot be modified"); 

                        /*EffectiveValueEntry[]*/var destEntries = new EffectiveValueEntry[endLength]; 
        ...
        /*private void */SetInheritanceParent:function(/*DependencyObject*/ newParent) 
        {
...
//        [FriendAccessAllowed] // Built into Base, also used by Framework. 
        /*internal void */SetIsSelfInheritanceParent:function()
        {
            // Merge all the inheritable properties on the inheritanceParent into the EffectiveValues
...
//            Debug.Assert(!DO_Sealed, "A Sealed DO cannot be modified"); 
        ...
        // 
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        /*internal void */SynchronizeInheritanceParent:function(/*DependencyObject*/ parent) 
        {
        ...
        // 
        /*private void */MergeInheritableProperties:function(/*DependencyObject*/ inheritanceParent)
        {
...
//            Debug.Assert(inheritanceParent.IsSelfInheritanceParent, "An inheritanceParent should always be one that has all the inheritable properties cached on self"); 
            ...
            /*EffectiveValueEntry[]*/var parentEffectiveValues = inheritanceParent.EffectiveValues; 
            /*uint*/var parentEffectiveValuesCount = inheritanceParent.EffectiveValuesCount; 

            for (/*uint*/var i=0; i<parentEffectiveValuesCount; i++) 
            {
                /*EffectiveValueEntry*/var entry = parentEffectiveValues[i];
                /*DependencyProperty*/var dp = DependencyProperty.RegisteredPropertyList.List[entry.PropertyIndex];
                ...
                { 
                    ...
                    if (metadata.IsInherited) 
                    {
                        /*object*/var value = inheritanceParent.GetValueEntry(
                                            new EntryIndex(i),
                                            dp, 
                                            metadata,
        ...
        // 
        /*private EntryIndex */CheckEntryIndex:function(/*EntryIndex*/ entryIndex, /*int*/ targetIndex) 
        {
            /*uint*/ var effectiveValuesCount = EffectiveValuesCount; 
...
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        /*internal EntryIndex */LookupEntry:function(/*int*/ targetIndex) 
        {
            var checkIndex;
            var iLo = 0;
            var iHi = EffectiveValuesCount; 
            ...
            while (iHi - iLo > 3)
            { 
                /*uint*/var iPv = Math.floor((iHi + iLo) / 2);
        ...
        /*private void */InsertEntry:function(/*EffectiveValueEntry*/ entry, /*uint*/ entryIndex)
        {
            // For thread-safety, sealed DOs can't modify _effectiveValues. 

            if (CanModifyEffectiveValues == false)
            { 
                throw new Error("LocalValueEnumerationInvalidated");
            } 
            ...
            if (effectiveValuesCount > 0) 
            {
                if (this._effectiveValues.Length == effectiveValuesCount)
                {
                    ...
                    /*EffectiveValueEntry[]*/var destEntries = new /*EffectiveValueEntry*/Array[newSize];
            ...
            else 
            {
                if (this._effectiveValues == null) 
                { 
                	this._effectiveValues = new EffectiveValueEntry[EffectiveValuesInitialSize];
                } 
...
//            Debug.Assert(!DO_Sealed, "A Sealed DO cannot be modified");
        ...
        /*internal void */SetEffectiveValue:function(/*EntryIndex*/ entryIndex, /*DependencyProperty*/ dp, 
        		/*PropertyMetadata*/ metadata, /*EffectiveValueEntry*/ newEntry, /*EffectiveValueEntry*/ oldEntry)
        {
            if (metadata != null &&
            ...
            /*bool*/ var restoreMarker = false; 

            if (oldEntry.HasExpressionMarker && !newEntry.HasExpressionMarker) 
            { 
                /*BaseValueSourceInternal*/var valueSource = newEntry.BaseValueSourceInternal;
...
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
        /*internal void */SetEffectiveValue:function(/*EntryIndex*/ entryIndex, /*DependencyProperty*/ dp, 
        		/*int*/ targetIndex, /*PropertyMetadata*/ metadata, /*object*/ value, /*BaseValueSourceInternal*/ valueSource)
        { 
            ...
            /*bool*/ var hasExpressionMarker = (value == ExpressionInAlternativeStore); 
...
//            Debug.Assert(dp == null || (dp.GlobalIndex == entry.PropertyIndex), "EffectiveValueEntry & DependencyProperty do not match");
        ...
        // 
        /*internal void */UnsetEffectiveValue:function(/*EntryIndex*/ entryIndex, /*DependencyProperty*/ dp, /*PropertyMetadata*/ metadata)
        { 
            if (entryIndex.Found) 
            {
        ...
        //
        /*private void */SetExpressionValuefunction(/*EntryIndex*/ entryIndex, /*object*/ value, /*object*/ baseValue)
        { 
        ...
        /// </summary> 
        /*private bool */Equals:function(/*DependencyProperty*/ dp, /*object*/ value1, /*object*/ value2)
        { 
...
//internal static void  ChangeExpressionSources(/*Expression*/ expr, /*DependencyObject*/ d, /*DependencyProperty*/ dp, /*DependencySource[] */newSources) 
	DependencyObject.ChangeExpressionSources=function(/*Expression*/ expr, /*DependencyObject*/ d, /*DependencyProperty*/ dp, /*DependencySource[] */newSources) 
	{
	    if (!expr.ForwardsInvalidations) 
	    { 
    ...
    Object.defineProperties( DependencyObject.prototype, {
        ...
        { 
            get:function()
            {
                ...
                { 
                    // Specialized type identification
                    this._dType = DependencyObjectType.FromSystemTypeInternal(GetType()); 
                } 
...
//        [FriendAccessAllowed]   // defined in Base, used in Core and Framework
        ...
        {
            get:function() { return (_packedData & 0x10000000) != 0; }, 
            set:function(value) { if (value) { _packedData |= 0x10000000; } else { _packedData &= 0xEFFFFFFF; } }
        }
