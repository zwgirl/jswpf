...
define([ "dojo/_base/declare", "dojo/_base/lang", 
         "my/Expression",
         "my/data/Feature" ], function(declare, lang, Expression) {
...
//        private enum PrivateFlags : uint 
        ...
        internal BindingExpressionBase(BindingBase binding, BindingExpressionBase parent) : base(ExpressionMode.SupportsUnboundSources) 
        {
            ...
            this._flags = /*(PrivateFlags)*/binding.Flags; 
...
//        internal override Expression 
        ...
        /// </summary> 
//        bool 
        IWeakEventListener.ReceiveWeakEvent:function(Type managerType, object sender, EventArgs e)
        {
...
//        internal static BindingExpressionBase 
        CreateUntargetedBindingExpression:function(DependencyObject d, BindingBase binding)
        { 
        ...
        internal void Attach:function(DependencyObject d) 
        {
...
//        internal ValidationError 
        ...
        {
            /*ValidationError*/var validationError = BaseValidationError; 
...
//        internal void 
	...
	Object.define.properties(Expression.prototype, {
        //------------------------------------------------------ 
        //
        //  Public Properties 
        // 
...
//        public BindingGroup 
        BindingGroup:
        {
            get:function() 
            {
                /*BindingExpressionBase*/var root = RootBindingExpression; 
                /*WeakReference<BindingGroup>*/var wr = /*(WeakReference<BindingGroup>)*/root.GetValue(Feature.BindingGroup, null); 
                if (wr == null)
                    return null; 
                else
                {
...
//        internal BindingStatusInternal 
        StatusInternal:function() { get:function() { return this._status; } },
...
//        internal ValidationError 
        BaseValidationError:
        { 
            get:function() { return /*(ValidationError)*/this.GetValue(Feature.ValidationError, null); } 
        },
 
//        internal List<ValidationError> 
        NotifyDataErrors:
        {
            get:function() { return /*(List<ValidationError>)*/this.GetValue(Feature.NotifyDataErrors, null); }
        }, 
...
//        internal bool 
        IsAttaching:
        {
            get:function() { return TestFlag(PrivateFlags.iAttaching); },
            set:function(value) { ChangeFlag(PrivateFlags.iAttaching, value); } 
        },
...
//        internal bool 
        IsDetaching:
        { 
            get:function() { return TestFlag(PrivateFlags.iDetaching); },
            set:function(value) { ChangeFlag(PrivateFlags.iDetaching, value); }
        },
...
//        internal bool 
        IsDetached: 
        { 
            get:function() { return (_status == BindingStatusInternal.Detached); }
        } ,

//        private bool 
        IsAttached
        {
            get:function() { return (_status != BindingStatusInternal.Unattached && 
...
//        internal bool 
        IsReflective
        {
            ...
            set:function(value) { ChangeFlag(PrivateFlags.iTargetToSource, value); } 
        },
...
//        internal bool 
        ...
        {
            get:function() { return TestFlag(PrivateFlags.iDefaultValueConverter); } ,
            set:function(value) { ChangeFlag(PrivateFlags.iDefaultValueConverter, value); } 
        },
...
//        internal bool 
        IsOneWayToSource:
        {
            get:function() { return (_flags & PrivateFlags.iPropagationMask) == PrivateFlags.iTargetToSource; } 
        }
...
//        internal bool 
        ...
        { 
            get:function() { return (_flags & PrivateFlags.iUpdateMask) == 0; }
        },
...
//        internal bool 
        IsUpdateOnLostFocus:
        { 
            get:function() { return TestFlag(PrivateFlags.iUpdateOnLostFocus); } 
        },
...
//        internal bool 
        IsTransferPending:
        {
            get:function() { return TestFlag(PrivateFlags.iTransferPending); } ,
            set:function(value) { ChangeFlag(PrivateFlags.iTransferPending, value); }
        } ,
...
//        internal bool 
        TransferIsDeferred: 
        {
            get:function() { return TestFlag(PrivateFlags.iTransferDeferred); },
            set:function(value) { ChangeFlag(PrivateFlags.iTransferDeferred, value); }
        }, 
...
//        internal bool 
        IsInTransfer: 
        {
            get:function() { return TestFlag(PrivateFlags.iInTransfer); } ,
            set:function(value) { ChangeFlag(PrivateFlags.iInTransfer, value); }
        },
...
//        internal bool 
        IsInUpdate:
        { 
            get:function() { return TestFlag(PrivateFlags.iInUpdate); }, 
            set:function(value) { ChangeFlag(PrivateFlags.iInUpdate, value); }
        } ,
...
//        internal bool 
        UsingFallbackValue:
        { 
            get:function() { return TestFlag(PrivateFlags.iUsingFallbackValue); },
            set:function(value) { ChangeFlag(PrivateFlags.iUsingFallbackValue, value); } 
        } ,
...
//        internal bool 
        UsingMentor:
        {
            get:function() { return TestFlag(PrivateFlags.iUsingMentor); },
            set:function(value) { ChangeFlag(PrivateFlags.iUsingMentor, value); } 
        },
...
//        internal bool 
        ...
        { 
            get:function() { return TestFlag(PrivateFlags.iResolveNamesInTemplate); },
            set:function(value) { ChangeFlag(PrivateFlags.iResolveNamesInTemplate, value); }
        },
...
//        internal bool 
        NeedsDataTransfer 
        { 
            get:function() { return TestFlag(PrivateFlags.iNeedDataTransfer); },
            set:function(value) { ChangeFlag(PrivateFlags.iNeedDataTransfer, value); } 
        },
...
//        internal bool 
        NeedsUpdate 
        {
            get:function() { return TestFlag(PrivateFlags.iNeedsUpdate); } ,
            set:function(value) 
            {
...
//        internal bool 
        NeedsValidation 
        {
            get:function() { return TestFlag(PrivateFlags.iNeedsValidation) || HasValue(Feature.ValidationError); },
            set:function(value) { ChangeFlag(PrivateFlags.iNeedsValidation, value); }
        } ,
...
//        internal bool 
        ...
        {
            get:function() { return TestFlag(PrivateFlags.iNotifyOnTargetUpdated); } ,
            set:function(value) { ChangeFlag(PrivateFlags.iNotifyOnTargetUpdated, value); }
        },
...
//        internal bool 
        ...
        { 
            get:function() { return TestFlag(PrivateFlags.iNotifyOnSourceUpdated); } ,
            set:function(value) { ChangeFlag(PrivateFlags.iNotifyOnSourceUpdated, value); }
        } ,
...
//        internal bool 
        ...
        { 
            get:function() { return TestFlag(PrivateFlags.iNotifyOnValidationError); },
            set:function(value) { ChangeFlag(PrivateFlags.iNotifyOnValidationError, value); } 
        } ,
...
//        internal bool 
        ...
        {
            get:function() { return TestFlag(PrivateFlags.iInPriorityBindingExpression); }
        }, 
...
//        internal bool 
        ...
        {
            get:function() { return TestFlag(PrivateFlags.iInMultiBindingExpression); } 
        },
...
//        internal bool 
        ...
        {
            get:function() { return TestFlag(PrivateFlags.iInPriorityBindingExpression | PrivateFlags.iInMultiBindingExpression); } 
        }, 
...
//        internal bool 
        ...
        {
            get:function() { return TestFlag(PrivateFlags.iValidatesOnExceptions); }
        } ,
...
//        internal bool 
        ...
        {
            get:function() { return TestFlag(PrivateFlags.iValidatesOnDataErrors); } 
        },
...
//        internal bool 
        ...
        {
            get:function() { return TestFlag(PrivateFlags.iTargetWantsXTNotification); } ,
            set:function(value) { ChangeFlag(PrivateFlags.iTargetWantsXTNotification, value); } 
        },
...
//        internal bool 
        ...
        {
            get:function() { return TestFlag(PrivateFlags.iDataErrorsChangedPending); }, 
            set:function(value) { ChangeFlag(PrivateFlags.iDataErrorsChangedPending, value); }
        } ,
...
//        internal bool 
        ...
        {
            get:function() { return TestFlag(PrivateFlags.iDeferUpdateForComposition); },
            set:function(value) { ChangeFlag(PrivateFlags.iDeferUpdateForComposition, value); }
        } ,
...
//        internal bool 
        ...
        {
            get:function() { return TestFlag(PrivateFlags.iValidatesOnNotifyDataErrors); } 
        },
...
//        internal MultiBindingExpression 
        ...
        {
            get:function() { return GetValue(Feature.ParentBindingExpressionBase, null) as MultiBindingExpression; } 
        } ,
...
//        internal PriorityBindingExpression 
        ...
        {
            get:function() { return GetValue(Feature.ParentBindingExpressionBase, null) as PriorityBindingExpression; }
        } ,
...
//        internal BindingExpressionBase 
        ParentBindingExpressionBase: 
        {
            get:function() { return (BindingExpressionBase)GetValue(Feature.ParentBindingExpressionBase, null); } 
        },
...
//        internal object 
        ...
        { 
            ...
            get:function() { return ConvertFallbackValue(ParentBindingBase.FallbackValue, TargetProperty, this); }
        },
...
//        internal string 
        EffectiveStringFormat:
        { 
            get:function() { return (string)GetValue(Feature.EffectiveStringFormat, null); } 
        },
...
//        internal object 
        EffectiveTargetNullValue:
        { 
            get:function() { return GetValue(Feature.EffectiveTargetNullValue, DependencyProperty.UnsetValue); }
        } ,
...
//        internal bool 
        UsesLanguage:
        {
            get:function() { return (ParentBindingBase.ConverterCultureInternal == null); } 
        },
...
//        internal Dispatcher 
        Dispatcher:
        { 
            get:function() { return (_engine != null) ? _engine.Dispatcher : null; }
        },
