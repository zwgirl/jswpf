...
//				var newNode = window.document.createElement('div');
				var v =(!module.def || strict) ? true : false;
//				newNode.innerHTML =  "<h3>" + module.mid +  "   module.executed === executing" + " result = " + v  +"</h3> ";
//				window.document.getElementById("test1").appendChild( newNode ); 
				
//				if (/^windows\*/.test(module.pid)) {
//					var newNode = window.document.createElement('div');
//					var v =(!module.def || strict) ? true : false;
//					newNode.innerHTML =  "<h3>" + "module.mid =" + "system package!"  +"</h3> ";
//					window.document.getElementById("test1").appendChild( newNode ); 
//				}
			...
			if(!module.executed){
//				var newNode = window.document.createElement('div');
//				newNode.innerHTML =  "<h3>" + module.mid +  "   module.executed == false" + "</h3> ";
//				window.document.getElementById("test1").appendChild( newNode );
				
				if(!module.def){
					
//					var newNode = window.document.createElement('div');
//					newNode.innerHTML =  "<h3>" + module.mid +  "   exited with !module.def" + "</h3> ";
//					window.document.getElementById("test1").appendChild( newNode );
					return abortExec;
				}
				var mid = module.mid,
				...
				function tt(arg, strict){

					
//					var newNode = window.document.createElement('div');
//					newNode.innerHTML =  "<h3> execute in while of execModule : " + module.mid /*+ " ,,,result = " + res*/ +  "</h3> ";
//					window.document.getElementById("test1").appendChild( newNode );
					var res =  execModule(arg, strict);
					return res;
					...
					argResult = ((arg === cjsRequireModule) ? createRequire(module) :
									((arg === cjsExportsModule) ? module.cjs.exports :
										((arg === cjsModuleModule) ? module.cjs :
											/*execModule(arg, strict)*/tt(arg, strict))));
...
//						var newNode = window.document.createElement('div');
//						newNode.innerHTML =  "<h3>" + module.mid +  "   execModule exit with abortExec" +  "</h3> ";
//						window.document.getElementById("test1").appendChild( newNode );
...
//			var newNode = window.document.createElement('div');
//			newNode.innerHTML =  "<h3>" + module.mid +  "   execModule exit ,module.result = " /*+ module.result*/ + "</h3> ";
//			window.document.getElementById("test1").appendChild( newNode );
		...
		checkComplete = function(){
			...
			guardCheckComplete(function(){
				...
				for(var currentDefOrder, module, i = 0; i < execQ.length;){
					...
					module = execQ[i];
//					var newNode = window.document.createElement('div');
//					newNode.innerHTML =  "<h1>guardCheckComplete : " + module.mid +  " execQ.length =   "  +execQ.length + "</h1> ";
//					window.document.getElementById("test1").appendChild( newNode );
					execModule(module);
	...
	if( 1 ){
		...
		var fixupUrl= function(url){
			...
			defineModule = function(module, deps, def){
				...
				if(module.injected === arrived){
//					var newNode = window.document.createElement('div');
//					newNode.innerHTML =  "<h4>defineModule : " + module.mid +  " module.injected === arrived "  + "</h4> ";
//					window.document.getElementById("test1").appendChild( newNode );
...
//				var newNode = window.document.createElement('div');
//				newNode.innerHTML =  "<h4>defineModule : " + module.mid +  " normal exit "  + "</h4> ";
//				window.document.getElementById("test1").appendChild( newNode );
    ...
    var using = function(mid){
        return getModule(mid).result;
    };
