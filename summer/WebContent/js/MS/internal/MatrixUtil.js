...
define(["dojo/_base/declare", "system/Type"], 
	...
	var MatrixUtil = declare("MatrixUtil", Object,{
...
//    internal static void 
	MatrixUtil.TransformRect = function(/*ref Rect*/ rect, /*ref Matrix*/ matrix)
    { 
        if (rect.IsEmpty)
        {
            return;
        ...
        /*MatrixTypes*/var matrixType = matrix._type; 
        ...
        if (matrixType == MatrixTypes.TRANSFORM_IS_UNKNOWN) 
        {
            ...
            /*Point*/var point0 = matrix.Transform(rect.TopLeft); 
            /*Point*/var point1 = matrix.Transform(rect.TopRight);
            /*Point*/var point2 = matrix.Transform(rect.BottomRight); 
            /*Point*/var point3 = matrix.Transform(rect.BottomLeft);
    ...
    /// </summary> 
//    internal static void 
    MatrixUtil.MultiplyMatrix = function(/*ref Matrix matrix1*/matrix1Ref, /*ref Matrix matrix2*/matrix2Ref)
    {
        /*MatrixTypes*/var type1 = matrix1._type;
        /*MatrixTypes*/var type2 = matrix2._type; 
        ...
        {
            // 2 additions 
        	matrix1Ref.matrix1._offsetX += matrix2._offsetX; 
        	matrix1Ref.matrix1._offsetY += matrix2._offsetY;

            // If matrix 1 wasn't unknown we added a translation
            if (type1 != MatrixTypes.TRANSFORM_IS_UNKNOWN)
            {
            	matrix1Ref.matrix1._type |= MatrixTypes.TRANSFORM_IS_TRANSLATION; 
            }
        ...
        if (type1 == MatrixTypes.TRANSFORM_IS_TRANSLATION)
        {
            ...
            var offsetX = matrix1Ref.matrix1._offsetX;
            var offsetY = matrix1Ref.matrix1._offsetY; 

            // Copy the matrix
            matrix1Ref.matrix1 = matrix2; 

            matrix1Ref.matrix1._offsetX = offsetX * matrix2._m11 + offsetY * matrix2._m21 + matrix2._offsetX;
            matrix1Ref.matrix1._offsetY = offsetX * matrix2._m12 + offsetY * matrix2._m22 + matrix2._offsetY;

            if (type2 == MatrixTypes.TRANSFORM_IS_UNKNOWN)
            { 
            	matrix1Ref.matrix1._type = MatrixTypes.TRANSFORM_IS_UNKNOWN; 
            }
            else 
            {
            	matrix1Ref.matrix1._type = MatrixTypes.TRANSFORM_IS_SCALING | MatrixTypes.TRANSFORM_IS_TRANSLATION;
            }
            return; 
        }
        ...
        { 
            case 34:  // S * S
                // 2 multiplications 
            	matrix1Ref.matrix1._m11 *= matrix2._m11;
            	matrix1Ref.matrix1._m22 *= matrix2._m22;
                return;
            ...
            case 35:  // S * S|T
            	...
            	matrix1Ref.matrix1._type = MatrixTypes.TRANSFORM_IS_TRANSLATION | MatrixTypes.TRANSFORM_IS_SCALING;
                return; 

            case 50: // S|T * S 
            	matrix1Ref.matrix1._m11 *= matrix2._m11; 
            	matrix1Ref.matrix1._m22 *= matrix2._m22;
            	matrix1Ref.matrix1._offsetX *= matrix2._m11; 
            	matrix1Ref.matrix1._offsetY *= matrix2._m22;
                return;

            case 51: // S|T * S|T 
            	matrix1Ref.matrix1._m11 *= matrix2._m11;
            	matrix1Ref.matrix1._m22 *= matrix2._m22; 
            	matrix1Ref.matrix1._offsetX = matrix2._m11 * matrix1Ref.matrix1._offsetX + matrix2._offsetX; 
            	matrix1Ref.matrix1._offsetY = matrix2._m22 * matrix1Ref.matrix1._offsetY + matrix2._offsetY;
                return; 
            case 36: // S * U
            case 52: // S|T * U
            case 66: // U * S
            case 67: // U * S|T 
            case 68: // U * U
            	matrix1Ref.matrix1 = new Matrix( 
            			matrix1Ref.matrix1._m11 * matrix2._m11 + matrix1Ref.matrix1._m12 * matrix2._m21, 
            			matrix1Ref.matrix1._m11 * matrix2._m12 + matrix1Ref.matrix1._m12 * matrix2._m22,

            			matrix1Ref.matrix1._m21 * matrix2._m11 + matrix1Ref.matrix1._m22 * matrix2._m21,
            			matrix1Ref.matrix1._m21 * matrix2._m12 + matrix1Ref.matrix1._m22 * matrix2._m22,

            			matrix1Ref.matrix1._offsetX * matrix2._m11 + matrix1Ref.matrix1._offsetY * matrix2._m21 + matrix2._offsetX, 
            			matrix1Ref.matrix1._offsetX * matrix2._m12 + matrix1Ref.matrix1._offsetY * matrix2._m22 + matrix2._offsetY);
                return; 
        }
    }; 
    ...
    /// </summary>
//    internal static void 
    MatrixUtil.PrependOffset = function( 
        /*ref Matrix matrix*/matrixRef,
        /*double*/ offsetX,
        /*double*/ offsetY)
    { 
        if (matrixRef.matrix._type == MatrixTypes.TRANSFORM_IS_IDENTITY)
        { 
        	matrixRef.matrix = new Matrix(1, 0, 0, 1, offsetX, offsetY); 
        	matrixRef.matrix._type = MatrixTypes.TRANSFORM_IS_TRANSLATION;
        } 
        else
        {
            //
        	...
        	matrixRef.matrix._offsetX += matrixRef.matrix._m11 * offsetX + matrixRef.matrix._m21 * offsetY; 
        	matrixRef.matrix._offsetY += matrixRef.matrix._m12 * offsetX + matrixRef.matrix._m22 * offsetY;
...
//            Debug.Assert(matrix._type != MatrixTypes.TRANSFORM_IS_IDENTITY);
            if (matrixRef.matrix._type != MatrixTypes.TRANSFORM_IS_UNKNOWN) 
            {
            	matrixRef.matrix._type |= MatrixTypes.TRANSFORM_IS_TRANSLATION;
            }
        } 
	...
	MatrixUtil.Type = new Type("MatrixUtil", MatrixUtil, [Object.Type]);
	return MatrixUtil;
});
