...
define(["dojo/_base/declare", "system/Type", "windows/FrameworkTemplate" ,"windows/TemplateKey"], 
		function(declare, Type, FrameworkTemplate, TemplateKey){
	var DataTemplate = declare("DataTemplate", FrameworkTemplate,{
		constructor:function(/*object*/ dataType) 
		{ 
			if(dataType !=undefined){
				/*Exception*/var ex = TemplateKey.ValidateDataType(dataType, "dataType");
				if (ex != null) 
					throw ex;
...
//      protected override void 
		...
		{ 
		    ...
		    { 
		        throw new Error('ArgumentException(SR.Get(SRID.TemplateTargetTypeMismatch, "ContentPresenter", templatedParent.GetType().Name)'); 
		    }
		},
...
//    internal override void 
	    ...
	    { 
	        throw new Error('InvalidOperationException(SR.Get(SRID.TemplateNotTargetType)');
	    } 
...
//      public object 
		...
		{ 
			...
			set:function(value) 
			{
				/*Exception*/var ex = TemplateKey.ValidateDataType(value, "value");
				if (ex != null)
					throw ex; 
...
//      public object 
		DataTemplateKey:
		{
			get:function() 
			{ 
				return (this.DataType != null) ? new DataTemplateKey(this.DataType) : null;
			} 
		},
...
//        internal override Type 
        TargetTypeInternal:
        { 
            get:function() {  return this.DefaultTargetType; }
        },
...
//        internal override object 
        DataTypeInternal: 
        { 
            get:function() {  return this.DataType; }
        },
...
//        static internal Type 
        DefaultTargetType:
        { 
            get:function() { return ContentPresenter.Type; }
        }
	});
	
	DataTemplate.Type = new Type("DataTemplate", DataTemplate, [FrameworkTemplate.Type]);
	return DataTemplate;
});

////---------------------------------------------------------------------------- 
////
//// <copyright file="DataTemplate.cs" company="Microsoft">
