...
define(["dojo/_base/declare", "system/Type"], function(declare, Type){
	var DeferredReference = declare("DeferredReference", Object,{
        ...
        /*internal abstract Type*/ GetValueType:function(){
        	
        },
	});
	
	DeferredReference.Type = new Type("DeferredReference", DeferredReference [Object.Type]);
