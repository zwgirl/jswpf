...
define(["dojo/_base/declare", "system/Type", "collections/IList"], 
	...
	var TableRowGroupCollection = declare("TableRowGroupCollection", IList,{
		constructor:function(){
		}
	});
	
	Object.defineProperties(TableRowGroupCollection.prototype,{
		  
	});
	
	Object.defineProperties(TableRowGroupCollection,{
		  
	});
	
	TableRowGroupCollection.Type = new Type("TableRowGroupCollection", TableRowGroupCollection, [IList.Type]);
