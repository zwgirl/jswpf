...
define(["dojo/_base/declare", "system/Type", "windows/FrameworkContentElement"], 
	 ...
	 /*private class*/ 
	var GetPageAsyncRequest = declare(null, {
         constructor:function(/*PageContent*/ pageContent, /*int*/ pageNumber, /*object*/ userState)
         { 
...
//    internal sealed class 
	var FixedDocumentPage =declare([DocumentPage, IServiceProvider], {
        //--------------------------------------------------------------------
        // 
        // Ctors
        // 
        ...
        constructor:function(/*FixedDocument*/ panel, /*FixedPage*/ page, /*Size*/ fixedSize, /*int*/ index) :
        {
...
//        internal FixedTextContainer 
	...
	var FixedDocument = declare("FixedDocument", 
			[FrameworkContentElement, IDocumentPaginatorSource, 
			 IAddChildInternal, IServiceProvider, IFixedNavigate, IUriContext],{
...
//        void IFixedNavigate.
        NavigateAsync:function(/*string*/ elementID)
        { 
...
//        UIElement IFixedNavigate.
        FindElementByID:function(/*string*/ elementID, /*out FixedPage rootFixedPage*/rootFixedPageOut)
        { 
        ...
        /// </summary>
        /// <exception cref="ArgumentOutOfRange">pageNumber is less than zero.</exception> 
        /// <param name="pageNumber">
        /// The page number.
        /// </param>
//        internal DocumentPage 
        GetPage:function(/*int*/ pageNumber) 
        {
...
//             Dispatcher.VerifyAccess(); 
        ...
        /// <summary>
        /// <see cref="DocumentPaginator.GetPageAsync"/> 
        /// </summary>
        /// <exception cref="ArgumentOutOfRange">pageNumber is less than zero.</exception>
        /// <exception cref="ArgumentNullException">userState is NULL.</exception>
//        internal void 
        GetPageAsync:function(/*int*/ pageNumber, /*object*/ userState) 
        {
...
//        internal int 
        GetPageNumber:function(/*ContentPosition*/ contentPosition)
        { 
//             Dispatcher.VerifyAccess();
        ...
        /// <exception cref="ArgumentNullException">userState is NULL.</exception>
//        internal void 
        CancelAsync:function(/*object*/ userState)
        { 
...
//        internal ContentPosition
        GetObjectPosition:function(/*Object*/ o)
        {
            if (o == null)
            { 
...
//             Dispatcher.VerifyAccess(); 
        ...
        /// </summary>
//        internal ContentPosition 
        GetPagePosition:function(/*DocumentPage*/ page) 
        {
...
//        internal int 
        GetIndexOfPage:function(/*FixedPage*/ p)
        { 
            PageContentCollection pc = this.Pages; 
            for (int i = 0, n = pc.Count; i < n; i++)
            { 
...
//        internal bool 
        IsValidPageIndex:function(/*int*/ index)
        {
...
//        internal FixedPage 
        SyncGetPageWithCheck:function(/*int*/ index)
        { 
...
//        internal FixedPage 
        SyncGetPage:function(/*int*/ index, /*bool*/ forceReload)
        { 
        ...
        /// </summary>
//        internal void 
        OnPageContentAppended:function(/*int*/ index) 
        { 
        ...
        // 
//        internal void 
        EnsurePageSize:function(/*FixedPage*/ fp)
        { 
...
//        internal bool 
        GetPageSize:function(/*ref Size pageSize*/pageSizeRef, /*int*/ pageNumber) 
        {
        ...
        // 
//        internal Size 
        ComputePageSize:function(/*FixedPage*/ fp)
        {
            if (fp == null)
            { 
...
//        private void 
        OnInitialized:function(/*object*/ sender, /*EventArgs*/ e)
        { 
...
//        private void 
        OnPageLoaded:function(/*object*/ sender, /*EventArgs*/ e)
        {
...
//        internal FixedPage 
        GetFixedPage:function(/*int*/ pageNumber) 
        {
            FixedPage fp = null; 
        ...
        //---------------------------------------
//        private void 
        OnHighlightChanged:function(/*object*/ sender, /*HighlightChangedEventArgs*/ args) 
        {
...
//        private object 
        GetPageAsyncDelegate:function(/*object*/ arg)
        { 
...
//        private void 
        OnGetPageRootCompleted:function(/*object*/ sender, /*GetPageRootCompletedEventArgs*/ args)
        {
...
//        private void 
        _NotifyGetPageAsyncCompleted:function(/*DocumentPage*/ page, /*int*/ pageNumber, 
	...
	Object.defineProperties(FixedDocument.prototype,{
//		internal NavigationService 
		NavigationService: 
        { 
            get:function() { return this.GetValue(NavigationService.NavigationServiceProperty); },
            set:function(value) { this.SetValue(NavigationService.NavigationServiceProperty, value); } 
        },
...
//        public DocumentPaginator 
        DocumentPaginator: 
        { 
            get:function() { return _paginator; }
        }, 
        /// <summary> 
...
//        Uri IUriContext.
        BaseUri: 
        {
            get:function() { return this.GetValue(BaseUriHelper.BaseUriProperty); },
            set:function(value) { this.SetValue(BaseUriHelper.BaseUriProperty, value); }
        },
        ...
        /// </summary> 
//        internal bool 
        IsPageCountValid: { get:function() { return this.IsInitialized; } },
 
        /// <summary>
        /// <see cref="DocumentPaginator.PageCount"/>
        /// </summary>
//        internal int 
        PageCount: { get:function() { return this.Pages.Count; } }, 
...
//        internal Size 
        PageSize: 
        {
            get:function() { return new Size(this._pageWidth, this._pageHeight); },
            set:function(value) { this._pageWidth = value.Width; this._pageHeight = value.Height; }
        }, 
...
//        public object 
        PrintTicket:
        {
            get:function()
            { 
                var printTicket = this.GetValue(PrintTicketProperty);
                return printTicket; 
            }, 
            set:function(value)
            { 
            	this.SetValue(PrintTicketProperty,value);
            }
        },
        ...
        FixedContainer: 
        {
            ...
            { 
                ...
                { 
                	...
                	this._fixedTextContainer.Highlights.Changed += new HighlightChangedEventHandler(OnHighlightChanged);
                }
                return this._fixedTextContainer; 
            }
        }, 
 
//        internal Dictionary<FixedPage, ArrayList> 
        Highlights:
        { 
            get:function()
            {
...
//        internal DocumentReference 
	...
	Object.defineProperties(FixedDocument,{
        /// <summary> 
        ///
        /// </summary>
//        public static readonly DependencyProperty 
        ...
        {
        	get:function(){
            	if(FixedDocument._PrintTicketProperty === undefined){
            		FixedDocument._PrintTicketProperty = DependencyProperty.RegisterAttached("PrintTicket", 
            				typeof(object), 
            				FixedDocument.Type, 
                            new FrameworkPropertyMetadata(null));	
            	}
            	
            	return FixedDocument._PrintTicketProperty;
        	}
        }
            	  
	});
	
//    internal static StoryFragments 
    FixedDocument.GetStoryFragments = function(FixedPage fixedPage)
    { 
        object o = null;
...
//    private static object 
    function ValidateAndLoadPartFromAbsoluteUri(/*Uri*/ AbsoluteUriDoc, /*bool*/ validateOnly, 
    		/*string*/ rootElement, /*out ContentType mimeType*/mimeTypeOut) 
    { 
        mimeType = null;
    ...
    /// </SecurityNote> 
//    static private Uri 
    FixedDocument.GetStructureUriFromRelationship = function(/*Uri*/ contentUri, /*string*/ relationshipName) 
    { 
...
//	static FixedDocument()
	FixedDocument.Init = function()
    { 
        FocusableProperty.OverrideMetadata(FixedDocument.Type, new FrameworkPropertyMetadata(true));
	...
	FixedDocument.Type = new Type("FixedDocument", FixedDocument, 
			[FrameworkContentElement.Type, IDocumentPaginatorSource.Type, 
			 IAddChildInternal.Type, IServiceProvider.Type, IFixedNavigate.Type, IUriContext.Type]);
