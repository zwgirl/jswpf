...
define(["dojo/_base/declare", "system/Type", "data/BindingExpressionBase"], 
		function(declare, Type, BindingExpressionBase){
	var PriorityBindingExpression = declare("PriorityBindingExpression", BindingExpressionBase,{
		constructor:function( ){

		}
	});
	
	Object.defineProperties(PriorityBindingExpression.prototype,{

	});
	
	PriorityBindingExpression.Type = new Type("PriorityBindingExpression", PriorityBindingExpression, [BindingExpressionBase.Type]);
	return PriorityBindingExpression;
});
