...
define(["dojo/_base/declare", "system/Type",
        "data/BindingExpressionBase", "data/MultiBinding", "internal.data/IDataBindEngineClient"], 
        function(declare, Type,
        		BindingExpressionBase, MultiBinding, IDataBindEngineClient){
	var MultiBindingExpression = declare("MultiBindingExpression", [BindingExpressionBase, IDataBindEngineClient],{
		constructor:function( ){

		}
	});
	
	Object.defineProperties(MultiBindingExpression.prototype,{

	});
	
	MultiBindingExpression.Type = new Type("MultiBindingExpression", MultiBindingExpression, 
			[BindingExpressionBase.Type, IDataBindEngineClient.Type]);
