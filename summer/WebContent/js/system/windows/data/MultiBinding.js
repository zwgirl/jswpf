...
define(["dojo/_base/declare", "system/Type", "data/BindingBase"], function(declare, Type, BindingBase){
	var MultiBinding = declare("MultiBinding", BindingBase, {
		constructor:function( ){

		}
	});
	
	Object.defineProperties(MultiBinding.prototype,{

	});
	
	MultiBinding.Type = new Type("MultiBinding", MultiBinding, [BindingBase.Type]);
	return MultiBinding;
});

////---------------------------------------------------------------------------- 
////
//// <copyright file="MultiBinding.cs" company="Microsoft">
