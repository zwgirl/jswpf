...
define(["dojo/_base/declare", "system/Type"], 
	...
	var _themeStyleCache = [];
	var SystemResources = declare("SystemResources", Object,{
	});
...
//    internal static object 
	SystemResources.FindThemeStyle = function(/*DependencyObjectType*/ key) 
    {
//		// Find a cached theme style 
//        /*object*/var resource = _themeStyleCache[key]; 
//        if (resource != null)
//        { 
...
//        return resource; 
    ...
    //[CodeAnalysis("AptcaMethodsShouldOnlyCallAptcaMethods")] //Tracking Bug: 29647
//    internal static object 
//    SystemResources.FindResourceInternal = function(/*object*/ key) 
//    {
//        // Call Forwarded 
...
//    internal static object 
    SystemResources.FindResourceInternal = function(/*object*/ key, /*bool*/ allowDeferredResourceReference, 
    		/*bool*/ mustReturnDeferredResourceReference)
    {
//    	if(allowDeferredResourceReference === undefined){
//    		allowDeferredResourceReference = false;
//    	}
//    	
//    	if(mustReturnDeferredResourceReference === undefined){
...
//
//        var resource = null; 
//        /*Type*/var typeKey = null; 
//        /*ResourceKey*/var resourceKey = null;
//
...
//        typeKey = key instanceof Type ? key : null; 
//        resourceKey = (typeKey == null) ? (key instanceof ResourceKey ? key : null) : null;
//
////        if (isTraceEnabled) 
////        {
...
//        }
//
//        var resourceRef = {"resource" : resource};
//        var result = FindCachedResource(key, /*ref resource*/resourceRef, mustReturnDeferredResourceReference);
...
////            {
//                var canCache = true; 
//                /*SystemResourceKey*/var sysKey = (resourceKey != null) ? (resourceKey instanceof SystemResourceKey ? resourceKey : null) : null;
//                if (sysKey != null)
//                {
...
//                    resource = FindDictionaryResource(key, typeKey, resourceKey, isTraceEnabled, allowDeferredResourceReference, 
//                    		mustReturnDeferredResourceReference, /*out canCache*/canCacheOut);
...
//    internal static void 
    SystemResources.CacheResource = function(/*object*/ key, /*object*/ resource, /*bool*/ isTraceEnabled) 
    { 
...
//    private static bool 
    function FindCachedResource(/*object*/ key, /*ref object resource*/resourceRef, /*bool*/ mustReturnDeferredResourceReference)
    { 
        // reading the cache is lock free

    	resourceRef.resource = _resourceCache[key];
        /*bool*/var found = (resource != null); 
        ...
        {
            /*DispatcherObject*/var dispatcherObject = resource instanceof DispatcherObject ? resource : null; 
	...
	SystemResources.Type = new Type("SystemResources", SystemResources, [Object.Type]);
