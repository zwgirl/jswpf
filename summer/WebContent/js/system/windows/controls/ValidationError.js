...
define(["dojo/_base/declare", "system/Type", "controls/ValidationRule"], 
		function(declare, Type, ValidationRule){
	var ValidationError = declare("ValidationError", null,{
		constructor:function( /*ValidationRule*/ ruleInError, /*object*/ bindingInError, /*object*/ errorContent, /*Exception*/ exception)
        {
            if (ruleInError == null)
                throw new Error('ArgumentNullException("ruleInError")'); 
            if (bindingInError == null)
                throw new Error('ArgumentNullException("bindingInError")'); 
	...
	ValidationError.Type = new Type("ValidationError", ValidationError, Object.Type);
