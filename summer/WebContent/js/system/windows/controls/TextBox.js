...
define(["dojo/_base/declare", "system/Type", "primitives/TextBoxBase", "markup/IAddChild", 
        "data/UpdateSourceTrigger"], 
		function(declare, Type, TextBoxBase, IAddChild,
				UpdateSourceTrigger){
	var TextBox = declare("TextBox", [TextBoxBase, IAddChild],{
		...
		AddEventListeners:function(){
			...
			this._dom.addEventListener("input", function(event){
				this._source.Text = event.target.value;
			});
			
//			this._dom.addEventListener("keydown",
//				function(event) {
//	            if (event.which == 9) {  
//	            	event.which=0;
...
//			});
		...
		Focus:function(){
			if(TextBoxBase.prototype.Focus.call(this)){
//				console.log("textBox setfocus");
				this._dom.focus();
			}
		},
...
//	    protected /*override*/ void 
	    ...
	    { 
			TextBoxBase.prototype.OnMouseDown.call(this, e); 
...
//        protected override Size 
        ...
        { 
        	TextBoxBase.prototype.MeasureOverride.call(this);
        	this._dom.setAttribute("value", this.Text);
        },
...
//        private void 
		OnTextPropertyChanged:function(/*string*/ oldText, /*string*/ newText)
        { 
			this._dom.setAttribute("value", newText); 
...
//            } 
	...
	Object.defineProperties(TextBox.prototype,{
        /// <summary> 
...
//        public string 
		Text:
        {
            get:function() { return this.GetValue(TextBox.TextProperty); }, 
            set:function(value) { this.SetValue(TextBox.TextProperty, value); }
        }   
	});
...
//        public static readonly DependencyProperty 
        ...
        {
        	get:function(){
        		if(TextBox._TextProperty === undefined){
        			TextBox._TextProperty  = 
                        DependencyProperty.Register(
                                "Text", // Property name
                                String.Type, // Property type
                                TextBox.Type, // Property owner 
                                ...
                                FrameworkPropertyMetadata.Build5(
                                		// Property metadata
                                		String.Empty, // default value 
                                        FrameworkPropertyMetadataOptions.BindsTwoWayByDefault | // Flags 
                                            FrameworkPropertyMetadataOptions.Journal,
                                        new PropertyChangedCallback(null, OnTextPropertyChanged),    // property changed callback 
...
//
//        if (d._isInsideTextContentChange)
//        {
//            // Ignore property changes that originate from OnTextContainerChanged, 
//            // unless they contain a different value (indicating that a
//            // re-entrant call changed the value) 
...
//        }
        ...
        d.OnTextPropertyChanged(e.OldValue, e.NewValue);
    }
...
//	private static object 
	...
	TextBox.Type = new Type("TextBox", TextBox, [TextBoxBase.Type, IAddChild.Type]);
	return TextBox;
});
