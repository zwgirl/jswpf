...
define(["dojo/_base/declare", "system/Type", "controls/ModelTreeEnumerator"], function(declare, Type, ModelTreeEnumerator){
	var HeaderedItemsModelTreeEnumerator = declare("HeaderedItemsModelTreeEnumerator", ModelTreeEnumerator,{
		...
		constructor:function(/*HeaderedItemsControl*/ headeredItemsControl, /*IEnumerator*/ items, /*object*/ header) 
        {
//			 : base(header)
...
//        protected override bool 
	...
	HeaderedItemsModelTreeEnumerator.Type = new Type("HeaderedItemsModelTreeEnumerator", 
			HeaderedItemsModelTreeEnumerator, [ModelTreeEnumerator.Type]);
