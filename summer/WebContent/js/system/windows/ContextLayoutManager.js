...
define(["dojo/_base/declare", "system/Type"/*, "threading/DispatcherObject"*/], 
	...
	var ContextLayoutManager = declare("ContextLayoutManager", Object/*DispatcherObject*/,{
		constructor:function(){
		}
	});
	
	Object.defineProperties(ContextLayoutManager.prototype,{
		  
	});
	
	Object.defineProperties(ContextLayoutManager,{
//	    internal static int 
		s_LayoutRecursionLimit:
		{
			get:function(){
				return 4096; //UIElement.MAX_ELEMENTS_IN_ROUTE; //to keep these two constants in [....] 
			}
		} 
		  
	});
	
	ContextLayoutManager.Type = new Type("ContextLayoutManager", ContextLayoutManager, [/*DispatcherObject*/Object.Type]);
