...
define(["dojo/_base/declare", "system/Type",
        "windows/DependencyObject"/*, "windows/FrameworkElement"*/,
        "windows/TriggerCondition", "windows/PropertyValue", "windows/PropertyValueType", "windows/StyleHelper",
        "windows/DynamicResourceExtension", "utility/FrugalStructList", "internal/InheritanceContextHelper"], 
        function(declare, Type,
        		DependencyObject/*, FrameworkElement*/,
        		TriggerCondition, PropertyValue, PropertyValueType, StyleHelper,
        		DynamicResourceExtension, FrugalStructList, InheritanceContextHelper){
	...
	var TriggerBase = declare("TriggerBase", DependencyObject, {
...
//        internal override void 
        Seal:function()
        {
            ...
            for (var i = 0; i < this.PropertyValues.Count; i++)
            {
                ...
                /*DependencyProperty*/
            	var dependent = propertyValue.Property; 
...
//        internal void 
        ProcessSettersCollection:function(/*SetterBaseCollection*/ setters)
        {
            ...
            if( setters != null ) 
            {
                ...
                {
                    /*Setter*/var setter = setters.Get(i);
                    if( setter != null )
                    { 
                        /*DependencyProperty*/
                    	var dp = setter.Property;
                        /*object*/
                    	var value = setter.ValueInternal; 
                        /*string*/
                    	var target = setter.TargetName; 
                        ...
                        var dynamicResource = value instanceof DynamicResourceExtension ? value : null;
        ...
        PropertyValues:
        {
        	get:function(){
	        	if(this._PropertyValues === undefined){
	        		this._PropertyValues = new FrugalStructList(); 
	        	}
