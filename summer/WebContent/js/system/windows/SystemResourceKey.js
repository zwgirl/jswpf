...
define(["dojo/_base/declare", "system/Type", "windows/ResourceKey"], 
    ...
    //
//    private const short 
	var SystemResourceKeyIDStart = SystemResourceKeyID.InternalSystemColorsStart; 
//    private const short 
	var SystemResourceKeyIDEnd = SystemResourceKeyID.InternalSystemThemeStylesEnd; 

    // 
    // This is the enum range representing the extended SystemResource[Key]s.
    //
//    private const short 
	var SystemResourceKeyIDExtendedStart = SystemResourceKeyID.InternalSystemColorsExtendedStart;
//    private const short 
	var SystemResourceKeyIDExtendedEnd = SystemResourceKeyID.InternalSystemColorsExtendedEnd; 

    // 
    // This is the BAML id range representing the original SystemResourceKeys. 
    //
//    private const short 
	var SystemResourceKeyBAMLIDStart = SystemResourceKeyIDStart; 
//    private const short 
	var SystemResourceKeyBAMLIDEnd = SystemResourceKeyIDEnd;

    //
    // This is the BAML id range representing the original SystemResources. 
    //
//    private const short 
	var SystemResourceBAMLIDStart = SystemResourceKeyBAMLIDEnd; 
//    private const short 
	var SystemResourceBAMLIDEnd = (SystemResourceBAMLIDStart + (SystemResourceKeyBAMLIDEnd - SystemResourceKeyBAMLIDStart)); 

    // 
    // This is the BAML id range representing the extended SystemResourceKeys.
    //
//    private const short 
	var SystemResourceKeyBAMLIDExtendedStart = SystemResourceBAMLIDEnd;
//    private const short 
	var SystemResourceKeyBAMLIDExtendedEnd = (SystemResourceKeyBAMLIDExtendedStart + (SystemResourceKeyIDExtendedEnd - SystemResourceKeyIDExtendedStart)); 

    // 
    // This is the BAML id range representing the extended SystemResources. 
    //
//    private const short 
    var SystemResourceBAMLIDExtendedStart = SystemResourceKeyBAMLIDExtendedEnd; 
//    private const short 
    var SystemResourceBAMLIDExtendedEnd = (SystemResourceBAMLIDExtendedStart + (SystemResourceKeyBAMLIDExtendedEnd - SystemResourceKeyBAMLIDExtendedStart));

	var SystemResourceKey = declare("SystemResourceKey", ResourceKey,{
...
//        internal 
		constructor:function(/*SystemResourceKeyID*/ id)
        { 
...
//                String.Format("Invalid SystemResourceKeyID (id={0})", id));
            this._id = id; 
        },
...
//        public override bool 
        ...
        {
            /*SystemResourceKey*/var key = o instanceof SystemResourceKey ? o :null; 
...
//        public override string 
	...
	Object.defineProperties(SystemResourceKey.prototype,{
//        internal object 
		Resource:
        { 
            get:function()
...
//        public override Assembly 
	...
	Object.defineProperties(SystemResourceKey,{
//	      internal static ComponentResourceKey 
...
//	internal static short 
	SystemResourceKey.GetSystemResourceKeyIdFromBamlId = function(/*short*/ bamlId, /*out bool isKey*/isKeyOut) 
    {
        isKey = true; 
...
//    internal static short 
    SystemResourceKey.GetBamlIdBasedOnSystemResourceKeyId = function(/*Type*/ targetType, /*string*/ memberName)
    { 
        var memberId = 0;
        var srkField = null; 
        var isKey = false; 
        ...
        var srkId = SystemResourceKeyID.InternalSystemColorsStart;

        if (memberName.EndsWith("Key", false, TypeConverterHelper.InvariantEnglishUS)) 
        {
            srkField = memberName.Remove(memberName.Length - 3); 

            if ((KnownTypes.Types[KnownElements.MenuItem] == targetType) ||
                (KnownTypes.Types[KnownElements.ToolBar] == targetType) || 
                (KnownTypes.Types[KnownElements.StatusBar] == targetType))
            {
        ...
        try 
        {
            srkId = Enum.Parse(typeof(SystemResourceKeyID), srkField); 
        } 
        ...
        if (found) 
        {
            var isExtended = (srkId > SystemResourceKeyIDExtendedStart && 
...
//    internal static ResourceKey 
    SystemResourceKey.GetResourceKey = function(/*short*/ id) 
    { 
        switch (id)
        { 
            case SystemResourceKeyID.ActiveBorderBrush:
...
//    internal static ResourceKey 
    SystemResourceKey.GetSystemResourceKey = function(/*string*/ keyName)
    {
        switch (keyName) 
        {
...
//    internal static object 
    SystemResourceKey.GetResource = function(/*short*/ id) 
    {
        var keyId = id; 
        if (_srk == null)
        {
	...
	SystemResourceKey.Type = new Type("SystemResourceKey", SystemResourceKey, [ResourceKey.Type]);
