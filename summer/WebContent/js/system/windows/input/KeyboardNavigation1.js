...
define(["dojo/_base/declare", "system/Type", "windows/DependencyProperty", "windows/FrameworkPropertyMetadata",
        /*"documents/Adorner",*/ "input/Key", "input/KeyboardNavigationMode"], 
		function(declare, Type, DependencyProperty, FrameworkPropertyMetadata,
				/*Adorner,*/ Key, KeyboardNavigationMode){
...
//        private DependencyObject 
        ...
        {
            return this._navigationProperty == KeyboardNavigation.ControlTabNavigationProperty ? GetControlTabOnceActiveElement(d) : GetTabOnceActiveElement(d); 
        }, 
...
//        private void 
        ShowFocusVisual:function(/*DependencyObject*/ element) 
        {
            ...
            if (!this.IsKeyboardMostRecentInputDevice())
            {
            	this.EnableKeyboardCues(element, false);
            } 

            // Show focus visual if system metric is true or keyboard is used last 
            if (this.AlwaysShowFocusVisual || this.IsKeyboardMostRecentInputDevice()) 
            {
        ...
        Navigate:function(/*DependencyObject*/ currentElement, /*TraversalRequest*/ request, /*ModifierKeys*/ modifierKeys, /*DependencyObject*/ firstElement)
        {
            ...
            { 
                ...
                case FocusNavigationDirection.Previous: 
                    _navigationProperty = (modifierKeys & ModifierKeys.Control) == ModifierKeys.Control ? KeyboardNavigation.ControlTabNavigationProperty : KeyboardNavigation.TabNavigationProperty; 
                ...
                case FocusNavigationDirection.Down: 
                    _navigationProperty = KeyboardNavigation.DirectionalNavigationProperty; 
            ...
            if (nextTab == null) 
            {
                ...
                var navigatedOutside = NavigateOutsidePresentationSource(currentElement, request);
                if (navigatedOutside)
                { 
                    return true;
                } 
...
//        private bool 
        ...
        { 
            ...
            if (visual == null)
            { 
                visual = GetParentUIElementFromContentElement(currentElement instanceof ContentElement ? currentElement : null);
                if (visual == null)
                    return false;
            } 
...
//        private DependencyObject 
        ...
        { 
            ...
            /*DependencyObject*/var result = FindElementAtViewportEdge(sourceElement, 
                viewportBoundsElement,
                container,
                direction,
                treeViewNavigation); 
...
//        private DependencyObject 
        ...
        {
            /*DependencyObject*/var parent = GetParent(e);
...
//        private DependencyObject 
        ...
        { 
            ...
            /*DependencyObject*/var focusedElement = FocusedElement(e);
            if (focusedElement != null)
                return focusedElement; 
...
*/ 
                ...
                { 
                    ...
                    for (var i = 0; i < count; i++)
                    {
                        ...
                        {
                            /*DependencyObject*/var firstChild = GetFirstChild(visual); 
                            if (firstChild != null)
                                return firstChild;
                        }
                    } 
...
//                }
                ...
                if (elementAsVisual != null)
                {
                    ...
                    for (var i = count - 1; i >= 0; i--) 
                    {
                        ...
                        {
                            /*DependencyObject*/var lastChild = GetLastChild(visual);
                            if (lastChild != null)
                                return lastChild; 
                        }
                    } 
...
//            Debug.Assert(container != null, "container should not be null"); 
            ...
            do 
            { 
                /*DependencyObject*/var sibling = GetNextSibling(parent);
                if (sibling != null) 
                    return sibling;
...
//        private DependencyObject 
        ...
        { 
            ...
            /*DependencyObject*/var result = GetPreviousSibling(e);
...
//        private bool 
        IsTabStop:function(/*DependencyObject*/ e) 
        {
            ...
            if (fe != null)
                return
                    (fe.Focusable
                    && fe.GetValue(IsTabStopProperty)) 
                    && fe.IsEnabled
                    && fe.IsVisible; 
 
            /*FrameworkContentElement*/var fce = e instanceof FrameworkContentElement ? e : null;
            return fce != null && fce.Focusable && fce.GetValue(IsTabStopProperty) && fce.IsEnabled; 
        },
...
//        private static int 
        GetTabIndexHelper:function(/*DependencyObject*/ d)
        { 
...
//        internal DependencyObject 
        GetFirstTabInGroup:function(/*DependencyObject*/ container) 
        {
            ...
            var minIndexFirstTab = Int32.MinValue;
...
//        private DependencyObject 
        ...
        { 
            ...
            /*DependencyObject*/var nextTabElement = GetNextTabWithSameIndex(e, container);
...
//            Debug.Assert(container != null, "container should not be null");
            ...
            if (e == null) 
            {
                ...
                /*DependencyObject*/var activeElement = GetActiveElement(container); 
...
//                Debug.Assert(IsTabStopOrGroup(nextTabElement), "nextTabElement should be IsTabStop or group");
                ...
                /*DependencyObject*/var firstTabElementInside = GetNextTab(null, nextTabElement, true);
...
//        internal DependencyObject 
        GetLastTabInGroup:function(/*DependencyObject*/ container) 
        {
            ...
            var maxIndexFirstTab = Int32.MaxValue;
            /*DependencyObject*/var currElement = GetLastInTree(container); 
...
//        private DependencyObject 
        ...
        { 
            var elementTabPriority = GetTabIndexHelper(e); 
            /*DependencyObject*/var currElement = GetPreviousInTree(e, container);
...
//            Debug.Assert(e != null || container != null, "e or container should not be null"); 
            ...
            /*KeyboardNavigationMode*/var tabbingType = GetKeyNavigationMode(container);
            ...
            { 
                ...
                else
                {
                    ...
                    if (tabbingType == KeyboardNavigationMode.Once) 
                    { 
                    	/*DependencyObject*/var firstTabElement = GetNextTabInGroup(null, container, tabbingType);
...
//        private bool 
        ...
        { 
            /*Visual*/var sourceVisual = sourceElement instanceof Visual ? sourceVisual : null;
...
//        private DependencyObject 
        ...
        { 
            _containerHashtable.Clear();
            /*DependencyObject*/var targetElement = MoveNext(sourceElement, null, direction, BASELINE_DEFAULT, BASELINE_DEFAULT, treeViewNavigation);
            ...
            if (targetElement != null) 
            {
                ...
                if (targetUIElement == null)
                    targetUIElement = GetParentUIElementFromContentElement(targetElement instanceof ContentElement ? targetElement : null); 
                else
                {
...
//        private void 
        ...
        { 
            ...
            if (sender instanceof UIElement)
            	sender.RemoveHandler(Keyboard.PreviewLostKeyboardFocusEvent, new KeyboardFocusChangedEventHandler(_LostFocus));
...
//        private bool 
        ...
        { 
            ...
            /*Hashtable*/
            var elementTable = _containerHashtable[container];
            ...
            elementTable[elementObject] = true;
            return false; 
        },
            ...
            /*bool*/ treeViewNavigation) 
        {
            ...
            { 
                    ...
                    (treeViewNavigation && IsFocusableInternal(currElement)))) 
                {
                    ...
                    var currentRect = GetRectangle(currentRectElement); 

                    // Consider the current element as a result candidate only if its layout is valid. 
                    if (currentRect != Rect.Empty)
                    {
                    	var isInDirection = IsInDirection(sourceRect, currentRect, direction);
                    	var isInRange = IsInRange(sourceElement, currElement, sourceRect, currentRect, direction, startRange, endRange); 
                        if (searchInsideContainer || isInDirection || isInRange)
                        { 
                        	var score = isInRange ? GetPerpDistance(sourceRect, currentRect, direction) : GetDistance(sourceRect, currentRect, direction); 
...
//                Debug.Assert(container != null, "container cannot be null");
            ...
            /*KeyboardNavigationMode*/var mode = GetKeyNavigationMode(container);
            var searchInsideContainer = (sourceElement == null);
            ...
            var sourceRect = GetRectangle(searchInsideContainer ? container 
            ...
            /*DependencyObject*/var result = FindNextInDirection(sourceElement, sourceRect, container, direction, startRange, endRange, treeViewNavigation);
            ...
            // Using ActiveElement if set 
            /*DependencyObject*/var activeElement = GetActiveElementChain(result, treeViewNavigation); 
            if (activeElement != null)
                return activeElement; 

            // Try to find focus inside the element
            // result is not TabStop, which means it is a group
            /*DependencyObject*/var insideElement = MoveNext(null, result, direction, startRange, endRange, treeViewNavigation); 
        ...
        ProcessForMenuMode:function(/*InputEventArgs*/ inputEventArgs)
        {
            ...
            { 
                ...
                { 
                    ...
                    {
                        EnableKeyboardCues(keyEventArgs.Source instanceof DependencyObject ? keyEventArgs.Source : null, true); 
...
//     private static UIElement 
     function GetParentUIElementFromContentElement(/*ContentElement*/ ce, /*ref IContentHost ichParent*/ichParentRef) 
     { 
         if (ce == null)
             return null; 
...
//     internal static Rect 
     ...
     { 
         ...
         else
         {
             ...
             {
                 /*IContentHost*/var parentICH = null; 
                 /*UIElement*/var parentUIElement = GetParentUIElementFromContentElement(ce, /*ref*/ parentICH); 
...
//     internal static void 
     ...
     { 
         ...
         if (visual == null)
         { 
             visual = GetParentUIElementFromContentElement(element instanceof ContentElement ? element : null);
             if (visual == null)
                 return;
         } 
