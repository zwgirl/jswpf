...
//    internal static Rect 
	var s_Rect = Rect.Empty;
	
    // Squared
//    private const UInt32 
	var c_squaredSegmentCount = 4;
//    private const UInt32 
	var c_squaredPointCount = 5; 
	
    // Rouneded
//    static private UInt32 
	var c_roundedSegmentCount = 8; 
//    static private UInt32 
	var c_roundedPointCount = 17; 
    
	var RectangleGeometry = declare("RectangleGeometry", Geometry,{
		constructor:function(){
			if(arguments.length == 1){
				 this.Rect = arguments[0];
...
//        internal override bool
        ...
        { 
            ...
            var pointCount = GetPointCount(rect, radiusX, radiusY);
            var segmentCount = GetSegmentCount(rect, radiusX, radiusY);
...
//        internal override PathFigureCollection 
        GetTransformedFigureCollection:function(/*Transform*/ transform) 
        {
            ...
            {
                /*Point[]*/var points = GetPointList(rect, radiusX, radiusY);
...
//        internal static bool 
        IsRounded:function(/*double*/ radiusX, /*double*/ radiusY) 
        {
...
//            return data; 
        ...
        /// </SecurityNote> 
//        private Point[] 
        GetPointList:function(/*Rect*/ rect, /*double*/ radiusX, /*double*/ radiusY) 
        { 
...
//        public double 
		RadiusX: 
        {
            get:function()
            {
                return (double) GetValue(RectangleGeometry.RadiusXProperty); 
            },
            set:function(value) 
            { 
            	this.SetValueInternal(RectangleGeometry.RadiusXProperty, value);
            } 
        },
...
//        public double 
        ...
        { 
            ...
            set:function(value)
            { 
            	this.SetValueInternal(RectangleGeometry.RadiusYProperty, value);
            } 
        }, 
...
//        public Rect 
        ...
        { 
            ...
            set:function(value) 
            {
            	this.SetValueInternal(RectangleGeometry.RectProperty, value);
            }
        }, 
...
//        public override bool 
	...
	Object.defineProperties(RectangleGeometry,{
...
//        RectangleGeometry target = ((RectangleGeometry) d);
        d.PropertyChanged(RectangleGeometry.RadiusXProperty); 
    }
//    private static void 
    function RadiusYPropertyChanged(/*DependencyObject*/ d, /*DependencyPropertyChangedEventArgs*/ e) 
    { 
//        RectangleGeometry target = ((RectangleGeometry) d);
        d.PropertyChanged(RectangleGeometry.RadiusYProperty);
    }
//    private static void 
    function RectPropertyChanged(/*DependencyObject*/ d, /*DependencyPropertyChangedEventArgs*/ e) 
    {
//        RectangleGeometry target = ((RectangleGeometry) d); 
        d.PropertyChanged(RectangleGeometry.RectProperty); 
    }
  ...
  /// <SecurityNote>
    ...
    /// </SecurityNote>
//    internal static Rect 
    GetBoundsHelper = function(/*Pen*/ pen, /*Matrix*/ worldMatrix, /*Rect*/ rect, /*double*/ radiusX, /*double*/ radiusY, 
...
//    private unsafe static void 
    function GetPointList(/*Point **/ points, /*uint*/ pointsCount, /*Rect*/ rect, /*double*/ radiusX, /*double*/ radiusY)
    { 
        if (IsRounded(radiusX, radiusY))
        {
...
//    private static byte[] 
    function GetTypeList(/*Rect*/ rect, /*double*/ radiusX, /*double*/ radiusY)
    { 
        if (rect.IsEmpty) 
        {
            return null; 
...
//    private uint 
    function GetPointCount(/*Rect*/ rect, /*double*/ radiusX, /*double*/ radiusY)
    { 
        if (rect.IsEmpty)
        { 
            return 0; 
...
//    private uint 
    function GetSegmentCount(/*Rect*/ rect, /*double*/ radiusX, /*double*/ radiusY)
    {
        if (rect.IsEmpty)
        { 
            return 0;
...
//    private static void 
    function GetCounts(/*Rect*/ rect, /*double*/ radiusX, /*double*/ radiusY, /*out uint pointCount*/pointCountOut, 
    		/*out uint segmentCount*/segmentCountOut)
    { 
        if (rect.IsEmpty)
        {
            pointCount = 0;
...
//    static private byte 
    var smoothBezier = MILCoreSegFlags.SegTypeBezier | 
    	MILCoreSegFlags.SegIsCurved   |
    	MILCoreSegFlags.SegSmoothJoin;

//	static private byte 
    var smoothLine = MILCoreSegFlags.SegTypeLine | MILCoreSegFlags.SegSmoothJoin; 
...
//	private static readonly byte[] 
	var s_squaredPathTypes = [ 
			MILCoreSegFlags.SegTypeLine | MILCoreSegFlags.SegClosed, 
			MILCoreSegFlags.SegTypeLine,
			MILCoreSegFlags.SegTypeLine, 
			MILCoreSegFlags.SegTypeLine
	];
        ...
        RectangleGeometry.RectProperty = 
              RegisterProperty("Rect",
            		  Number.Type,
       					RectangleGeometry.Type,
       					Rect.Empty, 
                        new PropertyChangedCallback(null, RectPropertyChanged),
                        null, 
                       /* isIndependentlyAnimated  = */ true, 
                       /* coerceValueCallback */ null);
    } 
	
	RectangleGeometry.Type = new Type("RectangleGeometry", RectangleGeometry, [Geometry.Type]);
	Initialize();
