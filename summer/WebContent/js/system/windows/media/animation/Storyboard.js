...
//    }
	...
	var Storyboard = declare("Storyboard", null,{
...
//	    { 
//	    	if(throwIfNull === undefined){
//	    		throwIfNull = true;
//	    	}
//	    	
//	    	if(operation === undefined){
//	    		operation = InteractiveOperation.Unknown;
//	    	}
//	    	
//	        Clock clock = null;
...
//	    } 
	...
	Object.defineProperties(Storyboard.prototype, {
	});
	
	Object.defineProperties(Storyboard, {
	    /// <summary>
...
//	    public static readonly DependencyProperty 
	    ...
	    {
	    	get:function(){
	    		if(Storyboard._TargetProperty === undefined){
	    			 /*PropertyMetadata*/var targetPropertyMetadata = new PropertyMetadata(); 
	    		        targetPropertyMetadata.FreezeValueCallback = this.TargetFreezeValueCallback; 
	    		
	    		        Storyboard._TargetProperty = DependencyProperty.RegisterAttached("Target", 
	    		        		DependencyObject.Type, Storyboard.Type, targetPropertyMetadata); 
	    		}
	    		
	    		return Storyboard._TargetProperty;
	    	}
	    ...
	    /// </remarks> 
//	    private static readonly UncommonField<HybridDictionary> 
	    StoryboardClockTreesField:
	    {
	    	get:function(){
	    		if(Storyboard._StoryboardClockTreesField === undefined){
	    			Storyboard._StoryboardClockTreesField = new UncommonField();
	    		}
	    		
	    		return Storyboard._StoryboardClockTreesField;
	    	}
	    },
...
//	    private static readonly UncommonField<FrugalMap> 
	    ComplexPathCloneField:
	    {
	    	get:function(){
	    		if(Storyboard._ComplexPathCloneField === undefined){
	    			Storyboard._ComplexPathCloneField = new UncommonField();
	    		}
	    		
	    		return Storyboard._ComplexPathCloneField;
	    	}
	    },
...
//	    public static readonly DependencyProperty 
	    ...
	    {
	    	get:function(){
	    		if(Storyboard._TargetNameProperty === undefined){
	    			Storyboard._TargetNameProperty =
	    		        DependencyProperty.RegisterAttached("TargetName", String.Type, Storyboard.Type); 
	    		}
	    		
	    		return Storyboard._TargetNameProperty;
	    	}
	    }, 
...
//	    public static readonly DependencyProperty 
	    ...
	    {
	    	get:function(){
	    		if(Storyboard._TargetPropertyProperty === undefined){
	    			Storyboard._TargetPropertyProperty =
	    		        DependencyProperty.RegisterAttached("TargetProperty", String.Type, Storyboard.Type); 
	    		}
	    		
	    		return Storyboard._TargetPropertyProperty;
	    	}
	    }, 
	});
...
//    /// </summary> 
////    public static void 
//    Storyboard.SetTarget = function(/*DependencyObject*/ element, /*DependencyObject*/ value)
//    {
...
//    Storyboard.GetTarget = function(/*DependencyObject*/ element) 
//    {
//        if (element == null) { throw new ArgumentNullException("element"); } 
...
//    private static bool 
    function TargetFreezeValueCallback( 
        /*DependencyObject*/ d,
        /*DependencyProperty*/ dp, 
...
//    /// </summary> 
////    public static void 
//    Storyboard.SetTargetName = function(/*DependencyObject*/ element, /*String*/ name)
//    { 
//        if (element == null) { throw new ArgumentNullException("element"); } 
...
//    Storyboard.GetTargetName = function(/*DependencyObject*/ element) 
//    { 
//        if (element == null) { throw new ArgumentNullException("element"); }
...
//    /// </summary> 
////    public static void 
//    Storyboard.SetTargetProperty = function(/*DependencyObject*/ element, /*PropertyPath*/ path)
//    { 
//        if (element == null) { throw new ArgumentNullException("element"); }
...
//    /// </summary>
////    public static PropertyPath 
//    Storyboard.GetTargetProperty = function(/*DependencyObject*/ element) 
//    {
//        if (element == null) { throw new ArgumentNullException("element"); }
...
//    internal static DependencyObject 
    Storyboard.ResolveTargetName = function( 
        /*string*/ targetName,
        /*INameScope*/ nameScope, 
        /*DependencyObject*/ element ) 
    {
//        /*object*/ var          nameScopeUsed = null; 
//        /*object*/ var          namedObject = null;
//        /*DependencyObject*/var targetObject = null;
//        /*FrameworkElement*/var fe = element instanceof FrameworkElement ? element : null;
//        /*FrameworkContentElement*/var fce = element instanceof FrameworkContentElement ? element : null; 
//
//        if( fe != null ) 
//        { 
//            if( nameScope != null )
//            { 
//                namedObject = nameScope.FindName(targetName, fe);
...
//        }
// 
//        targetObject = namedObject instanceof DependencyObject ? namedObject : null;
//        if( targetObject == null )
//        {
...
//        return targetObject; 
    ...
    /// Template.FindName().
    /// </remarks> 
//    internal static BeginStoryboard 
    Storyboard.ResolveBeginStoryboardName = function( 
        /*string*/ targetName,
        /*INameScope*/ nameScope, 
        /*FrameworkElement*/ fe,
    ...
    {
//        /*object*/var          namedObject = null; 
//        /*BeginStoryboard*/var beginStoryboard = null;
// 
//        if( nameScope != null ) 
//        {
...
//        }
//
//        beginStoryboard = namedObject instanceof BeginStoryboard ? namedObject : null; 
//
...
//        return beginStoryboard;
    ...
    /// </summary> 
//    private static void 
    function ApplyMediaClock( /*INameScope*/ nameScope, /*DependencyObject*/ containingObject, 
...
//            /*DependencyObject*/var mentor = Helper.FindMentor(containingObject); 
//            targetMediaElement = ResolveTargetName(currentObjectName, nameScope, mentor );
//            targetMediaElement = targetMediaElement instanceof MediaElement ? targetMediaElement : null; 
//
...
//        { 
//            targetMediaElement = currentObject instanceof MediaElement ? currentObject : null; 
//        }
//        else 
//        {
//            targetMediaElement = containingObject instanceof MediaElement ? containingObject : null;
//        }
// 
//        if( targetMediaElement == null )
//        { 
...
//    private static void 
    ...
    { 
//        /*object*/var mappedObject = clockMappings[mappingKey];
// 
...
//        }
//        else if( mappedObject instanceof AnimationClock ) 
//        { 
//            // One clock currently in storage, up-convert to list and replace in slot.
//            /*List<AnimationClock>*/var clockList = new List(); 
//
//            clockList.Add(mappedObject);
...
//            /*List<AnimationClock>*/var clockList = mappedObject;
//
//            clockList.Add(animationClock);
//        } 
//
//        return; 
    ...
    /// </summary>
//    private static void 
    function ApplyAnimationClocks( /*HybridDictionary*/ clockMappings, /*HandoffBehavior*/ handoffBehavior, /*Int64*/ layer ) 
    {
...
//    internal static void 
    Storyboard.VerifyPathIsAnimatable = function (/*PropertyPath*/ path) 
    {
...
//    private static string 
    function AccessorName( /*PropertyPath*/ path, /*int*/ index )
    {
...
//        }
    ...
    /// </summary>
//    private static void 
    function VerifyAnimationIsValid( /*DependencyProperty*/ targetProperty, /*AnimationClock*/ animationClock ) 
    {
    ...
    /// </summary> 
//    internal static void 
    Storyboard.GetComplexPathValue = function(
            /*DependencyObject*/ targetObject, 
            /*DependencyProperty*/ targetProperty,
        /*ref EffectiveValueEntry*/ entry,
            /*PropertyMetadata*/ metadata)
    { 
//        /*CloneCacheEntry*/var cacheEntry = GetComplexPathClone(targetObject, targetProperty);
// 
//        if (cacheEntry != null) 
//        {
//            /*object*/var baseValue = entry.Value; 
...
//            /*DeferredReference*/var deferredBaseValue = baseValue instanceof DeferredReference ? baseValue : null; 
...
//    private static void 
    function CloneEffectiveValue(/*ref EffectiveValueEntry*/ entry, /*CloneCacheEntry*/ cacheEntry) 
    { 
//        /*object*/var clonedValue = cacheEntry.Clone;
...
//  private static CloneCacheEntry 
    function GetComplexPathClone(/*DependencyObject*/ o, /*DependencyProperty*/ dp) 
    {
//        /*FrugalMap*/var clonesMap = ComplexPathCloneField.GetValue(o); 
//
...
//        /*object*/var value = clonesMap.Get(dp.GlobalIndex); 
//        if (value != DependencyProperty.UnsetValue)
//        { 
//            return clonesMap.Get(dp.GlobalIndex); 
//        }
//        else 
//        {
//            return null;
...
//        { 
//            clonesMap.Set(dp.GlobalIndex, new CloneCacheEntry(source, clone)); 
//        }
//        else 
//        {
//            clonesMap.Set(dp.GlobalIndex, DependencyProperty.UnsetValue);
//        }
// 
...
//        ComplexPathCloneField.SetValue(o, clonesMap); 
	...
	Storyboard.Type = new Type("Storyboard", Storyboard, [Object.Type]);
	return Storyboard;
});
