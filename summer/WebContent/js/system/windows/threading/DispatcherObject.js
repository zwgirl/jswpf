...
define(["dojo/_base/declare", "system/Type"], function(declare, Type){
	var DispatcherObject = declare("DispatcherObject", null,{
		constructor:function(){

		}
	});
	
	Object.defineProperties(DispatcherObject.prototype,{
		  

	});
	
	DispatcherObject.Type = new Type("DispatcherObject", DispatcherObject, [Object.Type]);
