...
define(["dojo/_base/declare","system/Type"], 
    ...
    ExpressionMode.Type = new Type("ExpressionMode", ExpressionMode, [Object.Type]);
    ...
    InternalFlags.Type = new Type("InternalFlags", InternalFlags, [Object.Type]);
	...
	var Expression = declare("Expression", null,{
		"-chains-": {
		      constructor: "manual"
		    },
		    
		constructor:function(/*ExpressionMode*/ mode1){
			var mode = mode1;
			if(mode === undefined){
            ...
            { 
                ...
                case ExpressionMode.NonSharable: 
                    this._flags1 |= InternalFlags.NonShareable;
                    break; 
 
                case ExpressionMode.ForwardsInvalidations:
                	this._flags1 |= InternalFlags.ForwardsInvalidations; 
                	this._flags1 |= InternalFlags.NonShareable;
                    break;
                ...
                case ExpressionMode.SupportsUnboundSources: 
                	this._flags1 |= InternalFlags.ForwardsInvalidations;
                	this._flags1 |= InternalFlags.NonShareable; 
                	this._flags1 |= InternalFlags.SupportsUnboundSources; 
                    break;
 
                default:
                    throw new Error('ArgumentException(SR.Get(SRID.UnknownExpressionMode)');
	        } 
		},
        ...
        /*internal virtual DependencySource[] */
        GetSources:function() 
        {
            return null; 
        },
        ...
        /*internal void */
        ChangeSources:function(/*DependencyObject*/ d, /*DependencyProperty*/ dp, /*DependencySource[]*/ newSources) 
        {
...
//            DependencyObject.ValidateSources(d, newSources, this);
            ...
            {
            	EnsureDependencyObject().ChangeExpressionSources(this, null, null, newSources); 
                
            }
            else 
            { 
            	EnsureDependencyObject().ChangeExpressionSources(this, d, dp, newSources);
            } 
        },
        ...
        { 
            this._flags1 |= InternalFlags.Attached;
        }, 
 
        /*internal void */MarkDetached:function()
        { 
        	this._flags1 |= InternalFlags.Detached;
        }
	...
	Object.defineProperties(Expression.prototype,{
        ...
        Attachable:
        {
            ...
            get:function() { return this.Shareable || !this.HasBeenAttached; }
        },
 
        Shareable:
        { 
            get:function() { return (this._flags1 & InternalFlags.NonShareable) == 0; } 
        },
 
        ForwardsInvalidations:
        {
            get:function() { return (this._flags1 & InternalFlags.ForwardsInvalidations) != 0; }
        }, 

        SupportsUnboundSources:
        { 
            get:function() { return (this._flags1 & InternalFlags.SupportsUnboundSources) != 0; }
        }, 

        HasBeenAttached:
        {
            get:function() { return (this._flags1 & InternalFlags.Attached) != 0; } 
        },
 
        HasBeenDetached:
        {
            get:function() { return (this._flags1 & InternalFlags.Detached) != 0; } 
        }
	});
	...
	Expression.Type = new Type("Expression", Expression, [Object.Type]);
	Expression.ExpressionMode = ExpressionMode;
	return Expression;
});
