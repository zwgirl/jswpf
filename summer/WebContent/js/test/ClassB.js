define(["dojo/_base/declare"/*,"test/SuperA"*/, "test/ClassC", "require"], function(declare, require/*, SuperA*/, ClassC){
var ClassB = declare(/*SuperA*/null,{
		...
		sayHello1:function(name){
			alert("I' m ClassB.sayHello()" + this.name);
			alert(ClassC.);
