...
define(["dojo/_base/declare", "system/Type", "documents/TextElementCollection", "collections/IList"], 
		function(declare, Type, TextElementCollection, IList){
	var InlineCollection = declare("InlineCollection", [TextElementCollection, IList],{
		constructor:function(){
		}
	});
	
	Object.defineProperties(InlineCollection.prototype,{
		  
	});
	
	Object.defineProperties(InlineCollection,{
		  
	});
	
	InlineCollection.Type = new Type("InlineCollection", InlineCollection, [TextElementCollection.Type, IList.Type]);
