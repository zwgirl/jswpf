...
define(["dojo/_base/declare", 
        "windows/DependencyProperty" ,"internal/DefaultValueFactory", "windows/DependencyObject" ,
        "system/Type"
        ], function(declare, 
        		DependencyProperty, DefaultValueFactory, DependencyObject,
        		Type){
...
//    MetadataFlags.Type = new Type("MetadataFlags", MetadataFlags, [Object.Type]);
       ...
       /// <summary>
        ...
        Merge:function(/*PropertyMetadata*/ baseMetadata, /*DependencyProperty*/ dp)
        {
            ...
            { 
                ...
                { 
                    /*PropertyChangedCallback*/var headHandler = /*(PropertyChangedCallback)*/handlers[0];
...
//  private static FreezeValueCallback 
    var _defaultFreezeValueCallback = PropertyMetadata.DefaultFreezeValueCallback; 
...
//                }
    ...
    PropertyMetadata.DefaultFreezeValueCallback = function( 
        /*DependencyObject*/ d,
