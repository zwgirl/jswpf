...
define(["dojo/_base/declare", "system/Type", "generic/List"], function(declare, Type, List){
	var InputBindingCollection = declare("InputBindingCollection", null,{
...
//        internal InputBinding 
        ...
        { 
            ...
            { 
                /*InputBinding*/var inputBinding = this[i]; 
	...
	InputBindingCollection.Type = new Type("InputBindingCollection", InputBindingCollection, [Object.Type]);
	return InputBindingCollection;
});
//---------------------------------------------------------------------------- 
//
// <copyright file=InputBindingCollection.cs company=Microsoft>
