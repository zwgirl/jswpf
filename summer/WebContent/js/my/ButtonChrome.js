...
define(["dojo/_base/declare", "system/Type", "controls/Decorator"], 
		function(declare, Type, Decorator){
	var ButtonChrome = declare("ButtonChrome", Decorator,{
		constructor:function(){
		}
	});
	
	Object.defineProperties(ButtonChrome.prototype,{
		  
	});
	
	Object.defineProperties(ButtonChrome,{
		  
	});
	
	ButtonChrome.Type = new Type("ButtonChrome", ButtonChrome, [Decorator.Type]);
	return ButtonChrome;
});
...
//
// Description:
// Implementation of thick chrome for "full figured" buttons in Aero. 
//
