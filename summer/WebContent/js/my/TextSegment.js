...
define(["dojo/_base/declare", "system/Type", "controls/HeaderedContentControl"], 
	...
	var TextSegment = declare("TextSegment", HeaderedContentControl,{
	...
	Object.defineProperties(TextSegment,{
		  
	});
	
	TextSegment.Type = new Type("TextSegment", TextSegment, [HeaderedContentControl.Type]);
	return TextSegment;
});
