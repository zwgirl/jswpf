...
//                lock (_synchronized) 
//                {
                    /*PropertyValue*/var propertyValue = this.PropertyValues[existingIndex]; 
        ...
        { 
            ...
            for (var i = 0; i < this.PropertyValues.Count; i++) 
            {
                if (this.PropertyValues[i].ValueType == PropertyValueType.Set && 
                		this.PropertyValues[i].Property == dp) 
                {
...
//                    Debug.Assert( _frameworkTemplate != null );
                ...
                else 
                {
                    ...
                    for (var i = 0; i < PropertyValues.Count; i++) 
                    {
                        if (PropertyValues[i].ValueType == PropertyValueType.Set)
                        {
                            ...
                            /*object*/var o = PropertyValues[i].ValueInternal;
                ...
                /*FrameworkElementFactory*/var childFactory = _firstChild; 
...
//        private void 
        AddNodeToParent:function( /*DependencyObject*/ parent, /*FrameworkObject*/ childFrameworkObject )
        {
            ...
            else 
            {
                ...
                if (!(parent instanceof IAddChild))
                {
                    throw new Error('InvalidOperationException(SR.Get(SRID.TypeMustImplementIAddChild, parent.GetType().Name)'); 
                }
...
//        internal FrameworkObject 
        InstantiateUnoptimizedTree:function() 
        {
            ...
            /*FrameworkObject*/var frameworkObject = new FrameworkObject(CreateDependencyObject());
            ...
            /*ProvideValueServiceProvider*/var provideValueServiceProvider = null; 
            FrameworkTemplate.SetTemplateParentValues( Name, frameworkObject.DO, this._frameworkTemplate, /*ref*/ provideValueServiceProvider );
            ...
            while (childFactory != null)
            {
                ...
                else
                {
                    ...
                    /*FrameworkObject*/var childFrameworkObject = childFactory.InstantiateUnoptimizedTree(); 
...
//        private string 
        ...
        { 
            /*string*/var childName = AutoGenChildNamePrefix + AutoGenChildNamePostfix; //.ToString(CultureInfo.InvariantCulture);
...
//        private void 
        ApplyAutoAliasRules:function() 
        {
            ...
            { 
                ...
                /*object*/var o = this.GetValue(ContentPresenter.ContentSourceProperty);
                /*string*/var prefix = (o == DependencyProperty.UnsetValue) ? "Content" : o;
...
//                    Debug.Assert(_frameworkTemplate != null, "ContentPresenter is an FE and can only have a FrameworkTemplate"); 
                    /*Type*/var targetType = this._frameworkTemplate.TargetTypeInternal;

                    /*DependencyProperty*/var dpContent = DependencyProperty.FromName(prefix, targetType);
                    /*DependencyProperty*/var dpContentTemplate = DependencyProperty.FromName(prefix + "Template", targetType); 
                    /*DependencyProperty*/var dpContentTemplateSelector = DependencyProperty.FromName(prefix + "TemplateSelector", targetType);
                    /*DependencyProperty*/var dpContentStringFormat = DependencyProperty.FromName(prefix + "StringFormat", targetType); 
        ...
        IsValueDefined:function(/*DependencyProperty*/ dp)
        {
            for (var i = 0; i < this.PropertyValues.Count; i++) 
            {
                if (this.PropertyValues[i].Property == dp && 
                    (this.PropertyValues[i].ValueType == PropertyValueType.Set || 
                    		this.PropertyValues[i].ValueType == PropertyValueType.Resource ||
                    		this.PropertyValues[i].ValueType == PropertyValueType.TemplateBinding)) 
                {
                    return true;
                }
            } 
...
//    internal static void 
        ...
        /*bool*/ treeNodeIsFE, /*FrameworkElement*/ treeNodeFE, /*FrameworkContentElement*/ treeNodeFCE) 
    {
        ...
        { 
            /*IEnumerator*/var childEnumerator = logicalParent.LogicalChildren;
        ...
        /*IAddChild*/var  addChildParent = parent instanceof IAddChild ? parent : null; 
        if (addChildParent == null)
        { 
