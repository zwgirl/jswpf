...
define(["dojo/_base/declare", "system/Type", "primitives/TextBoxBase"], 
		function(declare, Type, TextBoxBase){
	var TextBox = declare("TextBox", TextBoxBase,{
	...
	TextBox.Type = new Type("TextBox", TextBox, [TextBoxBase.Type]);
	return TextBox;
});
