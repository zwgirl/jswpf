...
define(["dojo/_base/declare", "system/Type", "controls/HeaderedContentControl"], 
	...
	var TextSchema = declare("TextSchema", Object,{
		constructor:function(){
		}
	});
	
	Object.defineProperties(TextSchema.prototype,{
		  
	});
	
	Object.defineProperties(TextSchema,{
		  
	});
	
	TextSchema.Type = new Type("TextSchema", TextSchema, [Object.Type]);
	return TextSchema;
});
