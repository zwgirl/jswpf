...
//        internal override void 
        Seal:function()
        {
            ...
            /*DependencyProperty*/var dp = Property; 
            /*object*/var value = ValueInternal;
            ...
            if (!dp.IsValidValue(value)) 
            {
                ...
                { 
                    if ( !(value instanceof DynamicResourceExtension) && !(value instanceof System.Windows.Data.BindingBase) )
                    { 
