...
define(["dojo/_base/declare", "system/Type", "controls/ContentControl"], 
		function(declare, Type, ContentControl){
	var Window = declare("Window", [ContentControl, IWindowService],{
	...
	Window.Type = new Type("Window", TabItem, [ContentControl.Type, IWindowService.Type]);
	return Window;
});
