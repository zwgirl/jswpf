...
define(["dojo/_base/declare", "system/Type", "documents/TextTreeNode"], 
		function(declare, Type, TextTreeNode){
	var TextTreeTextElementNode = declare("TextTreeTextElementNode", TextTreeNode,{
		constructor:function(){
		}
	});
	
	Object.defineProperties(TextTreeTextElementNode.prototype,{
		  
	});
	
	Object.defineProperties(TextTreeTextElementNode,{
		  
	});
	
	TextTreeTextElementNode.Type = new Type("TextTreeTextElementNode", TextTreeTextElementNode, [TextTreeNode.Type]);
