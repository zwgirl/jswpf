...
define(["dojo/_base/declare", "system/Type", "collections/IEnumerator"], 
	...
	var RangeContentEnumerator = declare("RangeContentEnumerator", IEnumerator,{
		constructor:function(){
		}
	});
	
	Object.defineProperties(RangeContentEnumerator.prototype,{
		  
	});
	
	Object.defineProperties(RangeContentEnumerator,{
		  
	});
	
	RangeContentEnumerator.Type = new Type("RangeContentEnumerator", RangeContentEnumerator, [IEnumerator.Type]);
	return RangeContentEnumerator;
});
