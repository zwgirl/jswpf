...
define(["dojo/_base/declare", "system/Type", "internal.data/DataBindEngine", "generic/Dictionary", "internal.data/SynchronizationInfo"], 
		function(declare, Type, DataBindEngine, Dictionary, SynchronizationInfo){
...
//    static object
	...
	//  internal class 
	var ViewTable = declare("ViewTable", Dictionary, {
		Get:function(/*CollectionViewSource*/ cvs) { 
			return Dictionary.prototype.Get.call(this, cvs); 
		}, 
		Set:function(/*CollectionViewSource*/ cvs, value)
		{ 
	     	Dictionary.prototype.Set.call(this, cvs, value);
		},
	...
	//      internal void 
	      InitializeViewfunction:function()
	      { 
	...
	//  	public ViewTable 
	  	ViewTable: 
	      {
	          ...
	          set:function(value) { this._wrViewTable = new WeakReference(value); }
	      },
	      ...
	      IsAlive:
	      {
	          ...
	          { 
	              return SynchronizationInfo.IsAlive ||
	                  this._wrViewTable.IsAlive; 
	          }
	      }
	  });
	
	
	  var ViewManager = declare("ViewManager", Dictionary, {
		  constructor:function(){
			   this._inactiveViewTables = new Dictionary();
		  },
	//      internal void 
	      Add:function(/*object*/ collection, /*CollectionRecord*/ cr)
	      {
	    	  Dictionary.prototype.Add.call(this, collection, cr);
	      }, 
	...
	//      internal ViewRecord 
	    		  ...
	    		  /*bool*/ createView, /*Func<object, object>*/ GetSourceItem) 
	      {
	          ...
	          /*ViewRecord*/
	    	  var viewRecord = GetExistingView(collection, cvs, collectionViewType, GetSourceItem);
	          ...
	          if (ils != null)
	          {
	              ...
	              if (viewRecord != null) 
	              {
	                  return CacheView(collection, cvs, viewRecord.View, viewRecord); 
	              }
	          }
	...
	//      internal void 
	                          ...
	                          /*CollectionSynchronizationCallback*/ synchronizationCallback)
	      {
	          ...
	          { 
	              ...
	              for/*each*/ (/*DictionaryEntry*/var de in vt)
	              {
	                  /*ViewRecord*/
	            	  var vr = de.Value; 
	                  /*CollectionView*/
	      ...
	      { 
	          ...
	          if (cv == null) 
	          {
	              ...
	              if (vt != null) 
	              {
	                  ...
	                  {
	                	  this._inactiveViewTables[vt] = this.InactivityThreshold;
	                  } 
	              }
	              else 
	              { 
	...
	//      internal bool 
	      ...
	      { 
	          ...
	          if (n > 0)
	          {
	             /* ViewTable[]*/var keys = new ViewTable[n];
	              this._inactiveViewTables.Keys.CopyTo(keys, 0); 
	
	              for (var i=0; i<n; ++i) 
	              { 
	                  /*ViewTable*/var vt = keys[i];
	                  var expirationDate = this._inactiveViewTables[vt]; 
	                  if (--expirationDate > 0)
	                  {
	                  	this._inactiveViewTables[vt] = expirationDate;
	                  } 
	                  else
	                  { 
	...
	//      public new CollectionRecord 
	      Get:function(/*object*/ o)
			{
	          /*CollectionRecord*/
	    	  var cr = Dictionary.prototype.Get.call(this, o); //[key]; 
	...
	ViewManager.Type = new Type("ViewManager", ViewManager, [Object.Type]);
	return ViewManager;
});
