...
define(["dojo/_base/declare", "system/Type", "data/BindingMode", "markup/MarkupExtension", 
	...
	var BindingBase = declare("BindingBase", MarkupExtension, {
        ...
        { 
            ...
            Helper.CheckCanReceiveMarkupExtension(this, serviceProvider, parObj/*out targetDependencyObject, out targetDependencyProperty*/);

            var targetDependencyObject = parObj.targetDependencyObject; 
            var targetDependencyProperty = parObj.targetDependencyProperty;
        ...
        /// </summary> 
        CreateBindingExpressionOverride:function(/*DependencyObject*/ targetObject, /*DependencyProperty*/ targetProperty, 
...
//        }, 
        ...
        /*internal abstract BindingBase*/ CreateClone:function(){
        	;
        },
