...
define(["dojo/_base/declare", "system/Type", "documents/TextTreeNode"], 
	...
	var TextTreeRootNode = declare("TextTreeRootNode", TextTreeNode,{
		constructor:function(){
		}
	});
	
	Object.defineProperties(TextTreeRootNode.prototype,{
		  
	});
	
	Object.defineProperties(TextTreeRootNode,{
		  
	});
	
	TextTreeRootNode.Type = new Type("TextTreeRootNode", TextTreeRootNode, [TextTreeNode.Type]);
	return TextTreeRootNode;
});
