...
define(["dojo/_base/declare", "system/Type", "windows/PropertyMetadata"], 
	...
	var UIPropertyMetadata = declare(PropertyMetadata,{
		constructor:function(){
			
			if(isAnimationProhibited != undefined){
...
//	  public 
	  ...
	  {
		  var result = new UIPropertyMetadata();
		  PropertyMetadata.prototype.InitWithDVandPCB.call(result, defaultValue, propertyChangedCallback);
		  return result;
	  }; 
