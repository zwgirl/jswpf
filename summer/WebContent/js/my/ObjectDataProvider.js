...
define(["dojo/_base/declare", "system/Type", "data/DataSourceProvider"], 
		function(declare, Type, DataSourceProvider){
	var ObjectDataProvider = declare(DataSourceProvider,{
