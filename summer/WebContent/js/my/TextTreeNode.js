...
define(["dojo/_base/declare", "system/Type", "documents/SplayTreeNode"], 
		function(declare, Type, SplayTreeNode){
	var TextTreeNode = declare("TabItem", SplayTreeNode,{
		constructor:function(){
		}
	});
	
	Object.defineProperties(TextTreeNode.prototype,{
		  
	});
	
	Object.defineProperties(TextTreeNode,{
		  
	});
	
	TextTreeNode.Type = new Type("TabItem", TextTreeNode, [SplayTreeNode.Type]);
	return TextTreeNode;
});
