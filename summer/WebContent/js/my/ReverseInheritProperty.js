...
define(["dojo/_base/declare", "system/Type", "controls/HeaderedContentControl"], 
	...
	Object.defineProperties(ReverseInheritProperty.prototype,{
		  
	});
	
	Object.defineProperties(ReverseInheritProperty,{
...
namespace System.Windows 
{
    internal abstract class ReverseInheritProperty 
    {
            ...
            bool setOriginCacheFlag) 
        {
            ...
            bool isFla----ginCacheSet = (setOriginCacheFlag ? IsFlagSet(uie, ce, uie3D, (newValue ? FlagNewOriginCache : FlagOldOriginCache)) : false);
 
            // If the cache flag value is undergoing change, record it and
            // propagate the change to the ancestors. 
            if ((newValue != isFlagSet) || 
                (setOriginCacheFlag && !isFla----ginCacheSet) ||
                !shortCircuit) 
            {
                if (newValue != isFlagSet)
                {
                ...
                if (setOriginCacheFlag && !isFla----ginCacheSet)
                {
