...
define(["dojo/_base/declare", "system/Type", "windows/FrameworkContentElement"], 
	...
	var FlowDocument = declare("FlowDocument", [FrameworkContentElement, IDocumentPaginatorSource, IServiceProvider, IAddChild],{
	...
	FlowDocument.Type = new Type("FlowDocument", FlowDocument, 
			[FrameworkContentElement.Type, IDocumentPaginatorSource.Type, IServiceProvider.Type, IAddChild.Type]);
	return FlowDocument;
});
