...
define(["dojo/_base/declare", "system/Type", "windows/RoutedEventHandlerInfo"], 
		function(declare, Type, RoutedEventHandlerInfo){
...
//        public void 
        ...
        { 
            ...
            { 
                this._entries[key.GlobalIndex] = Delegate.Combine(existingDelegate, handler);
            } 
        }, 
        ...
        { 
            ...
            { 
                ...
                { 
                    ...
                    this._entries[key.GlobalIndex] = Type.UnsetValue;
                }
                else
                { 
                    this._entries[key.GlobalIndex] = existingDelegate;
                } 
            } 
        },
...
//      internal Delegate 
        Get:function(/*EventPrivateKey or RoutedEvent*/ key)
        { 
//          Debug.Assert(key != null, "Search key cannot be null");
        	 
            /*object*/
        	var existingDelegate = this._entries[key.GlobalIndex];
            if (existingDelegate == Type.UnsetValue) 
            { 
                return null;
            } 
            else
...
//            FrugalObjectList<RoutedEventHandlerInfo> 
            var handlers = this.GetRoutedEventHandlers(routedEvent);
            if (handlers == null) 
            {
                this._entries[routedEvent.GlobalIndex] = handlers = new FrugalObjectList/*<RoutedEventHandlerInfo>*/(); 
            } 
...
//            FrugalObjectList<RoutedEventHandlerInfo> 
            ...
            if (handlers != null && handlers.Count > 0) 
            {
                ...
                { 
                    ...
                    this._entries[routedEvent.GlobalIndex] = Type.UnsetValue;
                }
                else 
                {
...
//            FrugalObjectList<RoutedEventHandlerInfo> 
            handlers = this.GetRoutedEventHandlers(routedEvent);
...
//        public RoutedEventHandlerInfo[] 
        GetRoutedEventHandlers:function(/*RoutedEvent*/ routedEvent) 
        {
            ...
            /*FrugalObjectList<RoutedEventHandlerInfo>*/
            var handlers = this._entries[routedEvent.GlobalIndex];
            if (handlers != null)
            { 
...
////        internal FrugalObjectList<RoutedEventHandlerInfo> 
//        this[RoutedEvent key]
//        { 
//            get
//            {
//                Debug.Assert(key != null, "Search key cannot be null");
