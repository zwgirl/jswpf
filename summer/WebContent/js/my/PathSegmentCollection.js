...
define(["dojo/_base/declare", "system/Type", "animation/Animatable", "collections/IList"], 
		function(declare, Type, Animatable, IList){
...
//---------------------------------------------------------------------------- 
//
// <copyright file="PathSegmentCollection.cs" company="Microsoft">
...
namespace System.Windows.Media 
{
    ...
    public sealed partial class PathSegmentCollection : Animatable, IList, IList<PathSegment> 
    {
        ...
        /// </summary> 
        public struct Enumerator : IEnumerator, IEnumerator<PathSegment>
        { 
            #region Constructor
        ...
        {
            _collection = new FrugalStructList<PathSegment>(); 
        }
