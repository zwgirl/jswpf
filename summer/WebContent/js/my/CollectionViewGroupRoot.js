...
define(["dojo/_base/declare", "system/Type", "data/CollectionViewGroupInternal", "specialized/INotifyCollectionChanged"], 
    ...
    Object.defineProperties(GroupTreeNode, {
...
//        public override object 
	...
	var CollectionViewGroupRoot = declare("CollectionViewGroupRoot", [CollectionViewGroupInternal, INotifyCollectionChanged],{
...
//        internal void 
        Initialize:function()
        { 
            if (this._topLevelGroupDescription == null)
            {
            	this._topLevelGroupDescription = new TopLevelGroupDescription();
            } 
            this.InitializeGroup(this, this._topLevelGroupDescription, 0);
        }, 
        ...
        MoveWithinSubgroups:function(/*object*/ item, /*LiveShapingItem*/ lsi, /*IList*/ list, /*int*/ oldIndex, /*int*/ newIndex) 
        {
            ...
            { 
                ...
                else
                {
                    ...
                    for/*each*/ (/*CollectionViewGroupInternal*/var group in lsi.ParentGroups) 
                    {
...
//                            { Group = parentGroup, FirstChild = node };
            ...
            { 
                ...
                for/*each*/ (/*CollectionViewGroupInternal*/var group in parentGroups)
                { 
                    node = new GroupTreeNode()
...
//        internal void 
        ...
        {
            for/*each*/ (/*AbandonedGroupItem*/var agi in deleteList) 
            { 
...
//        void 
        InitializeGroup:function(/*CollectionViewGroupInternal*/ group, /*GroupDescription*/ parentDescription, /*int*/ level) 
        {
            ...
            if (explicitNames != null) 
            {
                ...
                {
                    /*CollectionViewGroupInternal*/var subgroup = new CollectionViewGroupInternal(explicitNames[k], group); 
...
//        void 
        ...
        { 
            ...
            var index = (loading && IsDataInGroupOrder) ? group.LastIndex : 0; 
...
//        object 
        ...
        { 
            ...
            if (pgd != null) 
            {
                /*string*/var nameStr = name instanceof string ? name : null; 
                if (nameStr != null)
                {
