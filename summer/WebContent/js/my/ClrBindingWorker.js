...
define(["dojo/_base/declare", "system/Type", "internal.data/BindingWorker",
        "windows/PropertyPath", "internal.data/PropertyPathWorker", "data/BindingExpression", "internal.data/DrillIn",
        "windows/DependencySource", "data/BindingStatusInternal", "windows/PropertyPathStatus"], 
		function(declare, Type, BindingWorker,
				PropertyPath, PropertyPathWorker, BindingExpression, DrillIn,
				DependencySource, BindingStatusInternal, PropertyPathStatus){
	 
	var ClrBindingWorker = declare(BindingWorker, {
...
//            }
            ...
            /*AsyncGetValueRequest*/var pendingGetValueRequest =/* (AsyncGetValueRequest)*/this.GetValue(Feature.PendingGetValueRequest, null);
...
//        internal override void 
        UpdateValue:function(/*object*/ value)
        {
            ...
            if (ParentBinding.IsAsync && !(this.PW.GetAccessor(k) instanceof DependencyProperty))
            {
...
//        internal override bool 
        ...
        {
//            object item = (XmlWorker == null) ? this.DataItem : this.XmlWorker.RawValue();
            ...
            if (!this.ParentBindingExpression.IsDetaching) 
            {
                ...
                if (this.IsDynamic) 
                {
                    ...
                    if (this.PW.NeedsDirectNotification) 
                    {
                        ...
                        if (d != null)
                            newSources[n++] = new DependencySource(d, DependencyObject.DirectDependencyProperty);
                    }
                } 
...
//        XmlBindingWorker 
//        XmlWorker: { get:function() { return /*(XmlBindingWorker)*/this.GetValue(Feature.XmlWorker, null); } } 
