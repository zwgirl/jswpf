...
define(["dojo/_base/declare", "system/Type", "documents/ITextContainer"], 
		function(declare, Type, ITextContainer){
	var TextContainer = declare("TextContainer", ITextContainer,{
		constructor:function(){
		}
	});
	
	Object.defineProperties(TextContainer.prototype,{
		  
	});
	
	Object.defineProperties(TextContainer,{
		  
	});
	
	TextContainer.Type = new Type("TextContainer", TextContainer, [ITextContainer.Type]);
