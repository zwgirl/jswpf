...
//			this.inherited(arguments, [ExpressionMode.SupportsUnboundSources]);
//			base(ExpressionMode.SupportsUnboundSources);
            ...
            this.SetFeatureValue(Feature.ParentBindingExpressionBase, parent, null); 
...
//        public bool 
        ValidateWithoutUpdate:function() 
        {
            ...
            var parObject = {"values":null};
            return this.ValidateAndConvertProposedValue(/*out values*/parObject); 
        }, 
...
//        internal void 
        ...
        { 
            ...
            { 
                ...
                {
                    if (this.TargetProperty != NoTargetProperty)
                    { 
...
//        internal void 
        ...
        {
            if (this.IsDetached && status != _status)
            {
...
//        void 
//        ChangeSources:function(/*DependencyObject*/ target, /*DependencyProperty*/ dp, /*WeakDependencySource[]*/ newSources)
//        {
        ...
        Value:
        {
            ...
            { 
                ...
                { 
                	...
                	this.ChangeValue(UseFallbackValue(), false /*notify*/);
                }
                return this._value; 
            },
            set:function(value) 
...
//    EventHandler<BindingValueChangedEventArgs> ValueChanged; 
...
//    internal static void 
	...
	BindingExpressionBase.Type = new Type("BindingExpressionBase", BindingExpressionBase, [Expression.Type]);
