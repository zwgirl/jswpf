...
define(["dojo/_base/declare", "system/Type", "documents/ITextRange"], 
		function(declare, Type, ITextRange){
	var TextRange = declare("TextRange", ITextRange,{
	...
	Object.defineProperties(TextRange,{
		  
	});
	
	TextRange.Type = new Type("TextRange", TextRange, [ITextRange.Type]);
	return TextRange;
});
