...
define(["dojo/_base/declare", "system/Type",
        ...
        "data/Binding", "windows/Expression", 
	...
	var ChangingValueHelper = declare("ChangingValueHelper", null,{
...
//			BindingExpressionBase.prototype.constructor.call(this, binding, owner);
			this.inherited(arguments, [binding, owner]);
        ...
        /*internal override void */OnPropertyInvalidation:function(/*DependencyObject*/ d, /*DependencyPropertyChangedEventArgs*/ args) 
        {
            ...
            var relevant = !IgnoreSourcePropertyChange; 
...
//                }
        ...
        HasLocalDataContext:function(/*DependencyObject*/ d)
        { 
...
//            var isExtendedTraceEnabled = TraceData.IsExtendedTraceEnabled(this, TraceDataLevel.AttachToContext);
//            var traceObjectRef = TraceData.IsExtendedTraceEnabled(this, TraceDataLevel.SourceLookup); 
...
//                args.IsTracing = traceObjectRef;
                args.ReaolveNamesInTemplate = this.ResolveNamesInTemplate;
            ...
            if (!this.UseDefaultValueConverter) 
            { 
            	this.Converter = ParentBinding.Converter;
...
//            GC.KeepAlive(target);   // keep target alive during activation (bug 956831) 
        ...
        /*private void*/ DetachFromContext:function() 
        {
            ...
            if (this.UsingMentor)
            {
                var target = this.TargetElement; 
                if (target != null)
                	this.InheritanceContextChangedEventManager.RemoveHandler(target, OnInheritanceContextChanged); 
            } 
...
//                    }
        ...
        /*internal void*/ Activate:function(/*object*/ item)
        {
            var target = this.TargetElement;
            if (target == null) 
                return;
...
//            GC.KeepAlive(target);   // keep target alive during activation (bug 956831) 
        ...
        /*object*/ 
        GetInitialValue:function(/*DependencyObject*/ target, /*out ValidationError error*/parObj)
        { 
            var proposedValue;
            ...
            else
            {
            	...
            	parObj.error = entry.ValidationError; 
...
//                #endif
                    else if (implicitConverter != null || this.EffectiveStringFormat != null)
                    {
                        ...
                        value = ConvertHelper(implicitConverter, value, targetType, this.TargetElement, this.GetCulture());
                    }
                } 
...
//                goto Done; 
            ...
            if (!this.IsInMultiBindingExpression && value != this.IgnoreDefaultValue &&
            ...
            if (value == this.IgnoreDefaultValue) 
            {
            ...
            var realTransfer = !(this.IsInUpdate && Object.Equals(value, Value)); 
...
//            GC.KeepAlive(target);   // keep target alive during transfer (bug 956831) 
        ...
        ConvertHelper:function(/*IValueConverter*/ converter, /*object*/ value, /*Type*/ targetType, /*object*/ parameter, /*CultureInfo*/ culture)
        {
            ...
            var stringFormat = EffectiveStringFormat;
...
//            Debug.Assert(NeedsValidation, "check NeedsValidation before calling this");
        ...
        ShouldIgnoreUpdate:function() 
        {
            ...
            if (this.TargetProperty.OwnerType != Selector.Type/*typeof(System.Windows.Controls.Primitives.Selector*/ &&  // SelectedItem, SelectedValue, SelectedIndex, etc.
            		this.TargetProperty != ComboBox.TextProperty                                             // ComboBox.Text 
                )
            {
                return false;
            } 
...
// aaa               var newDataErrorWR = ReplaceReference(dataErrorValue, newDataErrorValue);
            ...
            try 
            { 
                /*List<object> */var propertyErrors = this.GetDataErrors(indei, propertyName);
                /*List<object>*/var valueErrors = this.GetDataErrors(dataErrorValue, String.Empty); 
...
//#region Event handlers
        ...
        { 
            ...
            if (!this.IsInUpdate && CanActivate) 
            {
...
//        	this._dataItem = this.CreateReference(newItem);
        ...
        { 
            ...
            {
                if (this.HasLocalDataContext(ancestor)) 
                {
...
//                        } 
	...
	Object.defineProperties(BindingExpression.prototype,{
        ...
        ContextElement: 
        {
            ...
            { 
                if (this._ctxElement != null)
                    return this._ctxElement.Target instanceof DependencyObject ? this._ctxElement.Target : null; 
                else
                    return null;
            }
        }, 
...
//                	this.SetFeatureValue(Feature.CollectionViewSource, new WeakReference(value));
        ...
        SourceItem: 
        {
            get:function() { return (Worker != null) ? Worker.SourceItem : null; }
        },
...
//                    Invariant.Assert(Worker != null);
                    ...
                    SetFeatureValue(Feature.DynamicConverter, 
	...
	BindingExpression.NullDataItem = {"name" : "NullDataItem"};
	BindingExpression.IgnoreDefaultValue = {"name" : "IgnoreDefaultValue"}; 
	BindingExpression.StaticSource = {"name" : "StaticSource"};
	
	BindingExpression.Type = new Type("BindingExpression", BindingExpression, Object.Type);
...
// 
//        /*bool*/ 
//        IDataBindEngineClient.AttachToContext = function(/*bool*/ lastChance)
//        {
...
//                object newDataErrorWR = ReplaceReference(dataErrorValue, newDataErrorValue);
