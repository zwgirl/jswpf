...
define(["dojo/_base/declare", "system/Type", "documents/Span", "input/ICommandSource"], 
		function(declare, Type, Span, ICommandSource){
	var TabItem = declare("Hyperlink", [Span, ICommandSource],{
