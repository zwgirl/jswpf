...
//        internal override void 
        ...
        { 
            ...
            var parObj = {"hasMultipleInheritanceContexts" : this._hasMultipleInheritanceContexts,
    		...
    		this._inheritanceContext = parObj.inheritanceContext;
        },
...
//                	,(object x) => 
//                    { 
//                        /*BindingExpressionBase*/var beb = BindingOperations.GetBindingExpressionBase(this, this.SourceProperty);
...
//                    }
            ...
            this.SetValue(ViewPropertyKey, view); 
        },
...
//        public ICollectionView 
        View: 
        {
            get:function()
            {
                return CollectionViewSource.GetOriginalView(CollectionView);
            }
        }, 
...
//        public object 
        Source:
        { 
            get:function() { return  this.GetValue(SourceProperty); },
            set:function(value) { this.SetValue(SourceProperty, value); }
        },
...
//        public Type 
        CollectionViewType:
        {
            get:function() { return /*(Type)*/ GetValue(CollectionViewTypeProperty); }, 
            set:function(value) { SetValue(CollectionViewTypeProperty, value); }
        }, 
...
//        public bool 
        ...
        { 
            get:function() { return this.GetValue(CanChangeLiveSortingProperty); },
            /*private*/ set:function(value) { this.SetValue(CanChangeLiveSortingPropertyKey, value); } 
        }, 
...
//        public bool 
        ...
        {
            get:function() { return this.GetValue(IsLiveSortingRequestedProperty); },
            set:function(value) { this.SetValue(IsLiveSortingRequestedProperty, value); } 
        },
...
//        public bool? 
        IsLiveSorting:
        { 
            get:function() { return this.GetValue(IsLiveSortingProperty); },
            /*private*/ set:function(value) { this.SetValue(IsLiveSortingPropertyKey, value); }
        },
...
//                    ((INotifyCollectionChanged)_liveSortingProperties).CollectionChanged += new NotifyCollectionChangedEventHandler(OnForwardedCollectionChanged);
                    this._liveSortingProperties.CollectionChanged += new NotifyCollectionChangedEventHandler(OnForwardedCollectionChanged);
                } 
...
//        public bool 
        ...
        {
            get:function() { return this.GetValue(CanChangeLiveFilteringProperty); },
            /*private*/ set:function(value) { this.SetValue(CanChangeLiveFilteringPropertyKey, value); }
        }, 
...
//        public bool 
        ...
        {
            get:function() { return this.GetValue(IsLiveFilteringRequestedProperty); },
            set:function(value) { this.SetValue(IsLiveFilteringRequestedProperty, value); } 
        },
...
//        public bool? 
        IsLiveFiltering:
        { 
            get:function() { return /*(bool?)*/this.GetValue(IsLiveFilteringProperty); },
            /*private*/ set:function(value) { this.SetValue(IsLiveFilteringPropertyKey, value); }
        },
...
//                    ((INotifyCollectionChanged)_liveFilteringProperties).CollectionChanged += new NotifyCollectionChangedEventHandler(OnForwardedCollectionChanged); 
                    this._liveFilteringProperties.CollectionChanged += new NotifyCollectionChangedEventHandler(OnForwardedCollectionChanged); 
                }
...
//        public bool 
        ...
        {
            get:function() { return this.GetValue(CanChangeLiveGroupingProperty); },
            /*private*/ set:function(value) { this.SetValue(CanChangeLiveGroupingPropertyKey, value); } 
        },
...
//        public bool 
        ...
        { 
            get:function() { return this.GetValue(IsLiveGroupingRequestedProperty); }, 
            set:function(value) { this.SetValue(IsLiveGroupingRequestedProperty, value); }
        },
...
//        public bool? 
        IsLiveGrouping: 
        {
            get:function() { return this.GetValue(IsLiveGroupingProperty); },
            /*private*/ set:function(value) { this.SetValue(IsLiveGroupingPropertyKey, value); }
        },
...
//                    ((INotifyCollectionChanged)_liveGroupingProperties).CollectionChanged += new NotifyCollectionChangedEventHandler(OnForwardedCollectionChanged); 
                    this._liveGroupingProperties.CollectionChanged += new NotifyCollectionChangedEventHandler(OnForwardedCollectionChanged);
                }
...
//        internal CollectionView 
        ...
        { 
            get:function()
            {
                var view = /*(ICollectionView)*/this.GetValue(ViewProperty);
...
//        internal override DependencyObject 
        InheritanceContext:
        {
            get:function() { return _inheritanceContext; } 
        },
...
//        internal override bool 
        ...
        { 
            get:function() { return _hasMultipleInheritanceContexts; } 
        },
        	...
        	get:function(){
        		if(CollectionViewSource._viewPropertyKey === undefined){
	        		...
	        		CollectionViewSource._viewPropertyKey= DependencyProperty.RegisterReadOnly( 
	                        "View", 
	                        ICollectionView.Type/*typeof(ICollectionView)*/,
	                        /*typeof(CollectionViewSource)*/CollectionViewSource.Type, 
        ...
        IsLiveSortingPropertyKey:{
        	get:function(){
        		...
        		CollectionViewSource._viewPropertyKey = DependencyProperty.RegisterReadOnly(
                        ...
                        /*typeof(bool?)*/ Boolean.Type, 
                        /*typeof(CollectionViewSource)*/CollectionViewSource.Type,
                        FrameworkPropertyMetadata.BuildWithDV(/*(bool?)*/null)); 
        		}
        	}
        },
...
//    static internal CollectionView 
    CollectionViewSource.GetDefaultCollectionView = function(/*object*/ source, /*bool*/ createView, /*Func<object, object>*/ GetSourceItem/*=null*/) 
    { 
        if (!this.IsValidSourceForView(source)){
            return null; 
        }
    ...
    /// </summary>
//    internal static CollectionView 
    CollectionViewSource.GetDefaultCollectionView = function(/*object*/ source, /*DependencyObject*/ d, /*Func<object, object>*/ GetSourceItem/*=null*/) 
    {
        /*CollectionView*/var view = CollectionViewSource.GetDefaultCollectionView(source, true, GetSourceItem); 
        ...
        {
            /*XmlLanguage*/var language = (d != null) ? /*(XmlLanguage)*/d.GetValue(FrameworkElement.LanguageProperty) : null;
            if (language != null) 
            {
                try 
                { 
...
////---------------------------------------------------------------------------- 
////
//// <copyright file="CollectionViewSource.cs" company="Microsoft">
