...
define(["dojo/_base/declare", "system/Type", "collections/IList", "collections/ICollection"], 
		function(declare, Type, HeaderedContentControl, IList, ICollection){
	var TextElementCollection = declare("TextElementCollection", [IList, ICollection],{
	...
	Object.defineProperties(TextElementCollection,{
		  
	});
	
	TextElementCollection.Type = new Type("TextElementCollection", TextElementCollection, [IList, ICollection.Type]);
