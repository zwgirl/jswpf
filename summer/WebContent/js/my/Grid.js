...
define(["dojo/_base/declare", "system/Type", "controls/Panel", "markup/IAddChild"], 
		function(declare, Type, Panel, IAddChild){
	...
	Grid.Type = new Type("TabItem", Grid, [Panel.Type, IAddChild.Type]);
	return Grid;
});
