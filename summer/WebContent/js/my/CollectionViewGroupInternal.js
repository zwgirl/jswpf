...
define(["dojo/_base/declare", "system/Type", "data/CollectionViewGroup"], function(declare, Type, CollectionViewGroup){
...
//        bool IEnumerator.
        MoveNext:function() 
        {
            ...
            { 
                ...
                /*CollectionViewGroupInternal*/var subgroup = this._group.Items[this._index];
...
//        internal int 
        ...
        { 
            ...
            {
                /*CollectionViewGroupInternal*/var subgroup = this.Items[k];
                subgroup = subgroup instanceof CollectionViewGroupInternal ? subgroup : null;
                if (subgroup != null)
                { 
                ...
                { 
                    ...
                    if (Object.Equals(item, this.Items[k])) 
                    {
                        return leaves;
                    }
                    else 
        ...
        LeafIndexFromItem:function(/*object*/ item, /*int*/ index)
        {
            ...
            { 
                ...
                for (var k=0, n=group.Items.Count;  k < n;  ++k)
                {
                    ...
                    /*CollectionViewGroupInternal*/var subgroup = group.Items[k];
                    subgroup = subgroup instanceof CollectionViewGroupInternal ? subgroup : null;
...
//        internal object 
        ...
        { 
            ...
            {
                /*CollectionViewGroupInternal*/var subgroup = Items[k];
                subgroup = subgroup instanceof CollectionViewGroupInternal ? subgroup : null; 
                if (subgroup != null)
                {
...
//        protected virtual int 
        FindIndex:function(/*object*/ item, /*object*/ seed, /*IComparer*/ comparer, /*int*/ low, /*int*/ high) 
        {
            ...
            if (comparer != null) 
            {
                ...
                { 
                    /*CollectionViewGroupInternal*/var subgroup = ProtectedItems[index];
                    subgroup = subgroup instanceof CollectionViewGroupInternal ? subgroup : null;
                    /*object*/var seed1 = (subgroup != null) ? subgroup.SeedItem : ProtectedItems[index]; 
...
//        internal bool 
        ...
        { 
            ...
            { 
                /*CollectionViewGroupInternal*/
            	var subgroup = this.Items[i] instanceof CollectionViewGroupInternal ? this.Items[i] : null;
...
//            Debug.Assert(subgroup != null);
            ...
            for/*each*/ (/*object*/var key in this._nameToGroupMap.Keys) 
            {
...
//            }
            ...
            if (!_mapCleanupScheduled) 
            {
                ...
                (function()
                {
                    ...
                    if (_nameToGroupMap != null)
                    { 
                        /*ArrayList*/var keysToBeRemoved = new ArrayList(); 
                        for/*each*/ (/*object*/var key in _nameToGroupMap.Keys)
                        { 
                            /*WeakReference*/
                        	var weakRef = _nameToGroupMap[key] instanceof WeakReference ? _nameToGroupMap[key] : null;
                            if (weakRef == null || !weakRef.IsAlive)
                            {
                                keysToBeRemoved.Add(key); 
                            }
                        } 
                        for/*each*/ (/*object*/var key in keysToBeRemoved) 
                        {
                            _nameToGroupMap.Remove(key); 
                        }
                    }
...
//        internal GroupDescription 
        GroupBy: 
        {
            ...
            set:function(value) 
            {
                ...
                if (_groupBy != null)
                    PropertyChangedEventManager.RemoveHandler(this._groupBy, OnGroupByChanged, String.Empty);
 
                this._groupBy = value;
 
                if (this._groupBy != null) 
                    PropertyChangedEventManager.AddHandler(this._groupBy, OnGroupByChanged, String.Empty);
        ...
        { 
            ...
            { 
                if (this.ItemCount > 0 && (GroupBy == null || this.GroupBy.GroupNames.Count == 0))
                {
                    ...
                    {
                        /*CollectionViewGroupInternal*/
                    	var subgroup = this.Items[k] instanceof CollectionViewGroupInternal ? this.Items[k] : null; 
                        if (subgroup == null) 
                        {
