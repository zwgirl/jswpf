...
define(["dojo/_base/declare", "system/Type", "windows/Freezable"], 
		function(declare, Type, Freezable){
	...
	PointCollection.Type = new Type("PointCollection", PointCollection, [Freezable.Type, IFormattable.Type, IList.Type, IList.Type]);
