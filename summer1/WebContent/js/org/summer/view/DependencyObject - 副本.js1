...
//        [FriendAccessAllowed] // Built into Base, also used by Framework. 
        Seal:function() 
        {
            ...
            // also be final.  Thus, when we Seal(), we promote all cached values to locally set
        ...
        /// <summary> 
        ///     We Equals() to seal it to prevent custom Equals()
        ///     implementations. 
        /// 
...
//        [FriendAccessAllowed] // Built into Base, also used by Core.
        /*EffectiveValueEntry*/ GetValueEntry:function( 
            ...
            /*RequestFlags*/        requests) 
        {
            ...
            { 
                ...
                if (getValueCallback != null) 
                {
                    ...
                    entry.Value = this.getValueCallback(this, valueSource);
            ...
            /*RequestFlags*/        requests)
        {
            ...
            {
                // For thread-safety, final DOs can't modify _effectiveValues. 
                Debug.Assert(!DO_Sealed, "A final DO cannot be modified");
            ...
            { 
                ...
                boolean referenceFromExpression = false;
        ...
        /// <summary> 
        ///     Sets the value of a property withchanging its value source.
        /// </summary> 
        /// <param name="dp">Dependency property</param>
        ...
        SetCurrentValue:function(/*DependencyProperty*/ dp, /*Object*/ value)
        {
            ...
            // Cache the metadata Object this method needed to get anyway.
            /*PropertyMetadata*/ var metadata = this.SetupPropertyChange(dp); 
...
//        /// <summary> 
//        ///     Sets the local value of a property 
//        /// The purpose of this private method is to reuse BooleanBoxes when setting boolean value
//        /// </summary> 
//        /// <param name="dp">Dependency property</param>
//        /// <param name="value">New local value</param>
////        [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
//        SetValue:function(/*DependencyProperty*/ dp, /*boolean*/ value) 
//        {
...
//        /// <param name="value">New local value</param>
////        [FriendAccessAllowed] // Built into Base, also used by Core and Framework. 
//        private void SetCurrentValue(DependencyProperty dp, boolean value) 
//        {
...
//        }
        ...
        /// <param name="value">New local value</param>
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework. 
        private void SetValueInternal(DependencyProperty dp, Object value)
        {
            // Do not allow foreign threads access.
            // (This is a noop if this Object is not assigned to a Dispatcher.) 
            //
        ...
        /// <param name="value">New local value</param>
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
        private void SetCurrentValueInternal(DependencyProperty dp, Object value) 
        {
            // Do not allow foreign threads access. 
            // (This is a noop if this Object is not assigned to a Dispatcher.) 
            //
        ...
        /// </summary>
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        private void SetDeferredValue(DependencyProperty dp, DeferredReference deferredReference) 
        {
            // Cache the metadata Object this method needed to get anyway. 
            PropertyMetadata metadata = SetupPropertyChange(dp); 
        ...
        /// <summary> 
        /// Sets the value of a property to a deferred reference, withchanging the ValueSource.
        /// </summary> 
//        [FriendAccessAllowed] // Built into Base, also used by Framework. 
        private void SetCurrentDeferredValue(DependencyProperty dp, DeferredReference deferredReference)
        { 
            // Cache the metadata Object this method needed to get anyway.
            PropertyMetadata metadata = SetupPropertyChange(dp);
        ...
        /// </summary>
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        private void SetMutableDefaultValue(DependencyProperty dp, Object value)
        { 
            // Cache the metadata Object this method needed to get anyway.
            PropertyMetadata metadata = SetupPropertyChange(dp); 
        ...
        /// <param name="value">New local value</param>
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework. 
        private void SetValue(DependencyPropertyKey dp, boolean value)
        {
            SetValue(dp, MS.Internal.KnownBoxes.BooleanBoxes.Box(value));
        } 
        ...
        public void SetValue(DependencyPropertyKey key, Object value) 
        {
            ...
            // Cache the metadata Object this method needed to get anyway. 
            PropertyMetadata metadata = SetupPropertyChange(key, dp);
        ...
        { 
            ...
            boolean newValueHasExpressionMarker = (value == ExpressionInAlternativeStore); 
            ...
            { 
                boolean isValidValue = isInternal ? dp.IsValidValueInternal(value) : dp.IsValidValue(value);
...
//        [FriendAccessAllowed] // Built into Base, also used by Core & Framework.
        private boolean ProvideSelfAsInheritanceContext( Object value, DependencyProperty dp ) 
        {
...
//        [FriendAccessAllowed] // Built into Base, also used by Core & Framework.
        private boolean ProvideSelfAsInheritanceContext( DependencyObject doValue, DependencyProperty dp ) 
        {
        ...
        //
//        [FriendAccessAllowed] // Built into Base, also used by Core & Framework. 
        private boolean RemoveSelfAsInheritanceContext( Object value, DependencyProperty dp )
        { 
            DependencyObject doValue = value as DependencyObject; 
            if (doValue != null)
            { 
...
//        [FriendAccessAllowed] // Built into Base, also used by Core & Framework. 
        private boolean RemoveSelfAsInheritanceContext( DependencyObject doValue, DependencyProperty dp )
        {
        ...
        /// </summary> 
        private boolean ContainsValue(DependencyProperty dp)
        {
            EntryIndex entryIndex = LookupEntry(dp.GlobalIndex);
        ...
        //
        static void ChangeExpressionSources(Expression expr, DependencyObject d, DependencyProperty dp, DependencySource[] newSources) 
        {
        ...
        /// 
        /// This is being done as an private method to enable the performance
        ///  bug #1114409.  This is candidate for a public API but we can't 
        ///  do that kind of work at the moment.
        /// </remarks>
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        private void InvalidateSubProperty(DependencyProperty dp) 
        {
        ...
        /// </remarks>
//        [FriendAccessAllowed] // Built into Base, also used by Framework. 
        private void NotifySubPropertyChange(DependencyProperty dp)
        { 
...
//        [FriendAccessAllowed] // Declared in Base also used in Framework 
        private UpdateResult UpdateEffectiveValue(
                EntryIndex          entryIndex,
                DependencyProperty  dp,
                PropertyMetadata    metadata, 
                EffectiveValueEntry oldEntry,
                ...
                OperationType       operationType) 
        {
            ...
            */ 
            ...
            boolean isReEvaluate = false; 
            boolean isCoerceValue = false;
                 ...
                 (oldEntry.IsExpression && newEntry.IsExpression && (newEntry.ModifiedValue.BaseValue == oldEntry.ModifiedValue.BaseValue)))))
            {
                ...
                { 
                    ...
                    // Make sure that the call did not cause a change to entryIndex 
                    entryIndex = CheckEntryIndex(entryIndex, targetIndex);

                    boolean found = (newEntry.Value != DependencyProperty.UnsetValue);
            ...
            // Try AvaCop withthe second condition to repro this problem.
            boolean isAValueChange = !Equals(dp, oldValue, newEntry.GetFlattenedEntry(RequestFlags.FullyResolved).Value); 
...
#region EventTracing
            ...
            */ 
            ...
            // BaseValueSource we are implicitly filtering any sources which
            // have modifiers.  (e.g., IsExpression, IsAnimated, etc.) 

            boolean oldEntryHadContext = oldEntry.FullValueSource == (FullValueSource) BaseValueSourceInternal.Local;
            boolean newEntryNeedsContext = newEntry.FullValueSource == (FullValueSource) BaseValueSourceInternal.Local;
            ...
            if (result != 0 || (oldEntryHadContext != newEntryNeedsContext)) 
            {
                ...
                // DANGER:  Callmight add/remove entries in the effective value table. 
        ...
        { 
            ...
            { 
                ...
                // limited circumstances, when we know the listener is private.
                // Since we never assign DeferredReference instances to
                // non-private (non-friend assembly) classes, it's safe to skip 
                ...
                if (!coerceWithDeferredReference || 
                    dp.OwnerType != metadata.CoerceValueCallback.Method.DeclaringType) // Need 2nd check to rule derived class callback overrides.
                {
        ...
        /// </summary>
//        [FriendAccessAllowed] // Built into Base, also used by Framework. 
        private void NotifyPropertyChange(DependencyPropertyChangedEventArgs args) 
        {
            // fire change notification 
...
#region EventTracing 
#if VERBOSE_PROPERTY_EVENT
            boolean isDynamicTracing = EventTrace.IsEnabled(EventTrace.Flags.performance, EventTrace.Level.verbose); // This was under "normal"
            if (isDynamicTracing)
            { 
                ++ValidationCount;
...
#if NESTED_OPERATIONS_CHECK 
            // Are we validating of control?
            if( NestedOperations > NestedOperationMaximum ) 
            { 
                // We're validating of control, time to abort.
            ...
            {
                // Read local storage 
                boolean isSetValue = (newEntry.BaseValueSourceInternal == BaseValueSourceInternal.Local);
                boolean isClearLocalValue = isSetValue && (newEntry.Value == DependencyProperty.UnsetValue);
                boolean oldLocalIsExpression = false;
...
#region EventTracing
        ...
        /// </summary>
        private void EvaluateBaseValueCore(
                DependencyProperty  dp,
                PropertyMetadata    metadata, 
            ref EffectiveValueEntry newEntry)
        { 
        ...
        /// </summary>
        private void EvaluateAnimatedValueCore(
                DependencyProperty  dp, 
                PropertyMetadata    metadata,
            ref EffectiveValueEntry newEntry) 
        { 
        ...
        /// <summary> 
        /// this method to control whether a DependencyProperty should be serialized.
        /// The base implementation returns true if the property is set (locally) on this Object. 
        /// </summary>
        protected private boolean ShouldSerializeProperty( DependencyProperty dp )
        {
            return ContainsValue( dp ); 
        }
 
//        [FriendAccessAllowed] // Built into Base, also used by Core & Framework. 
        BaseValueSourceInternal GetValueSource(DependencyProperty dp, PropertyMetadata metadata, boolean hasModifiers)
        { 
            boolean isExpression, isAnimated, isCoerced, isCurrent;
            return GetValueSource(dp, metadata, hasModifiers, isExpression, isAnimated, isCoerced, isCurrent);
        }
 
//        [FriendAccessAllowed] // Built into Base, also used by Core & Framework.
        BaseValueSourceInternal GetValueSource(DependencyProperty dp, PropertyMetadata metadata, 
                boolean hasModifiers, boolean isExpression, boolean isAnimated, boolean isCoerced, boolean isCurrent) 
        {
            if (dp == null) 
            {
                throw new ArgumentNullException("dp");
        ...
        ///     set via <cref see="SetValue"/>.
        /// </returns> 
        private Object ReadLocalValueEntry(EntryIndex entryIndex, DependencyProperty dp, boolean allowDeferredReferences) 
        {
            if (!entryIndex.Found) 
            {
        ...
        /// </summary>
        private boolean CanModifyEffectiveValues
        { 
...
//        [FriendAccessAllowed]   // defined in Base, used in Core and Framework 
        private boolean IsInheritanceContextSealed
        { 
        ...
        private boolean Freezable_Frozen
        {
            // uses the same bit as final ... even though they are not quite synonymous 
            // Since Frozen implies final, and calling Seal() is disallowed on Freezable,
            // this is ok. 
        ...
        private boolean Freezable_HasMultipleInheritanceContexts 
        {
        ...
        private boolean Freezable_UsingHandlerList
        { 
        ...
        private boolean Freezable_UsingContextList
        {
        ...
        private boolean Freezable_UsingSingletonHandler
        {
        ...
        private boolean Freezable_UsingSingletonContext 
        {
        ...
        //
        private boolean Animatable_IsResourceInvalidationNecessary 
        {
        ...
        private boolean IAnimatable_HasAnimatedProperties
        {
            [FriendAccessAllowed] // Built into Base, but used by Core. 
        ...
        // private DP used for direct dependencies (should never appear in an effective value table)
        //
        ...
        // notifications to direct dependents, the binding will hear abthe change,
        // and will forward a sub-property change to the Border. 
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        static private final DependencyProperty DirectDependencyProperty = 
            DependencyProperty.Register("__Direct", typeof(Object), typeof(DependencyProperty)); 

        private static void UpdateSourceDependentLists(DependencyObject d, DependencyProperty dp, DependencySource[] sources, Expression expr, boolean add) 
        {
            ...
            if (sources != null) 
            {
                ...
                { 
                    ...
                    // A final DependencyObject does not have a Dependents list 
        ...
        static void ValidateSources(DependencyObject d, DependencySource[] newSources, Expression expr)
        {
        ...
        /// </remarks>
//        [FriendAccessAllowed] // Built into Base, also used by Framework. 
        private static void RegisterForAlternativeExpressionStorage(
                            AlternativeExpressionStorageCallback getExpressionCore,
                            AlternativeExpressionStorageCallback getExpression)
        { 
        ...
        /// </returns> 
        private boolean HasAnyExpression()
        {
        ...
        /// </summary>
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework. 
        private boolean HasExpression(EntryIndex entryIndex, DependencyProperty dp)
        { 
            if (!entryIndex.Found) 
            {
                return false; 
            ...
            boolean result = (entry.HasExpressionMarker || o is Expression); 
            return result;
        } 
...
//        #region InheritanceContext
        ...
        /// <summary>
        ///     You are abto provided as the InheritanceContext for the target. 
        ///     You can choose to allow this or not. 
        /// </summary>
        private boolean ShouldProvideInheritanceContext(DependencyObject target, DependencyProperty property) 
        {
            return true;
        }
        ...
        /// </remarks>
        [FriendAccessAllowed] // Built into Base, also used by Core. 
        private void OnInheritanceContextChanged(EventArgs args)
        { 
            ...
            try 
            {
                ...
                // context for (we will call these inheritanceChildren) abthe
        ...
        /// </summary> 
        [FriendAccessAllowed] // Built into Base, also used by Core.
        private void OnInheritanceContextChangedCore(EventArgs args)
        {
        } 
        ...
        /// </remarks>
        private event EventHandler InheritanceContextChanged 
        { 
            [FriendAccessAllowed] // Built into Base, also used by Framework.
            add 
            {
        ...
        /// </summary> 
        private boolean CanBeInheritanceContext 
        {
//            [FriendAccessAllowed] // Built into Base, also used by Framework. 
...
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        private static boolean IsTreeWalkOperation(OperationType operation) 
        {
        ...
        /// </summary>
        [Conditional ("DEBUG")]
        private void Debug_AssertNoInheritanceContextListeners() 
        {
        ...
        private  static final UncommonField<EventHandler> InheritanceContextChangedHandlersField = new UncommonField<EventHandler>();
...
//        #region EffectiveValues 
        ...
        // has been modified
        private EffectiveValueEntry[] EffectiveValues
        { 
//            [FriendAccessAllowed] // Built into Base, also used by Framework.
        ...
        private uint EffectiveValuesCount
        {
            [FriendAccessAllowed] // Built into Base, also used by Framework.
        ...
        private uint InheritableEffectiveValuesCount
        { 
//            [FriendAccessAllowed] // Built into Base, also used by Framework.
        ...
        // Mode".  This is an opt-in mode: a DO starts *not* in Property 
        ...
        // methods below
        private boolean IsInPropertyInitialization 
        {
        ...
        // system that a bunch of property sets are abto happen; the
        ...
        // fewer reallocations 
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework. 
        private void BeginPropertyInitialization()
        { 
...
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
        private void EndPropertyInitialization()
        { 
...
//            [FriendAccessAllowed] // Built into Base, also used by Framework.
        ...
        void SetInheritanceParent(DependencyObject newParent)
        { 
            ...
            // For thread-safety, final DOs can't modify _contextStorage 
            Debug.Assert(!DO_Sealed, "A final DO cannot be modified");
        ...
        boolean IsSelfInheritanceParent
        { 
//            [FriendAccessAllowed] // Built into Base, also used by Framework. 
...
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        ...
        //
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        void SynchronizeInheritanceParent(DependencyObject parent)
        { 
        ...
        //
        void MergeInheritableProperties(DependencyObject inheritanceParent) 
        {
        ...
        //  could happen that we have made a call and thereby caused changes 
...
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        ...
        // 
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework. 
        private int EffectiveValuesInitialSize
        { 
            get { return 2; }
        }

        private void SetEffectiveValue(EntryIndex entryIndex, DependencyProperty dp, PropertyMetadata metadata, EffectiveValueEntry newEntry, EffectiveValueEntry oldEntry) 
        {
            if (metadata != null && 
        ...
        // 
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
        private void SetEffectiveValue(EntryIndex entryIndex, DependencyProperty dp, int targetIndex, PropertyMetadata metadata, Object value, BaseValueSourceInternal valueSource) 
        { 
            ...
            boolean hasExpressionMarker = (value == ExpressionInAlternativeStore);
        ...
        // 
        private void UnsetEffectiveValue(EntryIndex entryIndex, DependencyProperty dp, PropertyMetadata metadata)
        { 
            if (entryIndex.Found)
            {
        ...
        /// </summary> 
        private boolean Equals(DependencyProperty dp, Object value1, Object value2)
        { 
...
//        #region InstanceData 
        ...
        private Object _contextStorage; 
        ...
        //     Bit 22 (0x00400000): IsSealed:  whether or not this DO is in final mode
...
//        [FriendAccessAllowed] // Built into Base, also used by Framework. 
        private static final Object ExpressionInAlternativeStore = new NamedObject("ExpressionInAlternativeStore");
        ...
        private static final UncommonField<Object> DependentListMapField = new UncommonField<Object>();

        // Optimization, to avoid calling FromSystemType too often
        private static DependencyObjectType DType = DependencyObjectType.FromSystemTypeInternal(typeof(DependencyObject)); 
...
//        #endregion StaticData
    ...
    /// </remarks>
//    [FriendAccessAllowed] // Built into Base, also used by Framework. 
    private delegate Expression AlternativeExpressionStorageCallback(DependencyObject d, DependencyProperty dp, PropertyMetadata metadata); 
