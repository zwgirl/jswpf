...
public class DateTime implements IComparable, IFormattable, IConvertible, ISerializable, IComparable<DateTime>,IEquatable<DateTime> { 
	
    // Number of 100ns ticks per time unit
    private final long TicksPerMillisecond = 10000;
    private final long TicksPerSecond = TicksPerMillisecond * 1000; 
    private final long TicksPerMinute = TicksPerSecond * 60;
    private final long TicksPerHour = TicksPerMinute * 60; 
    private final long TicksPerDay = TicksPerHour * 24; 

    // Number of milliseconds per time unit 
    private final int MillisPerSecond = 1000;
    private final int MillisPerMinute = MillisPerSecond * 60;
    private final int MillisPerHour = MillisPerMinute * 60;
    private final int MillisPerDay = MillisPerHour * 24; 

    // Number of days in a non-leap year 
    private final int DaysPerYear = 365; 
    // Number of days in 4 years
    private final int DaysPer4Years = DaysPerYear * 4 + 1;       // 1461 
    // Number of days in 100 years
    private final int DaysPer100Years = DaysPer4Years * 25 - 1;  // 36524
    // Number of days in 400 years
    private final int DaysPer400Years = DaysPer100Years * 4 + 1; // 146097 

    // Number of days from 1/1/0001 to 12/31/1600 
    private final int DaysTo1601 = DaysPer400Years * 4;          // 584388 
    // Number of days from 1/1/0001 to 12/30/1899
    private final int DaysTo1899 = DaysPer400Years * 4 + DaysPer100Years * 3 - 367; 
    // Number of days from 1/1/0001 to 12/31/9999
    private final int DaysTo10000 = DaysPer400Years * 25 - 366;  // 3652059

    /*internal*/ public final long MinTicks = 0; 
    /*internal*/ public final long MaxTicks = DaysTo10000 * TicksPerDay - 1;
    private final long MaxMillis = (long)DaysTo10000 * MillisPerDay; 

    private final long FileTimeOffset = DaysTo1601 * TicksPerDay;
    private final long DoubleDateOffset = DaysTo1899 * TicksPerDay; 
    // The minimum OA date is 0100/01/01 (Note it's year 100).
    // The maximum OA date is 9999/12/31
    private final long OADateMinAsTicks = (DaysPer100Years - DaysPerYear) * TicksPerDay;
    // All OA dates must be greater than (not >=) OADateMinAsDouble 
    private final double OADateMinAsDouble = -657435.0;
    // All OA dates must be less than (not <=) OADateMaxAsDouble 
    private final double OADateMaxAsDouble = 2958466.0; 

    private final int DatePartYear = 0; 
    private final int DatePartDayOfYear = 1;
    private final int DatePartMonth = 2;
    private final int DatePartDay = 3;
    ...
    public static final DateTime MinValue = new DateTime(MinTicks, DateTimeKind.Unspecified);
    public static final DateTime MaxValue = new DateTime(MaxTicks, DateTimeKind.Unspecified);

    private final UInt64 TicksMask             = 0x3FFFFFFFFFFFFFFF; 
    private final UInt64 FlagsMask             = 0xC000000000000000;
    private final UInt64 LocalMask             = 0x8000000000000000; 
    private final Int64 TicksCeiling           = 0x4000000000000000; 
    private final UInt64 KindUnspecified       = 0x0000000000000000;
    private final UInt64 KindUtc               = 0x4000000000000000; 
    private final UInt64 KindLocal             = 0x8000000000000000;
    private final UInt64 KindLocalAmbiguousDst = 0xC000000000000000;
    private final Int32 KindShift = 62;
    ...
    /*internal*/ public DateTime(long ticks, DateTimeKind kind, Boolean isAmbiguousDst) {
        if (ticks < MinTicks || ticks > MaxTicks) { 
            throw new ArgumentOutOfRangeException("ticks", Environment.GetResourceString("ArgumentOutOfRange_DateTimeBadTicks"));
        }
    ...
    /*internal*/ public Int64 InternalTicks {
        get { 
    ...
    /*internal*/ public static long DoubleDateToTicks(double value) {
    ...
    /*internal*/ public static DateTime FromBinaryRaw(Int64 dateData) {
    ...
    /*internal*/ public Int64 ToBinaryRaw() {
        return (Int64)dateData; 
    } 
    ...
    /*internal*/ public Boolean IsAmbiguousDaylightSavingTime() { 
    ...
    /*internal*/ public static extern long GetSystemTimeAsFileTime(); 
    ...
    /*internal*/ public DateTime ToLocalTime(boolean throwOnOverflow) 
    {
        if (Kind == DateTimeKind.Local) { 
            return this; 
        }
    ...
    public static boolean operator ==(DateTime d1, DateTime d2) { 
    ...
    public static boolean operator <(DateTime t1, DateTime t2) {
        return t1.InternalTicks < t2.InternalTicks; 
    }
    ...
    //
    /*internal*/ public static Boolean TryCreate(int year, int month, int day, int hour, int minute, int second, int millisecond, out DateTime result) { 
