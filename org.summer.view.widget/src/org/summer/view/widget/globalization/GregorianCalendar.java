...
public class GregorianCalendar extends Calendar 
    {
        ...
        public final int ADEra = 1; 
 

        /*internal*/ public final int DatePartYear = 0; 
        /*internal*/ public final int DatePartDayOfYear = 1;
        /*internal*/ public final int DatePartMonth = 2;
        /*internal*/ public final int DatePartDay = 3;
 
        //
        // This is the max Gregorian year can be represented by DateTime class.  The limitation 
        // is derived from DateTime class. 
        //
        /*internal*/ public final int MaxYear = 9999; 

        /*internal*/ public GregorianCalendarTypes m_type;

        /*internal*/ public static readonly int[] DaysToMonth365 = 
        {
            0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365 
        }; 

        /*internal*/ public static readonly int[] DaysToMonth366 = 
        {
...
#region Serialization
        ...
        **Exceptions: 
        ...
        /*internal*/ public static Calendar GetDefaultInstance() {
        ...
        /*internal*/ public /*override*/ int ID {
            get { 
        ...
        /*internal*/ public virtual int GetDatePart(long ticks, int part) 
        {
        ...
        **Note:
        **      This is an /*internal*/ public method used by DateToTicks() and the calculations of Hijri and Hebrew calendars. 
        ...
        **
        ...
        /*internal*/ public static long GetAbsoluteDate(int year, int month, int day) { 
        ...
        /*internal*/ public virtual long DateToTicks(int year, int month, int day) {
        ...
        public /*override*/ boolean IsLeapDay(int year, int month, int day, int era) 
        {
            if (month < 1 || month > 12) { 
        ...
        public /*override*/ boolean IsLeapMonth(int year, int month, int era) 
        {
            if (era != CurrentEra && era != ADEra) { 
                throw new ArgumentOutOfRangeException("era", Environment.GetResourceString("ArgumentOutOfRange_InvalidEraValue"));
            }
        ...
        public /*override*/ boolean IsLeapYear(int year, int era) { 
            if (era == CurrentEra || era == ADEra) {
                if (year >= 1 && year <= MaxYear) { 
        ...
        /*internal*/ public /*override*/ Boolean TryToDateTime(int year, int month, int day, int hour, int minute, int second, int millisecond, int era, out DateTime result) { 
            if (era == CurrentEra || era == ADEra) { 
        ...
        private final int DEFAULT_TWO_DIGIT_YEAR_MAX = 2029;
