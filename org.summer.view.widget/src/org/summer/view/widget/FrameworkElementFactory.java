...
import org.summer.view.widget.controls.ColumnDefinition;
...
import org.summer.view.widget.controls.RowDefinition;
...
//                    #pragma warning suppress 6506 // value is obviously not null 
    ...
    public void SetValue(DependencyProperty dp, Object value)
    {
        ...
        if (dp == null) 
        {
            throw new NullPointerException("dp");
        }
...
//        #pragma warning suppress 6506 // dp.DefaultMetadata is never null
        if (dp.ReadOnly)
        {
            ...
            throw new IllegalArgumentException(/*SR.Get(SRID.ReadOnlyPropertyNotAllowed, dp.Name, GetType().Name)*/); 
        } 
    ...
    // Seal this FEF
    /*internal*/public void Seal(FrameworkTemplate ownerTemplate) 
    {
        if (_sealed)
        {
            return; 
    ...
    /*internal*/public DependencyObject InstantiateTree(
...
//        EventTrace.EasyTraceEvent(EventTrace.Keyword.KeywordXamlBaml, EventTrace.Level.Verbose, EventTrace.Event.WClientParseFefCrInstBegin); 
        ...
        boolean isContainerAnFE = containerAsFE != null;
        ...
        { 
            ...
            { 
                throw new InvalidOperationException(/*SR.Get(SRID.TypeMustImplementIAddChild, parent.GetType().Name)*/);
            } 
            else
            {
...
//            EventTrace.EasyTraceEvent(EventTrace.Keyword.KeywordXamlBaml, EventTrace.Level.Verbose, EventTrace.Event.WClientParseFefCrInstEnd);
            ...
            boolean treeNodeIsVisual3D = false; 
...
//                "We should not be trying to instantiate a node that is neither FrameworkElement nor FrameworkContentElement.  A type check should have been done when Type is set");
            ...
            // And here's the boolean we'll use to make the decision.
            boolean treeNodeIsFE = treeNodeFO.IsFE; 
...
//                Debug.Assert( _frameworkTemplate != null );
    ...
    private static void UpdateChildChains(String childID, int childIndex,
        boolean treeNodeIsFE, FrameworkElement treeNodeFE, FrameworkContentElement treeNodeFCE, 
    ...
    /// "Initialized" event. 
    /// </summary> 
    /*internal*/ static void NewNodeBeginInit( boolean treeNodeIsFE,
    ...
    /// "Initialized" event. 
    /// </summary>
    private static void NewNodeEndInit( boolean treeNodeIsFE, 
        FrameworkElement treeNodeFE, FrameworkContentElement treeNodeFCE )
    {
        if( treeNodeIsFE )
        { 
    ...
    private static void NewNodeStyledParentProperty(
        DependencyObject container, boolean isContainerAnFE,
        boolean treeNodeIsFE, FrameworkElement treeNodeFE, FrameworkContentElement treeNodeFCE) 
    {
        if( treeNodeIsFE ) 
        { 
    ...
    /*internal*/ boolean IsChildNameValid(String childName)
    {
...
//                Debug.Assert(_frameworkTemplate != null, "GridViewRowPresenter is an FE and can only have a FrameworkTemplate"); 
    ...
    private boolean IsValueDefined(DependencyProperty dp)
    {
        for (int i = 0; i < PropertyValues.Count; i++) 
        {
            if (PropertyValues[i].Property == dp && 
    ...
    /*internal*/ boolean   _hasLoadedChangeHandler;

    private Type _type; 
    private String _text;
    private Func<Object> _knownTypeFactory; 
    private String _childName; 
    /*internal*/public int _childIndex = -1; // Being used in Style.ProcessTemplateStyles
