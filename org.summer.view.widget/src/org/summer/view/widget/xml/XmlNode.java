...
//    [DebuggerDisplay("{debuggerDisplayProxy}")]
    public abstract class XmlNode implements ICloneable, IEnumerable, IXPathNavigable {
        /*internal*/ public XmlNode parentNode; //this pointer is reused to save the userdata information, need to prevent /*internal*/ public user access the pointer directly.
 
        /*internal*/ public XmlNode () {
        } 
 
        /*internal*/ public XmlNode( XmlDocument doc ) {
            if ( doc == null ) 
        ...
        /*internal*/ public /*virtual*/ bool IsContainer {
            get { return false;}
        } 

        /*internal*/ public /*virtual*/ XmlLinkedNode LastNode { 
            get { return null;} 
            set {}
        } 

        [System.Runtime.TargetedPatchingOptOutAttribute("Performance critical to inline across NGen image boundaries")]
        /*internal*/ public bool AncestorNode(XmlNode node) {
        ...
        /*internal*/ public bool IsConnected() 
        {
        ...
        /*internal*/ public /*virtual*/ XmlNode AppendChildForLoad(XmlNode newChild, XmlDocument doc) { 
        ...
        /*internal*/ public /*virtual*/ bool IsValidChildType( XmlNodeType type ) { 
            return false;
        } 
 
        /*internal*/ public /*virtual*/ bool CanInsertBefore( XmlNode newChild, XmlNode refChild ) {
            return true; 
        }

        /*internal*/ public /*virtual*/ bool CanInsertAfter( XmlNode newChild, XmlNode refChild ) {
            return true; 
        }
        ...
        /*internal*/ public /*virtual*/ void CopyChildren( XmlDocument doc, XmlNode container, bool deep ) { 
        ...
        /*internal*/ public static bool HasReadOnlyParent( XmlNode n ) { 
            while (n != null) {
                switch (n.NodeType) { 
        ...
        /*internal*/ public XmlDocument Document {
            get {
        ...
        /*internal*/ public String GetNamespaceOfPrefixStrict(String prefix) { 
        ...
        /*internal*/ public String GetPrefixOfNamespaceStrict(String namespaceURI) { 
            XmlDocument doc = Document;
            if (doc != null) { 
        ...
        [System.Runtime.TargetedPatchingOptOutAttribute("Performance critical to inline across NGen image boundaries")]
        /*internal*/ public /*virtual*/ void SetParent( XmlNode node ) {
            if (node == null) {
        ...
        /*internal*/ public /*virtual*/ void SetParentForLoad( XmlNode node ) {
            this.parentNode = node;
        } 

        /*internal*/ public static void SplitName( String name, out String prefix, out String localName ) { 
        ...
        /*internal*/ public /*virtual*/ XmlNode FindChild( XmlNodeType type ) { 
            for (XmlNode child = FirstChild; child != null; child = child.NextSibling) {
        ...
        /*internal*/ public /*virtual*/ XmlNodeChangedEventArgs GetEventArgs( XmlNode node, XmlNode oldParent, XmlNode newParent, String oldValue, String newValue, XmlNodeChangedAction action  ) { 
            XmlDocument doc = OwnerDocument;
            if (doc != null) {
                if ( ! doc.IsLoading ) {
        ...
        /*internal*/ public /*virtual*/ void BeforeEvent( XmlNodeChangedEventArgs args ) {
            if (args != null) 
                OwnerDocument.BeforeEvent( args );
        } 
 
        /*internal*/ public /*virtual*/ void AfterEvent( XmlNodeChangedEventArgs args ) {
            if (args != null) 
                OwnerDocument.AfterEvent( args );
        }

        /*internal*/ public /*virtual*/ XmlSpace XmlSpace { 
            get {
                XmlNode node = this; 
        ...
        /*internal*/ public /*virtual*/ String XmlLang {
            get {
                XmlNode node = this;
                XmlElement elem = null; 
                do {
        ...
        /*internal*/ public /*virtual*/ XPathNodeType XPNodeType {
            get { 
                return (XPathNodeType)(-1);
            }
        }
 
        /*internal*/ public /*virtual*/ String XPLocalName {
            get { 
                return String.Empty; 
            }
        } 

        /*internal*/ public /*virtual*/ String GetXPAttribute(String localName, String namespaceURI) {
            return String.Empty;
        } 

        /*internal*/ public /*virtual*/ bool IsText { 
            get { 
                return false;
            } 
        }

        /*internal*/ public /*virtual*/ XmlNode PreviousText {
            get { 
                return null;
            } 
        } 

        /*internal*/ public static void NestTextNodes(XmlNode prevNode, XmlNode nextNode) { 
        ...
        /*internal*/ public static void UnnestTextNodes(XmlNode prevNode, XmlNode nextNode) { 
            Debug.Assert(prevNode.IsText);
            Debug.Assert(nextNode.IsText); 
...
//    [DebuggerDisplay("{ToString()}")] 
    /*internal*/ public struct DebuggerDisplayXmlNodeProxy {
