...
// Represents an entire document. An XmlDocument contains XML data.
    public class XmlDocument extends XmlNode { 
        ...
        private boolean actualLoadingStatus;
        ...
        /*internal*/ public boolean fEntRefNodesPresent; 
        /*internal*/ public boolean fCDataNodesPresent;

        private boolean preserveWhitespace;
        private boolean isLoading; 

        // special name strings for 
        /*internal*/ public String strDocumentName; 
        /*internal*/ public String strDocumentFragmentName;
        /*internal*/ public String strCommentName; 
        /*internal*/ public String strTextName;
        /*internal*/ public String strCDataSectionName;
        /*internal*/ public String strEntityName;
        /*internal*/ public String strID; 
        /*internal*/ public String strXmlns;
        /*internal*/ public String strXml; 
        /*internal*/ public String strSpace; 
        /*internal*/ public String strLang;
        /*internal*/ public String strEmpty; 

        /*internal*/ public String strNonSignificantWhitespaceName;
        /*internal*/ public String strSignificantWhitespaceName;
        /*internal*/ public String strReservedXmlns; 
        /*internal*/ public String strReservedXml;
 
        /*internal*/ public String baseURI; 

        private XmlResolver resolver; 
        /*internal*/ public boolean       bSetResolver;
        /*internal*/ public Object     objLock;

        private XmlAttribute namespaceXml; 

        static /*internal*/ public EmptyEnumerator EmptyEnumerator = new EmptyEnumerator(); 
        static /*internal*/ public IXmlSchemaInfo NotKnownSchemaInfo = new XmlSchemaInfo(XmlSchemaValidity.NotKnown); 
        static /*internal*/ public IXmlSchemaInfo ValidSchemaInfo = new XmlSchemaInfo(XmlSchemaValidity.Valid);
        static /*internal*/ public IXmlSchemaInfo InvalidSchemaInfo = new XmlSchemaInfo(XmlSchemaValidity.Invalid); 
        ...
        protected /*internal*/ public XmlDocument( XmlImplementation imp ) {
        	super();
        ...
        /*internal*/ public SchemaInfo DtdSchemaInfo { 
        ...
        /*internal*/ public static void CheckName( String name ) {
        ...
        /*internal*/ public XmlName AddXmlName(String prefix, String localName, String namespaceURI, IXmlSchemaInfo schemaInfo) {
        ...
        /*internal*/ public XmlName GetXmlName(String prefix, String localName, String namespaceURI, IXmlSchemaInfo schemaInfo) { 
        ...
        /*internal*/ public XmlName AddAttrXmlName(String prefix, String localName, String namespaceURI, IXmlSchemaInfo schemaInfo) { 
        ...
        /*internal*/ public boolean AddIdInfo( XmlName eleName, XmlName attrName ) {
        ...
        /*internal*/ public XmlName GetIDInfoByElement( XmlName eleName ) {
            if (htElementIDAttrDecl == null) 
                return null;
            else 
        ...
        private WeakReference GetElement(ArrayList elementList, XmlElement elem) {
            ...
            for/*each*/( WeakReference elemRef : elementList) {
                if ( !elemRef.IsAlive) 
            ...
            for/*each*/( WeakReference elemRef : gcElemRefs) 
                elementList.Remove(elemRef);
            return null; 
        } 

        /*internal*/ public void AddElementWithId( String id, XmlElement elem ) { 
        ...
        /*internal*/ public void RemoveElementWithId( String id, XmlElement elem ) { 
            if (htElementIdMap != null && htElementIdMap.Contains(id)) {
                ArrayList elementList = (ArrayList)(htElementIdMap[id]); 
        ...
        /*internal*/ public /*virtual*/ XmlDeclaration Declaration {
            get { 
                if ( HasChildNodes ) {
        ...
        /*internal*/ public /*override*/ boolean IsContainer {
            get { return true; }
        } 

        /*internal*/ public /*override*/ XmlLinkedNode LastNode 
        { 
        ...
        /*internal*/ public boolean CanReportValidity { 
            get { return reportValidity; }
        } 
 
        /*internal*/ public boolean HasSetResolver {
            get { return bSetResolver; } 
        }

        /*internal*/ public XmlResolver GetResolver() {
           return resolver; 
        }
        ...
        /*internal*/ public /*override*/ boolean IsValidChildType( XmlNodeType type ) {
            switch ( type ) {
        ...
        /*internal*/ public /*override*/ boolean CanInsertBefore( XmlNode newChild, XmlNode refChild ) {
            if ( refChild == null ) 
                refChild = FirstChild; 
        ...
        /*internal*/ public /*override*/ boolean CanInsertAfter( XmlNode newChild, XmlNode refChild ) { 
            if ( refChild == null ) 
                refChild = LastChild;
        ...
        /*internal*/ public void SetDefaultNamespace( String prefix, String localName, /*ref*/ String namespaceURI ) {
        ...
        /*internal*/ public void AddDefaultAttributes( XmlElement elem ) { 
        ...
        /*internal*/ public protected /*virtual*/ XPathNavigator CreateNavigator(XmlNode node) { 
        ...
        /*internal*/ public static boolean IsTextNode( XmlNodeType nt ) {
            switch( nt ) { 
                case XmlNodeType.Text: 
                case XmlNodeType.CDATA:
                case XmlNodeType.Whitespace: 
...
//        [System.Runtime.TargetedPatchingOptOutAttribute("Performance critical to inline across NGen image boundaries")]
        ...
        protected /*internal*/ public /*virtual*/ XmlAttribute CreateDefaultAttribute( String prefix, String localName, String namespaceURI ) {
        ...
        /*internal*/ public XmlNamedNodeMap Entities { 
            get {
                if ( entities == null ) 
        ...
        /*internal*/ public boolean IsLoading { 
            get { return isLoading;}
            set { isLoading = value; } 
        }

        /*internal*/ public boolean ActualLoadingStatus{
...
//        [PermissionSetAttribute( SecurityAction.InheritanceDemand, Name = "FullTrust" )] 
        ...
        /*internal*/ public XmlNodeType ConvertToNodeType( String nodeTypeString ) { 
...
//        [ResourceExposure(ResourceScope.Machine)]
        ...
        /*internal*/ public Encoding TextEncoding { 
            get { 
                if ( Declaration != null )
                { 
...
//        [ResourceExposure(ResourceScope.Machine)]
        ...
        /*internal*/ public /*override*/ XmlNodeChangedEventArgs GetEventArgs(XmlNode node, XmlNode oldParent, XmlNode newParent, String oldValue, String newValue, XmlNodeChangedAction action) { 
            reportValidity = false; 
        ...
        /*internal*/ public XmlNodeChangedEventArgs GetInsertEventArgsForLoad( XmlNode node, XmlNode newParent ) {
            if (onNodeInsertingDelegate == null && onNodeInsertedDelegate == null) {
                return null; 
            }
        ...
        /*internal*/ public /*override*/ void BeforeEvent( XmlNodeChangedEventArgs args ) {
            if ( args != null ) {
                switch ( args.Action ) {
                    case XmlNodeChangedAction.Insert: 
        ...
        /*internal*/ public /*override*/ void AfterEvent( XmlNodeChangedEventArgs args ) { 
            if ( args != null ) {
                switch ( args.Action ) { 
                    case XmlNodeChangedAction.Insert: 
        ...
        /*internal*/ public XmlAttribute GetDefaultAttribute( XmlElement elem, String attrPrefix, String attrLocalname, String attrNamespaceURI ) {
            SchemaInfo schInfo = DtdSchemaInfo;
            SchemaElementDecl ed = GetSchemaElementDecl( elem ); 
            if ( ed != null && ed.AttDefs != null ) {
                IDictionaryEnumerator attrDefs = ed.AttDefs.GetEnumerator(); 
        ...
        /*internal*/ public String Version { 
            get {
        ...
        /*internal*/ public String Encoding { 
            get {
                XmlDeclaration decl = Declaration; 
                if ( decl != null )
        ...
        /*internal*/ public String Standalone { 
            get {
                XmlDeclaration decl = Declaration; 
                if ( decl != null )
        ...
        /*internal*/ public XmlEntity GetEntityNode( String name ) { 
            if ( DocumentType != null ) {
        ...
        /*internal*/ public void SetBaseURI( String inBaseURI ) {
            baseURI = inBaseURI;
        }
 
        /*internal*/ public /*override*/ XmlNode AppendChildForLoad( XmlNode newChild, XmlDocument doc ) {
        ...
        /*internal*/ public /*override*/ XPathNodeType XPNodeType { get { return XPathNodeType.Root; } }

        /*internal*/ public boolean HasEntityReferences { 
            get {
                return fEntRefNodesPresent; 
            } 
        }
 
        /*internal*/ public XmlAttribute NamespaceXml {
            get {
