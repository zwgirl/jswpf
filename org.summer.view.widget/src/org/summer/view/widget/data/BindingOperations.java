...
import org.summer.view.widget.internal.LiveShapingBlock;
...
//            target.VerifyAccess();
        ...
        {
            return (Binding) GetBindingBase(target, dp) as Binding;
        } 
...
//            target.VerifyAccess(); 
        ...
        /// <exception cref="ArgumentNullException"> DependencyObject target cannot be null </exception>
        public static boolean IsDataBound(DependencyObject target, DependencyProperty dp) 
        { 
            if (target == null)
                throw new ArgumentNullException("target"); 
            if (dp == null)
...
//            target.VerifyAccess();
        ...
        public static boolean IsValidUpdateSourceTrigger(UpdateSourceTrigger value)
        { 
            switch (value)
            {
        ...
        // The following properties and methods have no private callers.  They
        ...
        private static boolean TraceAccessorTableSize 
        { 
        ...
        private static void OnCollectionRegistering(IEnumerable collection, Object parent) 
        {
        ...
        public static void OnCollectionViewRegistering(CollectionView view)
        {
