...
import org.summer.view.widget.internal.ElementObjectRef;
import org.summer.view.widget.internal.EventHandler;
import org.summer.view.widget.internal.ExplicitObjectRef;
...
public class Binding extends BindingBase
{
    ...
    enum SourceProperties //: byte 
    	{ None, RelativeSource, ElementName, Source, StaticSource, InternalSource; }
    ...
    /// </summary> 
    public static final RoutedEvent SourceUpdatedEvent =
    ...
    /// </summary> 
    public static final RoutedEvent TargetUpdatedEvent =
...
//    #pragma warning disable 7008 
    ...
    /// </summary> 
    public static final DependencyProperty XmlNamespaceManagerProperty=
    ...
    private static boolean IsValidXmlNamespaceManager(Object value)
    { 
...
//    [DefaultValue(true)]
    public boolean ValidatesOnNotifyDataErrors
    { 
        get
        { 
        ...
        set 
        {
            boolean currentValue = TestFlag(BindingFlags.ValidatesOnNotifyDataErrors);
            if (currentValue != value)
            { 
                CheckSealed();
    ...
    /// </summary>
//    [EditorBrowsable(EditorBrowsableState.Never)] 
    public boolean ShouldSerializePath()
    { 
...
//    [TypeConverter(typeof(System.Windows.CultureInfoIetfLanguageTagConverter))]
    ...
    /// </summary>
//    [EditorBrowsable(EditorBrowsableState.Never)] 
    public boolean ShouldSerializeSource()
    { 
...
//    [DefaultValue(null)]
    ...
    /// </remarks>
//    [DefaultValue(false)] 
    public boolean BindsDirectlyToSource
    {
...
//    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] 
    ...
    /// </summary> 
    public static final Object DoNothing = new NamedObject("Binding.DoNothing"); 
    ...
    ///     has been changed.
    /// </summary> 
    public /*const*/ static final String IndexerName = "Item[]";
    ...
    /// </summary> 
    /*internal*/ /*override*/public BindingExpressionBase CreateBindingExpressionOverride(DependencyObject target, DependencyProperty dp, BindingExpressionBase owner)
    { 
        return BindingExpression.CreateBindingExpression(target, dp, this, owner);
    }

    /*internal*/ /*override*/public ValidationRule LookupValidationRule(Type type) 
    {
    ...
    /*internal*/public Object DoFilterException(Object bindExpr, Exception exception) 
    { 
    ...
    /*internal*/public void UsePath(PropertyPath path)
    { 
        _ppath = path;
        SetFlag(BindingFlags.PathGeneratedInternally);
    }

    /*internal*/ /*override*/public BindingBase CreateClone()
    { 
        return new Binding(); 
    }

    /*internal*/public /*override*/ void InitializeClone(BindingBase baseClone, BindingMode mode)
    {
    ...
    /*internal*/public /*override*/ CultureInfo ConverterCultureInternal
    {
        get { return ConverterCulture; } 
    }

    /*internal*/public ObjectRef SourceReference 
    {
        get { return (_source == UnsetSource) ? null : _source; } 
        set { CheckSealed();  _source = value;  DetermineSource(); }
    }

    /*internal*/public boolean TreeContextIsRequired 
    {
        get 
        { 
            boolean treeContextIsRequired;
    ...
    /*internal*/public /*override*/ Collection<ValidationRule> ValidationRulesInternal
    {
        get 
        {
            return (ValidationRuleCollection)GetValue(Feature.ValidationRules, null); 
    ...
    /*internal*/public boolean TransfersDefaultValue 
    {
        get { return !_doesNotTransferDefaultValue; } 
        set { CheckSealed();  _doesNotTransferDefaultValue = !value; } 
    }

    /*internal*/ /*override*/ boolean ValidatesOnNotifyDataErrorsInternal
    {
    ...
    boolean                _isAsync; 
    boolean                _bindsDirectlyToSource;
    boolean                _doesNotTransferDefaultValue;   // initially = false

    int                 _attachedPropertiesInPath; 

    static final ObjectRef UnsetSource = new ExplicitObjectRef(null); 
    static final ObjectRef StaticSourceRef = new ExplicitObjectRef(BindingExpression.StaticSource); 
}
