...
import org.summer.view.widget.internal.DataBindOperation;
import org.summer.view.widget.internal.NamedObject;
import org.summer.view.widget.internal.SynchronizationInfo;
...
//            }
        ...
        { 
            ...
            IBindingList ibl;
            if (!(this instanceof BindingListCollectionView) || 
    ...
    /*internal*/ protected CollectionView(IEnumerable collection, boolean shouldProcessCollectionChanged)
    {  
    	this(collection);
...
//    #region Public Properties
    ...
    /// </summary>
    public /*virtual*/ boolean IsInUse
    {
...
//            }
    ...
    { 
        /*lock*/synchronized(_changeLog.SyncRoot)
        {
            _changeLog.Clear();
...
//    #region Protected Properties 
    ...
    /// </notes> 
    protected boolean AllowsCrossThreadChanges 
    {
        get { return CheckFlag(CollectionViewFlags.AllowsCrossThreadChanges); } 
    }

    /*internal*/ void SetAllowsCrossThreadChanges(boolean value)
    { 
        boolean oldValue = CheckFlag(CollectionViewFlags.AllowsCrossThreadChanges);
        if (oldValue == value) 
            return; 
...
//    #region Internal Methods 
    ...
    /*internal*/ /*virtual*/ boolean HasReliableHashCodes() 
    {
...
//        #pragma warning restore 1634, 1691 
    ...
    /*internal*/public ReadOnlyCollection<ItemPropertyInfo> GetItemProperties() 
    {
        ...
        for/*each*/ (Object property : properties)
        {
    ...
    /*internal*/ /*virtual*/ void GetCollectionChangedSources(int level, Action<Integer, Object, Boolean/*?*/, List<String>> format, List<String> sources)
    { 
...
//    #region Internal Types 
    ...
    /*internal*/ class PlaceholderAwareEnumerator extends IEnumerator 
    { 
...
//        Debug.Assert(changeLog != null && changeLog.Count > 0, "don't defer when there's no work"); 
    ...
    /// </param> 
    private ICollection ProcessChangeLog(ArrayList changeLog, boolean processAll/*=false*/)
    { 
        int currentIndex = 0;
...
//    #region Private Types 
    ...
    private class SimpleMonitor implements IDisposable
    { 
...
//    #region Private Fields
    ...
    int                     _timestamp; 
    static final ArrayList EmptyArrayList = new ArrayList();
    static final String IEnumerableT = typeof(IEnumerable<>).Name; 
    /*internal*/ static final Object NoNewItem = new NamedObject("NoNewItem"); 

    // since there's nothing in the uncancelable event args that is mutable, 
    // just create one instance to be used universally.
    static final CurrentChangingEventArgs uncancelableCurrentChangingEventArgs = new CurrentChangingEventArgs(false);

    /*internal*/public final String CountPropertyName = "Count"; 
    /*internal*/public final String IsEmptyPropertyName = "IsEmpty";
    /*internal*/public final String CulturePropertyName = "Culture"; 
    /*internal*/public final String CurrentPositionPropertyName = "CurrentPosition"; 
    /*internal*/public final String CurrentItemPropertyName = "CurrentItem";
    /*internal*/public final String IsCurrentBeforeFirstPropertyName = "IsCurrentBeforeFirst"; 
    /*internal*/public final String IsCurrentAfterLastPropertyName = "IsCurrentAfterLast";
