...
import org.summer.view.widget.controls.ExceptionValidationRule;
...
import org.summer.view.widget.internal.InheritanceContextChangedEventManager;
import org.summer.view.widget.internal.NamedObject;
import org.summer.view.widget.internal.ObjectRef;
import org.summer.view.widget.internal.ObjectRefArgs;
import org.summer.view.widget.internal.RelativeObjectRef;
import org.summer.view.widget.markup.XmlAttributeProperties;
...
/// </summary> 
public /*sealed*/ class BindingExpression extends BindingExpressionBase implements IDataBindEngineClient, IWeakEventListener
{ 
    //----------------------------------------------------- 
    //
    //  Enums 
    ...
    /*internal*/ public enum SourceType { Unknown, CLR, XML } 
...
//    }
//
//    public void /*IDataBindEngineClient.*/UpdateValue()
//    { 
//        UpdateValue(); 
//    }

    public boolean /*IDataBindEngineClient.*/AttachToContext(boolean lastChance)
    {
        AttachToContext(lastChance ? AttachAttempt.Last : AttachAttempt.Again);
        return (StatusInternal != BindingStatusInternal.Unattached); 
    }

    public void /*IDataBindEngineClient.*/VerifySourceReference(boolean lastChance) 
    {
...
//#region Expression overrides
    ...
    /*internal*/ public /*override*/ void OnPropertyInvalidation(DependencyObject d, DependencyPropertyChangedEventArgs args) 
    {
        ...
        boolean relevant = !IgnoreSourcePropertyChange; 
        ...
        super.OnPropertyInvalidation(d, args);
    }
...
//#endregion  Expression overrides
    ...
    // element.
    /*internal*/ public DependencyObject ContextElement 
    {
        get 
        { 
            if (_ctxElement != null)
    ...
    /*internal*/ public CollectionViewSource CollectionViewSource 
    {
        get 
        {
    ...
    /*internal*/ public boolean IgnoreSourcePropertyChange 
    { 
        get
        { 
    ...
    /*internal*/ public PropertyPath Path
    { 
        get { return ParentBinding.Path; }
    }

    /*internal*/ public IValueConverter Converter 
    {
    ...
    /*internal*/ public Type ConverterSourceType
    { 
    ...
    /*internal*/ public Object SourceValue
    { 
    ...
    /*internal*/ public /*override*/ boolean IsDisconnected 
    {
    ...
    /*internal*/ public static BindingExpression CreateBindingExpression(DependencyObject d, 
    ...
    /*internal*/ public void SetupDefaultValueConverter(Type type) 
    { 
...
//            }
    ...
    /*internal*/ public static boolean HasLocalDataContext(DependencyObject d)
    { 
...
//#region Attachment
    ...
    /// </summary> 
    /*internal*/ public /*override*/ boolean AttachOverride(DependencyObject target, DependencyProperty dp) 
    {
        if (!super.AttachOverride(target, dp)) 
            return false;
...
//        boolean traceObjectRef = TraceData.IsExtendedTraceEnabled(this, TraceDataLevel.SourceLookup); 
...
//                }
        ...
        boolean lastChance = (attempt == AttachAttempt.Last);
...
//                }
        ...
        boolean contextElementFound = true; 
        ...
        else 
        {
            ...
            { 
                Object o = ror.GetObject(mentor, new ObjectRefArgs() /*{ IsTracing = traceObjectRef} cym comment*/);
...
//#region Activation
    ...
    /*internal*/ public /*override*/ void Activate()
    { 
        if (!CanActivate)
            return;
...
//                            } 
                    ...
                    Activate(ParentBinding.SourceReference.GetDataObject(target,
                                                            new ObjectRefArgs() /*{ ResolveNamesInTemplate = ResolveNamesInTemplate } cym comment*/)); 
                }
            }
        }
        else 
...
//                }
    ...
    /*internal*/ public void Activate(Object item)
    {
        DependencyObject target = TargetElement;
        if (target == null) 
            return;
...
//        boolean isExtendedTraceEnabled = TraceData.IsExtendedTraceEnabled(this, TraceDataLevel.Activate);
...
//        }
        ...
        { 
            ...
            boolean useValueFromBindingGroup = (value == NullDataItem); 
    ...
    /*internal*/ public /*override*/ void Deactivate()
    { 
...
//        }
    ...
    /*internal*/ public /*override*/ void Disconnect()
    { 
    ...
    /**
     * if the root item is a DataSourceProvider, use its Data instead and listen for DataChanged events.  
     * (Unless overridden explicitly by the BindsDirectlyToSource property). 
     * @param item
     * @return
     */
...
//            } 
     ...
     */
    /*internal*/ public /*override*/ Object GetSourceItem(Object newValue)
    { 
        return SourceItem;
    }
...
//        Invariant.Assert(Worker == null, "duplicate call to CreateWorker");
     ...
     * @param newWorkerSources
     * @param n
     */
    /*internal*/ public void ChangeWorkerSources(WeakDependencySource[] newWorkerSources, int n)
    { 
        int offset = 0;
        int size = n;
        ...
        boolean usesLanguage = UsesLanguage; 
...
//#region Value
     ...
     *  transfer a value from the source to the target 
     * @param newValue
     * @param isASubPropertyChange
     */
    /*internal*/ public void TransferValue(Object newValue, boolean isASubPropertyChange)
    {
...
//            #endif
                else if (implicitConverter != null || EffectiveStringFormat != null)
                {
                    ...
                    // Our DefaultValueConverters are all /*internal*/ public and only use this target element 
...
//        }
        ...
        boolean realTransfer = !(IsInUpdate && Object.Equals(value, Value)); 
    ...
    { 
        ...
        boolean needDataErrorRule = ParentBinding.ValidatesOnDataErrors; 
...
//        #pragma warning restore 1634, 1691 
    ...
    /*internal*/ public void ScheduleTransfer(boolean isASubPropertyChange) 
    {
     ...
     */
    /*internal*/ public /*override*/ boolean UpdateOverride()
    { 
...
//        boolean isExtendedTraceEnabled = TraceData.IsExtendedTraceEnabled(this, TraceDataLevel.Update); 
//        if (isExtendedTraceEnabled)
//        { 
//            TraceData.Trace(TraceEventType.Warning,
...
//        }
    ...
    /*internal*/ public /*override*/ Object UpdateSource(Object value) 
    {
...
//        #pragma warning restore 1634, 1691
    ...
    { 
        ...
        boolean result = super.Validate(value, validationStep); 
        ...
        if (validationStep == ValidationStep.UpdatedValue)
        {
            if (result && ParentBinding.ValidatesOnDataErrors) 
            {
                ...
                if (error != null) 
                {
                    UpdateValidationError(error, false);
                    result = false;
                } 
...
//        Debug.Assert(NeedsValidation, "check NeedsValidation before calling this");
    ...
    private boolean IsValidValueForUpdate(Object value, Type sourceType) 
    {
    ...
    private void ProcessException(Exception ex, boolean validate)
    { 
...
//#region INotifyDataErrorInfo
    ...
    /*internal*/ public void UpdateNotifyDataErrors(INotifyDataErrorInfo indei, String propertyName, Object value) 
    {
        ...
        { 
            ...
            INotifyDataErrorInfo newDataErrorValue = (INotifyDataErrorInfo) (value instanceof INotifyDataErrorInfo ? value : null); 
    ...
    { 
        ...
        UpdateNotifyDataErrors((INotifyDataErrorInfo) (SourceItem instanceof INotifyDataErrorInfo ? SourceItem : null), SourcePropertyName, value);
    } 

    /*const*/static final int RetryCount = 3;   //从下面方法中移上来的
    // fetch errors for the given property
    /*internal*/ public static List<Object> GetDataErrors(INotifyDataErrorInfo indei, String propertyName)
    { 
...
//#region Event handlers
    ...
    /*internal*/ public void OnCurrentChanged(Object sender, EventArgs e) 
    { 
...
//        } 
        ...
        Worker.OnCurrentChanged(sender instanceof ICollectionView ? sender : null, e);
    } 

    /*internal*/ public void OnCurrentChanging(Object sender, CurrentChangingEventArgs e)
    {
//        if (TraceData.IsExtendedTraceEnabled(this, TraceDataLevel.Events)) 
//        {
//            TraceData.Trace(TraceEventType.Warning, 
...
//        }
    ...
    /*internal*/ public /*override*/ void OnLostFocus(Object sender, RoutedEventArgs e) 
    {
//        if (TraceData.IsExtendedTraceEnabled(this, TraceDataLevel.Events))
//        {
//            TraceData.Trace(TraceEventType.Warning, 
...
//#region Helper functions
    ...
    private boolean ExceptionFilterExists() 
    {
    ...
    //      { ... }
    /*internal*/ public IDisposable ChangingValue()
    {
        return new ChangingValueHelper(this); 
    }

    // cancel any pending work 
    /*internal*/ public void CancelPendingTasks()
    { 
    ...
    /*internal*/ public static void OnTargetUpdated(DependencyObject d, DependencyProperty dp) 
    {
    ...
    /*internal*/ public static void OnSourceUpdated(DependencyObject d, DependencyProperty dp) 
    { 
        DataTransferEventArgs args = new DataTransferEventArgs(d, dp);
...
//        } 
    ...
    private class ChangingValueHelper implements IDisposable
    {
        /*internal*/ public ChangingValueHelper(BindingExpression b) 
        {
...
//#endregion Helper functions 
    ...
    /*internal*/ public static final Object NullDataItem = new NamedObject("NullDataItem");
    /*internal*/ public static final Object IgnoreDefaultValue = new NamedObject("IgnoreDefaultValue"); 
    /*internal*/ public static final Object StaticSource = new NamedObject("StaticSource");
}
