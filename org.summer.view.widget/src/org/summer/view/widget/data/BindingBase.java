...
public abstract class BindingBase extends MarkupExtension
{ 
//    #region Constructors
...
//    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    public boolean ShouldSerializeFallbackValue() 
    {
...
//    [System.ComponentModel.DefaultValue(null)] 
    ...
    /// </summary> 
//    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    public boolean ShouldSerializeTargetNullValue() 
    {
...
//    #region Public Methods
    ...
    /// binding. 
    /// </summary>
    public final /*override*/ Object ProvideValue(IServiceProvider serviceProvider) 
    { 
...
//    #region Protected Methods
    ...
    /// </summary> 
    /*internal*/public abstract BindingExpressionBase CreateBindingExpressionOverride(DependencyObject targetObject, DependencyProperty targetProperty, BindingExpressionBase owner);

    /// <summary> Return true if any of the given flags are set. </summary>
    /*internal*/ boolean TestFlag(BindingFlags flag)
    {
    ...
    /*internal*/ void ChangeFlag(BindingFlags flag, boolean value)
    {
        if (value) 
            _flags |=  flag;
        else 
...
//    #region Internal Properties
    ...
    /*internal*/ /*virtual*/public CultureInfo ConverterCultureInternal 
    {
        get { return null; }
    }

    /*internal*/ /*virtual*/public Collection<ValidationRule> ValidationRulesInternal
    { 
        get { return null; } 
    }

    /*internal*/ /*virtual*/public boolean ValidatesOnNotifyDataErrorsInternal
    {
        get { return false; }
    } 
...
//    #region Internal Methods
    ...
    /// to the given DependencyProperty on the given DependencyObject. 
    /// </summary>
    /*internal*/public BindingExpressionBase CreateBindingExpression(DependencyObject targetObject, DependencyProperty targetProperty)
    {
        _isSealed = true; 
    ...
    /// to the given DependencyProperty on the given DependencyObject.
    /// </summary>
    /*internal*/public BindingExpressionBase CreateBindingExpression(DependencyObject targetObject, DependencyProperty targetProperty, BindingExpressionBase owner)
    { 
        _isSealed = true;
        return CreateBindingExpressionOverride(targetObject, targetProperty, owner); 
    } 

    // Throw if the binding is final. 
    ...
    /*internal*/public ValidationRule GetValidationRule(Type type)
    { 
    ...
    /*internal*/public /*virtual*/ ValidationRule LookupValidationRule(Type type) 
    {
        return null; 
    } 

    /*internal*/public static ValidationRule LookupValidationRule(Type type, Collection<ValidationRule> collection) 
    {
        if (collection == null)
            return null;
    ...
    /*internal*/public BindingBase Clone(BindingMode mode) 
    { 
    ...
    // initialize a clone 
    /*internal*/public /*virtual*/ void InitializeClone(BindingBase clone, BindingMode mode)
    { 
        clone._flags = _flags; 
...
//    #region Uncommon Values 
    ...
    /*internal*/ boolean      HasValue(Feature id) { return _values.HasValue((int)id); }
