...
//#region Internal Methods 
    ...
    /*internal*/public void AddToSubgroups(Object item, LiveShapingItem lsi, boolean loading)
    { 
...
//        Debug.Assert(Object.Equals(item, ProtectedItems[index]), "RemoveSpecialItem finds inconsistent data");
    ...
    /*internal*/public void MoveWithinSubgroups(Object item, LiveShapingItem lsi, IList list, int oldIndex, int newIndex) 
    {
        if (lsi == null)
        {
        ...
        { 
            ...
            else
            {
                ...
                for/*each*/ (CollectionViewGroupInternal group : lsi.ParentGroups) 
                {
    ...
    /*internal*/public void RestoreGrouping(LiveShapingItem lsi, List<AbandonedGroupItem> deleteList) 
    {
...
//                        { Group = parentGroup, ContainsItemDirectly = true }; cym comment
            for (;;) 
            {
...
//                        { Group = parentGroup, FirstChild = node }; cymcomment
                node = parentNode; 
            }
            return node; 
        } 
        ...
        { 
            ...
            for/*each*/ (CollectionViewGroupInternal group : parentGroups)
            { 
                node = new GroupTreeNode()
...
//                            { Group = parentGroup, FirstChild = node };  cym comment
                    list.Add(parentNode);
                } 
                else
                {
    ...
    {
        for/*each*/ (AbandonedGroupItem agi : deleteList) 
        { 
    ...
    class GroupTreeNode 
    {
        ...
        public boolean                        ContainsItem { get; set; } 
        public boolean                        ContainsItemDirectly { get; set; }
    }
...
//#endif // GROUPDESCRIPTION_HAS_SELECTOR 
    ...
    void AddToSubgroups(Object item, LiveShapingItem lsi, CollectionViewGroupInternal group, int level, boolean loading)
    {
        ...
        else if ((nameList = (ICollection) (name instanceof ICollection ? name: null)) == null) 
        {
    ...
    void AddToSubgroup(Object item, LiveShapingItem lsi, CollectionViewGroupInternal group, int level, Object name, boolean loading) 
    { 
...
//#region private fields 
    ...
    static final Object UseAsItemDirectly = new NamedObject("UseAsItemDirectly");
