...
///<summary> 
/// <seealso cref="ICollectionView"/> based on and associated to <seealso cref="List"/>.
///</summary> 
public class ListCollectionView extends CollectionView implements IComparer, IEditableCollectionViewAddNewItem, IItemProperties
{
    //-----------------------------------------------------
    // 
    //  Constructors
...
//    #region Constructors 
    ...
    public ListCollectionView(List list) 
    {
        super(list);
        _internalList = list; 
...
//    #region ICollectionView
    ...
    /// <summary>
    /// Re-create the view over the associated List 
    /// </summary>
    /// <remarks> 
    ...
    protected /*override*/ void RefreshOverride() 
    {
        ...
        List list = UpdatedOutsideDispatcher ? ShadowCollection : (SourceCollection as List);
    ...
    /// made about the item. This method will behave similarly to List.Contains()
...
//    #region IComparer 
    ...
    /// <remarks> 
    /// Compares items by their resp. index in the List. 
    /// </remarks>
...
//    #region Adding new items 
    ...
    Object AddNewCommon(Object newItem)
    {
        ...
        if (!(SourceList instanceof INotifyCollectionChanged)) 
        {
            // the index returned by List.Add isn't always reliable 
...
//        Debug.Assert(_newItemIndex != -2 && Object.Equals(newItem, _newItem), "AddNew did not raise expected events"); 
    ...
    // Calling List.Add() will raise an ItemAdded event.  We handle this specially
...
//    #region Removing items
    ...
    { 
        ...
        boolean raiseEvent = !(SourceList instanceof INotifyCollectionChanged); 
...
//    #region Transactional editing of an item 
    ...
    public void CommitEdit() 
    {
        ...
        boolean wasInView = (fromIndex >= 0);
        boolean isInView = wasInView ? PassesFilter(editItem)
...
//                        Debug.Assert(false, "Cannot update collection view from outside UIContext without index in event args"); 
    ...
    void ProcessCollectionChangedWithAdjustedIndex(NotifyCollectionChangedEventArgs args, int adjustedOldIndex, int adjustedNewIndex) 
    {
        ...
        switch (effectiveAction)
        {
            ...
            case NotifyCollectionChangedAction.Move: 
                ...
                boolean simpleMove = args.OldItems[0] == args.NewItems[0];
    ...
    /// </summary> 
    protected boolean InternalContains(Object item) 
    {
        if (item == NewItemPlaceholder) 
    ...
    /// </summary>
    protected boolean UsesLocalArray 
    { 
...
//    #region Internal Methods
    ...
    /*internal*/ boolean HasSortDescriptions
    { 
...
//    #region Private Properties 
    ...
    {
        get { return SourceCollection as List; } 
    }
...
//    #region Private Methods 
    ...
    private List PrepareLocalArray(List list) 
    { 
        if (list == null)
    ...
    private int AdjustBefore (NotifyCollectionChangedAction action, Object item, int index)
    {
        ...
        int delta = IsGrouping ? 0 : 
                    (NewItemPlaceholderPosition == NewItemPlaceholderPosition.AtBeginning)
                    ? (IsAddingNew ? 2 : 1) : 0;
        List ilFull = (UpdatedOutsideDispatcher ? ShadowCollection : SourceCollection) as List;
    ...
    private void PrepareSortAndFilter(List list)
    { 
...
//    #region Private Fields
    ...
    private boolean                _applyChangeToShadow = false;
    private boolean                _currentElementWasRemoved;  // true if we need to MoveCurrencyOffDeletedElement
    ...
    private boolean                _isItemConstructorValid;
    private ConstructorInfo     _itemConstructor; 

    private final int           _unknownIndex = -1;
