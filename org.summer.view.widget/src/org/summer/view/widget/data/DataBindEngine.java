...
import org.summer.view.widget.internal.CommitManager;
import org.summer.view.widget.internal.DataBindOperation;
import org.summer.view.widget.internal.DefaultValueConverter;
import org.summer.view.widget.internal.ValueConverterContext;
import org.summer.view.widget.internal.ViewManager;
...
public class DataBindEngine extends DispatcherObject
{ 
    //-----------------------------------------------------
    // 
    //  Nested classes 
    ...
    static class Task 
    {
        enum Status { Pending, Running, Completed, Retry, Cancelled }; 
        ...
        public void Run(boolean lastChance) 
        { 
            ...
            switch (op)
            {
                ...
                case /*TaskOps.*/AttachToContext: 
                    boolean succeeded = client.AttachToContext(lastChance); 
...
//    [SecurityCritical,SecurityTreatAsSafe] 
    ...
    public PathParser PathParser { get { return _pathParser; } } 
    protected ValueConverterContext ValueConverterContext { get { return _valueConverterContext; } }
    protected AccessorTable AccessorTable { get { return _accessorTable; } } 
    protected boolean IsShutDown { get { return (_viewManager == null); } } 
    ...
    protected IAsyncDataDispatcher AsyncDataDispatcher
    {
        get
        { 
    ...
    /// </summary> 
    public static DataBindEngine CurrentDataBindEngine 
    {
        get 
        {
    ...
    protected ViewManager ViewManager { get { return _viewManager; } }
    protected CommitManager CommitManager { get { if (!_commitManager.IsEmpty) ScheduleCleanup(); return _commitManager; } } 
    ...
    protected void AddTask(IDataBindEngineClient c, TaskOps op) 
    {
    ...
    protected void CancelTask(IDataBindEngineClient c, TaskOps op)
    { 
        // ignore requests that arrive after shutdown
        if (_mostRecentTask == null)
            return;
    ...
    protected void CancelTasks(IDataBindEngineClient c) 
    { 
        // ignore requests that arrive after shutdown
        if (_mostRecentTask == null) 
            return;
...
//            Invariant.Assert(task.client == c, "task list is corrupt"); 
    ...
    { 
        boolean lastChance = (boolean)arg;
    ...
    protected ViewRecord GetViewRecord(Object collection, CollectionViewSource key, Type collectionViewType, 
    		boolean createView, Func<Object, Object> GetSourceItem)
    {
        if (IsShutDown)
            return null; 
    ...
    protected void RegisterCollectionSynchronizationCallback(
    ...
    protected IValueConverter GetDefaultValueConverter(Type sourceType,
                                                    Type targetType, 
    ...
    protected void AddAsyncRequest(DependencyObject target, AsyncDataRequest request)
    {
        if (target == null) 
            return;
    ...
    protected Object GetValue(Object item, PropertyDescriptor pd, boolean indexerIsNext)
    { 
        return _valueTable.GetValue(item, pd, indexerIsNext);
    }

    // give the value cache first chance at handling property changes 
    protected void RegisterForCacheChanges(Object item, Object descriptor)
    { 
    ...
    protected DataBindOperation Marshal(DispatcherOperationCallback method, Object arg, int cost/*=1*/) 
    {
        DataBindOperation op = new DataBindOperation(method, arg, cost);
        /*lock*/synchronized (_crossThreadQueueLock)
        { 
    ...
    protected void ChangeCost(DataBindOperation op, int delta)
    {
    	/*lock*/synchronized (_crossThreadQueueLock)
        { 
            op.Cost += delta;
    ...
    { 
        ...
        {
            for/*each*/ (Object o : asyncDispatchers.Keys)
            { 
    ...
    // share the same converter)
    class ValueConverterTable extends Hashtable 
    {
        class Key
        {
            ...
            public Key(Type sourceType, Type targetType, boolean targetToSource) 
            {
            ...
            public static boolean operator==(Key k1, Key k2)
            {
        ...
        public IValueConverter this[Type sourceType, Type targetType, boolean targetToSource]
        { 
            get 
            {
        ...
        public void Add(Type sourceType, Type targetType, boolean targetToSource, IValueConverter value) 
        { 
            super.Add(new Key(sourceType, targetType, targetToSource), value);
        } 
    }

    private final class DataBindEngineShutDownListener extends ShutDownListener
    { 
        /// <SecurityNote>
...
//        [SecurityCritical,SecurityTreatAsSafe]
        ...
        protected /*override*/ void OnShutDown(Object target, Object sender, EventArgs e) 
        { 
    ...
    protected final int  CrossThreadThreshold = 50000;   // 50 msec
