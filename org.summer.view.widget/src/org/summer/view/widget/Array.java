...
import org.summer.view.widget.document.IndexOutOfRangeException;
import org.summer.view.widget.reflection.Binder.Default;
import org.summer.view.widget.utils.ArgumentOutOfRangeException;
import org.summer.view.widget.xml.ICloneable;
 public abstract class Array implements ICloneable, IList, IStructuralComparable, IStructuralEquatable 
    { 
        /// <internalonly/>
        /*internal*/ public Array() {}  // Don't call this.  Internal for ArrayContracts type. 
...
//#endif 
        /*internal*/ public static Array UnsafeCreateInstance(Type elementType, int length) 
        {
...
//        [PermissionSet(SecurityAction.Assert, Unrestricted = true)]
//#endif 
        /*internal*/ public static Array UnsafeCreateInstance(Type elementType, int length1, int length2) 
        {
...
//        [PermissionSet(SecurityAction.Assert, Unrestricted = true)]
//#endif 
        /*internal*/ public static Array UnsafeCreateInstance(Type elementType, params int[] lengths) 
        {
...
//        [PermissionSet(SecurityAction.Assert, Unrestricted = true)]
//#endif 
        /*internal*/ public static Array UnsafeCreateInstance(Type elementType, int[] lengths, int[] lowerBounds) 
        {
...
//        [ResourceExposure(ResourceScope.None)]
//        [MethodImplAttribute(MethodImplOptions.InternalCall)] 
        /*internal*/ public static /*extern*/ void Copy(Array sourceArray, int sourceIndex, Array destinationArray, int destinationIndex, int length, boolean reliable){
        	; 
        }
...
//        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.Success)] 
        ...
        /*internal*/ public const int MaxArrayLength = 0X7FEFFFFF; 
...
//        [ResourceExposure(ResourceScope.None)]
//        [MethodImplAttribute(MethodImplOptions.InternalCall)] 
        /*internal*/ public extern int GetDataPtrOffsetInternal();
        ...
        /*internal*/ public static int CombineHashCodes(int h1, int h2) { 
            return (((h1 << 5) + h1) ^ h2); 
        }
...
//        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)] 
        public static int BinarySearch(Array array, int index, int length, Object value, IComparer comparer) {
            ...
            if (comparer == Comparer.Default) {
                int retval; 
                boolean r = TrySZBinarySearch(array, index, length, value, out retval); 
                if (r)
                    return retval; 
            }
...
//        [MethodImplAttribute(MethodImplOptions.InternalCall)] 
//        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
        private static extern boolean TrySZBinarySearch(Array sourceArray, int sourceIndex, int count, Object value, out int retVal); 
...
//        [ComVisible(false)] 
        ...
        public static boolean Exists<T>(T[] array, Predicate<T> match) {
...
//        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
        public static int IndexOf(Array array, Object value, int startIndex, int count) { 
            ...
            int retVal; 
            boolean r = TrySZIndexOf(array, startIndex, count, value, out retVal); 
            if (r)
                return retVal; 
...
//        [MethodImplAttribute(MethodImplOptions.InternalCall)] 
//        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
        private static extern boolean TrySZIndexOf(Array sourceArray, int sourceIndex, int count, Object value, out int retVal); 
...
//        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
        public static int LastIndexOf(Array array, Object value, int startIndex, int count) { 
            ...
            // Try calling a quick native method to handle primitive types.
            int retVal; 
            boolean r = TrySZLastIndexOf(array, startIndex, count, value, out retVal); 
            if (r)
                return retVal; 
...
//        [MethodImplAttribute(MethodImplOptions.InternalCall)]
//        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
        private static extern boolean TrySZLastIndexOf(Array sourceArray, int sourceIndex, int count, Object value, out int retVal);
...
//        [ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
        public static void Reverse(Array array, int index, int length) { 
            ...
            boolean r = TrySZReverse(array, index, length);
            if (r)
                return; 
...
//        [MethodImplAttribute(MethodImplOptions.InternalCall)] 
//        [ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
        private static extern boolean TrySZReverse(Array array, int index, int count); 
        ...
        public static void Sort(Array keys, Array items, int index, int length, IComparer comparer) { 
            ...
            if (length > 1) {
                if (comparer == Comparer.Default || comparer == null) {
                    boolean r = TrySZSort(keys, items, index, index + length - 1); 
                    if (r)
                        return; 
                } 
...
//        [MethodImplAttribute(MethodImplOptions.InternalCall)]
//        [ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)] 
        private static extern boolean TrySZSort(Array keys, Array items, int left, int right);
...
//#endif 
        ...
        public static boolean TrueForAll<T>(T[] array, Predicate<T> match) { 
            if( array == null) {
                throw new ArgumentNullException("array"); 
            }
        ...
        /*internal*/ public /*sealed*/ class FunctorComparer<T> : IComparer<T> { 
        ...
        { 
            ...
            /*internal*/ public SorterObjectArray(Object[] keys, Object[] items, IComparer comparer) { 
                if (comparer == null) comparer = Comparer.Default;
                this.keys = keys;
                this.items = items;
            ...
            /*internal*/ public void SwapIfGreaterWithItems(int a, int b) 
            {
                if (a != b) 
                {
            ...
            /*internal*/ public void IntrospectiveSort(int left, int length) 
            {
                if (length < 2) 
                    return; 
        ...
        { 
            ...
            /*internal*/ public SorterGenericArray(Array keys, Array items, IComparer comparer)
            {
                if (comparer == null) comparer = Comparer.Default; 
                this.keys = keys;
                this.items = items; 
...
//        [Serializable] 
        private /*sealed*/ class SZArrayEnumerator : IEnumerator, ICloneable 
        {
            ...
            /*internal*/ public SZArrayEnumerator(Array array) { 
        ...
        { 
            ...
            /*internal*/ public ArrayEnumerator(Array array, int index, int count) {
                this.array = array; 
                this.index = index - 1;
                startIndex = index; 
...
//        [SecuritySafeCritical]
        /*internal*/ public IEnumerator<T> GetEnumerator<T>() { 
...
//        [SecuritySafeCritical]
        /*internal*/ public int get_Count<T>() { 
            //! Warning: "this" is an array, not an SZArrayHelper. See comments above
            //! or you may introduce a security hole!
            T[] _this = JitHelpers.UnsafeCast<T[]>(this);
            return _this.Length; 
        ...
        // ----------------------------------------------------------- 
//        [SecuritySafeCritical]
        /*internal*/ public T get_Item<T>(int index) {
            //! Warning: "this" is an array, not an SZArrayHelper. See comments above
            //! or you may introduce a security hole! 
            T[] _this = JitHelpers.UnsafeCast<T[]>(this);
...
//        [SecuritySafeCritical] 
        /*internal*/ public void set_Item<T>(int index, T value) {
            //! Warning: "this" is an array, not an SZArrayHelper. See comments above 
            //! or you may introduce a security hole! 
            T[] _this = JitHelpers.UnsafeCast<T[]>(this);
            if ((uint)index >= (uint)_this.Length) { 
...
//        [Serializable] 
        private /*sealed*/ class SZGenericArrayEnumerator<T> : IEnumerator<T> {
            ...
            /*internal*/ public SZGenericArrayEnumerator(T[] array) { 
