...
//    [TypeConverter(typeof(System.Windows.Markup.SystemKeyConverter))] 
    /*internal*/ public class SystemResourceKey extends ResourceKey 
//#else
//    /*internal*/ public static class SystemResourceKey 
//#endif
    {
        //
        // This is the enum range representing the original SystemResource[Key]s. 
        //
        private final short SystemResourceKeyIDStart = (short)SystemResourceKeyID.InternalSystemColorsStart; 
        private final short SystemResourceKeyIDEnd = (short)SystemResourceKeyID.InternalSystemThemeStylesEnd; 

        // 
        // This is the enum range representing the extended SystemResource[Key]s.
        //
        private final short SystemResourceKeyIDExtendedStart = (short)SystemResourceKeyID.InternalSystemColorsExtendedStart;
        private final short SystemResourceKeyIDExtendedEnd = (short)SystemResourceKeyID.InternalSystemColorsExtendedEnd; 

        // 
        // This is the BAML id range representing the original SystemResourceKeys. 
        //
        private final short SystemResourceKeyBAMLIDStart = SystemResourceKeyIDStart; 
        private final short SystemResourceKeyBAMLIDEnd = SystemResourceKeyIDEnd;

        //
        // This is the BAML id range representing the original SystemResources. 
        //
        private final short SystemResourceBAMLIDStart = SystemResourceKeyBAMLIDEnd; 
        private final short SystemResourceBAMLIDEnd = (short)(SystemResourceBAMLIDStart + (SystemResourceKeyBAMLIDEnd - SystemResourceKeyBAMLIDStart)); 

        // 
        // This is the BAML id range representing the extended SystemResourceKeys.
        //
        private final short SystemResourceKeyBAMLIDExtendedStart = SystemResourceBAMLIDEnd;
        private final short SystemResourceKeyBAMLIDExtendedEnd = (short)(SystemResourceKeyBAMLIDExtendedStart + (SystemResourceKeyIDExtendedEnd - SystemResourceKeyIDExtendedStart)); 

        // 
        // This is the BAML id range representing the extended SystemResources. 
        //
        private final short SystemResourceBAMLIDExtendedStart = SystemResourceKeyBAMLIDExtendedEnd; 
        private final short SystemResourceBAMLIDExtendedEnd = (short)(SystemResourceBAMLIDExtendedStart + (SystemResourceKeyBAMLIDExtendedEnd - SystemResourceKeyBAMLIDExtendedStart));

//#if !PBTCOMPILER
        /*internal*/ public static short GetSystemResourceKeyIdFromBamlId(short bamlId, /*out*/ boolean isKey) 
        {
            isKey = true; 
...
//#endif
        ...
        /*internal*/ public static short GetBamlIdBasedOnSystemResourceKeyId(Type targetType, String memberName)
        { 
            short memberId = 0;
            ...
            if (found) 
            {
                boolean isExtended = ((short)srkId > SystemResourceKeyIDExtendedStart && 
...
//#if !PBTCOMPILER
        /*internal*/ public Object Resource
        { 
            get
            { 
                // ************************************************************************************* 
        ...
        /*internal*/ public static ResourceKey GetResourceKey(short id) 
        { 
            switch (id)
            { 
        ...
        /*internal*/ public static ResourceKey GetSystemResourceKey(String keyName)
        {
            switch (keyName) 
            {
        ...
        /*internal*/ public static Object GetResource(short id) 
        {
        ...
        /// </summary> 
        /// <param name="id">The /*internal*/ public, unique ID of the system resource.</param> 
        /*internal*/ public SystemResourceKey(SystemResourceKeyID id)
        { 
        ...
        /*internal*/ public SystemResourceKeyID InternalKey 
        {
            get
            {
                return _id; 
...
//        #region ResourceKeys 
        ...
        /*internal*/ public static ComponentResourceKey DataGridFocusBorderBrushKey
        {
            get 
            {
        ...
        /*internal*/ public static ComponentResourceKey DataGridComboBoxColumnTextBlockComboBoxStyleKey 
        { 
            get
            { 
        ...
        /*internal*/ public static ResourceKey MenuItemSeparatorStyleKey
        {
            get
            { 
        ...
        /*internal*/ public static ComponentResourceKey DataGridColumnHeaderColumnFloatingHeaderStyleKey 
        {
            get 
            { 
        ...
        /*internal*/ public static ComponentResourceKey DataGridColumnHeaderColumnHeaderDropSeparatorStyleKey
        { 
            get
            {
        ...
        /*internal*/ public static ResourceKey GridViewItemContainerStyleKey
        { 
            get
            { 
        ...
        /*internal*/ public static ResourceKey GridViewScrollViewerStyleKey 
        {
            get 
            {
        ...
        /*internal*/ public static ResourceKey GridViewStyleKey
        {
            get 
            {
        ...
        /*internal*/ public static ResourceKey StatusBarSeparatorStyleKey 
        { 
            get
            { 
        ...
        /*internal*/ public static ResourceKey ToolBarButtonStyleKey 
        {
            get
            {
        ...
        /// </summary> 
        /*internal*/ public static ResourceKey ToolBarToggleButtonStyleKey 
        {
            get 
            {
        ...
        /// </summary>
        /*internal*/ public static ResourceKey ToolBarSeparatorStyleKey 
        {
            get 
            { 
        ...
        /// </summary>
        /*internal*/ public static ResourceKey ToolBarCheckBoxStyleKey
        {
            get 
            {
        ...
        /// </summary> 
        /*internal*/ public static ResourceKey ToolBarRadioButtonStyleKey
        { 
            get
            {
        ...
        /// </summary>
        /*internal*/ public static ResourceKey ToolBarComboBoxStyleKey 
        { 
            get
            { 
        ...
        /// </summary>
        /*internal*/ public static ResourceKey ToolBarTextBoxStyleKey 
        {
            get 
            { 
        ...
        /// </summary>
        /*internal*/ public static ResourceKey ToolBarMenuStyleKey
        {
            get 
            {
