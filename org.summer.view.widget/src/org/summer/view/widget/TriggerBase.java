...
//    [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
    ...
    /*internal*/ public  boolean HasEnterActions { get { return _enterActions != null && _enterActions.Count > 0; } } 
...
//    [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
    ...
    // Internal way to check without triggering a pointless allocation 
    /*internal*/ public  boolean HasExitActions { get { return _exitActions != null && _exitActions.Count > 0; } }

//Here's the /*internal*/ public  version that does what Robby thinks it should do.
    /*internal*/ public  boolean ExecuteEnterActionsOnApply
    {
        get 
        {
            return true; 
    ...
    /*internal*/ public  boolean ExecuteExitActionsOnApply
    {
        get
        { 
            return false;
...
/*  Here's the version that looks like a public API.  (Needs Style/Template parser changes before these will actually parse.) 
    ...
    [DefaultValue(false)] 
    public boolean ExecuteEnterActionsOnApply
    { 
        get 
        {
    ...
    /// </summary> 
    [DefaultValue(false)]
    public boolean ExecuteExitActionsOnApply 
    {
        get
        {
...
*/
    ...
    /// </summary>
    /*internal*/ public  void ProcessParametersContainer(DependencyProperty dp) 
    {
    ...
    /// </summary> 
    /*internal*/ public  String ProcessParametersVisualTreeChild(DependencyProperty dp, String target)
    { 
        if (target == null)
        {
    ...
    /// </remarks> 
    /*internal*/ public  void AddToPropertyValues(String childName, DependencyProperty dp, Object value, PropertyValueType valueType)
    { 
        // Store original data 
    ...
    /*internal*/ public  void ProcessSettersCollection(SetterBaseCollection setters)
    {
    ...
    /*internal*/ public  /*virtual*/ boolean GetCurrentState(DependencyObject container, UncommonField<HybridDictionary[]> dataField) 
    { 
//        Debug.Assert( false,
//            "This method was written to handle Trigger, MultiTrigger, DataTrigger, and MultiDataTrigger.  It looks like a new trigger type was added - please add support as appropriate."); 
    ...
    /*internal*/ public  TriggerCondition[] TriggerConditions 
    { 
...
//    private boolean _executeEnterActionsOnApply = false;
//    private boolean _executeExitActionsOnApply = false; 
