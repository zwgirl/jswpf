...
// 
    ...
    //
    public class DependentList extends FrugalObjectList<Dependent> 
    {
        ...
        public void InvalidateDependents(DependencyObject source, DependencyPropertyChangedEventArgs sourceArgs) 
        {
            ...
            Dependent[] snapList = super.ToArray();
        ...
        { 
            ...
            boolean runIsValid = false;    // whether run contains valid or invalid entries
    ...
    { 
        ...
        public static boolean operator== (Dependent first, Dependent second)
        {
