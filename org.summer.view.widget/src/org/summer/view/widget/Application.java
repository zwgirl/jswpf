...
import org.summer.view.widget.NavigationStateChange.NestedBamlLoadInfo;
import org.summer.view.widget.NavigationStateChange.ShutdownMode;
import org.summer.view.widget.NavigationStateChange.ShutdownMode.ShutdownMode.ReasonSessionEnding;
...
//    #region Application Class 
    ...
    /// </summary>
    public class Application extends DispatcherObject implements IHaveResources, IQueryAmbient
    { 
...
//                    Debug.Assert(_appInstance == null, "_appInstance must be null here.");
            ...
            Dispatcher.BeginInvoke( 
                DispatcherPriority.Send,
                (DispatcherOperationCallback) new /* cym add new*/delegate(Object unused)
                {
...
//        [SecurityCritical]
        ...
        /// </summary>
        protected static boolean InBrowserHostedApp() 
        {
        ...
        protected Object GetService(Type serviceType)
        {
            ...
            // service for IBrowserCallbackServices which is protected. 
...
//        [SecurityCritical]
        ...
        /// </SecurityNote>
//        [SecurityCritical]
        protected void CriticalShutdown(int exitCode) 
        {
            VerifyAccess(); 
            //Already called once?? 
        ...
        //
        // protected routine only look up in application resources 
        //
        protected Object FindResourceInternal(Object resourceKey)
        {
            // Call Forwarded 
            return FindResourceInternal(resourceKey, false /*allowDeferredResourceReference*/, false /*mustReturnDeferredResourceReference*/);
        } 
 
        protected Object FindResourceInternal(Object resourceKey, boolean allowDeferredResourceReference, boolean mustReturnDeferredResourceReference)
        { 
            ResourceDictionary resources = _resources;
...
//        [SecurityCritical] 
        public static void LoadComponent(Object component, Uri resourceLocator) 
        {
            ...
            boolean bCloseStream = true;  // Whether or not to close the stream after LoadBaml is done. 
        ...
        ///           Part is not exposed. 
        /// 
        ///           This protected method is called only by the public LoadComponent(uri) and
...
//        [SecurityCritical, SecurityTreatAsSafe] 
        protected static Object LoadComponent(Uri resourceLocator, boolean bSkipJournaledProperties)
        { 
            // 
        ...
        //
        protected static Object LoadBamlStreamWithSyncInfo(Stream stream, ParserContext pc)
        { 
...
//        [SecurityCritical] 
        ...
        { 
            ...
            // Using PackUriHelper.ValidateAndGetPackUriComponents protected method
...
//        [Ambient]
        public ResourceDictionary Resources 
        {
            ...
            set 
            {
                boolean invalidateResources = false; 
        ...
        public ResourceDictionary /*IHaveResources.*/Resources 
        {
            get { return Resources; }
            set { Resources = value; }
        } 

        boolean /*IQueryAmbient.*/IsAmbientPropertyAvailable(String propertyName) 
        { 
        ...
        protected boolean HasImplicitStylesInResources 
        { 
...
//        #region protected Methods
        ...
        // It would be nice to make this FamANDAssem (protected and protected) if c# supported it
        protected /*virtual*/ void PerformNavigationStateChangeTasks(
            boolean isNavigationInitiator, boolean playNavigatingSound, NavigationStateChange state)
        { 
        ...
        /// </SecurityNote> 
//        [SecurityCritical, SecurityTreatAsSafe]
        protected void UpdateBrowserCommands() 
        { 
...
//            Debug.Assert(CheckAccess() == true, "DoShutdown can only be called on the Dispatcer thread"); 
        ...
        /// </SecurityNote> 
//        [SecurityCritical]
        protected int RunInternal(Window window) 
        {
            VerifyAccess();
...
//                        },
        ...
        protected void InvalidateResourceReferences(ResourcesChangeInfo info) 
        {
        ...
        /// </SecurityNote>
//        [SecurityCritical] 
        protected NavigationWindow GetAppWindow()
        { 
        ...
        protected void FireNavigating(NavigatingCancelEventArgs e, boolean isInitialNavigation) 
        { 
        ...
        protected void FireNavigated(NavigationEventArgs e) 
        {
            OnNavigated(e); 
        } 

        protected void FireNavigationProgress(NavigationProgressEventArgs e) 
        {
            OnNavigationProgress(e);
        }
 
        protected void FireNavigationFailed(NavigationFailedEventArgs e)
        { 
        ...
        protected void FireLoadCompleted(NavigationEventArgs e) 
        {
        ...
        protected void FireNavigationStopped(NavigationEventArgs e)
        {
        ...
        protected void FireFragmentNavigation(FragmentNavigationEventArgs e) 
        {
...
//        #region protected Properties 
        ...
        protected WindowCollection WindowsInternal 
        {
            get
            {
            	/*lock*/synchronized(_globalLock) 
        ...
        protected WindowCollection NonAppWindowsInternal 
        {
            get 
            { 
            	/*lock*/synchronized(_globalLock)
...
//            [SecurityCritical]
        ...
        protected IBrowserCallbackServices BrowserCallbackServices
        { 
            get
            { 
                VerifyAccess(); 
...
//            [SecurityCritical, SecurityTreatAsSafe]
        ...
        protected static boolean IsApplicationObjectShuttingDown 
        {
            get 
            {
                return _isShuttingDown;
...
//            [SecurityCritical]
        ...
        // 
        public Uri ApplicationMarkupBaseUri
        {
            get
            { 
...
//        [SecurityCritical, SecurityTreatAsSafe]
        ...
        private IntPtr AppFilterMessage(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref boolean handled)
        { 
        ...
        private boolean WmActivateApp(Int32 wParam)
        { 
            int temp = wParam; 
            boolean isActivated = (temp == 0? false : true);
 
            // Event handler exception continuality: if exception occurs in Activate/Deactivate event handlers, our state would not
            // be corrupted because no protected state are affected by Activate/Deactivate. Please check Event handler exception continuality
...
//        [SecuritySafeCritical]
        private boolean WmQueryEndSession(IntPtr lParam, /*ref*/ IntPtr refInt)
        {
            ...
            // be corrupted because no protected state are affected by SessionEnding. Please check Event handler exception continuality
        ...
        {
            boolean hasImplicitStyles  = info.IsResourceAddOperation && HasImplicitStylesInResources;
...
//        [SecurityCritical]
        ...
        private static boolean IsValidShutdownMode(ShutdownMode value) 
        {
...
//        [SecurityCritical, SecurityTreatAsSafe]
        ...
        /// </SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe] 
        private void ChangeBrowserDownloadState(boolean newState) 
        {
            IBrowserCallbackServices ibcs = (IBrowserCallbackServices)this.GetService(typeof(IBrowserCallbackServices)); 
            if (ibcs != null)
            {
...
//        [SecurityCritical] 
        ...
        // 
        private static boolean IsComponentBeingLoadedFromOuterLoadBaml(Uri curComponentUri)
        {
...
//        #region Private Fields
        ...
        static private boolean                             _isShuttingDown;
        static private boolean                             _appCreatedInThisAppDomain; 
...
//        [ThreadStatic]
        ...
        private boolean                        _ownDispatcherStarted;
        ...
        private boolean                        _appIsShutdown;
...
//        [SecurityCritical]
        ...
        private boolean                        _hasImplicitStylesInResources;
 
        private static final Object EVENT_STARTUP = new Object(); 
        private static final Object EVENT_EXIT = new Object();
        private static final Object EVENT_SESSIONENDING = new Object(); 

        private /*const*/ static final SafeNativeMethods.PlaySoundFlags PLAYSOUND_FLAGS = SafeNativeMethods.PlaySoundFlags.SND_FILENAME |
        ...
        private /*const*/ static final String SYSTEM_SOUNDS_REGISTRY_LOCATION            = @"AppEvents\Schemes\Apps\Explorer\{0}\.current\"; 
        private /*const*/ static final String SYSTEM_SOUNDS_REGISTRY_BASE                = @"HKEY_CURRENT_USER\AppEvents\Schemes\Apps\Explorer\"; 
        private /*const*/ static final String SOUND_NAVIGATING                           = "Navigating";
        private /*const*/ static final String SOUND_COMPLETE_NAVIGATION                  = "ActivatingDocument"; 
...
//        #region NavigationStateChange 
        protected enum NavigationStateChange //: byte
        {
            Navigating,
            Completed, 
            Stopped,
