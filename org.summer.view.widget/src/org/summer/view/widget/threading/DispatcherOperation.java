...
//        [SecuritySafeCritical] 
        ...
        /// </SecurityNote>
//        [SecurityCritical] 
        /*internal*/ public DispatcherOperation( 
...
//        [SecurityCritical] 
        ...
        /// </SecurityNote> 
//        [SecurityCritical]
        /*internal*/ public void InvokeCompletions() 
        { 
            switch(_status)
            { 
...
//        [SecurityCritical]
        ...
        private class DispatcherOperationFrame extends DispatcherFrame 
        { 
...
//        [SecurityCritical]
        ...
        private static final ContextCallback _invokeInSecurityContext;
 
        private final Dispatcher _dispatcher;
        private DispatcherPriority _priority; 
        /*internal*/ public final Delegate _method; 
        private final Object _args;
        private final int _numArgs; 

        /*internal*/ public DispatcherOperationStatus _status; // set from Dispatcher
        private Object _result;
        private Exception _exception; 

        /*internal*/ public PriorityItem<DispatcherOperation> _item; // The Dispatcher sets this when it enques/deques the item. 
 
        EventHandler _aborted;
        EventHandler _completed; 

        /*internal*/ public final DispatcherOperationTaskSource _taskSource; // also used from Dispatcher
        private final boolean _useAsyncSemantics;
    } 
