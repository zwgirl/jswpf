...
//    [FriendAccessAllowed] // Built into Base, also used by Framework. 
    /*internal*/ public /*virtual*/ void Seal() 
    {
...
//    [FriendAccessAllowed] // Built into Base, also used by Core.
    /*internal*/ public EffectiveValueEntry GetValueEntry( 
...
//            Debug.Assert(reference != null, "the only modified values that can have deferredreferences are (a) expression, (b) coerced control value"); 
    ...
    /// <summary> 
    ///     Sets the local value of a property 
    /// The purpose of this /*internal*/ public method is to reuse BooleanBoxes when setting boolean value
    /// </summary> 
    /// <param name="dp">Dependency property</param>
    /// <param name="value">New local value</param>
//    [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
    /*internal*/ public void SetValue(DependencyProperty dp, boolean value) 
    {
    ...
    /// <param name="value">New local value</param>
//    [FriendAccessAllowed] // Built into Base, also used by Core and Framework. 
    /*internal*/ public void SetCurrentValue(DependencyProperty dp, boolean value) 
    {
    ...
    /// <param name="value">New local value</param>
//    [FriendAccessAllowed] // Built into Base, also used by Core and Framework. 
    /*internal*/ public void SetValueInternal(DependencyProperty dp, Object value)
    {
        // Do not allow foreign threads access.
        // (This is a noop if this Object is not assigned to a Dispatcher.) 
        //
    ...
    /// <param name="value">New local value</param>
//    [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
    /*internal*/ public void SetCurrentValueInternal(DependencyProperty dp, Object value) 
    {
        // Do not allow foreign threads access. 
        // (This is a noop if this Object is not assigned to a Dispatcher.) 
        //
    ...
    /// </summary>
//    [FriendAccessAllowed] // Built into Base, also used by Framework.
    /*internal*/ public void SetDeferredValue(DependencyProperty dp, DeferredReference deferredReference) 
    {
        // Cache the metadata Object this method needed to get anyway. 
        PropertyMetadata metadata = SetupPropertyChange(dp); 
    ...
    /// </summary> 
//    [FriendAccessAllowed] // Built into Base, also used by Framework. 
    /*internal*/ public void SetCurrentDeferredValue(DependencyProperty dp, DeferredReference deferredReference)
    { 
        // Cache the metadata Object this method needed to get anyway.
        PropertyMetadata metadata = SetupPropertyChange(dp);
    ...
    /// </summary>
//    [FriendAccessAllowed] // Built into Base, also used by Framework.
    /*internal*/ public void SetMutableDefaultValue(DependencyProperty dp, Object value)
    { 
        // Cache the metadata Object this method needed to get anyway.
        PropertyMetadata metadata = SetupPropertyChange(dp); 
    ...
    /// <param name="value">New local value</param>
//    [FriendAccessAllowed] // Built into Base, also used by Core and Framework. 
    /*internal*/ public void SetValue(DependencyPropertyKey dp, boolean value)
    {
        SetValue(dp, /*MS.Internal.KnownBoxes.BooleanBoxes.Box(*/value);
    } 
...
//            Debug.Assert(!coerceWithCurrentValue, "Don't call SetCurrentValue with UnsetValue");
        ...
        { 
            ...
            { 
                ...
                newExpr = (Expression) (value instanceof Expression ? value : null);
                if (newExpr != null)
                { 
                    ...
                    {
                        throw new IllegalArgumentException(/*SR.Get(SRID.SharingNonSharableExpression)*/); 
                    }
                ...
                { 
                    ...
                    { 
                        ...
                        { 
                            ...
                            throw new IllegalArgumentException(/*SR.Get(SRID.InvalidPropertyValue, value, dp.Name)*/);
                        } 
                    }
                }
            }
...
//    [FriendAccessAllowed] // Built into Base, also used by Core & Framework. 
    /*internal*/ public boolean ProvideSelfAsInheritanceContext( Object value, DependencyProperty dp )
    { 
...
//    [FriendAccessAllowed] // Built into Base, also used by Core & Framework.
    /*internal*/ public boolean ProvideSelfAsInheritanceContext( DependencyObject doValue, DependencyProperty dp ) 
    {
    ...
    // 
//    [FriendAccessAllowed] // Built into Base, also used by Core & Framework.
    /*internal*/ public boolean RemoveSelfAsInheritanceContext( Object value, DependencyProperty dp ) 
    {
        DependencyObject doValue = value as DependencyObject;
        if (doValue != null)
        { 
...
//    [FriendAccessAllowed] // Built into Base, also used by Core & Framework. 
    /*internal*/ public boolean RemoveSelfAsInheritanceContext( DependencyObject doValue, DependencyProperty dp )
    { 
    ...
    /// </summary> 
    /*internal*/ public boolean ContainsValue(DependencyProperty dp)
    { 
        EntryIndex entryIndex = LookupEntry(dp.GlobalIndex); 
    ...
    //
    /*internal*/ public static void ChangeExpressionSources(Expression expr, DependencyObject d, DependencyProperty dp, DependencySource[] newSources) 
    {
        ...
        { 
            ...
            {
                throw new IllegalArgumentException(/*SR.Get(SRID.SourceChangeExpressionMismatch)*/); 
            } 
        }
    ...
    ///
    /// This is being done as an /*internal*/ public method to enable the performance
    ///  bug #1114409.  This is candidate for a public API but we can't 
    ///  do that kind of work at the moment.
    /// </remarks> 
//    [FriendAccessAllowed] // Built into Base, also used by Framework. 
    /*internal*/ public void InvalidateSubProperty(DependencyProperty dp)
    { 
    ...
    /// </remarks> 
//    [FriendAccessAllowed] // Built into Base, also used by Framework.
    /*internal*/ public void NotifySubPropertyChange(DependencyProperty dp) 
    {
    ...
    /*internal*/ public void InvalidateProperty(DependencyProperty dp, boolean preserveCurrentValue)
    { 
        // Do not allow foreign threads access.
        // (This is a noop if this Object is not assigned to a Dispatcher.) 
        // 
...
//    [FriendAccessAllowed] // Declared in Base also used in Framework
    /*internal*/ public UpdateResult UpdateEffectiveValue( 
            EntryIndex          entryIndex,
            DependencyProperty  dp,
            PropertyMetadata    metadata,
            EffectiveValueEntry oldEntry, 
...
//                !newEntry.IsAnimated, "Coerced or Animated value cannot be a deferred reference"); 
            ...
            // limited circumstances, when we know the listener is /*internal*/ public.
            // Since we never assign DeferredReference instances to
            // non-/*internal*/ public (non-friend assembly) classes, it's safe to skip
    ...
    /// </summary> 
//    [FriendAccessAllowed] // Built into Base, also used by Framework.
    /*internal*/ public void NotifyPropertyChange(DependencyPropertyChangedEventArgs args) 
    { 
        // fire change notification
...
//#endregion EventTracing 
    ...
    /// </summary> 
    /*internal*/ public /*virtual*/ void EvaluateBaseValueCore(
            DependencyProperty  dp, 
            PropertyMetadata    metadata,
        /*ref*/ EffectiveValueEntry newEntry)
    {
    ...
    /// </summary>
    /*internal*/ public /*virtual*/ void EvaluateAnimatedValueCore( 
            DependencyProperty  dp,
            PropertyMetadata    metadata,
        /*ref*/ EffectiveValueEntry newEntry)
    { 
    ...
    protected /*virtual*/ void OnPropertyChanged(DependencyPropertyChangedEventArgs e)
    {
        ...
        if( e.Property == null ) 
        { 
            throw new IllegalArgumentException(/*SR.Get(SRID.ReferenceIsNull, "e.Property"), */"e");
        } 
    ...
    /// </summary> 
    protected /*internal*/ /*virtual*/ boolean ShouldSerializeProperty( DependencyProperty dp )
    { 
        return ContainsValue( dp );
    }

//    [FriendAccessAllowed] // Built into Base, also used by Core & Framework. 
    /*internal*/ public BaseValueSourceInternal GetValueSource(DependencyProperty dp, PropertyMetadata metadata, /*out*/ boolean hasModifiers)
    { 
...
//    [FriendAccessAllowed] // Built into Base, also used by Core & Framework.
    /*internal*/ public BaseValueSourceInternal GetValueSource(DependencyProperty dp, PropertyMetadata metadata,
            /*out*/ boolean hasModifiers, /*out*/ boolean isExpression, /*out*/ boolean isAnimated, /*out*/ boolean isCoerced, /*out*/ boolean isCurrent) 
    {
        if (dp == null) 
        { 
            throw new ArgumentNullException("dp");
    ...
    ///     set via <cref see="SetValue"/>.
    /// </returns>
    /*internal*/ public Object ReadLocalValueEntry(EntryIndex entryIndex, DependencyProperty dp, boolean allowDeferredReferences) 
    {
        if (!entryIndex.Found) 
        { 
...
//    [FriendAccessAllowed]   // defined in Base, used in Core and Framework
    /*internal*/ public boolean IsInheritanceContextSealed
    {
    ...
    /*internal*/ public boolean Freezable_Frozen
    { 
    ...
    /*internal*/ public boolean Freezable_HasMultipleInheritanceContexts
    {
    ...
    /*internal*/ public boolean Freezable_UsingHandlerList 
    {
    ...
    /*internal*/ public boolean Freezable_UsingContextList
    { 
    ...
    /*internal*/ public boolean Freezable_UsingSingletonHandler 
    {
    ...
    /*internal*/ public boolean Freezable_UsingSingletonContext 
    { 
    ...
    //
    /*internal*/ public boolean Animatable_IsResourceInvalidationNecessary 
    { 
...
//        [FriendAccessAllowed] // Built into Base, but used by Core.
    ...
    /*internal*/ public boolean IAnimatable_HasAnimatedProperties
    { 
//        [FriendAccessAllowed] // Built into Base, but used by Core.
...
//        [FriendAccessAllowed] // Built into Base, but used by Core.
    ...
    // /*internal*/ public DP used for direct dependencies (should never appear in an effective value table) 
    //
...
//    [FriendAccessAllowed] // Built into Base, also used by Framework.
    static /*internal*/ public final DependencyProperty DirectDependencyProperty =
        DependencyProperty.Register("__Direct", typeof(Object), typeof(DependencyProperty)); 

    /*internal*/ public static void UpdateSourceDependentLists(DependencyObject d, DependencyProperty dp, 
    		DependencySource[] sources, Expression expr, boolean add) 
    { 
...
//                    Debug.Assert(dependentListObj != null, "dependentList should either be unset or non-null");
    ...
    /*internal*/ public static void ValidateSources(DependencyObject d, DependencySource[] newSources, Expression expr) 
    {
        ...
        if (newSources != null)
        {
            ...
            for (int i = 0; i < newSources.length; i++) 
            {
                ...
                {
                    throw new IllegalArgumentException(/*SR.Get(SRID.SourcesMustBeInSameThread)*/); 
                }
            }
        }
    } 
    ...
    /// </remarks>
//    [FriendAccessAllowed] // Built into Base, also used by Framework. 
    /*internal*/ public static void RegisterForAlternativeExpressionStorage( 
...
//        Debug.Assert(_getExpressionCore == null, "The 'alternative Expression storage' feature has already been registered");
    ...
    /// </returns> 
    /*internal*/ public boolean HasAnyExpression() 
    {
        EffectiveValueEntry[] effectiveValues = EffectiveValues; 
        int numEffectiveValues = EffectiveValuesCount;
        boolean result = false;

        for (int i = 0; i < numEffectiveValues; i++) 
        {
            DependencyProperty dp = 
    ...
    /// </summary> 
//    [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
    /*internal*/ public boolean HasExpression(EntryIndex entryIndex, DependencyProperty dp)
    {
        if (!entryIndex.Found) 
        {
            return false; 
        ...
        boolean result = (entry.HasExpressionMarker || o instanceof Expression); 
        return result;
    } 
...
//    #region InheritanceContext
    ...
    ///     InheritanceContext
    /// </summary> 
    /*internal*/ public /*virtual*/ DependencyObject InheritanceContext
    {
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
        get { return null; } 
    }
    ...
    /// </remarks>
    /*internal*/ public /*virtual*/ void AddInheritanceContext(DependencyObject context, DependencyProperty property)
    { 
    }
    ...
    /// </remarks> 
    /*internal*/ public /*virtual*/ void RemoveInheritanceContext(DependencyObject context, DependencyProperty property) 
    {
    } 
    ...
    /// </summary>
    /*internal*/ public /*virtual*/ boolean ShouldProvideInheritanceContext(DependencyObject target, DependencyProperty property) 
    { 
        return true;
    } 
    ...
    /// </remarks> 
//    [FriendAccessAllowed] // Built into Base, also used by Core.
    /*internal*/ public void OnInheritanceContextChanged(EventArgs args)
    {
...
//            Debug.Assert(CanModifyEffectiveValues == false, "We do not expect re-entrancy here.");
    ...
    /// </summary> 
//    [FriendAccessAllowed] // Built into Base, also used by Core. 
    /*internal*/ public /*virtual*/ void OnInheritanceContextChangedCore(EventArgs args)
    { 
    }
    ...
    /// </remarks>
    /*internal*/ public /*event*/ EventHandler InheritanceContextChanged
    { 
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        add 
        { 
...
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
    ...
    /// </summary> 
    /*internal*/ public /*virtual*/ boolean HasMultipleInheritanceContexts
    { 
        get { return false; } 
    }
    ...
    /// </summary>
    /*internal*/ public boolean CanBeInheritanceContext 
    {
//        [FriendAccessAllowed] // Built into Base, also used by Framework. 
...
//    [FriendAccessAllowed] // Built into Base, also used by Framework.
    /*internal*/ public static boolean IsTreeWalkOperation(OperationType operation) 
    { 
    ...
    /// </summary>
//    [Conditional ("DEBUG")] 
    /*internal*/ public void Debug_AssertNoInheritanceContextListeners()
    {
...
//    #region EffectiveValues
    ...
    // has been modified
    /*internal*/ public EffectiveValueEntry[] EffectiveValues 
    {
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
    ...
    /*internal*/ public int EffectiveValuesCount 
    {
//        [FriendAccessAllowed] // Built into Base, also used by Framework. 
    ...
    /*internal*/ public int InheritableEffectiveValuesCount 
    {
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
...
//            Debug.Assert(!DO_Sealed, "A Sealed DO cannot be modified"); 
    ...
    // fewer reallocations
//    [FriendAccessAllowed] // Built into Base, also used by Core and Framework. 
    /*internal*/ public void BeginPropertyInitialization()
    { 
...
//    [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
    /*internal*/ public void EndPropertyInitialization() 
    {
        ...
        if (_effectiveValues != null) 
        {
            ...
            {
                int endLength = effectiveValuesCount; 
...
//                    Debug.Assert(!DO_Sealed, "A Sealed DO cannot be modified"); 
    ...
    /*internal*/ public DependencyObject InheritanceParent 
    { 
//        [FriendAccessAllowed] // Built into Base, also used by Framework.
        get 
        {
...
//            Debug.Assert(!IsSelfInheritanceParent, "If the IsSelfInheritanceParent is set then the InheritanceParent should have been ----d."); 
    ...
    /*internal*/ public boolean IsSelfInheritanceParent
    {
//        [FriendAccessAllowed] // Built into Base, also used by Framework. 
...
//    [FriendAccessAllowed] // Built into Base, also used by Framework. 
    /*internal*/ public void SetIsSelfInheritanceParent()
    {
        // Merge all the inheritable properties on the inheritanceParent into the EffectiveValues
...
//        Debug.Assert(!DO_Sealed, "A Sealed DO cannot be modified"); 
    ...
    // 
//    [FriendAccessAllowed] // Built into Base, also used by Framework.
    /*internal*/ public void SynchronizeInheritanceParent(DependencyObject parent) 
    {
...
//        Debug.Assert(inheritanceParent.IsSelfInheritanceParent, "An inheritanceParent should always be one that has all the inheritable properties cached on self"); 
        ...
        int parentEffectiveValuesCount = inheritanceParent.EffectiveValuesCount; 

        for (int i=0; i<parentEffectiveValuesCount; i++) 
        {
...
//    [FriendAccessAllowed] // Built into Base, also used by Framework.
    /*internal*/ public EntryIndex LookupEntry(int targetIndex) 
    {
        int checkIndex;
        int iLo = 0;
        int iHi = EffectiveValuesCount; 
...
//#endif
    ...
    private void RemoveEntry(int entryIndex, DependencyProperty dp) 
    {
        // For thread-safety, sealed DOs can't modify _effectiveValues. 
//        Debug.Assert(!DO_Sealed, "A Sealed DO cannot be modified");
    ...
    //
//    [FriendAccessAllowed] // Built into Base, also used by Core and Framework. 
    /*internal*/ public /*virtual*/ int EffectiveValuesInitialSize
    { 
        get { return 2; } 
    }

    /*internal*/ public void SetEffectiveValue(EntryIndex entryIndex, DependencyProperty dp, PropertyMetadata metadata, EffectiveValueEntry newEntry, EffectiveValueEntry oldEntry)
    {
        if (metadata != null &&
...
//        Debug.Assert(dp == null || (dp.GlobalIndex == newEntry.PropertyIndex), "EffectiveValueEntry & DependencyProperty do not match"); 
    ...
    //
//    [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
    /*internal*/ public void SetEffectiveValue(EntryIndex entryIndex, DependencyProperty dp, int targetIndex, 
    		PropertyMetadata metadata, Object value, BaseValueSourceInternal valueSource)
    { 
...
//        Debug.Assert(dp == null || (dp.GlobalIndex == entry.PropertyIndex), "EffectiveValueEntry & DependencyProperty do not match");
    ...
    // 
    /*internal*/ public void UnsetEffectiveValue(EntryIndex entryIndex, DependencyProperty dp, PropertyMetadata metadata)
    { 
        if (entryIndex.Found) 
        {
...
//    #region InstanceData
    ...
    /*internal*/ public Object _contextStorage; 
...
//    [FriendAccessAllowed] // Built into Base, also used by Framework.
    /*internal*/ public static final Object ExpressionInAlternativeStore = new NamedObject("ExpressionInAlternativeStore");

    // callbacks used for alternative expression storage 
    private static AlternativeExpressionStorageCallback _getExpressionCore;

//#if VERBOSE_PROPERTY_EVENT 
//    /*internal*/ public static int ValidationCount;
//    /*internal*/ public static int InvalidationCount; 
//#endif
    ...
    /*internal*/ public static final UncommonField<Object> DependentListMapField = new UncommonField<Object>(); 

    // Optimization, to avoid calling FromSystemType too often 
    /*internal*/ public static DependencyObjectType DType = DependencyObjectType.FromSystemTypeInternal(typeof(DependencyObject));

    private final int NestedOperationMaximum = 153;
...
/// </remarks>
//[FriendAccessAllowed] // Built into Base, also used by Framework.
///*internal*/ public /*delegate*/ Expression AlternativeExpressionStorageCallback(DependencyObject d, DependencyProperty dp, PropertyMetadata metadata); 
