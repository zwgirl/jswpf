...
/// </summary>
/*internal*/ public class TextEditor
{
    //----------------------------------------------------- 
    //
    //  Constructors 
...
//    #region Constructors
    ...
    /// </param> 
    /*internal*/ public TextEditor(ITextContainer textContainer, FrameworkElement uiScope, boolean isUndoEnabled) 
    {
        // Validate parameters 
        ...
        // up speller support. 
        if ((boolean)_uiScope.GetValue(SpellCheck.IsEnabledProperty)) 
        {
...
//    [SecurityCritical, SecurityTreatAsSafe] 
    ...
    /// </summary> 
    private void DetachTextStore(boolean finalizer) 
    {
    ...
    /*internal*/ public void SetSpellCheckEnabled(boolean value)
    { 
    ...
    /// <returns></returns>
    /*internal*/ public void SetCustomDictionaries(boolean add) 
    {
    ...
    /*internal*/ public void SetSpellingReform(SpellingReform spellingReform)
    { 
        if (_speller != null)
        { 
    ...
    /*internal*/ public static ITextView GetTextView(UIElement scope)
    { 
    ...
    /*internal*/ public static ITextSelection GetTextSelection(FrameworkElement frameworkElement)
    {
    ...
    ///    TreatAsSafe: This just hooks up methods that are /*internal*/ public to this class
    /// </SecurityNote>
//    [SecurityCritical, SecurityTreatAsSafe]
    /*internal*/ public static void RegisterCommandHandlers(Type controlType, boolean acceptsRichContent, boolean readOnly, boolean registerEventListeners) 
    {
    ...
    /*internal*/ public SpellingError GetSpellingErrorAtPosition(ITextPointer position, LogicalDirection direction) 
    {
    ...
    /*internal*/ public SpellingError GetSpellingErrorAtSelection() 
    { 
        return TextEditorSpelling.GetSpellingErrorAtSelection(this);
    } 

    // Worker for TextBox/RichTextBox.GetNextSpellingErrorPosition.
    /*internal*/ public ITextPointer GetNextSpellingErrorPosition(ITextPointer position, LogicalDirection direction)
    { 
    ...
    /*internal*/ public void SetText(ITextRange range, String text, CultureInfo cultureInfo)
    { 
        // Input text
        range.Text = text; 
    ...
    /*internal*/ public void SetSelectedText(String text, CultureInfo cultureInfo)
    { 
    ...
    /// </summary>
    /*internal*/ public void MarkCultureProperty(TextRange range, CultureInfo inputCultureInfo) 
    {
        // 
    ...
    /*internal*/ public void RequestExtendSelection(Point point)
    { 
    ...
    /*internal*/ public void CancelExtendSelection() 
    { 
        if (_mouseSelectionState != null)
        { 
    ...
    /// </summary>
    /*internal*/ public void CloseToolTip()
    {
...
//    [SecurityCritical, SecurityTreatAsSafe]
    /*internal*/ public void Undo() 
    {
        ...
        boolean forceLayoutUpdate = this.Selection.CoversEntireContent; 
    ...
    /*internal*/ public void OnPreviewKeyDown(KeyEventArgs e)
    {
        TextEditorTyping.OnPreviewKeyDown(_uiScope, e);
    } 

    /*internal*/ public void OnKeyDown(KeyEventArgs e) 
    { 
        TextEditorTyping.OnKeyDown(_uiScope, e);
    } 

    /*internal*/ public void OnKeyUp(KeyEventArgs e)
    {
        TextEditorTyping.OnKeyUp(_uiScope, e); 
    }

    /*internal*/ public void OnTextInput(TextCompositionEventArgs e) 
    {
        TextEditorTyping.OnTextInput(_uiScope, e); 
    }

    /*internal*/ public void OnMouseDown(MouseButtonEventArgs e)
    { 
        TextEditorMouse.OnMouseDown(_uiScope, e);
    } 

    /*internal*/ public void OnMouseMove(MouseEventArgs e)
    { 
        TextEditorMouse.OnMouseMove(_uiScope, e);
    }

    /*internal*/ public void OnMouseUp(MouseButtonEventArgs e) 
    {
        TextEditorMouse.OnMouseUp(_uiScope, e); 
    } 

    /*internal*/ public void OnQueryCursor(QueryCursorEventArgs e) 
    {
        TextEditorMouse.OnQueryCursor(_uiScope, e);
    }

    /*internal*/ public void OnQueryContinueDrag(QueryContinueDragEventArgs e)
    { 
        TextEditorDragDrop.OnQueryContinueDrag(_uiScope, e); 
    }

    /*internal*/ public void OnGiveFeedback(GiveFeedbackEventArgs e)
    {
        TextEditorDragDrop.OnGiveFeedback(_uiScope, e);
    } 

    /*internal*/ public void OnDragEnter(DragEventArgs e) 
    { 
        TextEditorDragDrop.OnDragEnter(_uiScope, e);
    } 

    /*internal*/ public void OnDragOver(DragEventArgs e)
    {
        TextEditorDragDrop.OnDragOver(_uiScope, e); 
    }

    /*internal*/ public void OnDragLeave(DragEventArgs e) 
    {
        TextEditorDragDrop.OnDragLeave(_uiScope, e); 
    }

    /*internal*/ public void OnDrop(DragEventArgs e)
    { 
        TextEditorDragDrop.OnDrop(_uiScope, e);
    } 

    /*internal*/ public void OnContextMenuOpening(ContextMenuEventArgs e)
    { 
        TextEditorContextMenu.OnContextMenuOpening(_uiScope, e);
    }

    /*internal*/ public void OnGotKeyboardFocus(KeyboardFocusChangedEventArgs e) 
    {
        OnGotKeyboardFocus(_uiScope, e); 
    } 

    /*internal*/ public void OnLostKeyboardFocus(KeyboardFocusChangedEventArgs e) 
    {
        OnLostKeyboardFocus(_uiScope, e);
    }

    /*internal*/ public void OnLostFocus(RoutedEventArgs e)
    { 
...
//    #region Dependency Properties
    ...
    /// </summary> 
    /*internal*/ public static final DependencyProperty IsReadOnlyProperty =
    ...
    /*internal*/ public static final DependencyProperty AllowOvertypeProperty = 
            DependencyProperty.RegisterAttached(
                    "AllowOvertype", 
                    typeof(Boolean),
                    typeof(TextEditor),
    ...
    /// </summary> 
    /*internal*/ public static final DependencyProperty PageHeightProperty =
            DependencyProperty.RegisterAttached( 
                    "PageHeight",
                    typeof(Double),
                    typeof(TextEditor),
...
//    #region Properties - Relations With Other Components
    ...
    /*internal*/ public ITextContainer TextContainer
    { 
        get
        {
    ...
    /// </summary>
    /// <value></value>
    /*internal*/ public FrameworkElement UiScope
    { 
        get { return _uiScope; }
    } 
    ...
    /// </summary>
    /// <value></value>
    /*internal*/ public ITextView TextView 
    {
        get 
        { 
            return _textView;
    ...
    /// </summary> 
    /*internal*/ public ITextSelection Selection 
    {
    ...
    // 
    /*internal*/ public TextStore TextStore
    { 
    ...
    /// </summary>
    /*internal*/ public ImmComposition ImmComposition 
    {
        get 
        { 
...
//    #region Properties - Text Editor Behavior Parameterization
    ...
    /// </summary> 
    /*internal*/ public boolean AcceptsReturn
    { 
        get
        {
            return _uiScope == null ? true : (boolean)_uiScope.GetValue(KeyboardNavigation.AcceptsReturnProperty);
        } 
    }
    ...
    /// </summary>
    /*internal*/ public boolean AcceptsTab
    {
        get 
        {
            return _uiScope == null ? true : (boolean)_uiScope.GetValue(TextBoxBase.AcceptsTabProperty); 
        } 
        set
        { 
    ...
    /// </remarks> 
    /*internal*/ public boolean IsReadOnly 
    {
        get 
        {
            ...
            {
                return _uiScope == null ? false : (boolean)_uiScope.GetValue(TextEditor.IsReadOnlyProperty); 
            }
        }
        set
        { 
    ...
    /// Defaults to false.
    /// </remarks> 
    /*internal*/ public boolean IsSpellCheckEnabled
    {
        get
        { 
            return _uiScope == null ? false : (boolean)_uiScope.GetValue(SpellCheck.IsEnabledProperty);
        } 
        set 
        {
            Invariant.Assert(_uiScope != null); 
    ...
    /// Default is true. 
    /// </summary>
    /*internal*/ public boolean AcceptsRichContent 
    {
        get
        {
    ...
    /// </summary>
    /*internal*/ public boolean AllowOvertype 
    { 
        get
        { 
            return _uiScope == null ? true : (boolean)_uiScope.GetValue(TextEditor.AllowOvertypeProperty);
        }
    }
    ...
    /// </summary>
    /*internal*/ public CharacterCasing CharacterCasing 
    {
        get 
        { 
    ...
    /// Default is false.
    /// </summary> 
    /*internal*/ public boolean AutoWordSelection 
    {
        get 
        {
            return _uiScope == null ? false : (boolean)_uiScope.GetValue(RichTextBox.AutoWordSelectionProperty);
        }
    } 
    ...
    /// Default is false.
    /// </summary> 
    /*internal*/ public boolean IsReadOnlyCaretVisible
    {
        get
        { 
            return _uiScope == null ? false : (boolean)_uiScope.GetValue(TextBoxBase.IsReadOnlyCaretVisibleProperty);
        } 
    } 
...
//    #endregion Properties - Text Editor Behavior Parameterization 
    ...
    /*internal*/ public UndoState UndoState 
    {
        get 
        {
            return _undoState;
    ...
    /*internal*/ public boolean IsContextMenuOpen 
    {
        get 
        {
    ...
    /*internal*/ public Speller Speller
    { 
        get
        { 
            return _speller; 
...
//    #region Class Internal Methods
    ...
    /*internal*/ public static TextEditor _GetTextEditor(Object element) 
    {
    ...
    /// </summary>
    /*internal*/ public UndoManager _GetUndoManager()
    { 
    ...
    /// filtered text 
    /// </returns>
    /*internal*/ public String _FilterText(String textData, ITextRange range) 
    {
        return _FilterText(textData, range.Start.GetOffsetToPosition(range.End));
    }

    /*internal*/ public String _FilterText(String textData, int charsToReplaceCount)
    { 
        return _FilterText(textData, charsToReplaceCount, true); 
    }

    /*internal*/ public String _FilterText(String textData, ITextRange range, boolean filterMaxLength)
    {
        return _FilterText(textData, range.Start.GetOffsetToPosition(range.End), filterMaxLength);
    } 

    /*internal*/ public String _FilterText(String textData, int charsToReplaceCount, boolean filterMaxLength) 
    { 
    ...
    /*internal*/ public boolean _IsSourceInScope(Object source) 
    {
    ...
    /// </summary> 
    /*internal*/ public void CompleteComposition() 
    {
        if (TextStore != null) 
        {
    ...
    /// </summary>
    /*internal*/ public boolean _IsEnabled 
    { 
        get
        { 
    ...
    /*internal*/ public boolean _OvertypeMode
    { 
        get 
        {
    ...
    /*internal*/ public FrameworkElement _Scroller 
    {
        get
        {
    ...
    /*internal*/ public static TextEditorThreadLocalStore _ThreadLocalStore
    {
        get
        { 
    ...
    /*internal*/ public long _ContentChangeCounter
    {
        get 
        {
    ...
    /*internal*/ public static boolean IsTableEditingEnabled
    { 
        get
        { 
    ...
    /*internal*/ public ITextPointer _NextLineAdvanceMovingPosition
    {
        get
        { 
    ...
    /*internal*/ public boolean _IsNextLineAdvanceMovingPositionAtDocumentHead 
    {
        get
        {
...
//    #region Private Methods
    ...
    /// </summary>
    private boolean IsBadSplitPosition(String text, int position) 
    {
        //
...
//    [SecurityCritical, SecurityTreatAsSafe] 
    ...
    { 
        ...
        if ((boolean)e.NewValue == true && This._textstore != null)
        { 
    ...
    /// <SecurityNote> 
    /// Critical - adjusts /*internal*/ public state dealing with focus (including notifying
...
//    #region Private Types
    ...
    private /*sealed*/ class TextEditorShutDownListener extends ShutDownListener 
    {
        /// <SecurityNote> 
...
//        [SecurityCritical,SecurityTreatAsSafe]
    ...
    {
        /*internal*/ public DispatcherTimer Timer;
        /*internal*/ public Point Point;
        /*internal*/ public boolean BringIntoViewInProgress; 
    }
...
//    #region Private Fields 
    ...
    private static final DependencyProperty InstanceProperty = DependencyProperty.RegisterAttached( //
        "Instance", typeof(TextEditor), typeof(TextEditor), //
        new FrameworkPropertyMetadata((Object)null));

    //
    /*internal*/ public Dispatcher _dispatcher; 
    ...
    private boolean _overtypeMode; 

    // Preserved horizontal position for verical caret movement
    /*internal*/ public Double _suggestedX; 
    ...
    /*internal*/ public IParentUndoUnit _typingUndoUnit;

    // An Object for storing dragdrop state during dragging 
    /*internal*/ public TextEditorDragDrop._DragDropProcess _dragDropProcess;

    /*internal*/ public boolean _forceWordSelection;
    /*internal*/ public boolean _forceParagraphSelection;

    // Resizing operation information for table column 
    /*internal*/ public TextRangeEditTables.TableColumnResizeInfo _tableColResizeInfo;
    ...
    // If true, the TextEditor will accept xml markup for paragraphs and inline formatting.
    // Default is true.
    private boolean _acceptsRichContent;

    // If the system is IMM enabled, this is true.
    private static boolean _immEnabled = SafeSystemMetrics.IsImmEnabled ; 
    ...
    /*internal*/ public boolean _mouseCapturingInProgress; 
    ...
    private boolean _isContextMenuOpen;

    // Enables or disables table editing commands.
    // False by default, only enabled via reflection for lexicon.exe in V1.
    private static boolean _isTableEditingEnabled;
