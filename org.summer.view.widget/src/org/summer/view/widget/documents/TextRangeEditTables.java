...
/// </summary>
/*internal*/ public /*static*/ class TextRangeEditTables 
{
...
//    #region Table Selection
    ...
    /*internal*/ public static boolean GetColumnRange(ITextRange range, Table table, /*out*/ int firstColumnIndex, /*out*/ int lastColumnIndex) 
    {
        firstColumnIndex = -1; 
        lastColumnIndex = -1; 
        ...
        if (!(range.Start instanceof TextPointer))
        { 
    ...
    /*internal*/ public static Table GetTableFromPosition(TextPointer position) 
    {
    ...
    /*internal*/ public static TableCell GetTableCellFromPosition(TextPointer position)
    {
        TextElement element = position.Parent as TextElement;
    ...
    /*internal*/ public static boolean IsTableStructureCrossed(ITextPointer anchorPosition, ITextPointer movingPosition)
    {
    ...
    /// </returns>
    /*internal*/ public static boolean IsTableCellRange( 
        TextPointer anchorPosition, TextPointer movingPosition,
        boolean includeCellAtMovingPosition, 
    ...
    /// </returns> 
    /*internal*/ public static List<TextSegment> BuildTableRange(
        TextPointer anchorPosition, TextPointer movingPosition, 
        boolean includeCellAtMovingPosition, 
        out boolean isTableCellRange)
    { 
        // Find boundary cells and validate parameters
        TableCell anchorCell;
        TableCell movingCell;
    ...
    /// </summary> 
    /*internal*/ public static void IdentifyValidBoundaries(ITextRange range, out ITextPointer start, out ITextPointer end)
    { 
    ...
    /*internal*/ public static TextPointer GetNextTableCellRangeInsertionPosition(TextSelection selection, LogicalDirection direction) 
    {
    ...
    // within a Table.
    /*internal*/ public static TextPointer GetNextRowEndMovingPosition(TextSelection selection, LogicalDirection direction) 
    {
    ...
    /*internal*/ public static boolean MovingPositionCrossesCellBoundary(TextSelection selection)
    {
    ...
    // This method is only called when the selection's anchor position is not 
    // within a Table.
    /*internal*/ public static TextPointer GetNextRowStartMovingPosition(TextSelection selection, LogicalDirection direction) 
    { 
        // We only support table selection in TextContainers.
        Invariant.Assert(((ITextSelection)selection).Start is TextPointer); 
        // This method is called when the selection anchor is outside the scope of
    ...
    /// </returns>
    /*internal*/ public static Table InsertTable(TextPointer insertionPosition, int rowCount, int columnCount)
    {
    ...
    /// </summary>
    /*internal*/ public static TextPointer EnsureInsertionPosition(TextPointer position) 
    {
        ...
        else 
        {
            ...
            if (TextPointerBase.IsInBlockUIContainer(position)) 
            {
                ...
                boolean insertBefore = position.GetPointerContext(LogicalDirection.Backward) == TextPointerContext.ElementStart;
    ...
    /*internal*/ public static TextPointer GetAdjustedRowEndPosition(Table currentTable, TextPointer rowEndPosition)
    { 
    ...
    /// </summary>
    /*internal*/ public static void DeleteContent(TextPointer start, TextPointer end)
    {
    ...
    /// </returns>
    /*internal*/ public static TextRange InsertRows(TextRange textRange, int rowCount)
    {
    ...
    /// </returns>
    /*internal*/ public static boolean DeleteRows(TextRange textRange) 
    { 
        ...
        {
            boolean lastRowDeleted = endRow.Index == rows.Count - 1;
    ...
    /// </param>
    /*internal*/ public static TextRange InsertColumns(TextRange textRange, int columnCount) 
    { 
    ...
    /// </param>
    /*internal*/ public static void DeleteColumn(int colIndex, Table table) // Index to delete 
    {
        for (int iRowGroup = 0; iRowGroup < table.RowGroups.Count; iRowGroup++)
        {
            TableRowGroup rowGroup = table.RowGroups[iRowGroup]; 
    ...
    /// </param> 
    /*internal*/ public static boolean DeleteColumns(TextRange textRange)
    { 
        Invariant.Assert(textRange != null, "null check: textRange"); 
    ...
    /*internal*/ public static boolean TableBorderHitTest(ITextView textView, Point pt)
    {
        Table table;
        int columnIndex; 
        Rect columnRect;
    ...
    private static boolean TableBorderHitTest(
        ...
        out double[] columnWidths) 
    {
        ...
        // Do this /*internal*/ public for now, change to better location when tests out ok. 
        ...
        // into /*internal*/ public coordinates relative to DocumentPage in TextDocumentView 
        // 
    ...
    /*internal*/ public static TableColumnResizeInfo StartColumnResize(ITextView textView, Point pt) 
    {
        Table table;
        int columnIndex;
        Rect columnRect; 
    ...
    /*internal*/ public static void EnsureTableColumnsAreFixedSize(Table table, double[] columnWidths)
    { 
    ...
    /*internal*/ public class TableColumnResizeInfo
    { 
        /*internal*/ public TableColumnResizeInfo(ITextView textView, Table table, int columnIndex, Rect columnRect, double tableAutofitWidth, double[] columnWidths) 
        {
        ...
        /*internal*/ public void UpdateAdorner(Point mouseMovePoint)
        {
        ...
        //
        /*internal*/ public void ResizeColumn(Point mousePoint) 
        { 
        ...
        /*internal*/ public void DisposeAdorner() 
        {
            if (_tableColResizeAdorner != null) 
            {
        ...
        /*internal*/ public double LeftDragMax { get { return (_dxl); } } 
        /*internal*/ public double RightDragMax { get { return (_dxr); } }
        /*internal*/ public Table Table { get { return (_table); } } 
    ...
    /// </returns>
    /*internal*/ public static TextRange MergeCells(TextRange textRange) 
    { 
        Invariant.Assert(textRange != null, "null check: textRange");
    ...
    /// <returns>
    /// </returns>
    /*internal*/ public static TextRange SplitCell(TextRange textRange, int splitCountHorizontal, int splitCountVertical)
    { 
//        Invariant.Assert(textRange != null, "null check: textRange");
    ...
    /// </returns> 
    private static boolean IdentifyTableElements(
        TextPointer anchorPosition, TextPointer movingPosition,
        boolean includeCellAtMovingPosition,
        out TableCell anchorCell, out TableCell movingCell, 
    ...
    private static boolean FindTableElements( 
        TextPointer anchorPosition, TextPointer movingPosition, 
        out TableCell anchorCell, out TableCell movingCell,
        out TableRow anchorRow, out TableRow movingRow, 
        out TableRowGroup anchorRowGroup, out TableRowGroup movingRowGroup,
    ...
    private static TableCell AddCellCopy(TableRow newRow, TableCell currentCell, int cellInsertionIndex, boolean copyRowSpan, boolean copyColumnSpan)
    { 
...
//        Invariant.Assert(leftColumn <= rightColumn, "leftColumn must be <= rightColumn");
    ...
    // Check the ability of merging cell range 
    private static boolean CanMergeCellRange(TableRowGroup rowGroup, int topRow, int bottomRow, int leftColumn, int rightColumn)
    { 
        boolean canMergeCell = false; 
...
//                    Invariant.Assert(lastCell != null, "lastCell is not expected to be null");
    ...
    private static boolean GetBoundaryCells(TableRow row, int bottomRow, int leftColumn, int rightColumn, out TableCell firstCell, out TableCell lastCell)
    { 
        firstCell = null;
        lastCell = null;
    ...
    private static boolean IsLastCellInRow(TableCell cell) 
    {
