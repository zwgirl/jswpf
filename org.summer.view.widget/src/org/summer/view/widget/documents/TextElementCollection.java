...
/// <summary> 
/// </summary>
public class TextElementCollection<TextElementType extends TextElement> implements IList, ICollection // where TextElementType : TextElement 
{
    //-------------------------------------------------------------------
    //
    //  Constructors 
...
//    #region Constructors
    ...
    /// </param>
    /*internal*/ public TextElementCollection(DependencyObject owner, boolean isOwnerParent)
    { 
        if (isOwnerParent)
        { 
            Invariant.Assert(owner instanceof TextElement || owner instanceof FlowDocument || owner instanceof TextBlock); 
        }
        else 
        {
            Invariant.Assert(owner instanceof TextElement);
        }
...
//    #region ICollection<TextElementType> Members 
    ...
    /// <param name="item"></param> 
    /// <returns></returns>
    public boolean Contains(TextElementType item) 
    { 
        if (item == null)
        { 
            return false;
    ...
    /// </returns>
    public boolean Remove(TextElementType item)
    { 
        if (item == null)
        { 
            return false; 
...
//    #region IList Members
    ...
    /// </summary> 
    /*internal*/ public /*virtual*/ int OnAdd(Object value) 
    {
        if (value == null) 
        {
        ...
        if (!(value instanceof TextElementType))
        { 
        ...
        try 
        {
            boolean isCacheSafePreviousIndex = _indexCache.IsValid(this); 
...
//    #region Internal Properties
    ...
    // In case when a collection is created as a sibling collection of a TextElement, owner is that TextElement Object.
    // This distinction is very important, so that a collection belongs semantically to the owner it was created for. 
    /*internal*/ public DependencyObject Owner 
    {
        get 
        {
            return _owner;
    ...
    { 
        get
        {
            ...
            if (_owner instanceof TextBlock)
            { 
                textContainer = (TextContainer)((TextBlock)_owner).TextContainer; 
            }
            else if (_owner instanceof FlowDocument) 
            {
    ...
    /// </value>
    /*internal*/ public TextElementType FirstChild 
    { 
        get
        { 
    ...
    /// Returns a first item of this collection 
    /// </value>
    /*internal*/ public TextElementType LastChild
    {
        get 
        {
...
//    #region Private Methods
    ...
    private TextElementType GetElementAtIndex(int index, /*out*/ boolean atCollectionEnd)
    { 
        TextElementType element; 
    ...
    private int IndexOfInternal(Object value, boolean isCacheSafePreviousIndex)
    { 
        TextElementType item = value as TextElementType;
...
//    #region Internal Methods 
    ...
    /// </summary>
    /*internal*/ public /*virtual*/ void ValidateChild(TextElementType child)
    {
        return; 
    }
...
//    #region Private Properties 
    ...
    private TextPointer ContentStart
    {
        ...
        { 
            return
                this.Parent instanceof TextElement ? ((TextElement)this.Parent).ContentStart : this.TextContainer.Start; 
        } 
    }
    ...
    { 
        ...
        { 
            return 
                this.Parent instanceof TextElement ? ((TextElement)this.Parent).ContentEnd : this.TextContainer.End;
        } 
    }
...
//    #region Private Types
    ...
    private class ElementIndexCache 
    { 
        /*internal*/ public ElementIndexCache(int index, TextElementType element)
        { 
        ...
        /*internal*/ public boolean IsValid(TextElementCollection<TextElementType> collection)
        {
        ...
        /*internal*/ public int Index { get { return _index; } } 

        // Cached element in this collection. 
        /*internal*/ public TextElementType Element { get { return _element; } }

        // Cached element index in this collection.
        private final int _index; 

        // Cached element in this collection. 
        private final TextElementType _element; 
    }
...
//    #region Private Fields 
    ...
    private boolean _isOwnerParent; 
