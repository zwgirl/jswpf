...
// This static class is logically an extension of TextContainer.  It contains 
    ...
    /*internal*/ public /*static*/ class TextTreeUndo
    {
        //----------------------------------------------------- 
        //
        //  Internal Methods 
...
//        #region Internal Methods
        ...
        /*internal*/ public static void CreateInsertUndoUnit(TextContainer tree, int symbolOffset, int symbolCount)
        { 
        ...
        /*internal*/ public static void CreateInsertElementUndoUnit(TextContainer tree, int symbolOffset, boolean deep) 
        {
            UndoManager undoManager;
        ...
        /*internal*/ public static void CreatePropertyUndoUnit(TextElement element, DependencyPropertyChangedEventArgs e) 
        {
            UndoManager undoManager; 
        ...
        /*internal*/ public static TextTreeDeleteContentUndoUnit CreateDeleteContentUndoUnit(TextContainer tree, TextPointer start, TextPointer end)
        { 
            UndoManager undoManager; 
        ...
        /*internal*/ public static TextTreeExtractElementUndoUnit CreateExtractElementUndoUnit(TextContainer tree, TextTreeTextElementNode elementNode)
        { 
            UndoManager undoManager;
        ...
        /*internal*/ public static UndoManager GetOrClearUndoManager(ITextContainer textContainer) 
        {
            UndoManager undoManager;
