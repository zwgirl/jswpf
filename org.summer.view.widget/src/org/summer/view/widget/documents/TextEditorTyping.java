...
/// </summary>
/*internal*/ public /*static*/ class TextEditorTyping
{
    //----------------------------------------------------- 
    //
...
//    #region Class Internal Methods
    ...
    /// </param> 
    /*internal*/ public static void _RegisterClassHandlers(Type controlType, boolean registerEventListeners)
    { 
    ...
    /// </summary> 
    /*internal*/ public static void _AddInputLanguageChangedEventHandler(TextEditor This)
    {
    ...
    /// </summary> 
    /*internal*/ public static void _RemoveInputLanguageChangedEventHandler(TextEditor This)
    {
        TextEditorThreadLocalStore threadLocalStore;
    ...
    /// </summary> 
    /*internal*/ public static void _BreakTypingSequence(TextEditor This) 
    {
    ...
    /*internal*/ public static void _FlushPendingInputItems(TextEditor This)
    { 
        TextEditorThreadLocalStore threadLocalStore; 
    ...
    /*internal*/ public static void _ShowCursor() 
    {
    ...
    /// </remarks>
    /*internal*/ public static void OnPreviewKeyDown(Object sender, KeyEventArgs e) 
    { 
    ...
    /*internal*/ public static void OnKeyDown(Object sender, KeyEventArgs e)
    { 
    ...
    /*internal*/ public static void OnKeyUp(Object sender, KeyEventArgs e) 
    {
        TextEditor This = TextEditor._GetTextEditor(sender); 
    ...
    /*internal*/ public static void OnTextInput(Object sender, TextCompositionEventArgs e) 
    {
        TextEditor This = TextEditor._GetTextEditor(sender);
...
//    #region Private Methods
    ...
    ///               This code merely registers an /*internal*/ public handler to the PresentationSource.SourceChanged event. 
...
//    [SecurityCritical,SecurityTreatAsSafe] 
            ...
            { 
                ...
                else
                {
                        ...
                        position.GetPointerContext(LogicalDirection.Backward) == TextPointerContext.Text)
                    {
                        ...
                        // and all /*internal*/ public characters 
    ...
    private static boolean IsAtListItemChildStart(ITextPointer position, boolean emptyChildOnly)
    {
        if (position.GetPointerContext(LogicalDirection.Backward) != TextPointerContext.ElementStart) 
        {
            return false; 
    ...
    private static boolean IsBlockUIContainerBoundaryCrossed(TextPointer position1, TextPointer position2)
    {
        return
    ...
    /// </SecurityNote> 
    [SecurityCritical,SecurityTreatAsSafe]
    private static boolean IsMouseInputPending(TextEditor This)
    {
        boolean mouseInputPending = false; 
    ...
    {
        // Ctor. 
        /*internal*/ public InputItem(TextEditor textEditor) 
        {
            _textEditor = textEditor; 
        }

        // Handles the input event.
        /*internal*/ public abstract void Do(); 
    ...
    private class TextInputItem extends InputItem
    {
        // Ctor.
        /*internal*/ public TextInputItem(TextEditor textEditor, String text, boolean isInsertKeyToggled) 
            : base (textEditor)
        { 
            _text = text; 
        ...
        /*internal*/ public override void Do()
        { 
        ...
        private final boolean _isInsertKeyToggled; 
    }

    // Holds state originating from a single KeyDownEvent.
    private class KeyUpInputItem extends InputItem
    {
        // Ctor. 
        /*internal*/ public KeyUpInputItem(TextEditor textEditor, Key key, ModifierKeys modifiers)
            : base(textEditor) 
        { 
            _key = key;
        ...
        private final ModifierKeys _modifiers;
    }
