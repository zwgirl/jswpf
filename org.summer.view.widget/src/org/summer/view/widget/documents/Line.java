...
// ---------------------------------------------------------------------
    // Text line formatter. 
    // ---------------------------------------------------------------------
    /*internal*/ public abstract class Line implements TextSource, IDisposable
    {
        // ------------------------------------------------------------------ 
        //
...
//        #region Internal Methods 
        ...
        // ----------------------------------------------------------------- 
        /*internal*/ public Line(TextBlock owner)
        { 
            _owner = owner; 
        ...
        // ------------------------------------------------------------------ 
        /*internal*/ public void Format(int dcp, double width, TextParagraphProperties lineProperties, TextLineBreak textLineBreak, TextRunCache textRunCache, bool showParagraphEllipsis)
        { 
...
//#endif 
        ...
        /// </param>
        /*internal*/ public bool IsAtCaretCharacterHit(CharacterHit charHit) 
        {
        ...
        // ----------------------------------------------------------------- 
        /*internal*/ public virtual bool HasInlineObjects()
        { 
            return false;
        }
...
//        #region Internal Properties 
        ...
        // -----------------------------------------------------------------
        /*internal*/ public bool EndOfParagraph 
        {
            get 
            { 
