...
import org.summer.view.widget.media.Visual;
 // ITextPointer helper methods.
    /*internal*/ public static class TextPointerBase
    {
        //----------------------------------------------------- 
        //
        //  Internal Methods 
...
//        #region Internal Methods
        ...
        /// TextPointer to compare.
        /// </param>
        /*internal*/ public static ITextPointer Min(ITextPointer position1, ITextPointer position2)
        { 
        ...
        /// TextPointer to compare. 
        /// </param> 
        /*internal*/ public static ITextPointer Max(ITextPointer position1, ITextPointer position2)
        { 
            return position1.CompareTo(position2) >= 0 ? position1 : position2;
        }

        // Worker for GetText, accepts any ITextPointer. 
        /*internal*/ public static String GetTextInRun(ITextPointer position, LogicalDirection direction)
        { 
            char[] text; 
            int textLength;
            int getTextLength; 
...
//            Invariant.Assert(getTextLength == textLength, "textLengths returned from GetTextRunLength and GetTextInRun are innconsistent"); 
        ...
        /*internal*/ public static int GetTextWithLimit(ITextPointer thisPointer, LogicalDirection direction, char[] textBuffer, int startIndex, int count, ITextPointer limit)
        { 
            int charsCopied; 
...
//#if UNUSED
        ...
        /*internal*/ public static boolean IsAtFormatNormalizedPosition(ITextPointer position) 
        { 
...
//#endif
        ...
        /// </value>
        /*internal*/ public static boolean IsAtInsertionPosition(ITextPointer position) 
        {
        ...
        /*internal*/ public static boolean IsAtPotentialRunPosition(ITextPointer position)
        { 
            boolean isAtPotentialRunPosition = IsAtPotentialRunPosition(position, position);
        ...
        // position.
        /*internal*/ public static boolean IsAtPotentialRunPosition(TextElement run) 
        {
            return 
                run instanceof Run && 
                run.IsEmpty &&
        ...
        private static boolean IsAtPotentialRunPosition(c backwardPosition, ITextPointer forwardPosition)
        { 
        ...
        /*internal*/ public static boolean IsAtPotentialParagraphPosition(ITextPointer position)
        { 
        ...
        /*internal*/ public static boolean IsBeforeFirstTable(ITextPointer position)
        {
            TextPointerContext forwardContext = position.GetPointerContext(LogicalDirection.Forward);
            TextPointerContext backwardContext = position.GetPointerContext(LogicalDirection.Backward); 
        ...
        /*internal*/ public static boolean IsInBlockUIContainer(ITextPointer position) 
        {
            return (typeof(BlockUIContainer).IsAssignableFrom(position.ParentType)); 
        } 

        /*internal*/ public static boolean IsAtBlockUIContainerStart(ITextPointer position) 
        {
            return IsInBlockUIContainer(position) &&
                position.GetPointerContext(LogicalDirection.Backward) == TextPointerContext.ElementStart;
        } 

        /*internal*/ public static boolean IsAtBlockUIContainerEnd(ITextPointer position) 
        { 
            return IsInBlockUIContainer(position) &&
        ...
        private static boolean IsInAncestorScope(ITextPointer position, Type allowedParentType, Type limitingType) 
        {
        ...
        /*internal*/ public static boolean IsInAnchoredBlock(ITextPointer position)
        { 
        ...
        /*internal*/ public static boolean IsInHyperlinkScope(ITextPointer position)
        {
        ...
        /*internal*/ public static ITextPointer GetFollowingNonMergeableInlineContentStart(ITextPointer position)
        {
            ITextPointer navigator = position.CreatePointer();
            boolean moved = false; 
            Type elementType;
        ...
        /*internal*/ public static boolean IsAtNonMergeableInlineStart(ITextPointer position) 
        {
        ...
        /*internal*/ public static boolean IsAtNonMergeableInlineEnd(ITextPointer position) 
        { 
        ...
        /*internal*/ public static boolean IsPositionAtNonMergeableInlineBoundary(ITextPointer position) 
        {
            return IsAtNonMergeableInlineStart(position) || IsAtNonMergeableInlineEnd(position); 
        } 

        /*internal*/ public static boolean IsAtFormatNormalizedPosition(ITextPointer position, LogicalDirection direction) 
        {
            return IsAtNormalizedPosition(position, direction, false /* respectCaretUnitBoundaries */);
        }
 
        /*internal*/ public static boolean IsAtInsertionPosition(ITextPointer position, LogicalDirection direction)
        { 
            return IsAtNormalizedPosition(position, direction, true /* respectCaretUnitBoundaries */); 
        }
 
        /*internal*/ public static boolean IsAtNormalizedPosition(ITextPointer position, LogicalDirection direction, boolean respectCaretUnitBoundaries)
        {
        ...
        /*internal*/ public static int GetOffset(ITextPointer thisPosition)
        {
        ...
        /// </param> 
        /// <returns></returns>
        /*internal*/ public static boolean IsAtWordBoundary(ITextPointer thisPosition, LogicalDirection insideWordDirection)
        {
            boolean isAtWordBoundary; 
        ...
        /// </remarks> 
        /*internal*/ public static TextSegment GetWordRange(ITextPointer thisPosition) 
        {
        ...
        /// The return value includes trailing whitespace, if any.
        /// </remarks>
        /*internal*/ public static TextSegment GetWordRange(ITextPointer thisPosition, LogicalDirection direction)
        { 
            ...
            ITextPointer navigator = thisPosition.CreatePointer();
            boolean moved = MoveToNextWordBoundary(navigator, direction);
        ...
        // </summary> 
        /*internal*/ public static boolean IsNextToPlainLineBreak(ITextPointer thisPosition, LogicalDirection direction)
        {
        ...
        /*internal*/ public static Char[] NextLineCharacters = new char[] { '\n', '\r', '\v', '\f', '\u0085' /*NEL*/, '\u2028' /*LS*/, '\u2029' /*PS*/ };

        // Returns true if a specified char matches the Unicode definition of "newline". 
        /*internal*/ public static boolean IsCharUnicodeNewLine(char ch)
        { 
        ...
        /// </summary> 
        /*internal*/ public static boolean IsNextToRichLineBreak(ITextPointer thisPosition, LogicalDirection direction)
        { 
        ...
        /// ignoring any intermediate formatting elements.
        /// </summary> 
        /*internal*/ public static boolean IsNextToParagraphBreak(ITextPointer thisPosition, LogicalDirection direction)
        { 
        ...
        // </summary> 
        /*internal*/ public static boolean IsNextToAnyBreak(ITextPointer thisPosition, LogicalDirection direction) 
        {
            if (!thisPosition.IsAtInsertionPosition) 
            {
                thisPosition = thisPosition.GetInsertionPosition(direction);
        ...
        /// </summary>
        /*internal*/ public static boolean IsAtLineWrappingPosition(ITextPointer position, ITextView textView)
        {
            ...
            boolean isAtLineWrappingPosition = position.LogicalDirection == LogicalDirection.Forward
        ...
        /*internal*/ public static boolean IsAtRowEnd(ITextPointer thisPosition) 
        {
        ...
        /*internal*/ public static boolean IsAfterLastParagraph(ITextPointer thisPosition) 
        {
        ...
        /*internal*/ public static boolean IsAtParagraphOrBlockUIContainerStart(ITextPointer pointer) 
        { 
        ...
        /*internal*/ public static ListItem GetListItem(TextPointer pointer)
        {
        ...
        /*internal*/ public static ListItem GetImmediateListItem(TextPointer position) 
        {
        ...
        /*internal*/ public static boolean IsInEmptyListItem(TextPointer position)
        {
        ...
        /*internal*/ public static int MoveToLineBoundary(ITextPointer thisPointer, ITextView textView, int count)
        {
        ...
        /*internal*/ public static int MoveToLineBoundary(ITextPointer thisPointer, ITextView textView, int count, boolean respectNonMeargeableInlineStart) 
        {
        ...
        /*internal*/ public static Rect GetCharacterRect(ITextPointer thisPointer, LogicalDirection direction)
        { 
            return GetCharacterRect(thisPointer, direction, /*transformToUiScope*/true); 
        }
 
        // <see cref="TextPointer.GetCharacterRect"/>
        /*internal*/ public static Rect GetCharacterRect(ITextPointer thisPointer, LogicalDirection direction, boolean transformToUiScope)
        {
        ...
        /*internal*/ public static boolean MoveToFormatNormalizedPosition(ITextPointer thisNavigator, LogicalDirection direction) 
        {
        ...
        /// </summary>
        /*internal*/ public static boolean MoveToInsertionPosition(ITextPointer thisNavigator, LogicalDirection direction) 
        {
        ...
        /// </remarks>
        /*internal*/ public static boolean MoveToNextInsertionPosition(ITextPointer thisNavigator, LogicalDirection direction) 
        {
        ...
        /*internal*/ public static boolean MoveToNextWordBoundary(ITextPointer thisNavigator, LogicalDirection movingDirection) 
        {
            int moveCounter = 0;
        ...
        /*internal*/ public static ITextPointer GetFrozenPointer(ITextPointer thisPointer, LogicalDirection logicalDirection)
        { 
        ...
        /*internal*/ public static boolean ValidateLayout(ITextPointer thisPointer, ITextView textView)
        { 
            if (textView == null) 
            {
                return false; 
        ...
        private static boolean NormalizePosition(ITextPointer thisNavigator, LogicalDirection direction, boolean respectCaretUnitBoundaries)
        { 
            Invariant.Assert(!thisNavigator.IsFrozen, "Can't reposition a frozen pointer!");
        ...
        private static boolean IsAtNormalizedPosition(ITextPointer position, boolean respectCaretUnitBoundaries) 
        {
        ...
        private static boolean IsAtCaretUnitBoundary(ITextPointer position)
        { 
            ...
            { 
                ...
                { 
                    // Check the insertion position with the /*internal*/ public compound sequence
        ...
        private static boolean IsInsideCompoundSequence(ITextPointer position)
        { 
        ...
        private static boolean IsAtNonMergeableInlineEdge(ITextPointer position, LogicalDirection direction) 
        { 
        ...
        private static boolean IsNextToRichBreak(ITextPointer thisPosition, LogicalDirection direction, Type lineBreakType) 
        {
