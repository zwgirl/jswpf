...
// Base class for all nodes in a TextContainer or TextBlock splay tree.
    /*internal*/ public abstract class SplayTreeNode 
    { 
        //-----------------------------------------------------
        // 
        //  Internal Methods
...
//        #region Internal Methods
        ...
        /*internal*/ public SplayTreeNode GetSiblingAtOffset(int offset, /*out*/ int nodeOffset)
        {
            SplayTreeNode node;
            int nodeSymbolCount; 
        ...
        /*internal*/ public SplayTreeNode GetSiblingAtCharOffset(int charOffset, /*out*/ int nodeCharOffset)
        { 
            SplayTreeNode node;
            int nodeCharCount; 
        ...
        /*internal*/ public SplayTreeNode GetFirstContainedNode()
        { 
        ...
        // any.  Only TextTreeRootNode and TextTreeTextElement nodes 
        // ever have contained nodes.
        /*internal*/ public SplayTreeNode GetLastContainedNode()
        {
            SplayTreeNode containedNode; 
        ...
        // returns null. 
        /*internal*/ public SplayTreeNode GetContainingNode() 
        {
        ...
        /*internal*/ public SplayTreeNode GetPreviousNode() 
        {
        ...
        // 
        // This method will splay the returned node up to local root.
        /*internal*/ public SplayTreeNode GetNextNode() 
        { 
            SplayTreeNode walkerNode;
        ...
        /*internal*/ public int GetSymbolOffset(int treeGeneration)
        { 
            SplayTreeNode node;
            int offset; 
        ...
        /*internal*/ public int GetIMECharOffset() 
        {
            SplayTreeNode node; 
            int charOffset;
        ...
        /*internal*/ public void InsertAtNode(SplayTreeNode positionNode, ElementEdge edge) 
        {
...
//                    Invariant.Assert(this.LeftSymbolCount == 0); 
        ...
        /*internal*/ public void InsertAtNode(SplayTreeNode location, boolean insertBefore)
        {
...
//            Invariant.Assert(this.Role == SplayTreeNodeRole.LocalRoot);
        ...
        /*internal*/ public static void Join(SplayTreeNode root, SplayTreeNode leftSubTree, SplayTreeNode rightSubTree) 
        {
...
//            Invariant.Assert(root.Role == SplayTreeNodeRole.LocalRoot);
        ...
        // trees are null.
        /*internal*/ public static SplayTreeNode Join(SplayTreeNode leftSubTree, SplayTreeNode rightSubTree) 
        {
...
//                Invariant.Assert(maxNode.Role == SplayTreeNodeRole.LocalRoot); 
        ...
        /*internal*/ public SplayTreeNode Split() 
        {
            SplayTreeNode rightSubTree; 
...
//            Invariant.Assert(this.Role == SplayTreeNodeRole.LocalRoot, "location should be local root!"); 
        ...
        /*internal*/ public SplayTreeNode GetMinSibling() 
        {
            SplayTreeNode node; 
        ...
        /*internal*/ public SplayTreeNode GetMaxSibling()
        { 
            SplayTreeNode node;
...
//            Invariant.Assert(this.Role == SplayTreeNodeRole.LocalRoot, "Splay didn't move node to root!"); 
        ...
        /*internal*/ public boolean IsChildOfNode(SplayTreeNode parentNode)
        { 
...
//#if DEBUG 
        ...
        /*internal*/ public static int GetDebugId()
        { 
...
//        #region Internal Properties 
        ...
        /*internal*/ public abstract SplayTreeNode ParentNode { get; set; }
 
        // Root node of a contained tree, if any.
        /*internal*/ public abstract SplayTreeNode ContainedNode { get; set; }

        // Left child node in a sibling tree. 
        /*internal*/ public abstract SplayTreeNode LeftChildNode { get; set; }
 
        // Right child node in a sibling tree. 
        /*internal*/ public abstract SplayTreeNode RightChildNode { get; set; }
 
        // Count of symbols covered by this node and any contained nodes.
        /*internal*/ public abstract int SymbolCount { get; set; }

        // Count of unicode chars covered by this node and any contained nodes. 
        /*internal*/ public abstract int IMECharCount { get; set; }
 
        // Count of symbols of all siblings preceding this node. 
        /*internal*/ public abstract int LeftSymbolCount { get; set; }
 
        // Count of unicode chars of all siblings preceding this node.
        /*internal*/ public abstract int LeftCharCount { get; set; }
        ...
        /*internal*/ public abstract int Generation { get; set; } 

        // Cached symbol offset. 
        /*internal*/ public abstract int SymbolOffsetCache { get; set; }

        // The relative position of this node in its sibling tree.
        /*internal*/ public SplayTreeNodeRole Role 
        {
            get 
            { 
                SplayTreeNode parentNode;
