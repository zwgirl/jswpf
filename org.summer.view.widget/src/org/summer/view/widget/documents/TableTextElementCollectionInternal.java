...
/// <summary>
    ...
    /*internal*/ public class TableTextElementCollectionInternal<TParent, TElementType> 
        extends ContentElementCollection 
//        where TParent : TextElement, IAcceptInsertion
//        where TElementType : TextElement, IIndexedChild<TParent> 
    {
        /*internal*/ public TableTextElementCollectionInternal(TParent owner)
            : base(owner)
        { 
        }
        ...
        /// also updated.
        /// </remarks>
        public /*override*/ boolean Remove(TElementType item) 
        {
            Version++; 
...
//                    Debug.Assert(BelongsToOwner(Items[i]));
        ...
        /// </remarks>
        /*internal*/ public /*override*/ void PrivateConnectChild(int index, TElementType item)
        { 
        ...
        /// </summary> 
        /*internal*/ public /*override*/ void PrivateDisconnectChild(TElementType item)
        { 
...
//                Debug.Assert(BelongsToOwner(Items[i + 1]));
        ...
        /*internal*/ public int FindInsertionIndex(TElementType item)
        { 
            int index = 0;
        ...
        /*internal*/ public void InternalAdd(TElementType item) 
        {
        ...
        /// </summary>
        /*internal*/ public void InternalRemove(TElementType item) 
        { 
//            Debug.Assert(BelongsToOwner(item) && Items[item.Index] == item);
