...
import org.summer.view.widget.collection.ArrayList;
    ...
    /// <see cref="TextBlock"/>, <see cref="TextFlow"/>, <see cref="FlowDocument"/>. 
    ...
    /// <see cref="TextPointer.LoicalDirection"/> property.</para> 
    ...
    /// <see cref="TextPointer.GetNextInsertionPosition"/>, <see cref="TextPointer.GetPositionAtOffset"/>,
    /// etc. TextPointer can be also gotten from a visual coordinate via 
    /// methods like <see cref="TextFlow.GetPositionFromPoint"/>.</para> 
    /// <para></para>
    ...
    /// <code> 
    ///     boolean IsRichTextBoxEmpty(RichTextBox richTextBox)
    ///     { 
    ...
    ///         boolean isEmpty = normalizedStart.CompareTo(normalizedEnd) == 0; 
    ///
    ///         return isEmpty; 
    ///     }
    /// </code>
    ...
    public class TextPointer extends ContentPosition implements ITextPointer
    { 
        //----------------------------------------------------- 
        //
        //  Constructors 
...
//        #region Constructors 
        ...
        /// </remarks> 
        /*internal*/ public TextPointer(TextPointer textPointer)
        { 
            if (textPointer == null)
            {
        ...
        /*internal*/ public TextPointer(TextPointer position, int offset)
        {
            if (position == null)
            { 
        ...
        // Creates a new TextPointer instance.
        /*internal*/ public TextPointer(TextPointer position, LogicalDirection direction)
        { 
            InitializeOffset(position, 0, direction);
        } 
 
        // Creates a new TextPointer instance.
        /*internal*/ public TextPointer(TextPointer position, int offset, LogicalDirection direction) 
        {
            InitializeOffset(position, offset, direction);
        }
 
        // Creates a new TextPointer instance.
        /*internal*/ public TextPointer(TextContainer textContainer, int offset, LogicalDirection direction) 
        { 
            SplayTreeNode node;
            ElementEdge edge; 
        ...
        // Creates a new TextPointer instance.
        /*internal*/ public TextPointer(TextContainer tree, TextTreeNode node, ElementEdge edge) 
        {
            Initialize(tree, node, edge, LogicalDirection.Forward, tree.PositionGeneration, false, false, tree.LayoutGeneration); 
        } 

        // Creates a new TextPointer instance. 
        /*internal*/ public TextPointer(TextContainer tree, TextTreeNode node, ElementEdge edge, LogicalDirection direction)
        {
        ...
        /*internal*/ public TextPointer CreatePointer() 
        {
            return new TextPointer(this); 
        }

        // Constructor equivalent to ITextPointer.CreatePointer
        /*internal*/ public TextPointer CreatePointer(LogicalDirection gravity) 
        {
        ...
        /// <see cref="TextBlock"/>, <see cref="TextFlow"/>, <see cref="FlowDdocument"/>.
        ...
        /// <code> 
        ///     boolean IsPositionContainedBetween(TextPointer test, TextPointer start, TextPointer end)
        ///     { 
        ...
        /// </code> 
        /// </example>
        public boolean IsInSameDocument(TextPointer textPosition) 
        {
        ...
        /// is <see cref="LogicalDirection.Backward"/>, or if it is positioned 
        /// at the end of a text container  and the requested direction is 
        /// <see cref="LogicalDirection.Forward"/>.</para>
...
//                Invariant.Assert(this.GetScopingNode() is TextTreeRootNode); 
        ...
        /// <para>- opening or closing tag of a <see cref="TextElement"/>.</para> 
        /// <para>- the whole <see cref="UIElement"/> as atomic embedded Object.</para>
        /// <para>See examples in <seealso cref="TextPointer.GetPositionAtOffset"/> method with one parameter.</para> 
        /// </remarks>
...
//        }
        ...
        /// <code>
        ///     boolean IsElementEmpty(TextElement element) 
        ///     {
...
//        /*internal*/ public TextPointer GetInsertionPosition() 
//        {
...
//        }
        ...
        /// "insertion position" in the <see cref="TextPointer.GetInsertionPosition"/>
        /// method.</para>
...
//        }
        ...
        /// </exception>
        /*internal*/ public void InsertTextElement(TextElement textElement)
        { 
        ...
        /// </remarks> 
        public boolean IsAtLineStartPosition
        { 
            get 
            {
                _tree.EmptyDeadPositionList(); 
        ...
        /// </remarks>
        /*internal*/ public Block ParagraphOrBlockUIContainer
        {
            // 
            get
            { 
        ...
        /// which can be one of <see cref="TextBock"/>, <see cref="TextFlow"/>, 
        ...
        /*internal*/ public Inline GetNonMergeableInlineAncestor() 
        {
        ...
        /*internal*/ public ListItem GetListAncestor() 
        {
        ...
        /*internal*/ public static int GetTextInRun(TextContainer textContainer, int symbolOffset, TextTreeTextNode textNode, int nodeOffset, LogicalDirection direction, char[] textBuffer, int startIndex, int count) 
        {
            int skipCount; 
            int finalCount;
        ...
        /*internal*/ public static DependencyObject GetAdjacentElement(TextTreeNode node, ElementEdge edge, LogicalDirection direction) 
        {
        ...
        /// </exception>
        /*internal*/ public void MoveToPosition(TextPointer textPosition) 
        { 
        ...
        /// </returns>
        /*internal*/ public int MoveByOffset(int offset) 
        {
            SplayTreeNode node;
            ElementEdge edge;
            int symbolOffset; 
        ...
        /// </remarks> 
        /*internal*/ public boolean MoveToNextContextPosition(LogicalDirection direction) 
        {
            TextTreeNode node; 
            ElementEdge edge;
            boolean moved;
        ...
        /// </returns>
        /*internal*/ public boolean MoveToInsertionPosition(LogicalDirection direction) 
        {
            ValidationHelper.VerifyDirection(direction, "direction"); 
            VerifyNotFrozen(); 
        ...
        /// True if the TextPointer is repositioned, false otherwise. 
        /// </returns>
        /*internal*/ public boolean MoveToNextInsertionPosition(LogicalDirection direction)
        {
            ValidationHelper.VerifyDirection(direction, "direction"); 
            VerifyNotFrozen();
        ...
        /// positioned where it started -- at the start of the following line. 
        /// </remarks>
        /*internal*/ public int MoveToLineBoundary(int count)
        {
            VerifyNotFrozen(); 
        ...
        /// according to flow schema. 
        /// </exception>
        /*internal*/ public void InsertUIElement(UIElement uiElement) 
        { 
            if (uiElement == null)
            { 
        ...
        // 
        /*internal*/ public TextElement GetAdjacentElementFromOuterPosition(LogicalDirection direction)
        { 
        ...
        /*internal*/ public void SetLogicalDirection(LogicalDirection direction)
        { 
        ...
        /// </remarks> 
        /*internal*/ public TextPointer GetFrozenPointer(LogicalDirection logicalDirection)
        { 
...
//        }
        ...
        public int /*ITextPointer.*/CompareTo(ITextPointer position) 
        {
...
//        } 
        ...
        public Type /*ITextPointer.*/GetElementType(LogicalDirection direction)
        {
            DependencyObject element; 
        ...
        public boolean /*ITextPointer.*/HasEqualScope(ITextPointer position)
        { 
        ...
        public Object /*ITextPointer.*/GetValue(DependencyProperty formattingProperty) 
        {
        ...
        public Object /*ITextPointer.*/ReadLocalValue(DependencyProperty formattingProperty)
        { 
            TextElement element;
        ...
        public LocalValueEnumerator /*ITextPointer.*/GetLocalValueEnumerator()
        { 
            DependencyObject element;
...
//        boolean ITextPointer.MoveToNextContextPosition(LogicalDirection direction) 
//        {
...
//        } 
        ...
        /*internal*/ public void MoveToElementEdge(ElementEdge edge) 
        {
            TextTreeTextElementNode elementNode;
...
//        boolean ITextPointer.MoveToInsertionPosition(LogicalDirection direction)
//        { 
//            return MoveToInsertionPosition(direction); 
//        }
 
//        boolean ITextPointer.MoveToNextInsertionPosition(LogicalDirection direction)
//        {
...
//#if DEBUG
        /// <summary> 
        /// </summary>
        /*internal*/ public boolean MoveToCaretPosition(LogicalDirection contentDirection)
        {
            TextPointer position; 
        ...
        /// <summary>
        /// </summary> 
        /*internal*/ public boolean MoveToNextCaretPosition(LogicalDirection direction)
        {
            TextPointer position;
            boolean moved; 
        ...
        /// <summary>
        /// </summary> 
        /*internal*/ public boolean MoveToBackspaceCaretPosition() 
        {
            TextPointer position; 
            boolean moved;
...
//        // 
        ...
        public void /*ITextPointer.*/DeleteContentToPosition(ITextPointer limit)
        {
            _tree.BeginChange(); 
            try
            { 
...
//        boolean ITextPointer.ValidateLayout()
//        { 
//            return this.ValidateLayout();
//        }

        /// <see cref="ITextPointer.ValidateLayout"/> 
        /*internal*/ public boolean ValidateLayout()
        { 
        ...
        /*internal*/ public TextTreeTextNode GetAdjacentTextNodeSibling(LogicalDirection direction)
        { 
        ...
        // Returns the TextTreeTextNode in the direction indicated bordering
        // a TextPointer, or null if no such node exists. 
        /*internal*/ public static TextTreeTextNode GetAdjacentTextNodeSibling(TextTreeNode node, ElementEdge edge, LogicalDirection direction)
        {
        ...
        // Returns the TextTreeTextNode in the direction indicated bordering 
        // a TextPointer, or null if no such node exists. 
        /*internal*/ public TextTreeTextElementNode GetAdjacentTextElementNodeSibling(LogicalDirection direction)
        { 
        ...
        // Returns the TextTreeTextNode in the direction indicated bordering 
        // a TextPointer, or null if no such node exists.
        /*internal*/ public TextTreeTextElementNode GetAdjacentTextElementNode(LogicalDirection direction) 
        { 
        ...
        // a TextPointer, or null if no such node exists.
        /*internal*/ public TextTreeNode GetAdjacentSiblingNode(LogicalDirection direction) 
        {
            DebugAssertGeneration(); 
        ...
        /*internal*/ public static TextTreeNode GetAdjacentSiblingNode(TextTreeNode node, ElementEdge edge, LogicalDirection direction)
        {
        ...
        /*internal*/ public int GetSymbolOffset()
        {
            DebugAssertGeneration();
        ...
        // Returns the symbol offset within the TextContainer of this Position.
        /*internal*/ public static int GetSymbolOffset(TextContainer tree, TextTreeNode node, ElementEdge edge) 
        {
            int offset;
        ...
        /*internal*/ public void SyncToTreeGeneration() 
        { 
            SplayTreeNode node;
...
//                        Invariant.Assert(edge == ElementEdge.AfterEnd, "edge AfterEnd is expected");
        ...
        /*internal*/ public TextTreeNode GetScopingNode() 
        { 
            return GetScopingNode(_node, this.Edge);
        } 

        /*internal*/ public static TextTreeNode GetScopingNode(TextTreeNode node, ElementEdge edge)
        {
        ...
        /*internal*/ public void DebugAssertGeneration() 
        { 
            Invariant.Assert(_generation == _tree.PositionGeneration, "TextPointer not synchronized to tree generation!");
        } 

        /*internal*/ public boolean GetNextNodeAndEdge(/*out*/ TextTreeNode node, out ElementEdge edge)
        {
            DebugAssertGeneration(); 
        ...
        /*internal*/ public static boolean GetNextNodeAndEdge(TextTreeNode sourceNode, ElementEdge sourceEdge, 
        		boolean plainTextOnly, /*out*/ TextTreeNode node, /*out*/ ElementEdge edge)
        { 
            ...
            { 
                ...
                { 
                    ...
                    Invariant.Assert(newNode instanceof TextTreeRootNode);
        ...
        /*internal*/ public boolean GetPreviousNodeAndEdge(/*out*/ TextTreeNode node, /*out*/ ElementEdge edge)
        {
            DebugAssertGeneration();
        ...
        /*internal*/ public static boolean GetPreviousNodeAndEdge(TextTreeNode sourceNode, ElementEdge sourceEdge, boolean plainTextOnly, /*out*/ TextTreeNode node, /*out*/ ElementEdge edge)
        {
            SplayTreeNode currentNode; 
            SplayTreeNode newNode;
            SplayTreeNode containingNode; 
        ...
        /*internal*/ public static TextPointerContext GetPointerContextForward(TextTreeNode node, ElementEdge edge)
        { 
        ...
        /*internal*/ public static TextPointerContext GetPointerContextBackward(TextTreeNode node, ElementEdge edge)
        { 
            TextPointerContext symbolType;
        ...
        /*internal*/ public void InsertInline(Inline inline) 
        {
            TextPointer position = this;

            // Check for hyperlink schema validity first -- we'll throw on an illegal Hyperlink descendent insert. 
            boolean isValidChild = TextSchema.ValidateChild(position, /*childType*/inline.GetType(), false /* throwIfIllegalChild */, true /* throwIfIllegalHyperlinkDescendent */);
...
//                Invariant.Assert(position.Parent is Run, "EnsureInsertionPosition() must return a position in text content"); 
        ...
        /*internal*/ public static DependencyObject GetCommonAncestor(TextPointer position1, TextPointer position2)
        { 
...
//        #region Internal Properties 
        ...
        boolean ITextPointer.HasValidLayout 
        {
            get
            {
        ...
        boolean ITextPointer.IsAtCaretUnitBoundary 
        {
            get
            {
                _tree.EmptyDeadPositionList(); 
        ...
        boolean ITextPointer.IsAtInsertionPosition
        { 
            get { return this.IsAtInsertionPosition; }
        }

        // <see cref="TextPointer.IsFrozen"/> 
        boolean ITextPointer.IsFrozen
        { 
            get 
            {
        ...
        // Offset in unicode chars within the document. 
        /*internal*/ public int CharOffset
        { 
            get
            {
                TextTreeTextElementNode elementNode;
        ...
        /// </summary> 
        /*internal*/ public FrameworkElement ContainingFrameworkElement
        {
            get
            { 
        ...
        /*internal*/ public boolean IsAtRowEnd 
        {
            get 
            { 
...
//#endif // DEBUG
        ...
        /*internal*/ public boolean HasNonMergeableInlineAncestor 
        { 
            get
            { 
                Inline ancestor = this.GetNonMergeableInlineAncestor();
        ...
        /*internal*/ public boolean IsAtNonMergeableInlineStart
        { 
            get
            {
        ...
        /*internal*/ public TextTreeNode Node
        { 
            get
            {
                return _node;
        ...
        /*internal*/ public ElementEdge Edge
        { 
            get
            {
        ...
        /*internal*/ public Block ParentBlock
        { 
            get
            {
                _tree.EmptyDeadPositionList();
...
//        #region Private Methods 
        ...
        private void Initialize(TextContainer tree, TextTreeNode node, ElementEdge edge, LogicalDirection gravity, uint generation,
            boolean caretUnitBoundaryCache, boolean isCaretUnitBoundaryCacheValid, uint layoutGeneration)
        { 
            _tree = tree;
        ...
        // a TextPointer, or null if no such node exists. 
        /*internal*/ public TextTreeNode GetAdjacentNode(LogicalDirection direction)
        {
            return GetAdjacentNode(_node, this.Edge, direction);
        } 

        /*internal*/ public static TextTreeNode GetAdjacentNode(TextTreeNode node, ElementEdge edge, LogicalDirection direction) 
        { 
            TextTreeNode adjacentNode;
...
//#if DEBUG
        // Debug-only unique identifier for this instance. 
        private final int _debugId = _debugIdCounter++;
