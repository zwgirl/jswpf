...
// Each TextContainer maintains an array of TextTreeTextBlocks that holds all
    ...
    /*internal*/ public class TextTreeTextBlock extends SplayTreeNode 
    {
        //-----------------------------------------------------
        //
        //  Constructors 
...
//        #region Constructors
        ...
        /*internal*/ public TextTreeTextBlock(int size)
        {
...
//        #region Internal Methods
        ...
        /*internal*/ public int InsertText(int logicalOffset, Object text, int textStartIndex, int textEndIndex)
        { 
            int count; 
            String textString;
            char[] textChars; 
...
//            Invariant.Assert(textStartIndex <= textEndIndex, "Bad start/end index!");
        ...
        /*internal*/ public TextTreeTextBlock SplitBlock() 
        {
...
//                Invariant.Assert(newBlock._gapOffset == 0);
        ...
        // consider the gap). 
        /*internal*/ public void RemoveText(int logicalOffset, int count)
        { 
...
//            Invariant.Assert(originalCount == this.Count + originalCountToRemove); 
        ...
        /*internal*/ public int ReadText(int logicalOffset, int count, char []chars, int charsStartIndex) 
        {
            int copyCount;
            int originalCount;
...
//                Invariant.Assert(false, "Can't set SymbolCount on TextTreeTextBlock!"); 
        ...
        /*internal*/ public int FreeCapacity
        { 
            get
            {
                return _gapSize;
...
//        #region Private Fields 
        ...
        /*internal*/ public final int MaxBlockSize = 4096;
