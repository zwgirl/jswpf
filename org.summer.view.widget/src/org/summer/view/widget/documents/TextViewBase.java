...
/// <summary>
    ...
    /// </summary> 
    /*internal*/ public abstract class TextViewBase implements ITextView 
    {
        //------------------------------------------------------------------- 
        //
        //  Internal Methods
        ...
        /// </summary>
        /*internal*/ public abstract ITextPointer GetTextPositionFromPoint(Point point, bool snapToText);
        ...
        /// rect. 
        /// </remarks>
        /*internal*/ public /*virtual*/ Rect GetRectangleFromTextPosition(ITextPointer position)
        {
            Transform transform; 
        ...
        /// </summary>
        /*internal*/ public abstract Rect GetRawRectangleFromTextPosition(ITextPointer position, out Transform transform); 

        /// <summary>
        /// <see cref="ITextView.GetTightBoundingGeometryFromTextPositions"/>
        /// </summary> 
        /*internal*/ public abstract Geometry GetTightBoundingGeometryFromTextPositions(ITextPointer startPosition, ITextPointer endPosition);
 
        /// <summary> 
        /// <see cref="ITextView.GetPositionAtNextLine"/>
        /// </summary> 
        /*internal*/ public abstract ITextPointer GetPositionAtNextLine(ITextPointer position, double suggestedX, int count, out double newSuggestedX, out int linesMoved);

        /// <summary>
        /// <see cref="ITextView.GetPositionAtNextLine"/> 
        /// </summary>
        /*internal*/ public /*virtual*/ ITextPointer GetPositionAtNextPage(ITextPointer position, Point suggestedOffset, int count, out Point newSuggestedOffset, out int pagesMoved) 
        { 
        ...
        /// </summary> 
        /*internal*/ public abstract bool IsAtCaretUnitBoundary(ITextPointer position); 

        /// <summary> 
        /// <see cref="ITextView.GetNextCaretUnitPosition"/>
        /// </summary>
        /*internal*/ public abstract ITextPointer GetNextCaretUnitPosition(ITextPointer position, LogicalDirection direction);
 
        /// <summary>
        /// <see cref="ITextView.GetBackspaceCaretUnitPosition"/> 
        /// </summary> 
        /*internal*/ public abstract ITextPointer GetBackspaceCaretUnitPosition(ITextPointer position);
 
        /// <summary>
        /// <see cref="ITextView.GetLineRange"/>
        /// </summary>
        /*internal*/ public abstract TextSegment GetLineRange(ITextPointer position); 

        /// <summary> 
        /// <see cref="ITextView.GetGlyphRuns"/> 
        /// </summary>
        /*internal*/ public /*virtual*/ ReadOnlyCollection<GlyphRun> GetGlyphRuns(ITextPointer start, ITextPointer end) 
        {
        ...
        /// </summary>
        /*internal*/ public abstract bool Contains(ITextPointer position); 
        ...
        /// </remarks>
        /*internal*/ public static void BringRectIntoViewMinimally(ITextView textView, Rect rect)
        {
        ...
        /// </summary> 
        /*internal*/ public /*virtual*/ void BringPositionIntoViewAsync(ITextPointer position, object userState)
        { 
            // Verify that layout information is valid. Cannot continue if not valid.
            if (!IsValid)
            {
        ...
        /// </summary>
        /*internal*/ public /*virtual*/ void BringPointIntoViewAsync(Point point, object userState)
        { 
        ...
        /// </summary> 
        /*internal*/ public /*virtual*/ void BringLineIntoViewAsync(ITextPointer position, double suggestedX, int count, object userState)
        {
        ...
        /// </summary> 
        /*internal*/ public /*virtual*/ void BringPageIntoViewAsync(ITextPointer position, Point suggestedOffset, int count, object userState)
        {
            ITextPointer newPosition;
        ...
        /// </summary> 
        /*internal*/ public /*virtual*/ void CancelAsync(object userState)
        {
        }
        ...
        /// </summary> 
        /*internal*/ public /*virtual*/ bool Validate()
        { 
            return this.IsValid;
        }
        ...
        /// </summary> 
        /*internal*/ public /*virtual*/ bool Validate(Point point) 
        {
            return Validate(); 
        }
        ...
        /// </summary>
        /*internal*/ public /*virtual*/ bool Validate(ITextPointer position) 
        { 
            Validate();
        ...
        /// </summary>
        /*internal*/ public /*virtual*/ void ThrottleBackgroundTasksForUserInput() 
        { 
        }
        ...
        /// </summary> 
        /*internal*/ public abstract UIElement RenderScope { get; }
 
        /// <summary> 
        /// <see cref="ITextView.TextContainer"/>
        /// </summary> 
        /*internal*/ public abstract ITextContainer TextContainer { get; }

        /// <summary>
        /// <see cref="ITextView.IsValid"/> 
        /// </summary>
        /*internal*/ public abstract bool IsValid { get; } 
 
        /// <summary>
        /// <see cref="ITextView.RendersOwnSelection"/> 
        /// </summary>
        /*internal*/ public /*virtual*/ bool RendersOwnSelection
        {
            get 
            {
                return false; 
        ...
        /// </summary> 
        /*internal*/ public abstract ReadOnlyCollection<TextSegment> TextSegments { get; }
