...
// ---------------------------------------------------------------------
    // Text line formatter.
    // ---------------------------------------------------------------------
    /*internal*/ public /*sealed*/ class ComplexLine extends Line 
    {
        // ------------------------------------------------------------------ 
        // 
...
//        #region Internal Methods 
        ...
        // ------------------------------------------------------------------ 
        /*internal*/ public ComplexLine(TextBlock owner)
        {
        	super(owner);
        } 
        ...
        // ------------------------------------------------------------------ 
        /*internal*/ public /*override*/ void Arrange(VisualCollection vc, Vector lineOffset)
        { 
        ...
        // ----------------------------------------------------------------- 
        /*internal*/ public /*override*/ bool HasInlineObjects()
        {
        ...
        // ----------------------------------------------------------------- 
        /*internal*/ public /*override*/ IInputElement InputHitTest(double offset) 
        {
            TextContainer tree; 
