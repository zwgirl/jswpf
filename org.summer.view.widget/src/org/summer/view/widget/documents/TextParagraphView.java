...
/// <summary>
    ...
    /// </summary>
    /*internal*/ public class TextParagraphView extends TextViewBase 
    {
        //------------------------------------------------------------------- 
        // 
        //  Constructors
        ...
        /// </param> 
        /*internal*/ public TextParagraphView(TextBlock owner, ITextContainer textContainer)
        { 
            _owner = owner; 
        ...
        /// </summary>
        /*internal*/ public /*override*/ ITextPointer GetTextPositionFromPoint(Point point, boolean snapToText) 
        { 
        ...
        /// </remarks>
        /*internal*/ public /*override*/ Rect GetRawRectangleFromTextPosition(ITextPointer position, out Transform transform)
        {
        ...
        /// </summary>
        /*internal*/ public /*override*/ Geometry GetTightBoundingGeometryFromTextPositions(ITextPointer startPosition, ITextPointer endPosition) 
        { 
...
//#endif 
        ...
        /// </summary>
        /*internal*/ public /*override*/ ITextPointer GetPositionAtNextLine(ITextPointer position, double suggestedX, int count, out double newSuggestedX, out int linesMoved)
        {
        ...
        /// </summary> 
        /*internal*/ public /*override*/ boolean IsAtCaretUnitBoundary(ITextPointer position)
        { 
        ...
        /// </summary>
        /*internal*/ public /*override*/ ITextPointer GetNextCaretUnitPosition(ITextPointer position, LogicalDirection direction) 
        { 
            // Verify valid layout, position and direction
            if (!IsValid) 
            {
        ...
        /// </summary>
        /*internal*/ public /*override*/ ITextPointer GetBackspaceCaretUnitPosition(ITextPointer position)
        {
            // Verify valid layout, position and direction 
            if (!IsValid)
            { 
        ...
        /// </summary> 
        /*internal*/ public /*override*/ TextSegment GetLineRange(ITextPointer position) 
        {
        ...
        /// </summary>
        /*internal*/ public /*override*/ boolean Contains(ITextPointer position) 
        {
            // Verify that layout information is valid. Cannot continue if not valid.
            if (position == null)
            { 
        ...
        /// </summary>
        /*internal*/ public /*override*/ boolean Validate() 
        {
            _owner.UpdateLayout(); 
            return this.IsValid; 
        }
        ...
        /// </returns>
        /*internal*/ public static ITextPointer GetTextPositionFromPoint(ReadOnlyCollection<LineResult> lines, Point point, boolean snapToText) 
        { 
            int lineIndex;
        ...
        /// </returns> 
        /*internal*/ public static int GetLineFromPosition(ReadOnlyCollection<LineResult> lines, ITextPointer position)
        { 
            int lineIndex = -1; 
            int indexStart = 0;
...
//#endif 
        ...
        /// </summary> 
        /*internal*/ public void OnUpdated()
        { 
            OnUpdated(EventArgs.Empty); 
        }
 
        /// <summary>
        /// Invalidate TextView /*internal*/ public state.
        /// </summary>
        ...
        /// </summary>
        /*internal*/ public /*override*/ UIElement RenderScope 
        {
            get { return _owner; } 
        } 
        ...
        /// </summary>
        /*internal*/ public /*override*/ ITextContainer TextContainer
        { 
        ...
        /// </summary>
        /*internal*/ public /*override*/ boolean IsValid
        {
        ...
        /// </summary> 
        /*internal*/ public /*override*/ ReadOnlyCollection<TextSegment> TextSegments
        {
            get
            { 
        ...
        /// </summary> 
        /*internal*/ public ReadOnlyCollection<LineResult> Lines
        { 
            get 
            {
                if (_lines == null) 
        ...
        /// </returns> 
        /*internal*/ public static int GetLineFromPoint(ReadOnlyCollection<LineResult> lines, Point point, boolean snapToText)
        { 
            Debug.Assert(lines != null && lines.Count > 0); 
        ...
        private static boolean GetVerticalLineFromPoint(ReadOnlyCollection<LineResult> lines, Point point, boolean snapToText, /*out*/ int lineIndex) 
        { 
            Debug.Assert(lines != null && lines.Count > 0);
        ...
        /// <param name="lineIndex">Index of line that has been hit.</param>
        /// <returns>True if hit has been found.</returns> 
        private static boolean GetHorizontalLineFromPoint(ReadOnlyCollection<LineResult> lines, Point point, boolean snapToText, /*ref*/ int lineIndex) 
        {
            Debug.Assert(lines != null && lines.Count > 0); 

            boolean foundHit = false;
            boolean lookForSiblings = true;
        ...
        private final TextBlock _owner;

        /// <summary>
        /// TextContainer providing content for this view. 
        /// </summary>
        private final ITextContainer _textContainer; 
