...
//        #region Public Properties 
        ...
        public static void SetIsHyphenationEnabled(DependencyObject element, boolean value)
        { 
            if (element == null)
            { 
        ...
        public static boolean GetIsHyphenationEnabled(DependencyObject element)
        { 
            if (element == null)
            {
                throw new ArgumentNullException("element");
            ...
            return (boolean)element.GetValue(IsHyphenationEnabledProperty); 
        } 
...
//        [TypeConverter(typeof(LengthConverter))] 
        ...
        /// </summary> 
        public static final DependencyProperty BreakPageBeforeProperty =
                DependencyProperty.Register( 
                        "BreakPageBefore",
                        typeof(Boolean),
                        typeof(Block),
        ...
        /// </summary>
        public boolean BreakPageBefore
        {
            get { return (boolean)GetValue(BreakPageBeforeProperty); } 
        ...
        /// </summary>
        public static final DependencyProperty BreakColumnBeforeProperty =
                DependencyProperty.Register(
                        "BreakColumnBefore", 
                        typeof(Boolean),
                        typeof(Block), 
        ...
        /// </summary> 
        public boolean BreakColumnBefore
        { 
            get { return (boolean)GetValue(BreakColumnBeforeProperty); } 
        ...
        /// </summary> 
        public static final DependencyProperty ClearFloatersProperty =
                DependencyProperty.Register( 
                        "ClearFloaters", 
        ...
        /*internal*/ public static boolean IsValidMargin(object o) 
        {
            Thickness t = (Thickness)o; 
            return IsValidThickness(t, /*allow NaN*/true);
        }

        /*internal*/ public static boolean IsValidPadding(object o) 
        {
            Thickness t = (Thickness)o; 
            return IsValidThickness(t, /*allow NaN*/true); 
        }
 
        /*internal*/ public static boolean IsValidBorderThickness(object o)
        {
            Thickness t = (Thickness)o;
...
//        #region Private Methods
        ...
        private static boolean IsValidLineHeight(object o) 
        {
        ...
        private static boolean IsValidLineStackingStrategy(object o) 
        {
        ...
        private static boolean IsValidTextAlignment(object o)
        { 
        ...
        private static boolean IsValidWrapDirection(object o)
        { 
        ...
        /*internal*/ public static boolean IsValidThickness(Thickness t, boolean allowNaN)
        { 
