...
import org.summer.view.widget.media.FontFamily;
...
/// <remarks> 
/// </remarks> 
public abstract class TextElement extends FrameworkContentElement implements IAddChild
{ 
    //-----------------------------------------------------
    //
    //  Constructors
...
//    #region Public Methods
    ...
    /// </remarks>
    /*internal*/ public void Reposition(TextPointer start, TextPointer end) 
    {
        TextContainer tree;
...
//                    #pragma warning suppress 56506
    ...
    /// a new document. 
    /// </remarks>
    /*internal*/ public void RepositionWithContent(TextPointer textPosition) 
    {
        TextContainer tree;
...
//    #region Public Properties 
    ...
    /*internal*/ public static final UncommonField<TextElement> ContainerTextElementField = new UncommonField<TextElement>(); 
    ...
    /*internal*/ public StaticTextPointer StaticElementStart 
    {
        get 
        {
            TextContainer tree = EnsureTextContainer();
    ...
    /*internal*/ public StaticTextPointer StaticContentStart 
    {
        get 
        { 
            TextContainer tree = EnsureTextContainer();
    ...
    /*internal*/ public StaticTextPointer StaticContentEnd
    {
        get
        { 
            TextContainer tree = EnsureTextContainer();
    ...
    /*internal*/ public boolean Contains(TextPointer position)
    { 
        TextContainer tree = EnsureTextContainer();
    ...
    /*internal*/ public StaticTextPointer StaticElementEnd 
    { 
        get
        { 
            TextContainer tree = EnsureTextContainer();
...
//    #region IAddChild
    ...
    { 
        ...
        TextElement te = (TextElement) (value instanceof TextElement ? value : null);
...
//    #region Protected Methods 
    ...
    { 
        ...
        boolean localValueChanged = e.NewValueSource == BaseValueSourceInternal.Local || e.OldValueSource == BaseValueSourceInternal.Local; 
        ...
        if (localValueChanged || e.IsAValueChange || e.IsASubPropertyChange)
        {
            if (this.IsInTree) // No work to do if no one's listening. 
            {
                ...
                if (fmetadata != null) 
                {
                    boolean affectsMeasureOrArrange = fmetadata.AffectsMeasure || fmetadata.AffectsArrange || fmetadata.AffectsParentMeasure || fmetadata.AffectsParentArrange;
    ...
    /*internal*/ public void NotifyTypographicPropertyChanged(boolean affectsMeasureOrArrange, boolean localValueChanged, DependencyProperty property)
    { 
        if (!this.IsInTree) // No work to do if no one's listening.
        {
            return;
...
//    #region Internal Methods
    ...
    /*internal*/ public static TypographyProperties GetTypographyProperties(DependencyObject element)
    { 
        TypographyProperties group = new TypographyProperties(); 

        group.SetStandardLigatures((boolean) element.GetValue(Typography.StandardLigaturesProperty)); 
        group.SetContextualLigatures((boolean) element.GetValue(Typography.ContextualLigaturesProperty));
        group.SetDiscretionaryLigatures((boolean) element.GetValue(Typography.DiscretionaryLigaturesProperty));
        group.SetHistoricalLigatures((boolean) element.GetValue(Typography.HistoricalLigaturesProperty));
        group.SetAnnotationAlternates((int) element.GetValue(Typography.AnnotationAlternatesProperty)); 
        group.SetContextualAlternates((boolean) element.GetValue(Typography.ContextualAlternatesProperty));
        group.SetHistoricalForms((boolean) element.GetValue(Typography.HistoricalFormsProperty)); 
        group.SetKerning((boolean) element.GetValue(Typography.KerningProperty)); 
        group.SetCapitalSpacing((boolean) element.GetValue(Typography.CapitalSpacingProperty));
        group.SetCaseSensitiveForms((boolean) element.GetValue(Typography.CaseSensitiveFormsProperty)); 
        group.SetStylisticSet1((boolean) element.GetValue(Typography.StylisticSet1Property));
        group.SetStylisticSet2((boolean) element.GetValue(Typography.StylisticSet2Property));
        group.SetStylisticSet3((boolean) element.GetValue(Typography.StylisticSet3Property));
        group.SetStylisticSet4((boolean) element.GetValue(Typography.StylisticSet4Property)); 
        group.SetStylisticSet5((boolean) element.GetValue(Typography.StylisticSet5Property));
        group.SetStylisticSet6((boolean) element.GetValue(Typography.StylisticSet6Property)); 
        group.SetStylisticSet7((boolean) element.GetValue(Typography.StylisticSet7Property)); 
        group.SetStylisticSet8((boolean) element.GetValue(Typography.StylisticSet8Property));
        group.SetStylisticSet9((boolean) element.GetValue(Typography.StylisticSet9Property)); 
        group.SetStylisticSet10((boolean) element.GetValue(Typography.StylisticSet10Property));
        group.SetStylisticSet11((boolean) element.GetValue(Typography.StylisticSet11Property));
        group.SetStylisticSet12((boolean) element.GetValue(Typography.StylisticSet12Property));
        group.SetStylisticSet13((boolean) element.GetValue(Typography.StylisticSet13Property)); 
        group.SetStylisticSet14((boolean) element.GetValue(Typography.StylisticSet14Property));
        group.SetStylisticSet15((boolean) element.GetValue(Typography.StylisticSet15Property)); 
        group.SetStylisticSet16((boolean) element.GetValue(Typography.StylisticSet16Property)); 
        group.SetStylisticSet17((boolean) element.GetValue(Typography.StylisticSet17Property));
        group.SetStylisticSet18((boolean) element.GetValue(Typography.StylisticSet18Property)); 
        group.SetStylisticSet19((boolean) element.GetValue(Typography.StylisticSet19Property));
        group.SetStylisticSet20((boolean) element.GetValue(Typography.StylisticSet20Property));
        group.SetFraction((FontFraction) element.GetValue(Typography.FractionProperty));
        group.SetSlashedZero((boolean) element.GetValue(Typography.SlashedZeroProperty)); 
        group.SetMathematicalGreek((boolean) element.GetValue(Typography.MathematicalGreekProperty));
        group.SetEastAsianExpertForms((boolean) element.GetValue(Typography.EastAsianExpertFormsProperty)); 
    ...
    /*internal*/ public void DeepEndInit() 
    {
...
//            Invariant.Assert(this.IsInitialized); 
    ...
    /*internal*/ public static TextElement GetCommonAncestor(TextElement element1, TextElement element2) 
    {
        if (element1 != element2)
        {
            ...
            for (element = element1; element.Parent instanceof TextElement; element = (TextElement)element.Parent) 
            {
                depth1++;
            }
            for (element = element2; element.Parent instanceof TextElement; element = (TextElement)element.Parent) 
            {
                depth2++; 
            } 
...
//        Invariant.Assert(element1 == element2); 
    ...
    /// </remarks>
    /*internal*/ public /*virtual*/ void OnTextUpdated() 
    {
    }
    ...
    /// </summary> 
    /*internal*/ public /*virtual*/ void BeforeLogicalTreeChange()
    { 
    }
    ...
    /// causes a logical tree change that affects this element.
    /// </summary> 
    /*internal*/ public /*virtual*/ void AfterLogicalTreeChange() 
    {
    } 
...
//    #region Internal Properties
    ...
    //-----------------------------------------------------
    /*internal*/ public boolean IsInTree 
    {
        get 
        { 
    ...
    //-----------------------------------------------------
    /*internal*/ public int ElementStartOffset 
    { 
        get
        { 
//            Invariant.Assert(this.IsInTree, "TextElement is not in any TextContainer, caller should ensure this.");
    ...
    //-----------------------------------------------------
    /*internal*/ public int ContentStartOffset 
    {
        get
        {
//            Invariant.Assert(this.IsInTree, "TextElement is not in any TextContainer, caller should ensure this."); 
    ...
    //------------------------------------------------------
    /*internal*/ public int ContentEndOffset
    { 
        get
        { 
            Invariant.Assert(this.IsInTree, "TextElement is not in any TextContainer, caller should ensure this."); 
    ...
    //------------------------------------------------------
    /*internal*/ public int ElementEndOffset 
    { 
        get
        { 
            Invariant.Assert(this.IsInTree, "TextElement is not in any TextContainer, caller should ensure this.");
    ...
    //------------------------------------------------------
    /*internal*/ public TextTreeTextElementNode TextElementNode
    { 
        get
        { 
    ...
    //-----------------------------------------------------
    /*internal*/ public /*virtual*/ boolean IsIMEStructuralElement 
    { 
        get
        { 
            return false;
    ...
    // hide those edges.
    //-----------------------------------------------------
    /*internal*/ public /*virtual*/ boolean IsFirstIMEVisibleSibling 
    {
        get 
        { 
            boolean isFirstIMEVisibleSibling = false;
    ...
    //----------------------------------------------------- 
    /*internal*/ public TextElement NextElement
    { 
        get 
        {
            if (!this.IsInTree) 
    ...
    // on the same level of siblings.
    //------------------------------------------------------ 
    /*internal*/ public TextElement PreviousElement
    { 
        get 
        {
            if (!this.IsInTree) 
    ...
    // TextElement.
    //------------------------------------------------------ 
    /*internal*/ public TextElement FirstChildElement
    { 
        get 
        {
            if (!this.IsInTree) 
    ...
    // TextElement.
    //----------------------------------------------------- 
    /*internal*/ public TextElement LastChildElement
    { 
        get 
        {
            if (!this.IsInTree) 
...
//            Invariant.Assert(this.IsInTree);
    ...
    private static boolean IsValidFontFamily(Object o)
    { 
    ...
    /// </summary> 
    private static boolean IsValidFontSize(Object value)
    { 
