...
import org.summer.view.widget.collection.Stack;
  /// <summary>
    /// Undo Manager 
    /// </summary>
    /*internal*/ public class UndoManager
    {
        //----------------------------------------------------- 
        //
        //  Constructors 
...
//        #region Internal Methods
        ...
        /// </param> 
        /*internal*/ public static void AttachUndoManager(DependencyObject scope, UndoManager undoManager)
        {
            if (scope == null)
            { 
        ...
        /// </remarks> 
        /*internal*/ public static void DetachUndoManager(DependencyObject scope)
        { 
        ...
        /// </param>
        /// <returns></returns> 
        /*internal*/ public static UndoManager GetUndoManager(DependencyObject target)
        { 
            if (target == null) 
            {
                return null; 
        ...
        /// </exception>
        /*internal*/ public void Open(IParentUndoUnit unit)
        { 
        ...
        /// Thrown if passed unit is null.
        /// </exception>
        /*internal*/ public void Reopen(IParentUndoUnit unit)
        { 
            if (!IsEnabled)
            { 
                throw new InvalidOperationException(SR.Get(SRID.UndoServiceDisabled)); 
        ...
        /// </summary> 
        /*internal*/ public void Close(UndoCloseAction closeAction) 
        {
        ...
        /// </exception> 
        /*internal*/ public void Close(IParentUndoUnit unit, UndoCloseAction closeAction)
        {
            if (!IsEnabled)
            { 
                throw new InvalidOperationException(SR.Get(SRID.UndoServiceDisabled));
        ...
        /// Thrown if unit is null
        /// </exception> 
        /*internal*/ public void Add(IUndoUnit unit)
        { 
        ...
        /// </exception>
        /*internal*/ public void Undo(int count) 
        {
            if (!IsEnabled)
            {
                throw new InvalidOperationException(SR.Get(SRID.UndoServiceDisabled)); 
        ...
        /// </exception>
        /*internal*/ public void Redo(int count) 
        {
            if (!IsEnabled) 
            { 
                throw new InvalidOperationException(SR.Get(SRID.UndoServiceDisabled));
        ...
        /// </summary> 
        /*internal*/ public virtual void OnNextDiscard()
        {
            if (UndoCount > 0)
            { 
        ...
        /*internal*/ public IUndoUnit PeekUndoStack()
        { 
        ...
        /// </summary>
        /// <remark> 
        /// DANGER!  This method is /*internal*/ public (and not private) only so it can be accessed
        /// by IMEs.  Using this method can result in instability and is strongly discouraged.
        /// </remark>
        /*internal*/ public Stack SetRedoStack(Stack value) 
        {
...
//        #region Internal Properties
        ...
        /// </remarks>
        /*internal*/ public bool IsImeSupportModeEnabled 
        {
        ...
        /// </summary>
        /*internal*/ public UndoState State 
        {
            get 
            { 
                return _state;
        ...
        /// </summary>
        /*internal*/ public IParentUndoUnit OpenedUnit 
        {
            get
            {
                return _openedUnit; 
        ...
        /// </summary>
        /*internal*/ public IUndoUnit LastUnit
        {
            get 
            {
                return _lastUnit; 
        ...
        /// </remarks>
        /*internal*/ public IParentUndoUnit LastReopenedUnit 
        {
            get
            {
        ...
        /*internal*/ public static int UndoLimitDefaultValue
        { 
            get
            { 
        ...
        /// </remarks>
        /*internal*/ public IUndoUnit GetUndoUnit(int index)
        { 
        ...
        /// It does not handle circular undo stacks (_bottomUndoIndex > _topUndoIndex).
        /// </remarks> 
        /*internal*/ public void RemoveUndoRange(int index, int count)
        { 
            Invariant.Assert(index >= 0); 
        ...
        /// </remarks>
        /*internal*/ public int MinUndoStackCount 
        {
            get
            {
