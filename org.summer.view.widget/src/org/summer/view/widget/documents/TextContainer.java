...
import org.summer.view.widget.LocalValueEntry;
...
/*internal*/ public class TextContainer implements ITextContainer 
{
    //-----------------------------------------------------
    //
    //  Constructors 
...
//    #region Constructors
    ...
    /// </param> 
    /*internal*/ public TextContainer(DependencyObject parent, boolean plainTextOnly)
    { 
        _parent = parent;
        SetFlags(plainTextOnly, org.summer.view.widget.documents.PlainTextOnly);
    }
...
//    #region Internal Methods
    ...
    /*internal*/ public void EnableUndo(FrameworkElement uiScope) 
    {
//        Invariant.Assert(_undoManager == null, SR.Get(SRID.TextContainer_UndoManagerCreatedMoreThanOnce)); 
    ...
    /*internal*/ public void DisableUndo(FrameworkElement uiScope)
    { 
...
//        Invariant.Assert(_undoManager == MS.Internal.Documents.UndoManager.GetUndoManager(uiScope)); 
    ...
    /// element.
    /// </exception>
    /*internal*/ public void SetValue(TextPointer position, DependencyProperty property, Object value)
    { 
...
//            Invariant.Assert(textElement != null);
    ...
    /// </exception> 
    /*internal*/ public void SetValues(TextPointer position, LocalValueEnumerator values)
    { 
        TextElement textElement; 
...
//            Invariant.Assert(textElement != null); 
            ...
            while (values.MoveNext()) 
            {
                ...
                // If the property is final on the text element, then we shouldn't 
    ...
    /*internal*/ public void BeginChange() 
    {
        BeginChange(true /* undo */); 
    } 

    /*internal*/ public void BeginChangeNoUndo() 
    {
    ...
    /// <summary>
    /// </summary> 
    /*internal*/ public void EndChange() 
    {
    ...
    /// <summary>
    /// </summary> 
    /*internal*/ public void EndChange(boolean skipEvents)
    { 
...
//#endif 
    ...
    // Equivalent to this.Start.CreatePointer(offset), but does not 
    // necessarily allocate this.Start.
    /*internal*/ public TextPointer CreatePointerAtOffset(int offset, LogicalDirection direction) 
    { 
        EmptyDeadPositionList();
    ...
    /*internal*/ public TextPointer CreatePointerAtCharOffset(int charOffset, LogicalDirection direction)
    {
        EmptyDeadPositionList(); 
        DemandCreatePositionState();
    ...
    /*internal*/ public StaticTextPointer CreateStaticPointerAtOffset(int offset)
    {
        SplayTreeNode node; 
        ElementEdge edge;
        int nodeOffset; 
        ...
        // Add +1 to offset because we're converting from external to /*internal*/ public offsets.
    ...
    // Returns the "/*internal*/ public" offset of a StaticTextPointer, which includes 
    // an extra symbol for the root node.
    /*internal*/ public int GetInternalOffset(StaticTextPointer position) 
    { 
    ...
    int ITextContainer.CompareTo(StaticTextPointer position1, ITextPointer position2)
    {
        ...
        offsetThis = GetInternalOffset(position1); 
        offsetPosition = position2.Offset + 1; // Convert to /*internal*/ public offset with +1.
    ...
    /*internal*/ public void BeforeAddChange()
    { 
    ...
    /*internal*/ public void AddChange(TextPointer startPosition, int symbolCount, int charCount, PrecursorTextChangeType textChange)
    { 
    ...
    // Adds a change to the current change block. 
    // This call must be preceeded by a matching BeforeAddChange.
    /*internal*/ public void AddChange(TextPointer startPosition, int symbolCount, int charCount, PrecursorTextChangeType textChange, DependencyProperty property, boolean affectsRenderOnly) 
    { 
    ...
    // Adds a change to the current change block. 
    // This call must be preceeded by a matching BeforeAddChange. 
    /*internal*/ public void AddChange(TextPointer startPosition, TextPointer endPosition,
                            int symbolCount, int leftEdgeCharCount, int childCharCount, 
                            PrecursorTextChangeType textChange, DependencyProperty property, boolean affectsRenderOnly)
    {
        Invariant.Assert(_changeBlockLevel > 0, "All public APIs must call BeginChange!");
    ...
    // the collection. 
    /*internal*/ public void AddLocalValueChange()
    { 
        Invariant.Assert(_changeBlockLevel > 0, "All public APIs must call BeginChange!");
    ...
    /*internal*/ public void InsertTextInternal(TextPointer position, Object text)
    { 
        TextTreeTextNode textNode;
    ...
    // and insert that too.
    /*internal*/ public void InsertElementInternal(TextPointer startPosition, TextPointer endPosition, TextElement element) 
    { 
...
//        Invariant.Assert(endPosition.TextContainer == this);
        ...
        boolean scopesExistingContent = startPosition.CompareTo(endPosition) != 0;
        ...
        { 
            ...
            boolean sameTextContainer = (this == element.TextContainer);
    ...
    /*internal*/ public void InsertEmbeddedObjectInternal(TextPointer position, DependencyObject embeddedObject) 
    {
    ...
    /*internal*/ public void DeleteContentInternal(TextPointer startPosition, TextPointer endPosition) 
    {
    ...
    /*internal*/ public void GetNodeAndEdgeAtOffset(int offset, out SplayTreeNode node, out ElementEdge edge) 
    {
    ...
    /*internal*/ public void GetNodeAndEdgeAtOffset(int offset, boolean splitNode, out SplayTreeNode node, out ElementEdge edge)
    { 
        int nodeOffset; 
        int siblingTreeOffset;
        boolean checkZeroWidthNode; 
    ...
    // If the pair matches a character within a text node, the text node is split. 
    /*internal*/ public void GetNodeAndEdgeAtCharOffset(int charOffset, out TextTreeNode node, out ElementEdge edge) 
    {
        int nodeCharOffset; 
    ...
    /*internal*/ public void EmptyDeadPositionList() 
    {
    ...
    /*internal*/ public static int GetTextLength(Object text) 
    {
        String textString; 
        int length;
    ...
    /*internal*/ public void AssertTree() 
    {
#if DEBUG_SLOW
    ...
    /*internal*/ public int GetContentHashCode()
    { 
    ...
    /*internal*/ public void NextLayoutGeneration()
    {
    ...
    /*internal*/ public void ExtractElementInternal(TextElement element) 
    {
        ExtractChangeEventArgs extractChangeEventArgs;
    ...
    /*internal*/ public boolean IsAtCaretUnitBoundary(TextPointer position)
    { 
    ...
    /// </remarks> 
    /*internal*/ public TextPointer Start
    { 
        get 
        {
...
//             VerifyAccess();
    ...
    /// </remarks>
    /*internal*/ public TextPointer End 
    {
        get
        {
...
//             VerifyAccess();
    ...
    public boolean /*ITextContainer.*/IsReadOnly
    { 
        get 
        {
    ...
    public ITextPointer /*ITextContainer.*/Start 
    {
        get 
        { 
            return this.Start;
    ...
    public int /*ITextContainer.*/Generation 
    {
        get 
        { 
    ...
    public Highlights /*ITextContainer.*/Highlights
    { 
        get
        { 
    ...
    public DependencyObject /*ITextContainer.*/Parent
    {
        get 
        {
            return this.Parent; 
    ...
    public ITextSelection /*ITextContainer.*/TextSelection
    { 
        get
        { 
    ...
    public UndoManager /*ITextContainer.*/UndoManager
    { 
        get
        {
    ...
    public ITextView /*ITextContainer.*/TextView
    { 
        get
        {
    ...
    public int /*ITextContainer.*/SymbolCount
    {
        get
        { 
    ...
    // Count of symbols in this tree, equivalent to this.Start.GetOffsetToPosition(this.End), 
    // but doesn't necessarily allocate anything.
    /*internal*/ public int SymbolCount
    {
        get 
        {
    ...
    /*internal*/ public int InternalSymbolCount
    { 
        get 
        {
    ...
    /*internal*/ public int IMECharCount
    { 
        get 
        {
    ...
    // Character count for the entire tree. 
    public int /*ITextContainer.*/IMECharCount
    { 
        get 
        {
    ...
    // The tree generation.  Incremented whenever the tree content changes. 
    // Use NextGeneration to increment the generation. 
    /*internal*/ public int Generation
    { 
        get
        {
...
//#endif // REFCOUNT_DEAD_TEXTPOINTERS 
    ...
    /*internal*/ public Highlights Highlights
    { 
        get
        { 
            if (_highlights == null) 
    ...
    /*internal*/ public TextTreeRootNode RootNode
    { 
        get { return _rootNode; }
    }

    // The first node contained by the root node -- first toplevel node. 
    /*internal*/ public TextTreeNode FirstContainedNode
    { 
        get 
        {
    ...
    /*internal*/ public TextTreeNode LastContainedNode
    { 
        get 
        {
    ...
    // May be null.
    /*internal*/ public UndoManager UndoManager 
    { 
        get
        { 
            return _undoManager;
    ...
    /*internal*/ public ITextSelection TextSelection 
    { 
        get
        { 
    ...
    /*internal*/ public boolean HasListeners 
    {
        get 
        {
    ...
    /*internal*/ public boolean PlainTextOnly
    { 
        get
        {
    ...
    /*internal*/ public boolean CollectTextChanges 
    {
        get
        {
...
//    #region Internal Events
    ...
    /*internal*/ public /*event*/ EventHandler Changing
    { 
        add { ChangingHandler += value; } 
        remove { ChangingHandler -= value; }
    } 

    /*internal*/ public /*event*/ TextContainerChangeEventHandler Change
    {
        add { ChangeHandler += value; } 
        remove { ChangeHandler -= value; }
    } 

    /*internal*/ public /*event*/ TextContainerChangedEventHandler Changed
    { 
    ...
    private int DeleteContentFromSiblingTree(SplayTreeNode containingNode, TextPointer startPosition, TextPointer endPosition, boolean newFirstIMEVisibleNode, out int charCount) 
    {
        SplayTreeNode leftSubTree; 
        SplayTreeNode middleSubTree;
        SplayTreeNode rightSubTree;
    ...
    { 
        boolean leftEdgeReferenceCount;
        boolean rightEdgeReferenceCount;
    ...
    private void GetReferenceCounts(TextTreeNode node, /*ref*/ boolean leftEdgeReferenceCount, /*ref*/ boolean rightEdgeReferenceCount) 
    { 
        do
        { 
    ...
    private int CutContent(TextPointer startPosition, TextPointer endPosition, 
    		/*out*/ int charCount, /*out*/ SplayTreeNode leftSubTree, /*out*/ SplayTreeNode middleSubTree, 
    ...
    private char[] ExtractElementInternal(TextElement element, boolean deep, /*out*/ ExtractChangeEventArgs extractChangeEventArgs)
    {
        TextTreeTextElementNode elementNode;
        SplayTreeNode containingNode; 
        TextPointer startPosition;
    ...
    // node's sibling tree. 
    private void ExtractElementFromSiblingTree(SplayTreeNode containingNode, TextTreeTextElementNode elementNode, boolean deep)
    { 
        TextTreeNode previousNode;
        ElementEdge previousEdge;
        TextTreeNode nextNode;
...
//#endif // DEBUG_SLOW 
    ...
    // Worker for /*internal*/ public Begin methods.
    ...
    private void FireChangeEvent(TextPointer startPosition, TextPointer endPosition, int symbolCount,
                                 ...
                                 PrecursorTextChangeType precursorTextChange, DependencyProperty property, boolean affectsRenderOnly)
    {
...
//        #region Constructors
        ...
        /*internal*/ public ExtractChangeEventArgs(TextContainer textTree, TextPointer startPosition, TextTreeTextElementNode node,
...
//        #region Internal Methods
        ...
        /*internal*/ public void AddChange() 
        {
...
//        #region Internal Properties 
        ...
        /*internal*/ public TextContainer TextContainer { get { return _textTree; } }

        // Count of chars covered the extracted element, not counting edges.
        /*internal*/ public int ChildIMECharCount { get { return _childCharCount; } } 
...
//        #region Private Fields 
        ...
        // TextContainer associated with the pending event. 
        private final TextContainer _textTree;
        ...
        private final TextPointer _startPosition; 
        ...
        private final int _charCount; 

        // Count of chars covered the extracted element, not counting edges. 
        private final int _childCharCount; 

        // Next node following the extracted node. 
        private final TextTreeTextElementNode _newFirstIMEVisibleNode;

        // Former first contained node of the extracted node.
        private final TextTreeTextElementNode _formerFirstIMEVisibleNode; 
...
//    #region Private Fields 
    ...
    private final DependencyObject _parent;
