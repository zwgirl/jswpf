...
/// <summary> 
    ...
    /// </remarks>
    /*internal*/ public abstract class ContentElementCollection<TParent extends TextElement, TItem  extends FrameworkContentElement> implements IList
...
//        #region Constructors
        ...
        /*internal*/ public ContentElementCollection(TParent owner)
        { 
...
//        #region Public Methods
        ...
        /// </summary> 
        /*internal*/ public IEnumerator GetEnumerator()
        {
        ...
        {
            /*internal*/ public ContentElementCollectionEnumeratorSimple(ContentElementCollection<TParent, TItem> collection)
            { 
        ...
        /// </summary>
        /*internal*/ public void EnsureCapacity(int min) 
        {
        ...
        /// </remarks>
        abstract /*internal*/ public void PrivateConnectChild(int index, TItem item);
        ...
        /// </summary> 
        abstract /*internal*/ public void PrivateDisconnectChild(TItem item);
        ...
        /*internal*/ public void PrivateRemove(TItem item)
        { 
        ...
        /*internal*/ public bool BelongsToOwner(TItem item)
        { 
            if (item == null)
                return false; 
        ...
        /// </summary>
        /*internal*/ public int PrivateCapacity
        { 
            get
            { 
                return (Items.Length); 
