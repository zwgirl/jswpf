...
// Each TextContainer maintains an array of TextTreeTextBlocks that holds all
    ...
    /*internal*/ public /*static*/ class TextTreeText
    { 
        //-----------------------------------------------------
        //
        //  Internal Methods
...
//        #region Internal Methods 
        ...
        // or an array of char.
        /*internal*/ public static void InsertText(TextTreeRootTextBlock rootTextBlock, int offset, Object text)
        {
...
//            Invariant.Assert(text is String || text is char[], "Bad text parameter!"); 
        ...
        /*internal*/ public static void RemoveText(TextTreeRootTextBlock rootTextBlock, int offset, int count)
        { 
...
//                Invariant.Assert(firstBlock != null);
        ...
        // char array.
        /*internal*/ public static char[] CutText(TextTreeRootTextBlock rootTextBlock, int offset, int count) 
        {
            char[] text;
        ...
        /*internal*/ public static void ReadText(TextTreeRootTextBlock rootTextBlock, int offset, int count, char[] chars, int startIndex) 
        {
            TextTreeTextBlock block; 
            int localOffset; 
            int blockCount;
...
//                    Invariant.Assert(block != null, "Caller asked for too much text!");
        ...
        /*internal*/ public static void InsertObject(TextTreeRootTextBlock rootTextBlock, int offset)
        { 
        ...
        // The actual value stored doesn't really matter, it will never be read.
        /*internal*/ public static void InsertElementEdges(TextTreeRootTextBlock rootTextBlock, int offset, int childSymbolCount)
        { 
        ...
        /*internal*/ public static void RemoveElementEdges(TextTreeRootTextBlock rootTextBlock, int offset, int symbolCount)
        { 
...
//        #region Private Methods 
        ...
        /*internal*/ public static void Remove(TextTreeTextBlock firstNode, TextTreeTextBlock lastNode) 
        {
