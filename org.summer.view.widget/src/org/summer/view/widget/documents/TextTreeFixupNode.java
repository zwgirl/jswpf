package org.summer.view.widget.documents;
 // TextTreeFixupNodes never actually appear in live trees.  However,
    ...
    /*internal*/ public class TextTreeFixupNode extends TextTreeNode
    { 
        //----------------------------------------------------- 
        //
        //  Constructors 
...
//        #region Constructors 
        ...
        /*internal*/ public TextTreeFixupNode(TextTreeNode previousNode, ElementEdge previousEdge, TextTreeNode nextNode, ElementEdge nextEdge) : 
...
//        #region Internal Properties
        ...
        /*internal*/ public TextTreeNode PreviousNode
        { 
            get
            { 
        ...
        // when leaving the deleted content.
        /*internal*/ public ElementEdge PreviousEdge 
        {
            get 
            { 
        ...
        // when leaving the deleted content. 
        /*internal*/ public TextTreeNode NextNode
        { 
            get 
            {
                return _nextNode; 
        ...
        // when leaving the deleted content.
        /*internal*/ public ElementEdge NextEdge 
        { 
            get
            { 
                return _nextEdge;
...
//        #region Private Fields 
        ...
        private final TextTreeNode _previousNode; 

        // The edge immediately preceding the deleted content parented by this fixup node.
        private final ElementEdge _previousEdge;
 
        // The node immediately following the deleted content parented by this fixup node.
        private final TextTreeNode _nextNode; 
 
        // The edge immediately following the deleted content parented by this fixup node.
        private final ElementEdge _nextEdge; 

        // If this fixup is for a single TextElementNode extraction, this
        // field is the first contained node of the extracted element node.
        private final TextTreeNode _firstContainedNode; 

        // If this fixup is for a single TextElementNode extraction, this 
        // field is the last contained node of the extracted element node. 
        private final TextTreeNode _lastContainedNode;
