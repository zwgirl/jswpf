...
import org.summer.view.widget.controls.AccessText;
...
/// <summary>
    ...
    /// </summary> 
    /*internal*/ public /*static*/ class TextRangeBase 
    {
        //----------------------------------------------------- 
        //
        // ITextRange Methods
...
//        #region ITextRange Methods 
        ...
        /// </summary> 
        // 
        /*internal*/ public static boolean Contains(ITextRange thisRange, ITextPointer textPointer)
        { 
        ...
        /// </param>
        /*internal*/ public static void Select(ITextRange thisRange, ITextPointer position1, ITextPointer position2)
        { 
        ...
        /// </param>
        /*internal*/ public static void Select(ITextRange thisRange, ITextPointer position1, ITextPointer position2, boolean includeCellAtMovingPosition) 
        { 
        ...
        /// </param>
        /*internal*/ public static void SelectWord(ITextRange thisRange, ITextPointer position)
        {
            if (position == null) 
            {
        ...
        /*internal*/ public static TextSegment GetAutoWord(ITextRange thisRange)
        { 
        ...
        /// </param> 
        /*internal*/ public static void SelectParagraph(ITextRange thisRange, ITextPointer position)
        {
            if (position == null)
            { 
                throw new ArgumentNullException("position");
        ...
        /*internal*/ public static void ApplyInitialTypingHeuristics(ITextRange thisRange) 
        {
        ...
        // called together, with a an extra step in between for TextSelection
        // overrides of the ApplyTypingHueristic method.
        /*internal*/ public static void ApplyFinalTypingHeuristics(ITextRange thisRange, boolean overType) 
        {
        ...
        /// </summary>
        /*internal*/ public static void ApplyTypingHeuristics(ITextRange thisRange, boolean overType)
        {
        ...
        /*internal*/ public static void FindParagraphOrListItemBoundaries(ITextPointer position, /*out*/ ITextPointer start, /*out*/ ITextPointer end) 
        {
        ...
        /*internal*/ public static Object GetPropertyValue(ITextRange thisRange, DependencyProperty formattingProperty)
        { 
        ...
        { 
            ...
            {
                if (pointer instanceof TextPointer) // Implement only for concrete TextCotainer returning null otherwise - for optimization 
                {
                    DependencyObject element = ((TextPointer)pointer).Parent as TextElement; 
                    while (value == null && (element instanceof Inline || element instanceof Paragraph || element instanceof TextBlock)) 
                    {
                        value = element.GetValue(formattingProperty); 

                        element = element instanceof TextElement ? ((TextElement)element).Parent : null;
                    }
                } 
            }
        ...
        /*internal*/ public static boolean IsParagraphBoundaryCrossed(ITextRange thisRange) 
        {
        ...
        /// </summary>
        /*internal*/ public static void BeginChange(ITextRange thisRange) 
        { 
        ...
        /// </summary> 
        /*internal*/ public static void BeginChangeNoUndo(ITextRange thisRange)
        { 
        ...
        /// </summary>
        /*internal*/ public static void EndChange(ITextRange thisRange) 
        {
            EndChange(thisRange, false /* disableScroll */, false /* skipEvents */ ); 
        } 

        /// <summary> 
        /// <see cref="ITextRange.EndChange(boolean,boolean)"/>
        /// </summary>
        /*internal*/ public static void EndChange(ITextRange thisRange, boolean disableScroll, boolean skipEvents)
        { 
        ...
        /// <summary> 
        /// <see cref="ITextRange.NotifyChanged(boolean,boolean)"/>
        /// </summary> 
        /*internal*/ public static void NotifyChanged(ITextRange thisRange, boolean disableScroll) 
        {
        ...
        /*internal*/ public static String GetTextInternal(ITextPointer startPosition, ITextPointer endPosition) 
        { 
        ...
        /*internal*/ public static String GetTextInternal(ITextPointer startPosition, ITextPointer endPosition, ref Char[] charArray) 
        {
        ...
        { 
            ...
            boolean theParagraphIsTheFirstInCollection = navigator.GetPointerContext(LogicalDirection.Backward) == TextPointerContext.ElementStart;
            navigator.MoveToNextContextPosition(LogicalDirection.Forward);
        ...
        private static char[] ConvertNumberToString(int number, boolean oneBased, String numericSymbols)
        { 
        ...
        /*internal*/ public static ITextPointer GetStart(ITextRange thisRange)
        { 
            NormalizeRange(thisRange);
        ...
        /*internal*/ public static ITextPointer GetEnd(ITextRange thisRange)
        {
            NormalizeRange(thisRange); 
        ...
        /*internal*/ public static boolean GetIsEmpty(ITextRange thisRange)
        {
            NormalizeRange(thisRange);
        ...
        /*internal*/ public static List<TextSegment> GetTextSegments(ITextRange thisRange) 
        {
        ...
        /*internal*/ public static String GetText(ITextRange thisRange)
        { 
            NormalizeRange(thisRange);
        ...
        /*internal*/ public static void SetText(ITextRange thisRange, String textData) 
        {
            NormalizeRange(thisRange); 
            ...
            try
            {
                ...
                { 
                    ...
                    boolean pastedFragmentEndsWithNewLine = textData.EndsWith("\n", StringComparison.Ordinal);
                    ...
                    boolean implicitParagraphInserted = insertPosition is TextPointer && 
                    ...
                    if ((newStart instanceof TextPointer) && ((TextPointer)newStart).Paragraph != null)
                    { 
        ...
        /*internal*/ public static String GetXml(ITextRange thisRange)
        { 
            NormalizeRange(thisRange); 
        ...
        /*internal*/ public static boolean CanSave(ITextRange thisRange, String dataFormat) 
        {
            NormalizeRange(thisRange);
        ...
        /*internal*/ public static boolean CanLoad(ITextRange thisRange, String dataFormat)
        { 
            NormalizeRange(thisRange); 
        ...
        /*internal*/ public static void Save(ITextRange thisRange, Stream stream, String dataFormat, boolean preserveTextElements)
        {
            if (stream == null)
            { 
        ...
        /*internal*/ public static void Load(TextRange thisRange, Stream stream, String dataFormat)
        {
            if (stream == null)
            { 
                throw new ArgumentNullException("stream");
        ...
        /*internal*/ public static int GetChangeBlockLevel(ITextRange thisRange) 
        {
        ...
        /*internal*/ public static UIElement GetUIElementSelected(ITextRange range) 
        { 
        ...
        /*internal*/ public static boolean GetIsTableCellRange(ITextRange thisRange)
        {
            NormalizeRange(thisRange); 
...
//        #region Private Methods
        ...
        private static void CreateNormalizedTextSegment(ITextRange thisRange, ITextPointer start, ITextPointer end)
        {
            ...
            { 
                ...
                { 
                    ...
                    if (start instanceof TextPointer)
                    { 
        ...
        private static boolean IsAtNormalizedPosition(ITextRange thisRange, ITextPointer position, LogicalDirection direction)
        { 
            boolean isAtNormalizedPosition; 
        ...
        /*internal*/ public static void NormalizeAnchoredBlockBoundaries(/*ref*/ TextPointer start, /*ref*/ TextPointer end) 
        { 
            ...
            while (outerAnchoredBlock != null)
            {
                ...
                if (outerAnchoredBlock != null) 
                {
                    ...
                    { 
                        if (innerElement instanceof AnchoredBlock) 
                        {
        ...
        private static void SelectPrivate(ITextRange thisRange, ITextPointer position1, ITextPointer position2, boolean includeCellAtMovingPosition, boolean markRangeChanged)
        { 
            ...
            if (position1 instanceof TextPointer) 
            {
