...
//        #endif 
        ...
        private /*const*/static final int PIPELINE_ATTRIBUTES = 0x00;
        private /*const*/static final int PIPELINE_PROPERTIES = 0x01; 
        private /*const*/static final int PIPELINE_EVENTS = 0x02;
        ...
        private static final Guid[] _pipelineInitializeKeys = new Guid[] 
        {
        ...
        private static final Guid[] _pipelineMergeKeys = new Guid[]
        { 
            Guid.NewGuid(), // attributes 
            Guid.NewGuid(), // properties
            Guid.NewGuid()  // events 
        ...
        private static final Guid[] _pipelineFilterKeys = new Guid[]
        { 
            Guid.NewGuid(), // attributes
            Guid.NewGuid(), // properties 
            Guid.NewGuid()  // events 
        ...
        private static final Guid[] _pipelineAttributeFilterKeys = new Guid[]
        {
            Guid.NewGuid(), // attributes
            Guid.NewGuid(), // properties 
            Guid.NewGuid()  // events
...
//        [EditorBrowsable(EditorBrowsableState.Advanced)]
        ...
        /// </devdoc>
        /*internal*/public static int MetadataVersion {
            get {
...
//        [ReflectionPermission(SecurityAction.LinkDemand, Flags=ReflectionPermissionFlag.MemberAccess)]
        ...
        /// </devdoc> 
//        #if DEBUG
//        private static boolean DebugShouldValidate(Object key) 
//        {
...
//        [EditorBrowsable(EditorBrowsableState.Advanced)] 
        ...
        internal static ICustomTypeDescriptor GetDescriptor(Object component, boolean noCustomTypeDesc)
        {
            ...
            if (component instanceof IUnimplemented) { 
...
//                Debug.Fail("COMPAT:  Returning an empty collection, but you should not pass null here"); 
            ...
            // type descriptor, we do extenders and the filter. 
            // 
            if (component instanceof ICustomTypeDescriptor)
            { 
...
//        [EditorBrowsable(EditorBrowsableState.Advanced)]
        ...
        ///     Instance-based node lists are rare.  If a node list is not 
        ///     available for a given instance, this will return the head node
        ///     for the instance's type.  This variation offers a boolean called 
        ...
        private static ICollection PipelineFilter(int pipelineType, ICollection members, Object instance, IDictionary cache) 
        {
            ...
            {
                list.Clear(); 
                for/*each*/(Object obj : filterTable.Values) 
                {
                    list.Add(obj); 
                }
            }
        ...
        { 
            ...
            for/*each*/(Object obj : primary) 
            { 
                list.Add(obj);
            } 
            for/*each*/(Object obj : secondary)
            {
                list.Add(obj);
            } 
...
//            #endif
            ...
            { 
                for/*each*/(Type t : refreshedTypes.Keys) {
                    RaiseRefresh(t);
                }
            } 
        }
...
//        [ResourceConsumption(ResourceScope.Machine | ResourceScope.Assembly, ResourceScope.Machine | ResourceScope.Assembly)]
        public static void Refresh(Assembly assembly) 
        {
            ...
            for/*each*/ (Module mod : assembly.GetModules())
            { 
                Refresh(mod);
            } 
...
//        [EditorBrowsable(EditorBrowsableState.Advanced)] 
        ...
        /// </devdoc> 
//        [Conditional("DEBUG")]
        /*internal*/public static void Trace(String message, params Object[] args)
        {
        ...
        /// </devdoc>
        private /*sealed*/ class AttributeProvider extends TypeDescriptionProvider
        { 
            Attribute[] _attrs;
            ...
            /// </devdoc> 
            /*internal*/public AttributeProvider(TypeDescriptionProvider existingProvider, params Attribute[] attrs) : base(existingProvider)
            {
                _attrs = attrs;
            } 
            ...
            /// </devdoc> 
            private class AttributeTypeDescriptor extends CustomTypeDescriptor
            { 
                ...
                /// </devdoc> 
                /*internal*/public AttributeTypeDescriptor(Attribute[] attrs, ICustomTypeDescriptor parent) : base(parent) 
                {
        ...
        ///     interface. 
        /// </devdoc>
        private /*sealed*/ class ComNativeDescriptionProvider extends TypeDescriptionProvider 
        {
//#pragma warning disable 618
            private IComNativeDescriptorHandler _handler;
 
            /*internal*/public ComNativeDescriptionProvider(IComNativeDescriptorHandler handler)
            { 
                _handler = handler; 
            }
            ...
            /// </devdoc>
            /*internal*/public IComNativeDescriptorHandler Handler 
            {
                get 
                { 
                    return _handler;
...
//            [SuppressMessage("Microsoft.Globalization", "CA1303:DoNotPassLiteralsAsLocali?zedParameters")] 
            public /*override*/ ICustomTypeDescriptor GetTypeDescriptor(Type objectType, Object instance)
            { 
                if (objectType == null) 
                {
            ...
            ///     descriptor handler. 
            /// </devdoc>
            private /*sealed*/ class ComNativeTypeDescriptor implements ICustomTypeDescriptor
            {
//#pragma warning disable 618 
                private IComNativeDescriptorHandler _handler;
...
//#pragma warning restore 618 
        ...
        private /*sealed*/ class AttributeFilterCacheItem 
        {
            ...
            /*internal*/public ICollection FilteredMembers; 

            /*internal*/public AttributeFilterCacheItem(Attribute[] filter, ICollection filteredMembers) 
            {
                _filter = filter;
                FilteredMembers = filteredMembers;
            } 

            /*internal*/public boolean IsValid(Attribute[] filter) 
            { 
        ...
        private /*sealed*/ class FilterCacheItem { 
            ...
            /*internal*/public FilterCacheItem(ITypeDescriptorFilterService filterService, ICollection filteredMembers) {
                _filterService = filterService;
                FilteredMembers = filteredMembers;
            } 

            /*internal*/public boolean IsValid(ITypeDescriptorFilterService filterService) { 
        ...
        /// </devdoc>
        private /*sealed*/ class MemberDescriptorComparer implements IComparer { 
            public static final MemberDescriptorComparer Instance = new MemberDescriptorComparer(); 
        ...
        ///     secondary. 
        /// </devdoc>
        private /*sealed*/ class MergedTypeDescriptor implements ICustomTypeDescriptor
        {
        ...
        /// </devdoc> 
        private /*sealed*/ class TypeDescriptionNode extends TypeDescriptionProvider
        { 
            /*internal*/public TypeDescriptionNode                Next;
            /*internal*/public TypeDescriptionProvider   Provider;

            /// <devdoc> 
            ///     Creates a new type description node.
            /// </devdoc> 
            /*internal*/public TypeDescriptionNode(TypeDescriptionProvider provider) 
            {
                Provider = provider; 
            }
...
//            [SuppressMessage("Microsoft.Globalization", "CA1303:DoNotPassLiteralsAsLocalizedParameters")]
            ...
            public /*override*/ boolean IsSupportedType(Type type) 
            { 
                if (type == null)
                { 
                    throw new ArgumentNullException("type");
            ...
            /// </devdoc> 
            private class DefaultExtendedTypeDescriptor implements ICustomTypeDescriptor
            {
                ...
                /// </devdoc>
                /*internal*/public DefaultExtendedTypeDescriptor(TypeDescriptionNode node, Object instance) 
                {
                    _node = node;
                    _instance = instance;
                } 
            ...
            /// </devdoc> 
            private class DefaultTypeDescriptor implements ICustomTypeDescriptor
            { 
                private TypeDescriptionNode _node; 
                ...
                /// </devdoc> 
                /*internal*/public DefaultTypeDescriptor(TypeDescriptionNode node, Type objectType, Object instance)
                { 
                    _node = node; 
