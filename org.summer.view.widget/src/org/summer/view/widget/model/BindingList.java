...
//[Serializable]
public class BindingList<T> extends Collection<T> implements IBindingList, ICancelAddNew, IRaiseItemChangedEvents 
{ 
...
//    #region AddingNew event
    ...
    public /*event*/ AddingNewEventHandler AddingNew { 
        add {
            boolean allowNewWasTrue = AllowNew;
            onAddingNew += value;
...
//    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA2113:SecureLateBindingMethods")]
    ...
    public boolean AllowNew { 
        ...
        set {
            boolean oldAllowNewValue = AllowNew;
    ...
    /* private */ boolean IBindingList.AllowNew { 
        get {
            return AllowNew; 
        } 
    }
    ...
    /* private */ boolean IBindingList.AllowEdit { 
        get {
            return AllowEdit; 
        }
    }
    ...
    /* private */public boolean /*IBindingList.*/AllowRemove {
        get {
            return AllowRemove;
        } 
    }

    public boolean /*IBindingList.*/SupportsChangeNotification { 
        get {
            return SupportsChangeNotificationCore; 
        }
    }

    protected /*virtual*/ boolean SupportsChangeNotificationCore { 
        get {
            return true; 
        } 
    }

    public boolean /*IBindingList.*/SupportsSearching {
        get {
            return SupportsSearchingCore;
        } 
    }

    protected /*virtual*/ boolean SupportsSearchingCore { 
        get {
            return false; 
        }
    }

    public boolean /*IBindingList.*/SupportsSorting { 
        get {
            return SupportsSortingCore; 
        } 
    }

    protected /*virtual*/ boolean SupportsSortingCore {
        get {
            return false;
        } 
    }

    public boolean /*IBindingList.*/IsSorted { 
        get {
            return IsSortedCore; 
        }
    }

    protected /*virtual*/ boolean IsSortedCore { 
        get {
            return false; 
        } 
    }

    public PropertyDescriptor /*IBindingList.*/SortProperty {
        get {
    ...
    public ListSortDirection /*IBindingList.*/SortDirection { 
        get {
    ...
    public void /*IBindingList.*/ApplySort(PropertyDescriptor prop, ListSortDirection direction) { 
    ...
    public void /*IBindingList.*/RemoveSort() { 
        RemoveSortCore(); 
    }
    ...
    public int /*IBindingList.*/Find(PropertyDescriptor prop, Object key) {
    ...
    public void /*IBindingList.*/AddIndex(PropertyDescriptor prop) { 
        // Not supported
    } 

    public void /*IBindingList.*/RemoveIndex(PropertyDescriptor prop) {
        // Not supported 
    }
...
//
    ...
    /// </devdoc>
   public boolean /*IRaiseItemChangedEvents.*/RaisesItemChangedEvents { 
        get {
