...
import org.summer.view.widget.utils.DTypeMap;

/*internal*/ public /*static*/ class GlobalEventManager
{
//    #region Operations

    // Registers a RoutedEvent with the given details
    // NOTE: The Name must be unique within the given OwnerType 
	/* internal */public static RoutedEvent RegisterRoutedEvent(String name,
			RoutingStrategy routingStrategy, Type handlerType, Type ownerType)
    {
...
//                            "RoutedEvent name must be unique within a given OwnerType");
    	...
    	/*lock*/synchronized (Synchronized) 
        {
			...
			RoutedEvent routedEvent = new RoutedEvent(name, routingStrategy,
	...
	/* internal */public static void RegisterClassHandler(Type classType,
			RoutedEvent routedEvent, Delegate handler, boolean handledEventsToo)
    { 
//        Debug.Assert(
...
//                            "Handler Type mismatch"); 
    ...
    /*internal*/ public static RoutedEvent[] GetRoutedEvents()
    { 
    ...
    /*internal*/ public static void AddOwner(RoutedEvent routedEvent, Type ownerType)
    { 
    ...
    /*internal*/ public static RoutedEvent[] GetRoutedEventsForOwner(Type ownerType) 
    {
        if ((ownerType == typeof(DependencyObject)) || ownerType.IsSubclassOf(typeof(DependencyObject))) 
        { 
            // Search DTypeMap
    ...
    // If not found returns null 
    /*internal*/ public static RoutedEvent GetRoutedEventFromName(
        String name, 
        Type ownerType,
    ...
    /*internal*/ public static RoutedEventHandlerInfoList GetDTypedClassListeners(
...
//    #region Global Index for RoutedEvent and EventPrivateKey 
    ...
    /*internal*/ public static int GetNextAvailableGlobalIndex(Object value)
    {
        int index; 
        /*lock*/synchronized (Synchronized)
        { 
    ...
    /*internal*/ public static Object EventFromGlobalIndex(int globalIndex) 
    {
