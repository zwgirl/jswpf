...
import org.summer.view.widget.utils.InsertionSortMap;
/// <summary>
...
//        } 
    ...
    /*internal*/ public void ValidateFactoryDefaultValue(Object defaultValue)
    { 
...
//    [FriendAccessAllowed]   // Built into Base, also used by Core & Framework. 
    /*internal*/ public Object GetDefaultValue(DependencyObjectType dependencyObjectType)
    {
...
//    [FriendAccessAllowed]   // Built into Base, also used by Core & Framework.
    /*internal*/ public Object GetDefaultValue(Type forType)
    { 
        if (!IsDefaultValueChanged)
        { 
            return DefaultMetadata.DefaultValue; 
    ...
    /*internal*/ public boolean IsObjectType 
    {
        get { return (_packedData & Flags.IsObjectType) != 0; }
    }

    /*internal*/ public boolean IsValueType
    { 
        get { return (_packedData & Flags.IsValueType) != 0; } 
    }

    /*internal*/ public boolean IsFreezableType
    {
        get { return (_packedData & Flags.IsFreezableType) != 0; }
    } 

    /*internal*/ public boolean IsStringType 
    { 
        get { return (_packedData & Flags.IsStringType) != 0; }
    } 

    /*internal*/ public boolean IsPotentiallyInherited
    {
        get { return (_packedData & Flags.IsPotentiallyInherited) != 0; } 
    }

    /*internal*/ public boolean IsDefaultValueChanged 
    {
        get { return (_packedData & Flags.IsDefaultValueChanged) != 0; } 
    }

    /*internal*/ public boolean IsPotentiallyUsingDefaultValueFactory
    { 
    ...
    /// </summary>
    /*internal*/ public DependencyPropertyKey DependencyPropertyKey
    {
        get 
        {
            return _readOnlyKey; 
    ...
    /*internal*/ public void VerifyReadOnlyKey( DependencyPropertyKey candidateKey )
    {
//        Debug.Assert( ReadOnly, "Why are we trying to validate read-only key on a property that is not read-only?");
    ...
    /// <param name="value">Value to check</param> 
    /// <returns>true if value is appropriate</returns> 
    /*internal*/ public boolean IsValidValueInternal(Object value)
    { 
        if (ValidateValueCallback != null)
        {
            // CALLBACK
...
//    [FriendAccessAllowed]   // Built into Base, also used by Framework.
    /*internal*/ public static DependencyProperty FromName(String name, Type ownerType)
    {
    ...
    /*internal*/ public static boolean IsValidType(Object value, Type propertyType)
    { 
        if (value == null) 
        {
    ...
    private class FromNameKey
    {
        ...
        public boolean Equals(FromNameKey key)
        { 
    ...
    /*internal*/ public static int GetUniqueGlobalIndex(Type ownerType, String name) 
    { 
    ...
    /// </summary> 
    /*internal*/ public CoerceValueCallback DesignerCoerceValueCallback 
    {
    ...
    public static final Object UnsetValue = new NamedObject("DependencyProperty.UnsetValue"); 
...
//    [Flags]
    ...
    /* property */ /*internal*/ public InsertionSortMap _metadataMap = new InsertionSortMap();
    ...
    /* property */ /*internal*/ public static ItemStructList<DependencyProperty> RegisteredPropertyList = new ItemStructList<DependencyProperty>(768);
    ...
    /// </summary>
    /*internal*/ public static int RegisteredPropertyCount { 
        get {
    ...
    ///     Synchronized (write locks, lock-free reads): Covered by DependencyProperty.Synchronized 
    /// </summary>
    /*internal*/ public static IEnumerable RegisteredProperties {
        get {
            for/*each*/(DependencyProperty dp : RegisteredPropertyList.List) { 
                if (dp != null) {
                    /*yield*/ return dp; 
                } 
            }
