...
/// <summary>
    ...
    /// </remarks>
   public class IndexedEnumerable implements IEnumerable, IWeakEventListener
    {
        ...
        /// </summary>
         IndexedEnumerable(IEnumerable collection, Predicate<Object> filterCallback)
        {
...
//#pragma warning restore 1634
        ...
        ///</summary>
         static void CopyTo(IEnumerable collection, Array array, int index)
        {
...
//            Invariant.Assert(index >= 0, "index must be positive");
        ...
        private boolean EnsureCacheCurrent()
        {
            ...
            boolean isCacheCurrent = (version == _cachedVersion) && (_cachedIndex >= 0);
...
//#endif // DEBUG
        ...
        private boolean GetNativeCount(/*out*/ int value)
        {
        ...
        private boolean GetNativeIsEmpty(/*out*/ boolean isEmpty)
        {
            boolean isNativeValue = false;
            isEmpty = true;
            if (Collection != null)
        ...
        private boolean GetNativeIndexOf(Object item, /*out*/ int value)
        {
            boolean isNativeValue = false;
            value = -1;
        ...
        private boolean GetNativeItemAt(int index, /*out*/ Object value)
        {
            boolean isNativeValue = false;
            value = null;
            if (List != null)
...
//        }
        ...
        private boolean/*?*/   _cachedIsEmpty;
        ...
        //
        //------------------------------------------------------
        private class FilteredEnumerator implements IEnumerator
        {
