...
//#endif
{ 
    public /*const*/static final long    TicksPerMillisecond =  10000;
    private /*const*/static final double MillisecondsPerTick = 1.0 / TicksPerMillisecond;

    public /*const*/static final long TicksPerSecond = TicksPerMillisecond * 1000;   // 10,000,000 
    private /*const*/static final double SecondsPerTick =  1.0 / TicksPerSecond;         // 0.0001

    public /*const*/static final long TicksPerMinute = TicksPerSecond * 60;         // 600,000,000 
    private /*const*/static final double MinutesPerTick = 1.0 / TicksPerMinute; // 1.6666666666667e-9

    public /*const*/static final long TicksPerHour = TicksPerMinute * 60;        // 36,000,000,000
    private /*const*/static final double HoursPerTick = 1.0 / TicksPerHour; // 2.77777777777777778e-11

    public /*const*/static final long TicksPerDay = TicksPerHour * 24;          // 864,000,000,000 
    private /*const*/static final double DaysPerTick = 1.0 / TicksPerDay; // 1.1574074074074074074e-12

    private /*const*/static final int MillisPerSecond = 1000; 
    private /*const*/static final int MillisPerMinute = MillisPerSecond * 60; //     60,000
    private /*const*/static final int MillisPerHour = MillisPerMinute * 60;   //  3,600,000 
    private /*const*/static final int MillisPerDay = MillisPerHour * 24;      // 86,400,000

    /*const*/static final long MaxSeconds = Int64.MaxValue / TicksPerSecond;
    /*internal*/ public /*const*/static final long MinSeconds = Int64.MinValue / TicksPerSecond; 

    /*internal*/ public /*const*/static final long MaxMilliSeconds = Int64.MaxValue / TicksPerMillisecond; 
    /*internal*/ public /*const*/static final long MinMilliSeconds = Int64.MinValue / TicksPerMillisecond; 

    /*internal*/ public /*const*/static final long TicksPerTenthSecond = TicksPerMillisecond * 100; 

    public static final TimeSpan Zero = new TimeSpan(0);

    public static final TimeSpan MaxValue = new TimeSpan(Int64.MaxValue); 
    public static final TimeSpan MinValue = new TimeSpan(Int64.MinValue);

    // /*internal*/ public so that DateTime doesn't have to call an extra get 
    // method for some arithmetic operations.
    /*internal*/ public long _ticks; 
...
//#endif
    ...
    /*internal*/ public static long TimeToTicks(int hour, int minute, int second) {
...
//    [TargetedPatchingOptOut("Performance critical to inline across NGen image boundaries")]
//#endif
    public static boolean operator ==(TimeSpan t1, TimeSpan t2) {
        return t1._ticks == t2._ticks; 
    }
...
//    private static extern boolean LegacyFormatMode(); 
...
//#endif
    private static boolean GetLegacyFormatMode() { 
//#if !FEATURE_CORECLR 
