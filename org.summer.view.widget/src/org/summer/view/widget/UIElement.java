...
import static org.summer.view.widget.media.Visual.PropagateFlags;
...
import org.summer.view.runtime.HandleRef;
...
import org.summer.view.widget.input.CommandDevice;
import org.summer.view.widget.input.CommandDeviceEventArgs;
...
import org.summer.view.widget.input.KeyboardFocusChangedEventArgs;
import org.summer.view.widget.input.ManipulationStartingEventArgs;
...
import org.summer.view.widget.media.RenderOptions;
...
import org.summer.view.widget.media.VisualFlags;
import org.summer.view.widget.media.VisualProxyFlags;
import org.summer.view.widget.media.VisualTreeHelper;
import org.summer.view.widget.media.animation.AnimationClock;
import org.summer.view.widget.media.animation.AnimationStorage;
...
import org.summer.view.window.IContentHost;
import org.summer.view.window.LayoutEventList;
...
//[UidProperty("Uid")] 
public /*partial*/ class UIElement extends Visual implements IInputElement, IAnimatable
{ 
    /// <SecurityNote> 
...
//    #region Events
    ...
    /// </returns>
    /*internal*/ /*virtual*/public boolean BuildRouteCore(EventRoute route, RoutedEventArgs args)
    { 
        return false;
    } 
...
//    [MS.Internal.Permissions.UserInitiatedRoutedEventPermissionAttribute(SecurityAction.Assert)]
    ...
    ///     Returns new source 
    /// </returns>
    /*internal*/ /*virtual*/public Object AdjustEventSource(RoutedEventArgs args) 
    {
        return null;
    }
    ...
    ///     on the last removal. 
    /// </summary>
    /*internal*/ /*virtual*/public void OnAddHandler(
        RoutedEvent routedEvent,
        Delegate handler) 
    {
    } 
    ...
    /// </summary>
    /*internal*/ /*virtual*/public void AddToEventRouteCore(EventRoute route, RoutedEventArgs args) 
    {
    }
...
//    #endregion Events
    ...
    /*internal*/ /*virtual*/public boolean InvalidateAutomationAncestorsCore(Stack<DependencyObject> branchNodeStack, /*out*/ boolean continuePastVisualTree)
    { 
...
//        Invariant.Assert(!e.Handled, "Unexpected: Event has already been handled.");
    ...
    /// </summary>
    public static final RoutedEvent PreviewMouseLeftButtonDownEvent = EventManager.RegisterRoutedEvent("PreviewMouseLeftButtonDown", RoutingStrategy.Direct, typeof(MouseButtonEventHandler), _typeofThis);
    ...
    ///     Declaration of the routed event reporting the left mouse button was pressed
    /// </summary>
    public static final RoutedEvent MouseLeftButtonDownEvent = EventManager.RegisterRoutedEvent("MouseLeftButtonDown", RoutingStrategy.Direct, typeof(MouseButtonEventHandler), _typeofThis);
    ...
    /// </summary>
    public static final RoutedEvent PreviewMouseLeftButtonUpEvent = EventManager.RegisterRoutedEvent("PreviewMouseLeftButtonUp", RoutingStrategy.Direct, typeof(MouseButtonEventHandler), _typeofThis); 
    ...
    ///     Declaration of the routed event reporting the left mouse button was released
    /// </summary> 
    public static final RoutedEvent MouseLeftButtonUpEvent = EventManager.RegisterRoutedEvent("MouseLeftButtonUp", RoutingStrategy.Direct, typeof(MouseButtonEventHandler), _typeofThis);
    ...
    /// </summary>
    public static final RoutedEvent PreviewMouseRightButtonDownEvent = EventManager.RegisterRoutedEvent("PreviewMouseRightButtonDown", RoutingStrategy.Direct, typeof(MouseButtonEventHandler), _typeofThis); 
    ...
    ///     Declaration of the routed event reporting the right mouse button was pressed
    /// </summary> 
    public static final RoutedEvent MouseRightButtonDownEvent = EventManager.RegisterRoutedEvent("MouseRightButtonDown", RoutingStrategy.Direct, typeof(MouseButtonEventHandler), _typeofThis); 
    ...
    /// </summary> 
    public static final RoutedEvent PreviewMouseRightButtonUpEvent = EventManager.RegisterRoutedEvent("PreviewMouseRightButtonUp", RoutingStrategy.Direct, typeof(MouseButtonEventHandler), _typeofThis);
    ...
    ///     Declaration of the routed event reporting the right mouse button was released 
    /// </summary>
    public static final RoutedEvent MouseRightButtonUpEvent = EventManager.RegisterRoutedEvent("MouseRightButtonUp", RoutingStrategy.Direct, typeof(MouseButtonEventHandler), _typeofThis); 
...
//    [CustomCategory(SRID.Touch_Category)]
    ...
    /// </summary>
    /*internal*/ static final DependencyPropertyKey IsMouseDirectlyOverPropertyKey =
    ...
    /// </summary> 
    public static final DependencyProperty IsMouseDirectlyOverProperty =
    ...
    /// </summary> 
    /*internal*/ static final EventPrivateKey IsMouseDirectlyOverChangedKey = new EventPrivateKey(); 
    ...
    ///     The key needed set a read-only property. 
    /// </summary>
    /*internal*/ public static final DependencyPropertyKey IsMouseOverPropertyKey =
                DependencyProperty.RegisterReadOnly(
                            "IsMouseOver", 
                            typeof(Boolean),
                            _typeofThis, 
    ...
    /// </summary>
    public static final DependencyProperty IsMouseOverProperty = 
        IsMouseOverPropertyKey.DependencyProperty;

    /// <summary> 
    ///     The key needed set a read-only property.
    /// </summary> 
    /*internal*/ static final DependencyPropertyKey IsStylusOverPropertyKey =
                DependencyProperty.RegisterReadOnly(
                            "IsStylusOver",
                            typeof(boolean), 
                            _typeofThis,
    ...
    /// </summary>
    public static final DependencyProperty IsStylusOverProperty =
        IsStylusOverPropertyKey.DependencyProperty; 

    /// <summary> 
    ///     The key needed set a read-only property. 
    /// </summary>
    /*internal*/ static final DependencyPropertyKey IsKeyboardFocusWithinPropertyKey = 
                DependencyProperty.RegisterReadOnly(
    ...
    /// </summary>
    public static final DependencyProperty IsKeyboardFocusWithinProperty =
        IsKeyboardFocusWithinPropertyKey.DependencyProperty;

    /// <summary>
    ///     IsKeyboardFocusWithinChanged private key 
    /// </summary> 
    /*internal*/ static final EventPrivateKey IsKeyboardFocusWithinChangedKey = new EventPrivateKey();
    ...
    ///     The key needed set a read-only property.
    /// </summary>
    /*internal*/ static final DependencyPropertyKey IsMouseCapturedPropertyKey =
                DependencyProperty.RegisterReadOnly( 
                            "IsMouseCaptured",
                            typeof(boolean), 
                            _typeofThis, 
    ...
    /// </summary>
    public static final DependencyProperty IsMouseCapturedProperty = 
    ...
    /// </summary> 
    /*internal*/ static final EventPrivateKey IsMouseCapturedChangedKey = new EventPrivateKey();
    ...
    ///     The key needed set a read-only property.
    /// </summary>
    /*internal*/ static final DependencyPropertyKey IsMouseCaptureWithinPropertyKey =
                DependencyProperty.RegisterReadOnly( 
    ...
    /// </summary> 
    public static final DependencyProperty IsMouseCaptureWithinProperty =
        IsMouseCaptureWithinPropertyKey.DependencyProperty; 

    /// <summary>
    ///     IsMouseCaptureWithinChanged private key 
    /// </summary>
    /*internal*/ static final EventPrivateKey IsMouseCaptureWithinChangedKey = new EventPrivateKey();
    ...
    ///     The key needed set a read-only property. 
    /// </summary>
    /*internal*/ static final DependencyPropertyKey IsStylusDirectlyOverPropertyKey = 
                DependencyProperty.RegisterReadOnly( 
    ...
    /// </summary>
    public static final DependencyProperty IsStylusDirectlyOverProperty = 
    ...
    /// </summary>
    /*internal*/ static final EventPrivateKey IsStylusDirectlyOverChangedKey = new EventPrivateKey();
    ...
    ///     The key needed set a read-only property. 
    /// </summary>
    /*internal*/ static final DependencyPropertyKey IsStylusCapturedPropertyKey = 
                DependencyProperty.RegisterReadOnly( 
                            "IsStylusCaptured",
                            typeof(boolean), 
                            _typeofThis,
    ...
    /// </summary>
    public static final DependencyProperty IsStylusCapturedProperty = 
    ...
    /// </summary>
    /*internal*/ static final EventPrivateKey IsStylusCapturedChangedKey = new EventPrivateKey();
    ...
    ///     The key needed set a read-only property. 
    /// </summary>
    /*internal*/ static final DependencyPropertyKey IsStylusCaptureWithinPropertyKey = 
                DependencyProperty.RegisterReadOnly( 
    ...
    /// </summary> 
    public static final DependencyProperty IsStylusCaptureWithinProperty =
        IsStylusCaptureWithinPropertyKey.DependencyProperty; 

    /// <summary>
    ///     IsStylusCaptureWithinChanged private key
    /// </summary> 
    /*internal*/ static final EventPrivateKey IsStylusCaptureWithinChangedKey = new EventPrivateKey();
    ...
    ///     The key needed set a read-only property. 
    /// </summary>
    /*internal*/ public static final DependencyPropertyKey IsKeyboardFocusedPropertyKey = 
                DependencyProperty.RegisterReadOnly(
                            "IsKeyboardFocused",
                            typeof(Boolean),
                            _typeofThis, 
    ...
    /// </summary>
    public static final DependencyProperty IsKeyboardFocusedProperty =
    ...
    /// </summary> 
    /*internal*/ static final EventPrivateKey IsKeyboardFocusedChangedKey = new EventPrivateKey();
    ...
    ///     The key needed set a read-only property. 
    /// </summary>
    /*internal*/ static final DependencyPropertyKey AreAnyTouchesDirectlyOverPropertyKey = 
                DependencyProperty.RegisterReadOnly(
    ...
    /// </summary>
    public static final DependencyProperty AreAnyTouchesDirectlyOverProperty =
        AreAnyTouchesDirectlyOverPropertyKey.DependencyProperty;

    /// <summary>
    ///     The key needed set a read-only property. 
    /// </summary> 
    /*internal*/ static final DependencyPropertyKey AreAnyTouchesOverPropertyKey =
                DependencyProperty.RegisterReadOnly( 
                            "AreAnyTouchesOver",
                            typeof(boolean),
                            _typeofThis,
    ...
    /// </summary> 
    public static final DependencyProperty AreAnyTouchesOverProperty =
        AreAnyTouchesOverPropertyKey.DependencyProperty;

    /// <summary> 
    ///     The key needed set a read-only property.
    /// </summary> 
    /*internal*/ static final DependencyPropertyKey AreAnyTouchesCapturedPropertyKey = 
                DependencyProperty.RegisterReadOnly(
    ...
    /// </summary>
    public static final DependencyProperty AreAnyTouchesCapturedProperty = 
        AreAnyTouchesCapturedPropertyKey.DependencyProperty;

    /// <summary>
    ///     The key needed set a read-only property. 
    /// </summary>
    /*internal*/ static final DependencyPropertyKey AreAnyTouchesCapturedWithinPropertyKey = 
                DependencyProperty.RegisterReadOnly( 
    ...
    /// </summary> 
    public static final DependencyProperty AreAnyTouchesCapturedWithinProperty =
        AreAnyTouchesCapturedWithinPropertyKey.DependencyProperty; 

    /*internal*/ boolean ReadFlag(CoreFlags field)
    {
        return (_flags & field) != 0; 
    }

    /*internal*/ void WriteFlag(CoreFlags field,boolean value) 
    {
        if (value) 
        {
             _flags |= field;
...
//}  partial  
    ...
    { 
        ...
        SnapsToDevicePixelsCache = (boolean) SnapsToDevicePixelsProperty.GetDefaultValue(DependencyObjectType); 
        ClipToBoundsCache        = (boolean) ClipToBoundsProperty.GetDefaultValue(DependencyObjectType);
...
//    #endregion AllowDrop
    ...
    /*internal*/ public void InvalidateMeasureInternal() 
    { 
        MeasureDirty = true;
    } 
...
//             VerifyAccess(); 
    ...
    /// if necessary. 
    /// </summary>
    /*internal*/ public static void PropagateResumeLayout(Visual parent, Visual v)
    {
        if(v.CheckFlagsAnd(VisualFlags.IsLayoutIslandRoot)) return; 
        ...
        boolean parentIsSuspended = parent == null ? false : parent.CheckFlagsAnd(VisualFlags.IsLayoutSuspended);
        ...
        if (v.CheckFlagsAnd(VisualFlags.IsUIElement))
        {
            ...
            boolean requireMeasureUpdate = e.MeasureDirty && !e.NeverMeasured && (e.MeasureRequest == null); 
            boolean requireArrangeUpdate = e.ArrangeDirty && !e.NeverArranged && (e.ArrangeRequest == null);
    ...
    public void Measure(Size availableSize) 
    {
        ...
        { 
            ...
            { 
                ...
                boolean neverMeasured = NeverMeasured;
                ...
                boolean isCloseToPreviousMeasure = DoubleUtil.AreClose(availableSize, _previousAvailableSize);
    ...
    /*internal*/public void GetUIParentOrICH(/*out*/ UIElement uiParent, /*out*/ IContentHost ich) 
    {
        ich = null; 
        uiParent = null;
...
//        }
        ...
        try 
        {
            ...
            { 
                ...
                { 
                    boolean firstArrange = NeverArranged;
                    NeverArranged = false;
                    ...
                    { 
                        ...
                        try 
                        { 
                            boolean etwGeneralEnabled = EventTrace.IsEnabled(EventTrace.Keyword.KeywordGraphics | EventTrace.Keyword.KeywordPerf, EventTrace.Level.Verbose);
    ...
    private boolean markForSizeChangedIfNeeded(Size oldSize, Size newSize) 
    {
        //already marked for SizeChanged, simply update the newSize 
        boolean widthChanged = !DoubleUtil.AreClose(oldSize.Width, newSize.Width);
        boolean heightChanged = !DoubleUtil.AreClose(oldSize.Height, newSize.Height);
...
//#pragma warning restore 6523
    ...
    protected /*virtual*/ void ArrangeCore(Rect finalRect)
    {
        ...
        if (renderTransform != null)
        {
            ...
            boolean hasOrigin = (origin.X != 0d || origin.Y != 0d);
            if (hasOrigin) 
...
//    [CommonDependencyProperty] 
    public static final DependencyProperty RenderTransformProperty =
                DependencyProperty.Register(
                            "RenderTransform",
                            typeof(Transform), 
                            typeof(UIElement),
    ...
    public static final DependencyProperty RenderTransformOriginProperty =
                DependencyProperty.Register( 
    ...
    private static boolean IsRenderTransformOriginValid(Object value)
    {
        Point v = (Point)value;
    ...
    /*internal*/ DependencyObject GetUIParent(boolean continuePastVisualTree) 
    {
    ...
    /// </returns> 
    public /*virtual*/ /*internal*/ DependencyObject GetUIParentCore()
    {
        return null;
    } 
...
//         VerifyAccess();
    ...
    /*internal*/public static void BuildRouteHelper(DependencyObject e, EventRoute route, RoutedEventArgs args)
    { 
        if (route == null) {
            throw new IllegalArgumentException("route"); 
        }
        ...
        if (args.Source == null){ 
            throw new IllegalArgumentException(/*SR.Get(SRID.SourceNotSet)*/);
        }

        if (args.RoutedEvent != route.RoutedEvent) {
            throw new IllegalArgumentException(/*SR.Get(SRID.Mismatched_RoutedEvent)*/); 
        } 
    ...
    /*internal*/ boolean StartListeningSynchronizedInput(SynchronizedInputType inputType)
    {
        if(InputManager.IsSynchronizedInput) 
        {
            return false; 
    ...
    /// </summary>
//    [FriendAccessAllowed] // Built into Core, also used by Framework. 
    /*internal*/ public static void AddHandler(DependencyObject d, RoutedEvent routedEvent, Delegate handler) 
    {
        if (d == null) 
        {
...
//        Debug.Assert(routedEvent != null, "RoutedEvent must not be null");
    ...
    /// </summary> 
//    [FriendAccessAllowed] // Built into Core, also used by Framework.
    /*internal*/ public static void RemoveHandler(DependencyObject d, RoutedEvent routedEvent, Delegate handler)
    {
        if (d == null) 
        {
            throw new ArgumentNullException("d"); 
...
//    #region LoadedAndUnloadedEvents
    ...
    /// </summary> 
    /*internal*/ /*virtual*/ void OnPresentationSourceChanged(boolean attached) 
    {
    ...
    /*internal*/ void InputHitTest(Point pt, /*out*/ IInputElement enabledHit, /*out*/ IInputElement rawHit, /*out*/ HitTestResult rawHitResult)
    {
        ...
        while (candidate != null)
        {
            ...
            if (contentHost != null) 
            {
                ...
                if ((boolean)containingElement.GetValue(IsEnabledProperty))
                {
...
//    [FriendAccessAllowed]
    ...
    /// </summary>
    /*internal*/ /*virtual*/ boolean BlockReverseInheritance()
    {
        return false; 
    }
...
//    [Localizability(LocalizationCategory.None, Readability = Readability.Unreadable)]
    ...
    /// </summary> 
    public static final DependencyProperty OpacityMaskProperty
    ...
    /// </summary> 
    public static final DependencyProperty BitmapEffectProperty = 
            DependencyProperty.Register(
                    "BitmapEffect", 
                    typeof(BitmapEffect),
                    typeof(UIElement),
...
//#pragma warning restore 0618 
    ...
    ///     The Effect property.
    /// </summary> 
    public static final DependencyProperty EffectProperty =
            DependencyProperty.Register( 
                    "Effect", 
                    typeof(Effect),
                    typeof(UIElement), 
    ...
    /// </summary> 
    public static final DependencyProperty BitmapEffectInputProperty =
            DependencyProperty.Register( 
                    "BitmapEffectInput",
...
//    [Obsolete(MS.Internal.Media.VisualTreeUtils.BitmapEffectObsoleteMessage)]
    ...
    {
//#pragma warning disable 0618 
    	super.VisualBitmapEffectInput = newValue; 
//#pragma warning restore 0618
    } 
    ...
    { 
        super.VisualEdgeMode = RenderOptions.GetEdgeMode(this);
    }
    ...
    {
    	super.VisualBitmapScalingMode = RenderOptions.GetBitmapScalingMode(this);
    } 
    ...
    { 
    	super.VisualClearTypeHint = RenderOptions.GetClearTypeHint(this);
    } 
    ...
    { 
    	super.VisualTextHintingMode = TextOptionsInternal.GetTextHintingMode(this); 
    }

    /// <summary>
    ///     The CacheMode property.
    /// </summary>
    public static final DependencyProperty CacheModeProperty = 
            DependencyProperty.Register(
                    "CacheMode", 
                    typeof(CacheMode), 
                    typeof(UIElement),
    ...
    {
    	super.VisualCacheMode = CacheMode;
    }
...
//    #region Uid
    ...
    /// </summary> 
    static public final DependencyProperty UidProperty = 
                DependencyProperty.Register(
                            "Uid", 
                            typeof(String),
                            typeof(UIElement),
...
//    #endregion Uid
    ...
    /// </summary> 
//    [CommonDependencyProperty]
    public static final DependencyProperty VisibilityProperty =
            DependencyProperty.Register(
                    "Visibility", 
                    typeof(Visibility),
                    typeof(UIElement), 
    ...
    private static boolean ValidateVisibility(Object o) 
    { 
...
//    [Localizability(LocalizationCategory.None, Readability = Readability.Unreadable)] 
    ...
    private void ensureInvisible(boolean collapsed)
    {
        if(!ReadFlag(CoreFlags.IsOpacitySuppressed)) 
        {
        	super.VisualOpacity = 0; 
...
//        Debug.Assert(_proxy.IsOnChannel(channel)); 
    ...
    /// </summary>
    /*internal*/ /*override*/ void RenderContent(RenderContext ctx, boolean isOnChannel)
    { 
    ...
    /// </summary> 
//    [CommonDependencyProperty]
    public static final DependencyProperty ClipToBoundsProperty = 
                DependencyProperty.Register(
                            "ClipToBounds",
                            typeof(Boolean),
                            typeof(UIElement), 
    ...
    {
        UIElement uie = (UIElement) d;
        uie.ClipToBoundsCache = (boolean) e.NewValue;
    ...
    /// Clip Property
    /// </summary> 
    public static final DependencyProperty ClipProperty =
                DependencyProperty.Register( 
                            "Clip", 
                            typeof(Geometry),
                            typeof(UIElement), 
    ...
    /// Align Property
    /// </summary> 
    public static final DependencyProperty SnapsToDevicePixelsProperty =
            DependencyProperty.Register(
                    "SnapsToDevicePixels",
                    typeof(boolean), 
                    typeof(UIElement),
    ...
    {
        UIElement uie = (UIElement) d;
        uie.SnapsToDevicePixelsCache = (boolean) e.NewValue; 
    ...
    /// </summary> 
    public boolean SnapsToDevicePixels 
    {
    ...
    /// </summary>
    protected /*internal*/ /*virtual*/ boolean HasEffectiveKeyboardFocus
    {
        get 
        {
    ...
    /*internal*/public void InvokeAccessKey(AccessKeyEventArgs e)
    {
        OnAccessKey(e); 
    }
    ...
    ///     GotFocus event
    /// </summary> 
    public static final RoutedEvent GotFocusEvent = FocusManager.GotFocusEvent.AddOwner(typeof(UIElement));
    ...
    ///     LostFocus event 
    /// </summary>
    public static final RoutedEvent LostFocusEvent = FocusManager.LostFocusEvent.AddOwner(typeof(UIElement)); 
    ...
    /// </summary>
    /*internal*/public static final DependencyPropertyKey IsFocusedPropertyKey =
                DependencyProperty.RegisterReadOnly(
                            "IsFocused", 
                            typeof(boolean),
                            typeof(UIElement), 
...
//    [CommonDependencyProperty]
    ...
    /*internal*/ static final EventPrivateKey IsEnabledChangedKey = new EventPrivateKey(); // Used by ContentElement
...
//    #region IsHitTestVisible Property
    ...
    /// </summary> 
    public static final DependencyProperty IsHitTestVisibleProperty =
                DependencyProperty.Register( 
                            "IsHitTestVisible", 
                            typeof(boolean),
                            typeof(UIElement), 
    ...
    {
        get { return (boolean) GetValue(IsHitTestVisibleProperty); }
    ...
    /*internal*/ static final EventPrivateKey IsHitTestVisibleChangedKey = new EventPrivateKey(); // Used by ContentElement
...
//    #region IsVisible Property 
    ...
    /*internal*/ static final DependencyPropertyKey IsVisiblePropertyKey = 
                DependencyProperty.RegisterReadOnly( 
                            "IsVisible",
                            typeof(boolean), 
                            typeof(UIElement),
    ...
    /// </summary> 
    public static final DependencyProperty IsVisibleProperty = IsVisiblePropertyKey.DependencyProperty; 
    ...
    /*internal*/ static final EventPrivateKey IsVisibleChangedKey = new EventPrivateKey(); // Used by ContentElement
    ...
    /// </SecurityNote>
//    [SecurityCritical, SecurityTreatAsSafe] 
    /*internal*/public void UpdateIsVisibleCache() // Called from PresentationSource
    {
        // IsVisible is a read-only property.  It derives its "base" value
        // from the Visibility property. 
        boolean isVisible = (Visibility == Visibility.Visible);
        ...
        if(isVisible)
        { 
            boolean constraintAllowsVisible = false;
...
//    [CommonDependencyProperty] 
    ...
    /*internal*/ static final EventPrivateKey FocusableChangedKey = new EventPrivateKey(); // Used by ContentElement 
...
//    [FriendAccessAllowed] // Built into Core, also used by Framework.
    ...
    /*internal*/public Rect PreviousArrangeRect 
    {
...
//    #region ForceInherit property support
        ...
        DependencyObject parent) 
    {
        ...
        {
            boolean parentValue = (boolean) parent.GetValue(IsEnabledProperty); 
            if(!parentValue)
            { 
            ...
            parentValue = (boolean) parent.GetValue(IsHitTestVisibleProperty);
            if(!parentValue)
            { 
                // For Read/Write force-inherited properties, use the standard coersion pattern.
                // 
            ...
            parentValue = (boolean) parent.GetValue(IsVisibleProperty); 
            if(parentValue)
            {
    ...
    /*internal*/public static void InvalidateForceInheritPropertyOnChildren(Visual v, DependencyProperty property)
    {
...
//    #region Manipulation 
    ...
    /// </summary>
    public static final DependencyProperty IsManipulationEnabledProperty =
        DependencyProperty.Register(
...
//    [CustomCategory(SRID.Touch_Category)]
    public boolean IsManipulationEnabled 
    {
        get
        {
            return (boolean)GetValue(IsManipulationEnabledProperty); 
        }
        set 
        { 
    ...
    private static boolean IsDefaultValue(DependencyObject dependencyObject, DependencyProperty dependencyProperty)
    {
    ...
    /// </summary>
    public static final RoutedEvent ManipulationStartingEvent = Manipulation.ManipulationStartingEvent.AddOwner(typeof(UIElement));
...
//    [CustomCategory(SRID.Touch_Category)]
    ...
    ///     Indicates that a manipulation has started.
    /// </summary> 
    public static final RoutedEvent ManipulationStartedEvent = Manipulation.ManipulationStartedEvent.AddOwner(typeof(UIElement));
...
//    [CustomCategory(SRID.Touch_Category)] 
    ...
    /// </summary> 
    public static final RoutedEvent ManipulationDeltaEvent = Manipulation.ManipulationDeltaEvent.AddOwner(typeof(UIElement));
...
//    [CustomCategory(SRID.Touch_Category)] 
    ...
    /// </summary>
    public static final RoutedEvent ManipulationInertiaStartingEvent = Manipulation.ManipulationInertiaStartingEvent.AddOwner(typeof(UIElement)); 
...
//    [CustomCategory(SRID.Touch_Category)]
    ...
    /// </summary>
    public static final RoutedEvent ManipulationBoundaryFeedbackEvent = Manipulation.ManipulationBoundaryFeedbackEvent.AddOwner(typeof(UIElement)); 
...
//    [CustomCategory(SRID.Touch_Category)] 
    ...
    /// </summary>
    public static final RoutedEvent ManipulationCompletedEvent = Manipulation.ManipulationCompletedEvent.AddOwner(typeof(UIElement));
...
//    #endregion
    ...
    private static boolean _setDpi = true;
    ...
    // in the local store. 
    /*internal*/public static final UncommonField<EventHandlersStore> EventHandlersStoreField = new UncommonField<EventHandlersStore>();
    /*internal*/public static final UncommonField<InputBindingCollection> InputBindingCollectionField = new UncommonField<InputBindingCollection>(); 
    /*internal*/public static final UncommonField<CommandBindingCollection> CommandBindingCollectionField = new UncommonField<CommandBindingCollection>();
    private  static final UncommonField<Object> LayoutUpdatedListItemsField = new UncommonField<Object>();
    private  static final UncommonField<EventHandler> LayoutUpdatedHandlersField = new UncommonField<EventHandler>();
    private  static final UncommonField<StylusPlugInCollection> StylusPlugInsField = new UncommonField<StylusPlugInCollection>(); 
    ...
    /*internal*/ boolean HasAutomationPeer 
    {
        get { return ReadFlag(CoreFlags.HasAutomationPeer); }
        set { WriteFlag(CoreFlags.HasAutomationPeer, value); }
    } 
    private boolean RenderingInvalidated
    { 
        get { return ReadFlag(CoreFlags.RenderingInvalidated); } 
        set { WriteFlag(CoreFlags.RenderingInvalidated, value); }
    } 

    /*internal*/ boolean SnapsToDevicePixelsCache
    {
        get { return ReadFlag(CoreFlags.SnapsToDevicePixelsCache); } 
        set { WriteFlag(CoreFlags.SnapsToDevicePixelsCache, value); }
    } 

    /*internal*/ boolean ClipToBoundsCache
    { 
        get { return ReadFlag(CoreFlags.ClipToBoundsCache); }
        set { WriteFlag(CoreFlags.ClipToBoundsCache, value); }
    }

    /*internal*/ public boolean MeasureDirty
    { 
        get { return ReadFlag(CoreFlags.MeasureDirty); } 
        set { WriteFlag(CoreFlags.MeasureDirty, value); }
    } 

    /*internal*/ boolean ArrangeDirty
    {
        get { return ReadFlag(CoreFlags.ArrangeDirty); } 
        set { WriteFlag(CoreFlags.ArrangeDirty, value); }
    } 

    /*internal*/ boolean MeasureInProgress
    { 
        get { return ReadFlag(CoreFlags.MeasureInProgress); }
        set { WriteFlag(CoreFlags.MeasureInProgress, value); }
    }

    /*internal*/ boolean ArrangeInProgress
    { 
        get { return ReadFlag(CoreFlags.ArrangeInProgress); } 
        set { WriteFlag(CoreFlags.ArrangeInProgress, value); }
    } 

    /*internal*/ boolean NeverMeasured
    {
        get { return ReadFlag(CoreFlags.NeverMeasured); } 
        set { WriteFlag(CoreFlags.NeverMeasured, value); }
    } 

    /*internal*/ boolean NeverArranged
    { 
        get { return ReadFlag(CoreFlags.NeverArranged); }
        set { WriteFlag(CoreFlags.NeverArranged, value); }
    }

    /*internal*/ boolean MeasureDuringArrange
    { 
        get { return ReadFlag(CoreFlags.MeasureDuringArrange); } 
        set { WriteFlag(CoreFlags.MeasureDuringArrange, value); }
    } 

    /*internal*/ boolean AreTransformsClean
    {
        get { return ReadFlag(CoreFlags.AreTransformsClean); } 
        set { WriteFlag(CoreFlags.AreTransformsClean, value); }
    } 

    /*internal*/public static final FocusWithinProperty FocusWithinProperty = new FocusWithinProperty();
    /*internal*/public static final MouseOverProperty MouseOverProperty = new MouseOverProperty(); 
    /*internal*/public static final MouseCaptureWithinProperty MouseCaptureWithinProperty = new MouseCaptureWithinProperty();
    /*internal*/public static final StylusOverProperty StylusOverProperty = new StylusOverProperty();
    /*internal*/public static final StylusCaptureWithinProperty StylusCaptureWithinProperty = new StylusCaptureWithinProperty();
    /*internal*/public static final TouchesOverProperty TouchesOverProperty = new TouchesOverProperty(); 
    /*internal*/public static final TouchesCapturedWithinProperty TouchesCapturedWithinProperty = new TouchesCapturedWithinProperty();
    private Size               _size; 
    /*internal*/public final static int MAX_ELEMENTS_IN_ROUTE = 4096; 
}
