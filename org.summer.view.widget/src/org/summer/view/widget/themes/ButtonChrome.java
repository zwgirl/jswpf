package org.summer.view.widget.themes;
...
import org.summer.view.widget.controls.Border;
...
import org.summer.view.window.PowerLineStatus;
...
///
/// </summary> 
public /*sealed*/ class ButtonChrome extends Decorator 
{
//    #region Constructors 
...
//    #region Dynamic Properties
    ...
    /// </summary> 
    public static final DependencyProperty RenderDefaultedProperty = 
    ...
    /// </summary>
    public boolean RenderDefaulted 
    {
        get { return (boolean)GetValue(RenderDefaultedProperty); }
    ...
    /// </summary>
    public static final DependencyProperty RenderMouseOverProperty = 
    ...
    /// </summary> 
    public static final DependencyProperty RenderPressedProperty = 
    ...
    { 
        ...
        if (chrome.Animates)
        {
            ...
            { 
                boolean renderMouseOver = chrome.RenderMouseOver; 
                Duration duration = new Duration(TimeSpan.FromSeconds(0.1));
    ...
    /// </summary> 
    public static final DependencyProperty RoundCornersProperty = 
    ...
    {
        get { return (boolean)GetValue(RoundCornersProperty); }
...
//    #region Protected Methods
    ...
    protected /*override*/ Size MeasureOverride(Size availableSize) 
    {
        ...
        if (child != null) 
        {
            ...
            boolean isWidthTooSmall = (availableSize.Width < 4.0); 
            boolean isHeightTooSmall = (availableSize.Height < 4.0);
