...
public class DependencyObjectType 
{
    ...
    { 
        if (systemType == null) 
        {
            throw new IllegalArgumentException("systemType"); 
        }

        if (!typeof(DependencyObject).IsAssignableFrom(systemType))
        { 
//            #pragma warning suppress 6506 // systemType is obviously not null
            throw new IllegalArgumentException(/*SR.Get(SRID.DTypeNotSupportForSystemType, systemType.Name)*/); 
        } 
...
//    [FriendAccessAllowed] // Built into Base, also used by Framework. 
    /*internal*/ public static DependencyObjectType FromSystemTypeInternal(Type systemType)
    { 
//        Debug.Assert(systemType != null && typeof(DependencyObject).IsAssignableFrom(systemType), "Invalid systemType argument");
    ...
    /// </returns> 
    public boolean IsInstanceOfType(DependencyObject dependencyObject)
    { 
     ...
     * Determines whether the current DependencyObjectType derives from the 
     * specified DependencyObjectType 
     * @param dependencyObjectType
     * @return
     */
    public boolean IsSubclassOf(DependencyObjectType dependencyObjectType)
    {
