...
import org.summer.view.widget.DependencyObject.UpdateResult;
...
/// </summary> 
/*internal*/public /*static*/ class TreeWalkHelper
{
//    #region TreeChange
    ...
    /// </summary>
    /*internal*/public static void InvalidateOnTreeChange( 
        FrameworkElement        fe,
...
//        Debug.Assert(parent != null, "Must have a parent that the current node is connected to or disconnected from."); 
    ...
    ///     get involved. 
    /// </summary>
    private static boolean OnAncestorChanged(
        DependencyObject d,
        TreeChangeInfo   info, 
        boolean             visitedViaVisualTree)
    { 
...
//    [SecurityCritical,SecurityTreatAsSafe]
    ...
    /// </summary> 
    private static boolean OnPostAncestorChanged(
        DependencyObject d,
        TreeChangeInfo   info,
        boolean             visitedViaVisualTree) 
    {
...
//            Debug.Assert(inheritableProperty.IsPotentiallyInherited, "if we got here, it means that this property is inheritable by someone");
            ...
            if (metadata.IsInherited) 
            {
                ...
                boolean changed = InvalidateTreeDependentProperty(info, d, /*ref*/ fo, inheritableProperty, fMetadata, 
...
//                    Debug.Assert(!currentInheritableProperties.Contains(inheritableProperty), "InheritableProperties list should not have duplicates");
    ...
    /// </summary> 
    private static boolean InvalidateTreeDependentProperty(
        TreeChangeInfo              info, 
        DependencyObject            d, 
...
//        Debug.Assert(fMetadata.IsInherited == true, "This must be an inherited dependency property");
        ...
        { 
            ...
            boolean isForceInheritedProperty = IsForceInheritedProperty(dp); 
...
//    #region ResourcesChange
    ...
    /// </summary> 
    /*internal*/public static void InvalidateOnResourcesChange( 
        FrameworkElement        fe,
        FrameworkContentElement fce, 
...
//        Debug.Assert(fe != null || fce != null, "Node with the resources change notification must be an FE or an FCE.");
    ...
    /// </summary>
    private static boolean OnResourcesChangedCallback( 
        DependencyObject    d,
        ResourcesChangeInfo info, 
        boolean                visitedViaVisualTree) 
    {
    ...
    /// </summary>
    /*internal*/public static void OnResourcesChanged(
        DependencyObject    d,
        ResourcesChangeInfo info, 
        boolean raiseResourceChangedEvent)
    { 
//        Debug.Assert(d != null, "Must have non-null current node"); 

        boolean containsTypeOfKey = info.Contains(d.DependencyObjectType.SystemType, true /*isImplicitStyleKey*/); 
        boolean isSystemResourcesChange = info.IsThemeChange;
        boolean isStyleResourcesChange = info.IsStyleResourcesChange;
        boolean isTemplateResourcesChange = info.IsTemplateResourcesChange;
        boolean isContainer = (info.Container == d); 
...
//    #region InheritablePropertyChange 
    ...
    /// <summary> 
    /// </summary>
    /*internal*/public static void InvalidateOnInheritablePropertyChange(
        FrameworkElement              fe,
        FrameworkContentElement       fce, 
        InheritablePropertyChangeInfo info,
        boolean                          skipStartNode) 
    { 
    ...
    /// </summary> 
    private static boolean OnInheritablePropertyChanged(
        DependencyObject              d,
        InheritablePropertyChangeInfo info,
        boolean                          visitedViaVisualTree) 
    {
//        Debug.Assert(d != null, "Must have non-null current node"); 
        ...
        boolean inheritanceNode = IsInheritanceNode(d, dp, /*out*/ inheritanceBehavior); 
        boolean isForceInheritedProperty = IsForceInheritedProperty(dp);
    ...
    /// </remarks>
    /*internal*/ static boolean IsInheritanceNode(
        DependencyObject    d,
        DependencyProperty  dp, 
    ...
    /// </summary> 
    /*internal*/ static boolean SkipNow(InheritanceBehavior inheritanceBehavior)
    { 
    ...
    /// </summary> 
    /*internal*/ static boolean SkipNext(InheritanceBehavior inheritanceBehavior)
    { 
...
//    #region PrivateMethods
    ...
    /// </summary>
    /*internal*/ static boolean HasChildren(FrameworkElement fe, FrameworkContentElement fce) 
    { 
    ...
    /// </summary>
    private static boolean IsForceInheritedProperty(DependencyProperty dp)
    { 
