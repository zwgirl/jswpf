...
class EventHandlersStore
{
    ...
    public boolean Contains(RoutedEvent routedEvent)
    {
        if (routedEvent == null)
        {
            throw new IllegalArgumentException("routedEvent");
        ...
        FrugalObjectList<IllegalArgumentException> handlers = (FrugalObjectList<RoutedEventHandlerInfo>)this[routedEvent];
    ...
    FrugalObjectList<RoutedEventHandlerInfo> this[RoutedEvent key]
    {
        get
        {
//            Debug.Assert(key != null, "Search key cannot be null");
    ...
    Delegate this[EventPrivateKey key]
    {
        get
        {
            Debug.Assert(key != null, "Search key cannot be null");
