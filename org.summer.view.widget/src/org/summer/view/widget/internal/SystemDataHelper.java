...
/*internal*/ public /*static*/ class SystemDataHelper
{ 
    // return true if the list is a DataView
    /*internal*/ public static boolean IsDataView(IBindingList list)
    {
    ...
    /*internal*/ public static boolean IsDataRowView(Object item) 
    {
        SystemDataExtensionMethods extensions = AssemblyHelper.ExtensionsForSystemData();
    ...
    /*internal*/ public static boolean IsSqlNull(Object value) 
    {
        SystemDataExtensionMethods extensions = AssemblyHelper.ExtensionsForSystemData(); 
    ...
    /*internal*/ public static boolean IsSqlNullableType(Type type)
    { 
        SystemDataExtensionMethods extensions = AssemblyHelper.ExtensionsForSystemData(); 
    ...
    /*internal*/ public static boolean IsDataSetCollectionProperty(PropertyDescriptor pd) 
    {
        SystemDataExtensionMethods extensions = AssemblyHelper.ExtensionsForSystemData(); 
    ...
    /*internal*/ public static boolean DetermineWhetherDBNullIsValid(Object item, String columnName, Object arg)
    { 
        SystemDataExtensionMethods extensions = AssemblyHelper.ExtensionsForSystemData();
    ...
    /*internal*/ public static Object NullValueForSqlNullableType(Type type)
    {
