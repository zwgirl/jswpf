...
/*internal*/public class LiveShapingBlock extends RBNode<LiveShapingItem>
    { 
...
//            #endif 
            ...
            super.Copy(sourceNode, sourceOffset, destNode, destOffset, count);
        ...
        /*internal*/public void FindPosition(LiveShapingItem item, /*out*/ RBFinger<LiveShapingItem> oldFinger, 
        		/*out*/ RBFinger<LiveShapingItem> newFinger, Comparison<LiveShapingItem> comparison)
        { 
...
//            Debug.Assert(index < size, "FindPosition called with item not in its block"); 
        ...
        */
        ...
        RBFinger<LiveShapingItem> SearchLeft(LiveShapingItem item, int offset, Comparison<LiveShapingItem> comparison) 
        {
            ...
            return new RBFinger<LiveShapingItem>(); //  { Node=foundBlock, Offset=offset, Index=baseIndex+offset }; //cym comment
        }
