...
import org.summer.view.widget.data.BindingListCollectionView;
...
//#region ViewManager
    ...
    /*internal*/public class ViewManager extends HybridDictionary 
    {
        ...
        final int InactivityThreshold = 2;
        ...
        public /*new*/ CollectionRecord this[Object o]
        {
            ...
            { 
                ...
                CollectionRecord cr = (CollectionRecord)super[key]; 
        ...
        {
            super.Add(new WeakRefKey(collection), cr);
        } 
        ...
        /// </exception> 
        /*internal*/public ViewRecord GetViewRecord(Object collection, CollectionViewSource cvs,
        		Type collectionViewType, boolean createView, Func<Object, Object> GetSourceItem) 
        {
        ...
        /*internal*/public void RegisterCollectionSynchronizationCallback(
                            IEnumerable collection, 
                            Object context,
                            CollectionSynchronizationCallback synchronizationCallback)
        {
            CollectionRecord cr = EnsureCollectionRecord(collection, null); 
            cr.SynchronizationInfo = new SynchronizationInfo(context, synchronizationCallback);
 
            ViewTable vt = cr.ViewTable; 
            if (vt != null)
            { 
                boolean isSynchronized = cr.SynchronizationInfo.IsSynchronized;
                for/*each*/ (DictionaryEntry de : vt)
                {
        ...
        /*internal*/public SynchronizationInfo GetSynchronizationInfo(IEnumerable collection)
        { 
            CollectionRecord cr = this[collection]; 
        ...
        public static /*internal*/ ViewManager Current
        {
        ...
        { 
            ...
            boolean foundViewTableDirt = false;
