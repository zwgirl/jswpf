...
// ---------------------------------------------------------------------
    // Text line formatter. 
    // ---------------------------------------------------------------------
    /*internal*/ public abstract class Line extends TextSource implements IDisposable
    {
        // ------------------------------------------------------------------ 
        //
        ...
        // ----------------------------------------------------------------- 
        /*internal*/ public Line(/*System.Windows.Controls.*/TextBlock owner)
        { 
            _owner = owner; 
        ...
        // ------------------------------------------------------------------ 
        /*internal*/ public void Format(int dcp, double width, TextParagraphProperties lineProperties, TextLineBreak textLineBreak, TextRunCache textRunCache, boolean showParagraphEllipsis)
        { 
...
//#endif 
        ...
        // ------------------------------------------------------------------ 
        /*internal*/ public /*virtual*/ void Arrange(VisualCollection vc, Vector lineOffset)
        { 
        } 
        ...
        // ----------------------------------------------------------------- 
        /*internal*/ public void Render(DrawingContext ctx, Point lineOffset) 
        {
        ...
        // -----------------------------------------------------------------
        /*internal*/ public Rect GetBoundsFromTextPosition(int characterIndex, /*out*/ FlowDirection flowDirection) 
        {
        ...
        /// of the text bounds. 
        /// </remarks>
        /*internal*/ public List<Rect> GetRangeBounds(int cp, int cch, double xOffset, double yOffset)
        {
        ...
        //------------------------------------------------------------------- 
        /*internal*/ public CharacterHit GetTextPositionFromDistance(double distance) 
        {
        ...
        // Returns: Text position index.
        //------------------------------------------------------------------- 
        /*internal*/ public CharacterHit GetNextCaretCharacterHit(CharacterHit index)
        {
        ...
        // Returns: Text position index.
        //--------------------------------------------------------------------
        /*internal*/ public CharacterHit GetPreviousCaretCharacterHit(CharacterHit index) 
        {
        ...
        // Returns: Text position index.
        //-------------------------------------------------------------------- 
        /*internal*/ public CharacterHit GetBackspaceCaretCharacterHit(CharacterHit index) 
        {
        ...
        /// </param>
        /*internal*/ public boolean IsAtCaretCharacterHit(CharacterHit charHit) 
        {
        ...
        // ----------------------------------------------------------------- 
        /*internal*/ public /*virtual*/ boolean HasInlineObjects()
        { 
            return false;
        }
        ...
        // ------------------------------------------------------------------
        /*internal*/ public /*virtual*/ IInputElement InputHitTest(double offset)
        {
            return null; 
        }
        ...
        /// </summary> 
        /*internal*/ public TextLineBreak GetTextLineBreak()
        {
            if(_line == null)
            { 
                return null;
        ...
        //          by ellipses).
        // ------------------------------------------------------------------ 
        /*internal*/ public int GetEllipsesLength()
        {
        ...
        //
        // -----------------------------------------------------------------
        /*internal*/ public double GetCollapsedWidth() 
        {
            // There are no ellipses, if: 
            // * there is no overflow in the line 
            // * text trimming is turned off
        ...
        // ------------------------------------------------------------------
        /*internal*/ public double Height { get { return _line.Height; } }
 
        // -----------------------------------------------------------------
        // Distance from top to baseline of this text line. 
        // ------------------------------------------------------------------ 
        /*internal*/ public double BaselineOffset { get { return _line.Baseline; } }
 
        // -----------------------------------------------------------------
        // Is this the last line of the paragraph?
        // -----------------------------------------------------------------
        /*internal*/ public boolean EndOfParagraph 
        {
            get 
            { 
        ...
        // ------------------------------------------------------------------
        /*internal*/ public int Length { get { return _line.Length - (EndOfParagraph ? _syntheticCharacterLength : 0); } }

        // ----------------------------------------------------------------- 
        // Length of the line excluding any synthetic characters and line breaks.
        // ------------------------------------------------------------------ 
        /*internal*/ public int ContentLength { get { return _line.Length - _line.NewlineLength; } } 
        ...
        /// </summary>
        protected boolean IsXOffsetAdjusted 
        {
            get 
            { 
        ...
        /// </summary> 
        protected boolean IsWidthAdjusted 
        {
            get 
            {
        ...
        // Cached text line. 
        // -----------------------------------------------------------------
        protected TextFormatting.TextLine _line; 
        ...
        /// </summary> 
        protected boolean _showParagraphEllipsis;
