...
/// </summary> 
//[FriendAccessAllowed]
/*internal*/ public class WeakReferenceList extends CopyOnWriteList implements IEnumerable
{
    ...
    public boolean Contains(Object item) 
    {
        ...
        /*lock*/synchronized (super.SyncRoot) 
        {
    ...
    public int Count
    {
        ...
        {
            int count = 0; 
            /*lock*/synchronized (base.SyncRoot) 
            {
    ...
    /// </summary>
    public /*override*/ boolean Add(Object obj) 
    {
    ...
    public boolean Add(Object obj, boolean skipFind) 
    {
        Debug.Assert(null!=obj, "WeakReferenceList.Add() should not be passed null."); 
        /*lock*/synchronized(base.SyncRoot) 
        {
    ...
    ///   Returns false if Object is already on the list. 
    /// </summary>
    public /*override*/ boolean Remove(Object obj) 
    { 
    ...
    public boolean Insert(int index, Object obj) 
    {
     ...
     private int FindWeakReference(Object obj)
     {
         ...
         boolean foundDeadReferences = true;   // so that the while loop runs the first time
         int foundItem = -1; 

         while (foundDeadReferences) 
         { 
             foundDeadReferences = false;
             ArrayList list = super.LiveList; 
