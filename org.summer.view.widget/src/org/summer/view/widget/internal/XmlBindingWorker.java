...
import org.summer.view.widget.data.BindingWorker;
import org.summer.view.widget.data.ClrBindingWorker;
...
/*internal*/ public class XmlBindingWorker extends BindingWorker implements IWeakEventListener
{
    /*private*/ enum XPathType //: byte 
    { Default, SimpleName, SimpleAttribute }
    ...
    /*internal*/ public XmlBindingWorker(ClrBindingWorker worker, boolean collectionMode) 
    {
    	super(worker.ParentBindingExpression);
        _hostWorker = worker; 
...
//        Debug.Assert(_xpath != null); 
    ...
    /*internal*/ public /*override*/ void AttachDataItem()
    { 
    ...
    /*internal*/ public /*override*/ void DetachDataItem()
    { 
    ...
    /*internal*/ public /*override*/ void OnCurrentChanged(ICollectionView collectionView, EventArgs args) 
    {
    ...
    /*internal*/ public /*override*/ Object RawValue() 
    { 
        if (XPath.length() == 0)
        { 
            return DataItem;
    ...
    /*internal*/ public void ReportBadXPath(TraceEventType traceType)
    { 
...
//            } 
    ...
    private void UpdateContextNode(boolean hookNotifications) 
    {
        UnHookNotifications(); 
    ...
    private boolean IsChangeRelevant(EventArgs rawArgs) 
    {
    ...
    private boolean _collectionMode; 
