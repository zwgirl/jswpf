...
/*internal*/ class RBTree<T> extends RBNode<T> implements IList<T> 
    {
...
//        #endif 
        ...
        public /*override*/ boolean HasData { get { return false; } } 
        ...
        void Insert(RBFinger<T> finger, T x, boolean checkSort/*=false*/)
        { 
...
//            #endif 
        ...
        /*internal*/ void ForEachUntil(Func<T, boolean> action) 
        {
            for/*each*/ (T x : this) 
            { 
                if (action(x))
        ...
        /*internal*/ int IndexOf(T item, Func<T,T,boolean>AreEqual) 
        {
            if (Comparison != null) 
            { 
...
//        #if DEBUG
        ...
        public boolean Verify(int expectedSize, boolean checkSort = true) 
        {
            ...
            T maxItem = default(T);
            BlackHeight = -1; 
            boolean b = Verify(LeftChild, checkSort ? Comparison : null, 0, ref index, ref maxItem, out size) && size == LeftSize && size == expectedSize;
            return b; 
        } 
...
//        #else
        void Verify(int expectedSize, boolean checkSort = true) {}
        void SaveTree() {} 
        public void LoadTree(String s) {}
//        #endif // DEBUG 
//        #endregion Debugging 
