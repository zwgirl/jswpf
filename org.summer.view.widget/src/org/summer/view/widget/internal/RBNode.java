...
/*internal*/ class RBNode<T> implements INotifyPropertyChanged
    { 
...
//        #endif
        ...
        public /*virtual*/ boolean HasData { get { return true; } }
        ...
        protected RBFinger<T> FindIndex(int index, boolean exists /*= true*/) 
        {
            RBFinger<T> result;
        ...
        int BinarySearch(T x, int low, int high, Comparison<T> comparison, int compHigh, out boolean found)
        { 
        ...
        { 
            ...
            {
                boolean deleteHere = (index == node.LeftSize); 
        ...
        boolean IsNodeRed(RBNode<T> node)
        {
...
//        #region Debugging
        ...
        protected boolean Verify(RBNode<T> node, Comparison<T> comparison, int blackDepth, ref int index, ref T maxItem, out int size) 
        { 
            boolean result = true;
