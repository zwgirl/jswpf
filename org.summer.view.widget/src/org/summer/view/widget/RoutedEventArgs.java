...
//            }
    ...
    { 
        ...
        {
            throw new IllegalArgumentException("genericHandler"); 
        }

        if (genericTarget == null)
        { 
            throw new IllegalArgumentException("genericTarget");
        } 
...
//    #region Operations
    ...
    // method RoutedEventArgs.FireEventHandler 
     void InvokeHandler(Delegate handler, Object target)
    {
        InvokingHandler = true;
...
//    [SecurityCritical]
    ...
    private final int HandledIndex                          = 1; 
    private final int UserInitiatedIndex                    = 2;
    private final int InvokingHandlerIndex                  = 4; 
