...
import org.summer.view.widget.xaml.IXamlLineInfo;
import org.summer.view.widget.xaml.IXamlLineInfoConsumer;
...
import org.summer.view.widget.xaml.XamlSchemaContextSettings;
...
//    #region Public Methods 
    ...
    /*internal*/ public static boolean ShouldReWrapException(Exception e, Uri baseUri)
    { 
    ...
    { 
        ...
        org.summer.view.widget.xaml.XamlXmlReaderSettings settings = new /*System.Xaml.*/XamlXmlReaderSettings(); 
        ...
        try 
        {
            ...
            _stack = new XamlContextStack<WpfXamlFrame>(/*() => new WpfXamlFrame()  cym comment*/);

            /*System.Xaml.*/XamlObjectWriterSettings objectSettings = XamlReader.CreateObjectWriterSettings(); 
            objectSettings.AfterBeginInitHandler =new /*cym add new */ delegate(Object sender, /*System.Xaml.*/XamlObjectEventArgs args);
//cym comment 
/*                { 
                    if (rootObject == null) 
                    {
...
//cym comment
            ...
            boolean async = false;
            boolean lastPropWasSyncMode = false;
            boolean lastPropWasSyncRecords = false; 

            while (!_textReader.IsEof) 
            { 
                WpfXamlLoader.TransformNodes(xamlReader, _objectWriter, true /*onlyLoadOneNode*/, 
                		_skipJournaledProperties, shouldPassLineNumberInfo, xamlLineInfo, xamlLineInfoConsumer, _stack, _styleConnector);
                ...
                { 
                    ...
                    { 
                        if (xamlReader.Value instanceof Integer)
                        { 
                            _maxAsynxRecords = (int)xamlReader.Value; 
                        }
                        else if (xamlReader.Value instanceof String) 
                        {
        ...
        catch(Exception e) 
        {
            ...
            {
                throw new Exception();  //cym add new Exception
            } 
    ...
    /*internal*/ public static void RewrapException(Exception e, Uri baseUri)
    { 
        RewrapException(e, null, baseUri);
    } 

    /*internal*/ public static void RewrapException(Exception e, IXamlLineInfo lineInfo, Uri baseUri)
    { 
        throw WrapException(e, lineInfo, baseUri);
    }

    /*internal*/ public static XamlParseException WrapException(Exception e, IXamlLineInfo lineInfo, Uri baseUri) 
    {
    ...
    /// </summary> 
    /*internal*/ public void Post(DispatcherPriority priority) 
    {
    ...
    /*const*/ static final int AsyncLoopTimeout = (int)200; 
    /// <summary>
    /// called when in async mode when get a time slice to read and load the Tree
    /// </summary>
    /*internal*/ public /*virtual*/ void HandleAsyncQueueItem() 
    {
        try 
        { 
    ...
    /*internal*/ public void TreeBuildComplete()
    { 
...
//    #region Internal Methods 
    /*internal*/ public static XamlObjectWriterSettings CreateObjectWriterSettings()
    {
    ...
    /*internal*/ public static XamlObjectWriterSettings CreateObjectWriterSettings(XamlObjectWriterSettings parentSettings) 
    {
    ...
    /*internal*/ public static XamlObjectWriterSettings CreateObjectWriterSettingsForBaml()
    { 
        XamlObjectWriterSettings owSettings = CreateObjectWriterSettings();
    ...
    /*internal*/ public static Baml2006ReaderSettings CreateBamlReaderSettings()
    {
    ...
    /*internal*/ public static XamlSchemaContextSettings CreateSchemaContextSettings()
    { 
    ...
    /*internal*/ public static WpfSharedBamlSchemaContext BamlSharedSchemaContext { get { return _bamlSharedContext.Value; } } 
    /*internal*/ public static WpfSharedBamlSchemaContext XamlV3SharedSchemaContext { get { return _xamlV3SharedContext.Value; } } 
    ...
    /// <returns>Object root generated after xml parsed</returns> 
    // Note this is the /*internal*/ public entry point for XPS.  XPS calls here so
    // its reader is not wrapped with a Markup Compat Reader. 
    /*internal*/ public static Object Load( 
        XmlReader reader,
...
//#endif // DEBUG_CLR_MEM
    ...
    ///     Safe - because it gets this value from the stream if it implements an /*internal*/ public IStreamInfo
...
//    [SecurityCritical, SecurityTreatAsSafe] 
    //[CodeAnalysis("AptcaMethodsShouldOnlyCallAptcaMethods")] //Tracking Bug: 29647 
    /*internal*/ public static Object LoadBaml(
        Stream stream, 
        ParserContext parserContext,
        Object parent,
        boolean closeStream)
...
//#endif // DEBUG_CLR_MEM
    ...
    private static WpfSharedXamlSchemaContext CreateXamlSchemaContext(boolean useV3Rules)
    { 
        XamlSchemaContextSettings settings = new XamlSchemaContextSettings();
        settings.SupportMarkupExtensionsWithDuplicateArity = true;
...
//    #region Data
    ...
    private /*System.Xaml.*/Xa/*System.Xaml.*/xtReader;
    private XmlReader _xmlReader;
    private /*System.Xaml.*/XamlObjectWriter _objectWriter; 
    private Stream _stream;
    private boolean _parseCancelled; 
    ...
    private static final Lazy<WpfSharedBamlSchemaContext> _bamlSharedContext = 
        new Lazy<WpfSharedBamlSchemaContext>(() => CreateBamlSchemaContext());
    private static final Lazy<WpfSharedXamlSchemaContext> _xamlSharedContext = 
        new Lazy<WpfSharedXamlSchemaContext>(() => CreateXamlSchemaContext(false)); 
    private static final Lazy<WpfSharedXamlSchemaContext> _xamlV3SharedContext =
