...
/// </summary>
public /*sealed*/ class MarkupWriter implements IDisposable 
{ 
    /// <summary>
    ...
    /// </param>
    /*internal*/ public static void SaveAsXml(XmlWriter writer, Object instance)
    {
        if (writer == null) 
    ...
    /// The Object instance to serialize
    /// </param>
    /*internal*/ public static void SaveAsXml(XmlWriter writer, Object instance, XamlDesignerSerializationManager manager) 
    {
        if (writer == null) 
            throw new ArgumentNullException("writer"); 
        if (manager == null)
    ...
    /// </param> 
    /*internal*/ public static void SaveAsXml(XmlWriter writer, MarkupObject item) 
    {
    ...
    /// </param>
    /*internal*/ public static void VerifyTypeIsSerializable(Type type)
    { 
    ...
    #region /*internal*/ public Implementation
    /*internal*/ public MarkupWriter(XmlWriter writer)
    { 
        _writer = writer;
    ...
    private boolean RecordNamespaces(Scope scope, MarkupObject item, IValueSerializerContext context, boolean
        lastWasString) 
    {
        ...
        foreach (MarkupProperty property in item.Properties) 
        {
            ...
            {
                boolean isCollection = IsCollectionType(property.PropertyType);
    ...
    /*internal*/ public void WriteItem(MarkupObject item)
    { 
    ...
    private void WriteItem(MarkupObject item, Scope scope)
    {
        ...
        boolean noOtherPropertiesAllowed = false;
        ...
        { 
            ...
            { 
                boolean propertyTagWritten = false;
                boolean explicitTagWritten = false;
    ...
    private boolean IsContentProperty(MarkupProperty property, ContentPropertyAttribute cpa, ref MarkupProperty contentProperty) 
    { 
        // if the property already knows it is the content property, we're done
        boolean isContentProperty = property.IsContent; 
    ...
    private boolean IsDeferredProperty (MarkupProperty property, Dictionary<String, String> writtenAttributes, 
    ...
    /// </summary> 
    private boolean NeedToWriteExplicitTag(MarkupProperty property, MarkupObject firstItem)
    {
    ...
    private boolean IsInTypes(Type type, List<Type> types)
    { 
    ...
    private boolean HasNonValueProperties(MarkupObject item)
    { 
        foreach (MarkupProperty property in item.Properties)
        { 
            if (!property.IsValueAsString) 
    ...
    private boolean HasOnlyNormalizationNeutralStrings(MarkupProperty contentProperty,
        boolean keepLeadingSpace, boolean keepTrailingSpace)
    {
        if (!contentProperty.IsComposite) 
        ...
        else 
        {
            ...
            boolean result = true;
            boolean currentTrimSurroundingWhitespace = keepLeadingSpace; 
            boolean previousTrimSurroundingWhitespace = keepLeadingSpace;
            String text = null;
    ...
    private boolean ShouldTrimSurroundingWhitespace(MarkupObject item) 
    { 
    ...
    private boolean IsNormalizationNeutralString(String value, boolean keepLeadingSpace, boolean keepTrailingSpace) 
    {
        boolean lastCharSpace = !keepLeadingSpace; 
    ...
    { 
        ...
        private boolean? _xmlnsSpacePreserve;
        ...
        public boolean XmlnsSpacePreserve 
        {
            get
            {
                if (_xmlnsSpacePreserve != null) 
                    return (boolean)_xmlnsSpacePreserve;
        ...
        public boolean IsTopOfSpacePreservationScope 
        { 
            get
            { 
                ...
                else if( ((boolean)_xmlnsSpacePreserve) != _containingScope.XmlnsSpacePreserve )
                { 
                ...
                Debug.Assert( ((boolean)_xmlnsSpacePreserve) == _containingScope.XmlnsSpacePreserve ,
    ...
    /// </summary> 
    private class MarkupWriterContext implements IValueSerializerContext
    {
        Scope _scope;

        /*internal*/ public MarkupWriterContext(Scope scope)
        { 
            _scope = scope; 
        }
    ...
    /// the Scope.
    /// </summary> 
    private class TypeValueSerializer implements ValueSerializer 
    {
        Scope _scope; 
