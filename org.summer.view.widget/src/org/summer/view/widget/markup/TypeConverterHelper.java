...
/// </summary>
/*internal*/ public /*static*/ class TypeConverterHelper 
{ 
    private static CultureInfo invariantEnglishUS = CultureInfo.ReadOnly(new CultureInfo("en-us", false));

    /*internal*/ public static CultureInfo InvariantEnglishUS
    {
        get
        { 
...
//#if !SYSTEM_XAML 
    /*internal*/ public static MemberInfo GetMemberInfoForPropertyConverter(Object dpOrPiOrMi)
    {
...
//#endif 
    ...
    /*internal*/ public static Type GetConverterType(MemberInfo memberInfo) 
    {
...
//#endif
    /*internal*/ public static Type GetConverterType(Type type)
    { 
...
//#if !SYSTEM_XAML
    /*internal*/ public static Type GetCoreConverterTypeFromCustomType(Type type) 
    {
        Type converterType = null; 
        if (type.IsEnum) 
        {
...
//#if !PBTCOMPILER 
    ...
    /*internal*/ public static TypeConverter GetCoreConverterFromCustomType(Type type) 
    {
        TypeConverter typeConverter = null;
        if (type.IsEnum)
        { 
...
//#endif 
    ...
    /*internal*/ public static TypeConverter GetTypeConverter(Type type) 
    { 
        if (type == null)
        { 
