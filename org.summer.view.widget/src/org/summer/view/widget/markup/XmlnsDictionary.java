...
//#else 
    public class XmlnsDictionary implements IDictionary, /*System.Xaml.*/IXamlNamespaceResolver 
//#endif
    { 
...
//#region Private
       ...
       private void CheckSealed() 
        ...
        private boolean HasNamespace(String prefix)
        { 
            if (_lastDecl > 0)
            {
                for (int thisDecl = _lastDecl-1;
...
//#region Private Data
        ...
        /// </summary> 
        private boolean _sealed = false;       // True if dictionary is immutable.
