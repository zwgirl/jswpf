...
//		};
	...
	public XamlType (Type underlyingType, XamlSchemaContext schemaContext, XamlTypeInvoker invoker)
	{
		...
		if (type.IsGenericType) {
			...
			for/*each*/ (Type gta : type.GetGenericArguments ())
...
//	String explicit_ns;
	...
	/*internal*/ public EventHandler<XamlSetMarkupExtensionEventArgs> SetMarkupExtensionHandler {
		get { return LookupSetMarkupExtensionHandler (); }
	}

	/*internal*/ public EventHandler<XamlSetTypeConverterEventArgs> SetTypeConverterHandler {
	...
	public boolean ConstructionRequiresArguments {
	...
	public boolean IsUsableDuringInitialization {
		get { return LookupUsableDuringInitialization (); }
	}

	public boolean IsWhitespaceSignificantCollection {
	...
	public boolean TrimSurroundingWhitespace {
	...
	/*internal*/ public String GetInternalXmlName ()
	{
	...
	public static boolean operator == (XamlType left, XamlType right)
	{
		return IsNull (left) ? IsNull (right) : left.Equals (right);
	}

	static boolean IsNull (XamlType a)
	{
	...
	public boolean Equals (XamlType other)
	{
	...
	public /*virtual*/ boolean CanAssignTo (XamlType xamlType)
	{
	...
	static final XamlMember [] empty_array = new XamlMember [0];
	...
	{
		// This is a hack that is likely required due to /*internal*/ public implementation difference in System.Uri. Our Uri has two readonly collection properties
	...
	static boolean IsPublicAccessor (MethodInfo mi)
	{
	...
	protected /*internal*/ public /*virtual*/ XamlCollectionKind LookupCollectionKind ()
	{
		if (UnderlyingType == null)
	...
	protected /*virtual*/ boolean LookupConstructionRequiresArguments ()
	{
		if (UnderlyingType == null)
			return false;
	...
	protected /*internal*/ public /*virtual*/ ICustomAttributeProvider LookupCustomAttributeProvider ()
	{
	...
	protected /*virtual*/ boolean LookupIsConstructible ()
	{
		if (UnderlyingType == null)
			return true;
	...
	protected /*virtual*/ boolean LookupIsMarkupExtension ()
	{
		return typeof (MarkupExtension).IsAssignableFrom (UnderlyingType);
	}

	protected /*virtual*/ boolean LookupIsNameScope ()
	{
		return typeof (INameScope).IsAssignableFrom (UnderlyingType);
	}

	protected /*virtual*/ boolean LookupIsNullable ()
	{
		return !type.IsValueType || type.IsGenericType && type.GetGenericTypeDefinition () == typeof (Nullable<>);
	}

	protected /*virtual*/ boolean LookupIsPublic ()
	{
	...
	protected /*virtual*/ boolean LookupIsWhitespaceSignificantCollection ()
	{
	...
	protected /*virtual*/ boolean LookupIsXData ()
	{
	...
	protected /*virtual*/ XamlMember LookupMember (String name, boolean skipReadOnlyCheck)
	{
	...
	protected /*virtual*/ boolean LookupTrimSurroundingWhitespace ()
	{
	...
	protected /*virtual*/ boolean LookupUsableDuringInitialization ()
	{
	...
	/*internal*/ public static XamlValueConverter<ValueSerializer> LookupValueSerializer (XamlType targetType, ICustomAttributeProvider provider)
	{
		if (provider == null)
			return null;
