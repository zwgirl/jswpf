...
import org.summer.view.widget.data.BindingValueChangedEventArgs;
...
/*internal*/ public  /*static*/ class StyleHelper 
{
    //  =========================================================================== 
...
//    #region UpdateCache
    ...
    // 
    /*internal*/ public  static void UpdateStyleCache( 
        FrameworkElement        fe,
...
//        Debug.Assert(fe != null || fce != null);
    ...
    // 
    /*internal*/ public  static void UpdateThemeStyleCache(
        FrameworkElement        fe,
        FrameworkContentElement fce,
        Style                   oldThemeStyle, 
        Style                   newThemeStyle,
...
//#pragma warning restore 6503 
    ...
    //
    /*internal*/ public  static Style GetThemeStyle(FrameworkElement fe, FrameworkContentElement fce) 
    {
//        Debug.Assert((fe != null && fce == null)|| (fe == null && fce != null));
        ...
        { 
            ...
            { 
                ...
                else 
                {
                    ...
                    throw new InvalidOperationException(/*SR.Get(SRID.SystemResourceForTypeIsNotStyle, themeStyleKey)*/); 
                }
            }
    ...
    // 
    /*internal*/ public  static void UpdateTemplateCache(
        FrameworkElement        fe,
...
//    #region WriteMethods
    ...
    //  1. Seals a template 
    //
    /*internal*/ public  static void SealTemplate( 
        FrameworkTemplate                                           frameworkTemplate,
        /*ref*/ boolean                                                    isSealed,
...
//        Debug.Assert( frameworkTemplate != null );
    ...
    //     references
    // 
    /*internal*/ public  static void UpdateTables(
    ...
    { 
        ...
        boolean requiresInstanceStorage = RequiresInstanceStorage(/*ref*/ value);
    ...
    //
    private static boolean RequiresInstanceStorage(/*ref*/ Object value) 
    {
        ...
        boolean requiresInstanceStorage = false;
    ...
    // 
    /*internal*/ public  static void AddContainerDependent(
        DependencyProperty dp, 
        boolean fromVisualTrigger,
        /*ref*/ FrugalStructList<ContainerDependent> containerDependents)
    {
    ...
    //
    /*internal*/ public  static void AddEventDependent( 
        int                                     childIndex, 
...
//            Debug.Assert(childIndex >= 0); 
    ...
    /*internal*/ public  static void ProcessTemplateContentFromFEF( 
    ...
    private static void ProcessTemplateTriggers( 
        ...
        /*ref*/ boolean                                                    hasLoadedChangeHandler)
    { 
        if (triggers != null) 
        {
            ...
            for (int i = 0; i < triggerCount; i++)
            {
                ...
                DetermineTriggerType( triggerBase, /*ref*/ trigger, /*ref*/ multiTrigger, /*ref*/ dataTrigger, /*ref*/ multiDataTrigger, /*ref*/ eventTrigger );
    ...
    private static void DetermineTriggerType( TriggerBase triggerBase,
        /*ref*/ Trigger trigger, /*ref*/ MultiTrigger multiTrigger, 
        /*ref*/ DataTrigger dataTrigger, /*ref*/ MultiDataTrigger multiDataTrigger,
        /*ref*/ EventTrigger eventTrigger ) 
    { 
    ...
    // 
    /*internal*/ public  static void ProcessEventTrigger (
        EventTrigger                            eventTrigger,
        HybridDictionary                        childIndexFromChildName,
        /*ref*/ HybridDictionary                    triggerActions, 
        /*ref*/ ItemStructList<ChildEventDependent> eventDependents,
        ...
        /*ref*/ boolean                                hasLoadedChangeHandler) 
    {
        ...
        boolean                actionsListExisted = true; 
        boolean                actionsListChanged = false;
    ...
    //
    /*internal*/ public  static void SealIfSealable(Object value)
    {
...
//    #region WriteInstanceData 
    ...
    //
    /*internal*/ public  static void UpdateInstanceData(
...
//        Debug.Assert((fe != null && fce == null) || (fe == null && fce != null));
    ...
    //
    /*internal*/ public  static void CreateInstanceData( 
        UncommonField<HybridDictionary[]> dataField,
...
//        Debug.Assert(newStyle != null || newFrameworkTemplate != null );
    ...
    // 
    /*internal*/ public  static void CreateInstanceDataForChild(
        UncommonField<HybridDictionary[]>   dataField, 
        DependencyObject                    container, 
        DependencyObject                    child,
        int                                 childIndex, 
        boolean                                hasInstanceValues,
        /*ref*/ FrugalStructList<ChildRecord>   childRecordFromChildIndex)
    {
    ...
    //
    /*internal*/ public  static void ReleaseInstanceData( 
        UncommonField<HybridDictionary[]>  dataField,
        DependencyObject            container,
        FrameworkElement            fe,
        FrameworkContentElement     fce, 
...
//        Debug.Assert(oldStyle != null || oldFrameworkTemplate != null );
    ...
    // 
    /*internal*/ public  static HybridDictionary EnsureInstanceData(
        UncommonField<HybridDictionary[]>  dataField, 
        DependencyObject            container, 
...
//        Debug.Assert(dataType < InstanceStyleData.ArraySize, "Caller has queried using a value outside the range of the Enum.  Bad caller, bad!");
    ...
    { 
        ...
        { 
            ...
            Helper.DowncastToFEorFCE(child, /*ref*/ feChild, /*ref*/ fceChild, false); 
...
//                        Debug.Assert(!freezable.CanFreeze, "If a freezable could have been frozen it would have been done by now.");
    ...
    //
    /*internal*/ public  static void ProcessInstanceValue( 
        DependencyObject    target,
        int                 childIndex,
        HybridDictionary    instanceValues,
        DependencyProperty  dp, 
...
//            Debug.Assert(dataField == ThemeStyleDataField);
        ...
        if (dataTriggerRecordFromBinding != null)
        { 
            for/*each*/ (Object o : dataTriggerRecordFromBinding.Keys)
            {
        ...
        {
            for/*each*/ (Object o : dataTriggersWithActions.Keys)
            { 
                BindingBase binding = (BindingBase)o;
                ReleaseInstanceDataForTriggerBinding(binding, instanceValues, handler); 
            } 
...
//    #region InstantiateSubTree
    ...
    /*internal*/ public  static boolean ApplyTemplateContent( 
        UncommonField<HybridDictionary[]>  dataField,
        DependencyObject            container, 
        FrameworkElementFactory     templateRoot, 
        int                         lastChildIndex,
...
//        Debug.Assert(frameworkTemplate != null );
        ...
        FrameworkElement feContainer = (FrameworkElement) (container instanceof FrameworkElement ? container : null); 
...
//#endif 
    ...
    /*internal*/ public  static void AddCustomTemplateRoot( FrameworkElement container, UIElement child ) 
    {
    ...
    /*internal*/ public  static void AddCustomTemplateRoot(
        FrameworkElement container,
        UIElement child, 
        boolean checkVisualParent, //
        boolean mustCacheTreeStateOnChild) 
    { 
//#if DEBUG
...
//        Debug.Assert(frameworkTemplate != null ); 
        ...
        boolean walkNodeIsFE;

        while( walkNode != null ) 
        {
            // Figure out whether the node is a FE or FCE 
            Helper.DowncastToFEorFCE(walkNode, /*ref*/ feWalkNode, /*ref*/ fceWalkNode, false);
...
//                "Template tree node should be either FE or FCE - did you add support for more types and forgot to update this function?"); 
            ...
            walkNode = (walkNode instanceof ContentPresenter) ? null: nextParent; 
        }
    } 
...
//    #region ClearGeneratedSubTree 
    ...
    // 
    /*internal*/ public  static void ClearGeneratedSubTree( 
...
//        Debug.Assert(oldFrameworkTemplate != null ); 
        ...
        { 
            ...
            FrameworkElement fe;
            FrameworkContentElement fce; 
            SpecialDowncastToFEorFCE(walk, /*ref*/ fe, /*ref*/ fce, true); // Doesn't throw for Visual3D
...
//            Debug.Assert( oldFrameworkTemplate != null ); 
            ...
            { 
                ...
                for/*each*/ (DictionaryEntry entry : parentTemplateValues)
                { 
    ...
    /*internal*/ public  static void SpecialDowncastToFEorFCE(DependencyObject d, 
                                /*ref*/ FrameworkElement fe, /*ref*/ FrameworkContentElement fce,
...
//    #region InvokeEventTriggers 
    ...
    //
    /*internal*/ public  static FrameworkElementFactory FindFEF(FrameworkElementFactory root, int childIndex) 
    { 
    ...
    private static void ExecuteEventTriggerActionsOnContainer (Object sender, RoutedEventArgs e) 
    {
        ...
        FrameworkElement fe; 
        FrameworkContentElement fce;
        Helper.DowncastToFEorFCE((DependencyObject)sender, /*ref*/ fe, /*ref*/ fce, false);
    ...
    { 
        ...
        if (templatedParent != null)
        {
            ...
            Helper.DowncastToFEorFCE(templatedParent, /*ref*/ feTemplatedParent, /*ref*/ fceTemplatedParent, false); 
...
//    #region GetValueMethods 
    ...
    // 
    /*internal*/ public  static Object GetChildValue(
        UncommonField<HybridDictionary[]>   dataField, 
        DependencyObject                    container, 
        int                                 childIndex,
...
//        Debug.Assert(child.IsValid, "child should either be an FE or an FCE"); 
    ...
    //
    /*internal*/ public  static Object GetDataTriggerValue(
        UncommonField<HybridDictionary[]>  dataField,
        DependencyObject            container, 
        BindingBase                 binding)
    { 
...
//                Debug.Assert(dataField == ThemeStyleDataField);
    ...
    // 
    /*internal*/ public  static Object GetInstanceValue(
        UncommonField<HybridDictionary []>  dataField, 
        DependencyObject            container,
        FrameworkElement            feChild,
        FrameworkContentElement     fceChild,
        ...
        /*ref*/ EffectiveValueEntry     entry) 
    {
        ...
        FrameworkElement feContainer;
        FrameworkContentElement fceContainer; 
        Helper.DowncastToFEorFCE(container, /*ref*/ feContainer, /*ref*/ fceContainer, true);
        ...
        boolean isRequestingExpression = (feChild != null) ? feChild.IsRequestingExpression : fceChild.IsRequestingExpression;
        ...
        if (value == NotYetApplied) 
        {
            ...
            if ((me = rawValue as MarkupExtension) != null) 
            {
                ...
                { 
                    boolean isInitialized = (feChild != null) ? feChild.IsInitialized : fceChild.IsInitialized; 
                    if (!isInitialized)
                    { 
...
//#if DEBUG
    ...
    //
    /*internal*/ public  static void CheckForCyclicReferencesInStyleAndTemplateTriggers(
        DependencyProperty  templateProperty, 
        FrameworkTemplate   frameworkTemplate,
        Style               style, 
        Style               themeStyle) 
...
//#endif 
    ...
    // 
    /*internal*/ public  static boolean ShouldGetValueFromStyle (DependencyProperty dp)
    { 
    ...
    // 
    /*internal*/ public  static boolean ShouldGetValueFromThemeStyle (DependencyProperty dp)
    { 
        return (dp != FrameworkElement.StyleProperty &&
    ...
    //
    /*internal*/ public  static boolean ShouldGetValueFromTemplate( 
        DependencyProperty dp)
    { 
        return (dp != FrameworkElement.StyleProperty && 
                dp != FrameworkElement.DefaultStyleKeyProperty &&
...
//    #region InvalidateMethods
    ...
    // 
    /*internal*/ public  static void DoStyleInvalidations(
        FrameworkElement fe,
        FrameworkContentElement fce,
        Style oldStyle, 
        Style newStyle)
...
//        Debug.Assert(fe != null || fce != null); 
    ...
    //     FrameworkContentElement or a sub-class thereof.
    // 
    /*internal*/ public  static void DoThemeStyleInvalidations(
        FrameworkElement fe,
        FrameworkContentElement fce,
        Style oldThemeStyle, 
        Style newThemeStyle,
...
//        Debug.Assert(fe != null || fce != null);
    ...
    //
    /*internal*/ public  static void DoTemplateInvalidations( 
        FrameworkElement            feContainer,
        FrameworkTemplate           oldFrameworkTemplate) 
    { 
//        Debug.Assert(feContainer != null);
        ...
        Object              oldTemplate; 
        Object              newTemplate;
        boolean                newTemplateHasResourceReferences; 
...
//                Debug.Assert(feContainer != null);
            ...
            // Wipe /*ref*/ VisualTree only if VisualTree factories 
            // are changing
            // 
            ...
            boolean                                 canBuildVisualTree;
            boolean                                 hasTemplateGeneratedSubTree; 
            FrugalStructList<ContainerDependent> oldContainerDependents;
            FrugalStructList<ContainerDependent> newContainerDependents; 
...
//            Debug.Assert(feContainer != null); 
    ...
    // gets invalidated.
    // 
    /*internal*/ public  static void DoStyleResourcesInvalidations(
        DependencyObject        container,
        FrameworkElement        fe,
        FrameworkContentElement fce, 
        Style                   oldStyle,
...
//        Debug.Assert(container == fe || container == fce); 
        ...
        boolean isAncestorChangedInProgress = (fe != null) ? fe.AncestorChangeInProgress : fce.AncestorChangeInProgress; 
    ...
    // gets invalidated. 
    //
    /*internal*/ public  static void DoTemplateResourcesInvalidations( 
        DependencyObject        container, 
        FrameworkElement        fe,
        FrameworkContentElement fce, 
        Object                  oldTemplate,
...
//            "Old and new template types do not match." );
    ...
    /*internal*/ public  static void UpdateLoadedFlag( DependencyObject d,
...
//        Invariant.Assert(null != oldStyle || null != newStyle); 
    ...
    // 
    /*internal*/ public  static void InvalidateContainerDependents(
        DependencyObject                         container, 
    ...
    /*internal*/ public  static void ApplyTemplatedParentValue(
            DependencyObject                container, 
            FrameworkObject                 child, 
            int                             childIndex,
        /*ref*/ FrugalStructList<ChildRecord>   childRecordFromChildIndex, 
    ...
    /*internal*/ public  static boolean GetValueFromTemplatedParent(
            DependencyObject                container, 
            int                             childIndex,
            FrameworkObject                 child, 
            DependencyProperty              dp, 
    ...
    /*internal*/ public  static void ApplyStyleOrTemplateValue( 
            FrameworkObject fo,
            DependencyProperty dp) 
    {
        EffectiveValueEntry newEntry = new EffectiveValueEntry(dp);
    ...
    /*internal*/ public  static boolean GetValueFromStyleOrTemplate(
            FrameworkObject fo,
            DependencyProperty dp,
        /*ref*/ EffectiveValueEntry entry) 
    {
        ...
        { 
            ...
            if (value != DependencyProperty.UnsetValue)
            {
                ...
                { 
//                    Debug.Assert(sourceType == ValueLookupType.Simple || sourceType == ValueLookupType.Resource); 
                    setterValue = value; 
                }
            } 
        }
    ...
    //
    /*internal*/ public  static void SortResourceDependents( 
        /*ref*/ FrugalStructList<ChildPropertyDependent> resourceDependents)
    {
        ...
        // an unwelcome JIT of mscorlib, to load /*internal*/ public  methods 
    ...
    //
    /*internal*/ public  static void InvalidateResourceDependents( 
        DependencyObject                             container, 
        ResourcesChangeInfo                          info,
        /*ref*/ FrugalStructList<ChildPropertyDependent> resourceDependents, 
        boolean                                         invalidateVisualTreeToo)
    {
    ...
    //
    /*internal*/ public  static void InvalidateResourceDependentsForChild(
            DependencyObject                            container, 
            DependencyObject                            child,
            int                                         childIndex, 
            ResourcesChangeInfo                         info, 
    ...
    //
    /*internal*/ public  static boolean HasResourceDependentsForChild( 
        int                                          childIndex,
        /*ref*/ FrugalStructList<ChildPropertyDependent> resourceDependents)
    {
    ...
    //
    /*internal*/ public  static void InvalidatePropertiesOnTemplateNode(
            DependencyObject                container, 
            FrameworkObject                 child,
            int                             childIndex, 
        /*ref*/ FrugalStructList<ChildRecord>   childRecordFromChildIndex, 
...
//                    Debug.Assert(dp != null, "dp must not be null");
    ...
    // 
    /*internal*/ public  static boolean IsSetOnContainer(
        DependencyProperty                       dp, 
        /*ref*/ FrugalStructList<ContainerDependent> containerDependents,
        boolean                                     alsoFromTriggers)
    {
        for (int i = 0; i < containerDependents.Count; i++) 
        {
    ...
    // 
    /*internal*/ public  static void OnTriggerSourcePropertyInvalidated(
        Style                                                       ownerStyle,
        FrameworkTemplate                                           frameworkTemplate,
        DependencyObject                                            container, 
        DependencyProperty                                          dp,
        DependencyPropertyChangedEventArgs                          changedArgs, 
        boolean                                                        invalidateOnlyContainer, 
        /*ref*/ FrugalStructList<ItemStructMap<TriggerSourceRecord>>    triggerSourceRecordFromChildIndex,
        /*ref*/ FrugalMap                                               propertyTriggersWithActions, 
...
//        Debug.Assert(ownerStyle != null || frameworkTemplate != null );
        ...
        { 
            ...
            if (child != null && 
                child.GetValueSource(invalidProperty, null, /*ref*/ hasModifiers) != BaseValueSourceInternal.Local)
            { 
...
//        Debug.Assert( ft != null );
    ...
    private static boolean NoSourceNameInTrigger( TriggerBase triggerBase ) 
    {
        Trigger trigger = triggerBase as Trigger; 
        if( trigger != null )
        {
    ...
    private static void InvokeEnterOrExitActions( TriggerBase triggerBase,
        boolean oldState, boolean newState, DependencyObject triggerContainer,
        Style style, FrameworkTemplate frameworkTemplate)
    { 
    ...
    private static boolean CanInvokeActionsNow( DependencyObject container, 
        FrameworkTemplate frameworkTemplate) 
    {
        boolean result; 
...

    {
        ...
        { 
            ...
            if( !deferredActions.TryGetValue(triggerContainer, /*ref*/ actionList) )
            { 
    ...
    /*internal*/ public  static void InvokeDeferredActions( DependencyObject triggerContainer, 
        FrameworkTemplate frameworkTemplate ) 
    {
        ...
        {
            List<DeferredAction> actionList;
            if (frameworkTemplate.DeferredActions.TryGetValue(triggerContainer, /*ref*/ actionList)) 
            {
    ...
    /*internal*/ public  static void InvokeActions( TriggerBase triggerBase, 
        DependencyObject triggerContainer, TriggerActionCollection actions,
        Style style, FrameworkTemplate frameworkTemplate) 
    { 
...
//            Debug.Assert(!(action.ContainingTrigger instanceof EventTrigger),
//                "This trigger actions list used by this method are expected to contain only those actions under non-event triggers."); 
    ...
    private static void EvaluateOldNewStates( Trigger trigger, 
        ...
        /*ref*/ boolean oldState, /*ref*/ boolean newState ) 
    {
...
//                "A null binding was encountered in a MultiDataTrigger conditions collection - this is invalid input and should have been caught earlier."); 
    ...
    /*internal*/ public  static void AddPropertyTriggerWithAction(TriggerBase triggerBase, 
...
//                    "FrugalMap for holding List<TriggerBase> is holding an instance of unexpected type " + existing.GetType() );
    ...
    //  has associated TriggerActions. 
    /*internal*/ public  static void AddDataTriggerWithAction(TriggerBase triggerBase, 
    ...
    private static void OnBindingValueInStyleChanged(Object sender, BindingValueChangedEventArgs  e)
    {
        ...
        FrameworkElement fe;
        FrameworkContentElement fce; 
        Helper.DowncastToFEorFCE(container, /*ref*/ fe, /*ref*/ fce, false);
...
//    #region ReadInstanceData
    ...
    //
    /*internal*/ public  static int CreateChildIndexFromChildName(
        String              childName, 
        FrameworkTemplate   frameworkTemplate)
    { 
//        Debug.Assert(frameworkTemplate != null ); 
...
//        Debug.Assert(frameworkTemplate != null);
        ...
        {
            throw new IllegalArgumentException(/*SR.Get(SRID.NameScopeDuplicateNamesNotAllowed, childName)*/);
        } 
...
//        Debug.Assert(frameworkTemplate != null);
    ...
    //
    /*internal*/ public  static int QueryChildIndexFromChildName( 
        String           childName,
        HybridDictionary childIndexFromChildName) 
    { 
        // "Self" check
    ...
    /*internal*/ public  static Object FindNameInTemplateContent( 
        DependencyObject    container, 
        String              childName,
        FrameworkTemplate   frameworkTemplate) 
    {
...
//        Debug.Assert(frameworkTemplate != null); 
    ...
    // 
    /*internal*/ public  static DependencyObject GetChild(DependencyObject container, int childIndex)
    { 
    ...
    //  1. Finds the child corresponding to the given childIndex 
    // 
    /*internal*/ public  static DependencyObject GetChild(List<DependencyObject> styledChildren, int childIndex)
    { 
...
//    #region AlternateExpressionStorage 
    ...
    //
    /*internal*/ public  static void RegisterAlternateExpressionStorage()
    {
    ...
    { 
        FrameworkElement fe;
        FrameworkContentElement fce; 
        Helper.DowncastToFEorFCE(d, /*ref*/ fe, /*ref*/ fce, false); 
    ...
    // 
    /*internal*/ public  static Expression GetExpression(
        DependencyObject d, 
        DependencyProperty dp)
    {
        FrameworkElement fe;
        ...
        boolean isInitialized = (fe != null) ? fe.IsInitialized : (fce != null) ? fce.IsInitialized : true; 
        if (!isInitialized)
        {
            if (fe != null)
...
//    #region ReadEvents 
    ...
    //  (Index is '0' when the styled container is asking) 
    //
    /*internal*/ public  static RoutedEventHandlerInfo[] GetChildRoutedEventHandlers(
        int                                     childIndex,
        RoutedEvent                           routedEvent, 
        /*ref*/ ItemStructList<ChildEventDependent> eventDependents)
    { 
...
//    #region HelperMethods
    ...
    //
    /*internal*/ public  static boolean IsStylingLogicalTree(DependencyProperty dp, Object value) 
    {
...
//    #region Fields 
    ...
    //
    /*internal*/ public  static final UncommonField<HybridDictionary[]> StyleDataField = new UncommonField<HybridDictionary[]>();

    //
    //  Stores instance state of a template 
    // 
    /*internal*/ public  static final UncommonField<HybridDictionary[]> TemplateDataField = new UncommonField<HybridDictionary[]>();
    ...
    // 
    /*internal*/ public  static final UncommonField<HybridDictionary> ParentTemplateValuesField = new UncommonField<HybridDictionary>();

    // 
    //  Stores instance state of a theme style
    // 
    /*internal*/ public  static final UncommonField<HybridDictionary[]> ThemeStyleDataField = new UncommonField<HybridDictionary[]>();
    ...
    //  children after that. 
    //
    /*internal*/ public  static final UncommonField<List<DependencyObject>> TemplatedFeChildrenField = new UncommonField<List<DependencyObject>>(); 

    //
    //  A list of all named objects created from the Template that is *not* an FE/FCE.
    // 

    /*internal*/ public  static final UncommonField<Hashtable> TemplatedNonFeChildrenField = new UncommonField<Hashtable>(); 

    //  "Self" ChildName, maps to ChildIndex 0 to represent
    //  the Container for a Style/Template 
    //
    /*internal*/ public static final String SelfName = "~Self";

    // 
    // Used to pass an empty stucture reference when the parent style/template is null
    // 
    /*internal*/ public  static FrugalStructList<ContainerDependent>  EmptyContainerDependents; 

    // 
    // Certain instance values are "applied" only on demand.  This value indicates that
    // the demand hasn't happened yet.
    //
    /*internal*/ public  static final Object NotYetApplied = new NamedObject("NotYetApplied"); 
    ...
    // 
    /*internal*/ public  static RoutedEventHandler EventTriggerHandlerOnContainer = new RoutedEventHandler(ExecuteEventTriggerActionsOnContainer);
    /*internal*/ public  static RoutedEventHandler EventTriggerHandlerOnChild = new RoutedEventHandler(ExecuteEventTriggerActionsOnChild); 
    ...
    //
    /*internal*/ public /*const*/final static int UnsharedTemplateContentPropertyIndex = -1; 
