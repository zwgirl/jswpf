...
//    #region Public Methods 
    ...
    /// </summary>
    /// <returns>
    /// boolean - true if the two Point instances are exactly equal, false otherwise
    /// </returns> 
    ...
    /// </summary> 
    /// <returns>
    /// boolean - true if the two Point instances are exactly unequal, false otherwise
    /// </returns>
    /// <param name='point1'>The first Point to compare</param> 
    /// <param name='point2'>The second Point to compare</param>
    public static boolean operator != (Point point1, Point point2) 
    ...
    /// </summary> 
    /// <returns>
    /// boolean - true if the Object is an instance of Point and if it's equal to "this". 
    /// </returns>
    ...
    /// </summary>
    /// <returns>
    /// boolean - true if "value" is equal to "this". 
    /// </returns>
...
//    #region Internal Fields
    ...
    /*internal*/ public double _x;
    /*internal*/ public double _y;
