...
import org.summer.view.widget.GlobalEventManager;
...
/// </summary> 
public /*sealed*/ class InputManager extends DispatcherObject
{ 
    /// <summary> 
    ///     A routed event indicating that an input report arrived.
    /// </summary> 
    /*internal*/ public static final RoutedEvent PreviewInputReportEvent = GlobalEventManager.RegisterRoutedEvent("PreviewInputReport", RoutingStrategy.Tunnel, typeof(InputReportEventHandler), typeof(InputManager));

    /// <summary>
    ///     A routed event indicating that an input report arrived. 
    /// </summary>
//    [FriendAccessAllowed] 
    /*internal*/ public static final RoutedEvent InputReportEvent = GlobalEventManager.RegisterRoutedEvent("InputReport", RoutingStrategy.Bubble, typeof(InputReportEventHandler), typeof(InputManager)); 
...
//        [UIPermissionAttribute(SecurityAction.LinkDemand,Unrestricted=true)] 
    ...
    ///     Critical but not TAS - for /*internal*/ public's to use. 
    ...
    /// 
    /// </SecurityNote>
    /*internal*/ public static InputManager UnsecureCurrent 
    { 
//        [SecurityCritical]
//        [FriendAccessAllowed] 
        get
    ...
    ///</summary> 
    /*internal*/ public static boolean IsSynchronizedInput
    {
        get
        { 
    ...
    ///</summary>
    /*internal*/ public static RoutedEvent[] SynchronizedInputEvents
    { 
        get
        { 
    ...
    ///</summary> 
    /*internal*/ public static RoutedEvent[] PairedSynchronizedInputEvents
    { 
        get 
        {
    ...
    ///</summary> 
    /*internal*/ public static SynchronizedInputType SynchronizeInputType 
    {
        get 
        {
    ...
    ///</summary>
    /*internal*/ public static DependencyObject ListeningElement 
    {
        get
        {
    ...
    ///</summary>
    /*internal*/ public static SynchronizedInputStates SynchronizedInputState
    {
...
//        [UIPermissionAttribute(SecurityAction.LinkDemand,Unrestricted=true)] 
    ...
    /// </SecurityNote> 
    /*internal*/ public /*event*/ KeyEventHandler TranslateAccelerator
    {
...
//        [SecurityCritical]
    ...
    /// </SecurityNote> 
//    [SecurityCritical]
    /*internal*/ public void RaiseTranslateAccelerator(KeyEventArgs e) 
    { 
...
//    [SecurityCritical, SecurityTreatAsSafe] 
    /*internal*/ public InputProviderSite RegisterInputProvider(IInputProvider inputProvider)
    { 
...
//         VerifyAccess();
    ...
    /// </SecurityNote> 
//    [SecurityCritical] 
    /*internal*/ public void UnregisterInputProvider(IInputProvider inputProvider)
    { 
...
//        [SecurityCritical] 
    ...
    ///     quite often 
    /// </SecurityNote> 
    /*internal*/ public ICollection UnsecureInputProviders
    { 
//        [SecurityCritical]
        get
        {
    ...
    /// </SecurityNote>
    /*internal*/ public StylusLogic StylusLogic 
    {
//        [SecurityCritical, FriendAccessAllowed]
    ...
    ///     Read-only access to the primary keyboard device. 
    /// </summary>
    /*internal*/ public CommandDevice PrimaryCommandDevice 
    {
    ...
    /// </summary>
    /*internal*/ public boolean InDragDrop 
    {
    ...
    public InputDevice MostRecentInputDevice
    {
        ...
        /*internal*/ public set { _mostRecentInputDevice = value; }
    } 
    ...
    /*internal*/ public void NotifyHitTestInvalidated() 
    {
    ...
    ///</SecurityNote> 
//    [SecurityCritical, SecurityTreatAsSafe]
    /*internal*/ public static void SafeCurrentNotifyHitTestInvalidated() 
    { 
    ...
    /// </summary>
    /*internal*/ public void InvalidateInputDevices() 
    {
...
//    [SecurityCritical] 
//    [UIPermissionAttribute(SecurityAction.LinkDemand,Unrestricted=true)]
    public boolean ProcessInput(InputEventArgs input)
    {
//         VerifyAccess(); 
        ...
        boolean handled = ProcessStagingArea(); 
        return handled; 
    }
    ...
    ///</SecurityNote>
//    [SecurityCritical] 
    /*internal*/ public StagingAreaInputItem PushInput(StagingAreaInputItem inputItem)
    { 
    ...
    ///</SecurityNote> 
//    [SecurityCritical]
    /*internal*/ public StagingAreaInputItem PushInput(InputEventArgs input, StagingAreaInputItem promote) 
    { 
    ...
    ///</SecurityNote> 
//    [SecurityCritical]
    /*internal*/ public StagingAreaInputItem PushMarker() 
    {
    ...
    ///</SecurityNote> 
//    [SecurityCritical]
    /*internal*/ public StagingAreaInputItem PopInput()
    {
        Object input = null; 
    ...
    ///</SecurityNote>
//    [SecurityCritical] 
    /*internal*/ public StagingAreaInputItem PeekInput()
    {
        Object input = null;
    ...
    ///</SecurityNote> 
//    [SecurityCritical ] 
    /*internal*/ public Object ContinueProcessingStagingArea(Object unused)
    { 
    ...
    /*internal*/ public static boolean StartListeningSynchronizedInput(DependencyObject d, SynchronizedInputType inputType)
    { 
        /*lock*/synchronized (_synchronizedInputLock)
        { 
    ...
    /*internal*/ public static void CancelSynchronizedInput() 
    {
    	/*lock*/synchronized (_synchronizedInputLock) 
        {
    ...
    ///</SecurityNote>
//    [SecurityCritical]
    private boolean ProcessStagingArea()
    { 
...
//    [MS.Internal.Permissions.UserInitiatedRoutedEventPermissionAttribute(SecurityAction.Assert)] 
    ...
    private boolean _continueProcessingStagingArea;
...
//    [SecurityCritical]
    ...
    private static boolean _isSynchronizedInput;
