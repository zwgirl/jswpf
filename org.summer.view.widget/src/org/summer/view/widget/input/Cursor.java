...
//    [Localizability(LocalizationCategory.None, Readability = Readability.Unreadable)] 
    public /*sealed*/ class Cursor implements IDisposable
    { 
        /// <summary> 
        ...
        /*internal*/ public Cursor(CursorType cursorType)
        { 
...
//        [FriendAccessAllowed] //used by ColumnHeader.GetCursor in PresentationFramework
        /*internal*/ public Cursor(SafeHandle cursorHandle ) 
        {
...
//        [SecurityCritical, SecurityTreatAsSafe ]
        ...
        /// </summary>
        /// <value></value> 
        /*internal*/ public CursorType CursorType
        {
            get
            { 
                return _cursorType;
        ...
        /// See SecurityNote on _cursorHandle. 
        /// </SecurityNote> 
        /*internal*/ public SafeHandle Handle
        { 
//            [SecurityCritical]
            get
            {
        ...
        /// </summary>
        /// <value></value>
        /*internal*/ public String FileName 
        {
            get 
            { 
                return _fileName;
...
//        [SecurityCritical, SecurityTreatAsSafe]
        ...
        private /*const*/static final int BUFFERSIZE = 4096; // the maximum size of the buffer used for loading from stream
...
//        [SecurityCritical] 
        ...
        private static final int[] CursorTypes = {
            0, // None
