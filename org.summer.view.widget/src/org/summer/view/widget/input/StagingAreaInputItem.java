...
/// <summary> 
    ...
    { 
        ...
        /*internal*/ public StagingAreaInputItem(boolean isMarker) 
        {
            _isMarker = isMarker;
        }
        ...
        /*internal*/ public void Reset(InputEventArgs input, StagingAreaInputItem promote) 
        {
            _input = input; 
...
//        [UIPermissionAttribute(SecurityAction.LinkDemand,Unrestricted=true)] 
        ...
        /*internal*/ public boolean IsMarker {get {return _isMarker;}}
