...
//    #region Constructors
    ...
    /*internal*/ public RoutedCommand(String name, Type ownerType, byte commandId) 
    { 
    	this(name, ownerType, null);
...
//    #region ICommand
    ...
    /// </SecurityNote>
//    [SecurityCritical]
    public boolean /*ICommand.*/CanExecute(Object parameter) 
    {
        boolean unused; 
...
//    [SecurityCritical] 
    ...
    /// </SecurityNote>
//    [SecurityCritical] 
    public boolean CanExecute(Object parameter, IInputElement target)
    {
        boolean unused;
    ...
    /// </SecurityNote>
//    [SecurityCritical] 
    /*internal*/ public boolean CriticalCanExecute(Object parameter, IInputElement target, boolean trusted, 
    		/*out*/ boolean continueRouting)
    {
        // We only support UIElement, ContentElement, and UIElement3D
        if ((target != null) && !InputElement.IsValid(target)) 
        {
...
//    #region Public Properties
    ...
    /// </summary> 
    /*internal*/ public byte CommandId
    { 
        get 
        {
            return _commandId; 
    ...
    /*internal*/ public InputGestureCollection InputGesturesInternal
    {
        get
        { 
    ...
    /*internal*/ public boolean IsBlockedByRM 
    {
//        [SecurityCritical] 
        get
        {
...
//        [SecurityCritical] 
    ...
    /// </SecurityNote>
    /*internal*/ public boolean AreInputGesturesDelayLoaded 
    {
        get
        {
...
//    #region Implementation
    ...
    /// </SecurityNote>
//    [SecurityCritical]
    private boolean CanExecuteImpl(Object parameter, IInputElement target, boolean trusted, /*out*/ boolean continueRouting)
    { 
    ...
    /// </SecurityNote>
//    [SecurityCritical] 
    private void CriticalCanExecuteWrapper(Object parameter, IInputElement target, boolean trusted, 
    ...
    /// </SecurityNote>
//    [SecurityCritical]
    /*internal*/ public boolean ExecuteCore(Object parameter, IInputElement target, boolean userInitiated) 
    {
        if (target == null) 
        { 
            target = FilterInputElement(Keyboard.FocusedElement);
    ...
    /// </SecurityNote>
//    [SecurityCritical]
    private boolean ExecuteImpl(Object parameter, IInputElement target, boolean userInitiated)
    { 
        // If blocked by rights-management fall through and return false
        if ((target != null) && !IsBlockedByRM) 
        { 
...
//    #region Data 
    ...
    /// </SecurityNote> 
    private SecurityCriticalDataForSet<PrivateFlags> _flags;
