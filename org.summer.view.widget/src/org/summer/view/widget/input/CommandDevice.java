...
import org.summer.view.widget.RoutingStrategy;
 /// <summary> 
    ...
    /// </summary>
    /*internal*/ public /*sealed*/ class CommandDevice extends InputDevice 
    {
        /// <SecurityNote> 
...
//        [SecurityCritical,SecurityTreatAsSafe]
        /*internal*/ public CommandDevice( InputManager inputManager )
        { 
...
//        [SecurityCritical]
        ...
        /*internal*/ public static final RoutedEvent CommandDeviceEvent =
...
//        [SecurityCritical] 
    ...
    ///     Used by CommandDevice to send AppCommands to the tree.
    /// </summary> 
    /*internal*/ public class CommandDeviceEventArgs extends InputEventArgs
    { 
        /// <summary> 
        ...
        /*internal*/ public CommandDeviceEventArgs(CommandDevice commandDevice, int timestamp, ICommand command) 
        { 
        	super(commandDevice, timestamp);
            if (command == null) 
            {
        ...
        /// </summary>
        /*internal*/ public ICommand Command 
        {
            get { return _command; }
        }
    ...
    ///     Used by CommandDevice to send AppCommands to the tree.
    /// </summary>
//    /*internal*/ public delegate void CommandDeviceEventHandler(Object sender, CommandDeviceEventArgs e); 