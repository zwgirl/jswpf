...
/// <summary> 
    ...
    /// </summary> 
    public /*sealed*/ class InputGestureCollection implements IList 
    {
        //----------------------------------------------------- 
        //
        //  Constructors
...
//#endregion Implementation of ICollection 
        ...
        public int /*IList.*/Add(Object inputGesture) 
        {
            if (IsReadOnly) 
                throw new NotSupportedException(/*SR.Get(SRID.ReadOnlyInputGesturesCollection)*/);
        ...
        /// </summary>
        /// <param name="inputGesture"></param> 
        public void /*IList.*/Remove(Object inputGesture)
        {
            if (IsReadOnly)
                throw new NotSupportedException(/*SR.Get(SRID.ReadOnlyInputGesturesCollection)*/); 
...
//#endregion Implementation of IEnumberable 
        ...
        /// <param name="key">key</param>
        /// <returns>true - if found, false - otherwise</returns> 
        public boolean Contains(InputGesture key)
        { 
...
//        #region Internal 
        ...
        /*internal*/ public InputGesture FindMatch(Object targetElement, InputEventArgs inputEventArgs)
        { 
