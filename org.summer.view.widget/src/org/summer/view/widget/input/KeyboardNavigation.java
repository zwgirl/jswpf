...
import org.summer.view.widget.documents.Adorner;
import org.summer.view.widget.documents.AdornerLayer;
...
import org.summer.view.window.interop.HwndHost;
import org.summer.view.window.interop.HwndSource;
import org.summer.view.window.interop.IKeyboardInputSink;
import org.summer.view.window.interop.IKeyboardInputSite;
...
//    [SecurityCritical,SecurityTreatAsSafe] 
    /*internal*/ public KeyboardNavigation() 
    {
...
//    #region Properties
    ...
    private static final DependencyProperty TabOnceActiveElementProperty
        = DependencyProperty.RegisterAttached("TabOnceActiveElement", typeof(WeakReference), typeof(KeyboardNavigation)); 

    /*internal*/ public static DependencyObject GetTabOnceActiveElement(DependencyObject d) 
    { 
    ...
    /*internal*/ public static void SetTabOnceActiveElement(DependencyObject d, DependencyObject value)
    { 
        d.SetValue(TabOnceActiveElementProperty, new WeakReference(value));
    } 

    /*internal*/ public static final DependencyProperty ControlTabOnceActiveElementProperty
    ...
    /// </SecurityNote>
//    [SecurityCritical, SecurityTreatAsSafe]
    /*internal*/ public static Visual GetVisualRoot(DependencyObject d) 
    {
    ...
    /*internal*/ public static final DependencyProperty DirectionalNavigationMarginProperty = 
    ...
    /// </summary> 
    public static final DependencyProperty TabIndexProperty =
    ...
    ///     Default Value:      true
    /// </summary>
    public static final DependencyProperty IsTabStopProperty = 
            DependencyProperty.RegisterAttached(
                    "IsTabStop", 
                    typeof(Boolean), 
                    typeof(KeyboardNavigation),
...
//    [CommonDependencyProperty] 
    public static final DependencyProperty TabNavigationProperty =
            DependencyProperty.RegisterAttached(
                    "TabNavigation",
...
//    [Localizability(LocalizationCategory.NeverLocalize)]
//    [CommonDependencyProperty] 
    public static final DependencyProperty ControlTabNavigationProperty = 
            DependencyProperty.RegisterAttached(
...
//    [Localizability(LocalizationCategory.NeverLocalize)]
//    [CommonDependencyProperty]
    public static final DependencyProperty DirectionalNavigationProperty = 
            DependencyProperty.RegisterAttached(
    ...
    /// </summary>
    /*internal*/ public static final DependencyProperty ShowKeyboardCuesProperty = 
            DependencyProperty.RegisterAttached( 
                    "ShowKeyboardCues",
                    typeof(Boolean), 
                    typeof(KeyboardNavigation),
    ...
    /// Default: false.
    /// </summary>
    public static final DependencyProperty AcceptsReturnProperty =
            DependencyProperty.RegisterAttached( 
                    "AcceptsReturn",
                    typeof(Boolean), 
                    typeof(KeyboardNavigation), 
...
//    #region Workaround for Bug 908235 -- when focus change events go to PostProcessInput we don't need this glue.
    /*internal*/ public /*event*/ KeyboardFocusChangedEventHandler FocusChanged
    {
        add 
        {
            /*lock*/synchronized (_weakFocusChangedHandlers) 
            { 
    ...
    /*internal*/ public void NotifyFocusChanged(Object sender, KeyboardFocusChangedEventArgs e)
    {
...
//    [AttachedPropertyBrowsableForType(typeof(DependencyObject))]
    ...
    public static void SetIsTabStop(DependencyObject element, boolean isTabStop) 
    { 
        if (element == null)
        { 
            throw new ArgumentNullException("element");
...
//    [AttachedPropertyBrowsableForType(typeof(DependencyObject))]
    public static boolean GetIsTabStop(DependencyObject element) 
    {
        ...
        return (boolean)element.GetValue(IsTabStopProperty);
    }
...
//    [AttachedPropertyBrowsableForType(typeof(DependencyObject))] 
    ...
    public static void SetAcceptsReturn(DependencyObject element, boolean enabled) 
    {
        if (element == null) 
        {
            throw new ArgumentNullException("element");
...
//    [AttachedPropertyBrowsableForType(typeof(DependencyObject))] 
    ...
    { 
        ...
        return (boolean)element.GetValue(AcceptsReturnProperty);
    }

    private static boolean IsValidKeyNavigationMode(Object o)
    { 
...
//    #region FocusVisualStyle API
    ...
    private /*sealed*/ class FocusVisualAdorner extends Adorner
    { 
        ...
        {
            Size finalSize = super.ArrangeOverride(size);
        ...
        /// </summary>
        /*internal*/ public /*override*/ boolean NeedsUpdate(Size oldSize)
        {
            if (_adornedContentElement != null) 
            {
    ...
    /*internal*/ public static UIElement GetParentUIElementFromContentElement(ContentElement ce) 
    {
    ...
    /*internal*/ public void HideFocusVisual()
    { 
    ...
    /// </SecurityNote> 
//    [SecurityCritical, SecurityTreatAsSafe] 
    /*internal*/ public static boolean IsKeyboardMostRecentInputDevice()
    { 
        return InputManager.Current.MostRecentInputDevice instanceof KeyboardDevice;
    }

    /*internal*/ public static boolean AlwaysShowFocusVisual 
    {
        get 
        { 
    ...
    private static boolean _alwaysShowFocusVisual = SystemParameters.KeyboardCues; 

    /*internal*/ public static void ShowFocusVisual()
    { 
...
//    #region Navigate helpers 
    ...
    /*internal*/ public static void UpdateFocusedElement(DependencyObject focusTarget)
    { 
    ...
    /*internal*/ public void UpdateActiveElement(DependencyObject activeElement) 
    { 
    ...
    /*internal*/ public void UpdateActiveElement(DependencyObject container, DependencyObject activeElement) 
    {
        // Update TabNavigation = Once groups 
    ...
    /*internal*/ public boolean Navigate(DependencyObject currentElement, TraversalRequest request)
    {
        return Navigate(currentElement, request, Keyboard.Modifiers);
    } 

    private boolean Navigate(DependencyObject currentElement, TraversalRequest request, ModifierKeys modifierKeys) 
    { 
        return Navigate(currentElement, request, modifierKeys, null);
    } 

    private boolean Navigate(DependencyObject currentElement, TraversalRequest request, ModifierKeys modifierKeys, DependencyObject firstElement)
    {
        ...
        if (nextTab == null) 
        {
            ...
            boolean navigatedOutside = NavigateOutsidePresentationSource(currentElement, request);
            if (navigatedOutside)
            { 
                return true;
            } 
    ...
    /// </SecurityNote>
//    [SecurityCritical, SecurityTreatAsSafe] 
    private boolean NavigateOutsidePresentationSource(DependencyObject currentElement, TraversalRequest request)
    { 
    ...
    private boolean ShouldNavigateOutsidePresentationSource(DependencyObject currentElement, TraversalRequest request)
    {
    ...
    /*internal*/ public static KeyboardNavigation Current
    {
        get 
        {
...
//    [SecurityCritical] 
    ...
    /*internal*/ public static void EnableKeyboardCues(DependencyObject element, boolean enable)
    { 
    ...
    /*internal*/ public static FocusNavigationDirection KeyToTraversalDirection(Key key) 
    {
        switch (key) 
        { 
            case Key.Left:
    ...
    /*internal*/ public DependencyObject PredictFocusedElement(DependencyObject sourceElement, FocusNavigationDirection direction) 
    { 
        return PredictFocusedElement(sourceElement, direction, /*treeViewNavigation*/ false);
    } 

    /*internal*/ public DependencyObject PredictFocusedElement(DependencyObject sourceElement, FocusNavigationDirection direction, boolean treeViewNavigation)
    {
        if (sourceElement == null) 
        {
            return null; 
        ...
        return GetNextInDirection(sourceElement, direction, treeViewNavigation);
    } 

    /*internal*/ public DependencyObject PredictFocusedElementAtViewportEdge( 
        DependencyObject sourceElement, 
        FocusNavigationDirection direction,
        boolean treeViewNavigation, 
    ...
    /*internal*/ public boolean Navigate(DependencyObject sourceElement, Key key, ModifierKeys modifiers)
    { 
...
//    #region Tree navigation 
    ...
    private boolean IsInNavigationTree(DependencyObject visual)
    {
        UIElement uiElement = visual as UIElement; 
        if (uiElement != null && uiElement.IsVisible)
            return true; 

        if (visual instanceof IContentHost && !(visual instanceof MS.Internal.Documents.UIElementIsland))
            return true; 
    ...
    *        3   2
    ...
    private DependencyObject GetGroupParent(DependencyObject e, boolean includeCurrent)
    { 
...
//    #region Logical Navigation
    ...
    private boolean IsTabStop(DependencyObject e) 
    {
        FrameworkElement fe = e as FrameworkElement; 
        if (fe != null)
            return
                (fe.Focusable
                && (boolean)fe.GetValue(IsTabStopProperty)) 
                && fe.IsEnabled
                && fe.IsVisible; 

        FrameworkContentElement fce = e as FrameworkContentElement;
        return fce != null && fce.Focusable && (boolean)fce.GetValue(IsTabStopProperty) && fce.IsEnabled; 
    }

    private boolean IsGroup(DependencyObject e)
    { 
        return GetKeyNavigationMode(e) != KeyboardNavigationMode.Continue;
    } 

    /*internal*/ public boolean IsFocusableInternal(DependencyObject element)
    { 
    ...
    private boolean IsTabStopOrGroup(DependencyObject e)
    { 
...
//    #region Tab Navigation 
    ...
    /*internal*/ public DependencyObject GetFirstTabInGroup(DependencyObject container) 
    {
    ...
    private DependencyObject GetNextTab(DependencyObject e, DependencyObject container, boolean goDownOnly)
    {
        Debug.Assert(container != null, "container should not be null");
...
//    #region Shift+Tab Navigation 
    ...
    /*internal*/ public DependencyObject GetLastTabInGroup(DependencyObject container) 
    {
    ...
    private DependencyObject GetPrevTab(DependencyObject e, DependencyObject container, boolean goDownOnly)
    { 
...
//    #region Directional Navigation
    ...
    ///     not valid.
    /// </summary>
    /*internal*/ public static Rect GetRectangle(DependencyObject element)
    { 
    ...
    private boolean IsInDirection(Rect fromRect, Rect toRect, FocusNavigationDirection direction)
    { 
        switch (direction)
        { 
            case FocusNavigationDirection.Right: 
    ...
    private boolean IsFocusScope(DependencyObject e)
    { 
        return FocusManager.GetIsFocusScope(e) || GetParent(e) == null;
    } 

    private boolean IsAncestorOf(DependencyObject sourceElement, DependencyObject targetElement)
    { 
    ...
    /*internal*/ public boolean IsAncestorOfEx(DependencyObject sourceElement, DependencyObject targetElement)
    { 
    ...
    private boolean IsInRange(DependencyObject sourceElement, DependencyObject targetElement, Rect sourceRect, Rect targetRect, FocusNavigationDirection direction, double startRange, double endRange)
    { 
        switch (direction)
        { 
            case FocusNavigationDirection.Right : 
    ...
    private DependencyObject GetNextInDirection(DependencyObject sourceElement, FocusNavigationDirection direction, boolean treeViewNavigation)
    { 
        _containerHashtable.Clear();
        DependencyObject targetElement = MoveNext(sourceElement, null, direction, BASELINE_DEFAULT, BASELINE_DEFAULT, treeViewNavigation);
    ...
    private boolean IsEndlessLoop(DependencyObject element, DependencyObject container)
    { 
    ...
    private void ResetBaseLines(double value, boolean horizontalDirection)
    { 
        ...
        boolean treeViewNavigation) 
    {
        ...
        boolean searchInsideContainer = sourceElement == null;
        DependencyObject currElement = container; 
        while ((currElement = GetNextInTree(currElement, container)) != null)
        { 
                ...
                (treeViewNavigation && IsFocusableInternal(currElement)))) 
            {
                ...
                {
                    boolean isInDirection = IsInDirection(sourceRect, currentRect, direction);
                    boolean isInRange = IsInRange(sourceElement, currElement, sourceRect, currentRect, direction, startRange, endRange); 
    ...
    { 
        ...
        Rect sourceRect = GetRectangle(searchInsideContainer ? container 
                                        ...
                                        : sourceElement);
        boolean horizontalDirection = direction == FocusNavigationDirection.Right || direction == FocusNavigationDirection.Left;
        ...
        if (mode == KeyboardNavigationMode.Once && !searchInsideContainer) 
            return MoveNext(container, null, direction, startRange, endRange, treeViewNavigation);

        DependencyObject result = FindNextInDirection(sourceElement, sourceRect, container, direction, startRange, endRange, treeViewNavigation);
        ...
        if (result == null) 
        {
            ...
            { 
                case /*KeyboardNavigationMode.*/Cycle:
                    return MoveNext(null, container, direction, startRange, endRange, treeViewNavigation); 
        ...
        // Try to find focus inside the element
        // result is not TabStop, which means it is a group
        DependencyObject insideElement = MoveNext(null, result, direction, startRange, endRange, treeViewNavigation); 
        if (insideElement != null)
            return insideElement; 

        return MoveNext(result, null, direction, startRange, endRange, treeViewNavigation);
    } 

    private DependencyObject GetActiveElementChain(DependencyObject element, boolean treeViewNavigation)
    {
...
//    [SecurityCritical] 
    private void ProcessForMenuMode(InputEventArgs inputEventArgs)
    {
        ...
        // raise the (/*internal*/ public) EnterMenuMode event.
    ...
    private boolean IsMenuKey(Key key)
    { 
    ...
    /// </SecurityNote> 
//    [SecurityCritical,SecurityTreatAsSafe] 
    private boolean OnEnterMenuMode(Object eventSource)
    { 
        if (_weakEnterMenuModeHandlers == null)
            return false;

        /*lock*/synchronized (_weakEnterMenuModeHandlers) 
        {
    ...
    /// </SecurityNote> 
    /*internal*/ public /*event*/ EnterMenuModeEventHandler EnterMenuMode 
    {
//        [SecurityCritical,SecurityTreatAsSafe] 
        add
        {
    ...
    /*internal*/ public /*delegate*/ boolean EnterMenuModeEventHandler(Object sender, EventArgs e); 
    ...
    private boolean _win32MenuModeWorkAround; 
    ...
    private void ProcessForUIState(InputEventArgs inputEventArgs) 
    {
        ...
        { 
            ...
            { 
                ...
                boolean enable = (report.Action == RawUIStateActions.Clear); 
...
//    #region FocusEnterMainFocusScope weak event
    ...
    /*internal*/ public /*event*/ EventHandler FocusEnterMainFocusScope 
    { 
        add
        { 
...
//    #region Data
    ...
    private /*const*/static final double BASELINE_DEFAULT = Double.MinValue; 
...
//    #region WeakReferenceList 
    ...
    private class WeakReferenceList extends DispatcherObject 
    {
        ...
        public void Process(Func<Object, Boolean> action)
        {
            boolean hasDeadEntries = false;
            for (int i=0;  i<_list.Count;  ++i) 
            {
