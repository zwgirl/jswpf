...
// Helper class for working with IInputElement objects.
    /*internal*/ public /*static*/ class InputElement 
    {
        // Return whether the InputElement is one of our types. 
        /*internal*/ public static boolean IsValid(IInputElement e) 
        {
            DependencyObject o = e as DependencyObject; 
            return IsValid(o);
        }

        /*internal*/ public static boolean IsValid(DependencyObject o) 
        {
        ...
        /*internal*/ public static DependencyObject GetContainingUIElement(DependencyObject o, boolean onlyTraverse2D)
        { 
            ...
            if(o != null) 
            {
                ...
                else if ((v = o asorg.summer.view.widget.media.Visual) != null)
                {
        ...
        // Returns the containing input element of the given DynamicObject.
        /*internal*/ public static DependencyObject GetContainingUIElement(DependencyObject o) 
        { 
        ...
        // Returns the containing input element of the given DynamicObject.
        // If onlyTraverse2D is set to true, then we stop once we see a 3D Object and return null 
        /*internal*/ public static IInputElement GetContainingInputElement(DependencyObject o, boolean onlyTraverse2D)
        { 
        ...
        // Returns the containing input element of the given DynamicObject.
        //
        /*internal*/ public static IInputElement GetContainingInputElement(DependencyObject o)
        { 
            return GetContainingInputElement(o, false);
        } 
 
        // Returns the containing visual of the given DynamicObject.
        /*internal*/ public static DependencyObject GetContainingVisual(DependencyObject o) 
        {
        ...
        /*internal*/ public static DependencyObject GetRootVisual(DependencyObject o)
        { 
            return GetRootVisual(o, true /* enable2DTo3DTransition */);
        } 
 
        /*internal*/ public static DependencyObject GetRootVisual(DependencyObject o, boolean enable2DTo3DTransition)
        { 
            ...
            while(rootVisual != null && ((parentVisual = VisualTreeHelper.GetParent(rootVisual)) != null)) 
            {
                ...
                if (!enable2DTo3DTransition &&
                     rootVisual instanceof Visual && parentVisual instanceof Visual3D) 
...
//        [SecurityCritical,SecurityTreatAsSafe] 
        /*internal*/ public static Point TranslatePoint(Point pt, DependencyObject from, DependencyObject to)
        {
        ...
        /// </SecurityNote>
//        [SecurityCritical,SecurityTreatAsSafe]
        /*internal*/ public static Point TranslatePoint(Point pt, DependencyObject from, DependencyObject to, /*out*/ boolean translated) 
        {
            translated = false; 
            ...
            if(vFrom != null && rootFrom != null) 
            {
                ...
                { 
                    ...
                    { 
                        ...
                        boolean isDownSimple = vToAsVisual.TrySimpleTransformToAncestor(rootTo,
                                                                                     true, /* apply inverse */ 
                                                                                     /*out*/ gDown,
                                                                                     /*out*/ mDown);
