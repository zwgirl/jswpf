...
//    #region Protected Methods
    ...
    {
        boolean result1 = super.Purge(source, data, purgeAll); 
        EnsureAccessToCommandManagerSources();
        boolean result2 = _commandManagerSources.Purge();
    ...
    /*internal*/ public static boolean IsSourceDelegatingToCommandManager(EventHandler handler) 
    {
...
//    #region Private Methods 
    ...
    private void OnRequerySuggested(Object sender, EventArgs args)
    {
        try 
        {
            ...
            for/*each*/ (Object source : _commandManagerSources) 
            {
...
//    #region SourceTable
    ...
    private class SourceTable implements IEnumerable 
    {
        ...
        private class WeakEnumerator implements IEnumerator, IDisposable
        { 
            /*internal*/ public WeakEnumerator(Dictionary<WeakRefKey, Object> table)
            {
        ...
        private class WeakRefKey 
        {
            ...
            /*internal*/ public WeakRefKey(Object target)
            { 
