...
import org.summer.view.widget.internal.DeferredElementTreeState;
...
/// <summary>
    ...
    /// </summary> 
    public abstract class MouseDevice extends InputDevice
    { 
        /// <SecurityNote> 
...
//       [SecurityCritical,SecurityTreatAsSafe] 
       /*internal*/ public MouseDevice(InputManager inputManager)
       { 
        ...
        ///     The state of the specified mouse button
        /// </returns>
        /*internal*/ public abstract MouseButtonState GetButtonStateFromSystem(MouseButton mouseButton); 
        ...
        /// </SecurityNote> 
//        [SecurityCritical, SecurityTreatAsSafe] 
        /*internal*/ public Point GetScreenPositionFromSystem()
        { 
...
//                 VerifyAccess();
        ...
        /// </summary>
//        [FriendAccessAllowed]
        /*internal*/ public IInputElement RawDirectlyOver
        { 
            get
            { 
...
//                #pragma warning suppress 6506 // ce is obviosuly not null 
            ...
            else if (element instanceof UIElement3D)
            {
...
//             VerifyAccess();
        ...
        /// <summary> 
        /// </summary>
        /*internal*/ public void ReevaluateMouseOver(DependencyObject element, DependencyObject oldParent, boolean isCoreParent) 
        { 
            if (element != null)
            { 
                if (isCoreParent)
        ...
        { 
            ...
            {
                UIElement.MouseOverProperty.OnOriginValueChanged(_mouseOver instanceof DependencyObject ? _mouseOver : null, 
                		_mouseOver instanceof DependencyObject ? _mouseOver : null, /*ref*/ _mouseOverTreeState); 
            }
        ...
        private boolean ValidateUIElementForCapture(UIElement element)
        { 
        ...
        private boolean ValidateUIElement3DForCapture(UIElement3D element)
        { 
            if (element.IsEnabled == false)
                return false;
        ...
        private boolean ValidateContentElementForCapture(ContentElement element)
        { 
            if (element.IsEnabled == false) 
                return false;
...
//             VerifyAccess(); 
        ...
        /// </Securitynote>
//        [SecurityCritical,SecurityTreatAsSafe] 
        private boolean UpdateCursorPrivate()
        {
            int timeStamp = Environment.TickCount;
...
//        [SecurityCritical,SecurityTreatAsSafe]
        private void ChangeMouseOver(IInputElement mouseOver, int timestamp) 
        {
            ...
            if (_mouseOver != mouseOver) 
            {
                ...
                // set correctly. 
                UIElement.MouseOverProperty.OnOriginValueChanged(oldMouseOver instanceof DependencyObject ? oldMouseOver : null, 
                		_mouseOver instanceof DependencyObject ? _mouseOver : null, /*ref*/ _mouseOverTreeState); 
                ...
                if (!inputReportEventArgs.Handled && inputReportEventArgs.Report.Type == InputType.Mouse) 
                {
                    ...
                    { 
                        ...
                        if ((rawMouseInputReport.Actions & RawMouseActions.AbsoluteMove) == RawMouseActions.AbsoluteMove) //
                        {
                            ...
                            boolean mouseOverAvailable = false; 
                            Point ptClient = new Point(rawMouseInputReport.X, rawMouseInputReport.Y);
                            ...
                            boolean isPhysicallyOver = _isPhysicallyOver;
                            boolean isGlobalChange = ArePointsClose(ptClient, _lastPosition) == false;  // determine if the mouse actually physically moved 
                            ...
                            boolean isMouseOverChange = mouseOver != _mouseOver;
                            ...
                            // we are over.
                            // 
                            boolean isLocalChange = isMouseOverChange || ArePointsClose(ptRelativeToOver, _positionRelativeToOver) == false;
...
//                            #endif
        ...
        /*internal*/ public static IInputElement GlobalHitTest(boolean clientUnits, Point pt, PresentationSource inputSource)
        { 
        ...
        /*internal*/ public static IInputElement GlobalHitTest(Point ptClient, PresentationSource inputSource)
        { 
        ...
        /// </SecurityNote> 
//        [SecurityCritical,SecurityTreatAsSafe]
        private static void GlobalHitTest(boolean clientUnits, Point pt, PresentationSource inputSource, /*out*/ IInputElement enabledHit, /*out*/ IInputElement originalHit) 
        {
        ...
        /*internal*/ public static IInputElement LocalHitTest(boolean clientUnits, Point pt, PresentationSource inputSource)
        {
            IInputElement enabledHit; 
            IInputElement originalHit;
        ...
        /*internal*/ public static IInputElement LocalHitTest(Point ptClient, PresentationSource inputSource)
        {
        ...
        /// </SecurityNote>
//        [SecurityCritical,SecurityTreatAsSafe] 
        private static void LocalHitTest(boolean clientUnits, Point pt, PresentationSource inputSource, /*out*/ IInputElement enabledHit, /*out*/ IInputElement originalHit)
        { 
            enabledHit = originalHit = null; 
        ...
        /*internal*/ public boolean IsSameSpot(Point newPosition, StylusDevice stylusDevice) 
        {
        ...
        /*internal*/ public int CalculateClickCount(MouseButton button, int timeStamp, StylusDevice stylusDevice, Point downPt)
        { 
            ...
            // Is the delta coordinates of this click close enough to the last click?
            boolean isSameSpot = IsSameSpot(downPt, stylusDevice); 

            // Is this the same mouse button as the last click? 
            boolean isSameButton = (_lastButton == button); 
        ...
        /*internal*/ public Point PositionRelativeToOver 
        { 
            get
            { 
        ...
        /*internal*/ public Point NonRelativePosition
        { 
            get 
            {
        ...
        /// </SecurityNote> 
        /*internal*/ public boolean IsActive
        { 
//            [SecurityCritical, SecurityTreatAsSafe]
            get
            {
        ...
        /*internal*/ public StylusDevice StylusDevice
        { 
            get 
            {
        ...
        private boolean _isPhysicallyOver; 
        ...
        private boolean _forceUpdateLastPosition = false;
