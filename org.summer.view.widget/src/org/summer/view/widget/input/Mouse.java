...
public /*static*/ class Mouse
{
    ...
    ///     PreviewMouseMove 
    /// </summary>
    public static final RoutedEvent PreviewMouseMoveEvent = EventManager.RegisterRoutedEvent("PreviewMouseMove", RoutingStrategy.Tunnel, typeof(MouseEventHandler), typeof(Mouse)); 
    ...
    ///     MouseMove
    /// </summary>
    public static final RoutedEvent MouseMoveEvent = EventManager.RegisterRoutedEvent("MouseMove", RoutingStrategy.Bubble, typeof(MouseEventHandler), typeof(Mouse)); 
    ...
    /// </summary>
    public static final RoutedEvent PreviewMouseDownOutsideCapturedElementEvent = EventManager.RegisterRoutedEvent("PreviewMouseDownOutsideCapturedElement", RoutingStrategy.Tunnel, typeof(MouseButtonEventHandler), typeof(Mouse));
    ...
    /// </summary>
    public static final RoutedEvent PreviewMouseUpOutsideCapturedElementEvent = EventManager.RegisterRoutedEvent("PreviewMouseUpOutsideCapturedElement", RoutingStrategy.Tunnel, typeof(MouseButtonEventHandler), typeof(Mouse)); 
    ...
    ///     PreviewMouseDown
    /// </summary> 
    public static final RoutedEvent PreviewMouseDownEvent = EventManager.RegisterRoutedEvent("PreviewMouseDown", RoutingStrategy.Tunnel, typeof(MouseButtonEventHandler), typeof(Mouse)); 
    ...
    ///     MouseDown
    /// </summary> 
    public static final RoutedEvent MouseDownEvent = EventManager.RegisterRoutedEvent("MouseDown", RoutingStrategy.Bubble, typeof(MouseButtonEventHandler), typeof(Mouse));
    ...
    ///     PreviewMouseUp
    /// </summary>
    public static final RoutedEvent PreviewMouseUpEvent = EventManager.RegisterRoutedEvent("PreviewMouseUp", RoutingStrategy.Tunnel, typeof(MouseButtonEventHandler), typeof(Mouse));
    ...
    ///     MouseUp
    /// </summary> 
    public static final RoutedEvent MouseUpEvent = EventManager.RegisterRoutedEvent("MouseUp", RoutingStrategy.Bubble, typeof(MouseButtonEventHandler), typeof(Mouse));
    ...
    ///     PreviewMouseWheel 
    /// </summary> 
    public static final RoutedEvent PreviewMouseWheelEvent = EventManager.RegisterRoutedEvent("PreviewMouseWheel", RoutingStrategy.Tunnel, typeof(MouseWheelEventHandler), typeof(Mouse));
    ...
    ///     MouseWheel 
    /// </summary>
    public static final RoutedEvent MouseWheelEvent = EventManager.RegisterRoutedEvent("MouseWheel", RoutingStrategy.Bubble, typeof(MouseWheelEventHandler), typeof(Mouse)); 
    ...
    ///     MouseEnter
    /// </summary>
    public static final RoutedEvent MouseEnterEvent = EventManager.RegisterRoutedEvent("MouseEnter", RoutingStrategy.Direct, typeof(MouseEventHandler), typeof(Mouse)); 
    ...
    ///     MouseLeave 
    /// </summary>
    public static final RoutedEvent MouseLeaveEvent = EventManager.RegisterRoutedEvent("MouseLeave", RoutingStrategy.Direct, typeof(MouseEventHandler), typeof(Mouse));
    ...
    ///     GotMouseCapture 
    /// </summary>
    public static final RoutedEvent GotMouseCaptureEvent = EventManager.RegisterRoutedEvent("GotMouseCapture", RoutingStrategy.Bubble, typeof(MouseEventHandler), typeof(Mouse)); 
    ...
    ///     LostMouseCapture
    /// </summary> 
    public static final RoutedEvent LostMouseCaptureEvent = EventManager.RegisterRoutedEvent("LostMouseCapture", RoutingStrategy.Bubble, typeof(MouseEventHandler), typeof(Mouse)); 
    ...
    ///     QueryCursor
    /// </summary> 
    public static final RoutedEvent QueryCursorEvent = EventManager.RegisterRoutedEvent("QueryCursor", RoutingStrategy.Bubble, typeof(QueryCursorEventHandler), typeof(Mouse));
    ...
    ///     Returns the element that has captured the mouse.
    /// </summary>
    /*internal*/ public static CaptureMode CapturedMode
    { 
        get
        { 
...
//    [SecurityCritical]
    ...
    public static boolean SetCursor(Cursor cursor) 
    {
    ...
    ///     is reached. 
    /// </remarks>
    public /*const*/static final int MouseWheelDeltaForOneLine = 120; 
