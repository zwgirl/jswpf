...
/////////////////////////////////////////////////////////////////////////
    ...
    /// </summary> 
    public /*sealed*/ class StylusDevice extends InputDevice 
    {
        ///////////////////////////////////////////////////////////////////// 
...
//        [SecurityCritical,SecurityTreatAsSafe] 
        /*internal*/ public StylusDevice(TabletDevice tabletDevice, String sName, int id, boolean fInverted, StylusButtonCollection stylusButtonCollection)
        { 
...
//        [SecurityCritical]
        ...
        /// </SecurityNote>
        /*internal*/ public PresentationSource CriticalActiveSource 
        { 
            [SecurityCritical]
            get 
            {
        ...
        /// </SecurityNote> 
        /*internal*/ public PenContext ActivePenContext
        { 
            [SecurityCritical]
            get
            {
        ...
        /// </summary> 
        /*internal*/ public StylusPlugInCollection CurrentNonVerifiedTarget 
        {
            get 
            {
        ...
        ///     Returns the element that the stylus is over.
        /// </summary> 
        /*internal*/ public StylusPlugInCollection CurrentVerifiedTarget
        { 
            get 
            {
        ...
        ///     Returns the element that has captured the stylus. 
        /// </summary>
        /*internal*/ public CaptureMode CapturedMode
        {
            get 
            {
                return _captureMode; 
        ...
        /// </summary> 
        public boolean Capture(IInputElement element, CaptureMode captureMode)
        { 
        ...
        ///     Captures the stylus to a particular element.
        /// </summary>
        public boolean Capture(IInputElement element) 
        {
        ...
        /*internal*/ public StylusPlugInCollection GetCapturedPlugInCollection(ref boolean elementHasCapture)
        { 
...
//#if MULTICAPTURE 
        ...
        /// <summary> 
        /// </summary>
        /*internal*/ public void ReevaluateStylusOver(DependencyObject element, DependencyObject oldParent, boolean isCoreParent) 
        {
            if (element != null)
            {
                if (isCoreParent) 
...
//#else 
        /*internal*/ public void ChangeStylusCapture(IInputElement stylusCapture, CaptureMode captureMode, int timestamp) 
//#endif
        { 
...
//#if MULTICAPTURE
        /*internal*/ public void AttachToPropertiesAffectingCapture(IInputElement element)
        {
            // Adjust the handlers we use to track everything. 
            if (element != null)
            { 
        ...
        /*internal*/ public void DetachFromPropertiesAffectingCapture(IInputElement element)
        { 
            if (element != null) 
            {
                var o = element as DependencyObject; 
        ...
        /// <summary>
        /// </summary>
        /*internal*/ public void ReevaluateCapture(DependencyObject element, DependencyObject oldParent, boolean isCoreParent)
        { 
            if (element != null)
            { 
                if (isCoreParent) 
        ...
        private static boolean ValidateUIElementForCapture(UIElement element)
        { 
        ...
        private static boolean ValidateContentElementForCapture(ContentElement element)
        { 
            if (element.IsEnabled == false)
                return false;
        ...
        private static boolean ValidateUIElement3DForCapture(UIElement3D element) 
        {
            if (element.IsEnabled == false)
                return false;
        ...
        /// </SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe] 
        private boolean ValidateVisualForCapture(DependencyObject visual)
        {
            if (visual == null)
                return false; 
...
//#endif
        ...
        /// </SecurityNote> 
        [SecurityCritical,SecurityTreatAsSafe]
        /*internal*/ public void ChangeStylusOver(IInputElement stylusOver)
        {
...
//#endif 
        ...
        /// </SecurityNote> 
//        [SecurityCritical]
        /*internal*/ public IInputElement FindTarget(PresentationSource inputSource, Point position) 
        {
        ...
        /*internal*/ public static IInputElement LocalHitTest(PresentationSource inputSource, Point pt) 
        {
        ...
        /*internal*/ public static IInputElement GlobalHitTest(PresentationSource inputSource, Point pt) 
        { 
        ...
        public TabletDevice TabletDevice 
        {
            get 
            {
                ...
                // from the pen thread to get access to /*internal*/ public data.  The TabletDevice
...
//        [SecurityCritical]
        ...
        /// <returns></returns>
        /*internal*/ public Point GetRawPosition(IInputElement relativeTo) 
        {
        ...
        /*internal*/ public StylusPoint RawStylusPoint
        { 
        ...
        /// </SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe] 
        /*internal*/ public MouseButtonState GetMouseButtonState(MouseButton mouseButton, MouseDevice mouseDevice)
        { 
        ...
        ///     the Stylus system when we are processing Stylus events instead of Mouse events 
        /// </remarks>
        /*internal*/ public Point GetMouseScreenPosition(MouseDevice mouseDevice) 
        { 
            if (mouseDevice == null)
            { 
        ...
        /// <param name="relativeTo"></param>
        /// <ExternalAPI/> 
        /*internal*/ public static GeneralTransform GetElementTransform(IInputElement relativeTo)
        {
...
//        [SecurityCritical]
        ...
        /// </SecurityNote>
//        [SecurityCritical]
        /*internal*/ public void UpdateEventStylusPoints(RawStylusInputReport report, boolean resetIfNoOverride) 
        {
        ...
        /// </SecurityNote>
        /*internal*/ public int DoubleTapDeltaTime 
        {
//            [SecurityCritical, SecurityTreatAsSafe]
        ...
        /// </SecurityNote>
//        [SecurityCritical]
        /*internal*/ public void UpdateState(RawStylusInputReport report)
        { 
...
//        [SecurityCritical]
        ...
        /// </SecurityNote> 
//        [SecurityCritical] 
        /*internal*/ public void UpdateInRange(boolean inRange, PenContext penContext)
        { 
            _fInRange = inRange;
        ...
        /// </SecurityNote>
//        [SecurityCritical] 
        /*internal*/ public void UpdateStateForSystemGesture(RawStylusSystemGestureInputReport report)
        {
...
//        [SecurityCritical]
        ...
        /// </SecurityNote>
//        [SecurityCritical]
        /*internal*/ public void PlayBackCachedDownInputReport(int timestamp) 
        {
        ...
        /// </SecurityNote> 
//        [SecurityCritical]
        /*internal*/ public PresentationSource GetMousePresentationSource() 
        {
        ...
        /// </SecurityNote>
//        [SecurityCritical] 
        /*internal*/ public RawMouseActions GetMouseActionsFromStylusEventAndPlaybackCachedDown(RoutedEvent stylusEvent, StylusEventArgs stylusArgs)
        {
        ...
        /*internal*/ public Point LastMouseScreenPoint
        { 
            get { return _lastMouseScreenLocation; } 
            set { _lastMouseScreenLocation = value; }
        } 

        /*internal*/ public boolean SeenDoubleTapGesture
        {
            get { return _seenDoubleTapGesture; } 
            set { _seenDoubleTapGesture = value; }
        } 
 
        /*internal*/ public boolean SeenHoldEnterGesture
        { 
            get { return _seenHoldEnterGesture; }
        }

        /*internal*/ public boolean GestureWasFired 
        {
            get { return _fGestureWasFired;} 
        } 

        /*internal*/ public boolean SentMouseDown 
        {
            get { return _promotedMouseState == MouseButtonState.Pressed;}
        }
 
        /*internal*/ public boolean DetectedDrag
        { 
            get { return _fDetectedDrag; } 
        }
 
        /*internal*/ public boolean LeftIsActiveMouseButton
        {
            get { return _fLeftButtonDownTrigger; }
        } 

        /*internal*/ public void SetSawMouseButton1Down(boolean sawMouseButton1Down) 
        { 
            _sawMouseButton1Down = sawMouseButton1Down;
        } 

        /*internal*/ public boolean IgnoreStroke
        {
...
//        #region Touch
        ...
        /*internal*/ public StylusTouchDevice TouchDevice
        {
            get
            { 
        ...
        /// </SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe] 
        /*internal*/ public void UpdateTouchActiveSource()
        {
            if (_touchDevice != null)
            { 
...
//#endif 
        ...
        boolean          _needToSendMouseDown;
        private Point _lastMouseScreenLocation = new Point(0,0); 
        private Point _lastScreenLocation = new Point(0,0);
 
        boolean                    _fInAir = true; 
        boolean                    _fLeftButtonDownTrigger = true; // default to left button down
        boolean                    _fGestureWasFired = true; // StylusDown resets this. 
        boolean                    _fBlockMouseMoveChanges; // StylusDown sets to true, SystemGesture & StylusUp sets to false.
        boolean                    _fDetectedDrag; // StylusDown resets this.  Used for generating DoubleTap gestures.
        ...
        private boolean _lastTapBarrelDown;

        private boolean _seenDoubleTapGesture; 
        private boolean _seenHoldEnterGesture;
 
        private boolean _sawMouseButton1Down; // Did we see the mouse down before the stylus down? 
        private boolean _ignoreStroke; // Should we ignore promoting the stylus/mouse events for the current stroke?
