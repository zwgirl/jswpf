...
//        [SecurityCritical,SecurityTreatAsSafe]
        ...
        /*internal*/ public IInputElement ForceTarget
        { 
            get 
            {
...
//        [SecurityCritical] 
        public IInputElement Focus(IInputElement element)
        {
            ...
            boolean forceToNullIfFailed = false; 
...
//                    #pragma warning suppress 6506 // element is obviously not null
        ...
        /// </SecurityNote> 
//        [SecurityCritical,SecurityTreatAsSafe]
        private void Focus(DependencyObject focus, boolean askOld, boolean askNew, boolean forceToNullIfFailed) 
        {
...
//                 VerifyAccess();
        ...
        /// </summary>
        private boolean IsKeyDown_private(Key key)
        { 
...
//             VerifyAccess(); 
        ...
        /// </SecurityNote>
        /*internal*/ public TextServicesManager TextServicesManager 
        { 
//           [SecurityCritical,SecurityTreatAsSafe]
           get 
           {
       ...
       ///     Critical:This entity is not safe to give out 
       /// </SecurityNote>
       /*internal*/ public TextCompositionManager TextCompositionManager
        {
//           [SecurityCritical,SecurityTreatAsSafe] 
           get
           { 
        ...
        /// </SecurityNote> 
//        [SecurityCritical,SecurityTreatAsSafe]
        private void TryChangeFocus(DependencyObject newFocus, IKeyboardInputProvider keyboardInputProvider, boolean askOld, boolean askNew, boolean forceToNullIfFailed) 
        {
            ...
            { 
                ...
                // InputProvider has acquired it, go ahead and change our /*internal*/ public 
...
//        [SecurityCritical,SecurityTreatAsSafe]
        ...
        /// </remarks> 
        /*internal*/ public void ReevaluateFocusAsync(DependencyObject element, DependencyObject oldParent, boolean isCoreParent) 
        {
            if(element != null) 
            {
                if(isCoreParent)
        ...
        private void PostProcessInput(Object sender, ProcessInputEventArgs e) 
        {
            ...
            if(e.StagingItem.Input.RoutedEvent == Keyboard.PreviewKeyDownEvent)
            {
                ...
                { 
                    ...
                    boolean isSystemKey = false;
                    boolean isImeProcessed = false;
                    boolean isDeadCharProcessed = false;
...
//        [SecurityCritical]
        ...
        private boolean CheckForDisconnectedFocus() 
        {
        ...
        { 
            /*internal*/ public ScanCode(int code, boolean isExtended) 
            {
                _code = code; 
                _isExtended = isExtended;
            }

            /*internal*/ public int Code {get {return _code;}} 
            /*internal*/ public boolean IsExtended {get {return _isExtended;}}
