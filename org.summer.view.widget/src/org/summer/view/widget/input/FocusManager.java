...
//        #region Public Events
        ...
        ///     GotFocus event 
        /// </summary> 
        public static final RoutedEvent GotFocusEvent = EventManager.RegisterRoutedEvent("GotFocus", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(FocusManager));
        ...
        ///     LostFocus event 
        /// </summary>
        public static final RoutedEvent LostFocusEvent = EventManager.RegisterRoutedEvent("LostFocus", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(FocusManager)); 
...
//        #region FocusedElement property
        ...
        /// Default Value:      null
        /// </summary>
        public static final DependencyProperty FocusedElementProperty =
...
//        #region IsFocusScope Property
        ...
        ///     Default Value:      false 
        /// </summary>
        public static final DependencyProperty IsFocusScopeProperty
            = DependencyProperty.RegisterAttached("IsFocusScope", typeof(Boolean), typeof(FocusManager),
...
//        [SecurityCritical, SecurityTreatAsSafe] 
        /*internal*/ public static IInputElement GetFocusedElement(DependencyObject element, boolean validate)
        { 
            if (element == null)
            {
        ...
        public static boolean GetIsFocusScope(DependencyObject element) 
        {
            ...
            return (boolean)element.GetValue(IsFocusScopeProperty); 
        }
...
// 
        ...
        private static void OnFocusedElementChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) 
        {
            ...
            if (newVisual != null)
            {
                ...
                newVisual.SetValue(UIElement.IsFocusedPropertyKey, true);
...
*/
        ...
        private static DependencyObject _GetFocusScope(DependencyObject d) 
        {
            ...
            if ((boolean)d.GetValue(IsFocusScopeProperty))
                return d; 
...
//        #region private data 
        ...
        private static final UncommonField<Boolean> IsFocusedElementSet = new UncommonField<Boolean>(); 
        private static final UncommonField<WeakReference> FocusedElementWeakCacheField = new UncommonField<WeakReference>(); 
        private static final UncommonField<Boolean> IsFocusedElementCacheValid = new UncommonField<Boolean>();
        private static final UncommonField<WeakReference> FocusedElementCache = new UncommonField<WeakReference>(); 

//        private static boolean _currentlyUpdatingTree = false;
