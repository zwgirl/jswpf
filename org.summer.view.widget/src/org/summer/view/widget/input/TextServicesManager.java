...
/*internal*/ public class TextServicesManager extends DispatcherObject
    { 
        //-----------------------------------------------------
        //
        //  Constructors
...
//        [SecurityCritical, SecurityTreatAsSafe]
        /*internal*/ public TextServicesManager(InputManager inputManager) 
        {
...
//        #endregion Constructors
        ...
        /*internal*/ public void Focus(DependencyObject focus) 
        {
            if (focus == null)
            {
            ...
            if ((boolean)focus.GetValue(InputMethod.IsInputMethodSuspendedProperty)) 
            {
            ...
            InputMethod.Current.EnableOrDisableInputMethod((boolean)focus.GetValue(InputMethod.IsInputMethodEnabledProperty));
        }
...
//        [SecurityCritical]
        ...
        { 
            ...
            if ((element == null) || (boolean)element.GetValue(InputMethod.IsInputMethodSuspendedProperty))
            { 
                // The focus is on the element that suspending IME's input (such as menu).
        ...
        /// </SecurityNote> 
//        [SecurityCritical]
        private boolean TextServicesKeystroke(TextServicesContext context, KeyEventArgs keyArgs, boolean test)
        {
