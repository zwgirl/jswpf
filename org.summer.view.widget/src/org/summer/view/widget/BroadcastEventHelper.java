...
{ 
    ...
    {
//        Debug.Assert(d instanceof FrameworkElement || d instanceof FrameworkContentElement);
...
//            Debug.Assert(unloadedPending.length == 3); 
    ...
    /*internal*/ static Object BroadcastLoadedEvent(Object root) 
    {
        ...
        boolean isLoaded = IsLoadedHelper(rootDO);
    ...
    /*internal*/ static void BroadcastLoadedSynchronously(DependencyObject rootDO, boolean isLoaded) 
    {
    ...
    /*internal*/ static void BroadcastUnloadedSynchronously(DependencyObject rootDO, boolean isLoaded)
    {
    ...
    private class BroadcastEventData
    { 
    ...
    private static boolean OnBroadcastCallback(DependencyObject d, BroadcastEventData data, boolean visitedViaVisualTree) 
    { 
    ...
    private static boolean SubtreeHasLoadedChangeHandlerHelper(DependencyObject d) 
    {
        if (FrameworkElement.DType.IsInstanceOfType(d)) 
        { 
    ...
    private static boolean IsLoadedHelper(DependencyObject d)
    { 
    ...
    /*internal*/ static boolean IsParentLoaded(DependencyObject d) 
    {
        FrameworkObject     fo      = new FrameworkObject(d); 
        ...
        else if ((visual = d asorg.summer.view.widget.media.Visual) != null) 
        { 
    ...
    /*internal*/ static void AddOrRemoveHasLoadedChangeHandlerFlag( 
        ...
        DependencyObject newParent)
    { 
        boolean hasLoadChangedHandler = SubtreeHasLoadedChangeHandlerHelper(d);
    ...
    ///     Node 
    /// </param>
    private static boolean AreThereLoadedChangeHandlersInSubtree(/*ref*/ FrameworkObject fo) 
    { 
        ...
        for/*each*/(Object o : LogicalTreeHelper.GetChildren(fo.DO))
        { 
    ...
    /// </param>
    private static void UpdateHasLoadedChangeHandlerFlagInAncestry(DependencyObject d, boolean addHandler) 
    {
        FrameworkObject fo = new FrameworkObject(d);
        ...
        else  // neither a FE or an FCE 
        {
            ...
            // Propagate the change to your visual ancestry
            if ((v = d asorg.summer.view.widget.media.Visual) != null) 
            {
