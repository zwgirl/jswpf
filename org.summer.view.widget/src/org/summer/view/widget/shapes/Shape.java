...
//        [CommonDependencyProperty] 
        public static final DependencyProperty FillProperty = 
                DependencyProperty.Register(
                        "Fill", 
                        typeof(Brush),
                        typeof(Shape),
...
//        [TypeConverter(typeof(LengthConverter))]
        ...
        /// </summary>
        public static final DependencyProperty StrokeStartLineCapProperty  = 
                DependencyProperty.Register( 
                        "StrokeStartLineCap",
                        typeof(PenLineCap), 
                        typeof(Shape),
        ...
        /// </summary>
        public static final DependencyProperty StrokeEndLineCapProperty =
                DependencyProperty.Register( 
                        "StrokeEndLineCap",
                        typeof(PenLineCap), 
                        typeof(Shape), 
        ...
        /// </summary>
        public static final DependencyProperty StrokeDashCapProperty = 
                DependencyProperty.Register(
                        "StrokeDashCap",
                        typeof(PenLineCap),
                        typeof(Shape), 
        ...
        /// </summary> 
        public static final DependencyProperty StrokeLineJoinProperty =
                DependencyProperty.Register( 
                        "StrokeLineJoin", 
                        typeof(PenLineJoin),
                        typeof(Shape), 
        ...
        /// </summary> 
        public static final DependencyProperty StrokeMiterLimitProperty =
                DependencyProperty.Register(
                        "StrokeMiterLimit",
                        typeof(double), 
                        typeof(Shape),
        ...
        /// </summary> 
        public static final DependencyProperty StrokeDashOffsetProperty =
                DependencyProperty.Register( 
                        "StrokeDashOffset", 
                        typeof(double),
                        typeof(Shape), 
        ...
        /// </summary>
        public static final DependencyProperty StrokeDashArrayProperty = 
                DependencyProperty.Register(
                        "StrokeDashArray",
...
//        #region Internal Methods 
        ...
        /*internal*/ public boolean SizeIsInvalidOrEmpty(Size size)
        { 
        ...
        /*internal*/ public boolean IsPenNoOp 
        { 
            get
            { 
        ...
        /*internal*/ public double GetStrokeThickness() 
        { 
            if (IsPenNoOp)
            { 
                return 0;
        ...
        /*internal*/ public Pen GetPen()
        {
            ...
            { 
                ...
                // This pen is /*internal*/ public to the system and 
        ...
        /*internal*/ public static boolean IsDoubleFiniteNonNegative(object o) 
        { 
            double d = (double)o;
            return !(Double.IsInfinity(d) || DoubleUtil.IsNaN(d) || d < 0.0); 
        }
        /*internal*/ public static boolean IsDoubleFinite(object o)
        {
            double d = (double)o; 
            return !(Double.IsInfinity(d) || DoubleUtil.IsNaN(d));
        } 
        /*internal*/ public static boolean IsDoubleFiniteOrNaN(object o) 
        {
            double d = (double)o; 
            return !(Double.IsInfinity(d));
        }

        /*internal*/ public /*virtual*/ void CacheDefiningGeometry() {} 

        /*internal*/ public Size GetStretchedRenderSize(Stretch mode, double strokeThickness, Size availableSize, Rect geometryBounds) 
        { 
        ...
        /*internal*/ public Size GetStretchedRenderSizeAndSetStretchMatrix(Stretch mode, double strokeThickness, Size availableSize, Rect geometryBounds)
        { 
            double xScale, yScale, dX, dY;
            Size renderSize;
        ...
        /*internal*/ public void ResetRenderedGeometry() 
        {
            // reset rendered geometry
            _renderedGeometry = null;
        } 

        /*internal*/ public void GetStretchMetrics(Stretch mode, double strokeThickness, Size availableSize, Rect geometryBounds, 
                                             out double xScale, out double yScale, out double dX, out double dY, out Size stretchedSize) 
        {
            if (!geometryBounds.IsEmpty) 
            {
                ...
                boolean hasThinDimension = false;
        ...
        /// </summary>
        /*internal*/ public /*virtual*/ Size GetNaturalSize()
        {
        ...
        /// </summary>
        /*internal*/ public /*virtual*/ Rect GetDefiningGeometryBounds() 
        { 
            Geometry geometry = DefiningGeometry;
        ...
        /*internal*/ public void EnsureRenderedGeometry() 
        { 
