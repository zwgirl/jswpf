...
import org.summer.view.widget.utils.FrugalMapBase;
import org.summer.view.widget.utils.FrugalMapIterationCallback;
import org.summer.view.widget.utils.HashObjectMap;
import org.summer.view.widget.utils.SingleObjectMap;
...
/// <summary>
    ...
    { 
        ...
        /// </summary>
        boolean UsingDefaultValueFactory 
        { 
            get
            { 
                return _defaultValue instanceof DefaultValueFactory;
            }
        }
...
//            Debug.Assert(!(result instanceof DispatcherObject) || ((DispatcherObject)result).Dispatcher == owner.Dispatcher);
        ...
        ///
        ///     This is so it can be accessed by subclasses of 
        ///     DefaultValueFactory.
        /// </summary>
        void ClearCachedDefaultValue(DependencyObject owner, DependencyProperty property)
        { 
            FrugalMapBase map = _defaultValueFactoryCache.GetValue(owner);
            if (map.Count == 1) 
            { 
        ...
        static void PromoteAllCachedDefaultValues(DependencyObject owner) 
        {
            FrugalMapBase map = _defaultValueFactoryCache.GetValue(owner); 
        ...
        /// </summary> 
        /// <param name="owner"></param> 
        static void RemoveAllCachedDefaultValues(Freezable owner)
        { 
            FrugalMapBase map = _defaultValueFactoryCache.GetValue(owner);
        ...
        { 
            Freezable cachedDefault = (Freezable) (value instanceof Freezable ? value : null);
        ...
        /// </remarks>
//        [FriendAccessAllowed] // Built into Base, also used by Framework. 
        GetReadOnlyValueCallback GetReadOnlyValueCallback
        { 
            get 
            {
                return null; 
...
//        [FriendAccessAllowed] // Currently used by Storyboard in PresentationFramework.
        FreezeValueCallback FreezeValueCallback 
        { 
            get
            { 
        ...
        private static boolean DefaultFreezeValueCallback( 
            DependencyObject d,
        ...
        // and then Merge
        // 
        PropertyMetadata Copy(DependencyProperty dp) {
...
// 
        ...
        void InvokeMerge(PropertyMetadata baseMetadata, DependencyProperty dp)
        {
        ...
        void Seal(DependencyProperty dp, Type targetType) 
        { 
            // CALLBACK
        ...
        boolean IsDefaultValueModified { get { return IsModified(MetadataFlags.DefaultValueModifiedID); } }
...
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
        MetadataFlags _flags;
 
        private void SetModified(MetadataFlags id) { _flags |= id; }
        private boolean IsModified(MetadataFlags id) { return (id & _flags) != 0; } 
 
        /// <summary>
        ///     Write a flag value 
        /// </summary>
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework.
        void WriteFlag(MetadataFlags id, boolean value)
        { 
            if (value)
            { 
                _flags |= id; 
        ...
        /// </summary>
//        [FriendAccessAllowed] // Built into Base, also used by Core and Framework. 
        boolean ReadFlag(MetadataFlags id) { return (id & _flags) != 0; }
...
//            [FriendAccessAllowed] // Built into Base, also used by Core.
        ...
        private static final UncommonField<FrugalMapBase> _defaultValueFactoryCache = new UncommonField<FrugalMapBase>();
    ...
    /// </summary>
//    [FriendAccessAllowed] // Built into Base, also used by Framework. 
//    /*delegate*/ Object GetReadOnlyValueCallback(DependencyObject d, /*out*/ BaseValueSourcesource); 