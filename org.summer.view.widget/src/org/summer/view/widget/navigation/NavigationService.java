...
import org.summer.view.widget.controls.Frame;
import org.summer.view.widget.controls.ScrollViewer;
import org.summer.view.widget.controls.WebBrowser;
import org.summer.view.widget.controls.primitives.ScrollBar;
import org.summer.view.widget.documents.Hyperlink;
...
/// <summary>
    ...
    public /*sealed*/ class NavigationService implements IContentContainer /*See comment above*/
    { 
//        #region Constructors
        ...
        /// </param>
        /*internal*/ public NavigationService(INavigator nav) 
        {
            INavigatorHost = nav; 
        ...
        static private boolean IsSameUri(Uri baseUri, Uri a, Uri b, boolean withFragment)
        { 
            ...
            boolean isSame = aResolved.Equals(bResolved);
        ...
        /// it will have to use the FragmentNavigation callback, raise an /*internal*/ public flag, and possibly 
        ...
        private void NavigateToFragmentOrCustomContentState(Uri uri, Object navState)
        {
            ...
            boolean targetElementExists = NavigateToFragment(fragmentName, !hasCustomContentState);
        ...
        private boolean NavigateToFragment(String elementId, boolean scrollToTopOnEmptyFragment)
        { 
            // 
        ...
        private boolean IsParentedByBrowserWindow()
        {
        ...
        boolean IsConsistent(NavigateInfo navInfo) 
        {
            return navInfo == null 
        ...
        private boolean IsJournalNavigation(NavigateInfo navInfo)
        {
            return navInfo != null && 
        ...
        private boolean RestoreRootViewerState(CustomJournalStateInternal rvs) 
        {
        ...
        /// </SecurityNote> 
        private boolean ShouldDelegateXamlViewerNavigationToBrowser(NavigateInfo navigateInfo, Uri resolvedUri)
        {
        ...
        /// <returns></returns>
        static /*internal*/ public INavigatorBase FindTargetInApplication(String targetName) 
        { 
        ...
        /*internal*/ public void InvalidateJournalNavigationScope()
        { 
        ...
        /*internal*/ public void OnParentNavigationServiceChanged()
        { 
        ...
        /*internal*/ public void AddChild(NavigationService ncChild) 
        {
        ...
        /*internal*/ public void RemoveChild(NavigationService ncChild) 
        {
        ...
        /*internal*/ public NavigationService FindTarget(Guid navigationServiceId)
        { 
        ...
        /*internal*/ public INavigatorBase FindTarget(String name)
        { 
        ...
        /*internal*/ public boolean IsContentKeepAlive() 
        {
            ...
            if (o != null)
            {
                ...
                if (keepAlive == false) 
                {
                    ...
                    boolean noUriToReloadFrom = !CanReloadFromUri;
        ...
        private boolean UnhookOldTree(Object oldTree) 
        {
            //------------------------------------------------------------------------------- 
            // 
            ...
            { 
                ...
                if (dobj != null && JournalScope != null) 
                {
                    ...
                    if (!((boolean) focusScope.GetValue(FocusManager.IsFocusScopeProperty)))
                    { 
        ...
        /// </returns>
        private boolean HookupNewTree(Object newTree, NavigateInfo navInfo, Uri newUri)
        { 
        ...
        private boolean OnBeforeSwitchContent(Object newBP, NavigateInfo navInfo, Uri newUri)
        { 
            Debug.Assert(IsConsistent(navInfo));
            ...
            boolean canDispose = UnhookOldTree(_bp);
        ...
        /// </summary>
        /*internal*/ public void VisualTreeAvailable(Visual v)
        {
...
*/
            ...
            if (PreBPReady != null) 
            { 
                // ok to pass resolved Uri here because this is /*internal*/ public
        ...
        /// </summary>
        /*internal*/ public static readonly DependencyProperty NavigationServiceProperty =
        ...
        //
        // boolean INavigator.Navigate(Uri source) 
        //
        /// <summary> 
        /// Navigate to source 
        /// </summary>
        ...
        // 
        // boolean INavigator.Navigate(UIElement bp) 
        //
        /// <summary> 
        /// Navigate to content tree.
        /// </summary>
        /// <value></value>
        public boolean Navigate(Object root) 
        {
        ...
        /// </summary>
        /// <value>returns boolean to indicate if a navigation was started i.e. Navigating event was not cancelled</value>
        public boolean Navigate(Uri source, Object navigationState) 
        {
        ...
        /// </summary>
        /// <value>returns boolean to indicate if a navigation was started i.e. Navigating event was not cancelled</value>
        public boolean Navigate(Uri source, Object navigationState, boolean sandboxExternalContent) 
        {
...
#pragma warning disable 6506  // Both source and navigationState can accept null as valid input. 
        /*internal*/ public boolean Navigate(Uri source, Object navigationState, boolean sandboxExternalContent, boolean navigateOnSourceChanged)
        { 
            if (IsDisposed) 
            {
                return false; 
...
#pragma warning restore 6506
        ...
        // 
        // boolean Navigate(Object root, Object navigationState)
        // 
        /// <summary> 
...
#pragma warning disable 6506  // Both root and navigationState can accept null as vaild input.
        public boolean Navigate(Object root, Object navigationState) 
        {
            if (IsDisposed) 
            { 
                return false;
...
#pragma warning restore 6506
        ...
        //
        // boolean INavigator.CanGoForward 
        // 
        /// <summary>
        ...
        /// </summary>
        private void DoStopLoading(boolean clearRecursiveNavigations, boolean fireEvents)
        {
...
#pragma warning restore 6502
        ...
        /// <summary> 
        /// Fires the Navigating event and returns a boolean to indicate whether a navigation is
        /// allowed or not 
        /// </summary> 
        ...
        /// <returns>boolean indicating whether the Navigating is allowed or not</returns>
        private boolean FireNavigating(Uri source, Object bp, Object navState, WebRequest request) 
        {
        ...
        private boolean HandleNavigating(Uri source, Object content, Object navState, WebRequest newRequest, boolean navigateOnSourceChanged)
        {
            NavigateInfo navigateInfo = navState as NavigateInfo;
        ...
        /// </SecurityNote> 
        [SecurityCritical, SecurityTreatAsSafe] 
        private void HandleNavigated(Object navState, boolean navigatedToNewContent)
        { 
            ...
            boolean handleContentLoadedEvent = false;
        ...
        private void FireLoadCompleted(boolean isNavInitiator, Object navState)
        {
...
//        #region FragmentNavigation Event 
        ...
        private boolean FireFragmentNavigation(String fragment)
        { 
...
*/
            ...
            boolean isNavInitiator = IsNavigationInitiator;
...
//        # endregion public method and property 
        ...
        /*internal*/ public void DoNavigate(Uri source, NavigationMode f, Object navState) 
        {
            /*
...
*/ 
        ...
        private boolean FireNavigationFailed(NavigationFailedEventArgs e) 
        {
        ...
        private WebRequest CreateWebRequest(Uri resolvedDestinationUri, NavigateInfo navInfo)
        {
            ...
            boolean isRefresh = navInfo == null ? false : navInfo.NavigationMode == NavigationMode.Refresh; 
        ...
        private boolean CanUseTopLevelBrowserForHTMLRendering()
        { 
        ...
        private void GetObjectFromResponse(WebRequest request, WebResponse response, Uri destinationUri, Object navState) 
        {
            ...
            try 
            {
                ...
                boolean sandBoxContent = SandboxExternalContent && (! BaseUriHelper.IsPackApplicationUri(destinationUri)) && MimeTypeMapper.XamlMime.AreTypeAndSubTypeEqual(contentType);
        ...
        private void DelegateToBrowser(boolean isPack, Uri destinationUri)
        {
            try
            { 
                if (isPack)
        ...
        /*internal*/ public void DoNavigate(Object bp, NavigationMode navFlags, Object navState) 
        {
            /* 
...
*/
        ...
        /// </summary> 
        /*internal*/ public JournalEntry MakeJournalEntry(JournalReason journalReason)
        { 
            if (_bp == null) 
            {
                return null; 
            ...
            boolean keepAlive = IsContentKeepAlive();
            PageFunctionBase pfBase = _bp as PageFunctionBase;
            if (pfBase != null) 
            {
                if (keepAlive) 
        ...
        /// </summary>
        /*internal*/ public void RequestCustomContentStateOnAppShutdown() 
        {
        ...
        /// </SecurityNote>
        [SecurityCritical, SecurityTreatAsSafe] 
        /*internal*/ public void CallUpdateTravelLog(boolean addNewEntry)
        {
        ...
        /// </summary> 
        /*internal*/ public Application Application
        {
            get { return Application.Current; }
        } 

        /*internal*/ public boolean AllowWindowNavigation 
        { 
            private get { return _allowWindowNavigation; }
            set { _allowWindowNavigation = value; } 
        }

        /*internal*/ public long BytesRead
        { 
            get { return _bytesRead; }
            set { _bytesRead = value; } 
        } 

        /*internal*/ public long MaxBytes 
        {
        ...
        /*internal*/ public uint ContentId 
        {
#if DEBUG 
            [DebuggerStepThrough]
#endif
        ...
        /// </remarks>
        /*internal*/ public NavigationService ParentNavigationService 
        {
            get { return _parentNavigationService; }
        }
 
        /*internal*/ public boolean CanReloadFromUri
        { 
            get 
            {
        ...
        /*internal*/ public ArrayList ChildNavigationServices
        {
        ...
        /// </SecurityNote> 
        private boolean HasTravelLogIntegration 
        {
            [SecurityCritical, SecurityTreatAsSafe] 
            get
            {
        ...
        private boolean IsTopLevelContainer
        { 
            get
            {
        ...
        private boolean IsJournalLevelContainer 
        {
            get 
            {
                JournalNavigationScope jns = JournalScope;
        ...
        private boolean SandboxExternalContent 
        {
            get 
            {
                ...
                return (boolean)navigator.GetValue(Frame.SandboxExternalContentProperty); 
            }
 
        }

        /*internal*/ public INavigator INavigatorHost
        { 
#if DEBUG
            [DebuggerStepThrough] 
#endif 
        ...
        /*internal*/ public NavigationStatus NavStatus
        { 
            get { return _navStatus; } 
            set { _navStatus = value; }
        } 

        /*internal*/ public ArrayList PendingNavigationList
        {
        ...
        /*internal*/ public WebBrowser WebBrowser
        {
            get
            { 
                return _webBrowser;
        ...
        /*internal*/ public boolean IsDisposed 
        {
            get
            {
                ...
                boolean isAppShuttingDown = false; 
                if ((this.Application != null) &&
                    (this.Application.CheckAccess() == true) &&
        ...
        static /*internal*/ public boolean IsPageFunction(Object content)
        {
        ...
        //
        private boolean IsValidRootElement(Object bp)
        { 
...
//        #region Events 
        ...
        // BPReady event
        // </summary>
        /*internal*/ public event BPReadyEventHandler BPReady;
        /*internal*/ public event BPReadyEventHandler PreBPReady; 
...
//        #region Private Properties
        ...
        private boolean IsNavigationInitiator
        { 
            get
            {
...
//        #region Private Fields 
        ...
        private boolean _doNotJournalCurrentContent; 
        private boolean _cancelContentRenderedHandling; 
        ...
        private boolean _isNavInitiator; 
        private boolean _isNavInitiatorValid; 
        private boolean _allowWindowNavigation;
        ...
        private final int _noParentPage = -1; 
