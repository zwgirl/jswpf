...
/// </summary> 
/*internal*/ public  class TreeChangeInfo
{
//    #region Properties
    public TreeChangeInfo(DependencyObject root, DependencyObject parent, boolean isAddOperation) 
    {
        _rootOfChange = root; 
    ...
    // 
    /*internal*/ public  FrugalObjectList<DependencyProperty> CreateParentInheritableProperties(
        DependencyObject                         d, 
...
//        Debug.Assert(d != null, "Must have non-null current node"); 
        ...
        int parentEffectiveValuesCount = 0; 
        int inheritablePropertiesCount = 0; 
...
//                    Debug.Assert(!inheritableProperties.Contains(dp), "EffectiveValues cache must not contains duplicate entries for the same DP"); 
    ...
    /*internal*/ public  void ResetInheritableValueIndexer()
    {
        _valueIndexer = 0;
    } 
    ...
    // the last time.
    /*internal*/ public  InheritablePropertyChangeInfo GetRootInheritableValue(DependencyProperty dp) 
    { 
    ...
    /// </summary> 
    /*internal*/ public  Stack<FrugalObjectList<DependencyProperty>> InheritablePropertiesStack
    { 
        get 
        {
    ...
    /// </summary> 
    /*internal*/ public  Object TopmostCollapsedParentNode
    { 
