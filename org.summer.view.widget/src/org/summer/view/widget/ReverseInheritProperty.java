...
/*internal*/ public abstract class ReverseInheritProperty 
    {
        /*internal*/ public ReverseInheritProperty(
        ...
        /*internal*/ public abstract void FireNotifications(UIElement uie, ContentElement ce, UIElement3D uie3D, boolean oldValue); 
 
        /*internal*/ public void OnOriginValueChanged(DependencyObject oldOrigin, DependencyObject newOrigin, /*ref*/ DeferredElementTreeState oldTreeState)
        { 
            OnOriginValueChanged(oldOrigin, newOrigin, null, /*ref*/ oldTreeState, null);
        }

        /*internal*/ public void OnOriginValueChanged(DependencyObject oldOrigin, 
            DependencyObject newOrigin,
            IList<DependencyObject> otherOrigins, 
            /*ref*/ DeferredElementTreeState oldTreeState, 
            Action<DependencyObject, Boolean> originChangedAction)
        { 
            ...
            boolean setOriginCacheFlag = ((originChangedAction != null) && 
            ...
            boolean setOriginCacheFlag) 
        {
            ...
            boolean isFlagSet = IsFlagSet(uie, ce, uie3D, FlagCache);
            boolean isFlagOriginCacheSet = (setOriginCacheFlag ? IsFlagSet(uie, ce, uie3D, (newValue ? FlagNewOriginCache : FlagOldOriginCache)) : false);
        ...
        { 
            ...
            boolean flagChanged = IsFlagSet(uie, ce, uie3D, FlagChanged); 
            boolean isFlagOldOriginCacheSet = ((FlagOldOriginCache == CoreFlags.None) ? false : IsFlagSet(uie, ce, uie3D, FlagOldOriginCache)); 
            boolean isFlagNewOriginCacheSet = ((FlagNewOriginCache == CoreFlags.None) ? false : IsFlagSet(uie, ce, uie3D, FlagNewOriginCache));
        ...
        private static boolean BlockReverseInheritance(UIElement uie, ContentElement ce, UIElement3D uie3D) 
        {
            if (uie != null)
            {
        ...
        private static void SetFlag(UIElement uie, ContentElement ce, UIElement3D uie3D, CoreFlags flag, boolean value)
        {
            if (uie != null) 
            {
        ...
        private static boolean IsFlagSet(UIElement uie, ContentElement ce, UIElement3D uie3D, CoreFlags flag)
        {
            if (uie != null) 
            {
