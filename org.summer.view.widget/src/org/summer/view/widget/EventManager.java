...
//    #region External API 
    ...
    { 
        ...
        if (handlerType == null)
        { 
            throw new IllegalArgumentException("handlerType");
        }
        ...
        {
            throw new IllegalArgumentException(/*SR.Get(SRID.DuplicateEventName, name, ownerType)*/);
        }
        ...
        boolean handledEventsToo) 
    {
        ...
        { 
            throw new IllegalArgumentException(/*SR.Get(SRID.ClassTypeIllegal)*/);
        }
