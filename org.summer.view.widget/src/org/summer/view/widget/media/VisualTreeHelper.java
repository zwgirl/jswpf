...
public /*static*/ class VisualTreeHelper 
{
    ...
    // 
//    [FriendAccessAllowed] 
    /*internal*/ static boolean IsVisualType(DependencyObject reference)
    { 
        return (reference instanceof Visual) || (reference instanceof Visual3D);
    }
...
//    [FriendAccessAllowed] 
    /*internal*/ public static DependencyObject GetParentInternal(DependencyObject reference)
    { 
        Visual visual; 
        Visual3D visual3D;
...
//        Debug.Assert(reference == null); 
    ...
    /*internal*/ public static boolean IsAncestorOf(DependencyObject reference, DependencyObject descendant)
    {
        Visual visual; 
        Visual3D visual3D;
    ...
    // of the given type
    /*internal*/ static boolean IsAncestorOf(DependencyObject ancestor, DependencyObject descendant, Type stopType)
    {
        if (ancestor == null) 
        {
        ...
        while ((current != null) && (current != ancestor) && !stopType.IsInstanceOfType(current))
        {
            ...
            if ((visual = current asorg.summer.view.widget.media.Visual) != null) 
            {
...
//#pragma warning restore 0618 
    ...
    /// </summary>
//    [FriendAccessAllowed]
    /*internal*/ static HitTestResult HitTest(Visual reference, Point point, boolean include2DOn3D)
    { 
        CheckVisualReferenceArgument(reference);
