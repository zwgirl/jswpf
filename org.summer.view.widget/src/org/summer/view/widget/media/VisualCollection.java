...
import org.summer.view.widget.utils.ArgumentOutOfRangeException;
 /// <summary> 
    ...
    /// to.
    /// </remarks> 
    public /*sealed*/ class VisualCollection implements ICollection
    { 
        ...
        private final int c_defaultCapacity = 4;
        private final float c_growFactor = 1.5f; 
...
//                Debug.Assert(visual._parent != null);
        ...
        private boolean IsReadOnlyInternal 
        {
            get
            {
        ...
        /*internal*/ public void Move(Visual visual, Visual destination)
        {
            int newIndex;
            int oldIndex; 
