...
public class Color implements IFormattable, IEquatable<Color>
{
    //----------------------------------------------------- 
    //
    //  Constructors 
...
//    #region Constructors
    ...
    ///</summary> 
    /*internal*/ public static Color FromUInt32(uint argb)// /*internal*/ public legacy sRGB interface 
    {
        Color c1 = new Color(); 
...
//    #region Public Methods
    ...
    {
        // Delegate to the /*internal*/ public method which implements all ToString calls. 
    ...
    /// A String representation of this Object. 
    /// </returns>
    /*internal*/ public String ConvertToString(String format, IFormatProvider provider) 
    { 
    ...
    public static boolean AreClose(Color color1, Color color2)
    {
    ...
    /// <returns>Whether or not the two colors are equal</returns> 
    private boolean IsClose(Color color)
    { 
...
//            #pragma warning suppress 6506 // c1.context is obviously not null 
   ...
   ///<summary>
    ...
    ///</summary> 
    public static boolean operator ==(Color color1, Color color2) 
    {
        if (color1.context == null && color2.context == null) 
        {
...
//    [MarshalAs(UnmanagedType.Interface)]
    ...
    private class MILColorF // this structure is the "milrendertypes.h" structure and should be identical for performance
    { 
    ...
    private boolean isFromScRgb;

    private /*const*/static final String c_scRgbFormat = "R";
