...
/// </summary>
/*internal*/ public /*static*/ class VisualTreeUtils 
{
    //-----------------------------------------------------
    //
    //  Constructors 
...
//    #region Internal Methods
    ...
    /// </summary>
    /*internal*/ public static void SetFlagsToRoot(DependencyObject element, boolean value, VisualFlags flags) 
    {
        Visual visual;
        Visual3D visual3D;
    ...
    ///     flags set.
    /// </summary>
    /*internal*/ public static DependencyObject FindFirstAncestorWithFlagsAnd(DependencyObject element, VisualFlags flags)
    { 
        Visual visual;
        Visual3D visual3D; 
    ...
    /// </summary>
    /*internal*/ public static PointHitTestResult AsNearestPointHitTestResult(HitTestResult result)
    { 
        if (result == null)
        { 
            return null; 
    ...
    /// </summary>
    /*internal*/ public static void EnsureNonNullVisual(DependencyObject element)
    {
    ...
    ///     or if the Visual is on the wrong thread. 
    /// </summary>
    /*internal*/ public static void EnsureVisual(DependencyObject element)
    {
    ...
    ///     or if the Visual is on the wrong thread. 
    /// </summary>
    private static void EnsureVisual(DependencyObject element, boolean allowNull)
    {
        if (element == null) 
        {
            if (!allowNull) 
        ...
        //
        if (!(element instanceof Visual || element instanceof Visual3D)) 
        { 
    ...
    /// </summary>
    /*internal*/ public static void AsNonNullVisual(DependencyObject element, /*out*/ Visual visual, /*out*/ Visual3D visual3D) 
    {
        if (element == null)
        {
            throw new ArgumentNullException("element"); 
    ...
    /// </summary> 
    /*internal*/ public static void AsVisual(DependencyObject element, /*out*/ Visual visual, /*out*/ Visual3D visual3D)
    {
        boolean castSucceeded = AsVisualHelper(element, /*out*/ visual, /*out*/ visual3D);
    ...
    /// </summary>
    /*internal*/ public static boolean AsVisualInternal(DependencyObject element, /*out*/ Visual visual, /*out*/ Visual3D visual3D) 
    {
        boolean castSucceeded = AsVisualHelper(element, /*out*/ visual, /*out*/ visual3D); 
...
//    #region Internal Fields
    ...
    public /*const*/static final String BitmapEffectObsoleteMessage =
...
//    #region Private Methods
    ...
    private static boolean AsVisualHelper(DependencyObject element, /*out*/ Visual visual, /*out*/ Visual3D visual3D) 
    { 
