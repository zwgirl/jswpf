...
import org.summer.view.widget.media.composion.DUCE.Channel;
...
/// Sources, included decoders and effects 
/// </summary>
//[Localizability(LocalizationCategory.None, Readability = Readability.Unreadable)]
public abstract class BitmapSource extends ImageSource implements DUCE.IResource
{ 
//    #region Constructor
...
//    [SecurityCritical, SecurityTreatAsSafe]
    ...
    /// </SecurityNote>
//    [SecurityCritical, SecurityTreatAsSafe] 
    /*internal*/ public BitmapSource(bool useVirtuals)
    { 
        _useVirtuals = true; 
        _isSourceCached = false;
...
//    #region Internal, Protected and Private properties and methods 
    ...
    /// </summary> 
    /*internal*/ public override Size Size
    {
        get
        { 
            ReadPreamble();
    ...
    /*internal*/ public bool DelayCreation
    { 
        get
        { 
    ...
    /*internal*/ public bool CreationCompleted
    {
        get 
        {
    ...
    /// 
    /*internal*/ public void CompleteDelayedCreation()
    { 
    ...
    /*internal*/ public virtual void FinalizeCreation()
    {
    ...
    /*internal*/ public object SyncObject
    { 
        get 
        {
    ...
    /*internal*/ public bool IsSourceCached
    { 
        get 
        {
    ...
    /// </SecurityNote>
    /*internal*/ public BitmapSourceSafeMILHandle WicSourceHandle 
    {
        [SecurityCritical] 
        get 
        {
    ...
    /// </SecurityNote>
    [SecurityCritical]
    /*internal*/ public virtual void UpdateCachedSettings() 
    {
        EnsureShouldUseVirtuals(); 
    ...
    unsafe /*internal*/ public void CriticalCopyPixels(Int32Rect sourceRect, Array pixels, int stride, int offset)
    { 
        ReadPreamble(); 
        _bitmapInit.EnsureInitializedComplete();
        CompleteDelayedCreation(); 
    ...
    /// </SecurityNote> 
    [SecurityCritical] 
    /*internal*/ public void CriticalCopyPixels(Int32Rect sourceRect, IntPtr buffer, int bufferSize, int stride)
    { 
    ...
    /// </SecurityNote> 
    /*internal*/ public virtual BitmapSourceSafeMILHandle DUCECompatiblePtr
    { 
        [SecurityCritical]
        get
        {
    ...
    /// </SecurityNote>
    [SecurityCritical, SecurityTreatAsSafe] 
    /*internal*/ public virtual void UpdateBitmapSourceResource(DUCE.Channel channel, bool skipOnChannelCheck) 
    {
        if (_needsUpdate) 
        {
    ...
    /// </SecurityNote>
    [SecurityCritical, SecurityTreatAsSafe]
    /*internal*/ public void RecoverFromDecodeFailure(Exception e)
    { 
    ...
    /*internal*/ public static PixelFormat GetClosestDUCEFormat(PixelFormat format, BitmapPalette palette) 
    {
    ...
    /// </SecurityNote>
    [SecurityCritical] 
    /*internal*/ public static BitmapSourceSafeMILHandle CreateCachedBitmap(
        BitmapFrame frame,
    ...
    // Needs to be /*internal*/ public, called by subclasses to attach handlers when their Source changes
    /*internal*/ public void RegisterDownloadEventSource(BitmapSource eventSource) 
    {
        if (_weakBitmapSourceEventSink == null)
        {
    ...
    // Needs to be /*internal*/ public, called by BitmapImage to detach handlers from the dummy downloading 
    // BitmapFrameDecode's chain
    /*internal*/ public void UnregisterDownloadEventSource()
    {
        if (_weakBitmapSourceEventSink != null) 
        {
            CleanUpWeakEventSink(); 
    ...
    /*internal*/ public virtual bool IsValidForFinalizeCreation(bool throwIfInvalid)
    { 
        return true;
    }
    ...
    //
    /*internal*/ public virtual bool ShouldCloneEventDelegates
    {
        get { return true; } 
    }
    ...
    /*internal*/ public BitmapInitialize _bitmapInit = new BitmapInitialize(); 

    /// <SecurityNote>
    /// Critical: Unmanaged IWICBitmapSource handle. Access only through WicSourceHandle 
    /// </SecurityNote>
    [SecurityCritical]
    /*internal*/ public BitmapSourceSafeMILHandle _wicSource = null;

    /// <SecurityNote>
    /// Critical: Unmanaged IWICBitmapSource handle. 
    /// </SecurityNote> 
    [SecurityCritical]
    /*internal*/ public BitmapSourceSafeMILHandle _convertedDUCEPtr; 

    /*internal*/ public object _syncObject;
    /*internal*/ public bool _isSourceCached;
    ...
    /*internal*/ public bool _needsUpdate;

    /*internal*/ public bool _isColorCorrected;
    /*internal*/ public UniqueEventHelper _downloadEvent = new UniqueEventHelper();
    /*internal*/ public UniqueEventHelper<DownloadProgressEventArgs> _progressEvent = new UniqueEventHelper<DownloadProgressEventArgs>();
    /*internal*/ public UniqueEventHelper<ExceptionEventArgs> _failedEvent = new UniqueEventHelper<ExceptionEventArgs>(); 
    /*internal*/ public UniqueEventHelper<ExceptionEventArgs> _decodeFailedEvent = new UniqueEventHelper<ExceptionEventArgs>();

    // cached properties. should always reflect the unmanaged copy 
    /*internal*/ public PixelFormat _format = PixelFormats.Default;
    /*internal*/ public int _pixelWidth = 0; 
    /*internal*/ public int _pixelHeight = 0;
    /*internal*/ public double _dpiX = 96.0;
    /*internal*/ public double _dpiY = 96.0;
    /*internal*/ public BitmapPalette _palette = null; 

    /// Duce resource 
    /*internal*/ public DUCE.MultiChannelResource _duceResource = new DUCE.MultiChannelResource(); 

    // Whether or not the _wicSource handle must be cached on the UI Thread 
    // before being passed to the render thread.
    /*internal*/ public bool UsableWithoutCache
    {
        get 
        {
    ...
    /*internal*/ public bool HasCompatibleFormat
    { 
        get
        { 
    ...
    // thread.
    /*internal*/ public static bool IsCompatibleFormat(PixelFormat format) 
    {
    ...
    /*internal*/ public interface IWICBitmapSource 
    {
        [PreserveSig]
        int GetSize(
            out int puiWidth, 
...
//    [ClassInterface(ClassInterfaceType.None)] 
    /*internal*/ public class ManagedBitmapSource : IWICBitmapSource
    {
...
//    #region WeakBitmapSourceEventSink 
    ...
    private class WeakBitmapSourceEventSink extends WeakReference
    { 
