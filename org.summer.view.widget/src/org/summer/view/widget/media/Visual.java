...
/// </summary> 
public abstract /*partial*/ class Visual extends DependencyObject //implements /*DUCE.*/IResource
{ 
    // -------------------------------------------------------------------- 
    //
    //   Constants 
...
//    #region Constants 
    ...
    /// </summary> 
    private final VisualProxyFlags c_ProxyFlagsDirtyMask =
    ...
    /// channel yet 
    /// </summary>
    private final VisualProxyFlags c_Viewport3DProxyFlagsDirtyMask =
...
//    #region IResource implementation 
    ...
    /// <returns></returns> 
    /*internal*/ boolean IsOnChannel(DUCE.Channel channel)
    { 
...
//    #region Internal Properties
    ...
    /*internal*/ boolean IsVisualChildrenIterationInProgress 
    { 
//        [FriendAccessAllowed]
...
//        [FriendAccessAllowed]
    ...
    /// </remarks>
    /*internal*/ boolean IsRootElement 
    { 
        get
        { 
...
//    #region Visual Content
    ...
    /// is executed.
    /// </summary> 
    /*internal*/ /*virtual*/ void RenderContent(RenderContext ctx, boolean isOnChannel)
    {
        /* do nothing */
    } 
    ...
    /// CyclicBrush.
    /// </summary>
    /*internal*/ /*virtual*/ Rect CalculateSubgraphBoundsInnerSpace(boolean renderBounds)
    { 
    ...
    /// CyclicBrush. 
    /// </summary>
    private Rect CalculateSubgraphBoundsOuterSpace(boolean renderBounds)
    {
        Rect bboxSubgraph = Rect.Empty; 
    ...
    /// goes with them. 
    /// </summary> 
    private boolean IsEmptyRenderBounds(/*ref*/ Rect bounds)
    { 
...
//    #region Resource Marshalling and Unmarshalling
    ...
    /// </summary>
    private boolean IsCyclicBrushRootOnChannel(DUCE.Channel channel) 
    {
        boolean isCyclicBrushRootOnChannel = false;

        Dictionary<DUCE.Channel, Integer> channelsToCyclicBrushMap = 
        ...
        DUCE.Channel channel)
    {
        ...
        // channels. 
        //
        Dictionary<ICyclicBrush, Integer> cyclicBrushToChannelsMap =
            CyclicBrushToChannelsMapField.GetValue(this);

        if (cyclicBrushToChannelsMap == null)
        { 
            cyclicBrushToChannelsMap = new Dictionary<ICyclicBrush, Integer>(); 
...
//    #region Pre-compute / render passes
    ...
    /*internal*/public void Render(RenderContext ctx, UInt32 childIndex) 
    {
        ...
        RenderContext ctx) 
    {
        ...
        if (canEnter)
        {
            try 
            {
                ...
                boolean isOnChannel = IsOnChannel(channel);
    ...
    { 
        ...
        boolean isChildrenZOrderDirty = CheckFlagsAnd(channel, VisualProxyFlags.IsChildrenZOrderDirty);
        int childCount = VisualChildrenCount;
        ...
        for (int i = 0; i < childCount; i++) 
        {
            ...
            { 
                ...
                {
                    boolean isConnectedToParent = child.CheckFlagsAnd(channel, VisualProxyFlags.IsConnectedToParent); 
...
//    #region Hit Testing
    ...
    /// the tree. 
    /// </summary>
    /*internal*/ HitTestResult HitTest(Point point, boolean include2DOn3D)
    {
        // 
...
//
    ...
    ///</Summary>
    /*internal*/ boolean HasVisualChildren
    { 
        get
        { 
    ...
    /// </summary> 
    /*internal*/public void InternalAddVisualChild(Visual child)
    {
...
//    [Obsolete(MS.Internal.Media.VisualTreeUtils.BitmapEffectObsoleteMessage)]
    ...
    /// </summary>
    /*internal*/ boolean BitmapEffectEmulationDisabled
    { 
        get
        { 
    ...
    /// </summary> 
    /*internal*/ void ChangeVisualClip(Geometry newClip, boolean dontSetWhenClose)
    {
...
//    #region Visual Ancestry Relations 
    ...
    /*internal*/ /*virtual*/public void FireOnVisualParentChanged(DependencyObject oldParent)
    { 
    ...
    /// </summary>
    /*internal*/ void SetFlagsToRoot(boolean value, VisualFlags flag)
    { 
        Visual current = this;
...
//    #region Visual-to-Visual Transforms 
    ...
    { 
        ...
        boolean isSimple0 = this.TrySimpleTransformToAncestor(ancestorAsVisual, 
                                                           false,
                                                           /*out*/ g0,
                                                           /*out*/ m0);
        ...
        boolean isSimple1 = visual.TrySimpleTransformToAncestor(ancestorAsVisual,
                                                             true, 
                                                             /*out*/ g1,
                                                             /*out*/ m1);
    ...
    private GeneralTransform InternalTransformToAncestor(Visual ancestor, boolean inverse)
    {
        GeneralTransform generalTransform; 
        Matrix simpleTransform;

        boolean isSimple = TrySimpleTransformToAncestor(ancestor, 
                                                     inverse,
    ...
    /*internal*/ boolean TrySimpleTransformToAncestor(Visual ancestor, 
                                               boolean inverse,
    ...
    /// <param name="ancestor">Ancestor visual.</param>
    /// <param name="inverse">Returns inverse if this argument is true.</param> 
    private GeneralTransform2DTo3D InternalTransformToAncestor(Visual3D ancestor, boolean inverse)
    { 
    ...
    /*internal*/ boolean TrySimpleTransformToAncestor(Visual3D ancestor,
...
//
    ...
    /// </summary>
    /*internal*/ protected void SetFlags(boolean value, VisualFlags flags)
    {
    ...
    /// </remarks> 
    /*internal*/ boolean CheckFlagsOnAllChannels(VisualProxyFlags flagsToCheck)
    { 
    ...
    /// the method returns true.
    /// </remarks>
    /*internal*/public boolean CheckFlagsAnd( 
        DUCE.Channel channel,
    ...
    /*internal*/public boolean CheckFlagsAnd(VisualFlags flags)
    { 
    ...
    /// </remarks>
    /*internal*/public boolean CheckFlagsOr(
        DUCE.Channel channel,
        VisualProxyFlags flagsToCheck) 
    {
    ...
    /// <remarks>If there aren't any bits set on the specified flags the method 
    /// returns true</remarks>
    /*internal*/public boolean CheckFlagsOr(VisualFlags flags) 
    { 
    ...
    /// </summary>
    private static boolean DoAnyChildrenHaveABitSet(
        Visual pe, 
        VisualFlags flag)
    { 
        ...
        VisualProxyFlags proxyFlags) 
    {
               ...
               (!e.CheckFlagsAnd(flags) || !e.CheckFlagsOnAllChannels(proxyFlags))) 
        {
            ...
            else if (e.CheckFlagsAnd(VisualFlags.NodeIsCyclicBrushRoot)) 
            {
                ...
                for/*each*/ (ICyclicBrush cyclicBrush : cyclicBrushToChannelsMap.Keys)
                { 
    ...
    private boolean NodeHasLegacyBitmapEffect 
    { 
        get
        { 
...
//    #region Internal Fields 
    ...
    /*internal*/ static final UncommonField<BitmapEffectState> BitmapEffectStateField = new UncommonField<BitmapEffectState>();
...
//    #region Private Fields
    ...
    // 
    private static final UncommonField<Dictionary<ICyclicBrush, Integer>> CyclicBrushToChannelsMapField
        = new UncommonField<Dictionary<ICyclicBrush, Integer>>(); 
    ...
    //
    private static final UncommonField<Dictionary<DUCE.Channel, Integer>> ChannelsToCyclicBrushMapField 
        = new UncommonField<Dictionary<DUCE.Channel, Integer>>(); 

    private static final UncommonField<Geometry> ClipField = new UncommonField<Geometry>(); 
    private static final UncommonField<Double> OpacityField = new UncommonField<Double>(1.0);
    private static final UncommonField<Brush> OpacityMaskField = new UncommonField<Brush>();
    private static final UncommonField<EdgeMode> EdgeModeField = new UncommonField<EdgeMode>();
    private static final UncommonField<BitmapScalingMode> BitmapScalingModeField = new UncommonField<BitmapScalingMode>(); 
    private static final UncommonField<ClearTypeHint> ClearTypeHintField = new UncommonField<ClearTypeHint>();

    private static final UncommonField<Transform> TransformField = new UncommonField<Transform>(); 
    private static final UncommonField<Effect> EffectField = new UncommonField<Effect>();
    private static final UncommonField<CacheMode> CacheModeField = new UncommonField<CacheMode>(); 

    private static final UncommonField<DoubleCollection> GuidelinesXField = new UncommonField<DoubleCollection>();
    private static final UncommonField<DoubleCollection> GuidelinesYField = new UncommonField<DoubleCollection>();

    private static final UncommonField<AncestorChangedEventHandler> AncestorChangedEventField
        = new UncommonField<AncestorChangedEventHandler>(); 

    private static final UncommonField<BitmapEffectState> UserProvidedBitmapEffectData = new UncommonField<BitmapEffectState>();

    private static final UncommonField<Rect?> ScrollableAreaClipField = new UncommonField<Rect?>(null);

    private static final UncommonField<TextRenderingMode> TextRenderingModeField = new UncommonField<TextRenderingMode>();
    private static final UncommonField<TextHintingMode> TextHintingModeField = new UncommonField<TextHintingMode>(); 

    private Vector _offset; 
    private VisualFlags _flags; 

    private final int TreeLevelLimit = 0x7FF; 
