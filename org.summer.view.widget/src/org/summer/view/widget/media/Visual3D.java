...
/// </summary>
public abstract /*partial*/ class Visual3D extends DependencyObject implements DUCE.IResource, IVisual3DContainer 
{
    // ------------------------------------------------------------------- 
    // 
    //   Constants
...
//    #region Constants
    ...
    /// </summary>
    private /*const*/static final VisualProxyFlags c_Model3DVisualProxyFlagsDirtyMask = 
...
//    #region IResource implementation
    ...
    /// <returns></returns>
    /*internal*/ public boolean IsOnChannel(DUCE.Channel channel)
    {
...
//    #region Public Methods 
    ...
    private static void TransformPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) 
    {
        ...
        //
        // We currently maintain a cache of both a ModelVisual3D抯 content 
...
//    #region Protected Methods
    ...
    /// </summary>
    /*internal*/ public boolean InternalIsVisible
    { 
        get
        { 
    ...
    private void Visual3DModelPropertyChanged(Model3D oldValue, boolean isSubpropertyChange) 
    {
    ...
    /*internal*/ public /*virtual*/ void FireOnVisualParentChanged(DependencyObject oldParent)
    { 
    ...
    /// </remarks>
    /*internal*/ public event Visual.AncestorChangedEventHandler VisualAncestorChanged
    { 
        add
        { 
    ...
    /// </summary>
    /*internal*/ public static void ProcessAncestorChangedNotificationRecursive(DependencyObject e, AncestorChangedEventArgs args) 
    {
        if (e isorg.summer.view.widget.media.Visual)
        {
...
//    #region /*internal*/ public Methods 
    ...
    /*internal*/ public boolean DoesRayHitSubgraphBounds(RayHitTestParameters rayParams)
    {
        Point3D origin; 
        Vector3D direction;
    ...
    /*internal*/ public HitTestResultBehavior RayHitTest(
        HitTestFilterCallback filterCallback, 
    ...
    /*internal*/ public HitTestResultBehavior HitTestChildren(
        HitTestFilterCallback filterCallback, 
        RayHitTestParameters rayParams)
    {
    ...
    /// </summary> 
    /*internal*/ public static HitTestResultBehavior HitTestChildren(
        HitTestFilterCallback filterCallback,
        RayHitTestParameters rayParams,
    ...
    /*internal*/ public void RayHitTestInternal( 
        HitTestFilterCallback filterCallback,
        RayHitTestParameters rayParams) 
    {
    ...
    /// </summary>
    /*internal*/ public void RenderChanged(Object sender, EventArgs e) 
    {
        PropagateFlags(
            this,
            VisualFlags.IsSubtreeDirtyForPrecompute, 
    ...
    /// </summary>
    /*internal*/ public Rect3D VisualContentBounds
    {
        get 
        {
    ...
    /// </summary> 
//    [FriendAccessAllowed]
    /*internal*/ public Rect Visual2DContentBounds 
    {
        get
        {
            VerifyAPIReadWrite(); 
    ...
    /*internal*/ public Rect3D BBoxSubgraph
    { 
        get
        {
    ...
    /// </summary>
    /*internal*/ public Rect3D GetContentBounds()
    { 
        Model3D model = _visual3DModel;
    ...
    /// </summary> 
    /*internal*/ public Rect3D CalculateSubgraphBoundsOuterSpace()
    { 
    ...
    /// </summary>
    /*internal*/ public Rect3D CalculateSubgraphBoundsInnerSpace() 
    {
        return BBoxSubgraph;
    }
    ...
    /// </summary> 
    /*internal*/ public Rect3D VisualDescendantBounds
    {
        get
        { 
            // Probably too restrictive. Let's see who wants it during OnRender.
    ...
    // the /*internal*/ public methods as an explicit implementation of an /*internal*/ public interface. 
    ...
    /// </summary>
    /*internal*/ public void VerifyAPIReadOnly() 
    {
    ...
    /// Applies various API checks
    /// </summary>
    /*internal*/ public void VerifyAPIReadOnly(DependencyObject other) 
    {
        VerifyAPIReadOnly(); 
    ...
    /// </summary>
    /*internal*/ public void VerifyAPIReadWrite() 
    {
        VerifyAPIReadOnly();
    ...
    /// Applies various API checks 
    /// </summary>
    /*internal*/ public void VerifyAPIReadWrite(DependencyObject other)
    {
        VerifyAPIReadWrite(); 
    ...
    /*internal*/ public void SetParent(Visual newParent) 
    {
    ...
    /*internal*/ public void SetParent(Visual3D newParent)
    { 
...
//    [Conditional("DEBUG")]
    /*internal*/ public void Debug_VerifyBoundsEqual(Rect3D bounds1, Rect3D bounds2, string errorString) 
    { 
        // The funny boolean logic below avoids asserts when the cached
        // bounds contain NaNs.  (NaN != NaN) 
        boolean boundsAreEqual =
...
//    [Conditional("DEBUG")]
    /*internal*/ public void Debug_VerifyCachedSubgraphBounds() 
    {
...
//    [Conditional("DEBUG")]
    /*internal*/ public void Debug_VerifyCachedContentBounds() 
    {
        Model3D model = _visual3DModel;
...
//#if DEBUG
//    /*internal*/ public Rect3D Debug_CalculateSubgraphBounds()
//    { 
...
//    #endregion DEBUG 
    ...
    /// Precompute pass.
    /// </summary> 
    /*internal*/ public void PrecomputeRecursive(/*out*/ Rect3D bboxSubgraph)
    { 
        if (CheckFlagsAnd(VisualFlags.IsSubtreeDirtyForPrecompute)) 
        {
            // 
    ...
    /*internal*/ public void RenderRecursive(RenderContext ctx) 
    {
    ...
    /// </summary>
    /*internal*/ public void RenderContent(RenderContext ctx, boolean isOnChannel) 
    {
        DUCE.Channel channel = ctx.Channel;
    ...
    /// </summary>
    /*internal*/ public void SetFlagsToRoot(boolean value, VisualFlags flag) 
    {
        Visual3D current = this; 
    ...
    ///     flags set. 
    /// </summary>
    /*internal*/ public DependencyObject FindFirstAncestorWithFlagsAnd(VisualFlags flag) 
    {
        Visual3D current = this;
    ...
    /// </summary> 
    /*internal*/ public void FreeDUCEResources(DUCE.Channel channel) 
    {
        Transform3D transform = Transform; 
    ...
    /*internal*/ public void ReleaseOnChannelCore(DUCE.Channel channel) 
    { 
    ...
    /// </summary> 
    /*internal*/ public void DisconnectAttachedResource(
    ...
    /*internal*/ public /*override*/ void OnInheritanceContextChangedCore(EventArgs args) // ancestor changed
    {
...
//    #region Visual-to-Visual Transforms 
    ...
    private GeneralTransform3D InternalTransformToAncestor(Visual3D ancestor, boolean inverse)
    { 
    ...
    /*internal*/ public GeneralTransform3DTo2D InternalTransformToAncestor(Visual ancestor) 
    { 
        Debug.Assert(ancestor != null);
...
//    #region /*internal*/ public Properties

    /*internal*/ public DependencyObject InternalVisualParent
    { 
        get
        { 
            if (_3DParent != null) 
    ...
    /*internal*/ public int ParentIndex 
    { 
    ...
    /*internal*/ public boolean IsVisualChildrenIterationInProgress
    { 
        [FriendAccessAllowed] 
...
//    #endregion /*internal*/ public Properties
...
//    #region Visual flags manipulation 
    ...
    /// marshaled to. 
    /// </summary>
    /*internal*/ public void SetFlagsOnAllChannels(
        boolean value,
    ...
    /// </summary> 
    /*internal*/ public void SetFlags(boolean value, VisualFlags Flags)
    {
    ...
    /// </remarks>
    /*internal*/ public boolean CheckFlagsOnAllChannels(VisualProxyFlags flagsToCheck) 
    { 
    ...
    /// </summary> 
    /*internal*/ public /*virtual*/ DependencyObject InternalGet2DOr3DVisualChild(int index) 
    {
    ...
    /// Used only by VisualTreeHelper. 
    /// </summary>
    /*internal*/ public /*virtual*/ int InternalVisual2DOr3DChildrenCount
    {
        get 
        {
            // Call the right /*virtual*/ method. 
    ...
    /// </summary>
    /*internal*/ public static boolean DoAnyChildrenHaveABitSet(Visual3D pe,
                                                  VisualFlags flag)
    { 
    ...
    /// </remarks> 
    /*internal*/ public static void PropagateFlags( 
        Visual3D e,
        VisualFlags flags, 
...
//    #region /*internal*/ public Fields

//    /*internal*/ public VisualProxy _proxy; 

//    #endregion /*internal*/ public Fields 
...
//    #region Private Fields
    ...
    private static final UncommonField<Visual> _2DParent =
    ...
    private static final DependencyObject UseParentAsContext = new DependencyObject();
    ...
    private static final UncommonField<DependencyObject> _inheritanceContext =
        new UncommonField<DependencyObject>(/* defaultValue = */ UseParentAsContext); 

    private static final UncommonField<Visual.AncestorChangedEventHandler> AncestorChangedEventField
    ...
    private boolean _internalIsVisible; 

    private static final ScaleTransform3D _zeroScale = new ScaleTransform3D(0, 0, 0);
