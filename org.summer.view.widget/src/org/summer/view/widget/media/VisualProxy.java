...
/// </summary>
/*internal*/ public class VisualProxy 
{ 
    // -------------------------------------------------------------------
    // 
    //   Private Types
...
//    #region Private Types
    ...
    private class Proxy 
    {
        /*internal*/ public DUCE.Channel Channel; 
        /*internal*/ public VisualProxyFlags Flags; 
        /*internal*/ public DUCE.ResourceHandle Handle;
    } 
...
//    #region Internal Properties
    ...
    /// one channel.
    /// </summary> 
    /*internal*/ public boolean IsOnAnyChannel
    {
        get
        { 
            return Count != 0;
...
//    #region Internal Methods
    ...
    /// </summary>
    /*internal*/ public boolean CreateOrAddRefOnChannel(
        Object instance,
    ...
    /// Otherwise, a new resource is created on that channel. 
    /// </summary> 
    /*internal*/ public boolean ReleaseOnChannel(DUCE.Channel channel)
    { 
        int index = Find(channel);
    ...
    /// </summary>
    /*internal*/ public DUCE.Channel GetChannel(int index) 
    {
...
//    #region Internal Methods: resource handle getters
    ...
    /// </summary> 
    /*internal*/ public DUCE.ResourceHandle GetHandle(DUCE.Channel channel) 
    {
    ...
    /// </summary> 
    /*internal*/ public DUCE.ResourceHandle GetHandle(int index) 
    {
        Debug.Assert(index >= 0 && index < Count); 
...
//    #region Internal Methods: visual proxy flags 
    ...
    /// </summary> 
    /*internal*/ public VisualProxyFlags GetFlags(DUCE.Channel channel)
    { 
    ...
    /// </summary> 
    /*internal*/ public VisualProxyFlags GetFlags(int index)
    { 
        if (index < Count) 
        {
            if (index == 0) 
    ...
    /// </summary>
    /*internal*/ public boolean CheckFlagsOnAllChannels( 
...
//    #region Private Fields
    ...
    /// </summary> 
    private /*const*/static final int PROXY_NOT_FOUND = -2; 

    /// <summary> 
    /// Returned by the Find method to denote that a proxy for the given
    /// channel has been found in the inline storage.
    /// </summary>
    private /*const*/static final int PROXY_STORED_INLINE = -1; 
