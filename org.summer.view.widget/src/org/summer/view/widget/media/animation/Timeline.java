...
//    [Localizability(LocalizationCategory.None, Readability=Readability.Unreadable)] // cannnot be read & localized as string
    public abstract /*partial*/ class Timeline extends Animatable
    {
...
//        #region AccelerationRatio Property
        ...
        /// </summary>
        public static final DependencyProperty AccelerationRatioProperty =
        ...
        private static Boolean ValidateAccelerationDecelerationRatio(object value)
        {
        ...
        public Boolean AutoReverse 
        {
            get
            {
                return (Boolean)GetValue(AutoReverseProperty); 
            }
            set 
            { 
        ...
        private static Boolean ValidateDesiredFrameRate(object value) 
        {
        ...
        private static Boolean ValidateFillBehavior(object value)
        { 
        ...
        private static Boolean ValidateSpeedRatio(object value) 
        {
            double newValue = (double)value; 
        ...
        /// </remarks>
        protected /*internal*/ public /*virtual*/ Clock AllocateClock() 
        { 
        ...
        /// </returns>
        /*internal*/ public protected Duration GetNaturalDuration(Clock clock)
        {
...
//        #region Properties
        ...
        /// </summary> 
        /*internal*/ public EventHandlersStore InternalEventHandlersStore
        { 
            get
            {
...
//        #region Methods 
        ...
        /// </param>
        /*internal*/ public void InternalOnFreezablePropertyChanged(Timeline originalTimeline, Timeline newTimeline)
        { 
        ...
        /// </summary>
        /*internal*/ public Boolean InternalFreeze(Boolean isChecking)
        { 
        ...
        /// </summary>
        /*internal*/ public void InternalReadPreamble()
        {
            ReadPreamble(); 
        }
        ...
        /// </summary> 
        /*internal*/ public void InternalWritePostscript()
        {
            WritePostscript();
        } 
...
//#if DEBUG 
        ...
        /// </summary> 
        /*internal*/ public static void DumpAll()
        {
            System.Text.StringBuilder builder = new System.Text.StringBuilder();
            int timelineCount = 0; 
            builder.Capacity = 1024;
        ...
        /// </param> 
        /*internal*/ public void BuildInfoRecursive(System.Text.StringBuilder builder, int depth)
        { 
        ...
        /// </param>
        /*internal*/ public void BuildInfo(System.Text.StringBuilder builder, int depth, Boolean includeDebugID)
        { 
        ...
        /// </returns>
        /*internal*/ public static Timeline Find(int id)
        {
        ...
        /// references.
        /// </summary> 
        /*internal*/ public static void CleanKnownTimelinesTable()
        {
            lock (_debugLockObject)
            { 
...
//        #region Event Handler Storage 
        ...
        /*internal*/ public static readonly UncommonField<EventHandlersStore> EventHandlersStoreField = new UncommonField<EventHandlersStore>(); 
 
        // Unique identifiers for each of the events defined on Timeline.
        // This is used as a key in the EventHandlerStore 
        /*internal*/ public static readonly EventPrivateKey CurrentGlobalSpeedInvalidatedKey = new EventPrivateKey();
        /*internal*/ public static readonly EventPrivateKey CurrentStateInvalidatedKey = new EventPrivateKey();
        /*internal*/ public static readonly EventPrivateKey CurrentTimeInvalidatedKey = new EventPrivateKey();
        /*internal*/ public static readonly EventPrivateKey CompletedKey = new EventPrivateKey(); 
        /*internal*/ public static readonly EventPrivateKey RemoveRequestedKey = new EventPrivateKey();
...
//#if DEBUG
//
//        /*internal*/ public int                _debugIdentity; 
//
//        /*internal*/ public static int         _nextIdentity; 
//        /*internal*/ public static Hashtable   _objectTable = new Hashtable(); 
//        /*internal*/ public static object      _debugLockObject = new object();
// 
//#endif // DEBUG
