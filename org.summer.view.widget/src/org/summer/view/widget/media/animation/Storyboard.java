...
import org.summer.view.widget.controls.MediaElement;
...
//    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] 
    ...
    private static boolean TargetFreezeValueCallback( 
        DependencyObject d,
    ...
    /// </summary> 
    public static final DependencyProperty TargetPropertyProperty =
...
//#endregion 
    ...
    private class ObjectPropertyPair 
    {
        ...
        { 
            if ((o != null) && (o instanceof ObjectPropertyPair))
            {
        ...
        public boolean Equals(ObjectPropertyPair key)
        {
    ...
    /// same class
    /// </remarks>
    /*internal*/ public static DependencyObject ResolveTargetName( 
        String targetName,
    ...
    /// Template.FindName().
    /// </remarks> 
    /*internal*/ public static BeginStoryboard ResolveBeginStoryboardName( 
        String targetName,
        INameScope nameScope, 
        FrameworkElement fe,
    ...
    /*internal*/ public static void VerifyPathIsAnimatable(PropertyPath path) 
    {
        ...
        boolean      checkingFrozenState = true; 
    ...
    private boolean PropertyCloningRequired( Object targetPropertyValue ) 
    {
    ...
    /// </summary> 
    /*internal*/ public static void GetComplexPathValue(
        ...
        if (cacheEntry != null) 
        {
            ...
            if (baseValue == DependencyProperty.UnsetValue)
            {
                ...
                Debug.Assert(cacheEntry.Source != DependencyProperty.UnsetValue, 
                    "Storyboard complex path抯 clone cache should never contain DependencyProperty.UnsetValue.  Either something went wrong in Storyboard.ProcessComplexPath() or somebody else is messing with the Storyboard clone cache.");
...
*/ 
    ...
    ///     Begins all animations underneath this storyboard, clock tree starts at the given containing Object.
    /// </summary> 
    public void Begin( FrameworkElement containingObject, boolean isControllable )
    {
    ...
    ///     Begins all ControlTemplate animations underneath this storyboard, clock tree starts at the given Control. 
    /// </summary>
    public void Begin( FrameworkElement containingObject, FrameworkTemplate frameworkTemplate, boolean isControllable ) 
    { 
    ...
    ///     Begins all ControlTemplate animations underneath this storyboard, clock tree starts at the given Control.
    /// </summary> 
    public void Begin( FrameworkElement containingObject, FrameworkTemplate frameworkTemplate, HandoffBehavior handoffBehavior, boolean isControllable )
    { 
...
/*  This is the ContentControl+DataTemplate counterpert to Control+ControlTemplate above, need test signoff before enabling.
    ...
    ///     Begins all DataTemplate animations underneath this storyboard, clock tree starts at the given ContentControl.
    /// </summary>
    public void Begin( ContentControl contentControl, DataTemplate dataTemplate, boolean isControllable )
    { 
    ...
    ///     Begins all DataTemplate animations underneath this storyboard, clock tree starts at the given ContentControl. 
    /// </summary>
    public void Begin( ContentControl contentControl, DataTemplate dataTemplate, HandoffBehavior handoffBehavior, boolean isControllable )
    {
...
*/ 
    ...
    ///     Begins all animations underneath this storyboard, clock tree starts at the given containing Object. 
    /// </summary> 
    public void Begin( FrameworkContentElement containingObject, boolean isControllable )
    { 
        Begin(containingObject, HandoffBehavior.SnapshotAndReplace, isControllable );
    }
    ...
    ///     Begins all animations underneath this storyboard, clock tree starts at the given containing Object.
    /// </summary> 
    public void Begin( FrameworkContentElement containingObject, HandoffBehavior handoffBehavior, boolean isControllable ) 
    {
        BeginCommon(containingObject, null, handoffBehavior, isControllable, Storyboard.Layers.Code ); 
    }
    ...
    ///     Begins all animations underneath this storyboard, clock tree starts at the given containing Object. 
    /// </summary>
    /*internal*/ public void BeginCommon( DependencyObject containingObject, INameScope nameScope,
        HandoffBehavior handoffBehavior, boolean isControllable, Int64 layer)
    { 
    ...
    /// </summary>
    public boolean GetIsPaused( FrameworkElement containingObject ) 
    {
    ...
    ///  generated from 'this' storyboard.  If found, return whether the clock is paused.
    /// </summary> 
    public boolean GetIsPaused( FrameworkContentElement containingObject )
    { 
        return GetIsPausedImpl(containingObject); 
    }
    ...
    private boolean GetIsPausedImpl( DependencyObject containingObject )
    {
        Clock clock = GetStoryboardClock(containingObject);
    ...
    /// </remarks> 
    private static final UncommonField<HybridDictionary> StoryboardClockTreesField = new UncommonField<HybridDictionary>();
    ...
    ///
    /// </summary>
    private Clock GetStoryboardClock(DependencyObject o, boolean throwIfNull, InteractiveOperation operation)
    { 
        Clock clock = null;
    ...
    /// </remarks> 
    private static final UncommonField<FrugalMap> ComplexPathCloneField = new UncommonField<FrugalMap>();
    ...
    {
        /*internal*/ public CloneCacheEntry(Object source, Object clone)
        { 
            Source = source;
            Clone = clone; 
        } 
    ...
    { 
        /*internal*/ public static Int64 ElementEventTrigger = 1; 
        /*internal*/ public static Int64 StyleOrTemplateEventTrigger = 1;
        /*internal*/ public static Int64 Code = 1; 
        /*internal*/ public static Int64 PropertyTriggerStartLayer = 2; // First PropertyTrigger takes this layer number.
    }
