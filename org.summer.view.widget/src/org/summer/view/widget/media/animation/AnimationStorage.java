...
/*internal*/ public class AnimationStorage
    { 
        ...
        /// </param>
        /*internal*/ public void AttachAnimationClock(
        ...
        /// AnimationClock.
        /// </param>
        /*internal*/ public void DetachAnimationClock( 
            AnimationClock animationClock,
            EventHandler removeRequestedHandler) 
        { 
            Debug.Assert(animationClock != null);
        ...
        /*internal*/ public void Initialize(DependencyObject d, DependencyProperty dp)
        {
        ...
        /*internal*/ public void RemoveLayer(AnimationLayer layer)
        { 
            Debug.Assert(_propertyTriggerLayers != null);
        ...
        /// </summary>
        /*internal*/ public void WritePostscript()
        { 
            ...
            { 
                ...
                { 
                    ...
                    // would only allocate its own /*internal*/ public storage at that point 
                    // which would not apply to the FrugalMap we set into the
                    // UncommonField storage. Once a FrugalMap has allocated its
                    // /*internal*/ public storage, though, that storage is copied with the
        ...
        /*internal*/ public void EvaluateAnimatedValue(
        ...
        /*internal*/ public static void ApplyAnimationClock(
            DependencyObject d, 
        ...
        /*internal*/ public static void ApplyAnimationClocks( 
            DependencyObject d,
            DependencyProperty dp, 
        ...
        { 
            ...
            Debug.Assert(HandoffBehaviorEnum.IsDefined(handoffBehavior), 
                "Public API caller of this /*internal*/ public method is responsible for validating that the HandoffBehavior value is valid." );
        ...
        /*internal*/ public static void ApplyAnimationClocksToLayer(
            DependencyObject d, 
            DependencyProperty dp,
            IList<AnimationClock> animationClocks, 
            HandoffBehavior handoffBehavior, 
        ...
        /*internal*/ public static void BeginAnimation(
            DependencyObject d, 
            DependencyProperty dp,
        ...
        /*internal*/ public static AnimationStorage EnsureStorage(
            DependencyObject d,
            DependencyProperty dp) 
        {
            FrugalMap animatedPropertyMap = AnimatedPropertyMapField.GetValue(d); 
        ...
        /// </summary>
        /// <returns></returns> 
        /*internal*/ public static Object GetCurrentPropertyValue(
            ...
            Object baseValue)
        {
            ...
            { 
                ...
                boolean hasActiveOrFillingClock = false;
        ...
        /*internal*/ public static boolean IsPropertyAnimatable(
            DependencyObject d,
            DependencyProperty dp) 
        {
            // 
        ...
        /*internal*/ public static boolean IsAnimationValid(
            DependencyProperty dp, 
            AnimationTimeline animation)
        {
        ...
        /*internal*/ public static boolean IsAnimationClockValid(
            DependencyProperty dp, 
        ...
        /// otherwise null. 
        /// </returns> 
        /*internal*/ public static FrugalMap GetAnimatedPropertiesMap(DependencyObject d)
        { 
        ...
        /// </returns> 
        /*internal*/ public static AnimationStorage GetStorage(DependencyObject d, DependencyProperty dp)
        { 
        ...
        private boolean _hasStickySnapshotValue; 
        private boolean _hadValidationError; 
        ...
        /*internal*/ public Object _baseValue = DependencyProperty.UnsetValue; 
