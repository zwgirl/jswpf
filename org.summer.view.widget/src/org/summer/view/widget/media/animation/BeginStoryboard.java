...
import org.summer.view.widget.TriggerAction;
...
public /*sealed*/ class BeginStoryboard extends TriggerAction 
{ 
    ...
    /// </summary>
    public static final DependencyProperty StoryboardProperty =
...
//    [DefaultValue(null)]
    ...
    /*internal*/public /*sealed*/ /*override*/ void Invoke( FrameworkElement fe, FrameworkContentElement fce, Style targetStyle, FrameworkTemplate frameworkTemplate, Int64 layer )
    { 
...
//            Debug.Assert( frameworkTemplate != null ); 
    ...
    /*internal*/public /*sealed*/ /*override*/ void Invoke( FrameworkElement fe ) 
    { 
