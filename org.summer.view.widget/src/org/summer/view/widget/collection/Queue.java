...
//    [System.Runtime.InteropServices.ComVisible(false)] 
    public class Queue<T> implements IEnumerable<T> //, Collection 
    {
        private T[] _array;
...
//#endif
        ...
        private /*const*/static final int _MinimumGrow = 4; 
        private /*const*/static final int _ShrinkThreshold = 32;
        private /*const*/static final int _GrowFactor = 200;  // double each time 
        private /*const*/static final int _DefaultCapacity = 4; 
...
//        }
       ...
       public boolean Contains(T item) {
        ...
        /*internal*/ public T GetElement(int i)
        { 
...
//        [SuppressMessage("Microsoft.Performance", "CA1815:OverrideEqualsAndOperatorEqualsOnValueTypes", Justification = "not an expected scenario")] 
        class Enumerator implements IEnumerator<T>, Enumerator
        {
            private Queue<T> _q; 
            ...
            /*internal*/ public Enumerator(Queue<T> q) { 
                _q = q;
