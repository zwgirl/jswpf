...
/// </devdoc>
//[Serializable]
public class HybridDictionary implements IDictionary { 
    ...
    private final int CutoverPoint = 9;
    private final int InitialHashtableSize = 13; 
    private final int FixedSizeCutoverPoint = 6;
    ...
    ///    <para>[To be supplied.]</para>
    /// </devdoc> 
    public HybridDictionary(boolean caseInsensitive) {
    ...
    ///    <para>[To be supplied.]</para>
    /// </devdoc>
    public HybridDictionary(int initialSize, boolean caseInsensitive) {
        this.caseInsensitive = caseInsensitive; 
