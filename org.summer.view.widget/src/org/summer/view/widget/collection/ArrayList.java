...
import org.summer.view.widget.utils.ArgumentOutOfRangeException;
    ...
    // of the /*internal*/ public array. As elements are added to a ArrayList, the capacity
...
//        [NonSerialized]
        ...
        /*internal*/ public ArrayList( boolean trash ) 
        {
        } 
...
//        [Serializable]
        private class IListWrapper extends ArrayList 
        { 
            private IList _list;
 
            /*internal*/ public IListWrapper(IList list) {
                _list = list;
...
//            [Serializable]
            private /*sealed*/ class IListWrapperEnumWrapper implements IEnumerator, ICloneable 
            {
                ...
                /*internal*/ public IListWrapperEnumWrapper(IListWrapper listWrapper, int startIndex, int count) 
                {
...
//        [Serializable] 
        private class SyncArrayList extends ArrayList 
        {
            private ArrayList _list; 
            private Object _root;

            /*internal*/ public SyncArrayList(ArrayList list)
            {
                super( false );
                _list = list; 
                _root = list.SyncRoot; 
...
//        [Serializable]
        private class SyncIList implements IList
        { 
            private IList _list;
            private Object _root; 
 
            /*internal*/ public SyncIList(IList list) {
                _list = list; 
                _root = list.SyncRoot;
            }
...
//        [Serializable] 
        private class FixedSizeList implements IList
        { 
            private IList _list; 

            /*internal*/ public FixedSizeList(IList l) { 
                _list = l;
            }
...
//        [Serializable] 
        private class FixedSizeArrayList extends ArrayList
        { 
            private ArrayList _list;

            /*internal*/ public FixedSizeArrayList(ArrayList l) {
                _list = l; 
...
//        [Serializable]
        private class ReadOnlyList implements IList
        {
            private IList _list; 

            /*internal*/ public ReadOnlyList(IList l) { 
                _list = l; 
            }
...
//        [Serializable] 
        private class ReadOnlyArrayList extends ArrayList
        { 
            private ArrayList _list; 

            /*internal*/ public ReadOnlyArrayList(ArrayList l) { 
                _list = l;
            }
...
//            [SuppressMessage("Microsoft.Contracts", "CC1055")]  // Skip extra error checking to avoid *potential* AppCompat problems.
        ...
        // /*internal*/ public version number of the list to ensure that no modifications are
        // made to the list while an enumeration is in progress.
//        [Serializable] 
        private /*sealed*/ class ArrayListEnumerator implements IEnumerator, ICloneable
        { 
            ...
            /*internal*/ public ArrayListEnumerator(ArrayList list, int index, int count) {
                this.list = list; 
                startIndex = index; 
                this.index = index - 1;
...
//        [Serializable]
        private class Range extends ArrayList 
        { 
...
//            [ContractPublicPropertyName("Count")]
            ...
            /*internal*/ public Range(ArrayList list, int index, int count) : base(false) {
                _baseList = list; 
                _baseIndex = index; 
                _baseSize = count;
...
//        [Serializable]
        private /*sealed*/ class ArrayListEnumeratorSimple implements IEnumerator, ICloneable {
            private ArrayList list;
            private int index; 
            private int version;
            private Object currentElement; 
//            [NonSerialized] 
            ...
            /*internal*/ public ArrayListEnumeratorSimple(ArrayList list) {
                this.list = list; 
                this.index = -1;
                version = list._version; 
        ...
        /*internal*/ public class ArrayListDebugView { 
