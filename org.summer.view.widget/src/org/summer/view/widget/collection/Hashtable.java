...
//[Serializable] 
public class Hashtable implements IDictionary, ISerializable, IDeserializationCallback, ICloneable {
    /*
    ...
    */
    ...
    /*internal*/ public final Int32 HashPrime = 101;
    private final Int32 InitialSize = 3; 
    private final String LoadFactorName = "LoadFactor";
    private final String VersionName = "Version"; 
    private final String ComparerName = "Comparer"; 
    private final String HashCodeProviderName = "HashCodeProvider";
    private final String HashSizeName = "HashSize";  // Must save buckets.Length 
    private final String KeysName = "Keys";
    private final String ValuesName = "Values";
    private final String KeyComparerName = "KeyComparer";
...
//    [Obsolete("Please use KeyComparer properties.")]
    ...
    /*internal*/ public Hashtable( boolean trash ) 
    {
    } 
...
//    [Obsolete("Please use Hashtable(IDictionary, float, IEqualityComparer) instead.")] 
    ...
    // 慖nitHash?is basically an implementation of classic DoubleHashing (see http://en.wikipedia.org/wiki/Double_hashing)
    // 
    // 1) The only 慶orrectness?requirement is that the 慽ncrement?used to probe 
    //    a. Be non-zero
    //    b. Be relatively prime to the table size 慼ashSize? (This is needed to insure you probe all entries in the table before you 憌rap?and visit entries already probed) 
    ...
    // 
    // While this works well for 憉niformly distributed?keys, in practice, non-uniformity is common.
    // In particular in practice we can see 憁ostly sequential?where you get long clusters of keys that 憄ack? 
    // To avoid bad behavior you want it to be the case that the increment is 憀arge?even for 憇mall?values (because small 
    // values tend to happen more in practice). Thus we multiply 憇eed?by a number that will make these small values
    // bigger (and not hurt large values). We picked HashPrime (101) because it was prime, and if 慼ashSize-1?is not a multiple of HashPrime 
...
//#endif 
    ...
    /*internal*/ public /*virtual*/ KeyValuePairs[] ToKeyValuePairsArray() {
...
//    [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)] 
    private void rehash( int newsize, boolean forceNewHashCode ) {
        ...
        // Don't replace any /*internal*/ public state until we've finished adding to the
        ...
        // New bucket[] is good to go - replace buckets and other /*internal*/ public state.
//#if !FEATURE_CORECLR
//        Thread.BeginCriticalRegion();
//#endif 
        isWriterInProgress = true;
...
//#endif
    ...
    // /*internal*/ public method to get the hash code for an Object.  This will call 
...
//#endif
    ...
    // /*internal*/ public method to compare two keys.  If you have provided an IComparer 
...
//    [Serializable]
    private class KeyCollection : ICollection 
    {
        ...
        /*internal*/ public KeyCollection(Hashtable hashtable) { 
...
//    [Serializable] 
    private class ValueCollection implements ICollection
    { 
        private Hashtable _hashtable;

        /*internal*/ public ValueCollection(Hashtable hashtable) {
            _hashtable = hashtable; 
        }
...
//    [Serializable]
    private class SyncHashtable implements Hashtable, IEnumerable 
    { 
        protected Hashtable _table;

        /*internal*/ public SyncHashtable(Hashtable table) : base(false) {
            _table = table;
        }

        /*internal*/ public SyncHashtable(SerializationInfo info, StreamingContext context) : base (info, context) {
...
//#endif
        ...
        **Exceptions: None
        ...
        /*internal*/ public /*override*/ KeyValuePairs[] ToKeyValuePairsArray() { 
    ...
    // /*internal*/ public version number of the hashtabke to ensure that no modifications 
    // are made to the hashtable while an enumeration is in progress. 
//    [Serializable]
    /*private*/ class HashtableEnumerator implements IDictionaryEnumerator, ICloneable 
    {
        ...
        /*internal*/ public final int Keys = 1;
        /*internal*/ public final int Values = 2;
        /*internal*/ public final int DictEntry = 3;

        /*internal*/ public HashtableEnumerator(Hashtable hashtable, int getObjRetType) {
...
//#endif 
    ...
    // /*internal*/ public debug view class for hashtable
    /*internal*/ public class HashtableDebugView {
        private Hashtable hashtable; 
...
//[FriendAccessAllowed] 
/*internal*/ public static class HashHelpers
{ 

//#if FEATURE_RANDOMIZED_STRING_HASHING
//    public final int HashCollisionThreshold = 100;
//    public static boolean s_UseRandomizedStringHashing = String.UseRandomizedHashing(); 
//#endif
    ...
    /*internal*/ public static ConditionalWeakTable<Object, SerializationInfo> SerializationInfoTable
    {
        get 
        {
...
//    [ReliabilityContract(Consistency.WillNotCorruptState, Cer.Success)] 
    ...
    public final int MaxPrimeArrayLength = 0x7FEFFFFD; 

//#if FEATURE_RANDOMIZED_STRING_HASHING 
//    public static boolean IsWellKnownEqualityComparer(Object comparer)
//    {
...
//
//    /*internal*/ public static long GetEntropy() 
//    {
//        lock(lockObj) { 
//            long ret;
//
