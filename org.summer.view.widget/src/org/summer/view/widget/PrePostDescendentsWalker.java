...
/// </summary> 
/*internal*/ public class PrePostDescendentsWalker<T> extends DescendentsWalker<T>
{ 
    //-----------------------------------------------------
    //
    //  Constructors
...
//    #region Constructors 
    ...
    { 
    	super(priority, preCallback, data);
...
//    #region Public Methods
    ...
    public /*override*/ void StartWalk(DependencyObject startNode, boolean skipStartNode)
    {
        try
        { 
            super.StartWalk(startNode, skipStartNode);
        } 
        finally 
        {
            if (!skipStartNode) 
...
//    #region Protected Methods
    ...
    protected /*override*/ void _VisitNode(DependencyObject d, boolean visitedViaVisualTree) 
    {
        try 
        { 
            super._VisitNode(d, visitedViaVisualTree);
        } 
        finally
        {
            if (_postCallback != null)
