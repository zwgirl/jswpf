...
// RoutedEvent
/*internal*/ public class ClassHandlersStore
{
//    #region Construction 

    // Constructor for ClassHandlersStore 
    /*internal*/ public ClassHandlersStore(int size) 
    {
...
//    #region Operations
	...
	/* internal */public RoutedEventHandlerInfoList AddToExistingHandlers(
			int index, Delegate handler, boolean handledEventsToo)
    {
//        Debug.Assert(index != -1, "There should exist a set of handlers for the given routedEvent"); 
    ...
    // NOTE: index must be valid, i.e. not -1 
    /*internal*/ public RoutedEventHandlerInfoList GetExistingHandlers(int index)
    { 
//        Debug.Assert(index != -1, "There should exist a set of handlers for the given index"); 
    ...
    // given routedEvent 
    /*internal*/ public int CreateHandlersLink(RoutedEvent routedEvent, RoutedEventHandlerInfoList handlers) 
    {
//        Debug.Assert(GetHandlersIndex(routedEvent) == -1, "There should not exist a set of handlers for the given routedEvent"); 
    ...
    /*internal*/ public void UpdateSubClassHandlers(
...
//        Debug.Assert(baseClassListeners != null, "Update only when there are base class listeners to be updated"); 
        ...
        if (index != -1) 
        {
            boolean hasSelfHandlers = _eventHandlersList.List[index].HasSelfHandlers; 
    ...
    /*internal*/ public int GetHandlersIndex(RoutedEvent routedEvent)
    { 
        // Linear Search 
