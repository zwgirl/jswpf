...
public class UIElementCollection extends IList
{ 
    /// <summary>
    ...
    /*internal*/public void RemoveInternal(UIElement element) 
    {
    ...
    /// For more details, see <see cref="System.Windows.Media.VisualCollection" />
    /// </summary> 
    /*internal*/ /*virtual*/public void RemoveNoVerify(UIElement element) 
    {
        _visualChildren.Remove(element); 
    }
    ...
    /// For more details, see <see cref="System.Windows.Media.VisualCollection" />
    /// </summary> 
    public /*virtual*/ boolean Contains(UIElement element) 
    {
...
//    #endregion 
    ...
    private final VisualCollection _visualChildren; 
    private final UIElement _visualParent;
    private final FrameworkElement _logicalParent;
