...
import org.summer.view.widget.VerticalAlignment;
...
//    [CommonDependencyProperty]
    public static final DependencyProperty BorderBrushProperty
...
//    [Bindable(true), Category("Appearance")] 
    ...
    /// </summary> 
//    [CommonDependencyProperty]
    public static final DependencyProperty BorderThicknessProperty 
...
//    [Bindable(true), Category("Appearance")] 
    ...
    /// </summary>
//    [CommonDependencyProperty] 
    public static final DependencyProperty HorizontalContentAlignmentProperty =
...
//    [Bindable(true), Category("Layout")]
    ...
    /// </summary> 
//    [CommonDependencyProperty]
    public static final DependencyProperty VerticalContentAlignmentProperty = 
                DependencyProperty.Register(
...
//    [Bindable(true), Category("Behavior")] 
    ...
    { 
        get { return (boolean) GetValue(IsTabStopProperty); } 
...
//    [CommonDependencyProperty]
    ...
    /*internal*/ /*override*/public FrameworkTemplate TemplateCache 
    {
        get { return _templateCache; }
    ...
    /*internal*/ boolean VisualStateChangeSuspended
    { 
...
//    #region Events 
    ...
    /// </summary>
    public static final RoutedEvent PreviewMouseDoubleClickEvent = EventManager.RegisterRoutedEvent("PreviewMouseDoubleClick", RoutingStrategy.Direct, typeof(MouseButtonEventHandler), typeof(Control)); 
    ...
    /// </summary> 
    public static final RoutedEvent MouseDoubleClickEvent = EventManager.RegisterRoutedEvent("MouseDoubleClick", RoutingStrategy.Direct, typeof(MouseButtonEventHandler), typeof(Control));
...
//    #region Methods
    ...
    /// </summary> 
    /*internal*/ /*override*/ public void OnPostApplyTemplate() 
    {
    	super.OnPostApplyTemplate(); 
    ...
    /// </param>
    /*internal*/ void UpdateVisualState(boolean useTransitions) 
    {
...
//        EventTrace.EasyTraceEvent(EventTrace.Keyword.KeywordGeneral | EventTrace.Keyword.KeywordPerf, EventTrace.Level.Info, EventTrace.Event.UpdateVisualStateEnd);
    ...
    ///     snap directly to the new visual state.
    /// </param>
    /*internal*/ /*virtual*/ void ChangeVisualState(boolean useTransitions)
    { 
    ...
    /*internal*/public void ChangeValidationVisualState(boolean useTransitions) 
    {
    ...
    { 
        ...
        // non-controls. 
    	Control control = (Control) (d instanceof Control ? d :null);
        if (control != null)
        {
    ...
    /*internal*/ boolean ReadControlFlag(ControlBoolFlags reqFlag) 
    {
        return (_controlBoolField & reqFlag) != 0;
    }

    /*internal*/ void WriteControlFlag(ControlBoolFlags reqFlag, boolean set)
    { 
        if (set) 
        {
