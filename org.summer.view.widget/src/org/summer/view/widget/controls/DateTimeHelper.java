...
import org.summer.view.widget.globalization.DateTimeFormatInfo;
...
// NOTICE: This date time helper assumes it is working in a Gregorian calendar
    ...
    /*internal*/ public /*static*/ class DateTimeHelper 
    {
        ...
        /*internal*/ public static CultureInfo GetCulture(FrameworkElement element)
        {
            bool hasModifiers;
            CultureInfo culture; 
        ...
        /*internal*/ public static DateTimeFormatInfo GetDateFormat(CultureInfo culture) 
        {
