...
import static org.summer.view.widget.FrameworkElement.FindTemplateResourceInternal;
...
import org.summer.view.widget.HierarchicalDataTemplate;
...
//    [Bindable(true), CustomCategory("Content")] 
    ...
    /// </summary> 
    private static final DependencyPropertyKey HasHeaderPropertyKey =
    ...
    /// </summary> 
//    [CommonDependencyProperty]
    public static final DependencyProperty HasHeaderProperty = HeaderedContentControl.HasHeaderProperty.AddOwner(typeof(HeaderedItemsControl)); 
...
//    #region /*internal*/ public Methods
    ...
    /// </summary> 
    /*internal*/ public void PrepareHeaderedItemsControl(Object item, ItemsControl parentItemsControl)
    { 
        boolean headerIsNotLogical = item != this;
    ...
    /// </summary> 
    /*internal*/ public void ClearHeaderedItemsControl(Object item)
    { 
...
//    #region Private methods
    ...
    void PrepareHierarchy(Object item, ItemsControl parentItemsControl) 
    {
        ...
        if (hTemplate != null)
        { 
            boolean templateMatches = (ItemTemplate == parentItemsControl.ItemTemplate);
            boolean containerStyleMatches = (ItemContainerStyle == parentItemsControl.ItemContainerStyle);
            ...
            if (hTemplate.IsItemStringFormatSet && ItemStringFormat == parentItemsControl.ItemStringFormat) 
            {
                ...
                boolean setItemStringFormat = (hTemplate.ItemStringFormat != null); 
            ...
            if (hTemplate.IsItemTemplateSelectorSet && ItemTemplateSelector == parentItemsControl.ItemTemplateSelector) 
            {
                ...
                ClearValue(ItemTemplateSelectorProperty);
                boolean setItemTemplateSelector = (hTemplate.ItemTemplateSelector != null); 
            ...
            if (hTemplate.IsItemTemplateSet && templateMatches) 
            {
                ...
                ClearValue(ItemTemplateProperty); 
                boolean setItemTemplate = (hTemplate.ItemTemplate != null);
                if (setItemTemplate) 
                {
            ...
            { 
                ...
                boolean setItemContainerStyleSelector = (hTemplate.ItemContainerStyleSelector != null);
            ...
            { 
                ...
                ClearValue(ItemContainerStyleProperty); 
                boolean setItemContainerStyle = (hTemplate.ItemContainerStyle != null); 
            ...
            { 
                ...
                boolean setAlternationCount = true; 
            ...
            if (hTemplate.IsItemBindingGroupSet && ItemBindingGroup == parentItemsControl.ItemBindingGroup) 
            {
                ...
                boolean setItemBindingGroup = (hTemplate.ItemBindingGroup != null);
    ...
    boolean IsBound(DependencyProperty dp, Binding binding)
    { 
