...
///<summary>
    ...
    ///</summary>
    /// <remarks>
    /// The WebBrowser class is currently not thread safe. Multi-threading could corrupt the class /*internal*/ public state,
    /// which could lead to security exploits (see example in devdiv bug #196538). So we enforce thread affinity. 
    /// </remarks>
    public /*sealed*/ class WebBrowser extends ActiveXHost 
    { 
        //----------------------------------------------
        // 
        // Constructors
...
//        [ SecurityCritical ]
        ...
        {
        	super(new Guid(CLSID.WebBrowser), true );
...
//        [SecurityCritical] 
        public Object InvokeScript(String scriptName, params Object[] args) 
        {
            ...
            // If it is our /*internal*/ public navigation to blank for navigating to null or load stream,
...
//        #region Internal Methods 
        ...
        /*internal*/ public void OnNavigating(NavigatingCancelEventArgs e)
        {
            VerifyAccess(); 
        ...
        /*internal*/ public void OnNavigated(NavigationEventArgs e)
        { 
            VerifyAccess();
        ...
        /*internal*/ public void OnLoadCompleted(NavigationEventArgs e) 
        {
            VerifyAccess(); 
        ...
        /// </SecurityNote>
//        [SecurityCritical] 
        /*internal*/ public /*override*/ Object CreateActiveXObject(Guid clsid)
        {
        ...
        /// </SecurityNote>
//        [SecurityCritical] 
        /*internal*/ public /*override*/ void AttachInterfaces(Object nativeActiveXObject) 
        {
            //cache the interface 
        ...
        /// </SecurityNote>
        [SecurityCritical, SecurityTreatAsSafe]
        /*internal*/ public /*override*/ void DetachInterfaces()
        { 
        ...
        ///</SecurityNote> 
//        [ SecurityCritical, SecurityTreatAsSafe ] 
        /*internal*/ public /*override*/ void CreateSink()
        { 
        ...
        /// </SecurityNote>
//        [SecurityCritical] 
        /*internal*/ public /*override*/ void DetachSink()
        { 
...
//        [SecurityCritical]
        /*internal*/ public /*override*/ ActiveXSite CreateActiveXSite() 
        {
        ...
        /// </SecurityNote> 
//        [SecurityCritical, SecurityTreatAsSafe]
        /*internal*/ public /*override*/ System.Windows.Media.DrawingGroup GetDrawing()
        {
        ...
        /// <summary>
        ///     Cleans the /*internal*/ public state used by NavigateToStream/NavigateToString. 
        /// </summary>
        /// <SecurityNote>
        ///     Critical - Resets NavigatingToAboutBlank which is used in security decisions.
        /// </SecurityNote> 
//        [SecurityCritical]
        /*internal*/ public void CleanInternalState() 
        { 
...
//        #region Internal Properties
        ...
        /// </SecurityNote> 
        /*internal*/ public UnsafeNativeMethods.IHTMLDocument2 NativeHTMLDocument
        { 
//            [SecurityCritical]
            get
            {
...
//        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        /*internal*/ public UnsafeNativeMethods.IWebBrowser2 AxIWebBrowser2 
        { 
            [SecurityCritical]
            get 
            {
        ...
        /*internal*/ public WebOCHostingAdaptor HostingAdaptor { get { return _hostingAdaptor; } } 

        /*internal*/ public Stream DocumentStream 
        {
            get
            {
        ...
        /// </SecurityNote>
        /*internal*/ public boolean NavigatingToAboutBlank 
        { 
            get
            { 
...
//            [SecurityCritical]
        ...
        /// </SecurityNote>
        /*internal*/ public Guid LastNavigation 
        {
            get
            {
...
//            [SecurityCritical] 
        ...
        /// </SecurityNote>
        /*internal*/ public static boolean IsWebOCHostedInBrowserProcess 
        { 
            get
            { 
                if(!IsWebOCPermissionRestricted)
...
//        #region Internal Fields 
        ...
        /*internal*/ public boolean _canGoBack; 
        /*internal*/ public boolean _canGoForward; 
        /*internal*/ public final String AboutBlankUriString = "about:blank";
...
//        [SecurityCritical, SecurityTreatAsSafe] 
        private void LoadedHandler(Object sender, RoutedEventArgs args) 
        {
            ...
            if (pSource != null && pSource.RootVisual instanceof PopupRoot)
            { 
...
//            Justification="CoInternetSetFeatureEnabled() returns error for an unknown FCK. We expect this to happen with older versions of IE.")] 
        ...
        ///</SecurityNote> 
//        [SecurityCritical, SecurityTreatAsSafe]
        private void DoNavigate(Uri source, ref Object targetFrameName, ref Object postData, ref Object headers, boolean ignoreEscaping = false) 
        {
            VerifyAccess();

            // TFS Dev10 451846 - Calling Navigate and NavigateToStream subsequently causes /*internal*/ public state 
            ...
            // we've already overwritten /*internal*/ public state (more specifically the NavigatingToAboutBlank and 
            ...
            { 
                // Clear /*internal*/ public state if Navigation fails.
                CleanInternalState();
        ...
        ///</SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe]
        protected /*override*/ boolean TranslateAcceleratorCore(ref MSG msg, ModifierKeys modifiers)
        { 
            SyncUIActiveState();
...
//        [SecurityCritical]
        protected /*override*/ boolean TabIntoCore(TraversalRequest request)
        {
            ...
            boolean activated = DoVerb(NativeMethods.OLEIVERB_UIACTIVATE); 
...
//        #region Private Fields
        ...
        private static final boolean IsWebOCPermissionRestricted =
...
//        [SecurityCritical]
        ...
        ///              for example, when attempting a navigation that is canceled or fails.
        /// </SecurityNote>
        private SecurityCriticalDataForSet<Boolean>                    _navigatingToAboutBlank;
...
//        #region Private Class
        ...
        /// </summary>
        /*internal*/ public class WebOCHostingAdaptor 
        { 
            /*internal*/ public WebOCHostingAdaptor(WebBrowser webBrowser)
            { 
                _webBrowser = webBrowser;
            }

            /*internal*/ public /*virtual*/ Object ObjectForScripting 
            {
            ...
            /// </SecurityNote> 
            [SecurityCritical]
            /*internal*/ public /*virtual*/ Object CreateWebOC() 
            { 
            ...
            /// </SecurityNote>
//            [SecurityCritical] 
            /*internal*/ public /*virtual*/ Object CreateEventSink()
            { 
        ...
        /// </summary> 
        private class WebOCHostedInBrowserAdaptor extends WebOCHostingAdaptor 
        {
            /*internal*/ public WebOCHostedInBrowserAdaptor(WebBrowser webBrowser) : base(webBrowser) { } 
...
//            [SecurityCritical, SecurityTreatAsSafe] 
            ...
            /// </SecurityNote>
            /*internal*/ public /*override*/ Object ObjectForScripting 
            {
//                [SecurityCritical, SecurityTreatAsSafe]
                get
                { 
...
//                [SecurityCritical, SecurityTreatAsSafe]
            ...
            /// </SecurityNote> 
//            [SecurityCritical]
            /*internal*/ public /*override*/ Object CreateWebOC()
            {
            ...
            /// </SecurityNote>
//            [SecurityCritical] 
            /*internal*/ public /*override*/ Object CreateEventSink()
            { 
