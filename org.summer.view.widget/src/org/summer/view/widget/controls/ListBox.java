...
//    #region Public Properties
    ...
    private static boolean IsValidSelectionMode(Object o)
    { 
    ...
    /// </summary>
    public static final DependencyProperty SelectedItemsProperty = Selector.SelectedItemsImplProperty;
...
//    #region Protected Methods 
    ...
    protected boolean SetSelectedItems(IEnumerable selectedItems) 
    {
    ...
    { 
        ...
        super.AdjustItemInfosAfterGeneratorChangeOverride(); 
    }
    ...
    { 
        ...
        switch (key) 
        {
            ...
            case Key.Right: 
                {
                    ...
                    boolean shouldScroll = ScrollHost != null; 
                    if (shouldScroll)
                    { 
                        shouldScroll = 
            ...
            case Key.Enter: 
                {
                    if (e.Key == Key.Enter && (boolean)GetValue(KeyboardNavigation.AcceptsReturnProperty) == false)
                    {
                        handled = false; 
                        break;
                    } 
...
//    #region Private Methods
    ...
    /*internal*/public void NotifyListItemClicked(ListBoxItem item, MouseButton mouseButton)
    { 
        ...
        { 
            case SelectionMode.Single:
                { 
                    if (!item.IsSelected)
                    {
                        item.SetCurrentValueInternal(IsSelectedProperty, true);
                    } 
                    else if ((Keyboard.Modifiers & ModifierKeys.Control) == ModifierKeys.Control)
                    { 
                        item.SetCurrentValueInternal(IsSelectedProperty, false); 
                    }
    ...
    private void MakeToggleSelection(ListBoxItem item) 
    {
        ...
        item.SetCurrentValueInternal(IsSelectedProperty, select);

        UpdateAnchorAndActionItem(ItemInfoFromContainer(item)); 
    }

    private void MakeAnchorSelection(ListBoxItem actionItem, boolean clearCurrent) 
    {
        ...
        boolean beganSelectionChange = false;
    ...
    private void MakeKeyboardSelection(ListBoxItem item)
    {
        ...
        { 
            ...
            case SelectionMode.Extended: 
                ...
                { 
                    boolean clearCurrentSelection = (Keyboard.Modifiers & ModifierKeys.Control) == 0; 
    ...
    /// </summary> 
    /*internal*/ /*override*/ boolean FocusItem(ItemInfo info, ItemNavigateArgs itemNavigateArgs)
    { 
