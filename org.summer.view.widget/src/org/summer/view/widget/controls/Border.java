...
//    [CommonDependencyProperty]
    ...
    private static boolean IsThicknessValid(Object value)
    { 
...
//    #region Protected Methods
    ...
    { 
        ...
        boolean uniformCorners = AreUniformCorners(radii);
            ...
            &&  borderBrush != null )
        {
            ...
            boolean uniformBorders = borders.IsUniform;
    ...
    protected /*override*/ void OnRender(DrawingContext dc) 
    {
        ...
        else 
        {
            ...
            boolean roundedCorners = !DoubleUtil.IsZero(outerCornerRadius);
...
//    #region Private Methods 
    ...
    private static boolean AreUniformCorners(CornerRadius borderRadii)
    { 
...
//    #region Private Fields
    ...
    private boolean _useComplexRenderCodePath;

//    #endregion Private Fields 

//    #region Cache 

    private static final UncommonField<StreamGeometry> BorderGeometryField = new UncommonField<StreamGeometry>();
    private static final UncommonField<StreamGeometry> BackgroundGeometryField = new UncommonField<StreamGeometry>();
    private static final UncommonField<Pen> LeftPenField = new UncommonField<Pen>(); 
    private static final UncommonField<Pen> RightPenField = new UncommonField<Pen>();
    private static final UncommonField<Pen> TopPenField = new UncommonField<Pen>(); 
    private static final UncommonField<Pen> BottomPenField = new UncommonField<Pen>(); 
...
//    #region Private Structures Classes
    ...
    private class Radii 
    {
        /*internal*/ public Radii(CornerRadius radii, Thickness borders, boolean outer) 
        { 
        ...
        /*internal*/ public double LeftTop;
        /*internal*/ public double TopLeft;
        /*internal*/ public double TopRight; 
        /*internal*/ public double RightTop;
        /*internal*/ public double RightBottom; 
        /*internal*/ public double BottomRight; 
        /*internal*/ public double BottomLeft;
        /*internal*/ public double LeftBottom; 
    }
