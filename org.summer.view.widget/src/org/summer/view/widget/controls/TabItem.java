...
//    private void RaiseAutomationIsSelectedChanged(boolean oldValue, boolean newValue)
//    {
...
//    #region TabStripPlacement
    ...
    /// </summary>
    private static final DependencyPropertyKey TabStripPlacementPropertyKey =
...
//    #region Protected Methods 
    ...
    {
    	super.OnPreviewGotKeyboardFocus(e); 
        if (!e.Handled && e.NewFocus == this)
        { 
            if (!IsSelected && TabControlParent != null) 
            {
                SetCurrentValueInternal(IsSelectedProperty, true); 
                ...
                { 
                    ...
                    if (parentTabControl != null) 
                    {
                        ...
                        { 
                            ...
                            boolean success = selectedContentPresenter.MoveFocus(new TraversalRequest(FocusNavigationDirection.First));
    ...
    {
    	super.OnContentTemplateSelectorChanged(oldContentTemplateSelector, newContentTemplateSelector); 
...
//    #region Private Methods
    ...
    /*internal*/public boolean SetFocus()
    { 
        ...
        if (!GetBoolField(BoolField.SettingFocus)) 
        {
            ...
            boolean setFocusOnContent = ((currentFocus == this) || (currentFocus == null) || (currentFocus.TabControlParent != this.TabControlParent));
