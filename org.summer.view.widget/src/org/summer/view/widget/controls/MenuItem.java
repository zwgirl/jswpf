...
import org.summer.view.widget.controls.primitives.ButtonBase;
...
import org.summer.view.widget.input.InputGestureCollection;
...
import org.summer.view.window.ComponentResourceKey;
...
//    #region Constructors
    ...
    { 
        ...
        EventManager.RegisterClassHandler(typeof(MenuItem), MenuBase.IsSelectedChangedEvent, new RoutedPropertyChangedEventHandler<boolean>(OnIsSelectedChanged)); 
...
//    #region Public Events 
    ...
    /// </summary>
    public static final RoutedEvent ClickEvent = EventManager.RegisterRoutedEvent("Click", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(MenuItem));
...
//    [Category("Behavior")]
    ...
    /// </summary> 
    /*internal*/ public static final RoutedEvent PreviewClickEvent = EventManager.RegisterRoutedEvent("PreviewClick", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(MenuItem));

    /// <summary>
    ///     Checked event
    /// </summary>
    public static final RoutedEvent CheckedEvent = EventManager.RegisterRoutedEvent("Checked", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(MenuItem)); 

    /// <summary> 
    ///     Unchecked event 
    /// </summary>
    public static final RoutedEvent UncheckedEvent = EventManager.RegisterRoutedEvent("Unchecked", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(MenuItem)); 
...
//    [Category("Behavior")] 
    ...
    /// </summary>
    public static final RoutedEvent SubmenuOpenedEvent = 
    ...
    /// </summary> 
    public static final RoutedEvent SubmenuClosedEvent =
...
//    [Bindable(true), Category("Action")] 
    ...
    ///     Default Value:      false
    /// </summary> 
    public static final DependencyProperty IsSubmenuOpenProperty = 
...
//    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    ...
    {
        get { return (boolean) GetValue(IsSubmenuOpenProperty); } 
...
//		        }),   //曹永猛 comment
    ...
    { 
        ...
        { 
            ...
            menuItem.Dispatcher.BeginInvoke(DispatcherPriority.Background, 
//            		new DispatcherOperationCallback(delegate(Object param) 
//		            {
...
//		            }),   // 曹永猛 注释
    ...
    /// </summary> 
    private static final DependencyPropertyKey RolePropertyKey = 
    ...
    /// </summary> 
    public static final DependencyProperty RoleProperty =
...
//    [Category("Behavior")] 
    ...
    ///     Default Value:      false
    /// </summary>
    public static final DependencyProperty IsCheckableProperty =
            DependencyProperty.Register( 
                    "IsCheckable",
                    typeof(Boolean), 
                    typeof(MenuItem), 
...
//    [Bindable(true), Category("Behavior")] 
    ...
    ///     Default Value:      false
    /// </summary> 
    private static final DependencyPropertyKey IsPressedPropertyKey =
            DependencyProperty.RegisterReadOnly( 
                    "IsPressed", 
                    typeof(Boolean),
                    typeof(MenuItem), 
    ...
    ///     Default Value:      false 
    /// </summary> 
    public static final DependencyProperty IsPressedProperty = IsPressedPropertyKey.DependencyProperty;
...
//    [Browsable(false), Category("Appearance")]
    ...
    ///     Default Value:      false 
    /// </summary>
    public static final DependencyProperty IsCheckedProperty = 
            DependencyProperty.Register( 
                    "IsChecked",
                    typeof(Boolean), 
                    typeof(MenuItem),
...
//    [Bindable(true), Category("Appearance")]
    ...
    ///     Default Value:      false
    /// </summary>
    public static final DependencyProperty StaysOpenOnClickProperty =
            DependencyProperty.Register( 
                    "StaysOpenOnClick",
                    typeof(Boolean), 
                    typeof(MenuItem), 
    ...
    /// </summary>
//    [Bindable(true), Category("Behavior")] 
    public boolean StaysOpenOnClick
    { 
        get { return (boolean) GetValue(StaysOpenOnClickProperty); } 
    ...
    ///     focusless menus.
    /// </summary> 
    /*internal*/ public boolean IsSelected 
    {
    ...
    /// </summary> 
    /*internal*/ public static final DependencyProperty IsSelectedProperty = 
    ...
    { 
        ...
        menuItem.RaiseEvent(new RoutedPropertyChangedEventArgs<Boolean>((boolean) e.OldValue, (boolean) e.NewValue, MenuBase.IsSelectedChangedEvent)); 
    }

    /// <summary> 
    ///     Called when IsSelected changed on this element or any descendant.
    /// </summary> 
    private static void OnIsSelectedChanged(Object sender, RoutedPropertyChangedEventArgs<Boolean> e)
    {
    ...
    /// </summary>
    public static final DependencyProperty InputGestureTextProperty =
            DependencyProperty.Register(
                    "InputGestureText", 
                    typeof(String),
                    typeof(MenuItem), 
...
//    [Bindable(true), CustomCategory("Content")] 
    ...
    private static final DependencyPropertyKey IsSuspendingPopupAnimationPropertyKey
        = DependencyProperty.RegisterReadOnly("IsSuspendingPopupAnimation", typeof(Boolean), typeof(MenuItem), 
                                      new FrameworkPropertyMetadata(BooleanBoxes.FalseBox)); 

    /// <summary> 
    /// Returns true if the Menu should suspend animations on its popup
    /// </summary>
    public static final DependencyProperty IsSuspendingPopupAnimationProperty = IsSuspendingPopupAnimationPropertyKey.DependencyProperty;

    /// <summary>
    /// Returns true if the Menu should suspend animations on its popup 
    /// </summary> 
//    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public boolean IsSuspendingPopupAnimation 
    {
        get
        {
            return (boolean)GetValue(IsSuspendingPopupAnimationProperty); 
        }
        /*internal*/ public set 
        { 
    ...
    { 
        ...
        { 
            boolean openedWithKeyboard = MenuItem.GetBoolField(this, BoolField.OpenedWithKeyboard);
...
//#endif 
    ...
    /// </summary>
    /*internal*/ public static void PrepareMenuItem(DependencyObject element, Object item)
    { 
...
//    [SecurityCritical, SecurityTreatAsSafe]
    ...
    /// </SecurityNote>
//    [SecurityCritical]
    /*internal*/ public /*virtual*/ void OnClickCore(boolean userInitiated)
    { 
        OnClick();
    } 
    ...
    /// </SecurityNote>
//    [SecurityCritical]
    /*internal*/ public void OnClickImpl(boolean userInitiated) 
    {
        if (IsCheckable) 
        { 
...
//    [SecurityCritical]
    ...
    {
        boolean userInitiated = (boolean)arg;
    ...
    /// <param name="e"></param>
    /// <SecurityNote> 
    ///     Critical: Sets an /*internal*/ public variable in case input was user initiated and button was pressed
...
//    [SecurityCritical]
    ...
    {
        boolean ret = (item instanceof MenuItem) || (item instanceof Separator); 
        if (!ret)
        {
            _currentItem = item;
        } 
...
//    #region Private Methods
    ...
    private void SetMenuMode(boolean menuMode)
    { 
    ...
    /// </summary>
    private boolean OpenOnMouseEnter 
    {
        get 
        { 
            MenuBase parentMenu = LogicalParent as MenuBase;
    ...
    /*internal*/ public static final DependencyProperty InsideContextMenuProperty
        = DependencyProperty.RegisterAttached("InsideContextMenu", typeof(Boolean), typeof(MenuItem),
                                      new FrameworkPropertyMetadata(BooleanBoxes.FalseBox, FrameworkPropertyMetadataOptions.Inherits)); 

//    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] 
    private boolean InsideContextMenu 
    {
        get 
        {
            return (boolean)GetValue(InsideContextMenuProperty);
        }
    } 

    /*internal*/ public static void SetInsideContextMenuProperty(UIElement element, boolean value) 
    { 
    ...
    /// </SecurityNote>
//    [SecurityCritical, SecurityTreatAsSafe] 
    /*internal*/ public void ClickItem()
    {
        ClickItem(false);
    } 
    /// <SecurityNote>
    ...
    /// </SecurityNote>
//    [SecurityCritical] 
    private void ClickItem(boolean userInitiated)
    {
        try
        { 
    ...
    /*internal*/ public void ClickHeader()
    { 
        if (!IsKeyboardFocusWithin)
        {
            FocusOrSelect();
    ...
    /*internal*/ public boolean OpenMenu()
    { 
        if (!IsSubmenuOpen)
        { 
    ...
    /// </summary>
    /*internal*/ public void OpenSubmenuWithKeyboard()
    {
    ...
    private boolean MenuItemNavigate(Key key, ModifierKeys modifiers)
    { 
    ...
    /// </summary>
    /// <value></value> 
    /*internal*/ public Object LogicalParent
    { 
        get 
        {
            if (Parent != null) 
    ...
    ///     in that case too. 
    /// </summary>
    private boolean IsMouseOverSibling 
    { 
        get
        { 
    ...
    private static boolean IsMouseReallyOver(FrameworkElement elem)
    { 
        boolean isMouseOver = elem.IsMouseOver;
...
//    #region Private Fields
    ...
    private static final DependencyProperty BooleanFieldStoreProperty = DependencyProperty.RegisterAttached(
        "BooleanFieldStore", 
        typeof(BoolField), 
        typeof(MenuItem),
    ...
    private static boolean GetBoolField(UIElement element, BoolField field)
    { 
        return (((BoolField)element.GetValue(BooleanFieldStoreProperty)) & field) != 0;
    } 

    private static void SetBoolField(UIElement element, BoolField field, boolean value)
    { 
        if (value)
        {
...
//    [Flags]
    ...
    /// </SecurityNote> 
//    [SecurityCritical]
    private boolean _userInitiatedPress;
//    #endregion
