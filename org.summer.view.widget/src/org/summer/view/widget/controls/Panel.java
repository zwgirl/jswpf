...
//    #region Public Methods 
    ...
    { 
        ...
        UIElement uie = (UIElement) (value instanceof UIElement ? value : null);
...
//    [EditorBrowsable(EditorBrowsableState.Never)]
    public boolean ShouldSerializeChildren() 
    {
        if (!IsItemsHost)
        {
    ...
    ///     Default Value:      false
    /// </summary> 
    public static final DependencyProperty IsItemsHostProperty =
...
//    [Bindable(false), Category("Behavior")] 
    public boolean IsItemsHost
    { 
        get { return (boolean) GetValue(IsItemsHostProperty); }
    ...
    { 
        ...
        panel.OnIsItemsHostChanged((boolean) e.OldValue, (boolean) e.NewValue); 
    }
    ...
    protected /*virtual*/ void OnIsItemsHostChanged(boolean oldIsItemsHost, boolean newIsItemsHost)
    { 
        ...
        ItemsControl itemsControl = (ItemsControl) (parent instanceof ItemsControl ? parent: null); 
        ...
        { 
            GroupItem groupItem = (GroupItem) (parent instanceof GroupItem ? parent : null);
            if (groupItem != null) 
            { 
    ...
    /// </summary> 
    public boolean HasLogicalOrientationPublic
    {
    ...
    /// </summary>
    protected /*internal*/ /*virtual*/ boolean HasLogicalOrientation 
    {
        get { return false; }
    }
...
//    #region Internal Properties
    ...
    // 
    /*internal*/public boolean VSP_IsVirtualizing
    { 
        get
        {
    ...
    // Bool field used by VirtualizingStackPanel 
    //
    /*internal*/public boolean VSP_HasMeasured 
    { 
        get
        { 
    ...
    // Bool field used by VirtualizingStackPanel
    // 
    /*internal*/public boolean VSP_MustDisableVirtualization
    { 
        get 
        {
    ...
    // Bool field used by VirtualizingStackPanel
    //
    /*internal*/ boolean VSP_IsPixelBased
    { 
        get
        { 
    ...
    // Bool field used by VirtualizingStackPanel
    // 
    /*internal*/ boolean VSP_InRecyclingMode
    {
        get
        { 
    ...
    // Bool field used by VirtualizingStackPanel 
    // 
    /*internal*/ boolean VSP_MeasureCaches
    { 
        get
        {
...
//    #region Private Methods
    ...
    private boolean VerifyBoundState() 
    {
        ...
        boolean isItemsHost = (ItemsControl.GetItemsOwnerInternal(this) != null); 
    ...
    /*internal*/public boolean IsDataBound
    { 
        get 
        {
    ...
    /*internal*/public static boolean IsAboutToGenerateContent(Panel panel)
    { 
...
//        Debug.Assert(_itemContainerGenerator != null, "Attempted to disconnect from a generator when Panel._itemContainerGenerator is null.");
    ...
    /*internal*/public void EnsureGenerator() 
    {
//        Debug.Assert(IsItemsHost, "Should be invoked only on an ItemsHost panel");
    ...
    /*internal*/ /*virtual*/public void GenerateChildren()
    { 
...
//            Debug.Assert(_itemContainerGenerator != null, "Encountered a null _itemContainerGenerator while receiving an ItemsChanged from a generator.");
            ...
            boolean affectsLayout = OnItemsChangedInternal(sender, args);
    ...
    /*internal*/public /*virtual*/ boolean OnItemsChangedInternal(Object sender, ItemsChangedEventArgs args)
    {
        switch (args.Action) 
        {
...
//    [System.Flags]
    ...
    private final int c_zDefaultValue = 0;              //  default ZIndexProperty value 
...
//    #region ZIndex Support
    ...
    /// </summary>
    public static final DependencyProperty ZIndexProperty =
