...
import org.summer.view.widget.controls.internal.EmptyEnumerable;
...
public /*sealed*/ class ItemCollection extends CollectionView implements IList, IEditableCollectionViewAddNewItem, ICollectionViewLiveShaping, IItemProperties, IWeakEventListener 
{ 
    //-----------------------------------------------------
    // 
    //  Constructors
...
//    #region Constructors
    ...
    { 
        super(EmptyEnumerable.Instance, false);
...
//    #region IList 
    ...
    { 
        ...
        ModelParent.SetValue(ItemsControl.HasItemsPropertyKey, true); 
        return index;
    }
...
//    #region Adding new items
    ...
    /// where to put it. 
    /// </summary>
    public NewItemPlaceholderPosition /*IEditableCollectionView.*/NewItemPlaceholderPosition 
    {
        get
        {
    ...
    /// </summary>
    public boolean    /*IEditableCollectionView.*/CanAddNew 
    {
        get 
        { 
            IEditableCollectionView ecv = _collectionView as IEditableCollectionView;
    ...
    /// </summary> 
    public Object  /*IEditableCollectionView.*/AddNew()
    { 
        IEditableCollectionView ecv = _collectionView as IEditableCollectionView;
        if (ecv != null)
        {
    ...
    /// </summary>
    public void    /*IEditableCollectionView.*/CommitNew() 
    {
        IEditableCollectionView ecv = _collectionView as IEditableCollectionView;
        if (ecv != null)
        { 
    ...
    /// </summary> 
    public void    /*IEditableCollectionView.*/CancelNew()
    { 
        IEditableCollectionView ecv = _collectionView as IEditableCollectionView;
        if (ecv != null)
        {
    ...
    /// </summary>
    public boolean    /*IEditableCollectionView.*/IsAddingNew 
    { 
        get
        { 
            IEditableCollectionView ecv = _collectionView as IEditableCollectionView;
    ...
    /// </summary> 
    public Object  /*IEditableCollectionView.*/CurrentAddItem
    { 
        get
        {
            IEditableCollectionView ecv = _collectionView as IEditableCollectionView;
...
//    #region Removing items
    ...
    /// </summary> 
    public boolean    /*IEditableCollectionView.*/CanRemove
    { 
        get 
        {
            IEditableCollectionView ecv = _collectionView as IEditableCollectionView; 
    ...
    /// </summary> 
    public void    /*IEditableCollectionView.*/RemoveAt(int index)
    { 
        IEditableCollectionView ecv = _collectionView as IEditableCollectionView;
        if (ecv != null)
        {
    ...
    /// </summary>
    public void    /*IEditableCollectionView.*/Remove(Object item) 
    { 
        IEditableCollectionView ecv = _collectionView as IEditableCollectionView;
        if (ecv != null) 
        {
...
//    #region Transactional editing of an item
    ...
    /// </summary>
    public void    /*IEditableCollectionView.*/EditItem(Object item)
    { 
        IEditableCollectionView ecv = _collectionView as IEditableCollectionView;
        if (ecv != null) 
        { 
    ...
    /// </summary>
    public void    /*IEditableCollectionView.*/CommitEdit()
    {
        IEditableCollectionView ecv = _collectionView as IEditableCollectionView; 
        if (ecv != null)
        { 
    ...
    /// </summary> 
    public void    /*IEditableCollectionView.*/CancelEdit()
    {
        IEditableCollectionView ecv = _collectionView as IEditableCollectionView;
        if (ecv != null) 
        {
    ...
    /// changes.
    /// </summary>
    public boolean    /*IEditableCollectionView.*/CanCancelEdit 
    {
        get 
        { 
            IEditableCollectionView ecv = _collectionView as IEditableCollectionView;
    ...
    /// </summary> 
    public boolean    /*IEditableCollectionView.*/IsEditingItem
    { 
        get 
        {
            IEditableCollectionView ecv = _collectionView as IEditableCollectionView; 
    ...
    /// </summary> 
    public Object  /*IEditableCollectionView.*/CurrentEditItem 
    {
        get 
        {
            IEditableCollectionView ecv = _collectionView as IEditableCollectionView;
...
//    #region IEditableCollectionViewAddNewItem 
    ...
    /// </summary> 
    public boolean    /*IEditableCollectionViewAddNewItem.*/CanAddNewItem
    { 
        get 
        {
    ...
    /// called to complete the transaction. 
    /// </summary>
    public Object  /*IEditableCollectionViewAddNewItem.*/AddNewItem(Object newItem) 
    {
        IEditableCollectionViewAddNewItem ani = _collectionView as IEditableCollectionViewAddNewItem;
        if (ani != null)
        { 
...
//    #region Internal API
    ...
    /*internal*/public void SetItemsSource(IEnumerable value, Func<Object, Object> GetSourceItem /*= null*/)
    { 
    ...
    /*internal*/ boolean IsUsingItemsSource
    {
        get 
        {
...
//        Debug.Assert(_isInitializing == true); 
    ...
    /*internal*/ /*override*/ void GetCollectionChangedSources(int level, Action<Integer, Object, Boolean, List<String>> format, List<String> sources)
    { 
...
//        #pragma warning restore 1634, 1691 
    ...
    // keep collections in [....] 
    private void SynchronizeCollections(NotifyCollectionChangedEventArgs e, Collection<T> origin, Collection<T> clone)
    { 
        if (clone == null)
...
//    #region Shaping storage
    ...
    private boolean IsShapingActive
    {
...
//            Debug.Assert(IsShapingActive, "Shaping storage not available");
    ...
    private boolean/*?*/ MyIsLiveSorting 
    { 
    ...
    private boolean IsLiveSortingSet 
    {
    ...
    private boolean/*?*/ MyIsLiveFiltering
    { 
    ...
    private boolean IsLiveFilteringSet 
    { 
    ...
    private boolean/*?*/ MyIsLiveGrouping 
    {
    ...
    private boolean IsLiveGroupingSet
    { 
...
//    #region Private Types
    ...
    { 
        public boolean    _isSortingSet;       // true when user has added to this.SortDescriptions 
        public boolean    _isGroupingSet;      // true when user has added to this.GroupDescriptions
        public boolean    _isLiveSortingSet;   // true when user has added to this.LiveSortingProperties 
        public boolean    _isLiveFilteringSet; // true when user has added to this.LiveFilteringProperties
        public boolean    _isLiveGroupingSet;  // true when user has added to this.LiveGroupingProperties
        ...
        public boolean/*?*/    _isLiveSorting;     // true if live Sorting is requested
        public boolean/*?*/    _isLiveFiltering;   // true if live Filtering is requested 
        public boolean/*?*/    _isLiveGrouping;    // true if live Grouping is requested
