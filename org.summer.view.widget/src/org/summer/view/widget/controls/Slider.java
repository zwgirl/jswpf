...
//    #region Commands
    ...
    private class SliderGesture extends InputGesture
    { 
        public SliderGesture(Key normal, Key inverted, boolean forHorizontal) 
        {
            _normal = normal; 
            _inverted = inverted;
        ...
        /// </summary> 
        public /*override*/ boolean Matches(Object targetElement, InputEventArgs inputEventArgs)
        { 
        ...
        private boolean IsInverted(Slider slider)
        { 
            if (_forHorizontal)
            {
        ...
        private boolean _forHorizontal;
    } 
...
//    #region IsDirectionReversed Property 
    ...
    /// </summary> 
    public static final DependencyProperty IsDirectionReversedProperty
        = DependencyProperty.Register("IsDirectionReversed", typeof(boolean), typeof(Slider),
...
//    [Bindable(true), Category("Appearance")]
    public boolean IsDirectionReversed 
    {
        get
        {
            return (boolean)GetValue(IsDirectionReversedProperty); 
        }
        set 
        { 
...
//    #region Delay Property 
    ...
    /// </summary> 
    public static final DependencyProperty DelayProperty = RepeatButton.DelayProperty.AddOwner(typeof(Slider), new FrameworkPropertyMetadata(RepeatButton.GetKeyboardDelay()));
...
//    #region Interval Property
    ...
    /// </summary>
    public static final DependencyProperty IntervalProperty = RepeatButton.IntervalProperty.AddOwner(typeof(Slider), new FrameworkPropertyMetadata(RepeatButton.GetKeyboardSpeed())); 
...
//    #region AutoToolTipPlacement Property 
    ...
    /// </summary>
    public static final DependencyProperty AutoToolTipPlacementProperty 
...
//    [Bindable(true), Category("Behavior")]
    ...
    private static boolean IsValidAutoToolTipPlacement(Object o) 
    {
...
//    #region AutoToolTipPrecision Property
    ...
    ///     Default Value:      0
    /// </summary> 
    public static final DependencyProperty AutoToolTipPrecisionProperty
...
//    [Bindable(true), Category("Appearance")]
    ...
    /// <param name="o"></param>
    /// <returns></returns>
    private static boolean IsValidAutoToolTipPrecision(Object o)
    { 
        return (((int)o) >= 0);
    } 
...
//    #region TickMark support
    ...
    /// </summary> 
    public static final DependencyProperty IsSnapToTickEnabledProperty
        = DependencyProperty.Register("IsSnapToTickEnabled", typeof(boolean), typeof(Slider), 
        new FrameworkPropertyMetadata(false)); 
...
//    [Bindable(true), Category("Behavior")]
    public boolean IsSnapToTickEnabled 
    {
        get 
        { 
            return (boolean)GetValue(IsSnapToTickEnabledProperty);
        } 
        set
        {
    ...
    /// </summary> 
    public static final DependencyProperty TickPlacementProperty
...
//    [Bindable(true), Category("Appearance")]
    ...
    private static boolean IsValidTickPlacement(Object o) 
    { 
    ...
    /// </summary> 
    public static final DependencyProperty TickFrequencyProperty
...
//    [Bindable(true), Category("Appearance")]
    ...
    /// </summary>
    public static final DependencyProperty TicksProperty
...
//    #region Selection supports 
    ...
    /// </summary>
    public static final DependencyProperty IsSelectionRangeEnabledProperty
        = DependencyProperty.Register("IsSelectionRangeEnabled", typeof(boolean), typeof(Slider),
        new FrameworkPropertyMetadata(false)); 
...
//    [Bindable(true), Category("Appearance")] 
    public boolean IsSelectionRangeEnabled
    {
        get
        { 
            return (boolean)GetValue(IsSelectionRangeEnabledProperty);
        } 
        set 
        {
    ...
    /// </summary> 
    public static final DependencyProperty SelectionStartProperty 
...
//    [Bindable(true), Category("Appearance")] 
    ...
    /// </summary>
    public static final DependencyProperty SelectionEndProperty
...
//    #region Move-To-Point support
    ...
    /// </summary>
    public static final DependencyProperty IsMoveToPointEnabledProperty 
        = DependencyProperty.Register("IsMoveToPointEnabled", typeof(boolean), typeof(Slider),
        new FrameworkPropertyMetadata(false)); 
...
//    [Bindable(true), Category("Behavior")] 
    ...
    { 
        get 
        {
            return (boolean)GetValue(IsMoveToPointEnabledProperty); 
        }
        set
        {
...
//    #region Event Handlers
    ...
    /// </summary>
    /*internal*/ public FrameworkElement SelectionRangeElement 
    { 
        get
        { 
    ...
    private void MoveToNextTick(double direction) 
    {
        if (direction != 0.0) 
        {
            ...
            boolean greaterThan = direction > 0; //search for the next tick greater than value? 
...
//    #region Override Functions
    ...
    {
        Size size = super.ArrangeOverride(finalSize);
...
//    #region Private Fields
    ...
    private /*const*/static final String SelectionRangeElementName = "PART_SelectionRange";
