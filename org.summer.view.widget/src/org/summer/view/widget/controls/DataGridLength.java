...
public /*struct*/class DataGridLength implements IEquatable<DataGridLength>
{
//    #region Constructors 
...
//    #region Public Methods
    ...
    public static boolean operator ==(DataGridLength gl1, DataGridLength gl2)
    { 
    ...
    private static final DataGridLength _auto = new DataGridLength(AutoValue, DataGridLengthUnitType.Auto, 0d, 0d);
    private static final DataGridLength _sizeToCells = new DataGridLength(AutoValue, DataGridLengthUnitType.SizeToCells, 0d, 0d); 
    private static final DataGridLength
	/// <summary>
	    ///     DataGridLength is the type used for various length properties in DataGrid 
	    ///     that support a variety of descriptive sizing modes in addition to numerical 
	    ///     values.
...
//	        #region Fields 
	        ...
	        private static final DataGridLength _auto = new DataGridLength(AutoValue, DataGridLengthUnitType.Auto, 0d, 0d);
	        private static final DataGridLength _sizeToCells = new DataGridLength(AutoValue, DataGridLengthUnitType.SizeToCells, 0d, 0d); 
	        private static final DataGridLength _sizeToHeader = new DataGridLength(AutoValue, DataGridLengthUnitType.SizeToHeader, 0d, 0d);
