...
public /*static*/ class Validation 
{
    ...
    /// </summary> 
    public static final RoutedEvent ErrorEvent =
    ...
    /// </summary>
    /*internal*/ public static final DependencyPropertyKey ErrorsPropertyKey = 
    ...
    /// </remarks>
    public static final DependencyProperty ErrorsProperty = 
     ...
     */
    /*internal*/ public static final DependencyProperty ValidationErrorsInternalProperty =
    ...
    /*internal*/ public static ValidationErrorCollection GetErrorsInternal(DependencyObject target) 
    { 
    ...
    /// </summary> 
    /*internal*/ public static final DependencyPropertyKey HasErrorPropertyKey =
            DependencyProperty.RegisterAttachedReadOnly("HasError", 
                    typeof(Boolean), typeof(Validation), 
                    new FrameworkPropertyMetadata(
    ...
    /// </summary>
    public static final DependencyProperty HasErrorProperty=
        HasErrorPropertyKey.DependencyProperty; 

    /// <summary> Static accessor for HasError property </summary> 
    /// <exception cref="ArgumentNullException"> DependencyObject element cannot be null </exception> 
    public static boolean GetHasError(DependencyObject element)
    { 
        if (element == null)
            throw new ArgumentNullException("element");
    ...
    /// </code>
    /// </summary> 
    public static final DependencyProperty ErrorTemplateProperty = 
...
//    [AttachedPropertyBrowsableForType(typeof(DependencyObject))] 
    ...
    ///     should be directed.
    /// </summary> 
    public static final DependencyProperty ValidationAdornerSiteProperty =
...
//    [AttachedPropertyBrowsableForType(typeof(DependencyObject))]
    ...
    /// </summary>
    public static final DependencyProperty ValidationAdornerSiteForProperty = 
...
//    [AttachedPropertyBrowsableForType(typeof(DependencyObject))] 
    ...
    /*internal*/ public static void ShowValidationAdorner(DependencyObject targetElement, boolean show)
    { 
    ...
    private static boolean HasValidationGroup(FrameworkElement fe)
    { 
        if (fe != null) 
        {
    ...
    private static boolean HasValidationGroup(IList<VisualStateGroup> groups) 
    {
        if (groups != null)
        {
    ...
    private static void ShowValidationAdornerHelper(DependencyObject targetElement, DependencyObject adornerSite, boolean show)
    { 
    ...
    private static void ShowValidationAdornerHelper(DependencyObject targetElement, DependencyObject adornerSite, boolean show, boolean tryAgain) 
    {
     ...
     * @param targetElement
     * @param shouldRaiseEvent
     */
    /*internal*/ public static void AddValidationError(ValidationError validationError, DependencyObject targetElement, boolean shouldRaiseEvent)
    {
    ...
    /*internal*/ public static void RemoveValidationError(ValidationError validationError, DependencyObject targetElement, boolean shouldRaiseEvent) 
    {
        if (targetElement == null) 
            return; 
        ...
        boolean isValid = (validationErrors.Count == 1);   // about to remove the last error 
    ...
    /// </summary> 
    private static final DependencyProperty ValidationAdornerProperty =
