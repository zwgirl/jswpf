...
/// <summary>
    ...
    /// </summary>
    public abstract class DataGridColumn extends DependencyObject
    {
//        #region Header 
        ...
        /// </summary>
        public static final DependencyProperty HeaderStyleProperty = 
...
//        #region Cell Container 
        ...
        public static final DependencyProperty IsReadOnlyProperty =
            DependencyProperty.Register("IsReadOnly", typeof(boolean), typeof(DataGridColumn), new FrameworkPropertyMetadata(false, OnNotifyCellPropertyChanged, OnCoerceIsReadOnly)); 

        private static Object OnCoerceIsReadOnly(DependencyObject d, Object baseValue)
        {
            var column = d as DataGridColumn; 
            return column.OnCoerceIsReadOnly((boolean)baseValue);
        } 
 
        /// <summary>
        ///     Subtypes can override this to force IsReadOnly to be coerced to true. 
        /// </summary>
        protected /*virtual*/ boolean OnCoerceIsReadOnly(boolean baseValue)
        {
            return (boolean)DataGridHelper.GetCoercedTransferPropertyValue( 
                this,
                baseValue, 
                IsReadOnlyProperty, 
                DataGridOwner,
...
//        #region Width
        ...
        /*internal*/ public void SetWidthInternal(DataGridLength width)
        { 
            boolean originalValue = _ignoreRedistributionOnWidthChange; 
        ...
        /// </summary> 
        private static boolean ValidateMinWidth(Object v)
        { 
        ...
        /// </summary> 
        private static boolean ValidateMaxWidth(Object v)
        { 
            double value = (double)v; 
        ...
        public static final DependencyProperty ActualWidthProperty = ActualWidthPropertyKey.DependencyProperty;
        ...
        /*internal*/ public double GetConstraintWidth(boolean isHeader)
        {
        ...
        /*internal*/ public void UpdateDesiredWidthForAutoColumn(boolean isHeader, double pixelWidth)
        { 
            DataGridLength width = Width; 
        ...
        /// </summary> 
        /*internal*/ public void UpdateWidthForStarColumn(double displayWidth, double desiredWidth, double starValue)
        { 
...
//        #region Visual Tree Generation 
        ...
        /*internal*/ public FrameworkElement BuildVisualTree(boolean isEditing, Object dataItem, DataGridCell cell)
        { 
            if (isEditing)
            { 
...
//        #region Editing 
        ...
        protected /*virtual*/ boolean CommitCellEdit(FrameworkElement editingElement)
        {
            return DataGridHelper.ValidateWithoutUpdate(editingElement);
        } 

        /*internal*/ public void BeginEdit(FrameworkElement editingElement, RoutedEventArgs e) 
        { 
        ...
        /*internal*/ public void CancelEdit(FrameworkElement editingElement)
        {
            if (editingElement != null)
            { 
        ...
        /*internal*/ public boolean CommitEdit(FrameworkElement editingElement)
        {
            if (editingElement != null)
            { 
        ...
        private static final DependencyProperty OriginalValueProperty = 
...
//        #region Owner Communication
        ...
        /// </summary> 
        /*internal*/ public static void OnNotifyCellPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
        ...
        /// <param name="d"></param> 
        /// <param name="e"></param>
        /*internal*/ public static void NotifyPropertyChangeForRefreshContent(DependencyObject d, DependencyPropertyChangedEventArgs e) 
        { 
        ...
        /// <param name="propertyName"></param>
        protected /*internal*/ public /*virtual*/ void RefreshCellContent(FrameworkElement element, String propertyName) 
        {
        }
        ...
        /// </summary> 
        /*internal*/ public void SyncProperties() 
        {
            DataGridHelper.TransferProperty(this, MinWidthProperty); 
            DataGridHelper.TransferProperty(this, MaxWidthProperty);
            DataGridHelper.TransferProperty(this, WidthProperty);
        ...
        /// </summary>
        protected /*internal*/ public DataGrid DataGridOwner 
        { 
            get { return _dataGridOwner; }
            /*internal*/ public set { _dataGridOwner = value; } 
        }
...
//        #region Display Index
        ...
        ///     The DependencyProperty that represents the Width property.
        /// </summary> 
        public static final DependencyProperty DisplayIndexProperty = 
            DependencyProperty.Register(
                "DisplayIndex", 
                typeof(int),
                typeof(DataGridColumn),
...
//        #region Auto Sorting
        ...
        /// </summary> 
        public static final DependencyProperty SortMemberPathProperty =
            DependencyProperty.Register(
                "SortMemberPath",
                typeof(String), 
                typeof(DataGridColumn),
        ...
        /// </summary>
        public static final DependencyProperty CanUserSortProperty =
            DependencyProperty.Register(
                "CanUserSort", 
                typeof(boolean),
                typeof(DataGridColumn), 
        ...
        { 
            get { return (boolean)GetValue(CanUserSortProperty); }
        ...
        /// <returns></returns> 
        /*internal*/ public static Object OnCoerceCanUserSort(DependencyObject d, Object baseValue) 
        {
            var column = d as DataGridColumn; 

            boolean basePropertyHasModifiers;
            ...
            if (column.DataGridOwner != null)
            { 
                boolean parentPropertyHasModifiers; 
        ...
        /// </summary> 
        public static final DependencyProperty SortDirectionProperty = 
            DependencyProperty.Register(
                "SortDirection", 
...
//        #region Auto Generation
        ...
        private static final DependencyPropertyKey IsAutoGeneratedPropertyKey =
        ...
        /// </summary>
        public static final DependencyProperty IsAutoGeneratedProperty = IsAutoGeneratedPropertyKey.DependencyProperty;
        ...
        {
            get { return (boolean)GetValue(IsAutoGeneratedProperty); } 
            /*internal*/ public set { SetValue(IsAutoGeneratedPropertyKey, value); }
        }
        ...
        /// <returns></returns>
        /*internal*/ public static DataGridColumn CreateDefaultColumn(ItemPropertyInfo itemProperty) 
        {
...
//        #region Frozen Columns
        ...
        /// </summary> 
        private static final DependencyPropertyKey IsFrozenPropertyKey = 
            DependencyProperty.RegisterReadOnly(
                "IsFrozen", 
                typeof(boolean),
                typeof(DataGridColumn),
        ...
        /// </summary> 
        public static final DependencyProperty IsFrozenProperty = IsFrozenPropertyKey.DependencyProperty;
        ...
        {
            get { return (boolean)GetValue(IsFrozenProperty); } 
            /*internal*/ public set { SetValue(IsFrozenPropertyKey, value); } 
        }
...
//        #region Column Reordering
        ...
        /// </summary> 
        public static final DependencyProperty CanUserReorderProperty =
            DependencyProperty.Register("CanUserReorder", typeof(boolean), typeof(DataGridColumn), new FrameworkPropertyMetadata(true, new PropertyChangedCallback(OnNotifyColumnPropertyChanged), new CoerceValueCallback(OnCoerceCanUserReorder))); 
        ...
        { 
            get { return (boolean)GetValue(CanUserReorderProperty); } 
...
//        #region Special Input
        ...
        /*internal*/ public /*virtual*/ void OnInput(InputEventArgs e) 
        {
        }

        /*internal*/ public void BeginEdit(InputEventArgs e, boolean handled) 
        {
...
//        #region Column Resizing 
        ...
        /// </summary> 
        public static final DependencyProperty CanUserResizeProperty =
            DependencyProperty.Register("CanUserResize", typeof(boolean), typeof(DataGridColumn), new FrameworkPropertyMetadata(true, new PropertyChangedCallback(OnNotifyColumnHeaderPropertyChanged), new CoerceValueCallback(OnCoerceCanUserResize))); 
        ...
        {
            get { return (boolean)GetValue(CanUserResizeProperty); } 
...
//        #region Data
        ...
        private boolean _ignoreRedistributionOnWidthChange = false;    // Flag which indicates to ignore recomputation of column widths on width change of column 
        private boolean _processingWidthChange = false;                // Flag which indicates that execution of width change callback to avoid recursions. 
        private final double _starMaxWidth = 10000d;                // Max Width constant for star columns
