...
import org.summer.view.widget.documents.Block;
import org.summer.view.widget.documents.FlowDocument;
import org.summer.view.widget.documents.ITextContainer;
import org.summer.view.widget.documents.ITextPointer;
import org.summer.view.widget.documents.Inline;
import org.summer.view.widget.documents.InlineCollection;
import org.summer.view.widget.documents.InlineUIContainer;
import org.summer.view.widget.documents.Line;
import org.summer.view.widget.documents.LogicalDirection;
import org.summer.view.widget.documents.Run;
import org.summer.view.widget.documents.TextContainer;
import org.summer.view.widget.documents.TextElement;
import org.summer.view.widget.documents.TextParagraphView;
import org.summer.view.widget.documents.TextPointer;
import org.summer.view.widget.documents.TextPointerBase;
import org.summer.view.widget.documents.TextRangeBase;
import org.summer.view.widget.documents.TextSchema;
...
import org.summer.view.widget.media.VisualCollection;
...
public class TextBlock extends FrameworkElement implements IContentHost, IAddChildInternal, IServiceProvider 
{
    //------------------------------------------------------------------- 
    //
...
//    #region IAddChild members
    ...
    void IAddChild.AddChild(Object value)
    {
        ...
        if (!(_complexContent.TextContainer instanceof TextContainer))
        {
        ...
        Invariant.Assert(value instanceof Inline, "Schema validation helper must guarantee that invalid element is not passed here");
...
//    #region Public Methods
    ...
    /// </remarks> 
    public TextPointer GetPositionFromPoint(Point point, boolean snapToText)
    { 
...
//    #region Public Dynamic Properties
    ...
    /// </summary> 
    public static final DependencyProperty BaselineOffsetProperty =
...
//    [TypeConverter(typeof(LengthConverter))]
    ...
    /// </summary>
    public static final DependencyProperty PaddingProperty = 
    ...
    /// </summary>
//    [CommonDependencyProperty] 
    public static final DependencyProperty TextTrimmingProperty = 
            DependencyProperty.Register(
                    "TextTrimming", 
                    typeof(TextTrimming),
                    typeof(TextBlock),
    ...
    /// </summary>
//    [CommonDependencyProperty]
    public static final DependencyProperty TextWrappingProperty = 
            DependencyProperty.Register(
                    "TextWrapping", 
                    typeof(TextWrapping), 
                    typeof(TextBlock),
...
//#endif 
        ...
        boolean formattedOnce = CheckFlags(org.summer.view.widget.documents.FormattedOnce); 
...
//                	Debug.Assert(lineCount == LineCount); 
                    ...
                    if (lineMetrics.HasInlineObjects)
                    {
                        ...
                        { 
                            ...
                            boolean ellipsis = ParagraphEllipsisShownOnLine(i, lineOffset.Y - contentOffset.Y); 
...
//#endif
    ...
    { 
        ...
        { 
            ...
            Line line = CreateLine(lineProperties); 
            int dcp = 0; 
            boolean showParagraphEllipsis = false;
...
//        	Debug.Assert(lineCount == LineCount); 
            ...
            { 
                ...
                { 
                    ...
                    boolean ellipsis = ParagraphEllipsisShownOnLine(i, lineOffset);
    ...
    { 
        ...
        else if (child instanceof FrameworkContentElement) 
        { 
...
//        	Debug.Assert(lineCount == LineCount); 
            ...
            { 
                // Check if paragraph ellipsis are rendered
                boolean ellipsis = ParagraphEllipsisShownOnLine(lineIndex, lineOffset); 
...
//                #pragma warning suppress 6503 // IEnumerator.Current is documented to throw this exception
            ...
            if (_complexContent == null || !(_complexContent.TextContainer instanceof TextContainer)) 
            {
                // Return empty collection
...
//    #region Internal Methods
    ...
    /// </summary> 
    /*internal*/ public  void RemoveChild(Visual child)
    { 
        if (_complexContent != null) 
        {
    ...
    /// </remarks>
    /*internal*/ public  void SetTextContainer(ITextContainer textContainer) 
    { 
    ...
    //------------------------------------------------------------------- 
    /*internal*/ public  Size MeasureChild(InlineObject inlineObject)
    { 
//        Debug.Assert(_complexContent != null, "Inline objects are supported only in complex content.");
    ...
    /// </summary>
    /*internal*/ public  ReadOnlyCollection<LineResult> GetLineResults() 
    {
//#if TEXTPANELLAYOUTDEBUG
...
//        	Debug.Assert(lineCount == LineCount); 
    ...
    /*internal*/ public  void GetLineDetails(int dcp, int index, double lineVOffset, /*out*/ int cchContent, /*out*/ int cchEllipses) 
    {
        Invariant.Assert(IsLayoutDataValid);
        ...
        { 
            ...
            boolean ellipsis = ParagraphEllipsisShownOnLine(index, lineVOffset); 
    ...
    /// </returns> 
    /*internal*/ public  ITextPointer GetTextPositionFromDistance(int dcp, double distance, double lineVOffset, int index)
    { 
//#if TEXTPANELLAYOUTDEBUG 
...
//#endif
    ...
    /*internal*/ public  Rect GetRectangleFromTextPosition(ITextPointer orientedPosition) 
    { 
//#if TEXTPANELLAYOUTDEBUG
...
//#endif
    ...
    /// </summary> 
    /*internal*/ public  Geometry GetTightBoundingGeometryFromTextPositions(ITextPointer startPosition, ITextPointer endPosition)
    {
//#if TEXTPANELLAYOUTDEBUG
...
//#endif 
    ...
    /// </param> 
    /*internal*/ public  boolean IsAtCaretUnitBoundary(ITextPointer position, int dcp, int lineIndex) 
    {
        Invariant.Assert(IsLayoutDataValid); 
        // Line props may be invalid, even if Measure/Arrange is valid - rendering only props are changing.
        LineProperties lineProperties = GetLineProperties();
        ...
        TextRunCache textRunCache = new TextRunCache();
        boolean isAtCaretUnitBoundary = false; 
    ...
    /// Index of line in which position is found
    /// </param>
    /*internal*/ public  ITextPointer GetNextCaretUnitPosition(ITextPointer position, LogicalDirection direction, int dcp, int lineIndex)
    { 
        Invariant.Assert(IsLayoutDataValid);
    ...
    /// Index of line in which position is found 
    /// </param>
    /*internal*/ public  ITextPointer GetBackspaceCaretUnitPosition(ITextPointer position, int dcp, int lineIndex) 
    { 
        Invariant.Assert(IsLayoutDataValid);
...
//    #region Internal Properties 
    ...
    //--------------------------------------------------------------------
    /*internal*/ public  TextFormatter TextFormatter
    { 
        get
        { 
    ...
    //-------------------------------------------------------------------
    /*internal*/ public  LineProperties ParagraphProperties
    { 
        get
        { 
            LineProperties lineProperties = GetLineProperties(); 
    ...
    // HasComplexContent
    //-------------------------------------------------------------------
    /*internal*/ public  boolean HasComplexContent 
    {
        get 
        { 
    ...
    //-------------------------------------------------------------------
    /*internal*/ public  boolean IsTypographyDefaultValue 
    { 
        get
        { 
    ...
    //--------------------------------------------------------------------
    /*internal*/ public  boolean IsContentPresenterContainer
    {
...
//    #region Private Methods 
    ...
    private static void InsertTextRun(ITextPointer position, String text, boolean whitespacesIgnorable) 
    { 
        // We distinguish these two cases by parent of TextContainer:
        // for plain text case it is TextBox. 
        if (!(position instanceof TextPointer) || ((TextPointer)position).Parent == null || ((TextPointer)position).Parent instanceof TextBox)
        {
    ...
    private void EnsureComplexContent(ITextContainer textContainer) 
    {
        if (_complexContent == null) 
        {
            ...
            if (CheckFlags(Flags.FormattedOnce))
            {
                ...
                boolean wasLayoutValid = this.IsMeasureValid && this.IsArrangeValid; 
                InvalidateMeasure(); 
...
//        Invariant.Assert(sender == _complexContent.TextContainer, "Received text change for foreign TextContainer.");
    ...
    private LineProperties GetLineProperties() 
    {
        ...
        boolean isHyphenationEnabled = (boolean) this.GetValue(IsHyphenationEnabledProperty);
    ...
    //-------------------------------------------------------------------
    private TextParagraphProperties GetLineProperties(boolean firstLine, LineProperties lineProperties)
    {
        return GetLineProperties(firstLine, false, lineProperties); 
    }
    private TextParagraphProperties GetLineProperties(boolean firstLine, boolean showParagraphEllipsis, LineProperties lineProperties) 
    { 
        GetLineProperties();
    ...
    /// </param>
    private boolean ParagraphEllipsisShownOnLine(int lineIndex, double lineVOffset)
    { 
        if (lineIndex >= LineCount - 1)
        { 
...
//        	Debug.Assert(lineCount == LineCount);
    ...
    private static boolean ContainsContentElement(TextBlock textBlock, ContentElement element) 
    {
...
//        Debug.Assert(_complexContent.TextContainer is TextContainer);
    ...
    /// </summary>
    /*internal*/ public  void OnChildBaselineOffsetChanged(DependencyObject source)
    { 
    ...
    private static boolean IsValidTextTrimming(Object o)
    {
    ...
    private static boolean IsValidTextWrap(Object o)
    {
...
//    #region Private Fields
    ...
    //--------------------------------------------------------------------
    private  static final UncommonField<NaturalLanguageHyphenator> HyphenatorField = new UncommonField<NaturalLanguageHyphenator>();
...
//    #region Private Types 
    ...
    { 
        ...
        // Ctor
        //--------------------------------------------------------------- 
        /*internal*/ public  ComplexContent(TextBlock owner, ITextContainer textContainer, boolean foreignTextContianer, String content)
        {
...
//            Debug.Assert(textContainer != null);
        ...
        //---------------------------------------------------------------
        /*internal*/ public  void Detach(TextBlock owner)
        {
        ...
        //-------------------------------------------------------------------
        /*internal*/ public  VisualCollection VisualChildren;

        //----------------------------------------------------------------
        // Highlights associated with TextContainer. 
        //--------------------------------------------------------------- 
        /*internal*/ public  Highlights Highlights { get { return this.TextContainer.Highlights; } }

        //----------------------------------------------------------------
        // Text array exposing access to the content.
        //----------------------------------------------------------------
        /*internal*/ public  final ITextContainer TextContainer; 

        //--------------------------------------------------------------- 
        // Is TextContainer owned by another Object? 
        //----------------------------------------------------------------
        /*internal*/ public  final boolean ForeignTextContainer; 

        //---------------------------------------------------------------
        // TextView Object associated with TextContainer.
        //--------------------------------------------------------------- 
        /*internal*/ public  final TextParagraphView TextView;

        //--------------------------------------------------------------- 
        // Collection of inline objects hosted by the TextBlock control.
        //---------------------------------------------------------------- 
        /*internal*/ public  ArrayList InlineObjects;
    }

    //------------------------------------------------------------------- 
    // Simple content enumerator.
    //-------------------------------------------------------------------- 
    /*private*/ class SimpleContentEnumerator implements IEnumerator 
    {
        //---------------------------------------------------------------- 
        // Ctor
        //---------------------------------------------------------------
        /*internal*/ public  SimpleContentEnumerator(String content)
        { 
            _content = content;
            _initialized = false; 
        ...
        private boolean _invalidPosition;
    } 
...
//    [EditorBrowsable(EditorBrowsableState.Never)]
    public boolean ShouldSerializeBaselineOffset() 
    { 
