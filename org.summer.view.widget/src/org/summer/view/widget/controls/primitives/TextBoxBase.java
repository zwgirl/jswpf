...
import org.summer.view.widget.controls.ScrollBarVisibility;
...
//    #region Public Properties
    ...
    {
        get { return (boolean) GetValue(TextEditor.IsReadOnlyProperty); } 
    ...
    /// </summary> 
    public static final DependencyProperty IsReadOnlyCaretVisibleProperty = 
    ...
    {
        get { return (boolean)GetValue(IsReadOnlyCaretVisibleProperty); } 
    ...
    /// </summary> 
    public static final DependencyProperty AcceptsTabProperty =
            DependencyProperty.Register( 
                    "AcceptsTab", // Property name 
                    typeof(boolean), // Property type
    ...
    { 
        get { return (boolean) GetValue(AcceptsTabProperty); }
    ...
    /// to false. 
    /// </remarks>
    public static final DependencyProperty IsUndoEnabledProperty =
        DependencyProperty.Register("IsUndoEnabled", typeof(boolean), typeof(TextBoxBase),
    ...
    { 
        get
        { 
            return (boolean)GetValue(IsUndoEnabledProperty);
        }
    ...
    /// </remarks>
    public static final DependencyProperty UndoLimitProperty = 
        DependencyProperty.Register("UndoLimit", typeof(Integer), typeof(TextBoxBase),
    ...
    /// Default Value:      false 
    /// </summary> 
    public static final DependencyProperty AutoWordSelectionProperty =
        DependencyProperty.Register( 
    ...
    /// </summary>
    public boolean AutoWordSelection 
    {
        get
        {
            return (boolean)GetValue(AutoWordSelectionProperty); 
        }
    ...
    /// </remarks> 
    public static final DependencyProperty SelectionBrushProperty =
    ...
    /// </remarks>
    public static final DependencyProperty SelectionOpacityProperty =
    ...
    /// </remarks>
    public static final DependencyProperty CaretBrushProperty =
    ...
    /*internal*/ public static final DependencyPropertyKey IsSelectionActivePropertyKey = 
    ...
    { 
        get { return (boolean)GetValue(IsSelectionActiveProperty); }
    }

    public static final DependencyProperty IsInactiveSelectionHighlightEnabledProperty = 
        DependencyProperty.Register("IsInactiveSelectionHighlightEnabled", typeof(boolean), typeof(TextBoxBase));

    public boolean IsInactiveSelectionHighlightEnabled 
    {
        get { return (boolean)GetValue(IsInactiveSelectionHighlightEnabledProperty); } 
...
//    #region Public Events
    ...
    /// </summary> 
    public static final RoutedEvent TextChangedEvent = EventManager.RegisterRoutedEvent(
...
//    #region Protected Methods 
    ...
    protected /*override*/ void OnMouseWheel(MouseWheelEventArgs e)
    {
        ...
        if (this.ScrollViewer != null) 
        {
            ...
            { 
//                Invariant.Assert(this.RenderScope instanceof IScrollInfo);
                if (e.Delta > 0) 
                { 
    ...
    /*internal*/ public abstract FrameworkElement CreateRenderScope();
    ...
    /// event args 
    /// </param> 
    /*internal*/ public /*virtual*/ void OnTextContainerChanged(Object sender, TextContainerChangedEventArgs e)
    { 
...
//    #region Internal Methods
    ...
    /*internal*/ public void InitializeTextContainer(TextContainer textContainer)
    {
...
//            Invariant.Assert(_textEditor.TextContainer.TextSelection == _textEditor.Selection);
    ...
    /// </returns>
    /*internal*/ public TextPointer GetTextPositionFromPointInternal(Point point, boolean snapToText) 
    { 
    ...
    ///</remarks>
    /*internal*/ public boolean GetRectangleFromTextPosition(TextPointer position, out Rect rect) 
    { 
        Point offset;
    ...
    /// </summary>
    /*internal*/ public /*virtual*/ void AttachToVisualTree() 
    { 
        DetachFromVisualTree();
    ...
    /*internal*/ public /*virtual*/ void DoLineUp() 
    {
        if (this.ScrollViewer != null)
        {
    ...
    /*internal*/ public /*virtual*/ void DoLineDown() 
    {
        if (this.ScrollViewer != null)
        {
    ...
    {
        super.AddToEventRouteCore(route, args); 
    ...
    /// </param> 
    /*internal*/ public void ChangeUndoEnabled(boolean value)
    {
        //
    ...
    /// </param>
    /*internal*/ public void ChangeUndoLimit(Object value)
    { 
        UndoManager undoManager = UndoManager.GetUndoManager(this);
        if (undoManager != null) 
        { 
...
//    #region Internal Properties
    ...
    /// </summary> 
    /*internal*/ public ScrollViewer ScrollViewer
    { 
        get
        {
    ...
    /// <summary> 
    /// Text Selection (final)
    /// </summary> 
    /*internal*/ public TextSelection TextSelectionInternal
    {
        get
        { 
    ...
    /// <summary>
    /// final access to /*internal*/ public content control 
    /// </summary>
    /*internal*/ public FrameworkElement RenderScope 
    { 
        get
        { 
            return _renderScope;
    ...
    /*internal*/ public UndoAction PendingUndoAction 
    { 
        get
        { 
    ...
    /*internal*/ public TextEditor TextEditor
    {
        get 
        {
            return _textEditor; 
    ...
    /*internal*/ public boolean IsContentHostAvailable
    { 
        get
        { 
...
//    #region Private Methods
    ...
    private void UninitializeRenderScope()
    {
        ...
        if (_renderScope instanceof TextBoxView)
        { 
            // Nothing to do.
        }
        else if (_renderScope instanceof FlowDocumentView)
        { 
    ...
    { 
        ...
        if (_textBoxContentHost instanceof ScrollViewer) 
        { 
        ...
        else if (_textBoxContentHost instanceof Decorator) 
        {
...
//            Invariant.Assert(_textBoxContentHost == null, "_textBoxContentHost must be null here");
    ...
    /// </summary>
    /*internal*/ public /*virtual*/ void OnScrollChanged(Object sender, ScrollChangedEventArgs e)
    { 
        //
...
//#endif
    ...
    /*internal*/ public static void OnScrollViewerPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) 
    {
    ...
    { 
        TextBoxBase textBox = (TextBoxBase)d; 
        textBox.ChangeUndoEnabled((boolean)e.NewValue);
    } 

    /// <summary>
    /// <see cref="DependencyProperty.ValidateValueCallback"/>
    /// </summary> 
    private static boolean UndoLimitValidateValue(Object value)
    { 
        return ((int)value) >= -1; 
    }
...
//    #region Private Fields
    ...
    /*internal*/ public const String ContentHostTemplateName = "PART_ContentHost"; 
