...
import org.summer.view.widget.controls.MenuItemRole;
...
public abstract class MenuBase extends ItemsControl 
{
    //------------------------------------------------------------------- 
    // 
    //  Constructors
...
//    #region Constructors
    ...
    { 
        ...
        EventManager.RegisterClassHandler(typeof(MenuBase), MenuBase.IsSelectedChangedEvent, new RoutedPropertyChangedEventHandler<boolean>(OnIsSelectedChanged));
...
//    #region Protected Methods
    ...
    private void InvokeMenuOpenedClosedAutomationEvent(boolean open)
    {
    ...
    /*internal*/ public static final RoutedEvent IsSelectedChangedEvent = EventManager.RegisterRoutedEvent( 
        "IsSelectedChanged", RoutingStrategy.Bubble, typeof(RoutedPropertyChangedEventHandler<boolean>), typeof(MenuBase));
    ...
    private boolean IsDescendant(DependencyObject node) 
    {
        return IsDescendant(this, node); 
    } 

    /*internal*/ public static boolean IsDescendant(DependencyObject reference, DependencyObject node) 
    {
    ...
    { 
        boolean ret = (item is MenuItem) || (item is Separator);
        if (!ret) 
        { 
            _currentItem = item;
        } 
...
//    #region Private Methods
    ...
    /// </summary> 
    /*internal*/ public /*event*/ EventHandler InternalMenuModeChanged
    {
    ...
    private static final EventPrivateKey InternalMenuModeChangedKey = new EventPrivateKey(); 
...
//    [SecurityCritical, SecurityTreatAsSafe] 
    ...
    /*internal*/ public static void SetSuspendingPopupAnimation(ItemsControl menu, MenuItem ignore, boolean suspend)
    { 
    ...
    /*internal*/ public void KeyboardLeaveMenuMode() 
    {
...
//    #region Private Fields 
    ...
    /// </summary>
    /// <value></value>
    /*internal*/ public MenuItem CurrentSelection 
    {
        get 
        { 
    ...
    /*internal*/ public boolean IsMenuMode
    { 
        get
        {
        ...
        { 
            ...
            boolean isMenuMode = _bitFlags[(int)MenuBaseFlags.IsMenuMode]; 
            if (isMenuMode != value)
            {
    ...
    // This boolean is used by top level menu items to
    ...
    /*internal*/ public boolean OpenOnMouseEnter 
    {
    ...
    ///</SecurityNote>
//    [SecurityCritical, SecurityTreatAsSafe]
    private void PushMenuMode(boolean isAcquireFocusMenuMode)
    { 
...
//        Debug.Assert(_pushedMenuMode != null);
    ...
    ///</SecurityNote>
    private boolean HasPushedMenuMode 
    { 
//        [SecurityCritical, SecurityTreatAsSafe]
        get 
        {
    ...
    ///     set of IsMenuMode. 
    /// </summary>
    private boolean IsAcquireFocusMenuMode
    {
