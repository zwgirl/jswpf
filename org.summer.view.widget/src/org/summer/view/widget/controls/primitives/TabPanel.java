...
import org.summer.view.widget.controls.Dock;
import org.summer.view.widget.controls.Panel;
import org.summer.view.widget.controls.TabControl;
...
//    #region Private Methods
    ...
    { 
        ...
        for/*each*/ (UIElement child : InternalChildren) 
        {
            ...
            boolean lastHeaderInRow = isMultiRow && (separatorIndex < solution.length && solution[separatorIndex] == childIndex || childIndex == _numHeaders - 1); 
    ...
    private int GetActiveRow(int[] solution) 
    {
        ...
        if (solution.length > 0)
        {
            for/*each*/ (UIElement child : InternalChildren) 
            {
                ...
                boolean isActiveTab = (boolean)child.GetValue(Selector.IsSelectedProperty); 
