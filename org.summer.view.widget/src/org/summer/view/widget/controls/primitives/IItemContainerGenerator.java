...
{ 
    ...
    /// Error, as appropriate.
    /// </remarks>
    IDisposable StartAt(GeneratorPosition position, GeneratorDirection direction, boolean allowStartAtRealizedItem);
    ...
    /// a previous call to StartAt.
    /// </remarks>
    DependencyObject GenerateNext(/*out*/ boolean isNewlyRealized); 
