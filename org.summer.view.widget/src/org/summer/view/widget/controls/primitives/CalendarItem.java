...
import org.summer.view.widget.controls.CalendarMode;
import org.summer.view.widget.controls.ContentControl;
import org.summer.view.widget.controls.Control;
import org.summer.view.widget.controls.DateTimeHelper;
import org.summer.view.widget.controls.Grid;
...
import org.summer.view.widget.globalization.GregorianCalendar;
...
import org.summer.view.widget.input.MouseButtonState;
...
public /*sealed partial*/ class CalendarItem extends Control 
    {
//        #region Constants 
        private final String ElementRoot = "PART_Root";
        private final String ElementHeaderButton = "PART_HeaderButton";
        private final String ElementPreviousButton = "PART_PreviousButton";
        private final String ElementNextButton = "PART_NextButton"; 
        private final String ElementDayTitleTemplate = "DayTitleTemplate";
        private final String ElementMonthView = "PART_MonthView"; 
        private final String ElementYearView = "PART_YearView"; 
        private final String ElementDisabledVisual = "PART_DisabledVisual";
...
//        #region Data 
        ...
        private org.summer.view.widget.globalization.Calendar _calendar = new GregorianCalendar(); 
        ...
        private boolean _isMonthPressed;
        private boolean _isDayPressed; 
...
//        #region Internal Properties 
        ...
        /*internal*/ public Grid MonthView 
        {
...
//        #region Private Properties 
        ...
        /*internal*/ public Button HeaderButton 
        {
            get 
            { 
        ...
        /*internal*/ public Button NextButton
        { 
            get
            { 
        ...
        /*internal*/ public Button PreviousButton
        {
            get 
            {
...
//        #region Internal Methods
        ...
        /*internal*/ public void UpdateDecadeMode() 
        {
        ...
        /*internal*/ public void UpdateMonthMode() 
        { 
        ...
        /*internal*/ public void UpdateYearMode()
        {
        ...
        /*internal*/ public IEnumerable<CalendarDayButton> GetCalendarDayButtons()
        { 
            // 
            int count = ROWS * COLS;
            if (MonthView != null) 
        ...
        /*internal*/ public CalendarDayButton GetFocusedCalendarDayButton()
        { 
        ...
        /*internal*/ public CalendarDayButton GetCalendarDayButton(DateTime date) 
        {
            foreach (CalendarDayButton b in GetCalendarDayButtons())
            {
        ...
        /*internal*/ public CalendarButton GetCalendarButton(DateTime date, CalendarMode mode) 
        {
        ...
        /*internal*/ public CalendarButton GetFocusedCalendarButton()
        { 
            foreach (CalendarButton b in GetCalendarButtons())
            {
                if (b != null && b.IsFocused)
...
//        #region Private Methods 
        ...
        private void EndDrag(boolean ctrl, DateTime selectedDate) 
        {
            if (this.Owner != null) 
            {
                ...
                if (this.Owner.HoverStart.HasValue) 
                {
                    ...
                    { 
                        ...
                        // Use the /*internal*/ public AddRange that omits BlackOutDates based on the SelectionMode
...
//        #region Month Mode Display
        ...
        private void SetMonthModeCalendarDayButtons() 
        {
            ...
            boolean isMinMonth = DateTimeHelper.CompareYearMonth(firstDayOfMonth, DateTime.MinValue) <= 0;
            boolean isMaxMonth = DateTimeHelper.CompareYearMonth(firstDayOfMonth, DateTime.MaxValue) >= 0; 
