...
/// <summary>
    ...
    /// </summary> 
    public abstract class MultiSelector extends Selector
    { 
        /// <summary>
        /// Returns whether or not multiple items can be selected
        /// </summary>
        protected boolean CanSelectMultipleItems 
        {
            get { return super.CanSelectMultiple; } 
            set { super.CanSelectMultiple = value; } 
        }
...
//        #region BulkSelection
        ...
        /// </summary> 
        protected boolean IsUpdatingSelectedItems 
        {
            get 
            {
