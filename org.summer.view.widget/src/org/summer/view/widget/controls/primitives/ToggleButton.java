...
//    #region Properties and Events 
    ...
    ///     Checked event
    /// </summary> 
    public static final RoutedEvent CheckedEvent = EventManager.RegisterRoutedEvent("Checked", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(ToggleButton));

    /// <summary> 
    ///     Unchecked event
    /// </summary> 
    public static final RoutedEvent UncheckedEvent = EventManager.RegisterRoutedEvent("Unchecked", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(ToggleButton));

    /// <summary>
    ///     Indeterminate event 
    /// </summary>
    public static final RoutedEvent IndeterminateEvent = EventManager.RegisterRoutedEvent("Indeterminate", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(ToggleButton)); 
...
//    [Localizability(LocalizationCategory.None, Readability = Readability.Unreadable)] 
    ...
    { 
        get
        {
            // Because Nullable<boolean> unboxing is very slow (uses reflection) first we cast to boolean
            Object value = GetValue(IsCheckedProperty); 
            if (value == null)
                return new Nullable<Boolean>(); 
            else 
                return new Nullable<Boolean>((boolean)value);
        } 
        set
        {
    ...
    ///     Default Value:      false
    /// </summary>
    public static final DependencyProperty IsThreeStateProperty = 
            DependencyProperty.Register(
                    "IsThreeState", 
                    typeof(Boolean), 
                    typeof(ToggleButton),
...
//    [Bindable(true), Category("Behavior")] 
    ...
    {
        get { return (boolean) GetValue(IsThreeStateProperty); } 
...
//    #region Protected /*virtual*/ methods
    ...
    protected /*internal*/  /*virtual*/ void OnToggle() 
    {
        ...
        boolean/*?*/ isChecked; 
        if (IsChecked == true)
            isChecked = IsThreeState ? (boolean/*?*/)null : (boolean?)false; 
        else // false or null 
