...
//    #region Properties and Events
    ...
    /// </summary>
    public static final RoutedEvent DragStartedEvent = EventManager.RegisterRoutedEvent("DragStarted", RoutingStrategy.Bubble, typeof(DragStartedEventHandler), typeof(Thumb)); 

    /// <summary> 
    ///     Event fires when the thumb is in a mouse capture state and the user moves the mouse around. 
    /// </summary>
    public static final RoutedEvent DragDeltaEvent = EventManager.RegisterRoutedEvent("DragDelta", RoutingStrategy.Bubble, typeof(DragDeltaEventHandler), typeof(Thumb)); 

    /// <summary>
    ///     Event fires when user released mouse's left button or when CancelDrag method is called.
    /// </summary> 
    public static final RoutedEvent DragCompletedEvent = EventManager.RegisterRoutedEvent("DragCompleted", RoutingStrategy.Bubble, typeof(DragCompletedEventHandler), typeof(Thumb));
...
//    [Category("Behavior")] 
    ...
    private static final DependencyPropertyKey IsDraggingPropertyKey =
    ...
    ///     Default Value:      false
    /// </summary>
    public static final DependencyProperty IsDraggingProperty = IsDraggingPropertyKey.DependencyProperty; 
