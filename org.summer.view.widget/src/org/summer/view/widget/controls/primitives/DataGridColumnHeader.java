...
import org.summer.view.widget.controls.DataGridColumn;
...
public class DataGridColumnHeader extends ButtonBase implements IProvideDataGridColumn
{ 
//    #region Constructors
...
//    #region Public API
    ...
    /// </summary>
    public static final DependencyProperty SeparatorBrushProperty = 
    ...
    ///     DependencyProperty for SeperatorBrush. 
    /// </summary>
    public static final DependencyProperty SeparatorVisibilityProperty = 
...
//    #region Column Header Generation
    ...
    /// </summary> 
    /*internal*/ public void PrepareColumnHeader(Object item, DataGridColumn column) 
    {
    ...
    /*internal*/ public void ClearHeader()
    {
        _column = null;
    } 
    ...
    /// </summary>
    /*internal*/ public ContainerTracking<DataGridColumnHeader> Tracker 
    {
        get { return _tracker; }
    }
...
//    #region Resize Gripper 
    ...
    /// </summary>
    private static final DependencyPropertyKey DisplayIndexPropertyKey =
    ...
    /// </summary>
    public static final DependencyProperty DisplayIndexProperty = DisplayIndexPropertyKey.DependencyProperty; 
...
//    #region Property Change Notification Propagation
    ...
    /// </summary> 
    /*internal*/ public void NotifyPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    { 
    ...
    private void SetLeftGripperVisibility() 
    {
        ...
        boolean canPrevColumnResize = false;
    ...
    private void SetLeftGripperVisibility(boolean canPreviousColumnResize) 
    {
        if (_leftGripper == null || Column == null) 
        {
            return;
    ...
    private void SetNextHeaderLeftGripperVisibility(boolean canUserResize) 
    {
        DataGrid dataGrid = Column.DataGridOwner; 
    ...
    private void OnColumnVisibilityChanged(DependencyPropertyChangedEventArgs e) 
    {
        ...
        if (dataGrid != null)
        {
            boolean oldIsVisible = (((Visibility)e.OldValue) == Visibility.Visible); 
            boolean newIsVisible = (((Visibility)e.NewValue) == Visibility.Visible);
...
//    #region Auto Sort
    ...
    /// </summary> 
    private static final DependencyPropertyKey CanUserSortPropertyKey =
            DependencyProperty.RegisterReadOnly(
                    "CanUserSort",
                    typeof(boolean), 
                    typeof(DataGridColumnHeader),
    ...
    /// </summary>
    public static final DependencyProperty CanUserSortProperty = CanUserSortPropertyKey.DependencyProperty;
    ...
    /// </summary>
    private static final DependencyPropertyKey SortDirectionPropertyKey = 
            DependencyProperty.RegisterReadOnly( 
                    "SortDirection",
    ...
    /// </summary> 
    public static final DependencyProperty SortDirectionProperty = SortDirectionPropertyKey.DependencyProperty; 
...
//    #region Column Reordering
    ...
    /*internal*/ public DataGridColumnHeadersPresenter ParentPresenter
    { 
        get
        { 
    ...
    /// </summary>
    /*internal*/ public boolean SuppressClickEvent
    {
        get 
        {
...
//    #region Data
    ...
    private boolean _suppressClickEvent;
    private final String LeftHeaderGripperTemplateName = "PART_LeftHeaderGripper";
    private final String RightHeaderGripperTemplateName = "PART_RightHeaderGripper";
