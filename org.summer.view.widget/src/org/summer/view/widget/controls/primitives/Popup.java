...
import org.summer.view.widget.ValueSource;
...
import org.summer.view.widget.controls.ModelTreeEnumerator;
...
import org.summer.view.widget.internal.SecurityCriticalDataForSet;
...
//    #region Properties
    ...
    ///     Default Value:      null
    /// </summary> 
    public static final DependencyProperty ChildProperty =
...
//    [Bindable(true), CustomCategory("Content")] 
    ...
    /// </summary> 
    /*internal*/ public static final UncommonField<List<Popup>> RegisteredPopupsField = new UncommonField<List<Popup>>();

    /*internal*/ public /*override*/ void pushTextRenderingMode()
    {
        //
...
//    [Bindable(true), Category("Appearance")]
    ...
    { 
        ...
        boolean currentVisible = (popup._secHelper.IsWindowAlive() && (popup._asyncDestroy == null)) || (popup._asyncCreate != null);
...
//    [Bindable(true), Category("Layout")]
    ...
    private static boolean IsValidPlacementMode(Object o)
    {
...
//    [Bindable(true), Category("Layout")]
    ...
    /// </summary> 
    /*internal*/ public boolean DropOpposite
    { 
        get 
        {
    ...
    /// </summary> 
//    [CommonDependencyProperty]
    public static final DependencyProperty PopupAnimationProperty = 
            DependencyProperty.Register( 
                    "PopupAnimation",
...
//    [Bindable(true), Category("Appearance")]
    ...
    private static boolean IsValidPopupAnimation(Object o) 
    { 
    ...
    private static final DependencyPropertyKey HasDropShadowPropertyKey = 
...
//    #region Helper Functions
    ...
    /*internal*/ public static boolean IsRootedInPopup(Popup parentPopup, UIElement element) 
    { 
...
//    #region Events
    ...
    private static final EventPrivateKey OpenedKey = new EventPrivateKey(); 
    ...
    private static final EventPrivateKey ClosedKey = new EventPrivateKey();
    ...
    /*internal*/ public event EventHandler PopupCouldClose;
...
//    #region Input 
    ...
    {
    	super.OnPreviewMouseRightButtonDown(e); 
    ...
    { 
        OnPreviewMouseButton(e);
        super.OnPreviewMouseLeftButtonUp(e); 
    }
    ...
    { 
        ...
        { 
            ...
            // ourselves. 
            boolean reestablishCapture = e.OriginalSource != root && Mouse.Captured == null && MS.Win32.SafeNativeMethods.GetCapture() == IntPtr.Zero; 
            ...
            { 
                ...
                boolean newCaptureInsidePopup = Mouse.Captured != null && MenuBase.IsDescendant(root, Mouse.Captured as DependencyObject);
                boolean newCaptureOutsidePopup = !newCaptureInsidePopup && Mouse.Captured != root; 
    ...
    { 
        ...
        if (!popup.StaysOpen)
        {
            ...
            // there is an intermediate hwnd created /*internal*/ publicly by OleDragDrop 
...
//    #region Tree Behavior
    ...
    /// </summary>
    /*internal*/ public /*override*/ boolean BlockReverseInheritance() 
    { 
    ...
    private class PopupModelTreeEnumerator extends ModelTreeEnumerator
    { 
        /*internal*/ public PopupModelTreeEnumerator(Popup popup, Object child) 
...
//    #region Implementation
    ...
    private void SetHitTestable(boolean hitTestable) 
    {
...
//    [SecurityCritical,SecurityTreatAsSafe]
    ...
    private void CreateWindow(boolean asyncCall) 
    { 
        ...
        // create a new window? 
        boolean makeNewWindow = !_secHelper.IsWindowAlive(); 
        if (makeNewWindow)
        { 
            // create the window
...
//    [SecurityCritical, SecurityTreatAsSafe]
    ...
    { 
        boolean animating = SetupAnimations(false);
...
//        }; 
    ...
    private boolean SetupAnimations(boolean visible) 
    { 
    ...
    /*internal*/ public void ForceClose()
    { 
        if (_asyncDestroy != null)
        { 
            CancelAsyncDestroy(); 
...
//    [SecuritySafeCritical] 
    private IntPtr PopupFilterMessage(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, /*ref*/ boolean handled)
    { 
...
//    #region Saved exception
    ...
    private static final UncommonField<Exception> SavedExceptionField = new UncommonField<Exception>();

    /*internal*/ public Exception SavedException
    { 
...
//    #region Positioning
    ...
    /// Reposition the Popup
    /// </summary> 
    /*internal*/ public void Reposition() 
    {
...
//                    Debug.Assert(CheckAccess(), "AsyncReposition not called on the dispatcher thread.");
    ...
    private static boolean IsAbsolutePlacementMode(PlacementMode placement)
    {
        switch (placement) 
        {
    ...
    { 
        ...
        { 
            ...
            boolean animateFromRight = false;
    ...
    private PointCombination GetPointCombination(PlacementMode placement, int i, /*out*/ PopupPrimaryAxis axis) 
    {
        ...
        boolean dropFromRight = SystemParameters.MenuDropAlignment;
    ...
    /*internal*/ public Size RestrictSize(Size desiredSize) 
    { 
    ...
    //       and the Point p passed in is /*out*/side of the work area then return the monitor rect
...
//    #region Private Properties
    ...
    private boolean AnimateFromRight
    {
    ...
    /*internal*/ public boolean HitTestable 
    {
    ...
    private boolean IsDragDropActive
    {
...
//    #region Data
    ...
    /*internal*/ public /*const*/static final double Tolerance = 1.0e-2; // allow errors in double calculations

    private /*const*/static final int AnimationDelay = 150;
    /*internal*/ public static TimeSpan AnimationDelayTime = new TimeSpan(0, 0, 0, 0, AnimationDelay); 
    /*internal*/ public static RoutedEventHandler CloseOnUnloadedHandler; 
    ...
    private BitVector32 _cacheValid = new BitVector32(0);   // Condense booleanean bits 
...
//    #region Popup Security Helper
    ...
    private /*const*/static final double RestrictPercentage = 0.75; // This is how much the max dimensions will be reduced by
    ...
    /// </summary> 
    class PopupSecurityHelper 
    {
        /// <summary> 
        /// Helper constructor
        /// </summary>
        /*internal*/ public PopupSecurityHelper()
        { 
        }
        ...
        /// </SecurityNote>
        /*internal*/ public boolean IsChildPopup 
        {
//            [SecurityCritical, SecurityTreatAsSafe]
            get
            { 
        ...
        /// </SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe] 
        /*internal*/ public boolean IsWindowAlive()
        { 
            if (_window != null) 
            {
        ...
        /// </SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe]
        /*internal*/ public Point ClientToScreen(Visual rootVisual, Point clientPoint)
        { 
...
//        [SecurityCritical, SecurityTreatAsSafe]
        ...
        {
            boolean isChildPopup = IsChildPopup; 
        ...
        /// </SecurityNote> 
//        [SecurityCritical, SecurityTreatAsSafe] 
        /*internal*/ public NativeMethods.POINT GetMouseCursorPos(Visual targetVisual)
        { 
        ...
        /// </SecurityNote> 
//        [SecurityCritical, SecurityTreatAsSafe]
        /*internal*/ public void SetPopupPos(boolean position, int x, int y, boolean size, int width, int height) 
        { 
        ...
        /// </SecurityNote> 
//        [SecurityCritical, SecurityTreatAsSafe]
        /*internal*/ public Rect GetParentWindowRect() 
        {
            NativeMethods.RECT rect = new NativeMethods.RECT(0, 0, 0, 0);
        ...
        /// </SecurityNote> 
//        [SecurityCritical, SecurityTreatAsSafe]
        /*internal*/ public Matrix GetTransformToDevice() 
        {
        ...
        /// </SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe] 
        /*internal*/ public static Matrix GetTransformToDevice(Visual targetVisual) 
        {
            HwndSource hwndSource = null; 
            if (targetVisual != null)
            {
        ...
        /// </SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe] 
        /*internal*/ public Matrix GetTransformFromDevice()
        { 
            CompositionTarget ct = _window.Value.CompositionTarget; 
            if (ct != null && !ct.IsDisposed)
            { 
        ...
        /// </SecurityNote> 
//        [SecurityCritical]
        /*internal*/ public void SetWindowRootVisual(Visual v)
        {
        ...
        /// </SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe]
        /*internal*/ public static boolean IsVisualPresentationSourceNull(Visual visual)
        { 
        ...
        /// </SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe] 
        /*internal*/ public void ShowWindow()
        { 
            if (IsChildPopup) 
            {
        ...
        /// </SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe]
        /*internal*/ public void HideWindow()
        { 
...
//        [SecurityCritical]
        ...
        ///                         Considered safe.
        ///
        ///     Note that setting the _isChildPopup booleanean is critical. 
        ///
        /// </SecurityNote> 
//        [SecurityCritical, SecurityTreatAsSafe] 
        /*internal*/ public void SetHitTestable(boolean hitTestable)
        { 
...
//#pragma warning disable 6518
        ...
        /// </SecurityNote> 
//        [SecurityCritical]
        /*internal*/ public void BuildWindow(int x, int y, Visual placementTarget, 
            boolean transparent, HwndSourceHook hook, AutoResizedEventHandler handler)
        {
...
//#pragma warning restore 6518
        ...
        /// </SecurityNote>
//        [SecurityCritical] 
        private static boolean ConnectedToForegroundWindow(IntPtr window) 
        {
...
//        [SecurityCritical]
        ...
        /// </summary> 
//        [SecurityCritical, SecurityTreatAsSafe]
        /*internal*/ public void ForceMsaaToUiaBridge(PopupRoot popupRoot)
        {
        ...
        /// </SecurityNote> 
//        [SecurityCritical]
        /*internal*/ public void DestroyWindow(HwndSourceHook hook, AutoResizedEventHandler onAutoResizedEventHandler) 
        {
...
//        [SecurityCritical]
        ...
        /// </SecurityNote>
//        [SecurityCritical]
        private boolean _isChildPopupInitialized;
        ...
        private /*const*/static final String WebOCWindowClassName = "Shell Embedding";
    }
