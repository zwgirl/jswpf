...
/// <summary>
/// </summary> 
/*sealed*/ public class ScrollContentPresenter extends ContentPresenter implements IScrollInfo 
{
    //------------------------------------------------------------------- 
    //
    //  Constructors
...
//    #region Protected Methods
    ...
    { 
        ...
        { 
            ...
            return (super.TemplateChild == null) ? 0 : 2;
        } 
    }
    ...
    /// </summary>
    /*override*/ /*internal*/ public UIElement TemplateChild 
    {
        get
        {
            return super.TemplateChild; 
        ...
        set 
        { 
            UIElement oldTemplate = super.TemplateChild;
    ...
    { 
        ...
        boolean etwTracingEnabled = IsScrollClient && EventTrace.IsEnabled(EventTrace.Keyword.KeywordGeneral, EventTrace.Level.Info); 
...
//    #region Internal Methods 
    ...
    /// </returns> 
    /*internal*/ public Rect MakeVisible(Visual visual, Rect rectangle, boolean throwOnError)
    { 
        // 
...
//#pragma warning restore 1634, 1691 
    ...
    /*internal*/ public static double ComputeScrollOffsetWithMinimalScroll(
        double topView,
        double bottomView, 
        double topChild,
        double bottomChild) 
    ...
    /*internal*/ public static double ComputeScrollOffsetWithMinimalScroll( 
        ...
        double topChild, 
        double bottomChild,
        /*ref*/ boolean alignTop, 
        /*ref*/ boolean alignBottom)
    {
        ...
        boolean fAbove = DoubleUtil.LessThan(topChild, topView) && DoubleUtil.LessThan(bottomChild, bottomView); 
        boolean fBelow = DoubleUtil.GreaterThan(bottomChild, bottomView) && DoubleUtil.GreaterThan(topChild, topView); 
        boolean fLarger = (bottomChild - topChild) > (bottomView - topView);
    ...
    static /*internal*/ public double ValidateInputOffset(double offset, String parameterName)
    { 
...
//    #region Private Methods
    ...
    /*internal*/ public void HookupScrollingComponents() 
    {
...
//        Debug.Assert(IsScrollClient);
    ...
    static /*internal*/ public double CoerceOffset(double offset, double extent, double viewport) 
    {
...
//        Debug.Assert(IsScrollClient); 
        ...
        boolean fValid = DoubleUtil.AreClose(_scrollData._computedOffset, computedOffset);
...
//    #region Private Fields 
    ...
    private final AdornerLayer _adornerLayer;
...
//    #region ScrollData
    ...
    { 
        /*internal*/ public ScrollViewer _scrollOwner;

        /*internal*/ public boolean _canHorizontallyScroll;
        /*internal*/ public boolean _canVerticallyScroll; 

        /*internal*/ public Vector _offset;            // Set scroll offset of content.  Positive corresponds to a visually upward offset. 
        /*internal*/ public Vector _computedOffset;    // Actual (computed) scroll offset of content. ""  "" 

        /*internal*/ public Size _viewport;    // ViewportSize is computed from our FinalSize, but may be in different units. 
        /*internal*/ public Size _extent;      // Extent is the total size of our content.
    }
