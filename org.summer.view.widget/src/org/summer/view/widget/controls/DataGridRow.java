...
//        #region Constants
        ...
        private final byte DATAGRIDROW_stateMouseOverCode = 0; 
        private final byte DATAGRIDROW_stateMouseOverEditingCode = 1;
        private final byte DATAGRIDROW_stateMouseOverEditingFocusedCode = 2; 
        private final byte DATAGRIDROW_stateMouseOverSelectedCode = 3;
        private final byte DATAGRIDROW_stateMouseOverSelectedFocusedCode = 4;
        private final byte DATAGRIDROW_stateNormalCode = 5;
        private final byte DATAGRIDROW_stateNormalEditingCode = 6; 
        private final byte DATAGRIDROW_stateNormalEditingFocusedCode = 7;
        private final byte DATAGRIDROW_stateSelectedCode = 8; 
        private final byte DATAGRIDROW_stateSelectedFocusedCode = 9; 
        private final byte DATAGRIDROW_stateNullCode = 255;
...
//        #region Data Item
        ...
        /// </summary> 
        public static final DependencyProperty ItemProperty =
...
//        #region Template 
        ...
        /// </summary> 
        public static final DependencyProperty ItemsPanelProperty = ItemsControl.ItemsPanelProperty.AddOwner(typeof(DataGridRow));
...
//        #region Visual States
        ...
        private boolean IsDataGridKeyboardFocusWithin
        { 
            get
            { 
...
//        #region Row Header
        ...
        /// </summary> 
        public static final DependencyProperty ValidationErrorTemplateProperty = 
...
//        #region Row Details
        ...
        /// </summary> 
        public static final DependencyProperty DetailsTemplateProperty =
        ...
        /// </summary> 
        public static final DependencyProperty DetailsTemplateSelectorProperty =
        ...
        /// </summary>
        public static final DependencyProperty DetailsVisibilityProperty =
        ...
        /*internal*/ public boolean DetailsLoaded
        { 
            get 
            {
...
//        #region Row Generation
        ...
        /*internal*/ public void PrepareRow(Object item, DataGrid owningDataGrid)
        { 
            boolean fireOwnerChanged = (_owner != owningDataGrid);
            ...
            boolean forcePrepareCells = false;
        ...
        /// </summary> 
        /*internal*/ public void ClearRow(DataGrid owningDataGrid)
        { 
        ...
        /// </summary> 
        /*internal*/ public ContainerTracking<DataGridRow> Tracker 
        {
            get { return _tracker; } 
        }
        ...
        /*internal*/ public void OnRowResizeStarted() 
        {
            var cellsPresenter = CellsPresenter; 
            if (cellsPresenter != null)
            {
        ...
        /*internal*/ public void OnRowResize(double changeAmount) 
        {
            var cellsPresenter = CellsPresenter; 
            if (cellsPresenter != null)
            {
        ...
        /*internal*/ public void OnRowResizeCompleted(boolean canceled)
        { 
            var cellsPresenter = CellsPresenter; 
        ...
        /*internal*/ public void OnRowResizeReset()
        { 
            var cellsPresenter = CellsPresenter; 
            if (cellsPresenter != null)
            { 
        ...
        protected /*internal*/ public /*virtual*/ void OnColumnsChanged(ObservableCollection<DataGridColumn> columns, NotifyCollectionChangedEventArgs e) 
        {
            DataGridCellsPresenter cellsPresenter = CellsPresenter;
            if (cellsPresenter != null)
            { 
        ...
        /// </summary> 
        /*internal*/ public DataGridCellsPresenter CellsPresenter
        { 
        ...
        /// </summary> 
        /*internal*/ public DataGridDetailsPresenter DetailsPresenter
        { 
        ...
        /// </summary> 
        /*internal*/ public DataGridRowHeader RowHeader
        { 
        ...
        /// </remarks> 
        private void SyncProperties(boolean forcePrepareCells)
        { 
...
//        #region Alternation 
        ...
        /// </remarks> 
        public static final DependencyProperty AlternationIndexProperty = ItemsControl.AlternationIndexProperty.AddOwner(typeof(DataGridRow));
...
//        [Bindable(true), Category("Appearance")] 
        ...
        /// </summary> 
        public static final DependencyProperty IsSelectedProperty = Selector.IsSelectedProperty.AddOwner( 
            typeof(DataGridRow),
        ...
        /// </summary>
        public static final RoutedEvent SelectedEvent = Selector.SelectedEvent.AddOwner(typeof(DataGridRow)); 
        ...
        /// </summary> 
        public static final RoutedEvent UnselectedEvent = Selector.UnselectedEvent.AddOwner(typeof(DataGridRow)); 
...
//        #region Editing
        ...
        { 
            ...
            /*internal*/ public set { SetValue(IsEditingPropertyKey, value); } 
        }

        private static final DependencyPropertyKey IsEditingPropertyKey =
            DependencyProperty.RegisterReadOnly("IsEditing", typeof(boolean), typeof(DataGridRow), new FrameworkPropertyMetadata(false, OnNotifyRowAndRowHeaderPropertyChanged)); 

        /// <summary> 
        ///     The DependencyProperty for IsEditing. 
        /// </summary>
        public static final DependencyProperty IsEditingProperty = IsEditingPropertyKey.DependencyProperty; 
...
//        #region Column Virtualization 
        ...
        /*internal*/ public void ScrollCellIntoView(int index)
        {
            DataGridCellsPresenter cellsPresenter = CellsPresenter;
            if (cellsPresenter != null) 
            {
...
//        #region New Item
        ...
        {
            get { return (boolean)GetValue(IsNewItemProperty); }
            /*internal*/ public set { SetValue(IsNewItemPropertyKey, value); }
        } 

        /// <summary> 
        ///     Using a DependencyProperty as the backing store for IsNewItem.  This enables animation, styling, binding, etc... 
        /// </summary>
        /*internal*/ public static final DependencyPropertyKey IsNewItemPropertyKey = 
            DependencyProperty.RegisterReadOnly("IsNewItem", typeof(boolean), typeof(DataGridRow), new FrameworkPropertyMetadata(false));

        /// <summary>
        ///     DependencyProperty for IsNewItem property. 
        /// </summary>
        public static final DependencyProperty IsNewItemProperty = 
...
//        #region Helpers
        ...
        /// </summary>
        /*internal*/ public boolean DetailsPresenterDrawsGridLines 
        {
        ...
        /// </summary>
        /*internal*/ public DataGridCell TryGetCell(int index) 
        {
            DataGridCellsPresenter cellsPresenter = CellsPresenter;
            if (cellsPresenter != null)
            { 
...
//        #region Data 
        ...
        /*internal*/ public boolean _detailsLoaded; 
