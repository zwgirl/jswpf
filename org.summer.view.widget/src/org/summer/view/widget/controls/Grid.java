...
//    #region Constructors 
    ...
    public Grid() 
    {
        SetFlags((boolean) ShowGridLinesProperty.GetDefaultValue(DependencyObjectType), Flags.ShowGridLinesPropertyValue);
    }
...
//    #region Public Methods 
    ...
    protected /*internal*/ /*override*/ IEnumerator LogicalChildren
    {
        ...
        { 
            ...
            boolean noChildren = (super.VisualChildrenCount == 0) || IsItemsHost; 
...
//    [AttachedPropertyBrowsableForChildren()]
    ...
    public static void SetIsSharedSizeScope(UIElement element, boolean value)
    { 
        if (element == null)
        { 
            throw new ArgumentNullException("element"); 
    ...
    public static boolean GetIsSharedSizeScope(UIElement element) 
    {
        if (element == null)
        {
            throw new ArgumentNullException("element"); 
...
//    #region Protected Methods 
    ...
    { 
        ...
        else return super.GetVisualChild(index); 
    ...
    protected /*override*/ Size MeasureOverride(Size constraint) 
    {
        ...
        { 
            ...
            { 
                {
                    boolean sizeToContentU = double.IsPositiveInfinity(constraint.Width);
                    boolean sizeToContentV = double.IsPositiveInfinity(constraint.Height);
...

                {
                    ...
                    boolean canResolveStarsV = !HasGroup3CellsInAutoRows;
                    ...
                    { 
                        ...
                        boolean canResolveStarsU = extData.CellGroup2 > PrivateCells.Length; 
                        if (canResolveStarsU)
                        {
                            if (HasStarCellsU) { ResolveStar(DefinitionsU, constraint.Width); }
                            MeasureCellsGroup(extData.CellGroup3, constraint, false, false); 
                        ...
                        else 
                        {
                            ...
                            boolean hasDesiredSizeUChanged = false; 
                            int cnt=0; 
        ...
        DependencyObject visualRemoved) 
    {
        ...
        super.OnVisualChildrenChanged(visualAdded, visualRemoved);
    } 
...
//    #region Internal Properties
    ...
    /// </summary>
    /*internal*/ boolean MeasureOverrideInProgress 
    { 
    ...
    /// </summary>
    /*internal*/ boolean ArrangeOverrideInProgress 
    { 
    ...
    /// </summary>
    /*internal*/ boolean ColumnDefinitionCollectionDirty 
    { 
    ...
    /// </summary>
    /*internal*/ boolean RowDefinitionCollectionDirty 
    { 
...
//    #region Private Methods
    ...
    private double[] CacheMinSizes(int cellsHead, boolean isRows)
    {
    ...
    private void ApplyCachedMinSizes(double[] minSizes, boolean isRows)
    { 
    ...
    private void MeasureCellsGroup(
        int cellsHead, 
        Size referenceSize,
        boolean ignoreDesiredSizeU, 
        boolean forceInfinityV) 
    {
        boolean unusedHasDesiredSizeUChanged; 
    ...
    private void MeasureCellsGroup(
        ...
        boolean ignoreDesiredSizeU,
        boolean forceInfinityV, 
        /*out*/ boolean hasDesiredSizeUChanged)
    {
        ...
        boolean ignoreDesiredSizeV = forceInfinityV;
...
//    [EditorBrowsable(EditorBrowsableState.Never)]
    public boolean ShouldSerializeColumnDefinitions() 
    { 
        ExtendedData extData = ExtData;
        return (    extData != null 
    ...
    /// </summary> 
//    [EditorBrowsable(EditorBrowsableState.Never)]
    public boolean ShouldSerializeRowDefinitions() 
    {
        ExtendedData extData = ExtData;
        return (    extData != null
    ...
    /// <c>true</c>.
    /// </remarks> 
    private boolean CheckFlagsOr(Flags flags)
    { 
    ...
    private static void OnShowGridLinesPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) 
    {
        ...
        grid.SetFlags((boolean) e.NewValue, Flags.ShowGridLinesPropertyValue);
    } 
    ...
    /// </summary>
    private static boolean IsIntValueNotNegative(Object value) 
    {
        return ((int)value >= 0); 
    } 
    ...
    /// <see cref="DependencyProperty.ValidateValueCallback"/>
    /// </summary>
    private static boolean IsIntValueGreaterThanZero(Object value)
    { 
        return ((int)value > 0);
    } 
    ...
    /// </returns>
    private static boolean CompareNullRefs(Object x, Object y, out int result) 
    { 
        result = 2;
...
//    #region Private Properties 
    ...
    /// </summary>
    private boolean CellsStructureDirty
    {
    ...
    /// </summary>
    private boolean SizeToContentU
    {
    ...
    /// </summary>
    private boolean SizeToContentV
    {
    ...
    /// </summary>
    private boolean HasGroup3CellsInAutoRows
    {
    ...
    private static boolean _IsZero(double d) 
    {
    ...
    private static boolean _AreClose(double d1, double d2) 
    { 
...
//    #region Static Fields
    private final double c_epsilon = 1e-5;                  //  used in fp calculations
    private final double c_starClip = 1e298;                //  used as maximum for clipping star values during normalization
    private final int c_layoutLoopMaxCount = 5;             // 5 is an arbitrary constant chosen to end the measure loop 
    private static final LocalDataStoreSlot s_tempDefinitionsDataSlot = Thread.AllocateDataSlot();
    private static final IComparer s_spanPreferredDistributionOrderComparer = new SpanPreferredDistributionOrderComparer(); 
    private static final IComparer s_spanMaxDistributionOrderComparer = new SpanMaxDistributionOrderComparer(); 
    private static final IComparer s_starDistributionOrderComparer = new StarDistributionOrderComparer();
    private static final IComparer s_distributionOrderComparer = new DistributionOrderComparer(); 
...
//    #region Properties 
    ...
    /// of grid lines. 
    /// </summary> 
    public static final DependencyProperty ShowGridLinesProperty =
...
//    [CommonDependencyProperty]
    public static final DependencyProperty ColumnProperty =
    ...
    /// </summary> 
//    [CommonDependencyProperty]
    public static final DependencyProperty RowProperty = 
            DependencyProperty.RegisterAttached( 
                  "Row",
                  typeof(Integer), 
                  typeof(Grid),
    ...
    /// </remarks> 
//    [CommonDependencyProperty]
    public static final DependencyProperty ColumnSpanProperty = 
            DependencyProperty.RegisterAttached(
                  "ColumnSpan",
                  typeof(Integer),
                  typeof(Grid), 
    ...
    /// </remarks>
//    [CommonDependencyProperty]
    public static final DependencyProperty RowSpanProperty =
            DependencyProperty.RegisterAttached( 
                  "RowSpan",
                  typeof(Integer), 
                  typeof(Grid), 
    ...
    /// </summary> 
    public static final DependencyProperty IsSharedSizeScopeProperty  =
            DependencyProperty.RegisterAttached( 
                  "IsSharedSizeScope",
                  typeof(Boolean),
                  typeof(Grid),
...
//    #region Private Structures Classes
    ...
    private class CellCache
    {
        ...
        /*internal*/ int Next; 
        /*internal*/ boolean IsStarU { get { return ((SizeTypeU & LayoutTimeSizeType.Star) != 0); } }
        /*internal*/ boolean IsAutoU { get { return ((SizeTypeU & LayoutTimeSizeType.Auto) != 0); } }
        /*internal*/ boolean IsStarV { get { return ((SizeTypeV & LayoutTimeSizeType.Star) != 0); } }
        /*internal*/ boolean IsAutoV { get { return ((SizeTypeV & LayoutTimeSizeType.Auto) != 0); } } 
    }
    ...
    class SpanKey
    {
        ...
        /*internal*/ SpanKey(int start, int count, boolean u) 
        {
            _start = start;
            _count = count;
            _u = u; 
        ...
        /// </summary> 
        /*internal*/ boolean U { get { return (_u); } }
    ...
    /// </summary>
    class SpanPreferredDistributionOrderComparer implements IComparer
    {
    ...
    /// </summary> 
    class SpanMaxDistributionOrderComparer implements IComparer
    { 
        public int Compare(Object x, Object y)
        {
            DefinitionBase definitionX = x as DefinitionBase;
    ...
    /// </summary> 
    class StarDistributionOrderComparer implements IComparer
    { 
        public int Compare(Object x, Object y) 
        {
            DefinitionBase definitionX = x as DefinitionBase; 
    ...
    /// </summary> 
    class DistributionOrderComparer implements IComparer
    { 
        public int Compare(Object x, Object y)
        {
            DefinitionBase definitionX = x as DefinitionBase;
    ...
    /// </summary> 
    class StarDistributionOrderIndexComparer implements IComparer
    { 
        private final DefinitionBase[] definitions; 
    ...
    /// DistributionOrderComparer.
    /// </summary> 
    class DistributionOrderIndexComparer implements IComparer
    {
        private final DefinitionBase[] definitions;
    ...
    /// </summary> 
    class RoundingErrorIndexComparer implements IComparer
    { 
    ...
    /// </summary>
    class GridChildrenCollectionEnumeratorSimple implements IEnumerator
    { 
        /*internal*/ GridChildrenCollectionEnumeratorSimple(Grid grid, boolean includeChildren)
        { 
...
//                    #pragma warning suppress 6503 // IEnumerator.Current is documented to throw this exception 
    ...
    /// </summary> 
    /*internal*/ class GridLinesRenderer extends DrawingVisual
    {
        /// <summary>
        ...
        private final double c_dashLength = 4.0;    //
        private final double c_penWidth = 1.0;      //
        private static final Pen s_oddDashPen;   //  first pen to draw dash 
        private static final Pen s_evenDashPen;  //  second pen to draw dash
        private static final Point c_zeroPoint = new Point(0, 0); 
    } 
...
//    private static final boolean _performanceFrequencyInitialized = InitializePerformanceFrequency();
//
...
//    }
//
//    private static boolean InitializePerformanceFrequency()
//    { 
//        long l;
...
//    private boolean _hasNewCounterInfo;
//#endif // GRIDPARANOIA
