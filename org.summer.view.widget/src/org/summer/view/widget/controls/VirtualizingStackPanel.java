...
import org.summer.view.widget.controls.primitives.GeneratorDirection;
import org.summer.view.widget.controls.primitives.GeneratorPosition;
...
import org.summer.view.widget.controls.primitives.IRecyclingItemContainerGenerator;
...
import org.summer.view.widget.controls.primitives.ScrollBar;
...
/// <summary> 
    ...
    /// </summary>
    public class VirtualizingStackPanel extends VirtualizingPanel implements IScrollInfo, IStackMeasure
    { 
        //-------------------------------------------------------------------
        // 
        //  Constructors 
...
//        #region Constructors
        ...
        //
        private static final DependencyProperty ContainerSizeProperty = DependencyProperty.Register("ContainerSize", typeof(Size), typeof(VirtualizingStackPanel)); 
        ...
        //
        private static final DependencyProperty AreContainersUniformlySizedProperty = DependencyProperty.Register("AreContainersUniformlySized", typeof(boolean), typeof(VirtualizingStackPanel)); 
        ...
        // been realized yet. 
        //
        private static final DependencyProperty UniformOrAverageContainerSizeProperty = DependencyProperty.Register("UniformOrAverageContainerSize", typeof(double), typeof(VirtualizingStackPanel)); 
...
//            {
//                _indicesStoredInItemValueStorage = new int[] {ContainerSizeProperty.GlobalIndex, 
...
//        #region IScrollInfo Methods
        ...
        private void SetAnchorInformation(boolean isHorizontalOffset)
        { 
            if (IsScrolling)
            {
                //
                ...
                { 
                    ...
                    { 
                        boolean areContainersUniformlySized = GetAreContainersUniformlySized(null, this);
...
//                                        Debug.Assert(AnchorOperationField.GetValue(this) == null, "There is already a pending AnchorOperation.");
        ...
        { 
            boolean isAnchorOperationPending = false;
            OnAnchorOperation(isAnchorOperationPending); 
        }

        private void OnAnchorOperation(boolean isAnchorOperationPending)
        { 
//            Debug.Assert(_firstContainerInViewport != null, "Must have an anchor element");
        ...
        private void ClearAnchorInformation(boolean shouldAbort) 
        {
            if (_firstContainerInViewport != null) 
            {
        ...
        /*internal*/ public void AnchoredInvalidateMeasure() 
        { 
...
//        #region Public Properties 
        ...
        /// </summary>
        public /*new*/ static final DependencyProperty IsVirtualizingProperty = 
        ...
        /// </summary>
        public /*new*/ static final DependencyProperty VirtualizationModeProperty = 
        ...
        /// </summary> 
        protected /*internal*/ /*override*/ boolean HasLogicalOrientation
        {
            get { return true; }
        } 
...
//        #region Public Events 
        ...
        /// </summary>
        public static final RoutedEvent CleanUpVirtualizedItemEvent = EventManager.RegisterRoutedEvent("CleanUpVirtualizedItemEvent", RoutingStrategy.Direct, typeof(CleanUpVirtualizedItemEventHandler), typeof(VirtualizingStackPanel)); 
...
//        #region Protected Methods
        ...
        protected /*override*/ boolean CanHierarchicallyScrollAndVirtualizeCore
        {
            get { return true; }
        } 
...
//#endif 
        ...
        private Size MeasureOverrideImpl(Size constraint, double/*?*/ lastPageSafeOffset, /*ref*/ List<double> previouslyMeasuredOffsets, boolean remeasure)
        { 
            boolean etwTracingEnabled = IsScrolling && EventTrace.IsEnabled(EventTrace.Keyword.KeywordGeneral, EventTrace.Level.Info);
            ...
            boolean hasVirtualizingChildren = false;
            ...
            { 
                ...
                { 
                    ...
                    // 
                    boolean mustDisableVirtualization = false; 
                    ...
                    // 
                    boolean foundFirstItemInViewport = false, foundLastItemInViewport = false, foundFirstItemInExtendedViewport = false;
                    ...
                    // to the stackSize. 
                    //
                    boolean areContainersUniformlySized = GetAreContainersUniformlySized(itemStorageProvider, parentItem); 
                    boolean computedAreContainersUniformlySized = areContainersUniformlySized;
                    boolean hasUniformOrAverageContainerSizeBeenSet;
                    ...
                    boolean hasBringIntoViewContainerBeenMeasured = false;
                    ...
                    if (itemCount > 0) 
                    {
                        ...
                        { 
                            ...
                            {
                                boolean adjustToChangeInFirstItem = false; 
...
//                                    Debug.Assert(!adjustToChangeInFirstItem || foundFirstItemInViewport, "This loop should only happen twice at most");
                                    ...
                                    // 
                                    int startIndex;
                                    boolean isAlwaysBeforeFirstItem = false; 
                                    boolean isAlwaysAfterFirstItem = false;
                                    boolean isAlwaysAfterLastItem = false;
...
//#endif 
        ...
        protected /*override*/ void OnItemsChanged(Object sender, ItemsChangedEventArgs args) 
        {
            ...
            super.OnItemsChanged(sender, args);
        ...
        protected /*override*/ boolean ShouldItemsChangeAffectLayoutCore(boolean areItemChangesLocal, ItemsChangedEventArgs args)
        { 
            boolean shouldItemsChangeAffectLayout = true; 
        ...
        private void UpdateExtent(boolean areItemChangesLocal) 
        { 
            boolean isHorizontal = (Orientation == Orientation.Horizontal);
...
//        #region Internal Methods 
        ...
        /*internal*/ public void ClearAllContainers() 
        { 
            IItemContainerGenerator generator = Generator;
            if (generator != null) 
            {
...
//        #region MeasureOverride Helpers
        ...
        {
            boolean isChildHorizontal = false; 
            return GetVirtualizingChild(element, /*ref*/ isChildHorizontal); 
        }
 
        private static IHierarchicalVirtualizationAndScrollInfo GetVirtualizingChild(DependencyObject element, /*ref*/ boolean isChildHorizontal)
        {
        ...
        private void GetOwners(
            boolean shouldSetVirtualizationState, 
            ...
            /*out*/ boolean mustDisableVirtualization)
        {
            groupItem = null; 
            parentItem = null;
            ...
            boolean mustDisableVirtualization) 
        {
            if (itemsControl != null)
            {
                boolean isVirtualizing = GetIsVirtualizing(itemsControl); 
                boolean isVirtualizingWhenGrouping = GetIsVirtualizingWhenGrouping(itemsControl);
                VirtualizationMode virtualizationMode = GetVirtualizationMode(itemsControl); 
                boolean isGrouping = itemsControl.IsGrouping; 
                ...
                boolean oldIsPixelBased = IsPixelBased;
...
//            Debug.Assert(cacheUnit != VirtualizationCacheLengthUnit.Page, "Page cacheUnit is not expected here."); 
        ...
        private void CoerceScrollingViewportOffset(/*ref*/ Rect viewport, Size extent, boolean isHorizontal) 
        { 
...
//            Debug.Assert(!containerSize.IsEmpty, "We can't estimate an empty size"); 
        ...
        private void SetContainerSizeForItem(
            ...
            Size containerSize,
            boolean isHorizontal, 
            /*ref*/ boolean hasUniformOrAverageContainerSizeBeenSet, 
            /*ref*/ double uniformOrAverageContainerSize,
            /*ref*/ boolean areContainersUniformlySized) 
        {
...
//            Debug.Assert(cacheUnit != VirtualizationCacheLengthUnit.Page, "Page cacheUnit is not expected here.");
        ...
        private boolean IsEndOfViewport(boolean isHorizontal, Rect viewport, Size stackPixelSizeInViewport)
        {
            if (isHorizontal) 
            {
        ...
        private boolean IsViewportEmpty(boolean isHorizontal, Rect viewport)
        { 
            if (isHorizontal) 
            {
...
//            Debug.Assert(virtualizingChild != null, "This method should only be invoked for a virtualizing child");
        ...
        private void GetSizesForChild(
            boolean isHorizontal,
            boolean isChildHorizontal, 
            boolean isBeforeFirstItem,
            boolean isAfterLastItem, 
            IHierarchicalVirtualizationAndScrollInfo virtualizingChild, 
            ...
            /*out*/ Size childLogicalSizeInCacheAfterViewport)
        {
            ...
            if (virtualizingChild != null) 
            {
                ...
                boolean isChildHeaderHorizontal = (headerPosition == RelativeHeaderPosition.Left || headerPosition == RelativeHeaderPosition.Right);
...
//                Debug.Assert(DoubleUtil.AreClose(pixelSizeInViewport + pixelSizeBeforeViewport + pixelSizeAfterViewport, childPixelSize.Height), "The computed sizes within and outside the viewport should add up to the childPixelSize.");
        ...
        private static void StackSizes(boolean isHorizontal, /*ref*/ Size sz1, Size sz2) 
        { 
            if (isHorizontal)
            { 
                sz1.Width += sz2.Width;
        ...
        private void SyncUniformSizeFlags(
            ...
            /*ref*/ double uniformOrAverageContainerSize,
            boolean isHorizontal,
            boolean evaluateAreContainersUniformlySized) 
        {
...
//                Debug.Assert(evaluateAreContainersUniformlySized || !computedAreContainersUniformlySized, "AreContainersUniformlySized starts off true and can only be flipped to false.");
        ...
        private boolean GetAreContainersUniformlySized(IContainItemStorage itemStorageProvider, Object item)
        {
            ...
            if (item == this) 
            {
                if (AreContainersUniformlySized.HasValue) 
                {
                    ...
                    return (boolean)AreContainersUniformlySized;
                } 
            }
            else 
            { 
        ...
        private void SetAreContainersUniformlySized(IContainItemStorage itemStorageProvider, Object item, boolean value) 
        {
            Debug.Assert(itemStorageProvider != null || item == this, "An item storage provider must be available.");
            Debug.Assert(item != null, "An item must be available.");
        ...
        private double GetUniformOrAverageContainerSize(IContainItemStorage itemStorageProvider, Object item, /*out*/ boolean hasUniformOrAverageContainerSizeBeenSet) 
        {
            Debug.Assert(itemStorageProvider != null || item == this, "An item storage provider must be available."); 
            Debug.Assert(item != null, "An item must be available."); 
        ...
        private void MeasureExistingChildBeyondExtendedViewport(
            ...
            /*ref*/ boolean computedAreContainersUniformlySized, 
            /*ref*/ IList items,
            /*ref*/ IList children,
            /*ref*/ int childIndex,
            /*ref*/ boolean visualOrderChanged, 
            /*ref*/ boolean isHorizontal,
            /*ref*/ Size childConstraint, 
            /*ref*/ boolean foundFirstItemInViewport, 
            /*ref*/ double firstItemInViewportOffset,
            /*ref*/ boolean mustDisableVirtualization, 
            /*ref*/ boolean hasVirtualizingChildren,
            /*ref*/ boolean hasBringIntoViewContainerBeenMeasured)
        {
            ...
            Size stackLogicalSizeInCacheBeforeViewport = new Size();
            Size stackLogicalSizeInCacheAfterViewport = new Size(); 
            boolean isBeforeFirstItem = childIndex < _firstItemInExtendedViewportChildIndex; 
            boolean isAfterFirstItem = childIndex > _firstItemInExtendedViewportChildIndex;
            boolean isAfterLastItem = childIndex > _firstItemInExtendedViewportChildIndex + _actualItemsInExtendedViewportCount; 
            boolean skipActualMeasure = false;
            boolean skipGeneration = true;
        ...
        { 
            ...
            boolean isChildHorizontal = isHorizontal;
        ...
        private void ArrangeItemsBeyondTheExtendedViewport( 
            ...
            boolean areContainersUniformlySized,
            double uniformOrAverageContainerSize, 
            boolean beforeExtendedViewport,
            /*ref*/ Rect rcChild, 
            /*ref*/ Size previousChildSize, 
            /*ref*/ Point previousChildOffset,
            /*ref*/ int previousChildItemIndex) 
...
//        #endregion 
        ...
        /// <param name="container"></param>
        /// <returns></returns> 
        private boolean InsertRecycledContainer(int childIndex, UIElement container) 
        {
        ...
        private boolean InsertContainer(int childIndex, UIElement container, boolean isRecycled)
        {
            ...
            else
            {
                if (visualTreeIndex < children.Count) 
                {
                    ...
                    if (isRecycled && container.InternalVisualParent != null) 
                    {
                        ...
                        // insert it in the proper location.   For perf we'll use an /*internal*/ public Move API that moves
        ...
        private void EnsureCleanupOperation(boolean delay) 
        {
            if (delay)
            {
                boolean noPendingOperations = true; 
        ...
        private boolean PreviousChildIsGenerated(int childIndex)
        { 
        ...
        private boolean AddContainerFromGenerator(int childIndex, UIElement child, boolean newlyRealized, boolean isBeforeViewport) 
        {
            boolean visualOrderChanged = false;
...
//#endif
        ...
        /// runs after measuring the children.
        /// </summary>
        private boolean CleanupContainers(int firstItemInExtendedViewportIndex,
            int itemsInExtendedViewportCount, 
            ItemsControl itemsControl,
            boolean timeBound, 
            int startTickCount) 
        {
            ...
            UIElement child;
            Object item; 
            boolean isVirtualizing = IsVirtualizing; 
            boolean needsMoreCleanup = false;
        ...
        private void debug_VerifyRealizedChildren() 
        {
           ...
           /* System.Windows.Controls.*/ItemContainerGenerator generator = Generator as /*System.Windows.Controls.*/ItemContainerGenerator;
            ...
            { 
                ...
                for/*each*/ (UIElement child : InternalChildren)
                {
...
//        #region Delayed Cleanup Methods
        ...
        private boolean NotifyCleanupItem(int childIndex, UIElementCollection children, ItemsControl itemsControl)
        { 
            return NotifyCleanupItem(children[childIndex], itemsControl);
        } 
 
        private boolean NotifyCleanupItem(UIElement child, ItemsControl itemsControl)
        { 
...
//#endif
            ...
            boolean viewportSizeChanged = !DoubleUtil.AreClose(viewportSize, _scrollData._viewport);
            boolean extentSizeChanged = !DoubleUtil.AreClose(extentSize, _scrollData._extent); 
            boolean computedViewportOffsetChanged = !DoubleUtil.AreClose(computedViewportOffset, _scrollData._computedOffset); 
            ...
            { 
                ...
                boolean vsbAuto = (vsbv == ScrollBarVisibility.Auto); 
                ...
                if (allowRemeasure) 
                {
                    ...
                    boolean hsbAuto = (hsbv == ScrollBarVisibility.Auto); 
            ...
            if (isHorizontal) 
            {
                ...
                if (allowRemeasure)
                { 
                    boolean wasViewportOffsetCoerced = !DoubleUtil.AreClose(computedViewportOffset.X, _scrollData._offset.X);
            ...
            else 
            {
                ...
                if (allowRemeasure) 
                {
                    boolean wasViewportOffsetCoerced = !DoubleUtil.AreClose(computedViewportOffset.Y, _scrollData._offset.Y); 
        ...
        private boolean WasOffsetPreviouslyMeasured(
        ...
        // pixel offset.
        private void MakeVisiblePhysicalHelper(Rect r, /*ref*/ Vector newOffset, /*ref*/ Rect newRect, boolean isHorizontal, /*ref*/ boolean alignTop, /*ref*/ boolean alignBottom) 
        {
        ...
        private void MakeVisibleLogicalHelper(int childIndex, Rect r, /*ref*/ Vector newOffset, /*ref*/ Rect newRect, /*ref*/ boolean alignTop, /*ref*/ boolean alignBottom) 
        {
            boolean fHorizontal = (Orientation == Orientation.Horizontal); 
        ...
        /// </summary> 
        private double GetMaxChildArrangeLength(IList children, boolean isHorizontal)
        { 
...
//        #region Private Properties 
        ...
        private boolean InRecyclingMode 
        {
            get 
            {
        ...
        /*internal*/ public boolean IsScrolling
        {
        ...
        /// </remarks> 
        /*internal*/ public boolean IsPixelBased
        { 
            get
            {
        ...
        /*internal*/ public boolean MustDisableVirtualization
        { 
            get
            { 
        ...
        /*internal*/ public boolean MeasureCaches 
        { 
            get
            { 
        ...
        private boolean IsVirtualizing 
        {
            get
            {
            ...
            { 
                ...
                boolean isVirtualizing = IsItemsHost && value; 
        ...
        private boolean HasVirtualizingChildren
        {
            get 
            {
        ...
        private boolean AlignTopOfBringIntoViewContainer 
        { 
            get
            { 
        ...
        private boolean WasLastMeasurePassAnchored
        {
            get
            { 
        ...
        private boolean ItemsChangedDuringMeasure
        { 
            get 
            {
        ...
        /*internal*/ public boolean IgnoreMaxDesiredSize 
        {
            get 
            { 
        ...
        /// </summary>
        private boolean/*?*/ AreContainersUniformlySized
        {
            get; 
            set;
        } 
        ...
        boolean IStackMeasure.IsScrolling 
        {
...
//        #region Private Fields 
        ...
        private boolean GetBoolField(BoolField field)
        {
            return (_boolFieldStore & field) != 0; 
        }
 
        private void SetBoolField(BoolField field, boolean value) 
        {
            if (value) 
            {
...
//        [System.Flags]
        ...
        private /*const*/static final int FocusTrail = 5; // The maximum number of items off the edge we will generate to get a focused item (so that keyboard navigation can work)
        ...
        private static final UncommonField<DispatcherOperation> MeasureCachesOperationField = new UncommonField<DispatcherOperation>(); 
        private static final UncommonField<DispatcherOperation> AnchorOperationField = new UncommonField<DispatcherOperation>();
        private static final UncommonField<DispatcherOperation> AnchoredInvalidateMeasureOperationField = new UncommonField<DispatcherOperation>(); 
        private static final UncommonField<DispatcherOperation> ClearIsScrollActiveOperationField = new UncommonField<DispatcherOperation>();
...
//        #region ScrollData 
        ...
        private class ScrollData implements IStackMeasureScrollData
        { 
            ...
            /*internal*/ public void ClearLayout() 
            {
                _offset = new Vector();
            ...
            /*internal*/ public Vector _computedOffset = new Vector(0,0); 
            ///*internal*/ public Vector _viewportOffset;    // ViewportOffset is in pixels
            /*internal*/ public Size _viewport;            // ViewportSize is in {pixels x items} (or vice-versa). 
            /*internal*/ public Size _extent;              // Extent is the total number of children (logical dimension) or physical size
            /*internal*/ public ScrollViewer _scrollOwner; // ScrollViewer to which we're attached.

            /*internal*/ public Size _maxDesiredSize;      // Hold onto the maximum desired size to avoid re-laying out the parent ScrollViewer. 
