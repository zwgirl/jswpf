...
// Backing store for the PasswordBox control. 
    ...
    //    and use the /*internal*/ public Password property. 
    //
    //  - Performance doesn't scale with large documents.  The expectation is 
    //    that the document will always be small (< 100 chars). 
    //
    /*internal*/ public /*sealed*/ class PasswordTextContainer extends ITextContainer 
    {
        //-----------------------------------------------------
        //
        //  Constructors 
...
//        #region Constructors
        ...
        /*internal*/ public PasswordTextContainer(PasswordBox passwordBox)
        {
...
//        #region Internal Methods 
        ...
        /// </remarks> 
        /*internal*/ public void InsertText(ITextPointer position, string textData) 
        {
            int offset; 
            int i;
        ...
        /// </remarks> 
        /*internal*/ public void DeleteContent(ITextPointer startPosition, ITextPointer endPosition)
        {
            int startOffset;
            int endOffset; 
            int i;
        ...
        /*internal*/ public void AddPosition(PasswordTextPointer position)
        { 
            int index; 
        ...
        // Positions in the list are updated as the document content changes. 
        /*internal*/ public void RemovePosition(PasswordTextPointer searchPosition) 
        {
            int index; 
        ...
        /// </remarks> 
        boolean ITextContainer.IsReadOnly 
        {
            get 
            {
                return false;
        ...
        /// The returned ITextPointer has LogicalDirection.Backward gravity. 
        /// </remarks> 
        /*internal*/ public ITextPointer Start
        { 
            get
            {
        ...
        /// The returned ITextPointer has LogicalDirection.Forward gravity.
        /// </remarks>
        /*internal*/ public ITextPointer End 
        {
            get 
            { 
        ...
        /*internal*/ public SecureString GetPasswordCopy()
        { 
            return _password.Copy(); 
        }
 
        // Sets the content with a copy of a supplied SecureString.
        /*internal*/ public void SetPassword(SecureString value)
        {
            int symbolCount; 
        ...
        // called.  Defaults to '*'.
        /*internal*/ public char PasswordChar 
        {
            get
            {
        ...
        /*internal*/ public PasswordBox PasswordBox 
        {
            get
            {
                return _passwordBox; 
