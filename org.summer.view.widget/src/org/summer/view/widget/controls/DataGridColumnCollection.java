...
import org.summer.view.window.DoubleUtil;
 /// <summary> 
    ...
    /// </summary>
    /*internal*/ public class DataGridColumnCollection extends ObservableCollection<DataGridColumn>
    { 
        /*internal*/ public DataGridColumnCollection(DataGrid dataGridOwner)
        { 
            Debug.Assert(dataGridOwner != null, "We should have a valid DataGrid"); 

            DisplayIndexMap = new List<Integer>(5); 
...
//        #region Display Index 
        ...
        /// </summary> 
        /*internal*/ public DataGridColumn ColumnFromDisplayIndex(int displayIndex)
        { 
        ...
        /// </summary> 
        /*internal*/ public List<int> DisplayIndexMap
        { 
            get 
            {
                if (!DisplayIndexMapInitialized) 
        ...
        /// </summary> 
        private boolean IsUpdatingDisplayIndex
        { 
        ...
        private int CoerceDefaultDisplayIndex(DataGridColumn column, int newDisplayIndex)
        {
            ...
            { 
                boolean isUpdating = IsUpdatingDisplayIndex;
                try 
                { 
        ...
        /*internal*/ public void InitializeDisplayIndexMap() 
        {
            int resultIndex = -1;
        ...
        { 
            ...
            for (int columnIndex = 0; columnIndex < columnCount; columnIndex++) 
            {
                DataGridColumn currentColumn = this[columnIndex];
                int currentColumnDisplayIndex = currentColumn.DisplayIndex;
                boolean hasDefaultDisplayIndex = DataGridHelper.IsDefaultValue(currentColumn, DataGridColumn.DisplayIndexProperty); 
                if (currentColumn == changingColumn)
                { 
        ...
        /// </summary> 
        private boolean IsDisplayIndexValid(DataGridColumn column, int displayIndex, boolean isAdding)
        { 
        ...
        ///     Throws an ArgumentOutOfRangeException if the given displayIndex is invalid for the given column. 
        /// </summary>
        /*internal*/ public void ValidateDisplayIndex(DataGridColumn column, int displayIndex, boolean isAdding) 
        {
        ...
        /*internal*/ public boolean DisplayIndexMapInitialized
        { 
            get
            {
        ...
        /// </summary>
        private boolean HasVisibleStarColumnsInternal(DataGridColumn ignoredColumn, out double perStarWidth) 
        { 
            boolean hasStarColumns = false;
            perStarWidth = 0.0; 
        ...
        /// </summary>
        private boolean HasVisibleStarColumnsInternal(out double perStarWidth)
        {
        ...
        /// </summary>
        private boolean HasVisibleStarColumnsInternal(DataGridColumn ignoredColumn)
        {
            double perStarWidth; 
        ...
        ///     in the datagrid.
        /// </summary>
        /*internal*/ public boolean HasVisibleStarColumns
        { 
            get
            { 
        ...
        /// </summary>
        /*internal*/ public void InvalidateHasVisibleStarColumns() 
        {
...
//        #region Column Width Computation Helper
        ...
        /// </summary> 
        /*internal*/ public void InvalidateAverageColumnWidth()
        { 
        ...
        /// </summary> 
        /*internal*/ public double AverageColumnWidth 
        {
            get 
            {
        ...
        /// </summary>
        /*internal*/ public boolean ColumnWidthsComputationPending
        { 
            get
            { 
        ...
        /// </summary> 
        /*internal*/ public void InvalidateColumnWidthsComputation()
        { 
        ...
        /// </summary> 
        /*internal*/ public void RedistributeColumnWidthsOnMinWidthChangeOfColumn(DataGridColumn changedColumn, double oldMinWidth)
        {
        ...
        /// </summary> 
        /*internal*/ public void RedistributeColumnWidthsOnMaxWidthChangeOfColumn(DataGridColumn changedColumn, double oldMaxWidth)
        { 
            if (ColumnWidthsComputationPending)
            {
                return;
        ...
        /// </summary> 
        /*internal*/ public void RedistributeColumnWidthsOnWidthChangeOfColumn(DataGridColumn changedColumn, DataGridLength oldWidth)
        { 
            if (ColumnWidthsComputationPending) 
            {
                return; 
            ...
            DataGridLength width = changedColumn.Width;
            boolean hasStarColumns = HasVisibleStarColumns; 
        ...
        /// </summary>
        /*internal*/ public void RedistributeColumnWidthsOnAvailableSpaceChange(double availableSpaceChange, double newTotalAvailableSpace)
        {
...
//        #region Column Resizing Helper 
        ...
        /// </summary> 
        /*internal*/ public void OnColumnResizeStarted()
        { 
        ...
        /// </summary> 
        /*internal*/ public void OnColumnResizeCompleted(boolean cancel)
        { 
        ...
        /// </summary>
        /*internal*/ public void RecomputeColumnWidthsOnColumnResize(DataGridColumn resizingColumn, double horizontalChange, boolean retainAuto) 
        {
        ...
        private static boolean CanColumnParticipateInResize(DataGridColumn column) 
        {
        ...
        private double RecomputeNonStarColumnWidthsOnColumnPositiveResize( 
            ...
            int resizingColumnIndex,
            boolean retainAuto,
            boolean onlyShrinkToDesiredWidth) 
        {
            if (DoubleUtil.GreaterThan(horizontalChange, 0.0)) 
            { 
        ...
        private double RecomputeNonStarColumnWidthsOnColumnNegativeResize( 
            ...
            int resizingColumnIndex, 
            boolean retainAuto, 
            boolean expandBeyondDesiredWidth)
        { 
            if (DoubleUtil.GreaterThan(horizontalChange, 0.0))
            {
        ...
        /// </summary>
        private static void SetResizedColumnWidth(DataGridColumn column, double widthDelta, boolean retainAuto) 
        { 
            DataGridLength width = column.Width;
...
//        #region Width Give Away Methods
        ...
        /// <param name="ignoredColumn">The column which is giving away the width</param> 
        /// <param name="giveAwayWidth">The amount of giveaway width</param>
        private double GiveAwayWidthToColumns(DataGridColumn ignoredColumn, double giveAwayWidth, boolean recomputeStars)
        {
            ...
            { 
                ...
                boolean giveAwayWidthIncluded = false;
                foreach (DataGridColumn column in this) 
                {
                    DataGridLength width = column.Width; 
        ...
        /// </summary> 
        private double GiveAwayWidthToScrollViewerExcess(double giveAwayWidth, boolean includedInColumnsWidth) 
        {
...
//        #region Width Take Away Methods
        ...
        /// </summary> 
        private double TakeAwayUnusedSpaceOnColumnPositiveResize(double horizontalChange, int resizingColumnIndex, boolean retainAuto)
        { 
        ...
        /// </summary> 
        private double TakeAwayWidthFromUnusedSpace(boolean spaceAlreadyUtilized, double takeAwayWidth, double totalAvailableWidth)
        { 
            double usedSpace = 0.0; 
            foreach (DataGridColumn column in this)
            { 
        ...
        ///     Helper method which tries to take away width from unused space 
        /// </summary>
        private double TakeAwayWidthFromUnusedSpace(boolean spaceAlreadyUtilized, double takeAwayWidth) 
        { 
            double totalAvailableWidth = DataGridOwner.GetViewportWidthForColumns();
        ...
        /// </summary>
        private double TakeAwayWidthFromColumns(DataGridColumn ignoredColumn, double takeAwayWidth, boolean widthAlreadyUtilized)
        { 
            double totalAvailableWidth = DataGridOwner.GetViewportWidthForColumns();
        ...
        ///     except the ignored column
        /// </summary>
        private double TakeAwayWidthFromColumns(DataGridColumn ignoredColumn, double takeAwayWidth, boolean widthAlreadyUtilized, double totalAvailableWidth) 
        {
...
//        #region Column Virtualization
        ...
        /// </summary> 
        /*internal*/ public boolean RebuildRealizedColumnsBlockListForNonVirtualizedRows
        { 
            get; set; 
        }
        ...
        /// </summary>
        /*internal*/ public List<RealizedColumnsBlock> RealizedColumnsBlockListForNonVirtualizedRows 
        {
            get 
            { 
        ...
        /// </summary>
        /*internal*/ public List<RealizedColumnsBlock> RealizedColumnsDisplayIndexBlockListForNonVirtualizedRows
        { 
            get; set;
        } 
        ...
        /// </summary>
        /*internal*/ public boolean RebuildRealizedColumnsBlockListForVirtualizedRows
        { 
            get; set;
        } 
        ...
        /// </summary>
        /*internal*/ public List<RealizedColumnsBlock> RealizedColumnsBlockListForVirtualizedRows
        {
            get 
            {
        ...
        /// </summary> 
        /*internal*/ public List<RealizedColumnsBlock> RealizedColumnsDisplayIndexBlockListForVirtualizedRows
        {
            get; set;
        } 
        ...
        /// </summary> 
        /*internal*/ public void InvalidateColumnRealization(boolean invalidateForNonVirtualizedRows)
        {
            RebuildRealizedColumnsBlockListForVirtualizedRows = true;
...
//        #region Hidden Columns
        ...
        /// </summary> 
        /*internal*/ public int FirstVisibleDisplayIndex
        { 
            get
            {
        ...
        /// </summary> 
        /*internal*/ public int LastVisibleDisplayIndex
        {
            get
            { 
        ...
        /// </summary>
        /*internal*/ public boolean RefreshAutoWidthColumns { get; set; }
...
//        #region Data 
        ...
        private boolean _isUpdatingDisplayIndex;     // true if we're in the middle of updating the display index of each column.
        private List<Integer> _displayIndexMap;            // maps a DisplayIndex to an index in the _columns collection.
        private boolean _displayIndexMapInitialized; // Flag is used to delay the validation of DisplayIndex until the first measure
        private boolean _isClearingDisplayIndex; // Flag indicating that we're currently clearing the display index.  We should not coerce default display index's during this time. 
        private boolean _columnWidthsComputationPending; // Flag indicating whether the columns width computaion operation is pending
        ...
        private boolean _hasVisibleStarColumns = false;
