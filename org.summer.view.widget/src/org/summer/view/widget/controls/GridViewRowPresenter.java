...
import org.summer.view.widget.controls.primitives.GridViewRowPresenterBase;
...
//    #region Protected Methods 
    ...
    protected /*override*/ Size MeasureOverride(Size constraint) 
    {
        ...
        boolean desiredWidthListEnsured = false; 
...
//    #region Internal Methods / Properties
    ...
    /*internal*/ public /*override*/ void OnPreApplyTemplate() 
    {
        ...
        if (NeedUpdateVisualTree) 
        {
            ...
            if (columns != null) 
            { 
                for/*each*/ (GridViewColumn column : columns.ColumnCollection)
                { 
    ...
    /// </summary> 
    /*internal*/ public /*override*/ void OnColumnPropertyChanged(GridViewColumn column, String propertyName) 
    {
    ...
    /// </summary>
    /*internal*/ public /*override*/ void OnColumnCollectionChanged(GridViewColumnCollectionChangedEventArgs e) 
    { 
        super.OnColumnCollectionChanged(e);
    ...
    /*internal*/ public List<UIElement> ActualCells
    {
        get 
        {
...
//    #region Private Methods
    ...
    private boolean CheckVisibleOnCurrentPage() 
    {
        if (!_viewPortValid)
        {
            FindViewPort(); 
    ...
    private boolean CheckContains(Rect container, Rect element) 
    {
        ...
        /*const*/static final double tolerance = 2.0; 
    ...
    private boolean CheckIsPointBetween(Rect rect, double pointY) 
    {
    ...
    {
        boolean desiredWidthChanged = false; // whether the shared minimum width has been changed since last layout 
...
//    #region Private Properties / Fields 
    ...
    private boolean _viewPortValid = false; 
    private boolean _isOnCurrentPage = false;
    private boolean _isOnCurrentPageValid = false;

    private static final Thickness _defalutCellMargin = new Thickness(6, 0, 6, 0); 
