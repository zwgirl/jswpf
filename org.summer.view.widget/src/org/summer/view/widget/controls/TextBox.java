...
public class TextBox extends TextBoxBase implements IAddChild, ITextBoxViewHost
{
    //----------------------------------------------------- 
    //
    //  Constructors 
...
//    #region Public Methods
    ...
    public int GetCharacterIndexFromPoint(Point point, boolean snapToText)
    { 
...
//    #region Public Properties 
    ...
    public static final DependencyProperty TextWrappingProperty =
            TextBlock.TextWrappingProperty.AddOwner( 
                    ...
                    new FrameworkPropertyMetadata( 
                            ...
                            new PropertyChangedCallback(null, OnTextWrappingChanged))); 
    ...
    /// Default value: 1
    /// </summary>
    public static final DependencyProperty MinLinesProperty = 
    ...
    /// </summary>
    public static final DependencyProperty MaxLinesProperty =
            DependencyProperty.Register(
...
//    [Localizability(LocalizationCategory.Text)]
    ...
    /// </summary> 
    public static final DependencyProperty CharacterCasingProperty =
            DependencyProperty.Register( 
    ...
    /// </remarks>
    public static final DependencyProperty MaxLengthProperty = 
            DependencyProperty.Register(
...
//    [Localizability(LocalizationCategory.None, Modifiability = Modifiability.Unmodifiable)] // cannot be modified by localizer
    ...
    /// </summary>
    public static final DependencyProperty TextAlignmentProperty = Block.TextAlignmentProperty.AddOwner(typeof(TextBox)); 
...
//    #region Protected Methods
    ...
    { 
        ...
        { 
            ...
            {
                peer.RaiseIsReadOnlyPropertyChangedEvent((boolean)e.OldValue, (boolean)e.NewValue); 
            } 
        }
    } 
    ...
    protected /*override*/ Size MeasureOverride(Size constraint) 
    {
        ...
        Size size = super.MeasureOverride(constraint);
    ...
    /*internal*/ public void OnTextWrappingChanged()
    { 
        CoerceValue(HorizontalScrollBarVisibilityProperty); 
    }

    // Allocates the initial render scope for this control.
    /*internal*/ public /*override*/ FrameworkElement CreateRenderScope()
    {
...
//    #region Internal Methods 
    ...
    /// </summary>
    /*internal*/ public /*override*/ void AttachToVisualTree()
    {
    	super.AttachToVisualTree(); 
    ...
    /// </summary>
    /*internal*/ public /*override*/ void DoLineUp() 
    {
        if (this.ScrollViewer != null) 
        { 
    ...
    /// </summary>
    /*internal*/ public /*override*/ void DoLineDown() 
    { 
        if (this.ScrollViewer != null)
        { 
            ScrollViewer.ScrollToVerticalOffset(VerticalOffset + GetLineHeight());
    ...
    /// </summary> 
    /*internal*/ public /*override*/ void OnTextContainerChanged(Object sender, TextContainerChangedEventArgs e)
    { 
        ...
        { 
        	...
        	super.OnTextContainerChanged(sender, e); 
        } 
    }

    // if the DeferredTextReference is resolved to a String during the previous
    // method, track that here
    /*internal*/ public void OnDeferredTextReferenceResolved(DeferredTextReference dtr, String s)
    { 
    ...
    /// </summary> 
    /*internal*/ public /*override*/ void OnScrollChanged(Object sender, ScrollChangedEventArgs e)
    { 
        super.OnScrollChanged(sender, e); 
...
//    #region Internal Properties 
    ...
    /// </summary>
    /*internal*/ public TextSelection Selection
    {
        get 
        {
    ...
    /// <summary>
    /// TextPointer where the TextBox's text begins (final)
    /// </summary>
    /*internal*/ public TextPointer StartPosition 
    {
        get 
        { 
    ...
    /// <summary>
    /// TextPointer where the TextBox's text ends (final) 
    /// </summary>
    /*internal*/ public TextPointer EndPosition 
    { 
        get
        { 
    ...
    boolean ITextBoxViewHost.IsTypographyDefaultValue
    { 
        get
        {
...
//    #region Private Methods 
    ...
    private boolean GetRectangleFromTextPositionInternal(TextPointer position, boolean relativeToTextBox, out Rect rect) 
    {
        if (this.RenderScope == null)
        {
            rect = Rect.Empty; 
    ...
    /// </summary> 
    private static boolean MaxLengthValidateValue(Object value)
    {
        return ((int)value) >= 0;
    } 
    ...
    /// <see cref="DependencyProperty.ValidateValueCallback"/> 
    /// </summary>
    private static boolean CharacterCasingValidateValue(Object value) 
    {
    ...
    /// <see cref="DependencyProperty.ValidateValueCallback"/> 
    /// </summary> 
    private static boolean MinLinesValidateValue(Object value)
    { 
        return ((int)value > 0);
    }
    ...
    /// <see cref="DependencyProperty.ValidateValueCallback"/>
    /// </summary> 
    private static boolean MaxLinesValidateValue(Object value) 
    {
        return ((int)value > 0); 
    }
    ...
    { 
        boolean inReentrantChange = false;
        int savedCaretIndex = 0;
        boolean resetCaret = false;
        ...
        boolean hasExpression = HasExpression(LookupEntry(TextBox.TextProperty.GlobalIndex), TextBox.TextProperty);
    ...
    public boolean ShouldSerializeText(XamlDesignerSerializationManager manager)
    { 
...
//    #region Private Fields 
    ...
    private boolean _isTypographySet;
