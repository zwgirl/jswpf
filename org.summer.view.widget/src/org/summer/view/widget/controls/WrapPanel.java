...
//        #region Public Properties 
        ...
        /// </summary>
        public static final DependencyProperty ItemWidthProperty = 
...
//        [TypeConverter(typeof(LengthConverter))] 
        ...
        /// </summary>
        public static final DependencyProperty ItemHeightProperty =
                DependencyProperty.Register(
                        "ItemHeight", 
                        typeof(double),
                        typeof(WrapPanel), 
...
//        #region Protected Methods
        ...
        protected /*override*/ Size MeasureOverride(Size constraint)
        {
            ...
            boolean itemWidthSet = !DoubleUtil.IsNaN(itemWidth);
            boolean itemHeightSet = !DoubleUtil.IsNaN(itemHeight); 
        ...
        { 
            ...
            boolean itemWidthSet = !DoubleUtil.IsNaN(itemWidth);
            boolean itemHeightSet = !DoubleUtil.IsNaN(itemHeight); 
            boolean useItemU = (Orientation == Orientation.Horizontal ? itemWidthSet : itemHeightSet);
        ...
        private void arrangeLine(double v, double lineV, int start, int end, boolean useItemU, double itemU)
        { 
            double u = 0;
