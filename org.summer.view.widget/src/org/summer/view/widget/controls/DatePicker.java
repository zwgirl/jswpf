...
//        #region Constants 
        ...
        private final String ElementTextBox = "PART_TextBox"; 
        private final String ElementButton = "PART_Button";
        private final String ElementPopup = "PART_Popup"; 
...
//        #region Data 
        ...
        private boolean _disablePopupReopen;
        private DatePickerTextBox _textBox;
        private IDictionary<DependencyProperty, Boolean> _isHandlerSuspended;
...
//        #region Public Events
        ...
        public static final RoutedEvent SelectedDateChangedEvent = EventManager.RegisterRoutedEvent("SelectedDateChanged", RoutingStrategy.Direct, typeof(EventHandler<SelectionChangedEventArgs>), typeof(DatePicker));
...
//        #region CalendarStyle
        ...
        /// </summary> 
        public static final DependencyProperty CalendarStyleProperty =
...
//        #region SelectedDateFormat 
        ...
        /// </summary>
        public static final DependencyProperty SelectedDateFormatProperty = 
            DependencyProperty.Register(
            "SelectedDateFormat",
...
//        #region Protected Methods 
        ...
        protected /*internal*/ /*override*/ boolean HasEffectiveKeyboardFocus 
        {
            get 
            { 
                if (_textBox != null)
...
//        #region Private Methods 
        ...
        private boolean IsHandlerSuspended(DependencyProperty property)
        {
            return _isHandlerSuspended != null && _isHandlerSuspended.ContainsKey(property);
        } 

        private void SetIsHandlerSuspended(DependencyProperty property, boolean value) 
        { 
            if (value)
            { 
                if (_isHandlerSuspended == null)
                {
                    _isHandlerSuspended = new Dictionary<DependencyProperty, boolean>(2);
                } 
        ...
        private static boolean IsValidSelectedDateFormat(Object value) 
        {
        ...
        private boolean ProcessDatePickerKey(KeyEventArgs e) 
        {
            switch (e.Key) 
            {
                case Key.System:
