...
import org.summer.view.widget.input.InputReportEventArgs;
...
import org.summer.view.widget.input.ProcessInputEventArgs;
import org.summer.view.widget.input.RawMouseInputReport;
...
/// </summary>
/*internal*/ public /*sealed*/ class PopupControlService
{ 
//    #region Creation
...
//    [SecurityCritical,SecurityTreatAsSafe]
    /*internal*/ public PopupControlService()
    { 
...
//    [SecurityCritical]
    ...
    private void OnMouseMove(IInputElement directlyOver, Point pt) 
    {
        if (directlyOver != LastMouseDirectlyOver)
        {
            ...
            { 
                InspectElementForToolTip(directlyOver instanceof DependencyObject ? directlyOver :null); 
            }
        } 
    }
    /////////////////////////////////////////////////////////////////////
...
//    #region ToolTip 
    ...
    private void InspectElementForToolTip(DependencyObject o)
    {
        ...
        { 
            ...
            if (o != null) 
            {
                ...
                boolean quickShow = _quickShow; // ResetToolTipTimer may reset _quickShow 
                ResetToolTipTimer();
    ...
    private boolean LocateNearestToolTip(/*ref*/ DependencyObject o) 
    { 
    ...
    /*internal*/ public boolean StopLookingForToolTip(DependencyObject o)
    { 
    ...
    private boolean WithinCurrentToolTip(DependencyObject o) 
    {
        ...
        return (v != null) &&
               ((v instanceof Visual && ((Visual)v).IsDescendantOf(_currentToolTip)) ||
                (v instanceof Visual3D && ((Visual3D)v).IsDescendantOf(_currentToolTip))); 
    }
    ...
    /*internal*/ public void OnRaiseToolTipOpeningEvent(Object sender, EventArgs e)
    { 
        RaiseToolTipOpeningEvent();
    }
        ...
        { 
            ...
            if (show) 
            {
                ...
                else if ((_currentToolTip == null) || !_ownToolTip) 
                {
                    ...
                    _ownToolTip = true;
                    _currentToolTip.SetValue(ServiceOwnedProperty, true); 
    ...
    /*internal*/ public void OnRaiseToolTipClosingEvent(Object sender, EventArgs e) 
    { 
        RaiseToolTipClosingEvent(false /* reset */);
    } 
    ...
    /// </param>
    private void RaiseToolTipClosingEvent(boolean reset)
    {
        ResetToolTipTimer(); 
        ...
        { 
            if (_currentToolTip != null)
            { 
                boolean isOpen = _currentToolTip.IsOpen; 
    ...
    { 
        ...
        if ((boolean)toolTip.GetValue(ServiceOwnedProperty))
        { 
...
//    #region ContextMenu 
    ...
    /// </summary>
    /*internal*/ public static final RoutedEvent ContextMenuOpenedEvent =
    ...
    ///     Located here to avoid circular dependencies.
    /// </summary> 
    /*internal*/ public static final RoutedEvent ContextMenuClosedEvent =
...
//    [SecurityCritical]
    ...
    ///</SecurityNote>
//    [SecurityCritical] 
    private boolean RaiseContextMenuOpeningEvent(IInputElement source, double x, double y,boolean userInitiated) 
    {
        // Fire the event 
    ...
    /// </SecurityNote>
//    [SecurityCritical, SecurityTreatAsSafe]
    private static boolean IsPresentationSourceNull(DependencyObject uie)
    { 
...
//    #region Helpers
    ...
    /*internal*/ public static DependencyObject FindParent(DependencyObject o)
    { 
    ...
    /*internal*/ public static DependencyObject FindContentElementParent(ContentElement ce)
    {
    ...
    /*internal*/ public static boolean IsElementEnabled(DependencyObject o)
    { 
    ...
    /*internal*/ public static PopupControlService Current 
    {
        get 
        { 
    ...
    /*internal*/ public ToolTip CurrentToolTip
    { 
        get
        { 
    ...
    /// </summary> 
    /*internal*/ public static final DependencyProperty ServiceOwnedProperty =
    ...
    /// </summary> 
    /*internal*/ public static final DependencyProperty OwnerProperty =
    ...
    /*internal*/ public static Object CoerceProperty(DependencyObject o, Object value, DependencyProperty dp)
    {
...
//    #region Data
    ...
    private boolean _quickShow = false;
