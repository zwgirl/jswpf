...
//    [StyleTypedProperty(Property = "ItemContainerStyle", StyleTargetType = typeof(TreeViewItem))]
    public class TreeViewItem extends HeaderedItemsControl implements IHierarchicalVirtualizationAndScrollInfo
    {
//        #region Constructors 
...
//        #region Public Properties 
        ...
        private static void OnIsExpandedChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) 
        {
            ...
            boolean isExpanded = (boolean) e.NewValue;
            ...
            if (peer != null) 
            {
                peer.RaiseExpandCollapseAutomationEvent((boolean)e.OldValue, isExpanded);
            }
        ...
        /// </summary> 
        public static final DependencyProperty IsSelectionActiveProperty = Selector.IsSelectionActiveProperty.AddOwner(typeof(TreeViewItem));
...
//        [Browsable(false), Category("Appearance"), ReadOnly(true)]
        public boolean IsSelectionActive 
        {
            get 
            { 
                return (boolean)GetValue(IsSelectionActiveProperty);
            } 
        }
...
//        #region Public Events
        ...
        /// </summary> 
        public static final RoutedEvent ExpandedEvent = EventManager.RegisterRoutedEvent("Expanded", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(TreeViewItem));
...
//        [Category("Behavior")] 
        ...
        /// </summary>
        public static final RoutedEvent CollapsedEvent = EventManager.RegisterRoutedEvent("Collapsed", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(TreeViewItem)); 
...
//        [Category("Behavior")]
        ...
        /// </summary>
        public static final RoutedEvent SelectedEvent = EventManager.RegisterRoutedEvent("Selected", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(TreeViewItem));
...
//        [Category("Behavior")] 
        ...
        /// </summary> 
        public static final RoutedEvent UnselectedEvent = EventManager.RegisterRoutedEvent("Unselected", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(TreeViewItem)); 
...
//        #region Tree 
        ...
        /// </summary> 
        /*internal*/ public TreeView ParentTreeView
        { 
            get 
            {
        ...
        /// </summary> 
        /*internal*/ public TreeViewItem ParentTreeViewItem
        {
            get
            { 
        ...
        /// </summary>
        /*internal*/ public ItemsControl ParentItemsControl
        { 
            get
            { 
...
//        #region Selection 
        ...
        protected /*internal*/ public /*override*/ void OnVisualParentChanged(DependencyObject oldParent)
        {
        ...
        /*internal*/ public void UpdateContainsSelection(boolean selected) 
        {
...
//        #region Input 
        ...
        private boolean LogicalLeft(Key key) 
        {
        ...
        private boolean CanExpandOnInput
        { 
            get
            { 
        ...
        /*internal*/ public boolean HandleUpKey(KeyEventArgs e)
        {
            return HandleUpDownKey(true, e); 
        }
 
        /*internal*/ public boolean HandleDownKey(KeyEventArgs e) 
        {
            return HandleUpDownKey(false, e); 
        }

        private boolean HandleUpDownKey(boolean up, KeyEventArgs e)
        { 
        ...
        private boolean AllowHandleKeyEvent(FocusNavigationDirection direction) 
        { 
            if (!IsSelected)
            { 
                return false;
        ...
        /*internal*/ public FrameworkElement HeaderElement
        {
            get
            { 
        ...
        /*internal*/ public FrameworkElement TryGetHeaderElement()
        {
...
//        #region Containers
        ...
        /*internal*/ public static void IsVirtualizingPropagationHelper(DependencyObject parent, DependencyObject element)
        { 
        ...
        /*internal*/ public static void SynchronizeValue(DependencyProperty dp, DependencyObject parent, DependencyObject child) 
        {
...
//        #region Data 
        ...
        private /*const*/ static final String HeaderPartName = "PART_Header";
        private /*const*/ static final  String ItemsHostPartName = "ItemsHost";
