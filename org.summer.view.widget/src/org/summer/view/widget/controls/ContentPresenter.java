...
//    [CommonDependencyProperty] 
    public static final DependencyProperty RecognizesAccessKeyProperty =
    ...
    /// </summary>
    public boolean RecognizesAccessKey 
    {
        get { return (boolean) GetValue(RecognizesAccessKeyProperty); }
    ...
    private static void OnContentChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) 
    {
        ...
        else 
        {
            ...
            { 
                ...
                boolean oldHasAccessKey = (oldString.IndexOf(AccessText.AccessKeyMarker) > -1);
                boolean newHasAccessKey = (newString.IndexOf(AccessText.AccessKeyMarker) > -1); 
...
//    [EditorBrowsable(EditorBrowsableState.Never)] 
    public boolean ShouldSerializeContentTemplateSelector() 
    {
        return false; 
    }
...
//    [Bindable(true), CustomCategory("Content")]
    ...
    /// </summary>
//    [CommonDependencyProperty] 
    public static final DependencyProperty ContentSourceProperty =
            DependencyProperty.Register(
                    "ContentSource",
                    typeof(String), 
                    typeof(ContentPresenter),
    ...
    /// </summary> 
    /*internal*/ /*override*/ public void OnPreApplyTemplate()
    { 
    ...
    /*internal*/ /*override*/ public FrameworkTemplate TemplateInternal 
    {
        get { return Template; } 
    } 
    ...
    /*internal*/ boolean TemplateIsCurrent 
    {
    ...
    /// </summary>
    /*internal*/public void PrepareContentPresenter(Object item,
    ...
    /*internal*/ public static Object DataTypeForItem(Object item, DependencyObject target, /*out*/ Type type)
    { 
        if (item == null)
        { 
            type = null; 
    ...
    /// TemplateProperty
    /// </summary> 
    /*internal*/ public static final DependencyProperty TemplateProperty =
            DependencyProperty.Register(
                    "Template",
                    typeof(DataTemplate), 
                    typeof(ContentPresenter),
    ...
    boolean IsUsingDefaultStringTemplate
    {
        get
        { 
    ...
    /*internal*/public static FrameworkElementFactory CreateAccessTextFactory()
    { 
    ...
    /*internal*/public static FrameworkElementFactory CreateTextBlockFactory() 
    {
    ...
    public static TextBlock CreateTextBlock(ContentPresenter container) 
    { 
    ...
    private class UseContentTemplate extends DataTemplate
    {
        ...
        /*internal*/ /*override*/ public boolean BuildVisualTree(FrameworkElement container)
        { 
...
//                Debug.Assert(tc.CanConvertTo(typeof(UIElement)));
    ...
    private class DefaultTemplate extends DataTemplate 
    { 
        ...
        /*internal*/ /*override*/public boolean BuildVisualTree(FrameworkElement container)
        {
//            boolean tracingEnabled = EventTrace.IsEnabled(EventTrace.Keyword.KeywordGeneral, EventTrace.Level.Info);
//            if (tracingEnabled) 
//            {
...
//            Debug.Assert(!(content is String) && !(content is UIElement));  // these are handled by different templates
            ...
            else
            {
                ...
                if (!succeeded) 
                {
                    ...
                    {
                        textBlock.Text = (String)tc.ConvertTo(null, culture, content, typeof(String)); 
                    }
                    else
                    {
//                        Debug.Assert(!(tc != null && tc.CanConvertTo(typeof(UIElement))));  // this is handled by a different template 
    ...
    private class DefaultSelector extends DataTemplateSelector 
    {
        /// <summary> 
    ...
    private boolean _templateIsCurrent;
    private boolean _contentIsItem;
    ...
    private static final UncommonField<DataTemplate> XMLFormattingTemplateField = new UncommonField<DataTemplate>();
    private static final UncommonField<DataTemplate> StringFormattingTemplateField = new UncommonField<DataTemplate>(); 
    private static final UncommonField<DataTemplate> AccessTextFormattingTemplateField = new UncommonField<DataTemplate>();
} 