...
{ 
	...
	///     Default Value:      false 
	/// </summary>
	public static final DependencyProperty IsDefaultProperty 
	    = DependencyProperty.Register("IsDefault", typeof(Boolean), typeof(Button), 
	...
	///     Default Value:      false
	/// </summary>
	public static final DependencyProperty IsCancelProperty =
	...
	/// </summary>
	private static final DependencyPropertyKey IsDefaultedPropertyKey 
	    = DependencyProperty.RegisterReadOnly("IsDefaulted", typeof(Boolean), typeof(Button), 
	                                  new FrameworkPropertyMetadata(BooleanBoxes.FalseBox));
	...
	///     Default Value:      false 
	/// </summary>
	public static final DependencyProperty IsDefaultedProperty 
	...
	public boolean IsDefaulted 
	{
	    get 
	    { 
	        return (boolean)GetValue(IsDefaultedProperty);
	    } 
	}
	...
	{ 
	    ...
	    { 
	        ...
	        if (thisScope == focusScope && (focusDO == null || (boolean)focusDO.GetValue(KeyboardNavigation.AcceptsReturnProperty) == false)) 
	        {
	...
	protected /*override*/ void OnClick() 
	{
	    ...
	    finally 
	    {
	        ...
	        { 
	            ...
	            CommandHelpers.ExecuteCommand(DialogCancelCommand, null, this); 
	        }
	    } 
	}
	...
	private static final UncommonField<KeyboardFocusChangedEventHandler> FocusChangedEventHandlerField = new UncommonField<KeyboardFocusChangedEventHandler>(); 
