...
import org.summer.view.widget.controls.primitives.CalendarItem;
...
//        #region Constants
        ...
        private final String ElementRoot = "PART_Root"; 
        private final String ElementMonth = "PART_CalendarItem";
 
        private final int COLS = 7;
        private final int ROWS = 7;
        private final int YEAR_ROWS = 3;
        private final int YEAR_COLS = 4; 
...
//        #region Public Events
        ...
        public static final RoutedEvent SelectedDatesChangedEvent = EventManager.RegisterRoutedEvent("SelectedDatesChanged", RoutingStrategy.Direct, typeof(EventHandler<SelectionChangedEventArgs>), typeof(Calendar)); 
...
//        #region CalendarButtonStyle 
        ...
        /// </summary>
        public static final DependencyProperty CalendarButtonStyleProperty =
...
//        #region CalendarDayButtonStyle
        ...
        /// </summary>
        public static final DependencyProperty CalendarDayButtonStyleProperty = 
            DependencyProperty.Register( 
...
//        #region CalendarItemStyle
        ...
        /// </summary> 
        public static final DependencyProperty CalendarItemStyleProperty =
            DependencyProperty.Register(
            "CalendarItemStyle",
            typeof(Style), 
            typeof(Calendar));
...
//        #region DisplayDate 
        ...
        /// </summary>
        public static final DependencyProperty DisplayDateProperty = 
            DependencyProperty.Register( 
            "DisplayDate",
            typeof(DateTime), 
            typeof(Calendar),
...
//        #region DisplayDateEnd
        ...
        /// </summary> 
        public static final DependencyProperty DisplayDateEndProperty =
            DependencyProperty.Register( 
            "DisplayDateEnd",
            typeof(DateTime?),
            typeof(Calendar),
...
//        #region DisplayDateStart 
        ...
        /// </summary>
        public static final DependencyProperty DisplayDateStartProperty = 
            DependencyProperty.Register( 
            "DisplayDateStart",
            typeof(DateTime?), 
            typeof(Calendar),
...
//        #region DisplayMode
        ...
        /// </summary> 
        public static final DependencyProperty DisplayModeProperty =
            DependencyProperty.Register( 
            "DisplayMode",
            typeof(CalendarMode),
            typeof(Calendar),
...
//        #region FirstDayOfWeek
        ...
        /// </summary>
        public static final DependencyProperty FirstDayOfWeekProperty = 
            DependencyProperty.Register( 
            "FirstDayOfWeek",
            typeof(DayOfWeek), 
            typeof(Calendar),
...
//        #region IsTodayHighlighted
        ...
        /// </summary>
        public static final DependencyProperty IsTodayHighlightedProperty = 
            DependencyProperty.Register( 
            "IsTodayHighlighted",
            typeof(boolean), 
            typeof(Calendar),
...
//        #region SelectedDate
        ...
        /// </summary> 
        public static final DependencyProperty SelectedDateProperty =
            DependencyProperty.Register( 
            "SelectedDate", 
            typeof(DateTime?),
            typeof(Calendar), 
...
//        #region Internal Events 
        ...
        /*internal*/ public event MouseButtonEventHandler DayButtonMouseUp;

        /*internal*/ public event RoutedEventHandler DayOrMonthPreviewKeyDown; 
...
//        #region Internal Properties
        ...
        /// </summary> 
        /*internal*/ public boolean DatePickerDisplayDateFlag
        { 
            get; 
            set;
        } 

        /*internal*/ public DateTime DisplayDateInternal
        {
            get; 
            private set;
        } 
 
        /*internal*/ public DateTime DisplayDateEndInternal
        { 
            get
            {
        ...
        /*internal*/ public DateTime DisplayDateStartInternal 
        {
            get 
            {
        ...
        /*internal*/ public DateTime CurrentDate 
        { 
            get { return _currentDate.GetValueOrDefault(this.DisplayDateInternal); }
            set { _currentDate = value; } 
        }

        /*internal*/ public DateTime? HoverStart
        { 
            get
            { 
        ...
        /*internal*/ public DateTime? HoverEnd 
        {
            get 
            {
        ...
        /*internal*/ public CalendarItem MonthControl
        {
            get { return _monthControl; } 
        }
 
        /*internal*/ public DateTime DisplayMonth 
        {
            get 
            {
        ...
        /*internal*/ public DateTime DisplayYear 
        { 
            get
            { 
...
//        #region Public Methods
        ...
        /// <summary> 
        /// Invoked whenever application code or an /*internal*/ public process,
...
//        #region Internal Methods 
        ...
        /*internal*/ public CalendarDayButton FindDayButtonFromDay(DateTime day) 
        { 
        ...
        /*internal*/ public static boolean IsValidDateSelection(Calendar cal, object value) 
        {
            return (value == null) || (!cal.BlackoutDates.Contains((DateTime)value)); 
        }

        /*internal*/ public void OnDayButtonMouseUp(MouseButtonEventArgs e)
        { 
        ...
        /*internal*/ public void OnDayOrMonthPreviewKeyDown(RoutedEventArgs e)
        { 
        ...
        /*internal*/ public void OnDayClick(DateTime selectedDate) 
        {
        ...
        /*internal*/ public void OnCalendarButtonPressed(CalendarButton b, boolean switchDisplayMode) 
        {
            if (b.DataContext is DateTime) 
            { 
        ...
        /*internal*/ public void OnNextClick() 
        {
        ...
        /*internal*/ public void OnPreviousClick() 
        {
            DateTime? nextDate = GetDateOffset(this.DisplayDate, -1, this.DisplayMode);
            if (nextDate.HasValue)
            { 
        ...
        /*internal*/ public void OnSelectedDatesCollectionChanged(SelectionChangedEventArgs e) 
        {
        ...
        /*internal*/ public void UpdateCellItems()
        {
...
//        #region Private Methods 
        ...
        private static boolean IsSelectionChanged(SelectionChangedEventArgs e)
        { 
        ...
        private static boolean IsValidDisplayMode(object value)
        { 
        ...
        /*internal*/ public static boolean IsValidFirstDayOfWeek(object value)
        { 
        ...
        private static boolean IsValidKeyboardSelection(Calendar cal, object value) 
        {
            if (value == null) 
            {
                return true;
        ...
        private static boolean IsValidSelectionMode(object value)
        { 
        ...
        /*internal*/ public void FocusDate(DateTime date)
        { 
            if (MonthControl != null)
            {
        ...
        private boolean ProcessCalendarKey(KeyEventArgs e) 
        { 
        ...
        private void ProcessDownKey(boolean ctrl, boolean shift)
        {
            switch (this.DisplayMode) 
            {
                case CalendarMode.Month: 
        ...
        private void ProcessEndKey(boolean shift) 
        { 
            switch (this.DisplayMode)
            { 
                case CalendarMode.Month:
        ...
        private void ProcessHomeKey(boolean shift)
        { 
            switch (this.DisplayMode)
            {
                case CalendarMode.Month:
        ...
        private void ProcessLeftKey(boolean shift) 
        {
        ...
        private void ProcessPageDownKey(boolean shift)
        {
            switch (this.DisplayMode)
            { 
                case CalendarMode.Month:
        ...
        private void ProcessPageUpKey(boolean shift)
        {
            switch (this.DisplayMode)
            { 
                case CalendarMode.Month:
        ...
        private void ProcessRightKey(boolean shift)
        {
            int moveAmmount = (!this.IsRightToLeft) ? 1 : -1;
            switch (this.DisplayMode) 
            {
        ...
        private void ProcessSelection(boolean shift, DateTime? lastSelectedDate)
        {
        ...
        private void ProcessUpKey(boolean ctrl, boolean shift) 
        {
            switch (this.DisplayMode)
            {
                case CalendarMode.Month: 
