...
import org.summer.view.widget.controls.StackPanel.ScrollData;
...
/*internal*/ public class TextBoxView extends FrameworkElement implements ITextView, IScrollInfo, IServiceProvider 
{
    //----------------------------------------------------- 
    //
    //  Constructors
...
//    #region Constructors 
    ...
    // Constructor. 
    /*internal*/ public TextBoxView(ITextBoxViewHost host) 
    {
//        Invariant.Assert(host instanceof Control); 
        _host = host;
    }
...
//    #region Protected Methods
    ...
    { 
        ...
        boolean widthChanged = !DoubleUtil.AreClose(constraint.Width, _previousConstraint.Width); 
        ...
        boolean constraintschanged = widthChanged && 
...
//    #region Internal Methods
    ...
    /// </summary> 
    ITextPointer ITextView.GetTextPositionFromPoint(Point point, boolean snapToText)
    { 
//        Invariant.Assert(this.IsLayoutValid);
    ...
    Geometry ITextView.GetTightBoundingGeometryFromTextPositions(ITextPointer startPosition, ITextPointer endPosition) 
    {
        ...
        boolean firstLinePartiallyCovered = _lineMetrics[firstLineIndex].Offset < startOffset || 
                                         _lineMetrics[firstLineIndex].EndOffset > endOffset;
        boolean lastLinePartiallyCovered =  _lineMetrics[lastLineIndex].Offset < startOffset || 
    ...
    /// </summary> 
    boolean ITextView.IsAtCaretUnitBoundary(ITextPointer position) 
    {
        Invariant.Assert(this.IsLayoutValid); 
        Invariant.Assert(Contains(position));
...
//        Invariant.Assert(false);
    ...
    /// </summary> 
    boolean ITextView.Contains(ITextPointer position)
    { 
...
//        Invariant.Assert(false);
    ...
    /// </summary> 
    boolean ITextView.Validate(Point point)
    { 
    ...
    /// </summary> 
    boolean ITextView.Validate(ITextPointer position) 
    {
    ...
    // change value.
    /*internal*/ public void Remeasure() 
    {
        if (_lineMetrics != null) 
        { 
            _lineMetrics.Clear();
    ...
    /*internal*/ public int GetLineIndexFromOffset(int offset)
    { 
        int index = -1;
        int min = 0;
...
//    #region Internal Properties
    ...
    /*internal*/ public ITextBoxViewHost Host
    {
        get 
        {
            return _host; 
    ...
    /// <see cref="ITextView.IsValid"/>
    /// </summary> 
    boolean ITextView.RendersOwnSelection
    {
        get
        { 
            return false;
...
//    #region Private Methods
    ...
    private void OnHighlightChanged(Object sender, HighlightChangedEventArgs args)
    {
        ...
        for/*each*/ (TextSegment segment : args.Ranges) 
        {
    ...
    private int GetLineIndexFromPoint(Point point, boolean snapToText) 
    {
//        Invariant.Assert(_lineMetrics.Count >= 1);
...
//        Invariant.Assert(_dirtyList == null); // We should never see pending incremental updates during arrange.
    ...
    private void IncrementalMeasureLinesAfterInsert(double constraintWidth, LineProperties lineProperties, DirtyTextRange range, 
    ...
    private void FormatFirstIncrementalLine(int lineIndex, double constraintWidth, LineProperties lineProperties, TextBoxLine line, 
        /*out*/ int lineOffset, out boolean endOfParagraph)
    { 
    ...
    private void SyncLineMetrics(DirtyTextRange range, double constraintWidth, LineProperties lineProperties, TextBoxLine line,
        boolean endOfParagraph, int lineIndex, int lineOffset) 
    {
        boolean offsetSyncOk = (range.PositionsAdded == 0 || range.PositionsRemoved == 0); 
    ...
    /// <see cref="ITextView.Contains"/> 
    /// </summary>
    private boolean Contains(ITextPointer position)
    {
//        Invariant.Assert(this.IsLayoutValid); 
...
//    #region Private Properties 
    ...
    private boolean IsBackgroundLayoutPending
    {
        get
        { 
...
//    [System.Flags] 
    ...
    {
        /*internal*/ public TextCache(TextBoxView owner) 
        { 
        ...
        /*internal*/ public LineProperties LineProperties 
        { 
            get { return _lineProperties; }
        } 

        /*internal*/ public TextRunCache TextRunCache
        {
        ...
        private final LineProperties _lineProperties; 
        private final TextRunCache _textRunCache;
    ...
    {
        /*internal*/ public LineRecord(int offset, TextBoxLine line) 
        { 
            _offset = offset;
            _length = line.Length; 
        ...
        /*internal*/ public int Length { get { return _length; } }

        /*internal*/ public int ContentLength { get { return _contentLength; } } 

        /*internal*/ public double Width { get { return _width; } } 

        /*internal*/ public int EndOffset { get { return _offset + _length; } }
...
//    #region Private Fields 
    ...
    private final ITextBoxViewHost _host; 
    ...
    private /*const*/static final int _maxMeasureTimeMs = 200;

    // Number of seconds to disable background layout after receiving
    // user input. 
    private /*const*/static final int _throttleBackgroundSeconds = 2;
