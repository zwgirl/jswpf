...
import org.summer.view.widget.controls.primitives.GeneratorStatus;
import org.summer.view.widget.controls.primitives.MultiSelector;
...
import org.summer.view.widget.input.RoutedUICommand;
...
import org.summer.view.widget.media.GeneralTransform;
...
//    #region Columns 
    ...
    /// </summary>
    /*internal*/ public DataGridColumnCollection InternalColumns
    {
        get { return _columns; } 
    }
    ...
    /// </remarks>
    public boolean CanUserResizeColumns 
    {
        get { return (boolean)GetValue(CanUserResizeColumnsProperty); } 
    ...
    /// </summary>
    public static final DependencyProperty CanUserResizeColumnsProperty = 
        DependencyProperty.Register("CanUserResizeColumns", typeof(Boolean), typeof(DataGrid), new FrameworkPropertyMetadata(true, new PropertyChangedCallback(OnNotifyColumnAndColumnHeaderPropertyChanged)));
    ...
    /// </summary> 
    public static final DependencyProperty MinColumnWidthProperty = 
    ...
    /// </summary>
    public static final DependencyProperty MaxColumnWidthProperty = 
        DependencyProperty.Register(
            "MaxColumnWidth",
            typeof(Double),
            typeof(DataGrid), 
    ...
    /// </summary> 
    private static boolean ValidateMinColumnWidth(Object v) 
    {
    ...
    /// </summary> 
    private static boolean ValidateMaxColumnWidth(Object v) 
    {
        double value = (double)v; 
    ...
    private void OnColumnsChanged(Object sender, NotifyCollectionChangedEventArgs e) 
    {
        ...
        boolean visibleColumnsChanged = HasVisibleColumns(e.OldItems);
    ...
    /*internal*/ public void UpdateDataGridReference(IList list, boolean clear)
    {
    ...
    /// </summary> 
    private static boolean HasVisibleColumns(IList columns)
    {
        if (columns != null && columns.Count > 0)
        { 
            for/*each*/ (DataGridColumn column : columns)
            { 
                if (column.IsVisible) 
                {
                    return true; 
...
//    #region Display Index
    ...
    /// </summary>
    /*internal*/ public List<Integer> DisplayIndexMap 
    {
    ...
    /// </summary>
    /*internal*/ public void ValidateDisplayIndex(DataGridColumn column, int displayIndex)
    { 
    ...
    /// </summary>
    /*internal*/ public int ColumnIndexFromDisplayIndex(int displayIndex)
    {
    ...
    /// <returns></returns>
    /*internal*/ public DataGridColumnHeader ColumnHeaderFromDisplayIndex(int displayIndex) 
    {
...
//    #region Notification Propagation
    ...
    { 
        ...
        //
        // ItemsControl.OnItemTemplateChanged calls the /*internal*/ public ItemContainerGenerator.Refresh() method, which
    ...
    /// </remarks>
    /*internal*/ public void NotifyPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e, DataGridNotificationTarget target) 
    { 
    ...
    /*internal*/ public void NotifyPropertyChanged(DependencyObject d, String propertyName, DependencyPropertyChangedEventArgs e, DataGridNotificationTarget target)
    {
        if (DataGridHelper.ShouldNotifyDataGrid(target)) 
        {
            ...
            else if ((e.Property == DataGridColumn.VisibilityProperty) || (e.Property == DataGridColumn.WidthProperty) || (e.Property == DataGridColumn.DisplayIndexProperty))
            {
                ...
                for/*each*/ (DependencyObject container : ItemContainerGenerator.RecyclableContainers) 
                { 
    ...
    /// </summary>
    /// <param name="e"></param>
    /*internal*/ public void UpdateColumnsOnVirtualizedCellInfoCollections(NotifyCollectionChangedAction action, int oldDisplayIndex, DataGridColumn oldColumn, int newDisplayIndex)
    { 
    ...
    /// </summary> 
    /*internal*/ public DataGridColumnHeadersPresenter ColumnHeadersPresenter
    { 
...
//    #region GridLines 
    ...
    /// </summary>
    public static final DependencyProperty GridLinesVisibilityProperty =
        DependencyProperty.Register(
            "GridLinesVisibility", 
    ...
    /// </summary>
    public static final DependencyProperty HorizontalGridLinesBrushProperty =
        DependencyProperty.Register( 
    ...
    /// </summary>
    public static final DependencyProperty VerticalGridLinesBrushProperty = 
        DependencyProperty.Register(
...
//#if GridLineThickness
    ...
    /// </summary>
    public static final DependencyProperty HorizontalGridLineThicknessProperty = 
    ...
    /// </summary>
    public static final DependencyProperty VerticalGridLineThicknessProperty = 
...
//#else 
    /*internal*/ public double HorizontalGridLineThickness
    {
        get { return 1.0; }
    } 

    /*internal*/ public double VerticalGridLineThickness 
    { 
        get { return 1.0; }
    } 
//#endif
...
//    #region Row Generation
    ...
    { 
        return item instanceof DataGridRow;
    } 
    ...
    { 
        ...
        if (row.DataGridOwner == this)
        {
            row.Tracker.StopTracking( _rowTrackingRoot); 
        }
    ...
    /// </summary>
    public static final DependencyProperty RowStyleProperty = 
    ...
    /// </summary>
    public static final DependencyProperty RowValidationErrorTemplateProperty = 
    ...
    { 
        ...
        if (_defaultBindingGroup != null)
        {
            ...
            { 
                ...
                { 
                    case NotifyCollectionChangedAction.Add: 
                        for/*each*/ (ValidationRule rule : e.NewItems)
                        { 
                    ...
                    case NotifyCollectionChangedAction.Remove: 
                        for/*each*/ (ValidationRule rule : e.OldItems) 
                        {
    ...
    /// </summary> 
    public static final DependencyProperty RowStyleSelectorProperty =
    ...
    /// </summary> 
    public static final DependencyProperty RowBackgroundProperty =
    ...
    /// </summary> 
    public static final DependencyProperty AlternatingRowBackgroundProperty =
    ...
    /// </summary>
    public static final DependencyProperty RowHeightProperty = 
    ...
    /// </summary> 
    public static final DependencyProperty MinRowHeightProperty =
    ...
    /// </summary> 
    /*internal*/ public Visibility PlaceholderVisibility 
    {
        get 
        {
    ...
    /*internal*/ public static Object DelayedOnLoadingRowDetails(Object arg) 
    {
...
//    #region Row/Column Headers 
    ...
    /// </summary> 
    public static final DependencyProperty RowHeaderWidthProperty =
    ...
    public double RowHeaderActualWidth
    {
        ...
        /*internal*/ public set { SetValue(RowHeaderActualWidthPropertyKey, value); }
    } 

    /// <summary>
    ///     The DependencyPropertyKey for RowHeaderActualWidth. 
    /// </summary>
    private static final DependencyPropertyKey RowHeaderActualWidthPropertyKey =
    ...
    /// </summary> 
    public static final DependencyProperty RowHeaderActualWidthProperty = RowHeaderActualWidthPropertyKey.DependencyProperty;
    ...
    /// </summary>
    public static final DependencyProperty ColumnHeaderHeightProperty = 
    ...
    /// </summary> 
    public static final DependencyProperty HeadersVisibilityProperty =
...
//    #region Item Associated Properties
    ...
    /*internal*/ public DataGridItemAttachedStorage ItemAttachedStorage 
    {
    ...
    /// </summary>
    private boolean ShouldSelectRowHeader 
    { 
        get
        { 
...
//    #region Style Properties 
    ...
    /// </summary> 
    public static final DependencyProperty CellStyleProperty =
    ...
    /// </summary>
    public static final DependencyProperty ColumnHeaderStyleProperty =
    ...
    /// </summary> 
    public static final DependencyProperty RowHeaderStyleProperty =
    ...
    /// </summary> 
    public static final DependencyProperty RowHeaderTemplateProperty =
    ...
    /// </summary>
    public static final DependencyProperty RowHeaderTemplateSelectorProperty =
    ...
    /// <summary> 
    ///     A converter which converts boolean to SelectiveScrollin----entation based on a ConverterParameter.
    /// </summary> 
    /// <remarks>
    ///     This can be used in the DataGrid's template to control how the RowDetails selectively scroll based on a boolean.
    /// </remarks>
...
//    #region Scrolling
    ...
    /// </summary> 
    public static final DependencyProperty HorizontalScrollBarVisibilityProperty = ScrollViewer.HorizontalScrollBarVisibilityProperty.AddOwner(typeof(DataGrid), new FrameworkPropertyMetadata(ScrollBarVisibility.Auto)); 
    ...
    ///     The DependencyProperty for the HorizontalScrollBarVisibility property.
    /// </summary>
    public static final DependencyProperty VerticalScrollBarVisibilityProperty = ScrollViewer.VerticalScrollBarVisibilityProperty.AddOwner(typeof(DataGrid), new FrameworkPropertyMetadata(ScrollBarVisibility.Auto));
    ...
    { 
        ...
        { 
            ...
            if (index >= 0)
            {
                ...
                // we are relying on some /*internal*/ public communication between DataGridRowsPresenter 
                // and the DataGrid.
                ...
                if (itemsHost != null) 
                {
                    ...
                    // but that method is protected, so we are relying on an /*internal*/ public
    ...
    private new boolean DoAutoScroll()
    { 
    ...
    /// </summary>
    /*internal*/ public Panel InternalItemsHost 
    {
    ...
    /// </summary> 
    /*internal*/ public ScrollViewer InternalScrollHost
    { 
        get 
        {
            EnsureInternalScrollControls(); 
    ...
    /// </summary> 
    /*internal*/ public ScrollContentPresenter InternalScrollContentPresenter
    { 
        get
        {
            EnsureInternalScrollControls();
    ...
    /// <summary>
    ///     Helper method which cleans up the /*internal*/ public scroll controls. 
    /// </summary> 
    ...
    /// </summary> 
    /*internal*/ public void OnViewportSizeChanged(Size oldSize, Size newSize)
    { 
    ...
    /// </summary>
    /*internal*/ public static final DependencyProperty HorizontalScrollOffsetProperty =
        DependencyProperty.Register( 
    ...
    /// </summary>
    /*internal*/ public double HorizontalScrollOffset 
    {
        get 
        { 
...
//    #region Editing Commands
    ...
    /// </summary>
    public static final RoutedCommand BeginEditCommand = new RoutedCommand("BeginEdit", typeof(DataGrid));

    /// <summary> 
    ///     The command to fire and allow to route to the DataGrid in order to indicate that the
    ///     current cell or row should commit any pending changes and exit edit mode. 
    /// </summary> 
    public static final RoutedCommand CommitEditCommand = new RoutedCommand("CommitEdit", typeof(DataGrid));
    ...
    ///     in before BeginEdit. 
    /// </summary>
    public static final RoutedCommand CancelEditCommand = new RoutedCommand("CancelEdit", typeof(DataGrid)); 
    ...
    { 
        boolean canExecute = !IsReadOnly && (CurrentCellContainer != null) && !IsEditingCurrentCell && !IsCurrentCellReadOnly && !HasCellValidationError; 
    ...
    protected /*virtual*/ void OnExecutedBeginEdit(ExecutedRoutedEventArgs e) 
    {
        ...
        if ((cell != null) && !cell.IsReadOnly && !cell.IsEditing) 
        {
            ...
            boolean deselectedPlaceholder = false;
            boolean reselectPlaceholderCells = false;
            List<int> columnIndexRanges = null;
            int newItemIndex = -1; 
            Object newItem = null;
            boolean placeholderAtBeginning = (EditableItems.NewItemPlaceholderPosition == NewItemPlaceholderPosition.AtBeginning); 
    ...
    private boolean CanEndEdit(CanExecuteRoutedEventArgs e, boolean commit) 
    {
        DataGridCell cellContainer = GetEventCellOrCurrentCell(e);
        if (cellContainer == null)
        { 
    ...
    { 
        ...
        { 
            ...
            boolean isEditingRowItem = IsEditingRowItem;
            ...
            if (shouldDelete)
            {
                ...
                using (UpdateSelectedCells())
                { 
                    boolean alreadyUpdating = IsUpdatingSelectedItems;
                    if (!alreadyUpdating)
                    {
...
//    #region Editing 
    ...
    public static final DependencyProperty IsReadOnlyProperty =
        DependencyProperty.Register("IsReadOnly", typeof(boolean), typeof(DataGrid), new FrameworkPropertyMetadata(false, new PropertyChangedCallback(OnIsReadOnlyChanged))); 
    ...
    /// </summary>
    public static final DependencyProperty CurrentItemProperty =
    ...
    /// </summary> 
    public static final DependencyProperty CurrentColumnProperty =
    ...
    /// </summary> 
    public static final DependencyProperty CurrentCellProperty = 
    ...
    private void UpdateCurrentCell(DataGridCell cell, boolean isFocusWithinCell)
    { 
    ...
    private boolean IsCurrentCellReadOnly
    { 
        get
        { 
            DataGridCell cell = CurrentCellContainer; 
    ...
    /// </remarks> 
    protected /*internal*/ public /*virtual*/ void OnPreparingCellForEdit(DataGridPreparingCellForEditEventArgs e) 
    {
    ...
    /*internal*/ public boolean CancelEdit(DataGridCell cell)
    { 
    ...
    private boolean EndEdit(RoutedCommand command, DataGridCell cellContainer, DataGridEditingUnit editingUnit, boolean exitEditMode)
    { 
        boolean cellLeftEditingMode = true;
        boolean rowLeftEditingMode = true;
    ...
    private boolean HasCellValidationError 
    {
        get 
        {
    ...
    private boolean HasRowValidationError
    { 
        get
        {
    ...
    /// </summary>
    /*internal*/ public DataGridCell FocusedCell
    { 
        get
        { 
            return _focusedCell; 
...
//    #region Row Editing
    ...
    /// </summary>
    public boolean CanUserAddRows 
    { 
        get { return (boolean)GetValue(CanUserAddRowsProperty); }
    ...
    /// </summary>
    public static final DependencyProperty CanUserAddRowsProperty = 
        DependencyProperty.Register("CanUserAddRows", typeof(boolean), typeof(DataGrid), new FrameworkPropertyMetadata(true, new PropertyChangedCallback(OnCanUserAddRowsChanged), new CoerceValueCallback(OnCoerceCanUserAddRows))); 
    ...
    { 
        return OnCoerceCanUserAddOrDeleteRows((DataGrid)d, (boolean)baseValue, /* canUserAddRowsProperty = */ true); 
    }

    private static boolean OnCoerceCanUserAddOrDeleteRows(DataGrid dataGrid, boolean baseValue, boolean canUserAddRowsProperty)
    {
    ...
    /// </summary>
    public boolean CanUserDeleteRows
    {
        get { return (boolean)GetValue(CanUserDeleteRowsProperty); } 
    ...
    /// </summary>
    public static final DependencyProperty CanUserDeleteRowsProperty =
        DependencyProperty.Register("CanUserDeleteRows", typeof(boolean), typeof(DataGrid), new FrameworkPropertyMetadata(true, new PropertyChangedCallback(OnCanUserDeleteRowsChanged), new CoerceValueCallback(OnCoerceCanUserDeleteRows)));
    ...
    {
        return OnCoerceCanUserAddOrDeleteRows((DataGrid)d, (boolean)baseValue, /* canUserAddRowsProperty = */ false); 
    }
    ...
    private void CancelRowItem() 
    {
        ...
        { 
            ...
            boolean wasCurrent = currentAddItem == CurrentItem; 
            boolean wasSelected = SelectedItems.Contains(currentAddItem); 
            boolean reselectPlaceholderCells = false;
            List<int> columnIndexRanges = null; 
            int newItemIndex = -1;
    ...
    private boolean IsEditingRowItem 
    {
        get { return EditableItems.IsEditingItem; }
    }

    private boolean IsAddingOrEditingRowItem(Object item)
    { 
        return IsEditingItem(item) || 
            (IsAddingNewItem && (EditableItems.CurrentAddItem == item));
    } 

    private boolean IsAddingOrEditingRowItem(DataGridEditingUnit editingUnit, Object item)
    {
        return (editingUnit == DataGridEditingUnit.Row) && 
                IsAddingOrEditingRowItem(item);
    } 

    private boolean IsEditingItem(Object item)
    { 
        return IsEditingRowItem && (EditableItems.CurrentEditItem == item);
    }

    private void UpdateNewItemPlaceholder(boolean isAddingNewItem) 
    {
        var editableItems = EditableItems; 
        boolean canUserAddRows = CanUserAddRows; 
    ...
    private boolean HasNewItemPlaceholder
    { 
        get 
        {
            IEditableCollectionView editableItems = EditableItems; 
    ...
    private boolean IsNewItemPlaceholder(Object item)
    { 
...
//    #region Row Details
    ...
    /// </summary> 
    public static final DependencyProperty RowDetailsVisibilityModeProperty =
    ...
    /// </summary> 
    public boolean AreRowDetailsFrozen
    { 
        get { return (boolean)GetValue(AreRowDetailsFrozenProperty); } 
    ...
    /// </summary> 
    public static final DependencyProperty AreRowDetailsFrozenProperty =
        DependencyProperty.Register("AreRowDetailsFrozen", typeof(boolean), typeof(DataGrid), new FrameworkPropertyMetadata(false)); 
    ...
    /// </summary>
    public static final DependencyProperty RowDetailsTemplateProperty =
    ...
    /// </summary> 
    public static final DependencyProperty RowDetailsTemplateSelectorProperty =
    ...
    /*internal*/ public void OnLoadingRowDetailsWrapper(DataGridRow row) 
    {
        if (row != null &&
    ...
    /*internal*/ public void OnUnloadingRowDetailsWrapper(DataGridRow row) 
    {
        if (row != null && 
            row.DetailsLoaded == true && 
            row.DetailsPresenter != null)
    ...
    /// </summary> 
    protected /*internal*/ public /*virtual*/ void OnRowDetailsVisibilityChanged(DataGridRowDetailsEventArgs e)
    { 
...
//    #region Row Resizing 
    ...
    /// </summary>
    public boolean CanUserResizeRows
    {
        get { return (boolean)GetValue(CanUserResizeRowsProperty); } 
    ...
    ///     The DependencyProperty that represents the CanUserResizeColumns property. 
    /// </summary>
    public static final DependencyProperty CanUserResizeRowsProperty =
        DependencyProperty.Register("CanUserResizeRows", typeof(boolean), typeof(DataGrid), new FrameworkPropertyMetadata(true, new PropertyChangedCallback(OnNotifyRowHeaderPropertyChanged)));
...
//    #region Selection 
    ...
    /*internal*/ public SelectedCellsCollection SelectedCellsInternal
    { 
        get { return _selectedCells; }
    }
    ...
    /// </summary>
    /*internal*/ public void OnSelectedCellsChanged(NotifyCollectionChangedAction action, VirtualizedCellInfoCollection oldItems, VirtualizedCellInfoCollection newItems)
    { 
            ...
            using (UpdateSelectedCells()) 
            {
                ...
                { 
                    ...
                    try 
                    {
                        ...
                        for/*each*/ (DataGridCellInfo cellInfo : oldItems) 
                        {
    ...
    /// </summary> 
    /*internal*/ public /*override*/ void SelectAllImpl()
    { 
    ...
    /*internal*/ public void SelectOnlyThisCell(DataGridCellInfo currentCellInfo)
    {
        using (UpdateSelectedCells()) 
        {
            _selectedCells.Clear(); 
    ...
    /// </summary>
    public static final DependencyProperty SelectionModeProperty =
    ...
    { 
        ...
        boolean changingToSingleMode = newSelectionMode == DataGridSelectionMode.Single; 
    ...
    /// </summary> 
    public static final DependencyProperty SelectionUnitProperty =
    ...
    /// </summary> 
    private void UpdateIsSelected(VirtualizedCellInfoCollection cells, boolean isSelected)
    { 
        if (cells != null)
        {
            ...
            if (numCells > 0) 
            {
                ...
                { 
                	for/*each*/ (DataGridCellInfo cellInfo : cells)
                    {
    ...
    private void UpdateSelectionOfCellsInRow(Object rowItem, boolean isSelected)
    { 
    ...
    /// </summary> 
    /*internal*/ public void CellIsSelectedChanged(DataGridCell cell, boolean isSelected)
    {
        if (!IsUpdatingSelectedCells)
        { 
            DataGridCellInfo cellInfo = new DataGridCellInfo(cell);
    ...
    /*internal*/ public void HandleSelectionForCellInput(DataGridCell cell, boolean startDragging, boolean allowsExtendSelect, boolean allowsMinimalSelect)
    { 
        DataGridSelectionUnit selectionUnit = SelectionUnit; 
    ...
    /// <param name="startDragging">Whether the input also indicated that dragging should start.</param>
    /*internal*/ public void HandleSelectionForRowHeaderAndDetailsInput(DataGridRow row, boolean startDragging) 
    { 
    ...
    /// </remarks> 
    private void MakeFullRowSelection(Object dataItem, boolean allowsExtendSelect, boolean allowsMinimalSelect)
    {
        boolean extendSelection = allowsExtendSelect && ShouldExtendSelection;

        // minimalModify means that previous selections should not be cleared
        // or that the particular item should be toggled. 
        boolean minimalModify = allowsMinimalSelect && ShouldMinimallyModifySelection; 
    ...
    ///     are in the same row scope.
    /// </remarks> 
    private void MakeCellSelection(DataGridCellInfo cellInfo, boolean allowsExtendSelect, boolean allowsMinimalSelect)
    {
        boolean extendSelection = allowsExtendSelect && ShouldExtendSelection;
        ...
        using (UpdateSelectedCells()) 
        {
            ...
            { 
                boolean selectedCellsContainsCellInfo = _selectedCells.Contains(cellInfo); 
                boolean singleRowOperation = (_editingRowIndex >= 0 && _editingRowItem == cellInfo.Item);
    ...
    private void SelectItem(Object item, boolean selectCells) 
    {
        if (selectCells)
        {
            using (UpdateSelectedCells()) 
    ...
    {
        boolean updatingSelectedItems = IsUpdatingSelectedItems;
    ...
    private boolean IsUpdatingSelectedCells
    {
    ...
    {
        /*internal*/ public ChangingSelectedCellsHelper(DataGrid dataGrid)
        { 
            _dataGrid = dataGrid;
        ...
        private boolean _wasUpdatingSelectedCells;
    } 
    ...
    /// </summary>
    private boolean ShouldExtendSelection 
    {
        get 
        { 
    ...
    /// </summary> 
    private static boolean ShouldMinimallyModifySelection
    { 
        get
        {
    ...
    { 
        ...
        {
        	for/*each*/ (Object item : e.OldItems)
            {
...
//    #region Input 
    ...
    { 
        ...
        { 
            e.Handled = true;
            boolean wasEditing = currentCellContainer.IsEditing;
            ...
            { 
                boolean navigateFromCellContainer = e.OriginalSource == currentCellContainer;
                if (navigateFromCellContainer) 
                {
                    ...
                    boolean controlModifier = ((e.KeyboardDevice.Modifiers & ModifierKeys.Control) == ModifierKeys.Control); 
    ...
    private void OnTabKeyDown(KeyEventArgs e)
    {
        ...
        {
            boolean wasEditing = currentCellContainer.IsEditing; 
            boolean previous = ((e.KeyboardDevice.Modifiers & ModifierKeys.Shift) == ModifierKeys.Shift);
    ...
    private void OnEnterKeyDown(KeyEventArgs e)
    {
        ...
        { 
            ...
            { 
                boolean shiftModifier = ((e.KeyboardDevice.Modifiers & ModifierKeys.Shift) == ModifierKeys.Shift);
    ...
    private void SelectAndEditOnFocusMove(KeyEventArgs e, DataGridCell oldCell, boolean wasEditing, boolean allowsExtendSelect, boolean ignoreControlKey) 
    {
        DataGridCell newCell = GetCellForSelectAndEditOnFocusMove(); 
    ...
    private void OnHomeOrEndKeyDown(KeyEventArgs e) 
    {
        if ((_columns.Count > 0) && (Items.Count > 0)) 
        {
            ...
            boolean homeKey = (e.Key == Key.Home); 
            boolean controlModifier = ((e.KeyboardDevice.Modifiers & ModifierKeys.Control) == ModifierKeys.Control);
    ...
    private DataGridCell GetCellNearMouse() 
    {
        ...
        { 
            ...
            boolean isMouseInCorner = IsMouseInCorner(RelativeMousePosition);
            boolean isGrouping = IsGrouping; 
    ...
    /// </returns>
    private static boolean CalculateCellDistance(FrameworkElement cell, DataGridRow rowOwner, Panel itemsHost, Rect itemsHostBounds, boolean isMouseInCorner, /*out*/ double distance)
    {
    ...
    private static boolean IsMouseToLeft(RelativeMousePositions position) 
    { 
        return (position & RelativeMousePositions.Left) == RelativeMousePositions.Left;
    } 

    private static boolean IsMouseToRight(RelativeMousePositions position)
    {
        return (position & RelativeMousePositions.Right) == RelativeMousePositions.Right; 
    }

    private static boolean IsMouseAbove(RelativeMousePositions position) 
    {
        return (position & RelativeMousePositions.Above) == RelativeMousePositions.Above; 
    }

    private static boolean IsMouseBelow(RelativeMousePositions position)
    { 
        return (position & RelativeMousePositions.Below) == RelativeMousePositions.Below;
    } 

    private static boolean IsMouseToLeftOrRightOnly(RelativeMousePositions position)
    { 
        return (position == RelativeMousePositions.Left) || (position == RelativeMousePositions.Right);
    }

    private static boolean IsMouseInCorner(RelativeMousePositions position) 
    {
...
//    #region Automation 
    ...
    /*internal*/ public String GetCellAutomationValue(Object item, DataGridColumn column)
    { 
    ...
    /*internal*/ public Object GetCellClipboardValue(Object item, DataGridColumn column) 
    {
        CellAutomationValueHolder cellAutomationValueHolder = GetCellAutomationValueHolder(item, column);
        return cellAutomationValueHolder.GetClipboardValue();
    } 

    /*internal*/ public void SetCellAutomationValue(Object item, DataGridColumn column, String value) 
    { 
        SetCellValue(item, column, value, false /*clipboard*/);
    } 

    /*internal*/ public void SetCellClipboardValue(Object item, DataGridColumn column, Object value)
    {
        SetCellValue(item, column, value, true /*clipboard*/); 
    }

    private void SetCellValue(Object item, DataGridColumn column, Object value, boolean clipboard) 
    {
    ...
    { 
        for/*each*/ (KeyValuePair<DataGridColumn, CellAutomationValueHolder> kvp : _editingCellAutomationValueHolders)
        {
...
//    #region CellAutomationHelper 
    ...
    /*internal*/ public class CellAutomationValueHolder
    {
        ...
        public void SetValue(DataGrid dataGrid, Object value, boolean clipboard)
        { 
            if (_column.ClipboardContentBinding == null)
                return; 
...
//    #region Cell Info
    ...
    /*internal*/ public DataGridCell TryFindCell(Object item, DataGridColumn column)
    {
        // Does not de-virtualize cells
...
//    #region Auto Sort 
    ...
    /// </summary>
    public static final DependencyProperty CanUserSortColumnsProperty =
        DependencyProperty.Register( 
            "CanUserSortColumns",
            typeof(boolean), 
            typeof(DataGrid), 
    ...
    /// </summary> 
    public boolean CanUserSortColumns
    { 
        get { return (boolean)GetValue(CanUserSortColumnsProperty); } 
    ...
    /*internal*/ public void PerformSort(DataGridColumn sortColumn)
    { 
    ...
    private void DefaultSort(DataGridColumn column, boolean clearExistingSortDescriptions)
    {
    ...
    /// <returns></returns> 
    private static boolean CanConvertToSortDescription(PropertyGroupDescription propertyGroupDescription) 
    {
...
//    #region Column Auto Generation
    ...
    /// </summary>
    public static final DependencyProperty AutoGenerateColumnsProperty =
        DependencyProperty.Register("AutoGenerateColumns", typeof(boolean), typeof(DataGrid), new FrameworkPropertyMetadata(true, new PropertyChangedCallback(OnAutoGenerateColumnsPropertyChanged)));
    ...
    {
        get { return (boolean)GetValue(AutoGenerateColumnsProperty); }
    ...
    { 
        super.OnItemsSourceChanged(oldValue, newValue);
    ...
    /// </summary>
    private boolean DeferAutoGeneration 
    { 
        get;
        set; 
    }
    ...
    { 
        ...
        {
            for/*each*/ (ItemPropertyInfo itemProperty : itemProperties) 
            {
...
//    #region Frozen Columns
    ...
    /// </summary> 
    public static final DependencyProperty FrozenColumnCountProperty =
        DependencyProperty.Register( 
            "FrozenColumnCount",
            typeof(int),
            typeof(DataGrid),
    ...
    /// <returns></returns> 
    private static boolean ValidateFrozenColumnCount(Object value)
    { 
    ...
    /// </summary> 
    private static final DependencyPropertyKey NonFrozenColumnsViewportHorizontalOffsetPropertyKey =
    ...
    /// </summary>
    public static final DependencyProperty NonFrozenColumnsViewportHorizontalOffsetProperty = NonFrozenColumnsViewportHorizontalOffsetPropertyKey.DependencyProperty; 
...
//    #region Container Virtualization
    ...
    /// </summary>
    public boolean EnableRowVirtualization 
    {
        get { return (boolean)GetValue(EnableRowVirtualizationProperty); } 
    ...
    /// </summary>
    public static final DependencyProperty EnableRowVirtualizationProperty = DependencyProperty.Register( 
    ...
    /// </summary> 
    public boolean EnableColumnVirtualization 
    {
        get { return (boolean)GetValue(EnableColumnVirtualizationProperty); } 
    ...
    /// </summary> 
    public static final DependencyProperty EnableColumnVirtualizationProperty = DependencyProperty.Register( 
    ...
    /// </summary>
    public static final DependencyProperty CanUserReorderColumnsProperty =
        DependencyProperty.Register("CanUserReorderColumns", typeof(boolean), typeof(DataGrid), new FrameworkPropertyMetadata(true, new PropertyChangedCallback(OnNotifyColumnPropertyChanged))); 

    /// <summary> 
    /// The property which determines if an end user can re-order columns or not. 
    /// </summary>
    public boolean CanUserReorderColumns 
    {
        get { return (boolean)GetValue(CanUserReorderColumnsProperty); }
    ...
    /// </summary>
    public static final DependencyProperty DragIndicatorStyleProperty = 
    ...
    /// </summary>
    public static final DependencyProperty DropLocationIndicatorStyleProperty = 
    ...
    protected /*internal*/ public /*virtual*/ void OnColumnHeaderDragStarted(DragStartedEventArgs e)
    {
    ...
    protected /*internal*/ public /*virtual*/ void OnColumnReordering(DataGridColumnReorderingEventArgs e) 
    {
    ...
    protected /*internal*/ public /*virtual*/ void OnColumnHeaderDragDelta(DragDeltaEventArgs e)
    { 
    ...
    protected /*internal*/ public /*virtual*/ void OnColumnHeaderDragCompleted(DragCompletedEventArgs e) 
    {
    ...
    protected /*internal*/ public /*virtual*/ void OnColumnReordered(DataGridColumnEventArgs e) 
    { 
...
//    #region Clipboard Copy 
    ...
    /// </summary>
    public static final DependencyProperty ClipboardCopyModeProperty =
...
//    [SecurityCritical, SecurityTreatAsSafe] 
    ...
    { 
        ...
        for/*each*/ (String format : formats)
        { 
        ...
        boolean hasPerms = SecurityHelper.CallerHasAllClipboardPermission() && SecurityHelper.CallerHasSerializationPermission();
...
//    #region Cells Panel Width
    ...
    /// </summary> 
    /*internal*/ public static final DependencyProperty CellsPanelActualWidthProperty = 
        DependencyProperty.Register(
    ...
    /// </summary>
    /*internal*/ public double CellsPanelActualWidth 
    {
        get
        {
...
//    #region Column Width Computations
    ...
    /// </summary> 
    private static final DependencyPropertyKey CellsPanelHorizontalOffsetPropertyKey =
        DependencyProperty.RegisterReadOnly( 
    ...
    /// </summary>
    public static final DependencyProperty CellsPanelHorizontalOffsetProperty = CellsPanelHorizontalOffsetPropertyKey.DependencyProperty; 
    ...
    /// </summary>
    private boolean CellsPanelHorizontalOffsetComputationPending 
    { 
        get;
        set; 
    }
    ...
    /// </summary> 
    /*internal*/ public void QueueInvalidateCellsPanelHorizontalOffset() 
    {
    ...
    /// </summary>
    /// <returns></returns>
    /*internal*/ public IProvideDataGridColumn GetAnyCellOrColumnHeader() 
    {
    ...
    /// </summary> 
    /// <returns></returns>
    /*internal*/ public double GetViewportWidthForColumns() 
    {
...
//    #region Helpers
    ...
    /*internal*/ public static Object NewItemPlaceholder
    {
...
//    #region Data
    ...
    private boolean _isDraggingSelection;                                  // Whether a drag select is being performed
    private boolean _isRowDragging;                                        // Whether a drag select is being done on rows 
    ...
    private boolean _hasAutoScrolled;                                      // Whether an auto-scroll has occurred since starting the tick 
    ...
    private boolean _measureNeverInvoked = true;                           // Flag used to track if measure was invoked atleast once. Particularly used for AutoGeneration.
    private boolean _updatingSelectedCells = false;                        // Whether to defer notifying that SelectedCells changed. 
    ...
    private boolean _ignoreSortDescriptionsChange = false;                 // Flag used to neglect the SortDescriptionCollection changes in the CollectionChanged listener.
    private boolean _sortingStarted = false;                               // Flag used to track if Sorting ever started or not. 
    ...
    private boolean _hasCellValidationError;                               // An unsuccessful cell commit occurred
    private boolean _hasRowValidationError;                                // An unsuccessful row commit occurred 
    ...
    private boolean _viewportWidthChangeNotificationPending = false;       // Flag to indicate if a viewport width change reuest is already queued. 
...
//    #region Constants 
    private /*const*/static final String ItemsPanelPartName = "PART_RowsPresenter";
//    #endregion
}