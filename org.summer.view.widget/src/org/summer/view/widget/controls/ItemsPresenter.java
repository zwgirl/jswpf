...
{ 
    ...
    /*internal*/public ItemsControl Owner
    {
        get { return _owner; }
    } 
    ...
    /// TemplateProperty 
    /// </summary>
    /*internal*/ static final DependencyProperty TemplateProperty = 
    ...
    /*internal*/public static ItemsPresenter FromPanel(Panel panel) 
    {
        if (panel == null) 
            return null;
    ...
    /*internal*/public static ItemsPresenter FromGroupItem(GroupItem groupItem) 
    { 
        if (groupItem == null)
            return null; 
    ...
    /*internal*/ /*override*/ public void OnAncestorChanged() 
    {
