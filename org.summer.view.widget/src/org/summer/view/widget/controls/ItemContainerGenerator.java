...
import org.summer.view.widget.collection.Queue;
...
/// </summary>
public /*sealed*/ class ItemContainerGenerator implements IRecyclingItemContainerGenerator, IWeakEventListener 
{ 
    //-----------------------------------------------------
    // 
    //  Constructors
    ...
    /*internal*/public ItemContainerGenerator(IGeneratorHost host) 
    { 
...
//    #region IItemContainerGenerator 
    ...
    /// </summary>
    public ItemContainerGenerator /*IItemContainerGenerator.*/GetItemContainerGeneratorForPanel(Panel panel)
    {
    ...
    /// </remarks> 
    public IDisposable /*IItemContainerGenerator.*/StartAt(GeneratorPosition position, GeneratorDirection direction)
    {
    ...
    /// Error, as appropriate.
    /// </remarks> 
    public IDisposable /*IItemContainerGenerator.*/StartAt(GeneratorPosition position, GeneratorDirection direction, boolean allowStartAtRealizedItem)
    { 
        if (_generator != null) 
    ...
    public DependencyObject /*IItemContainerGenerator.*/GenerateNext() 
    {
    ...
    public DependencyObject /*IItemContainerGenerator.*/GenerateNext(/*out*/ boolean isNewlyRealized) 
    {
        if (_generator == null) 
            throw new InvalidOperationException(/*SR.Get(SRID.GenerationNotInProgress)*/); 
    ...
    /// </param> 
    public void /*IItemContainerGenerator.*/PrepareItemContainer(DependencyObject container)
    { 
    ...
    /// </summary> 
    public void /*IItemContainerGenerator.*/Remove(GeneratorPosition position, int count)
    { 
    ...
    /// Remove generated elements.
    /// </summary> 
    private void Remove(GeneratorPosition position, int count, boolean isRecycling) 
    {
        ...
        while (rblock != blockR || offset <= offsetR) 
        {
            ...
            boolean isNewItemPlaceHolderWhenGrouping = _generatesGroupItems && !(container instanceof GroupItem); 
...
//                Debug.Assert(!_recyclableContainers.Contains(container), "trying to add a container to the collection twice");
        ...
        boolean edgeR = (offsetR == blockR.ItemCount-1);
        boolean abutL = edgeL && (blockL.Prev instanceof UnrealizedItemBlock); 
        boolean abutR = edgeR && (blockR.Next instanceof UnrealizedItemBlock);
    ...
    /// </summary>
    public void /*IItemContainerGenerator.*/RemoveAll() 
    { 
        RemoveAllInternal(false /*saveRecycleQueue*/);
    } 

    /*internal*/ void RemoveAllInternal(boolean saveRecycleQueue)
    {
    ...
    public void /*IRecyclingItemContainerGenerator.*/Recycle(GeneratorPosition position, int count) 
    { 
    ...
    /// </summary> 
    public GeneratorPosition /*IItemContainerGenerator.*/GeneratorPositionFromIndex(int itemIndex)
    { 
    ...
    /// </summary>
    public int /*IItemContainerGenerator.*/IndexFromGeneratorPosition(GeneratorPosition position) 
    {
        int index = position.Index; 
...
//            /*out*/ dummy, /*out*/ container, /*out*/ index, false);
    ...
    /// within the ItemCollection.
    /// </summary> 
    public int IndexFromContainer(DependencyObject container, boolean returnLocalIndex)
    {
        if (container == null)
        { 
            throw new ArgumentNullException("container");
...
//            /*out*/ item, /*out*/ dummy, /*out*/ index, returnLocalIndex);
    ...
    /*internal*/ boolean FindItem(Func<Object, DependencyObject, Boolean> match,
    ...
    /// </returns> 
    private boolean DoLinearSearch(Func<Object, DependencyObject, Boolean> match,
        ...
        while (true) 
        {
            ...
            if (rib != null)
            {
                ...
                { 
                    ...
                    boolean found = match(rib.ItemAt(offset), rib.ContainerAt(offset)); 
    ...
    private int GetCount(ItemBlock stop, boolean returnLocalIndex) 
    {
        int count = 0; 
    ...
    private int GetRealizedItemBlockCount(RealizedItemBlock rib, int end, boolean returnLocalIndex) 
    {
...
//#endif 
    ...
    /*internal*/public IEnumerable RecyclableContainers
    {
        get 
        {
    ...
    void FormatCollectionChangedSource(int level, Object source, boolean/*?*/ isLikely, List<String> sources)
    {
        ...
        { 
            ...
            final String PublicKeyToken = "PublicKeyToken="; 
    ...
    void GetCollectionChangedSources(int level, Action<Integer, Object, Boolean/*?*/, List<String>> format, List<String> sources) 
    { 
    ...
    /*internal*/public ItemContainerGenerator Parent 
    {
        get { return _parent;} 
    } 

    /*internal*/public int Level 
    {
        get { return _level;}
    }

    // The group style that governs the generation of UI for the items.
    /*internal*/public GroupStyle GroupStyle 
    { 
        ...
        set 
        {
            ...
            {
                if (_groupStyle instanceof INotifyPropertyChanged) 
                {
    ...
    /*internal*/public IList ItemsInternal
    {
        get { return _items; } 
        set
        { 
    ...
    /*internal*/ public static final DependencyProperty ItemForItemContainerProperty =
    ...
    /// </summary> 
    private class Generator implements IDisposable 
    {
        //------------------------------------------------------ 
        //
        //  Constructors
        ...
        /*internal*/ Generator(ItemContainerGenerator factory, GeneratorPosition position, GeneratorDirection direction, 
...
*/
        ...
        public DependencyObject GenerateNext(boolean stopAtRealized, /*out*/ boolean isNewlyRealized)
        {
            ...
            { 
                ...
                { 
                    ...
                    boolean isNewItemPlaceHolderWhenGrouping = (_factory._generatesGroupItems && group == null); 
    ...
    private class BatchGenerator implements IDisposable
    {
    ...
    void MoveToPosition(GeneratorPosition position, GeneratorDirection direction, boolean allowStartAtRealizedItem, /*ref*/ GeneratorState state) 
    { 
    ...
    boolean ShouldHide(CollectionViewGroup group) 
    {
    ...
    void GetBlockAndPosition(Object item, int itemIndex, 
    		boolean deletedFromItems, /*out*/ GeneratorPosition position, 
    		/*out*/ ItemBlock block, /*out*/ int offsetFromBlockStart, /*out*/ int correctIndex) 
    {
        if (itemIndex >= 0) 
        {
    ...
    void GetBlockAndPosition(Object item, boolean deletedFromItems, /*out*/ GeneratorPosition position, 
    		/*out*/ ItemBlock block, /*out*/ int offsetFromBlockStart, /*out*/ int correctIndex)
    { 
        correctIndex = 0; 
        int containerIndex = 0;
...
//#endif 
                ...
                boolean itemIsInCurrentBlock = false;
    ...
    /*internal*/public static void LinkContainerToItem(DependencyObject container, Object item)
    {
...
//            #endif 
    ...
    /*internal*/public static void UnlinkContainerFromItem(DependencyObject container, Object item, IGeneratorHost host)
    {
...
//            #endif
    ...
    private boolean            _generatesGroupItems; // Flag to indicate that this generates GroupItems 
    private boolean            _isGeneratingBatches;
...
//#endif
    ...
    { 
        ...
        public void MoveForward(/*ref*/ GeneratorState state, boolean allowMovePastRealizedItem)
        {
        ...
        public void MoveBackward(/*ref*/ GeneratorState state, boolean allowMovePastRealizedItem) 
        { 
            if (IsMoveAllowed(allowMovePastRealizedItem))
            { 
                if (--state.Offset < 0)
        ...
        public int MoveForward(/*ref*/ GeneratorState state, boolean allowMovePastRealizedItem, int count)
        {
            if (IsMoveAllowed(allowMovePastRealizedItem)) 
            {
        ...
        public int MoveBackward(/*ref*/ GeneratorState state, boolean allowMovePastRealizedItem, int count) 
        { 
            if (IsMoveAllowed(allowMovePastRealizedItem))
            { 
        ...
        protected /*virtual*/ boolean IsMoveAllowed(boolean allowMovePastRealizedItem)
        {
    ...
    private class UnrealizedItemBlock extends ItemBlock
    {
        public /*override*/ int ContainerCount { get { return 0; } } 

        protected /*override*/ boolean IsMoveAllowed(boolean allowMovePastRealizedItem) 
        { 
            return true;
        } 
    }
    ...
    private class RealizedItemBlock extends ItemBlock 
    {
    ...
    private class EmptyGroupItem extends GroupItem
    {
