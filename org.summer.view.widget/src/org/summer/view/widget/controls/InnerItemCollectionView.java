...
/*internal*/ /*sealed*/ public class InnerItemCollectionView extends CollectionView implements IList 
{
...
//#region IList 
    ...
    public Object this[int index] 
    {
        ...
        { 
            ...
            boolean changingCurrentItem = (CurrentPosition == index);
...
//    #region Private Methods 
    ...
    void SetModelParent(Object item) 
    {
        ...
        if ((ModelParentFE != null) && (item instanceof DependencyObject)) 
...
//    #endregion Private Methods 
    ...
    boolean _isModified;
    boolean _currentElementWasRemoved = false; // true if we need to MoveCurrencyOffDeletedElement 
}