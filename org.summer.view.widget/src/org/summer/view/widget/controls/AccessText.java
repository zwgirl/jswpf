...
import org.summer.view.widget.Trigger;
...
//    #region Internal Methods 
    ...
    /*internal*/ public static boolean HasCustomSerialization(Object o) 
    {
...
//    #region Internal Properties
    ...
    /*internal*/ public TextBlock TextBlock 
    {
        get 
        {
            if (_textBlock == null)
    ...
    /*internal*/ public static char AccessKeyMarker 
    {
...
//    #region Private Methods 
    ...
    /*internal*/ public static void SerializeCustom(XmlWriter xmlWriter, Object o)
    {
    ...
    /*internal*/ public static String RemoveAccessKeyMarker(String text)
    {
...
//    #region Private Fields 
    ...
    //---------------------------------------------------------------
    private boolean _accessKeyLocated; 

    //---------------------------------------------------------------
    // Defines the charecter to be used in fron of the access key
    //--------------------------------------------------------------- 
    private /*const*/static final char _accessKeyMarker = '_';

    //---------------------------------------------------------------- 
    // Stores the default Style applied on the /*internal*/ public Run
    //--------------------------------------------------------------- 
    ...
    //---------------------------------------------------------------
    // Flag that indicates that /*internal*/ public Run should have a custom serialization 
    //----------------------------------------------------------------
    private static final UncommonField<Boolean> HasCustomSerializationStorage = new UncommonField<Boolean>();
