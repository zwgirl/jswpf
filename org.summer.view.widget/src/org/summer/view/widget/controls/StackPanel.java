...
/// </summary>
public class StackPanel extends Panel implements IScrollInfo, IStackMeasure 
{ 
    //-------------------------------------------------------------------
    // 
    //  Constructors
...
//#endif 
    ...
    /// </summary> 
    /*internal*/ public  static Size StackMeasureHelper(IStackMeasure measureElement, IStackMeasureScrollData scrollData, Size constraint)
    { 
        Size stackDesiredSize = new Size();
        UIElementCollection children = measureElement.InternalChildren;
        Size layoutSlotSize = constraint;
        boolean fHorizontal = (measureElement.Orientation == Orientation.Horizontal); 
    ...
    /// </summary> 
    /*internal*/ public  static Size StackArrangeHelper(IStackMeasure arrangeElement, IStackMeasureScrollData scrollData, Size arrangeSize)
    { 
        UIElementCollection children = arrangeElement.InternalChildren; 
        boolean fHorizontal = (arrangeElement.Orientation == Orientation.Horizontal);
...
//    #region Private Methods
    ...
    private static double ComputePhysicalFromLogicalOffset(IStackMeasure arrangeElement, double logicalOffset, boolean fHorizontal) 
    {
...
//    #region ScrollData
    ...
    { 
        ...
        /*internal*/ public  Vector _offset;            // Scroll offset of content.  Positive corresponds to a visually upward offset.
        ...
        /*internal*/ public  double _physicalViewport;  // The physical size of the viewport for the items dimension above.
