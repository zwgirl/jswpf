...
//    #region Public Properties
    ...
    /// </summary>
    public static final DependencyProperty VolumeProperty
        = DependencyProperty.Register( 
                    "Volume",
                    typeof(double), 
                    typeof(MediaElement), 
    ...
    /// </summary>
    public static final DependencyProperty BalanceProperty 
        = DependencyProperty.Register( 
                    "Balance",
                    typeof(double), 
                    typeof(MediaElement),
    ...
    /// </summary> 
    public static final DependencyProperty IsMutedProperty
        = DependencyProperty.Register(
                    "IsMuted",
                    typeof(boolean), 
                    typeof(MediaElement),
    ...
    /// </summary> 
    public static final DependencyProperty ScrubbingEnabledProperty
        = DependencyProperty.Register( 
                    "ScrubbingEnabled", 
                    typeof(boolean),
                    typeof(MediaElement), 
    ...
    /// </summary>
    public static final DependencyProperty UnloadedBehaviorProperty 
        = DependencyProperty.Register(
                    "UnloadedBehavior",
                    typeof(MediaState),
                    typeof(MediaElement), 
    ...
    /// </summary>
    public static final DependencyProperty LoadedBehaviorProperty 
        = DependencyProperty.Register(
                    "LoadedBehavior", 
                    typeof(MediaState), 
                    typeof(MediaElement),
...
//    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    ...
    { 
        get 
        {
            return (boolean) GetValue(IsMutedProperty); 
        }
        set
        {
    ...
    public boolean ScrubbingEnabled
    {
        get 
        {
            return (boolean) GetValue(ScrubbingEnabledProperty); 
        } 
        set
        { 
    ...
    /// </summary>
    public static final RoutedEvent MediaFailedEvent = 
    ...
    /// </summary> 
    public static final RoutedEvent MediaOpenedEvent = 
        EventManager.RegisterRoutedEvent(
                        "MediaOpened", 
                        RoutingStrategy.Bubble,
    ...
    /// </summary> 
    public static final RoutedEvent BufferingStartedEvent =
        EventManager.RegisterRoutedEvent( 
                        "BufferingStarted",
                        RoutingStrategy.Bubble,
                        typeof(RoutedEventHandler),
    ...
    /// </summary>
    public static final RoutedEvent BufferingEndedEvent = 
        EventManager.RegisterRoutedEvent(
                        "BufferingEnded",
                        RoutingStrategy.Bubble,
                        typeof(RoutedEventHandler), 
    ...
    /// </summary> 
    public static final RoutedEvent ScriptCommandEvent =
        EventManager.RegisterRoutedEvent(
                        "ScriptCommand",
                        RoutingStrategy.Bubble, 
    ...
    /// </summary>
    public static final RoutedEvent MediaEndedEvent =
        EventManager.RegisterRoutedEvent(
                        "MediaEnded", 
                        RoutingStrategy.Bubble,
                        typeof(RoutedEventHandler), 
...
//    #region Internal Properties / Methods 
    ...
    /// </summary>
    /*internal*/ public AVElementHelper Helper 
    {
        get
        {
            return _helper; 
...
//    #region Private Methods
    ...
    private static void IsMutedPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) 
    {
        ...
        if (target != null) 
        {
            target._helper.SetIsMuted((boolean)e.NewValue); 
        } 
    }
    ...
    private static void ScrubbingEnabledPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ...
        if (target != null)
        {
            target._helper.SetScrubbingEnabled((boolean)e.NewValue);
        } 
    }

    private static void UnloadedBehaviorPropertyChanged( 
        DependencyObject d,
    ...
    private static void LoadedBehaviorPropertyChanged(
        DependencyObject d,
        DependencyPropertyChangedEventArgs e 
        )
    { 
    ...
    /*internal*/ public void OnMediaFailed( 
        Object sender,
    ...
    /*internal*/ public void OnMediaOpened( 
        Object sender,
        EventArgs args
        )
    { 
    ...
    /*internal*/ public void OnBufferingStarted(
        Object sender,
        EventArgs args
        ) 
    {
    ...
    /*internal*/ public void OnBufferingEnded(
        Object sender,
        EventArgs args 
        )
    { 
    ...
    /*internal*/ public void OnMediaEnded(
        Object sender, 
        EventArgs args
        ) 
    { 
    ...
    /*internal*/ public void OnScriptCommand( Object  sender, MediaScriptCommandEventArgs args  ) 
    {
        RaiseEvent( 
