...
/// </remarks> 
public abstract /*partial*/ class UIElement3D extends Visual3D implements IInputElement
{ 
    /// <SecurityNote> 
...
//    #endregion AllowDrop
    ...
    /*internal*/ public void OnVisualAncestorChanged(Object sender, AncestorChangedEventArgs e)
    { 
...
//    #region LoadedAndUnloadedEvents 
    ...
    /// </summary>
    /*internal*/ public /*virtual*/ void OnPresentationSourceChanged(boolean attached)
    {
...
//    [Localizability(LocalizationCategory.None, Readability = Readability.Unreadable)]
    ...
    // /*internal*/ public accessor for AccessKeyManager class 
...
//    [CommonDependencyProperty]
    ...
    { 
        ...
        if ((boolean)value) 
        {
            ...
            if (parent == null || (boolean)parent.GetValue(UIElement.IsEnabledProperty)) 
            { 
...
//    #region IsHitTestVisible Property 
    ...
    /*internal*/ public static readonly EventPrivateKey IsHitTestVisibleChangedKey = new EventPrivateKey(); // Used by ContentElement
...
//    #region IsVisible Property 
    ...
    /*internal*/ public static readonly EventPrivateKey IsVisibleChangedKey = new EventPrivateKey(); // Used by ContentElement 
...
//    #region ForceInherit property support 
    ...
    /*internal*/ public static void InvalidateForceInheritPropertyOnChildren(Visual3D v, DependencyProperty property)
    {
...
//    #region Private Fields
    ...
    private final Visual3DCollection _children; 

    private boolean _renderRequestPosted; 
