...
/// more details.
/// </summary>
public abstract class Freezable extends DependencyObject implements ISealable
{ 
...
//
//    private final int DebugID = _nextID++;
//
//#endif
...
//    #region Public Properties 
    ...
    /*internal*/ public boolean IsFrozenInternal 
    {
        get
        {
...
//    #region Public Events 
    ...
    /*internal*/ public /*event*/ EventHandler ChangedInternal
    { 
        add 
        {
            HandlerAdd(value); 
...
//    #region Protected Methods 
    ...
    protected /*virtual*/ boolean FreezeCore(boolean isChecking) 
    { 
...
//    [ThreadStatic] 
    ...
    { 
        ...
        if (IsFrozenInternal) 
        {
            throw new InvalidOperationException(/* SR.Get(SRID.Freezable_CantBeFrozen,GetType().FullName)*/);
        } 
    }
    ...
    /// <summary> 
    /// Extenders of Freezable call this to set in a new value for /*internal*/ public
    ...
    static protected /*internal*/  boolean Freeze(Freezable freezable, boolean isChecking)
    {
        if (freezable != null)
        { 
...
//    #region /*internal*/ public Methods 
    ...
    /// </summary>
    /*internal*/ public void ClearContextAndHandlers()
    {
    ...
    /// </summary>
    /*internal*/ public void FireChanged() 
    {
...
//    #region Private methods 
    ...
    /*internal*/ public boolean Freeze(boolean isChecking) 
    { 
        if (isChecking)
        { 
            ReadPreamble();
    ...
    private void CloneCoreCommon(Freezable sourceFreezable, boolean useCurrentValue, boolean cloneFrozenValues)
    {
        EffectiveValueEntry[] srcEffectiveValues = sourceFreezable.EffectiveValues; 
        int srcEffectiveValueCount = sourceFreezable.EffectiveValuesCount;
        ...
        for (int i = 0; i < srcEffectiveValueCount; i++)
        {
...
//            "Caller should guard against passing null owner/child."); 
        ...
        { 
            throw new InvalidOperationException(/*SR.Get(SRID.Freezable_AttemptToUseInnerValueWithDifferentThread)*/);
        } 
    }
...
//        Debug.Assert(context != null);
    ...
    /// <param name="property">The property of the DependencyObject this Object maps to or null if none.</param>
    /// </summary>
    /*internal*/ public void AddContextInformation(DependencyObject context, DependencyProperty property)
    { 
//        Debug.Assert(context != null);
...
//        Debug.Assert(context != null);
        ...
        boolean multipleInheritanceContextsFound = HasMultipleInheritanceContexts;  // We can never leave this state once there

        //
        boolean newInheritanceContext = context.CanBeInheritanceContext && !this.IsInheritanceContextSealed;  // becomes false if we find context on the list
...
//                         "Must call UsingSingletonContext before use"); 
    ...
    /// </summary> 
    private boolean HasContextInformation
    { 
        get
        {
...
//    #endregion InheritanceContext 
    ...
    class FreezableContextPair 
    {
        ...
        public final DependencyProperty Property; 
    }
...
//    #region Debug
    ...
    private static void Debug_VerifyCloneCommon(Freezable original, Object clone, boolean isDeepClone) 
    {
        if (Invariant.Strict) 
        { 
...
//                    Debug_VerifyContextIsValid(owner, context.Property);
    ...
    { 
        if (Invariant.Strict) 
        {
            ...
            boolean mayBeResourceDictionary =
...
//    #region Private Fields 
    ...
    private final int INITIAL_EVENTSTORAGE_SIZE = 4;
