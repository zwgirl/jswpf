...
//	[ClassInterface(ClassInterfaceType.AutoDual)]
	public abstract class Binder
	{
		...
		static final Binder default_binder = new Default ();

		/*internal*/ public static Binder DefaultBinder {
			get {
				return default_binder;
			}
		}

		/*internal*/ public void ConvertValues (Object[] args, ParameterInfo[] pinfo, CultureInfo culture, boolean exactMatch)
		{
			if (args == null) {
				if (pinfo.Length == 0)
					return;
		...
		/*internal*/ public Object ConvertValue (Object value, Type type, CultureInfo culture, boolean exactMatch)
		{
		...
		Object TryConvertToType (Object value, Type type, /*ref*/ boolean failed)
		{
		...
		/*internal*/ public static int GetDerivedLevel (Type type) 
		{
		...
		/*internal*/ public static MethodBase FindMostDerivedMatch (MethodBase [] match) 
		{
			int highLevel = 0;
			int matchId = -1;
		...
		/*internal*/ public /*sealed*/ class Default extends Binder {
			...
			private static boolean check_arguments (Type[] types, ParameterInfo[] args, boolean allowByRefMatch) {
				for (int i = 0; i < types.Length; ++i) {
					boolean match = check_type (types [i], args [i].ParameterType);
			...
			MethodBase SelectMethod (BindingFlags bindingAttr, MethodBase[] match, Type[] types, ParameterModifier[] modifiers, boolean allowByRefMatch, Object[] arguments)
			{
				MethodBase m;
				int i, j;
			...
			MethodBase GetBetterMethod (MethodBase m1, MethodBase m2, Type [] types)
			{
				...
				boolean va1 = (m1.CallingConvention & CallingConventions.VarArgs) != 0;
				boolean va2 = (m2.CallingConvention & CallingConventions.VarArgs) != 0;
				if (va1 && !va2)
					return m2;
				if (va2 && !va1)
					return m1;
			...
			public /*override*/ PropertyInfo SelectProperty (BindingFlags bindingAttr, PropertyInfo[] match, Type returnType, Type[] indexes, ParameterModifier[] modifiers)
			{
				...
				boolean haveRet = (returnType != null);
