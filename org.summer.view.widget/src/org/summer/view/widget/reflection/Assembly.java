...
public abstract class Assembly extends _Assembly implements IEvidenceFactory, ICustomAttributeProvider, ISerializable 
{
//    #region constructors 
    protected Assembly() {} 
//    #endregion
...
//#if !FEATURE_CORECLR 
    public static boolean operator ==(Assembly left, Assembly right)
    { 
...
//    [System.Security.SecuritySafeCritical]  // auto-generated
//    [MethodImplAttribute(MethodImplOptions.NoInlining)] // Methods containing StackCrawlMark local var has to be marked non-inlineable
    /*internal*/ public static Type GetType_Compat(String assemblyString, String typeName)
    { 
        // Normally we would get the stackMark only in public APIs. This is /*internal*/ public API, but it is AppCompat replacement of public API
...
//    [ComVisible(false)] 
    public /*virtual*/ boolean ReflectionOnly
    { 
        get
        {
            throw new NotImplementedException();
...
//    [ComVisible(false)] 
    ...
    */ 
    public /*virtual*/ boolean GlobalAssemblyCache 
    {
        get 
        {
            throw new NotImplementedException();
...
//    [ComVisible(false)] 
    ...
    public /*virtual*/ boolean IsDynamic 
    {
        get 
        { 
            return false;
...
/*internal*/ public enum LoadContext 
{
   DEFAULT, 
   LOADFROM,
   UNKNOWN,
...
//#endif //!FEATURE_CORECLR
//[Serializable] 
/*internal*/ public class RuntimeAssembly extends Assembly implements
...
//    [System.Security.SecurityCritical]
    CustomQueryInterfaceResult ICustomQueryInterface.GetInterface([In]/*ref*/ Guid iid, /*out*/*out*/ntPtr ppv) 
    {
...
//#endif // !FEATURE_CORECLR 
    ...
    private /*const*/static final uint COR_E_LOADING_REFERENCE_ASSEMBLY = 0x80131058U;

    /*internal*/ public RuntimeAssembly() { throw new NotSupportedException(); } 
...
//#if FEATURE_APPX
    /*internal*/ public int InvocableAttributeCtorToken 
    {
        get 
        { 
...
//#endif // !FEATURE_CORECLR
    ...
    /*internal*/ public Object SyncRoot
    {
        get
        { 
            if (m_syncRoot == null)
...
//    [System.Security.SecurityCritical]  // auto-generated
    /*internal*/ public String GetCodeBase(boolean copiedName)
    {
...
//#endif 
    ...
    /*internal*/ public RuntimeAssembly GetNativeHandle() 
    {
        return this; 
    }
...
//    [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
//    [SuppressUnmanagedCodeSecurity] 
    /*internal*/ public extern static void GetForwardedTypes(RuntimeAssembly assembly, ObjectHandleOnStack retTypes);
...
//        [SecurityPermissionAttribute( SecurityAction.Demand, ControlEvidence = true )] 
    ...
    /*internal*/ public Evidence EvidenceNoDemand 
    { 
//        [SecurityCritical]
        get 
        {
...
//    [ResourceConsumption(ResourceScope.Machine)]
//    [MethodImplAttribute(MethodImplOptions.NoInlining)] // Methods containing StackCrawlMark local var has to be marked non-inlineable 
    /*internal*/ public static RuntimeAssembly InternalLoadFrom(String assemblyFile, 
                                                     Evidence securityEvidence,
                                                     byte[] hashValue, 
                                                     AssemblyHashAlgorithm hashAlgorithm,
...
//    [System.Security.SecurityCritical]  // auto-generated
    /*internal*/ public static RuntimeAssembly InternalLoad(String assemblyString, 
...
//    [System.Security.SecurityCritical]  // auto-generated 
    /*internal*/ public static AssemblyName CreateAssemblyName(
...
//    [ResourceExposure(ResourceScope.None)]
//    [ResourceConsumption(ResourceScope.Machine, ResourceScope.Machine)] 
    /*internal*/ public static RuntimeAssembly InternalLoadAssemblyName(
        AssemblyName assemblyRef,
        Evidence assemblySecurity,
        RuntimeAssembly reqAssembly, 
        /*ref*/ StackCrawlMark stackMark,
        boolean throwOnFileNotFound, 
        boolean forIntrospection, 
        boolean suppressSecurityChecks)
    { 
...
//#if !FEATURE_CORECLR 
//    [System.Security.SecuritySafeCritical]
    /*internal*/ public boolean IsFrameworkAssembly()
    {
...
//#if FEATURE_APPX 
    ...
    /*internal*/ public boolean IsSafeForReflection()
    { 
        ASSEMBLY_FLAGS flags = Flags;
...
//    [System.Security.SecuritySafeCritical] 
    private boolean IsDesignerBindingContext()
    {
...
//    [SuppressUnmanagedCodeSecurity]
//    [ResourceExposure(ResourceScope.None)] 
    private extern static boolean nIsDesignerBindingContext(RuntimeAssembly assembly);
//#endif
...
//    [ResourceExposure(ResourceScope.None)] 
//    [MethodImplAttribute(MethodImplOptions.InternalCall)] 
    private static extern boolean IsFrameworkAssembly(AssemblyName assemblyName);

//    [System.Security.SecurityCritical]
//    [ResourceExposure(ResourceScope.Machine)]
//    [MethodImplAttribute(MethodImplOptions.InternalCall)]
    /*internal*/ public static extern boolean Is----ableAssembly(AssemblyName assemblyName); 
//#endif
...
//    [System.Security.SecurityCritical]  // auto-generated
//    [MethodImplAttribute(MethodImplOptions.NoInlining)] // Methods containing StackCrawlMark local var has to be marked non-inlineable 
    private static unsafe RuntimeAssembly LoadWithPartialNameHack(String partialName, boolean cropPublicKey)
    { 
        StackCrawlMark stackMark = StackCrawlMark.LookForMyCaller; 
...
//#if !FEATURE_CORECLR 
    [System.Security.SecurityCritical]  // auto-generated
    /*internal*/ public static RuntimeAssembly LoadWithPartialNameInternal(String partialName, Evidence securityEvidence, /*ref*/ StackCrawlMark stackMark) 
    {
        AssemblyName an = new AssemblyName(partialName);
    ...
    [System.Security.SecurityCritical]  // auto-generated 
    /*internal*/ public static RuntimeAssembly LoadWithPartialNameInternal(AssemblyName an, Evidence securityEvidence, /*ref*/ StackCrawlMark stackMark) 
    {
...
//#endif // !FEATURE_CORECLR 
    ...
    [SecuritySafeCritical] 
    private static boolean IsUserError(Exception e)
    {
        return (uint)Marshal.GetHRForException(e) == COR_E_LOADING_REFERENCE_ASSEMBLY;
    } 

    private static boolean IsSimplyNamed(AssemblyName partialName) 
    { 
    ...
    private static boolean CulturesEqual(CultureInfo refCI, CultureInfo defCI) 
    {
        boolean defNoCulture = defCI.Equals(CultureInfo.InvariantCulture); 
...
//    [ResourceExposure(ResourceScope.None)] 
//    [MethodImplAttribute(MethodImplOptions.InternalCall)]
    private static extern boolean IsReflectionOnly(RuntimeAssembly assembly); 

    // To not break compatibility with the V1 _Assembly interface we need to make this
    // new member ComVisible(false).
    [ComVisible(false)] 
    public /*override*/ boolean ReflectionOnly
    { 
        [System.Security.SecuritySafeCritical]  // auto-generated 
        get
        { 
...
//    [System.Security.SecurityCritical] // auto-generated
    /*internal*/ public static RuntimeAssembly InternalLoadFromStream(Stream assemblyStream, Stream pdbStream, /*ref*/ StackCrawlMark stackMark)
    {
...
//    [ResourceExposure(ResourceScope.Machine | ResourceScope.Assembly)] 
//    [ResourceConsumption(ResourceScope.Machine | ResourceScope.Assembly)]
    public /*override*/ FileStream[] GetFiles(boolean getResourceModules) 
    { 
...
//    [System.Security.SecurityCritical]  // auto-generated
    /*internal*/ public static RuntimeAssembly GetExecutingAssembly(/*ref*/ StackCrawlMark stackMark) 
    { 
...
//    [ResourceExposure(ResourceScope.None)]
//    [MethodImplAttribute(MethodImplOptions.InternalCall)] 
    private extern static boolean IsGlobalAssemblyCache(RuntimeAssembly assembly); 

    public /*override*/ boolean GlobalAssemblyCache 
    {
        [System.Security.SecuritySafeCritical]  // auto-generated
        get
        { 
...
//    [System.Security.SecurityCritical]  // auto-generated 
    /*internal*/ public Stream GetManifestResourceStream(
        Type type,
        String name,
        boolean skipSecurityCheck, 
        /*ref*/ StackCrawlMark stackMark)
    { 
...
//#if FEATURE_CAS_POLICY 
    /*internal*/ public boolean IsStrongNameVerified
    {
        [System.Security.SecurityCritical]  // auto-generated
...
//    [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
//    [SuppressUnmanagedCodeSecurity] 
    private static extern boolean GetIsStrongNameVerified(RuntimeAssembly assembly);
//#endif // FEATURE_CAS_POLICY
...
//    [System.Security.SecurityCritical]  // auto-generated 
    /*internal*/ public unsafe Stream GetManifestResourceStream(String name, /*ref*/ StackCrawlMark stackMark, boolean skipSecurityCheck) 
    {
        ulong length = 0; 
...
//    [System.Security.SecurityCritical]  // auto-generated 
    /*internal*/ public Version GetVersion()
    {
...
//    [System.Security.SecurityCritical]  // auto-generated 
    /*internal*/ public CultureInfo GetLocale()
    { 
        String locale = null; 
...
//    [ResourceExposure(ResourceScope.None)] 
//    [MethodImplAttribute(MethodImplOptions.InternalCall)]
    private static extern boolean FCallIsDynamic(RuntimeAssembly assembly);
...
//    [SecuritySafeCritical] 
    /*internal*/ public String GetSimpleName()
    { 
        String name = null;
...
//    [SecuritySafeCritical]
    /*internal*/ public byte[] GetRawBytes()
    {
        byte[] rawBytes = null; 
...
//    [System.Security.SecurityCritical]  // auto-generated 
    /*internal*/ public byte[] GetPublicKey()
    { 
        byte[] publicKey = null;
...
//    [SecurityCritical]
    /*internal*/ public void GetGrantSet(/*/*out*/*/ PermissionSet newGrant, /*out*/ PermissionSet newDenied) 
    {
...
//    [return: MarshalAs(UnmanagedType.Bool)] 
    private extern static boolean IsAllSecurityCritical(RuntimeAssembly assembly); 

    // Is everything introduced by this assembly critical 
//    [System.Security.SecuritySafeCritical]  // auto-generated
    /*internal*/ public boolean IsAllSecurityCritical()
    {
...
//    [SuppressUnmanagedCodeSecurity]
//    [return: MarshalAs(UnmanagedType.Bool)]
    private extern static boolean IsAllSecuritySafeCritical(RuntimeAssembly assembly);

    // Is everything introduced by this assembly safe critical
//    [System.Security.SecuritySafeCritical]  // auto-generated 
    /*internal*/ public boolean IsAllSecuritySafeCritical() 
    {
...
//    [SuppressUnmanagedCodeSecurity] 
//    [return: MarshalAs(UnmanagedType.Bool)] 
    private extern static boolean IsAllPublicAreaSecuritySafeCritical(RuntimeAssembly assembly);

    // Is everything introduced by this assembly safe critical
//    [System.Security.SecuritySafeCritical]  // auto-generated
    /*internal*/ public boolean IsAllPublicAreaSecuritySafeCritical()
    { 
...
//    [SuppressUnmanagedCodeSecurity]
//    [return: MarshalAs(UnmanagedType.Bool)]
    private extern static boolean IsAllSecurityTransparent(RuntimeAssembly assembly); 

    // Is everything introduced by this assembly transparent 
//    [System.Security.SecuritySafeCritical]  // auto-generated 
    /*internal*/ public boolean IsAllSecurityTransparent()
    { 
...
//    [ResourceExposure(ResourceScope.None)]
//    [ResourceConsumption(ResourceScope.Machine, ResourceScope.Machine)]
    private static void DemandPermission(String codeBase, boolean havePath, 
                                         int demandFlag)
    { 
...
//#if FEATURE_MULTICOREJIT && !FEATURE_CORECLR 
        // Once OnModuleResolveEvent is raised and registered, multicore JIT is considered not safe
        System.Runtime.ProfileOptimization.InternalAbortProfile(); 
//#endif
...
//    [System.Security.SecuritySafeCritical]  // auto-generated
//    [MethodImplAttribute(MethodImplOptions.NoInlining)] // Methods containing StackCrawlMark local var has to be marked non-inlineable
    /*internal*/ public Assembly InternalGetSatelliteAssembly(CultureInfo culture, 
                                                   Version version,
                                                   /*ref*/ StackCrawlMark stackMark) 
    { 
        if (culture == null)
...
//    [ResourceExposure(ResourceScope.None)]
//    [return: MarshalAs(UnmanagedType.Bool)] 
    private static extern boolean UseRelativeBindForSatellites();
//#endif 

//    [System.Security.SecurityCritical]  // auto-generated
//    [MethodImplAttribute(MethodImplOptions.NoInlining)] // Methods containing StackCrawlMark local var has to be marked non-inlineable 
    /*internal*/ public RuntimeAssembly InternalGetSatelliteAssembly(String name,
                                                          CultureInfo culture,
                                                          Version version,
                                                          boolean throwOnFileNotFound, 
                                                          /*ref*/ StackCrawlMark stackMark)
...
//#if !FEATURE_CORECLR
        boolean bIsAppXDevMode = AppDomain.IsAppXDesignMode(); 

        boolean useRelativeBind = false;
        if (CodeAccessSecurityEngine.QuickCheckForAllDemands()) 
        {
...
//    [ResourceExposure(ResourceScope.Machine)] 
//    [MethodImplAttribute(MethodImplOptions.InternalCall)]
    static /*internal*/ public extern RuntimeAssembly nLoadFile(String path, Evidence evidence);

//    [System.Security.SecurityCritical]  // auto-generated 
//    [ResourceExposure(ResourceScope.None)]
//    [MethodImplAttribute(MethodImplOptions.InternalCall)] 
    static /*internal*/ public extern RuntimeAssembly nLoadImage(byte[] rawAssembly, 
                                                      byte[] rawSymbolStore,
                                                      Evidence evidence, 
                                                      ref StackCrawlMark stackMark,
...
//    [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)] 
//    [SuppressUnmanagedCodeSecurity] 
    static /*internal*/ public extern unsafe void nLoadFromUnmanagedArray(boolean fIntrospection,
...
//    [System.Security.SecuritySafeCritical]  // auto-generated 
//    [ResourceExposure(ResourceScope.Machine | ResourceScope.Assembly)]
    private RuntimeModule[] GetModulesInternal(boolean loadIfNotFound, 
                                 boolean getResourceModules)
    {
...
//    [ResourceExposure(ResourceScope.Machine | ResourceScope.Assembly)] 
//    [ResourceConsumption(ResourceScope.Machine | ResourceScope.Assembly)] 
    public /*override*/ Module[] GetLoadedModules(boolean getResourceModules)
    { 
...
//    [ResourceExposure(ResourceScope.None)]
//    [MethodImplAttribute(MethodImplOptions.InternalCall)] 
    /*internal*/ public static extern RuntimeModule GetManifestModule(RuntimeAssembly assembly); 

//#if FEATURE_APTCA 
//    [System.Security.SecuritySafeCritical]
//    [ResourceExposure(ResourceScope.None)]
//    [MethodImplAttribute(MethodImplOptions.InternalCall)]
    /*internal*/ public static extern boolean AptcaCheck(RuntimeAssembly targetAssembly, RuntimeAssembly sourceAssembly); 
//#endif // FEATURE_APTCA

//    [System.Security.SecurityCritical]  // auto-generated 
//    [ResourceExposure(ResourceScope.None)]
//    [MethodImplAttribute(MethodImplOptions.InternalCall)] 
    /*internal*/ public static extern int GetToken(RuntimeAssembly assembly);
}
