...
import org.summer.view.widget.controls.ItemContainerTemplateKey;
import org.summer.view.widget.controls.PopupControlService;
import org.summer.view.widget.controls.ScrollContentPresenter;
...
import org.summer.view.widget.media.TransformCollection;
...
public /*partial*/ class FrameworkElement extends UIElement implements IFrameworkInputElement, ISupportInitialize, IHaveResources, IQueryAmbient
{ 
    static private final Type _typeofThis = typeof(FrameworkElement);
...
//    #region Internal Methods
    ...
    { 
        ...
        { 
            ...
            try
            {
                ...
                FrameworkObject fo = new FrameworkObject((DependencyObject) child  ); 
    ...
    /// </summary> 
    /// <remarks>
    ///     A parent change is considered catastrophic and results in a large 
    ...
    /*internal*/public void ChangeLogicalParent(DependencyObject newParent) 
    {
        ...
        // 
        // We also need to ensure that the tree is homogeneous with respect
    ...
    /*internal*/ /*virtual*/ void OnNewParent(DependencyObject newParent)
    {
        ...
        if(_parent != null && _parent instanceof ContentElement) 
        { 
...
//    [SecurityCritical,SecurityTreatAsSafe] 
    ...
    /// </summary>
    /*internal*/ /*override*/ public boolean ShouldProvideInheritanceContext(DependencyObject target, DependencyProperty property) 
    {
    ...
    /*internal*/ /*override*/public DependencyObject InheritanceContext
    { 
    ...
    /// </remarks>
    /*internal*/ /*override*/ public void AddInheritanceContext(DependencyObject context, DependencyProperty property) 
    { 
    ...
    /*internal*/ /*override*/ public void RemoveInheritanceContext(DependencyObject context, DependencyProperty property)
    { 
    ...
    ///     their own thing. 
    /// </summary>
    /*internal*/ /*override*/ public void OnInheritanceContextChangedCore(EventArgs args) 
    { 
...
//    #region Internal Properties
    ...
    /*internal*/ boolean IsStyleUpdateInProgress
    { 
    ...
    /*internal*/ boolean IsThemeStyleUpdateInProgress
    { 
    ...
    /*internal*/ boolean HasNumberSubstitutionChanged 
    {
    ...
    /*internal*/ boolean HasTemplateGeneratedSubTree
    { 
    ...
    /*internal*/ boolean HasImplicitStyleFromResources 
    { 
    ...
    /*internal*/ boolean IsStyleSetFromGenerator
    {
    ...
    /*internal*/ boolean HasStyleInvalidated
    { 
    ...
    /*internal*/ boolean HasStyleEverBeenFetched 
    {
    ...
    // performed atleast once on this node
    /*internal*/ boolean HasThemeStyleEverBeenFetched 
    {
    ...
    /*internal*/ boolean AncestorChangeInProgress
    { 
    ...
    /*internal*/ /*override*/ boolean HasMultipleInheritanceContexts
    { 
    ...
    /*internal*/ boolean PotentiallyHasMentees 
    {
    ...
    /// </summary>
    /*internal*/ static final EventPrivateKey ResourcesChangedKey = new EventPrivateKey();
    ...
    /// </remarks>
    /*internal*/ /*event*/ public EventHandler ResourcesChanged 
    {
        add 
        { 
    ...
    /// </summary>
    /*internal*/ static final EventPrivateKey InheritedPropertyChangedKey = new EventPrivateKey(); 
...
//    [EditorBrowsable(EditorBrowsableState.Never)] 
    ...
    public static final DependencyProperty OverridesDefaultStyleProperty 
        = DependencyProperty.Register("OverridesDefaultStyle", typeof(Boolean), _typeofThis,
                                        new FrameworkPropertyMetadata( 
    ...
    /// </summary>
    public static final DependencyProperty UseLayoutRoundingProperty = 
            DependencyProperty.Register(
                    "UseLayoutRounding",
                    typeof(Boolean),
    ...
    /// </summary>
    public boolean UseLayoutRounding 
    { 
        get { return (boolean)GetValue(UseLayoutRoundingProperty); }
    ...
    /*internal*/ /*virtual*/ public FrameworkTemplate TemplateInternal
    { 
        get { return null; }
    }
    ...
    // ControlTemplate/DataTemplate set on the
    // Control/Page/PageFunction/ContentPresenter 
    /*internal*/ /*virtual*/public FrameworkTemplate TemplateCache 
    {
        get { return null; } 
        set {}
    }
    ...
    /*internal*/ /*virtual*/public void OnTemplateChangedInternal( 
    ...
    /// </remarks> 
    /*internal*/ /*virtual*/ public void OnPreApplyTemplate()
    { 
    } 
    ...
    /// </remarks>
    /*internal*/public /*virtual*/ void OnPostApplyTemplate() 
    {
    ...
    public void BeginStoryboard(Storyboard storyboard, HandoffBehavior handoffBehavior, boolean isControllable) 
    {
        if( storyboard == null )
        {
            throw new IllegalArgumentException("storyboard"); 
        }
    ...
    /*internal*/ static FrameworkElement FindNamedFrameworkElement( FrameworkElement startElement, String targetName )
    {
        ...
        else 
        {
            ...
            { 
                throw new IllegalArgumentException( /*SR.Get(SRID.TargetNameNotFound, targetName)*/);
            } 
...
//    [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
    ...
    /// </summary> 
//    [EditorBrowsable(EditorBrowsableState.Never)]
    public boolean ShouldSerializeTriggers() 
    {
        TriggerCollection triggerCollection = EventTrigger.TriggerCollectionField.GetValue(this);
    ...
    /*internal*/public boolean IsTemplateRoot
    {
        get
        { 
    ...
    /// </summary>
    /*virtual*/ /*internal*/ public UIElement TemplateChild 
    {
        get 
        { 
    ...
    /// </summary>
    /*internal*/ /*virtual*/public FrameworkElement StateGroupsRoot 
    { 
        get
        { 
...
//    [EditorBrowsable(EditorBrowsableState.Never)]
    ...
    /*internal*/ static Object FindImplicitStyleResource(FrameworkElement fe, Object resourceKey, /*out*/ Object source) 
    {
        ...
        { 
            ...
            boolean allowDeferredResourceReference = false;
            boolean mustReturnDeferredResourceReference = false; 

            // Implicit style lookup must stop at the app.
            boolean isImplicitStyleLookup = true;
    ...
    /*internal*/public static Object FindImplicitStyleResource(FrameworkContentElement fce, Object resourceKey, /*out*/ Object source) 
    {
        // Do a FindResource call only if someone in the ancestry has 
        // implicit styles. This is a performance optimization.
    ...
    /*internal*/ public static Object FindResourceFromAppOrSystem( 
        Object resourceKey,
        /*out*/ Object source, 
        boolean disableThrowOnResourceNotFound, 
    ...
    /*internal*/ public static Object FindResourceInternal( 
        FrameworkElement        fe, 
...
//                    }
            ...
            { 
//                Debug.Assert(fo.IsValid, "The current node being processed should be an FE/FCE");
...
//#endif
    ...
    /*internal*/ protected boolean HasNonDefaultValue(DependencyProperty dp) 
    { 
    ...
    // Finds the nearest NameScope by walking up the logical tree 
    /*internal*/public static INameScope FindScope(DependencyObject d, /*out*/ DependencyObject scopeOwner)
    {
        while (d != null)
        { 
    ...
    /*internal*/ /*sealed*/ /*override*/public void EvaluateBaseValueCore(
        DependencyProperty  dp,
...
//        Debug.Assert( IsTemplatedParentAnFE ); 
    ...
    private Object GetInheritableValue(DependencyProperty dp, FrameworkPropertyMetadata fmetadata)
    {
        ...
        if (!TreeWalkHelper.SkipNext(InheritanceBehavior) || fmetadata.OverridesInheritanceBehavior == true) 
        {
            ...
            FrameworkContentElement parentFCE;
            FrameworkElement parentFE; 
            boolean hasParent = GetFrameworkParent(this, /*out*/ parentFE, /*out*/ parentFCE);
            while (hasParent) 
            { 
...
//#endregion EventTracing 
    ...
    { 
        ...
        return (Expression) (entry.Value instanceof Expression ? entry.Value : null);
    } 
...
//            }
                ...
                if (TemplatedParent != null) 
                {
                    ...
                    { 
                        StyleHelper.OnTriggerSourcePropertyInvalidated(null, frameworkTemplate, TemplatedParent, dp, e, false /*invalidateOnlyContainer*/, 
                            ...
                            /*ref*/ frameworkTemplate.PropertyTriggersWithActions, TemplateChildIndex /*sourceChildIndex*/);
                    } 
                }
        ...
        if (fmetadata != null) 
        {
            ...
            if (e.IsAValueChange || e.IsASubPropertyChange) 
            {
                ...
                { 
                    ...
                    boolean affectsParentMeasure = fmetadata.AffectsParentMeasure; 
                    boolean affectsParentArrange = fmetadata.AffectsParentArrange;
                    boolean affectsMeasure = fmetadata.AffectsMeasure; 
                    boolean affectsArrange = fmetadata.AffectsArrange;
    ...
    // 
    /*internal*/ public static DependencyObject GetFrameworkParent(Object current)
    {
    ...
    /*internal*/ static boolean GetFrameworkParent(FrameworkElement current, /*out*/ FrameworkElement feParent, /*out*/ FrameworkContentElement fceParent)
    {
    ...
    /*internal*/ static boolean GetFrameworkParent(FrameworkContentElement current, /*out*/ FrameworkElement feParent, /*out*/ FrameworkContentElement fceParent)
    { 
    ...
    /*internal*/ static boolean GetContainingFrameworkElement(DependencyObject current, /*out*/ FrameworkElement fe, /*out*/ FrameworkContentElement fce)
    { 
    ...
    /*internal*/ static void GetTemplatedParentChildRecord(
        ...
        /*out*/ boolean isChildRecordValid)
    { 
...
//                "If this node is the result of a VisualTree expansion then it should have a parent template");
    ...
    /*internal*/ /*virtual*/ void pushTextRenderingMode()
    {
        ...
        { 
            super.VisualTextRenderingMode = TextOptions.GetTextRenderingMode(this);
        } 
    } 

    /*internal*/ static final NumberSubstitution DefaultNumberSubstitution = new NumberSubstitution( 
    ...
    /*internal*/ /*virtual*/ protected void OnAncestorChanged()
    { 
    }
    ...
    protected /*internal*/ /*override*/ void OnVisualParentChanged(DependencyObject oldParent)
    {
        ...
        if (newParent != null && (newParent instanceof FrameworkElement) == false) 
        {
            ...
            else if (newParent instanceof Visual3D) 
            {
        ...
        { 
            ...
            else if (oldParent instanceof Visual3D)
            { 
...
//        Debug.Assert(fceParent == null, "Nearest framework parent via the visual tree has to be an FE. It cannot be an FCE"); 
    ...
    ///     changed.
    /// </remarks> 
    public /*internal*/ InheritanceBehavior InheritanceBehavior 
    {
        get 
        {
...
//            Debug.Assert((int)InternalFlags.InheritanceBehavior2 == 0x20); 
            ...
            final int inheritanceBehaviorMask = 
...
//            Debug.Assert((int)InternalFlags.InheritanceBehavior2 == 0x20);
    ...
    /// </summary> 
    /*internal*/ static final EventPrivateKey DataContextChangedKey = new EventPrivateKey();
...
//    [Localizability(LocalizationCategory.NeverLocalize)]
    ...
    ///     Returns new source
    /// </returns>
    /*internal*/ /*override*/public Object AdjustEventSource(RoutedEventArgs args)
    { 
        Object source = null;
    ...
    /*internal*/ /*virtual*/public void AdjustBranchSource(RoutedEventArgs args)
    { 
    } 
    ...
    /// </returns> 
    /*internal*/ /*override*/public boolean BuildRouteCore(EventRoute route, RoutedEventArgs args) 
    {
        return BuildRouteCoreHelper(route, args, true); 
    }
    /*internal*/public boolean BuildRouteCoreHelper(EventRoute route, RoutedEventArgs args, boolean shouldAddIntermediateElementsToRoute)
    {
        ...
        DependencyObject branchNode = (DependencyObject) 
        		(route.PeekBranchNode() instanceof DependencyObject ? route.PeekBranchNode() : null); 
    ...
    /// </summary>
    /*internal*/ /*override*/ public void AddToEventRouteCore(EventRoute route, RoutedEventArgs args) 
    {
...
//            Debug.Assert( feTemplatedParent != null ); 
    ...
    //CASRemoval:[StrongNameIdentityPermissionAttribute(SecurityAction.InheritanceDemand, PublicKey=Microsoft.Internal.BuildInfo.WCP_PUBLIC_KEY_STRING)]
    /*internal*/ /*virtual*/ boolean IgnoreModelParentBuildRoute(RoutedEventArgs args) 
    {
        return false;
    }

    /*internal*/ /*override*/ boolean InvalidateAutomationAncestorsCore(Stack<DependencyObject> branchNodeStack, /*out*/ boolean continuePastCoreTree)
    { 
        boolean shouldInvalidateIntermediateElements = true; 
    ...
    /*internal*/ boolean InvalidateAutomationAncestorsCoreHelper(Stack<DependencyObject> branchNodeStack, /*out*/ boolean continuePastCoreTree, boolean shouldInvalidateIntermediateElements)
    {
    ...
    /*internal*/ static boolean InvalidateAutomationIntermediateElements( 
    ...
    /// </summary> 
    public static final DependencyProperty LanguageProperty = 
...
//    [Localizability(LocalizationCategory.NeverLocalize)] 
    ...
    /// </summary>
    public static final RoutedEvent RequestBringIntoViewEvent = EventManager.RegisterRoutedEvent("RequestBringIntoView", RoutingStrategy.Bubble, typeof(RequestBringIntoViewEventHandler), _typeofThis);
    ...
    /// SizeChanged event
    /// </summary>
    public static final RoutedEvent SizeChangedEvent = EventManager.RegisterRoutedEvent("SizeChanged", RoutingStrategy.Direct, typeof(SizeChangedEventHandler), _typeofThis);
    ...
    /// </summary> 
    private static final DependencyPropertyKey ActualWidthPropertyKey = 
    ...
    /// </summary> 
    public static final DependencyProperty ActualWidthProperty =
    ...
    ///     The key needed set a read-only property.
    /// </summary> 
    private static final DependencyPropertyKey ActualHeightPropertyKey = 
            DependencyProperty.RegisterReadOnly(
                    "ActualHeight", 
                    typeof(Double),
                    _typeofThis,
    ...
    /// </summary> 
    public static final DependencyProperty ActualHeightProperty =
    ...
    /// </summary> 
    public static final DependencyProperty LayoutTransformProperty = DependencyProperty.Register(
                "LayoutTransform", 
                typeof(Transform), 
                _typeofThis,
                new FrameworkPropertyMetadata( 
    ...
    private static boolean IsWidthHeightValid(Object value) 
    { 
        double v = (double)value;
        return (DoubleUtil.IsNaN(v)) || (v >= 0.0d && !Double.IsPositiveInfinity(v)); 
    }

    private static boolean IsMinWidthHeightValid(Object value)
    { 
        double v = (double)value;
        return (!DoubleUtil.IsNaN(v) && v >= 0.0d && !Double.IsPositiveInfinity(v)); 
    } 

    private static boolean IsMaxWidthHeightValid(Object value) 
    {
        double v = (double)value;
    ...
    /// </summary> 
//    [CommonDependencyProperty] 
    public static final DependencyProperty WidthProperty =
                DependencyProperty.Register( 
                            "Width",
                            typeof(Double),
                            _typeofThis,
...
//    [Localizability(LocalizationCategory.None, Readability = Readability.Unreadable)]
    ...
    /// </summary>
//    [CommonDependencyProperty] 
    public static final DependencyProperty MinWidthProperty = 
                DependencyProperty.Register(
                            "MinWidth", 
                            typeof(Double),
                            _typeofThis,
...
//    [Localizability(LocalizationCategory.None, Readability = Readability.Unreadable)] 
    ...
    /// </summary> 
//    [CommonDependencyProperty]
    public static final DependencyProperty MaxWidthProperty = 
                DependencyProperty.Register( 
                            "MaxWidth",
                            typeof(Double), 
                            _typeofThis,
...
//    [Localizability(LocalizationCategory.None, Readability = Readability.Unreadable)] 
    ...
    /// </summary> 
//    [CommonDependencyProperty]
    public static final DependencyProperty HeightProperty = 
                DependencyProperty.Register( 
                            "Height",
                            typeof(Double), 
                            _typeofThis,
...
//    [Localizability(LocalizationCategory.None, Readability = Readability.Unreadable)]
    ...
    /// </summary>
//    [CommonDependencyProperty] 
    public static final DependencyProperty MinHeightProperty =
                DependencyProperty.Register( 
                            "MinHeight", 
                            typeof(Double),
                            _typeofThis, 
...
//    [Localizability(LocalizationCategory.None, Readability = Readability.Unreadable)]
    ...
    /// </summary>
//    [CommonDependencyProperty]
    public static final DependencyProperty MaxHeightProperty = 
                DependencyProperty.Register(
                            "MaxHeight", 
                            typeof(Double), 
                            _typeofThis,
...
//[Localizability(LocalizationCategory.None)]
    ...
    /// </summary> 
    private static boolean IsValidFlowDirection(Object o)
    { 
    ...
    /// </summary> 
//    [CommonDependencyProperty]
    public static final DependencyProperty MarginProperty 
    ...
    private static boolean IsMarginValid(Object value) 
    {
    ...
    /// </summary>
//    [CommonDependencyProperty]
    public static final DependencyProperty HorizontalAlignmentProperty = 
                DependencyProperty.Register(
                            "HorizontalAlignment", 
    ...
    /*internal*/ static boolean ValidateHorizontalAlignmentValue(Object value)
    { 
...
//    [CommonDependencyProperty]
    ...
    /*internal*/ static boolean ValidateVerticalAlignmentValue(Object value)
    {
    ...
    /*internal*/ static boolean ShouldApplyMirrorTransform(FrameworkElement fe) 
    { 
        ...
        else
        {
            FrameworkContentElement parentFCE; 
            FrameworkElement parentFE;
            boolean hasParent = GetFrameworkParent(fe, /*out*/ parentFE, /*out*/ parentFCE); 
            if (hasParent) 
            {
    ...
    /*internal*/ static boolean ApplyMirrorTransform(FlowDirection parentFD, FlowDirection thisFD)
    { 
    ...
    private Size FindMaximalAreaLocalSpaceRect(Transform layoutTransform, Size transformSpaceBounds) 
    {
        ...
        boolean xConstrInfinite = Double.IsInfinity(xConstr);
        boolean yConstrInfinite = Double.IsInfinity(yConstr); 
    ...
    protected /*sealed*/ /*override*/ Size MeasureCore(Size availableSize) 
    {
        ...
        boolean useLayoutRounding = this.UseLayoutRounding;
        ...
        else
        {
            ...
            if (useLayoutRounding && this instanceof ScrollContentPresenter) 
            {
    ...
    protected /*override*/ Geometry GetLayoutClip(Size layoutSlotSize) 
    {
        ...
        return super.GetLayoutClip(layoutSlotSize);
    } 
...
//    [EditorBrowsable(EditorBrowsableState.Advanced)] 
    ...
    /// </summary>
    /*internal*/ static final EventPrivateKey InitializedKey = new EventPrivateKey(); 
...
//    [EditorBrowsable(EditorBrowsableState.Advanced)]
    ...
    private static boolean ShouldUseSystemFont(FrameworkElement fe, DependencyProperty dp) 
    {
    ...
    /// </summary>
    /*internal*/public /*sealed*/ /*override*/ void OnPresentationSourceChanged(boolean attached) 
    {
        super.OnPresentationSourceChanged(attached); 
    ...
    ///     The key needed set a read-only property. 
    /// </summary> 
    /*internal*/ static final DependencyPropertyKey LoadedPendingPropertyKey =
                DependencyProperty.RegisterReadOnly( 
                            "LoadedPending",
                            typeof(Object[]),
                            _typeofThis,
    ...
    /// </summary> 
    /*internal*/ static final DependencyProperty LoadedPendingProperty =
        LoadedPendingPropertyKey.DependencyProperty;

    /// <summary> 
    ///     The key needed set a read-only property.
    /// </summary> 
    /*internal*/ static final DependencyPropertyKey UnloadedPendingPropertyKey = 
                DependencyProperty.RegisterReadOnly(
                            "UnloadedPending", 
                            typeof(Object[]),
                            _typeofThis,
    ...
    /// </summary>
    /*internal*/ static final DependencyProperty UnloadedPendingProperty = 
    ...
    ///     Loaded RoutedEvent
    /// </summary>
    public static final RoutedEvent LoadedEvent = EventManager.RegisterRoutedEvent("Loaded", RoutingStrategy.Direct, typeof(RoutedEventHandler), _typeofThis);
    ...
    /*internal*/public /*override*/ void OnAddHandler( 
        ...
        Delegate handler) 
    {
        super.OnAddHandler(routedEvent, handler);
    ...
    /*internal*/ /*override*/ void OnRemoveHandler(
        ...
        Delegate handler) 
    {
        super.OnRemoveHandler(routedEvent, handler); 
    ...
    /// </summary>
    public static final RoutedEvent UnloadedEvent = EventManager.RegisterRoutedEvent("Unloaded", RoutingStrategy.Direct, typeof(RoutedEventHandler), _typeofThis); 
    ...
    /*internal*/public /*override*/ void AddSynchronizedInputPreOpportunityHandlerCore(EventRoute route, RoutedEventArgs args) 
    { 
    ...
    private class FrameworkServices
    {
        ...
        /*internal*/public KeyboardNavigation _keyboardNavigation;
        /*internal*/public PopupControlService _popupControlService;
    }

    /*internal*/public static PopupControlService PopupControlService
    { 
        get 
        {
    ...
    /*internal*/ public static KeyboardNavigation KeyboardNavigation
    { 
        get 
        {
...
//    [Localizability(LocalizationCategory.ToolTip)]
    ...
    /// </summary> 
    public static final RoutedEvent ToolTipOpeningEvent = ToolTipService.ToolTipOpeningEvent.AddOwner(_typeofThis);
    ...
    /// </summary> 
    public static final RoutedEvent ToolTipClosingEvent = ToolTipService.ToolTipClosingEvent.AddOwner(_typeofThis);
    ...
    /// </summary>
    public static final RoutedEvent ContextMenuOpeningEvent = ContextMenuService.ContextMenuOpeningEvent.AddOwner(_typeofThis); 
    ...
    /// </summary> 
    public static final RoutedEvent ContextMenuClosingEvent = ContextMenuService.ContextMenuClosingEvent.AddOwner(_typeofThis);
    ...
    /*internal*/public static void AddIntermediateElementsToRoute( 
        DependencyObject mergePoint,
        EventRoute route, 
        RoutedEventArgs args,
        DependencyObject modelTreeNode)
    ...
    /*internal*/ boolean HasResourceReference
    {
    ...
    /*internal*/ boolean IsLogicalChildrenIterationInProgress
    { 
    ...
    /*internal*/ boolean InVisibilityCollapsedTree
    { 
    ...
    private boolean HasHeightEverChanged
    { 
    ...
    /*internal*/ boolean IsRequestingExpression
    { 
    ...
    /*internal*/ boolean BypassLayoutPolicies
    { 
    ...
    /*internal*/ boolean ReadInternalFlag(InternalFlags reqFlag) 
    {
        return (_flags & reqFlag) != 0; 
    } 

    /*internal*/ boolean ReadInternalFlag2(InternalFlags2 reqFlag) 
    {
    ...
    /*internal*/ void WriteInternalFlag(InternalFlags reqFlag, boolean set) 
    {
        if (set) 
        {
            _flags |= reqFlag;
    ...
    /*internal*/ void WriteInternalFlag2(InternalFlags2 reqFlag, boolean set)
    {
        if (set)
        { 
            _flags2 |= reqFlag;
    ...
    // 
    /*internal*/ /*override*/public int EffectiveValuesInitialSize 
    {
        get { return 7; } 
    }

    // Ratio of screen to layout DPI in x dimension
    /*internal*/public static double DpiScaleX 
    {
        get 
        { 
    ...
    /*internal*/public static double DpiScaleY
    { 
        get
        {
    ...
    // Layout 
    private static final UncommonField<SizeBox> UnclippedDesiredSizeField = new UncommonField<SizeBox>();
    private static final UncommonField<LayoutTransformData> LayoutTransformDataField = new UncommonField<LayoutTransformData>(); 

    // Style/Template state (internals maintained by Style, per-instance data in StyleDataField)
    private  Style       _styleCache;

    // Resources dictionary
    /*internal*/ static final UncommonField<ResourceDictionary> ResourcesField = new UncommonField<ResourceDictionary>(); 
...
/*internal*/ class LayoutDoubleUtil
{ 
    private final double eps = 0.00000153; //more or less random more or less small number 

    /*internal*/ static boolean AreClose(double value1, double value2) 
    {
    ...
    /*internal*/ static boolean LessThan(double value1, double value2)
    { 
        return (value1 < value2) && !AreClose(value1, value2);
    }
}

/*internal*/ enum InternalFlags // : int
{ 
...
//[Flags]
/*internal*/ enum InternalFlags2 //: int
{
