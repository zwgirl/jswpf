...
public abstract class MulticastDelegate extends Delegate
    {
        ...
        /*internal*/ public boolean IsUnmanagedFunctionPtr()
        {
        ...
        public /*override*/ void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            if (invocationList == null)
            {
                ...
                if (method instanceof System.Reflection.Emit.DynamicMethod || method is System.Reflection.Emit.DynamicMethod.RTDynamicMethod || IsUnmanagedFunctionPtr())
            ...
            else
            {
                ...
                int invocationCount = (Integer)_invocationCount;
...
//            BCLDebug.Assert(d != null && (_invocationList as Object[]) != null, "bogus delegate in multicast list comparison");
        ...
        private boolean TrySetSlot(Object[] a, int index, Object o)
        {
        ...
        /*internal*/ public MulticastDelegate NewMulticastDelegate(Object[] invocationList, int invocationCount, boolean thisIsMultiCastAlready)
        {
        ...
        /*internal*/ public MulticastDelegate NewMulticastDelegate(Object[] invocationList, int invocationCount)
        {
            return NewMulticastDelegate(invocationList, invocationCount, false);
        }
 
        /*internal*/ public void StoreDynamicMethod(MethodInfo dynamicMethod)
        {
            if (_invocationCount != (IntPtr)0)
            {
        ...
        private boolean EqualInvocationLists(Object[] a, Object[] b, int start, int count)
        {
        ...
        public static boolean operator ==(MulticastDelegate d1, MulticastDelegate d2)
        {
            if ((Object)d1 == null)
        ...
        /*internal*/ public /*override*/ Object GetTarget()
        {
            if (_invocationCount != (IntPtr)0)
            {
