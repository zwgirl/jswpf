...
import org.summer.view.widget.markup.XamlWriter;
...
import org.summer.view.widget.xaml.XamlReaderSettings;
import org.summer.view.widget.xaml.XamlSchemaContext;
import org.summer.view.widget.xaml.XamlType;

public class Baml2006Reader extends XamlReader implements IXamlLineInfo, IFreezeFreezables 
    { 
        private Baml2006ReaderSettings _settings;
        private boolean _isBinaryProvider; 
        ...
        private Dictionary<Integer, TypeConverter> _typeConverterMap = new Dictionary<Integer, TypeConverter>();
        ...
        private /*const*/static final Int16 ExtensionIdMask = 0x0FFF; 
        private /*const*/static final Int16 TypeExtensionValueMask = 0x4000;
        private /*const*/static final Int16 StaticExtensionValueMask = 0x2000; 

        private /*const*/static final sbyte ReaderFlags_AddedToTree = 0x02;
...
//        #region Constructors 
        ...
        /*internal*/ public Baml2006Reader(Stream stream, 
            Baml2006SchemaContext schemaContext, 
        ...
        /*internal*/ public Baml2006Reader(
            Stream stream, 
...
//        #region IXamlLineInfo Members
        ...
        boolean IXamlLineInfo.HasLineInfo
        { 
...
//        #region Internal Methods 
        ...
        /*internal*/ public List<KeyRecord> ReadKeys() 
        { 
        ...
        /*internal*/ public XamlReader ReadObject(KeyRecord record)
        { 
        ...
        /*internal*/ public Type GetTypeOfFirstStartObject(KeyRecord record)
        { 
            _context.CurrentKey = _context.KeyList.IndexOf(record);
...
//        #region Private Methods
        ...
        private boolean Process_BamlRecords()
        {
        ...
        private boolean Process_OneBamlRecord()
        { 
...
//                #endregion 
        ...
        { 
            ...
            boolean shouldInjectContentProperty = _context.CurrentFrame.Member == null;
        ...
        { 
            ...
            boolean shouldDropProperty = _context.CurrentFrame.Member == null; 
        ...
        private void Process_DefAttributeKeyString() 
        {
            ...
            boolean isShared = _binaryReader.ReadBoolean(); 
            boolean isSharedSet = _binaryReader.ReadBoolean();
        ...
        private boolean IsStringOnlyWhiteSpace(String value)
        { 
        ...
        private void Process_ElementStart() 
        {
            ...
            // 
            boolean isRetrieved = (flags & ReaderFlags_AddedToTree) > 0;
        ...
        private XamlMember GetProperty(Int16 propertyId, boolean isAttached)
        { 
        ...
        private boolean WriteTypeConvertedInstance(short converterId, int dataByteSize) 
        {
        ...
        private void Process_PropertyWithExtension() 
        {
            ...
            boolean isValueTypeExtension = (extensionId & TypeExtensionValueMask) == TypeExtensionValueMask;
            boolean isValueStaticExtension = (extensionId & StaticExtensionValueMask) == StaticExtensionValueMask; 
        ...
        private boolean NodeListHasAKeySetOnTheRoot(XamlReader reader)
        { 
            int depth = 0; 
            while (reader.Read())
            { 
