...
//    #region External API 
    ...
    /// </param> 
    public void Add(Object target, Delegate handler, boolean handledEventsToo)
    { 
        if (target == null)
        {
    ...
    /// </param>
    /*internal*/ public void InvokeHandlers(Object source, RoutedEventArgs args) 
    {
        InvokeHandlersImpl(source, args, false); 
    } 

    /*internal*/ public void ReInvokeHandlers(Object source, RoutedEventArgs args) 
    {
        InvokeHandlersImpl(source, args, true);
    }

    private void InvokeHandlersImpl(Object source, RoutedEventArgs args, boolean reRaised)
    { 
        if (source == null){
...
//    #region Operations 
    ...
    /*internal*/ public void AddSource(Object source)
    { 
