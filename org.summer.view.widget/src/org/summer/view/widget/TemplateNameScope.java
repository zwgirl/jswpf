...
/*internal*/ public class TemplateNameScope implements INameScope
{ 
//    #region Constructors
    ...
    /*internal*/ public TemplateNameScope(DependencyObject templatedParent) 
    ...
    /*internal*/ public TemplateNameScope(
                                DependencyObject templatedParent, 
                                List<DependencyObject> affectedChildren,
                                FrameworkTemplate frameworkTemplate ) 
    { 
//        Debug.Assert(templatedParent == null || (templatedParent instanceof FrameworkElement || templatedParent instanceof FrameworkContentElement),
...
//    #region INameScope
    ...
    public void /*INameScope.*/RegisterName(String name, Object scopedElement)
    { 
    ...
    /*internal*/ public void RegisterNameInternal(String name, Object scopedElement) 
    {
        FrameworkElement fe; 
    ...
    /// </summary>
    /// <param name="name">Name of the element</param> 
    public void /*INameScope.*/UnregisterName(String name)
    {
...
//    #endregion INameScope
    ...
    private boolean                   _isTemplatedParentAnFE;
