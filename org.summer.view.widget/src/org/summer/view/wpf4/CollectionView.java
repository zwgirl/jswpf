...
/// <summary>
    ...
    /// </summary>
    public class CollectionView extends DispatcherObject implements ICollectionView, INotifyPropertyChanged 
    {
        //----------------------------------------------------- 
        // 
        //  Constructors
...
//        #region Constructors
        ...
        /*internal*/ public CollectionView(IEnumerable collection, int moveToFirst) 
        {
            if (collection == null)
...
//            } 
        ...
        /*internal*/ public CollectionView(IEnumerable collection, boolean shouldProcessCollectionChanged) 
        { 
        	this(collection);
...
//        [TypeConverter(typeof(System.Windows.CultureInfoIetfLanguageTagConverter))]
        ...
        /// </summary> 
        public /*virtual*/ boolean CanSort
        { 
            get { return false; }
        }
        ...
        /*internal*/ public void RefreshInternal() 
        { 
            RefreshOverride();
        ...
        /// </summary>
        /// <remarks>
        /// Only wrapper classes (those that pass currency handling calls to another /*internal*/ public 
        ...
        /// </summary>
        public /*virtual*/ boolean IsCurrentAfterLast 
        {
            get
            {
                VerifyRefreshNotDeferred(); 
        ...
        /// </summary> 
        public /*virtual*/ boolean IsCurrentBeforeFirst
        { 
            get 
            {
                VerifyRefreshNotDeferred(); 
        ...
        public /*virtual*/ boolean MoveCurrentTo(Object item)
        {
            ...
            int index = -1;
            IEditableCollectionView ecv = this as IEditableCollectionView; 
            boolean isNewItem = (ecv != null && ecv.IsAddingNew && Object.Equals(item, ecv.CurrentAddItem)); 
        ...
        /// <returns>true if <seealso cref="CurrentItem"/> points to an item within the view.</returns> 
        public /*virtual*/ boolean MoveCurrentToPosition(int position)
        { 
            VerifyRefreshNotDeferred(); 
...
//        #region Public Methods
        ...
        /// </summary>
        public /*virtual*/ boolean PassesFilter(Object item)
        { 
...
//        #region Public Properties
        ...
        /// </summary>
        public /*virtual*/ boolean NeedsRefresh
        {
...
//        #region IPropertyChange implementation 
        ...
        /// <summary>
        /// PropertyChanged event (per <see cref="IPropertyChange" />).
        /// </summary> 
        ...
        /// <summary>
        /// Raises a PropertyChanged event (per <see cref="IPropertyChange" />). 
        /// </summary>
        ...
        { 
            ...
            boolean oldIsCurrentAfterLast = CheckFlag(CollectionViewFlags.IsCurrentAfterLast); 
            boolean oldIsCurrentBeforeFirst = CheckFlag(CollectionViewFlags.IsCurrentBeforeFirst);
        ...
        protected boolean OKToChangeCurrent()
        { 
        ...
        { 
            ...
            {
                boolean isDispatcherThread = CheckAccess(); 
                ...
                // if we have entered the correct UI thread dispatcher, and have never been 
                // updated from a different thread, then we can just directly process
                // the change. 
                if (isDispatcherThread && !UpdatedOutsideDispatcher == true) 
                {
        ...
        /// <summary>
        ///     Clear any pending changes from the changelog. 
        /// </summary> 
...
//        #region Protected Properties
        ...
        /// <summary>
        ///     Returns true if it has been necessary 
        ///     to add a change to the ChangeLog because a CollectionChange
        ///     notification has been received on a different thread without
        ///     first entering the UI thread dispatcher.
        /// </summary> 
        protected boolean UpdatedOutsideDispatcher
        { 
            get { return CheckFlag(CollectionViewFlags.UpdatedOutsideDispatcher); } 
        }
        ...
        /// </summary>
        protected boolean IsCurrentInSync
        {
            get 
            {
                if (IsCurrentInView) 
...
//        #region Internal Methods
        ...
        /// </remarks>
        /*internal*/ public void SetViewManagerData(Object value) 
        {
            Object[] array; 
        ...
        /*internal*/ public /*virtual*/ boolean HasReliableHashCodes() 
        { 
        ...
        /*internal*/ public void VerifyRefreshNotDeferred()
        { 
...
//            #pragma warning restore 1634, 1691
        ...
        /*internal*/ public void InvalidateEnumerableWrapper()
        {
        ...
        /*internal*/ public ReadOnlyCollection<ItemPropertyInfo> GetItemProperties()
        {
        ...
        /*internal*/ public Type GetItemType(boolean useRepresentativeItem)
        { 
        ...
        /*internal*/ public Object GetRepresentativeItem() 
        { 
            if (IsEmpty)
                return null; 
...
//        #region Internal Types 
        ...
        /*internal*/ public class PlaceholderAwareEnumerator : IEnumerator 
        {
...
//        #region Private Methods
        ...
        private void DeferProcessing(ICollection changeLog)
        {
            ...
            { 
                ...
                { 
                    ...
                    if (_dispatcherOperation != null && _dispatcherOperation.Priority == DispatcherPriority.DataBind)
                    {
                        _dispatcherOperation.Priority = DispatcherPriority.Input;
                    } 
                    else
                    { 
                        _dispatcherOperation = this.Dispatcher.BeginInvoke(DispatcherPriority.Input, new DispatcherOperationCallback(ProcessInvoke), null); 
                    }
                } 
            }
        }
        ...
        { 
            int currentIndex = 0;
            boolean mustDeferProcessing = false; 
            ...
            for ( ; currentIndex < changeLog.Count && !(mustDeferProcessing); currentIndex++) 
            {
                ...
                mustDeferProcessing = DateTime.Now.Ticks - beginTime > 1000000; // 100 milliseconds 
            }

            if (mustDeferProcessing)
            { 
        ...
        private boolean CheckFlag(CollectionViewFlags flags)
        { 
            return (_flags & flags) != 0; 
        }
 
        private void SetFlag(CollectionViewFlags flags, boolean value)
        {
            if (value)
            { 
                _flags = _flags | flags;
            ...
            lock(SyncRoot) 
            {
                lock(_changeLog.SyncRoot) 
                {
                    ...
                    { 
                        ...
                        _dispatcherOperation = Dispatcher.BeginInvoke( 
                        ...
                        if (!UpdatedOutsideDispatcher)
                        {
                            ...
                            SetFlag(CollectionViewFlags.UpdatedOutsideDispatcher, true); 
                        }
                    } 
                } 
            }
        ...
        { 
            ArrayList tempChangeLog;
            ICollection unprocessedChanges; 
            ...
            { 
                ...
                lock(_changeLog.SyncRoot)
                {
                    ...
                    tempChangeLog = _changeLog;
                    _changeLog = new ArrayList(); 
                } 
            }
 
            // if there is a refresh in the changelog, then the refresh
            // is the only thing that is interesting.
            foreach (NotifyCollectionChangedEventArgs args in tempChangeLog)
            { 
                if (args.Action == NotifyCollectionChangedAction.Reset)
                { 
                    tempChangeLog = new ArrayList(1); 
                    tempChangeLog.Add(args);
                    break; 
                }
            }

            unprocessedChanges = ProcessChangeLog(tempChangeLog); 
...
//        #region Private Types 
        ...
        { 
            ...
            public boolean Busy { get { return _entered; } } 
...
//        #region Private Fields 
        ...
        boolean                    _currentElementWasRemovedOrReplaced; 
        ...
        /*internal*/ public static readonly Object NoNewItem = new NamedObject("NoNewItem");
        ...
        /*internal*/ public /*const*/static final String CountPropertyName = "Count";
        /*internal*/ public /*const*/static final String IsEmptyPropertyName = "IsEmpty"; 
        /*internal*/ public /*const*/static final String CulturePropertyName = "Culture"; 
        /*internal*/ public /*const*/static final String CurrentPositionPropertyName = "CurrentPosition";
        /*internal*/ public /*const*/static final String CurrentItemPropertyName = "CurrentItem"; 
        /*internal*/ public /*const*/static final String IsCurrentBeforeFirstPropertyName = "IsCurrentBeforeFirst";
        /*internal*/ public co/*const*/static finalnst String IsCurrentAfterLastPropertyName = "IsCurrentAfterLast";
