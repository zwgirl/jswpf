...
//[FriendAccessAllowed] 
    /*internal*/ public class HwndWrapper extends DispatcherObject implements IDisposable
    {
        ///<SecurityNote>
...
//        [SecurityCritical] 
            ...
            HwndWrapperHook[] hooks)
        {
            ...
            _ownerThreadID = new SecurityCriticalDataForSet<Integer>(Thread.CurrentThread.ManagedThreadId);
...
//        } 
        ...
        // /*internal*/ public Dispose(boolean, boolean)
        /// <SecurityNote>
...
//        [SecurityTreatAsSafe, SecurityCritical] 
        private void Dispose(boolean disposing, boolean isHwndBeingDestroyed)
        { 
            if (_isDisposed)
            {
...
//        [SecurityCritical]
        ...
        /// </SecurityNote>
//        [SecurityCritical] 
        /*internal*/ public void AddHookLast(HwndWrapperHook hook)
        {
            if(_hooks == null)
            { 
                _hooks = new SecurityCriticalDataClass<WeakReferenceList>(new WeakReferenceList());
...
//        [SecurityCritical]
        private IntPtr WndProc(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref boolean handled) 
        {
            ...
            if(_hooks != null) 
            {
                for/*each*/(HwndWrapperHook hook : _hooks.Value) 
                {
        ...
        private void CheckForCreateWindowFailure( IntPtr result, boolean handled )
        {
        ...
        /// </SecurityNote>
//        [SecurityCritical] 
        /*internal*/ public static Object DestroyWindow(Object args)
        { 
        ...
        /// </SecurityNote>
//        [SecurityCritical]
        /*internal*/ public static Object UnregisterClass(Object arg) 
        {
        ...
        /*internal*/ public class DestroyWindowArgs
        { 
...
//        [SecurityCritical] 
        ...
        private boolean _isInCreateWindow = false;     // debugging variable (temporary)
