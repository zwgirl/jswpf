...
import org.summer.view.window.interop.HwndWrapperHook;
...
//    [FriendAccessAllowed] // Built into Base, also used by Framework 
    /*internal*/ public class HwndSubclass implements IDisposable
    { 
        /// <SecurityNote> 
...
//        [SecurityCritical]
        ...
        /// </SecurityNote> 
//        [SecurityCritical]
        /*internal*/ public HwndSubclass(HwndWrapperHook hook)
        {
            if(hook == null) 
            {
...
//        [SecurityCritical]
        ...
        /// </SecurityNote>
//        [SecurityCritical]
        private boolean DisposeImpl(boolean forceUnhook) 
        {
            _hook = null; 
...
//        [SecurityCritical, SecurityTreatAsSafe] 
        /*internal*/ public IntPtr Attach(IntPtr hwnd)
        {
            SecurityHelper.DemandUIWindowPermission();
        ...
        ///</SecurityNote>
//        [SecurityCritical] 
        /*internal*/ public boolean Detach(boolean force) 
        {
            SecurityHelper.DemandUIWindowPermission(); 
        ...
        ///</SecurityNote> 
//        [SecurityCritical]
        /*internal*/ public boolean CriticalDetach(boolean force) 
        {
            boolean detached;
        ...
        /// </SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe] 
        /*internal*/ public void RequestDetach(boolean force) 
        {
        ...
        /// </SecurityNote> 
//        [SecurityCritical, SecurityTreatAsSafe]
        /*internal*/ public static void RequestDetach(IntPtr hwnd, IntPtr subclass, boolean force) 
        {
            SecurityHelper.DemandUIWindowPermission();
            if(hwnd == IntPtr.Zero)
            { 
        ...
        ///</SecurityNote> 
//        [SecurityCritical] 
        /*internal*/ public IntPtr SubclassWndProc(IntPtr hwnd, Int32 msg, IntPtr wParam, IntPtr lParam)
        { 
...
//        [ThreadStatic] 
        ...
        {
            /*internal*/ public IntPtr hwnd, wParam, lParam, retVal; 
            /*internal*/ public int msg;
            /*internal*/ public boolean handled; 
        } 
        ...
        ///</SecurityNote> 
//        [ SecurityCritical ]
        /*internal*/ public IntPtr CriticalAttach( IntPtr hwnd ) 
        { 
            if(hwnd == IntPtr.Zero)
            { 
                throw new ArgumentNullException("hwnd");
...
//        [SecurityCritical]
        ...
        /// </SecurityNote>
//        [SecurityCritical]
        private boolean UnhookWindowProc(boolean force)
        { 
...
//        [SecurityCritical]
        ...
        /*internal*/ public static final WindowMessage DetachMessage; 
