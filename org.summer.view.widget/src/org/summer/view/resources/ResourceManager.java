...
//    [System.Runtime.InteropServices.ComVisible(true)] 
    ...
    { 
        ...
        /*internal*/ public class CultureNameResourceSetPair {
...
//        [NonSerialized]
        ...
        private boolean _ignoreCase;   // Whether case matters in GetString & GetObject
 
        private boolean UseManifest;  // Use Assembly manifest, or grovel disk. 

        // unused! But need to keep for serialization 
//        [OptionalField(VersionAdded = 1)]
        private boolean UseSatelliteAssem;  // Are all the .resources files in the
                  // main assembly, or in satellite assemblies for each culture?
//#if FEATURE_SPLIT_RESOURCES 
        private boolean _isDebugSatellite;
...
//#if RESOURCE_SATELLITE_CONFIG 
        ...
        private static volatile boolean _checkedConfigFile;  // Did we read the app's config file?
//#endif
...
//        [NonSerialized] 
        ...
        public static final int HeaderVersionNumber = 1; 
        ...
        //Assembly (or at least make it an /*internal*/ public property) we should be able to circumvent this problem. 
        //
        //      private static CultureInfo _neutralCulture = null; 

        // This is our min required ResourceSet type.
        private static final Type _minResourceSet = typeof(ResourceSet);
        ...
        // InternalResGen. 
        /*internal*/ public static final String ResReaderTypeName = typeof(ResourceReader).FullName; 
        /*internal*/ public static final String ResSetTypeName = typeof(RuntimeResourceSet).FullName;
        /*internal*/ public static final String MscorlibName = typeof(ResourceReader).Assembly.FullName; 
        /*internal*/ public /*const*/ static final String ResFileExtension = ".resources";
        /*internal*/ public /*const*/ static final int ResFileExtensionLength = 10;

        // My private debugging aid.  Set to 5 or 6 for verbose output.  Set to 3 
        // for summary level information.
        /*internal*/ public static final int DEBUG = 0; //Making this const causes C# to consider all of the code that it guards unreachable. 
 
        private static volatile boolean s_IsAppXModel;
...
//        [MethodImplAttribute(MethodImplOptions.NoInlining)] // Methods containing StackCrawlMark local var have to be marked non-inlineable 
        public ResourceManager(String baseName, Assembly assembly) 
        {
            ...
            // breaking changes to mscorlib's /*internal*/ public resources without
...
//#if FEATURE_SPLIT_RESOURCES 
        /*internal*/ public ResourceManager(String baseName, Assembly assembly, boolean isDebugSatellite) : this(baseName, assembly) {
...
//#endif 
        ...
        public /*virtual*/ boolean IgnoreCase {
...
//#endif 
            ...
            /*lock*/synchronized(localResourceSets) { 
...
//        [ResourceConsumption(ResourceScope.Machine)] 
        ...
        /*internal*/ public ResourceSet GetFirstResourceSet(CultureInfo culture)
        { 
            ...
            if(_lastUsedResourceCache != null) {
                /*lock*/ synchronized(_lastUsedResourceCache) {
...
//        [ResourceExposure(ResourceScope.None)] 
//        [ResourceConsumption(ResourceScope.Machine, ResourceScope.Machine)] 
        private ResourceSet InternalGetResourceSet(CultureInfo requestedCulture, boolean createIfNotExists, 
        		boolean tryParents, /*ref*/ StackCrawlMark stackMark)
        { 
            Dictionary<String, ResourceSet> localResourceSets = _resourceSets;
            ResourceSet rs = null;
...
//        [System.Security.SecuritySafeCritical]  // auto-generated 
        ...
        // IGNORES VERSION
        /*internal*/ public static boolean CompareNames(String asmTypeName1, 
                                          String typeName2,
...
//        [SecurityCritical]
        /*internal*/ public static WindowsRuntimeResourceManagerBase GetWinRTResourceManager()
        {
...
//        [NonSerialized] 
        private boolean _bUsingModernResourceManagement; // Written only by SetAppXConfiguration
...
//        [NonSerialized]
        private boolean _PRIonAppXInitialized; // Written only by SetAppXConfiguration 
...
//#if !FEATURE_CORECLR 
            ...
            boolean bUsingSatelliteAssembliesUnderAppX = false; 
            ...
            if (resourcesAssembly != null) 
            {
                if (resourcesAssembly != typeof(Object).Assembly) // We are not loading resources for mscorlib 
                {
                    ...
                    if (AppDomain.IsAppXModel() && !AppDomain.IsAppXNGen) 
                    {
                        ...
                        boolean bWRRM_Initialized = false; 
...
//        [System.Security.SecurityCritical]  // auto-generated 
        private boolean TryLookingForSatellite(CultureInfo lookForCulture) 
        {
...
//#if FEATURE_FUSION 
            ...
            // Use /*internal*/ public methods to bypass security checks.
...
//#endif  // RESOURCE_SATELLITE_CONFIG
        ...
        /*internal*/ public class ResourceManagerMediator
        { 
            private ResourceManager _rm;
 
            /*internal*/ public ResourceManagerMediator(ResourceManager rm) 
            {
                if (rm == null) 
                {
...
//#endif
            ...
            // with it for compat.
            /*internal*/ public String BaseName
            {
...
//#if RESOURCE_SATELLITE_CONFIG
//            [System.Security.SecurityCritical]  // auto-generated 
            /*internal*/ public boolean TryLookingForSatellite(CultureInfo lookForCulture)
            {
