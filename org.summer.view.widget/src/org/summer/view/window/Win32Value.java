...
import org.summer.view.window.FOF.MF;
...
//    #region SafeHandles
    ...
    /*internal*/ /*sealed*/ class SafeFindHandle extends SafeHandleZeroOrMinusOneIsInvalid 
    {
        /// <SecurityNote> 
...
//        [SecurityCritical]
    ...
    /// </SecurityNote>
//    [SecurityCritical]
    /*internal*/ /*sealed*/ class SafeDC extends SafeHandleZeroOrMinusOneIsInvalid
    { 
...
//    [StructLayout(LayoutKind.Sequential)]
    ...
    // Win7 only.
//    [StructLayout(LayoutKind.Sequential)] 
    /*internal*/ class CHANGEFILTERSTRUCT
    { 
        public uint cbSize; 
...
//    [StructLayout(LayoutKind.Sequential, Pack=1)]
    /*internal*/ class DWM_TIMING_INFO
    { 
        public int cbSize;
...
//    #endregion
    ...
    /// <summary>Delegate declaration that matches native WndProc signatures.</summary> 
    /*internal*/ delegate IntPtr WndProcHook(IntPtr hwnd, WM uMsg, IntPtr wParam, IntPtr lParam, /*ref*/ boolean handled);
 
    /// <summary>Delegate declaration that matches managed WndProc signatures.</summary>
    /*internal*/ delegate IntPtr MessageHandler(WM uMsg, IntPtr wParam, IntPtr lParam, /*out*/ boolean handled);
...
//        [return: MarshalAs(UnmanagedType.Bool)] 
        private static /*extern*/ boolean _AdjustWindowRectEx(/*ref*/ RECT lpRect, WS dwStyle, [MarshalAs(UnmanagedType.Bool)] boolean bMenu, WS_EX dwExStyle);
 
        /// <SecurityNote> 
        ///   Critical : Calls critical method
        /// </SecurityNote> 
//        [SecurityCritical]
        public static RECT AdjustWindowRectEx(RECT lpRect, WS dwStyle, boolean bMenu, WS_EX dwExStyle)
        {
...
//        [return: MarshalAs(UnmanagedType.Bool)]
        private static /*extern*/ boolean _ChangeWindowMessageFilter(WM message, MSGFLT dwFlag);
...
//        [return: MarshalAs(UnmanagedType.Bool)]
        private static /*extern*/ boolean _ChangeWindowMessageFilterEx(IntPtr hwnd, WM message, MSGFLT action, [In, Out, Optional] /*ref*/ CHANGEFILTERSTRUCT pChangeFilterStruct);
...
//        [return: MarshalAs(UnmanagedType.Bool)]
        private static /*extern*/ boolean _DwmIsCompositionEnabled();
...
//        [DllImport("dwmapi.dll", EntryPoint = "DwmGetColorizationColor", PreserveSig = true)]
        private static /*extern*/ HRESULT _DwmGetColorizationColor(/*out*/ uint pcrColorization, [Out, MarshalAs(UnmanagedType.Bool)] /*out*/ boolean pfOpaqueBlend);

        /// <SecurityNote> 
        ///   Critical : Calls critical method
        /// </SecurityNote> 
//        [SecurityCritical] 
        public static boolean DwmGetColorizationColor(/*out*/ uint pcrColorization, /*out*/ boolean pfOpaqueBlend)
        { 
...
//        [return: MarshalAs(UnmanagedType.Bool)]
        public static /*extern*/ boolean DwmDefWindowProc(IntPtr hwnd, WM msg, IntPtr wParam, IntPtr lParam, /*out*/ IntPtr plResult); 
...
//        [SecurityCritical] 
//        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        public static void DwmSetWindowAttributeDisallowPeek(IntPtr hwnd, boolean disallowPeek) 
        { 
...
//        [return: MarshalAs(UnmanagedType.Bool)]
        private static /*extern*/ boolean _RemoveMenu(IntPtr hMenu, uint uPosition, uint uFlags); 
...
//        [return: MarshalAs(UnmanagedType.Bool)] 
        private static /*extern*/ boolean _DrawMenuBar(IntPtr hWnd);
...
//        [return: MarshalAs(UnmanagedType.Bool)]
        public static /*extern*/ boolean FindClose(IntPtr handle); 
...
//        [return: MarshalAs(UnmanagedType.Bool)] 
        public static /*extern*/ boolean FindNextFileW(SafeFindHandle hndFindFile, [In, Out, MarshalAs(UnmanagedType.LPStruct)] WIN32_FIND_DATAW lpFindFileData);
...
//        [return: MarshalAs(UnmanagedType.Bool)] 
        private static /*extern*/ boolean _GetClientRect(IntPtr hwnd, [Out] /*out*/ RECT lpRect);
...
//        [return: MarshalAs(UnmanagedType.Bool)]
        public static /*extern*/ boolean IsThemeActive(); 
...
//        [return: MarshalAs(UnmanagedType.Bool)]
        private static /*extern*/ boolean _GetMonitorInfo(IntPtr hMonitor, [In, Out] MONITORINFO lpmi);
...
//        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")] 
//        [DllImport("user32.dll")]
        public static /*extern*/ IntPtr GetSystemMenu(IntPtr hWnd, [MarshalAs(UnmanagedType.Bool)] boolean bRevert);
...
//        [return: MarshalAs(UnmanagedType.Bool)]
        private static /*extern*/ boolean _GetWindowRect(IntPtr hWnd, /*out*/ RECT lpRect); 
...
//        [return: MarshalAs(UnmanagedType.Bool)]
        private static /*extern*/ boolean _PostMessage(IntPtr hWnd, WM Msg, IntPtr wParam, IntPtr lParam); 
...
//        [return: MarshalAs(UnmanagedType.Bool)]
        private static /*extern*/ boolean _SetProcessWorkingSetSize(IntPtr hProcess, IntPtr dwMinimiumWorkingSetSize, IntPtr dwMaximumWorkingSetSize);
...
//        [DllImport("user32.dll", EntryPoint = "SetWindowRgn", SetLastError = true)]
        private static /*extern*/ int _SetWindowRgn(IntPtr hWnd, IntPtr hRgn, [MarshalAs(UnmanagedType.Bool)] boolean bRedraw);
...
//        [SecurityCritical]
//        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")] 
        public static void SetWindowRgn(IntPtr hWnd, IntPtr hRgn, boolean bRedraw)
        {
...
//        [return: MarshalAs(UnmanagedType.Bool)] 
        private static /*extern*/ boolean _SetWindowPos(IntPtr hWnd, IntPtr hWndInsertAfter, int x, int y, int cx, int cy, SWP uFlags);
...
//        [SecurityCritical] 
//        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        public static boolean SetWindowPos(IntPtr hWnd, IntPtr hWndInsertAfter, int x, int y, int cx, int cy, SWP uFlags) 
        { 
...
//        [return: MarshalAs(UnmanagedType.Bool)]
        private static /*extern*/ boolean _SystemParametersInfo_String(SPI uiAction, int uiParam, [MarshalAs(UnmanagedType.LPWStr)] string pvParam, SPIF fWinIni); 
...
//        [return: MarshalAs(UnmanagedType.Bool)] 
        private static /*extern*/ boolean _SystemParametersInfo_NONCLIENTMETRICS(SPI uiAction, int uiParam, [In, Out] /*ref*/ NONCLIENTMETRICS pvParam, SPIF fWinIni);
...
//        [DllImport("user32.dll", EntryPoint = "SystemParametersInfoW", SetLastError = true, CharSet = CharSet.Unicode)] 
//        [return: MarshalAs(UnmanagedType.Bool)]
        private static /*extern*/ boolean _SystemParametersInfo_HIGHCONTRAST(SPI uiAction, int uiParam, [In, Out] /*ref*/ HIGHCONTRAST pvParam, SPIF fWinIni); 
...
//        [return: MarshalAs(UnmanagedType.Bool)] 
        private static /*extern*/ boolean _UnregisterClassAtom(IntPtr lpClassName, IntPtr hInstance);
...
//        [return: MarshalAs(UnmanagedType.Bool)] 
        private static /*extern*/ boolean _UnregisterClassName(string lpClassName, IntPtr hInstance);
...
//        [return: MarshalAs(UnmanagedType.Bool)] 
        private static /*extern*/ boolean _UpdateLayeredWindow(
            IntPtr hwnd, 
            SafeDC hdcDst,
            [In] /*ref*/ POINT pptDst,
            [In] /*ref*/ SIZE psize,
...
//        [DllImport("user32.dll", SetLastError = true, EntryPoint = "UpdateLayeredWindow")] 
//        [return: MarshalAs(UnmanagedType.Bool)] 
        private static /*extern*/ boolean _UpdateLayeredWindowIntPtr(
            IntPtr hwnd, 
            IntPtr hdcDst,
            IntPtr pptDst,
            IntPtr psize,
...
//        [return: MarshalAs(UnmanagedType.Bool)] 
        public static /*extern*/ boolean Shell_NotifyIcon(NIM dwMessage, [In] NOTIFYICONDATA lpdata);
