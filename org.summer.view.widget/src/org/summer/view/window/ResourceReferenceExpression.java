...
/*internal*/ public class ResourceReferenceExpression extends Expression
{ 
    /// <summary> 
    ...
    /// </remarks> 
    /*internal*/ public Object GetRawValue(DependencyObject d, /*out*/ Object source, DependencyProperty dp)
    { 
        ...
        { 
            ...
            {
//                Debug.Assert(_targetObject == d, "TargetObject that this expression is attached to must be" +
//                		" the same as the one on which its value is being queried");
    ...
    /// <param name="d">DependencyObject being set</param>
    /// <param name="dp">Property being set</param>
    /*internal*/ public /*override*/ void OnAttach(DependencyObject d, DependencyProperty dp)
    { 
        _targetObject = d;
        _targetProperty = dp; 
    ...
    /*internal*/ public /*override*/ void OnDetach(DependencyObject d, DependencyProperty dp) 
    {
        // Invalidate all the caches 
        InvalidateMentorCache();

        if (!(_targetObject instanceof FrameworkElement) && !(_targetObject instanceof FrameworkContentElement))
        { 
    ...
    ///     3. ResourceDictionary changes
    /// </summary>
    /*internal*/ public void InvalidateExpressionValue(Object sender, EventArgs e) 
    {
    ...
    // work 
    /*internal*/ public void OnDeferredResourceInflated(DeferredResourceReference deferredResourceReference)
    {
        if (ReadInternalState(InternalState.IsListeningForInflated))
        { 
    ...
    private boolean ReadInternalState(InternalState reqFlag) 
    { 
    ...
    private void WriteInternalState(InternalState reqFlag, boolean set) 
    {
        if (set) 
        { 
            _state |= reqFlag;
...
//    #region ResourceReferenceExpressionWeakContainer 
    ...
    /// </summary> 
    private class ResourceReferenceExpressionWeakContainer extends WeakReference
    {
