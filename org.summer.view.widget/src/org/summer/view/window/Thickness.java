...
public class Thickness implements IEquatable<Thickness> 
{
    //------------------------------------------------------------------- 
    //
    //  Constructors
...
//    #region Public Methods
    ...
    /// </summary>
    /// <returns>String conversion.</returns> 
    /*internal*/public String ToString(CultureInfo cultureInfo)
    {
        return ThicknessConverter.ToString(this, cultureInfo);
    } 

    /*internal*/public boolean IsZero 
    { 
        get
        { 
    ...
    /*internal*/public boolean IsUniform
    { 
        get
        {
    ...
    /*internal*/ public boolean IsValid(boolean allowNegative, boolean allowNaN, boolean allowPositiveInfinity, boolean allowNegativeInfinity) 
    {
        if(!allowNegative)
        {
    ...
    /*internal*/public boolean IsClose(Thickness thickness) 
    {
    ...
    static /*internal*/public boolean AreClose(Thickness thickness0, Thickness thickness1)
    {
