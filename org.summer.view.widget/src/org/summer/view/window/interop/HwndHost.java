...
import org.summer.view.widget.SourceChangedEventArgs;
...
//        [ SecurityCritical ] 
        ...
        ///</SecurityNote>
//        [SecurityCritical] 
        /*internal*/ public HwndHost(boolean fTrusted )
        { 
            Initialize( fTrusted ) ; 
        }
...
//        [SecurityCritical, SecurityTreatAsSafe]
        ...
        { 
            ...
            boolean handled = ((IKeyboardInputSink)this).TranslateAccelerator(/*ref*/ msg, modifiers);
...
//#pragma warning suppress 6519 
        ...
        /// </SecurityNote>
//        [ SecurityCritical ] 
        protected /*virtual*/ IntPtr WndProc(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref boolean handled) 
        {
            DemandIfUntrusted(); 
...
//        [ SecurityCritical, SecurityTreatAsSafe ]
        ...
        /// </remarks> 
        /*internal*/ public /*override*/ DrawingGroup GetDrawing() 
        {
        ...
        /// </summary>
        /*internal*/ public /*override*/ Rect GetContentBounds() 
        { 
...
//        [SecurityCritical, SecurityTreatAsSafe] 
                        ...
                        { 
                            ...
                            if(hBitmap.Handle != IntPtr.Zero) 
                            {
                                ...
                                try
                                {
                                    ...
                                    boolean result = UnsafeNativeMethods.CriticalPrintWindow(_hwnd, hdcBitmap, 0);
                                    if(result == false)
                                    {
        ...
        ///</SecurityNote>
//        [ SecurityCritical ]
        private void Initialize( boolean fTrusted ) 
        {
            _fTrusted = new SecurityCriticalDataForSet<Boolean> ( fTrusted ) ; 
...
//        [SecurityCritical, SecurityTreatAsSafe] 
        private void OnEnabledChanged(Object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            boolean boolNewValue = (boolean)e.NewValue;
...
//        [SecurityCritical,SecurityTreatAsSafe]
        private void OnVisibleChanged(Object sender, DependencyPropertyChangedEventArgs e) 
        {
            ...
            boolean vis = (boolean)e.NewValue; 
...
//            [SecurityCritical] 
        ...
        ///</SecurityNote>
//        [ SecurityCritical ] 
        private IntPtr SubclassWndProc(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref boolean handled) 
        {
            IntPtr result = IntPtr.Zero ; 
...
//        [ SecurityCritical ] 
        ...
        private SecurityCriticalDataForSet<boolean> _fTrusted ;

        private boolean _isBuildingWindow = false;
