...
import org.summer.view.widget.input.IMouseInputProvider;
...
import org.summer.view.widget.input.MouseDevice;
import org.summer.view.widget.input.RawMouseActions;
...
/*internal*/ public /*sealed*/ class HwndMouseInputProvider extends DispatcherObject implements IMouseInputProvider, IDisposable 
    {
        /// <SecurityNote>
        ///     Accesses and store critical data. This class is also critical (_site,_source)
        /// </SecurityNote> 
//        [SecurityCritical]
        /*internal*/ public HwndMouseInputProvider(HwndSource source) 
        { 
...
//        [SecurityCritical,SecurityTreatAsSafe] 
        ...
        /// </SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe] 
        public boolean /*IInputProvider.*/ProvidesInputForRootVisual(Visual v) 
        {
            Debug.Assert(null != _source && null != _source.Value); 
        ...
        /// </SecurityNote> 
//        [SecurityCritical, SecurityTreatAsSafe]
        public void /*IInputProvider.*/NotifyDeactivate()
        {
            if(_active) 
            {
                StopTracking(_source.Value.CriticalHandle); 
        ...
        /// </SecurityNote> 
//        [SecurityCritical,SecurityTreatAsSafe]
        public boolean /*IMouseInputProvider.*/SetCursor(Cursor cursor) 
        {
        ...
        /// </SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe]
        public boolean /*IMouseInputProvider.*/CaptureMouse() 
        {
            if(_isDwmProcess) 
            { 
                return true;
        ...
        /// </SecurityNote> 
//        [SecurityCritical, SecurityTreatAsSafe]
        public void /*IMouseInputProvider.*/ReleaseMouseCapture() 
        { 
            // MITIGATION_SETCURSOR
            _haveCapture = false; 
        ...
        /// </SecurityNote>
//        [SecurityCritical,SecurityTreatAsSafe] 
        public int /*IMouseInputProvider.*/GetIntermediatePoints(IInputElement relativeTo, Point[] points)
        {
        ...
        /// </SecurityNote>
//        [SecurityCritical]
        /*internal*/ public IntPtr FilterMessage(IntPtr hwnd, WindowMessage msg, IntPtr wParam, IntPtr lParam, /*ref*/ boolean handled)
        { 
        ...
        /// </SecurityNote> 
//        [SecurityCritical]
        private void PossiblyDeactivate(IntPtr hwndCapture, boolean stillActiveIfOverSelf)
        {
            ...
            boolean deactivate = !IsOurWindow(hwndToCheck);
...
//        [SecurityCritical, SecurityTreatAsSafe]
        ...
        private boolean _tracking; // Whether or not we have called TrackMouse() to get a WM_MOUSELEAVE.  This essentaully means IsOver.
        private boolean _active; // Whether or not the mouse is actively sending events to the input manager. 

        // MITIGATION_SETCURSOR
        private SetCursorState _setCursorState; // Have we received a WM_SETCURSOR message lately?
        private boolean _haveCapture; // Do we currently have capture? 
        private DispatcherOperation _queryCursorOperation;
 
        private boolean _isDwmProcess; // If we are the DWM, we need to always be _active, don't track focus. 
