...
import org.summer.view.w32.HwndWrapper;
...
import org.summer.view.widget.input.ObjectDisposedException;
...
import org.summer.view.widget.media.CompositionTarget;
...
/// <summary>
    ...
    /// </summary>
    public class HwndSource extends PresentationSource implements IDisposable, IWin32Window, IKeyboardInputSink
    {
        /// <SecurityNote> 
...
//        [SecurityCritical] 
        public HwndSource(int classStyle,
                          ...
                          String name,
                          IntPtr parent, 
                          boolean adjustSizingForNonClientArea)
        { 
            SecurityHelper.DemandUIWindowPermission(); 
...
//        [SecurityCritical ]
        ...
        /// </SecurityNote>
//        [SecurityCritical] 
        /*internal*/ public /*override*/ IInputProvider GetInputProvider(Type inputDevice) 
        {
        ...
        /// </summary> 
        public /*override*/ boolean IsDisposed {get {return _isDisposed;}} 
...
//            [SecurityCritical]
            set
            {
                if (_rootVisual.Value != value) 
                {
                    ...
                    { 
                        ...
                        if(_rootVisual.Value instanceof UIElement)
                        { 
                    ...
                    if(oldRoot != null) 
                    { 
                        if(oldRoot instanceof UIElement)
                        { 
        ...
        public IEnumerable<IKeyboardInputSink> ChildKeyboardInputSinks 
        {
            ...
            { 
                ...
                { 
                    for/*each*/ (IKeyboardInputSite site : _keyboardInputSinkChildren)
...
//        [SecurityCritical]
        ...
        ///    This function is only for /*internal*/ public consumption
        /// </SecurityNote> 
//        [SecurityCritical]
        /*internal*/ public static HwndSource CriticalFromHwnd(IntPtr hwnd) 
        { 
            if (hwnd == IntPtr.Zero)
            { 
...
//        [SecurityCritical]
        ...
        /// </SecurityNote>
//        [SecurityCritical, SecurityTreatAsSafe]
        /*internal*/ public /*override*/ void OnEnterMenuMode()
        { 
        ...
        /// </SecurityNote> 
//        [SecurityCritical, SecurityTreatAsSafe]
        /*internal*/ public /*override*/ void OnLeaveMenuMode() 
        {
            if(IsInExclusiveMenuMode)
            {
                Debug.Assert(_weakMenuModeMessageHandler != null); 
        ...
        /*internal*/ public boolean IsInExclusiveMenuMode{get; private set;}
...
//        [SecurityCritical, SecurityTreatAsSafe] 
        ...
        /// </SecurityNote> 
//        [SecurityCritical]
        /*internal*/ public void ShowSystemMenu() 
        {
        ...
        /// </SecurityNote> 
//        [SecurityCritical, SecurityTreatAsSafe]
        /*internal*/ public Point TransformToDevice(Point pt) 
        { 
            //
        ...
        /// </SecurityNote> 
//        [SecurityCritical, SecurityTreatAsSafe] 
        /*internal*/ public Point TransformFromDevice(Point pt)
        { 
...
//            [SecurityCritical]
        ...
        /// </SecurityNote> 
        /*internal*/ public HwndWrapper HwndWrapper
        { 
//            [SecurityCritical]
        ...
        /// </SecurityNote> 
        /*internal*/ public boolean HasCapture
        {
//            [SecurityCritical, SecurityTreatAsSafe]
            get 
            {
        ...
        ///</SecurityNote> 
        /*internal*/ public boolean IsHandleNull 
        {
//            [SecurityCritical, SecurityTreatAsSafe ] 
            get
            {
...
//        [SecurityCritical, SecurityTreatAsSafe]
        ...
        { 
            ...
            /*const*/ final EventTrace.Keyword etwKeywords = EventTrace.Keyword.KeywordLayout | EventTrace.Keyword.KeywordPerf;
            boolean etwEnabled = EventTrace.IsEnabled(etwKeywords, EventTrace.Level.Info);
            long  ctxHashCode = 0; 
...
//        [SecurityCritical, SecurityTreatAsSafe] 
        ...
        /// </SecurityNote> 
//        [SecurityCritical]
        private IntPtr HwndTargetFilterMessage(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, /*ref*/ boolean handled)
        {
        ...
        /// </SecurityNote> 
//        [SecurityCritical]
        private IntPtr LayoutFilterMessage(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, /*ref*/ boolean handled) 
        {
            IntPtr result = IntPtr.Zero ;
            ...
            if(!handled && (_constructionParameters != null || IsUsable)) 
            {
                ...
                boolean usesPerPixelOpacity = _constructionParameters != null ? ((HwndSourceParameters)_constructionParameters).UsesPerPixelOpacity : _hwndTarget.UsesPerPixelOpacity;
        ...
        { 
            ...
            { 
                ...
                else 
                {
                    ...
                    boolean sizeToWidth = (SizeToContent == SizeToContent.Height) ? false : true; 
                    boolean sizeToHeight = (SizeToContent == SizeToContent.Width) ? false : true;
...
//        [SecurityCritical, SecurityTreatAsSafe] 
        ...
        /// </SecurityNote>
//        [SecurityCritical]
        private IntPtr InputFilterMessage(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, /*ref*/ boolean handled)
        { 
            IntPtr result = IntPtr.Zero ;
            WindowMessage message = (WindowMessage)msg; 
        ...
        private IntPtr PublicHooksFilterMessage(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, /*ref*/ boolean handled) 
        {
            ...
            if (_hooks != null) 
            {
                ...
                for (int i = handlers.Length -1; i >= 0; --i) 
                {
                	HwndSourceHook hook = (HwndSourceHook)handlers[i]; 
...
//#region IKeyboardInputSink
        ...
        /// </SecurityNote>
//        [SecurityCritical] 
        private void OnPreprocessMessageThunk(/*ref*/ MSG msg, /*ref*/ boolean handled)
        { 
//             VerifyAccess(); 
...
//        [SecurityCritical, UIPermissionAttribute(SecurityAction.LinkDemand, Unrestricted=true)]
        ...
        /// </SecurityNote>
//        [SecurityCritical, UIPermissionAttribute(SecurityAction.LinkDemand, Unrestricted=true)]
        protected /*virtual*/ boolean TranslateAcceleratorCore(/*ref*/ MSG msg, ModifierKeys modifiers)
        { 
...
//        [SecurityCritical] 
        ...
        /// </summary> 
        protected /*virtual*/ boolean TabIntoCore(TraversalRequest request)
        { 
...
//            [SecurityCritical]
        ...
        /// </SecurityNote>
//        [SecurityCritical, UIPermissionAttribute(SecurityAction.LinkDemand, Unrestricted=true)]
        protected /*virtual*/ boolean OnMnemonicCore(/*ref*/ MSG msg, ModifierKeys modifiers)
        { 
//             VerifyAccess();
            SecurityHelper.DemandUnmanagedCode(); 
            switch((WindowMessage)msg.message) 
...
//        [SecurityCritical]
        ...
        /// </SecurityNote> 
//        [SecurityCritical, UIPermissionAttribute(SecurityAction.LinkDemand, Unrestricted=true)] 
        protected /*virtual*/ boolean TranslateCharCore(/*ref*/ MSG msg, ModifierKeys modifiers)
        { 
            SecurityHelper.DemandUnmanagedCode();
...
//        [SecurityCritical]
        ...
        /// 
        /// </summary> 
        protected virtual boolean HasFocusWithinCore()
        { 
            if(HasFocus)
            {
                return true;
            ...
            { 
                ...
                for/*each*/ (HwndSourceKeyboardInputSite site : _keyboardInputSinkChildren)
                {
        ...
        /// <summary> 
        public static boolean DefaultAcquireHwndFocusInMenuMode
        { 
            get
            {
        ...
        /// </SecurityNote>
//        [ SecurityCritical ] 
        /*internal*/ public void CriticalUnregisterKeyboardInputSink(HwndSourceKeyboardInputSite site)
        { 
            if(_isDisposed) 
                return;
...
//        [SecurityCritical, FriendAccessAllowed]
        /*internal*/ public boolean CriticalTranslateAccelerator(/*ref*/ MSG msg, ModifierKeys modifiers)
        { 
            switch ((WindowMessage)msg.message)
            { 
                case WindowMessage.WM_KEYUP: 
            ...
            else
            {
                ...
                boolean isExtendedKey = HwndKeyboardInputProvider.IsExtendedKey(msg.lParam); 
        ...
        /*internal*/ public static Object RestoreCharMessages(Object unused)
        {
            _eatCharMessages = false; 
            return null;
        } 
...
//#endregion IKeyboardInputSink
        ...
        /*internal*/ public boolean IsRepeatedKeyboardMessage(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam)
        {
...
//                 this.VerifyAccess();
                ...
                if (!_isDisposing) 
                {
                    ...
                    // before we dispose our /*internal*/ public stuff, in case the event 
...
//#pragma warning restore 56500
        ...
        private void CheckDisposed(boolean verifyAccess)
        {
            if(verifyAccess) 
            {
//                 this.VerifyAccess(); 
...
//#region WeakEventHandlers 
        ...
        private class WeakEventDispatcherShutdown extends WeakReference 
        { 
        ...
        private class WeakEventPreprocessMessage extends WeakReference
        {
            /// <SecurityNote> 
            ...
            /// </SecurityNote> 
//            [SecurityCritical]
            public WeakEventPreprocessMessage(HwndSource source, boolean addToFront)
            {
            	super(source);
            ...
            /// </SecurityNote>
//            [SecurityCritical] 
            public void OnPreprocessMessage(/*ref*/ MSG msg, /*ref*/ boolean handled)
            {
                HwndSource source = this.Target as HwndSource;
                if(null != source) 
                {
...
//#endregion WeakEventHandlers
        ...
        private boolean                        _inRealHwndDispose = false; 

        private boolean                        _adjustSizingForNonClientArea;
        private boolean                        _treatAncestorsAsNonClientArea;
 
        private boolean                        _myOwnUpdate;
        private boolean                        _isWindowInMinimizeState = false; 
...
//        [ThreadStatic] 
        private static boolean? _defaultAcquireHwndFocusInMenuMode; 
...
//        [SecurityCritical]
        ...
        //
//        [ThreadStatic]
        /*internal*/ public static boolean _eatCharMessages; // used from HwndKeyboardInputProvider
    } 