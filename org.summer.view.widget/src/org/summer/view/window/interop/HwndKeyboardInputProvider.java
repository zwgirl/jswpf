...
import org.summer.view.widget.input.IKeyboardInputProvider;
import org.summer.view.widget.input.InputManager;
import org.summer.view.widget.input.InputMode;
import org.summer.view.widget.input.InputProviderSite;
import org.summer.view.widget.input.Keyboard;
import org.summer.view.widget.input.ModifierKeys;
import org.summer.view.widget.input.RawKeyboardActions;
import org.summer.view.widget.input.RawKeyboardInputReport;
import org.summer.view.widget.input.RawTextInputReport;
...
/*internal*/ public /*sealed*/ class HwndKeyboardInputProvider extends  DispatcherObject implements IKeyboardInputProvider, IDisposable
{
    /// <SecurityNote>
    ///     Accesses and store critical data. This class is also critical (_site and _source) 
    /// </SecurityNote>
//    [SecurityCritical] 
    /*internal*/ public HwndKeyboardInputProvider(HwndSource source) 
    {
...
//    [SecurityCritical, SecurityTreatAsSafe] 
    ...
    /// </SecurityNote> 
//    [SecurityCritical,SecurityTreatAsSafe]
    boolean IInputProvider.ProvidesInputForRootVisual(Visual v) 
    { 
    ...
    /// </SecurityNote> 
//    [SecurityCritical] 
    boolean IKeyboardInputProvider.AcquireFocus(boolean checkOnly)
    { 
    ...
    /// </SecurityNote> 
//    [SecurityCritical]
    /*internal*/ public IntPtr FilterMessage(IntPtr hwnd, WindowMessage message, IntPtr wParam, IntPtr lParam, /*ref*/ boolean handled) 
    { 
...
//    [SecurityCritical] 
    ...
    { 
        ...
        { 
            ...
            // us a WM_SETFOCUS message BEFORE it has updated it's /*internal*/ public
            // /*internal*/ public keyboard state information.  When we get the 
    ...
    /// </SecurityNote>
//    [SecurityCritical]
    /*internal*/ public void ProcessKeyAction(/*ref*/ MSG msg, /*ref*/ boolean handled)
    { 
        ...
        try 
        {
            ...
            boolean isExtendedKey = IsExtendedKey(msg.lParam); 
            boolean isSystemKey = (((WindowMessage)msg.message == WindowMessage.WM_SYSKEYDOWN) || ((WindowMessage)msg.message == WindowMessage.WM_SYSKEYUP));
    ...
    ///</SecurityNote> 
//    [SecurityCritical ]
    /*internal*/ public void ProcessTextInputAction(IntPtr hwnd, WindowMessage msg, IntPtr wParam, IntPtr lParam, /*ref*/ boolean handled)
    {
        char charcode = (char)wParam; 
        boolean isDeadChar = ((msg == WindowMessage.WM_DEADCHAR) || (msg == WindowMessage.WM_SYSDEADCHAR));
        boolean isSystemChar = ((msg == WindowMessage.WM_SYSCHAR) || (msg == WindowMessage.WM_SYSDEADCHAR)); 
    ...
    /*internal*/ public static int GetVirtualKey(IntPtr wParam, IntPtr lParam)
    { 
        ...
        { 
            boolean right = ((keyData & 0x1000000) >> 24) != 0;
    ...
    /*internal*/ public static int GetScanCode(IntPtr wParam, IntPtr lParam) 
    {
        int keyData = NativeMethods.IntPtrToInt32(lParam); 
    ...
    /*internal*/ public static boolean IsExtendedKey(IntPtr lParam) 
    {
        int keyData = NativeMethods.IntPtrToInt32(lParam); 
...
//    [FriendAccessAllowed]
//    [SecurityCritical,SecurityTreatAsSafe] 
    /*internal*/ public static ModifierKeys GetSystemModifierKeys() 
    {
...
//    [SecurityCritical] 
    private void PossiblyDeactivate(IntPtr hwndFocus)
    {
        ...
        //
        boolean deactivate = !IsOurWindow(hwndFocus); 
    ...
    /// </SecurityNote>
//    [SecurityCritical,SecurityTreatAsSafe] 
    private boolean IsOurWindow(IntPtr hwnd)
    {
        boolean isOurWindow = false;
...
//    [SecurityCritical]
    ...
    { 
        ...
        boolean handled = _site.Value.ReportInput(report); 
...
//    [SecurityCritical] 
    ...
    private boolean _partialActive;
    private boolean _acquiringFocusOurselves;
}